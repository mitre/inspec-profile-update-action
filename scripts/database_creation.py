...
# atlas schema apply --to file://database/schema --dev-url "sqlite://dev?mode=memory" --url sqlite://database/test.db

print("Install `atlas-cli`, then run: ")
print(
    'atlas schema apply --to file://database/schema --dev-url "sqlite://dev?mode=memory" --url sqlite://database/test.db"'
)

print('Atlas can help us manage changes to the DB more easily')
