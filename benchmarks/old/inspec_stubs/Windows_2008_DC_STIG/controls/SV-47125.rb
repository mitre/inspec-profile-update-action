...
If any accounts or groups are defined for the "Deny log on as a service", this is a finding.'
  desc 'fix', 'Configure the policy value for Computer Configuration -> Windows Settings -> Security Settings -> Local Policies -> User Rights Assignment -> "Deny log on as a service" to include the no entries (blank).'
  impact 0.5
  ref 'DPMS Target Windows 2008'
  tag check_id: 'C-44742r2_chk'
  tag severity: 'medium'
  tag gid: 'V-26484'
  tag rid: 'SV-47125r1_rule'
  tag stig_id: 'WINUR-000019-DC'
  tag gtitle: 'Deny log on as service'
  tag fix_id: 'F-41042r3_fix'
  tag 'documentable'
