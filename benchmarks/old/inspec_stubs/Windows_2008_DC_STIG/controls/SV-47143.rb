control 'SV-47143' do
  title 'The Deny log on through Terminal Services user right on domain controllers must be configured to prevent unauthenticated access.'
