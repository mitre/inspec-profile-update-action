...
The three Success types listed below are defaults Inherited From the Parent Object. Where Special is listed in the summary screens for Access, detailed Permissions are provided for reference, various.
...
Applies To - Descendant Organization Unit objects'
  ...
  tag check_id: 'C-79571r4_chk'
  tag severity: 'medium'
  tag gid: 'V-39325'
  tag rid: 'SV-55016r3_rule'
  tag stig_id: 'WINAU-000207-DC'
  tag gtitle: 'WINAU-000207-DC'
  tag fix_id: 'F-86709r3_fix'
  tag 'documentable'
