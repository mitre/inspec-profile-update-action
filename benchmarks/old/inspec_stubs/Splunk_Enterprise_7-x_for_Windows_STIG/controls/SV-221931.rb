control 'SV-221931' do
  title 'Splunk Enterprise must display the Standard Mandatory DOD Notice and Consent Banner and accept user acknowledgement before granting access to the application.'
...
The string in the above line will be the text of the DOD consent banner.'
  ...
  tag check_id: 'C-23645r918480_chk'
  tag severity: 'low'
  tag gid: 'V-221931'
  tag rid: 'SV-221931r918482_rule'
  tag stig_id: 'SPLK-CL-000035'
  tag gtitle: 'SRG-APP-000068-AU-000035'
  tag fix_id: 'F-23634r918481_fix'
  tag 'documentable'
  tag legacy: ['SV-111311', 'V-102355']
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
