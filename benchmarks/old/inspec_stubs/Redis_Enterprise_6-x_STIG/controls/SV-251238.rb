...
Note that if a client supports an older TLS version, the communication is not allowed.)
  ...
  tag check_id: 'C-54673r863365_chk'
  tag severity: 'medium'
  tag gid: 'V-251238'
  tag rid: 'SV-251238r863366_rule'
  tag stig_id: 'RD6X-00-010400'
  tag gtitle: 'SRG-APP-000224-DB-000384'
  tag fix_id: 'F-54627r804903_fix'
  tag 'documentable'
  tag cci: ['CCI-001188']
  tag nist: ['SC-23 (3)']
end
