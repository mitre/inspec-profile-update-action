...
From the expanded list, right-click to select the zone (repeat for each hosted zone), point to DNSSEC, and then click Sign the Zone, either using approved saved parameters or approved custom parameters.'
  ...
  tag check_id: 'C-16817r314344_chk'
  tag severity: 'medium'
  tag gid: 'V-215623'
  tag rid: 'SV-215623r561297_rule'
  tag stig_id: 'WDNS-SC-000015'
  tag gtitle: 'SRG-APP-000424-DNS-000057'
  tag fix_id: 'F-16815r314345_fix'
  tag 'documentable'
  tag legacy: ['SV-73109', 'V-58679']
  tag cci: ['CCI-002466']
  tag nist: ['SC-21']
end
