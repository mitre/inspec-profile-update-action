control 'WDNS-22-000045_rule' do
  title 'The Windows 2022 DNS Server must include data origin with authoritative data the system returns in response to external name/address resolution queries.'
...
Note: It is important to use the -server switch followed by Windows 2022 DNS Server name/IP address.
...
Right-click the zone (repeat for each hosted zone), point to DNSSEC, and then click "Sign the Zone" using either approved saved parameters or approved custom parameters.'
  impact 0.5
  tag check_id: 'C-WDNS-22-000045_chk'
  tag severity: 'medium'
  tag gid: 'WDNS-22-000045'
  tag rid: 'WDNS-22-000045_rule'
  tag stig_id: 'WDNS-22-000045'
  tag gtitle: 'SRG-APP-000213-DNS-000024'
  tag fix_id: 'F-WDNS-22-000045_fix'
  tag 'documentable'
  tag cci: ['CCI-001178']
  tag nist: ['SC-20 a']
end
