control 'WDNS-22-000048_rule' do
  title 'The Windows 2022 DNS Server must use DNSSEC data within queries to confirm data origin to DNS resolvers.'
...
From the expanded list, right-click to select the zone (repeat for each hosted zone), point to DNSSEC, and then click "Sign the Zone" using either approved saved parameters or approved custom parameters.'
  impact 0.5
  tag check_id: 'C-WDNS-22-000048_chk'
  tag severity: 'medium'
  tag gid: 'WDNS-22-000048'
  tag rid: 'WDNS-22-000048_rule'
  tag stig_id: 'WDNS-22-000048'
  tag gtitle: 'SRG-APP-000421-DNS-000054'
  tag fix_id: 'F-WDNS-22-000048_fix'
  tag 'documentable'
