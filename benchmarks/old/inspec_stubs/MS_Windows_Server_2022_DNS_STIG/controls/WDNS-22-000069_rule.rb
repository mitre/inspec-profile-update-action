control 'WDNS-22-000069_rule' do
  title 'The Windows 2022 DNS Server must protect the integrity of transmitted information.'
...
From the expanded list, right-click to select the zone (repeat for each hosted zone), point to DNSSEC, and then click "Sign the Zone" using either approved saved parameters or approved custom parameters.'
  impact 0.7
  tag check_id: 'C-WDNS-22-000069_chk'
  tag severity: 'high'
  tag gid: 'WDNS-22-000069'
  tag rid: 'WDNS-22-000069_rule'
  tag stig_id: 'WDNS-22-000069'
  tag gtitle: 'SRG-APP-000439-DNS-000063'
  tag fix_id: 'F-WDNS-22-000069_fix'
  tag 'documentable'
  tag cci: ['CCI-002418']
  tag nist: ['SC-8']
end
