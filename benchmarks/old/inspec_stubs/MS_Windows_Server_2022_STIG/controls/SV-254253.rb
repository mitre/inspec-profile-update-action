...
The default permissions are adequate when the Security Option "Network access: Let Everyone permissions apply to anonymous users" is set to "Disabled" (WN22-SO-000240).
  ...
  desc 'check', 'The default permissions are adequate when the Security Option "Network access: Let Everyone permissions apply to anonymous users" is set to "Disabled" (WN22-SO-000240).
...
Successfully processed 1 files; Failed processing 0 files'
  desc 'fix', 'Maintain the default file ACLs and configure the Security Option "Network access: Let Everyone permissions apply to anonymous users" to "Disabled" (WN22-SO-000240).
...
ALL RESTRICTED APPLICATION PACKAGES - Read & execute - This folder, subfolders, and files'
  ...
  tag check_id: 'C-57738r848573_chk'
  tag severity: 'medium'
  tag gid: 'V-254253'
  tag rid: 'SV-254253r848575_rule'
  tag stig_id: 'WN22-00-000160'
  tag gtitle: 'SRG-OS-000312-GPOS-00122'
  tag fix_id: 'F-57689r848574_fix'
