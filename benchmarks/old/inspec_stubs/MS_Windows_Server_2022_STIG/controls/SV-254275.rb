control 'SV-254275' do
  ...
  desc 'check', 'Different methods are available to disable SMBv1 on Windows Server 2022. This is the preferred method, however if WN22-00-000390 and WN22-00-000400 are configured, this is NA.
...
Click "Next" and "Remove" as prompted.'
  ...
  tag check_id: 'C-57760r848639_chk'
  tag severity: 'medium'
  tag gid: 'V-254275'
  tag rid: 'SV-254275r848641_rule'
  tag stig_id: 'WN22-00-000380'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-57711r848640_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
