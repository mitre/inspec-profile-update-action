...
System >> Security State Change - Success'
  desc 'fix', 'Configure the policy value for Computer Configuration >> Windows Settings >> Security Settings >> Advanced Audit Policy Configuration >> System Audit Policies >> System >> Audit Security State Chang with "Success" selected.'
  impact 0.5
  ref 'DPMS Target Microsoft Windows Server 2022'
  tag check_id: 'C-57814r848801_chk'
  tag severity: 'medium'
  tag gid: 'V-254329'
  tag rid: 'SV-254329r848803_rule'
  tag stig_id: 'WN22-AU-000360'
  tag gtitle: 'SRG-OS-000327-GPOS-00127'
  tag fix_id: 'F-57765r848802_fix'
