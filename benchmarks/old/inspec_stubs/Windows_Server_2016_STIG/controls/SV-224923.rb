control 'SV-224923' do
  title 'Windows Server 2016 virtualization-based security must be enabled with the platform security level configured to Secure Boot or Secure Boot with DMA Protection.'
...
https://technet.microsoft.com/itpro/windows/keep-secure/credential-guard'
  ...
  tag check_id: 'C-26614r857252_chk'
  tag severity: 'medium'
  tag gid: 'V-224923'
  tag rid: 'SV-224923r857253_rule'
  tag stig_id: 'WN16-CC-000110'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-26602r465672_fix'
  tag 'documentable'
  tag legacy: ['SV-88165', 'V-73513']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
