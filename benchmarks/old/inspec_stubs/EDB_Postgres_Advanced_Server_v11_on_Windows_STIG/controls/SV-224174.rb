control 'SV-224174' do
  title 'The EDB Postgres Advanced Server must use NIST FIPS 140-2 or 140-3 validated cryptographic modules for all cryptographic operations including generation of cryptographic hashes and data protection.'
...
Restart the Postgres server via the Services administration GUI.'
  ...
  tag check_id: 'C-25847r836878_chk'
  tag severity: 'high'
  tag gid: 'V-224174'
  tag rid: 'SV-224174r836880_rule'
  tag stig_id: 'EP11-00-004900'
  tag gtitle: 'SRG-APP-000179-DB-000114'
  tag fix_id: 'F-25835r836879_fix'
