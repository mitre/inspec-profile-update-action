control 'SV-215296' do
  ...
  desc 'check', %q(Note:  If the installed version of OpenSSH is 7.4 or above, this requirement is not applicable.
...
# startsrc -s sshd'
  ...
  tag check_id: 'C-16494r922843_chk'
  tag severity: 'medium'
  tag gid: 'V-215296'
  tag rid: 'SV-215296r922844_rule'
