...
Configuration of allowlisting applications will vary by the program. AppLocker is an allowlisting application built into Windows Server 2012.
...
https://docs.microsoft.com/en-us/windows/security/threat-protection/windows-defender-application-control/applocker/applocker-policies-deployment-guide'
  ...
  tag check_id: 'C-26954r890487_chk'
  tag severity: 'medium'
  tag gid: 'V-225255'
  tag rid: 'SV-225255r890489_rule'
  tag stig_id: 'WN12-00-000018'
  tag gtitle: 'SRG-OS-000370-GPOS-00155'
  tag fix_id: 'F-26942r890488_fix'
  tag 'documentable'
