...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when successful/unsuccessful attempts to use the "apparmor_parser" command occur.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20993r305132_chk'
  tag severity: 'medium'
  tag gid: 'V-219268'
  tag rid: 'SV-219268r610963_rule'
  tag stig_id: 'UBTU-18-010345'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-20992r305133_fix'
  tag 'documentable'
  tag legacy: ['V-100761', 'SV-109865']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
