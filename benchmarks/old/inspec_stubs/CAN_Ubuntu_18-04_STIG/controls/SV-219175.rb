control 'SV-219175' do
  title 'The Ubuntu operating system must require the change of at least 8 characters when passwords are changed.'
  desc 'If the Ubuntu operating system allows the user to consecutively reuse extensive portions of passwords, this increases the chances of password compromise by increasing the window of opportunity for attempts at guessing and brute-force attacks.
...
If the password length is an odd number then number of changed characters must be rounded up. For example, a password length of 15 characters must require the change of at least 8 characters.'
  desc 'check', 'Verify the Ubuntu operating system requires the change of at least 8 characters when passwords are changed.
...
If the "difok" parameter is less than "8", or is commented out, this is a finding.'
  desc 'fix', 'Configure the Ubuntu operating system to require the change of at least 8 characters when passwords are changed.
...
difok=8'
  ...
  tag check_id: 'C-20900r304853_chk'
  tag severity: 'low'
  tag gid: 'V-219175'
  tag rid: 'SV-219175r610963_rule'
  tag stig_id: 'UBTU-18-010103'
  tag gtitle: 'SRG-OS-000072-GPOS-00040'
  tag fix_id: 'F-20899r304854_fix'
  tag 'documentable'
  tag legacy: ['SV-109681', 'V-100577']
  tag cci: ['CCI-000195']
  tag nist: ['IA-5 (1) (b)']
end
