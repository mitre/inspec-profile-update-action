control 'SV-219235' do
  ...
  desc 'check', 'Verify that "/etc/audit/audit.rules", "/etc/audit/rules.d/*" and "/etc/audit/auditd.conf" files are owned by root account by using the following command:
...
Note: The "root" account must be used to edit any files in the /etc/audit and /etc/audit/rules.d/ directories.'
  ...
  tag check_id: 'C-20960r305033_chk'
  tag severity: 'medium'
  tag gid: 'V-219235'
  tag rid: 'SV-219235r610963_rule'
  tag stig_id: 'UBTU-18-010312'
  tag gtitle: 'SRG-OS-000063-GPOS-00032'
  tag fix_id: 'F-20959r305034_fix'
  tag 'documentable'
  tag legacy: ['SV-109801', 'V-100697']
  tag cci: ['CCI-000171']
  tag nist: ['AU-12 b']
end
