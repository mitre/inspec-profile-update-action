...
This requirement applies to each audit data storage repository (i.e., distinct information system component where audit records are stored), the centralized audit storage capacity of organizations (i.e., all audit data storage repositories combined), or both.'
  desc 'check', 'Verify that the System Administrator (SA) and Information System Security Officer (ISSO) (at a minimum) are notified in the event of an audit processing failure.
...
If the value of the "action_mail_acct" keyword is not set to "root" and/or other accounts for security personnel, the "action_mail_acct" keyword is missing, or the returned line is commented out, this is a finding.'
  desc 'fix', 'Configure "auditd" service to notify the System Administrator (SA) and Information System Security Officer (ISSO) in the event of an audit processing failure. 
...
# sudo systemctl restart auditd.service'
  ...
  tag check_id: 'C-20951r305006_chk'
  tag severity: 'medium'
  tag gid: 'V-219226'
  tag rid: 'SV-219226r610963_rule'
  tag stig_id: 'UBTU-18-010300'
  tag gtitle: 'SRG-OS-000046-GPOS-00022'
  tag fix_id: 'F-20950r305007_fix'
  tag 'documentable'
  tag legacy: ['V-100679', 'SV-109783']
  tag cci: ['CCI-000139']
  tag nist: ['AU-5 a']
end
