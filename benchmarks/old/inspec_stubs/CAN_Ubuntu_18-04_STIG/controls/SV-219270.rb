...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when successful/unsuccessful attempts to use the "chacl" command occur.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20995r928518_chk'
  tag severity: 'medium'
  tag gid: 'V-219270'
  tag rid: 'SV-219270r928519_rule'
  tag stig_id: 'UBTU-18-010347'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-20994r305139_fix'
  tag 'documentable'
  tag legacy: ['V-100765', 'SV-109869']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
