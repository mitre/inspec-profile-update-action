...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', %q(Verify if the Ubuntu operating system generates audit records when successful/unsuccessful attempts to use of the "mount" command occur.
...
The "root" account must be used to view/edit any files in the /etc/audit/rules.d/ directory.'
  ...
  tag check_id: 'C-20965r305048_chk'
  tag severity: 'medium'
  tag gid: 'V-219240'
  tag rid: 'SV-219240r610963_rule'
  tag stig_id: 'UBTU-18-010317'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-20964r305049_fix'
  tag 'documentable'
  tag legacy: ['V-100707', 'SV-109811']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
