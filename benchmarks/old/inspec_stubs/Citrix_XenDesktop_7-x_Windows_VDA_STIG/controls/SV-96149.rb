...
If an unapproved port is used, this is a finding.'
  desc 'fix', %q(To change the VDA registration port from the default "80", create the Citrix Machine Policy and update the DDCs, as explained below:
...
7. Restart all desktops and verify that all VDAs register successfully.)
  ...
  tag check_id: 'C-81175r1_chk'
  tag severity: 'medium'
  tag gid: 'V-81435'
  tag rid: 'SV-96149r1_rule'
  tag stig_id: 'CXEN-VD-000275'
  tag gtitle: 'SRG-APP-000142'
  tag fix_id: 'F-88253r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000382']
  tag nist: ['CM-7 b']
end
