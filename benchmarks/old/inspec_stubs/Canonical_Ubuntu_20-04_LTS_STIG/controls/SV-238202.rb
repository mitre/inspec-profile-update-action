control 'SV-238202' do
  ...
  desc 'check', 'Verify the Ubuntu operating system enforces a 24 hours/1 day minimum password lifetime for new user accounts by running the following command: 
...
PASS_MIN_DAYS    1'
  ...
  tag check_id: 'C-41412r653779_chk'
  tag severity: 'low'
  tag gid: 'V-238202'
