...
'
  desc 'check', 'Verify the Ubuntu operating system prevents passwords from being reused for a minimum of five generations by running the following command:
...
If the "remember" parameter value is not greater than or equal to "5", is commented out, or is not set at all, this is a finding.'
  desc 'fix', 'Configure the Ubuntu operating system to prevent passwords from being reused for a minimum of five generations.
...
password [success=1 default=ignore] pam_unix.so obscure sha512 shadow remember=5 rounds=5000'
  ...
  tag check_id: 'C-41444r832943_chk'
  tag severity: 'low'
  tag gid: 'V-238234'
