...
Inactive accounts that have been reviewed and deemed to be required must be documented with the ISSO.)
  ...
  tag check_id: 'C-56721r828886_chk'
  tag severity: 'low'
  tag gid: 'V-253268'
  tag rid: 'SV-253268r828888_rule'
  tag stig_id: 'WN11-00-000065'
  tag gtitle: 'SRG-OS-000468-GPOS-00212'
  tag fix_id: 'F-56671r828887_fix'
  tag satisfies: ['SRG-OS-000468-GPOS-00212', 'SRG-OS-000118-GPOS-00060']
  tag 'documentable'
  tag cci: ['CCI-000172', 'CCI-000795']
  tag nist: ['AU-12 c', 'IA-4 e']
end
