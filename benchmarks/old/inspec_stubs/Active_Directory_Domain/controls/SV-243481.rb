control 'SV-243481' do
  ...
  desc 'check', "1. Before performing this check, perform V-243494, which validates the trusts within the documentation are current within AD.
...
4. If the need for the trust is not documented, this is a finding."
  ...
  tag check_id: 'C-46756r890557_chk'
  tag severity: 'medium'
  tag gid: 'V-243481'
  tag rid: 'SV-243481r890559_rule'
  tag stig_id: 'AD.0170'
  tag gtitle: 'SRG-OS-000480'
  tag fix_id: 'F-46713r890558_fix'
  tag 'documentable'
