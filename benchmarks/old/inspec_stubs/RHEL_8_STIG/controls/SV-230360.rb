...
RHEL 8 utilizes "pwquality" as a mechanism to enforce password complexity. The "maxclassrepeat" option sets the maximum number of allowed same consecutive characters in the same class in the new password.'
  desc 'check', 'Check for the value of the "maxclassrepeat" option in "/etc/security/pwquality.conf" with the following command:
...
maxclassrepeat = 4'
  ...
  tag check_id: 'C-33029r809288_chk'
  tag severity: 'medium'
  tag gid: 'V-230360'
  tag rid: 'SV-230360r809289_rule'
