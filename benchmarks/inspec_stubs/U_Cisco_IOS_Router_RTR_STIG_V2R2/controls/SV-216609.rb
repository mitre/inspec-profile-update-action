...
If the router with RSVP-TE enabled does not rate limit RSVP messages based on the link speed and input queue size of adjacent core routers, this is a finding.'
  desc 'fix', 'Configure the router to rate limit RSVP messages per interface as shown in the example.

R2(config)#ip rsvp signaling rate-limit burst 9  maxsize 2100 period 30 limit 50'
  impact 0.3
  ref 'DPMS Target Cisco IOS Router RTR'
  tag check_id: 'C-17844r287199_chk'
  tag severity: 'low'
  tag gid: 'V-216609'
  tag rid: 'SV-216609r531085_rule'
  tag stig_id: 'CISC-RT-000610'
  tag gtitle: 'SRG-NET-000193-RTR-000001'
  tag fix_id: 'F-17840r287200_fix'
  tag 'documentable'
  tag legacy: ['SV-105757', 'V-96619']
  tag cci: ['CCI-001095']
  tag nist: ['SC-5 (2)']
end
