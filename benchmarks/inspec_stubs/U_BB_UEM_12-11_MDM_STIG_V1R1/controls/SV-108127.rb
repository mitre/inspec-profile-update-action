control 'SV-108127' do
  ...
  desc 'Note: The advisory notice and consent warning message is not required if the general purpose OS or network device displays an advisory notice and consent warning message when the administrator logs on to the general purpose OS or network device prior to accessing the BlackBerry UEM 12.11 server or BlackBerry UEM 12.11 server platform.
...
8. Click "Save". 
If the self-service portal is used in the organization, complete steps 7-11.
...
11. Click "Save".'
  ...
  tag check_id: 'C-97863r1_chk'
  tag severity: 'medium'
  tag gid: 'V-99023'
  tag rid: 'SV-108127r1_rule'
  tag stig_id: 'BUEM-12-110080'
  tag gtitle: 'PP-MDM-411056'
  tag fix_id: 'F-104699r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
