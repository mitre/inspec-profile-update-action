control 'SV-235120' do
  title 'The MySQL Database Server 8.0 must generate audit records when unsuccessful attempts to delete privileges/permissions occur.'
...
To aid in diagnosis, it is necessary to keep track of failed attempts in addition to the successful ones.'
  desc 'check', %q(Review the system documentation to determine if MySQL Server is required to audit when unsuccessful attempts to delete privileges/permissions occur.
...
If the audit event is not present, this is a finding.)
  desc 'fix', 'Configure the MySQL Database Server to audit when unsuccessful attempts to delete privileges/permissions occur.

See the supplemental file "MySQL80Audit.sql".'
  impact 0.5
  ref 'DPMS Target Oracle MySQL 8.0'
  tag check_id: 'C-38339r623480_chk'
  tag severity: 'medium'
  tag gid: 'V-235120'
  tag rid: 'SV-235120r638812_rule'
  tag stig_id: 'MYS8-00-003300'
  tag gtitle: 'SRG-APP-000499-DB-000331'
  tag fix_id: 'F-38302r623481_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
