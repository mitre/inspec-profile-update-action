control 'SV-224047' do
  title 'The IBM z/OS Syslog daemon must not be started at z/OS initialization.'
...
It is important that syslogd be started during the initialization phase of the z/OS system to ensure that significant messages are not lost. As with other z/OS UNIX daemons, there is more than one way to start SYSLOGD. It can be started as a process in the /etc/rc file or as a z/OS started task.'
  ...
  tag check_id: 'C-25720r516540_chk'
  tag severity: 'medium'
  tag gid: 'V-224047'
  tag rid: 'SV-224047r561402_rule'
  tag stig_id: 'TSS0-SL-000020'
  tag gtitle: 'SRG-OS-000104-GPOS-00051'
  tag fix_id: 'F-25708r516541_fix'
  tag 'documentable'
  tag legacy: ['V-98801', 'SV-107905']
  tag cci: ['CCI-000764']
  tag nist: ['IA-2']
end
