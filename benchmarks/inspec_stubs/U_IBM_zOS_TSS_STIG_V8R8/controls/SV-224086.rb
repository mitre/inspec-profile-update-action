...
Note: If the OMVS statement is not specified, OMVS=DEFAULT is used. In minimum mode there is no access to permanent file systems or to the shell, and IBM's Communication Server TCP/IP will not run."
  ...
  tag check_id: 'C-25759r869024_chk'
  tag severity: 'medium'
  tag gid: 'V-224086'
  tag rid: 'SV-224086r869026_rule'
  tag stig_id: 'TSS0-US-000130'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-25747r869025_fix'
  tag 'documentable'
  tag legacy: ['V-98879', 'SV-107983']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
