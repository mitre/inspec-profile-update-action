...
If the TSS data set access authorizations do not  restrict WRITE and/or greater access to the product STC(s) and/or batch job(s), this is a finding.'
  desc 'fix', "The ISSO will ensure that WRITE and/or greater access to IBM Integrated Crypto Service Facility (ICSF) STC and/or batch data sets are limited to system programmers and ICSF STC and/or batch jobs only. READ access can be given to auditors at the ISSO's discretion.
...
TSS PERMIT(icsfstc) DSN(SYS3.CDS.) ACCESS(ALL)"
  ...
  tag check_id: 'C-56349r868972_chk'
  tag severity: 'medium'
  tag gid: 'V-252893'
  tag rid: 'SV-252893r868974_rule'
  tag stig_id: 'TSS0-IC-000030'
  tag gtitle: 'SRG-OS-000259'
  tag fix_id: 'F-56299r868973_fix'
  tag 'documentable'
