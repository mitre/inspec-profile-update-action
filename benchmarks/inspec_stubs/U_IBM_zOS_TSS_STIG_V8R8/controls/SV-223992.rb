...
If access authorization to the JES2.UPDATE.JESNEWS resource in the OPERCMDS class restricts CONTROL access to the appropriate personnel (i.e., users responsible for maintaining the JES News data set) and all access is logged, this is not a finding.'
  desc 'fix', 'Configure access authorization to the JES2.UPDATE.JESNEWS resource in the OPERCMDS class to restrict CONTROL access to the appropriate personnel (i.e., users responsible for maintaining the JES News data set) and ensure all access is logged. 
...
ACCESS(CONTROL) ACTION(AUDIT)'
  ...
  tag severity: 'medium'
  tag gid: 'V-223992'
  tag rid: 'SV-223992r868978_rule'
  tag stig_id: 'TSS0-JS-000080'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25653r868977_fix'
  tag 'documentable'
