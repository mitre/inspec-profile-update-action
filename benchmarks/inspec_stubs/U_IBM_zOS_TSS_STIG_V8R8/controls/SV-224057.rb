...
chaudit w=sf,rx+f /usr/lpp/tcpip/sbin'
  ...
  tag check_id: 'C-25730r516570_chk'
  tag severity: 'medium'
  tag gid: 'V-224057'
  tag rid: 'SV-224057r561402_rule'
  tag stig_id: 'TSS0-TC-000020'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25718r516571_fix'
  tag 'documentable'
  tag legacy: ['V-98821', 'SV-107925']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
