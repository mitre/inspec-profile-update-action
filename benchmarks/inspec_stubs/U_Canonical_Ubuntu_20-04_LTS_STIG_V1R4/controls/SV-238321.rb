control 'SV-238321' do
  title 'The Ubuntu operating system must have a crontab script running weekly to offload audit events of standalone systems.'
...
The script must be located in the "/etc/cron.weekly" directory.'
  ...
  tag check_id: 'C-41531r654136_chk'
  tag severity: 'low'
  tag gid: 'V-238321'
