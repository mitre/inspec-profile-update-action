control 'SV-238309' do
  title 'The Ubuntu operating system must generate audit records for privileged activities, nonlocal maintenance, diagnostic sessions and other system-level access.'
...
'
  desc 'check', 'Verify the Ubuntu operating system audits activities performed during nonlocal maintenance and diagnostic sessions. 
...
Note: The "-k" allows for specifying an arbitrary identifier, and the string after it does not need to match the example output above.'
  desc 'fix', 'Configure the Ubuntu operating system to audit activities performed during nonlocal maintenance and diagnostic sessions. 
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41519r654100_chk'
  tag severity: 'medium'
  tag gid: 'V-238309'
