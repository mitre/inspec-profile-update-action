...
# grep nullok /etc/pam.d/common_password
...
Remove any instances of the "nullok" option in "/etc/pam.d/common_password" to prevent logons with empty passwords.'
  impact 0.7
  ref 'DPMS Target Canonical Ubuntu 20.04 LTS'
  tag check_id: 'C-54939r808507_chk'
  tag severity: 'high'
  tag gid: 'V-251504'
  tag rid: 'SV-251504r808509_rule'
  tag stig_id: 'UBTU-20-010463'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-54893r808508_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
