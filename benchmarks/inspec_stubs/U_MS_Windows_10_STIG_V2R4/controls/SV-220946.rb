...
Computer\\HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Cryptography\\Calais\\SmartCards'
  desc 'fix', "For non-domain joined systems, configuring Windows Hello for sign-on options is suggested based on the organization's needs and capabilities."
  impact 0.5
  ref 'DPMS Target Microsoft Windows 10'
  tag check_id: 'C-22661r819674_chk'
  tag severity: 'medium'
  tag gid: 'V-220946'
  tag rid: 'SV-220946r819676_rule'
  tag stig_id: 'WN10-SO-000251'
  tag gtitle: 'SRG-OS-000105-GPOS-00052'
  tag fix_id: 'F-22650r819675_fix'
