...
Use the chmod command to set the permissions correctly.  For example, if the log directory is located at /opt/cf11/cfusion/logs, the command would be:
  ...
  tag check_id: 'C-40371r641549_chk'
  tag severity: 'medium'
  tag gid: 'V-237152'
  tag rid: 'SV-237152r641551_rule'
  tag stig_id: 'CF11-02-000050'
  tag gtitle: 'SRG-APP-000118-AS-000078'
  tag fix_id: 'F-40334r641550_fix'
  tag 'documentable'
  tag legacy: ['SV-76867', 'V-62377']
  tag cci: ['CCI-000162']
  tag nist: ['AU-9 a']
end
