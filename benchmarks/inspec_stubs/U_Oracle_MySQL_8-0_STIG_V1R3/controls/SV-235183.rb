control 'SV-235183' do
  title 'The MySQL Database Server 8.0 must associate organization-defined types of security labels having organization-defined security label values with information in process.'
...
If a MySQL solution through the use of views and stored procedures or a third party solution does not exist, this is a finding.'
  ...
  tag check_id: 'C-38402r623669_chk'
  tag severity: 'medium'
  tag gid: 'V-235183'
  tag rid: 'SV-235183r855581_rule'
