...
If the network parameter "ipv4.conf.default.accept_source_route" is not equal to "0" or nothing is returned, this is a finding.'
  desc 'fix', %q(Configure the SUSE operating system to disable IPv4 default source routing by running the following command as an administrator:
...
> sudo sysctl --system)
  ...
  tag check_id: 'C-38204r619317_chk'
  tag severity: 'medium'
  tag gid: 'V-235016'
  tag rid: 'SV-235016r622137_rule'
  tag stig_id: 'SLES-15-040320'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-38167r619318_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
