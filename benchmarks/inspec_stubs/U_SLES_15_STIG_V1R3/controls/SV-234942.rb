...
'
  desc 'check', %q(Verify the SUSE operating system generates an audit record for all uses of the "setfacl" command.
...
> sudo augenrules --load'
  ...
  tag check_id: 'C-38130r619095_chk'
  tag severity: 'medium'
  tag gid: 'V-234942'
  tag rid: 'SV-234942r622137_rule'
  tag stig_id: 'SLES-15-030430'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-38093r619096_fix'
