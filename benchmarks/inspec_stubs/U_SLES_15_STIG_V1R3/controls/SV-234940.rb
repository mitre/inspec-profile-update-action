...
'
  desc 'check', %q(Verify the SUSE operating system generates an audit record for all uses of the "kmod" command.
...
> sudo augenrules --load'
  ...
  tag check_id: 'C-38128r619089_chk'
  tag severity: 'medium'
  tag gid: 'V-234940'
  tag rid: 'SV-234940r622137_rule'
  tag stig_id: 'SLES-15-030410'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-38091r619090_fix'
