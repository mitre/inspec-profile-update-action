...
This check is only for unclassified/sensitive media being used in a strictly unclassified physical environment. If all Controlled Unclassified Information (CUI) media are in a mixed environment where classified systems and media are in use, then STIG ID IS-03.02.01. applies and this check is NA. 
...
While For Official Use Only (FOUO) is the primary CUI marking used in DOD, all types of CUI markings must be considered for use as appropriate. For instance: "Law Enforcement Sensitive" is a marking sometimes applied, in addition to the marking "FOR OFFICIAL USE ONLY," by the Department of Justice and other activities in the law enforcement community, including those within the Department of Defense.'
  ...
  tag check_id: 'C-49281r917256_chk'
  tag severity: 'low'
  tag gid: 'V-245850'
  tag rid: 'SV-245850r917357_rule'
  tag stig_id: 'IS-16.03.02'
  tag gtitle: 'IS-16.03.02'
  tag fix_id: 'F-49236r917257_fix'
  tag 'documentable'
  tag legacy: ['V-32262', 'SV-42579r3_rule']
end
