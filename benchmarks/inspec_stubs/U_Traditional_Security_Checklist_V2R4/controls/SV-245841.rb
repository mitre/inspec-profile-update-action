...
DoD 5220.22-M (NISPOM), Incorporating Change 2, 18 May 2016, paragraphs 1-303, 1-304, 1-400, 1-401 and 8-302.i.
...
3. Ensure employees know what to do when discovering classified material unsecure or out of proper control.  Verify by asking random employees if they know what to do if they discover a security incident.'
  ...
  tag check_id: 'C-49272r770183_chk'
  tag severity: 'medium'
  tag gid: 'V-245841'
  tag rid: 'SV-245841r822904_rule'
  tag stig_id: 'IS-14.02.01'
  tag gtitle: 'IS-14.02.01'
  tag fix_id: 'F-49227r770184_fix'
  tag 'documentable'
  tag legacy: ['V-32138', 'SV-42455r3_rule']
end
