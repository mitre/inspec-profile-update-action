control 'SV-245834' do
  ...
  desc 'Failure to follow guidance for disabling removable media drives on devices connected to the SIPRNet or, if approved by the local AO, failure to follow US CYBERCOM procedures for using removable media on SIPRNet could result in the loss or compromise of classified information.
...
5. Ensure there are written procedures approved by the AO for use of removable media on SIPRNet.'
  ...
  tag check_id: 'C-49265r917229_chk'
  tag severity: 'medium'
  tag gid: 'V-245834'
  tag rid: 'SV-245834r917348_rule'
  tag stig_id: 'IS-10.02.01'
  tag gtitle: 'IS-10.02.01'
  tag fix_id: 'F-49220r917230_fix'
  tag 'documentable'
  tag legacy: ['V-31996', 'SV-42295r3_rule']
end
