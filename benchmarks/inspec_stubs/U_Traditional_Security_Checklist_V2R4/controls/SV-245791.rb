...
DOD 5220.22-M (NISPOM), Incorporating Change 2, 18 May 2016, Chapter 8, paragraph 8-302.a., b., g.& j, and paragraph 8-303.a and b. 

DOD Manual 5200.48 Controlled Unclassified Information (CUI)
...
2. Conduct a cursory review of the DD 254 to ensure all security requirements are properly detailed on the form, especially with regard to Information Assurance (i.e., IT Position level designation) in addition to security clearance, training and certification requirements. 
...
2. All security requirements must be properly detailed on the form, particularly for Information Technology related requirements, such as IT Position levels (in addition to security clearance, training and certification requirements)for the positions or types of work to be performed.'
  ...
  tag check_id: 'C-49222r822842_chk'
  tag severity: 'medium'
  tag gid: 'V-245791'
  tag rid: 'SV-245791r917342_rule'
  tag stig_id: 'ID-01.02.01'
  tag gtitle: 'ID-01.02.01'
  tag fix_id: 'F-49177r770034_fix'
  tag 'documentable'
  tag legacy: ['V-30993', 'SV-41039r3_rule']
end
