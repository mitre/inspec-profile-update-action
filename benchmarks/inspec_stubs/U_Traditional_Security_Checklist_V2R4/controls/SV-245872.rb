control 'SV-245872' do
  title 'Security Training - Information Security (INFOSEC) for ALL Employees; Military, Government Civilian and Contractor'
  desc 'Failure to provide security training to ALL employees results in a weak security program and could lead to the loss or compromise of classified or sensitive information.
...
Controls: AT-1, AT-2, AT-3 and AT-4 
...
Encl 2, para 7.c., 7.d., 7.g., 9.f.; Encl 3, para 5.f.; Encl 4 para 10.c.; Encl 5, para 3.b. 

CJCSI 6510.01F, INFORMATION ASSURANCE (IA) AND SUPPORT TO COMPUTER NETWORK DEFENSE (CND), 9 February 2011 
Encl A, para 11; Encl B, para 4.h., 4.i., 6.m.; Encl C para 5., 7.f., 21.h.(2), 27e.(8)(d) and 31.b. 
...
Enclosure 5'
  desc 'check', 'Check #1. Check that initial and recurring (minimum annually) information security is provided to each employee. 
...
TACTICAL ENVIRONMENT: The check is applicable for fixed (established) tactical processing environments.  Not applicable to a field/mobile environment.'
  desc 'fix', '1. Ensure initial and recurring (annual minimum) information security training is provided to each employee. 
...
All training accomplished must be documented. Anything less will be a finding.'
  ...
  tag check_id: 'C-49303r822938_chk'
  tag severity: 'medium'
  tag gid: 'V-245872'
  tag rid: 'SV-245872r822940_rule'
  tag stig_id: 'SM-02.02.01'
  tag gtitle: 'SM-02.02.01'
  tag fix_id: 'F-49258r822939_fix'
  tag 'documentable'
  tag legacy: ['SV-42943r3_rule', 'V-32606']
end
