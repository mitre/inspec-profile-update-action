...
DOD 5220.22-M (NISPOM), Incorporating Change 2, 18 May 2016, paragraphs 5-704, 5-705 & 5-708.
...
In all cases, if any such previously approved equipment needs to be replaced or otherwise requires a rebuild or replacement of a critical assembly (e.g., shredder blade assembly), the unit must be replaced with one listed on the appropriate EPL.

The EPLs and further guidance may be obtained by calling (410) 854-6358 or at: https://www.nsa.gov/Resources/Media-Destruction-Guidance
...
3. Burn bags (if used to store classified paper awaiting destruction at a central destruction facility) must be sealed and safeguard in a safe or vault or area approved for classified open storage until actually destroyed.'
  ...
  tag check_id: 'C-49267r917369_chk'
  tag severity: 'high'
  tag gid: 'V-245836'
  tag rid: 'SV-245836r917369_rule'
  tag stig_id: 'IS-11.01.01'
  tag gtitle: 'IS-11.01.01'
  tag fix_id: 'F-49222r917233_fix'
  tag 'documentable'
