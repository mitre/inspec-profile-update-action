...
DoD 5220.22-M (NISPOM), Incorporating Change 2, 18 May 2016, Chapter 5, Section 3, paragraphs 5-312, 5-313, and 5-314.'
...
Always be sure to coordinate door locking and emergency egress considerations with supporting facility risk management(fire/safety) personnel.'
  ...
  tag check_id: 'C-49250r770117_chk'
  tag severity: 'medium'
  tag gid: 'V-245819'
  tag rid: 'SV-245819r822876_rule'
  tag stig_id: 'IS-02.02.10'
  tag gtitle: 'IS-02.02.10'
  tag fix_id: 'F-49205r770118_fix'
  tag 'documentable'
  tag legacy: ['V-31908', 'SV-42205r3_rule']
end
