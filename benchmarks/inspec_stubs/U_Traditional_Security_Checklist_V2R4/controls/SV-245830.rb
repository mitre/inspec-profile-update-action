...
DoD 5220.22-M (NISPOM), Incorporating Change 2, 18 May 2016, Chapter 8, paragraph 8-103.
...
3.  CACs and other tokens must not be left unattended and must be in the physical custody of the person to whom they were issued.'
  ...
  tag check_id: 'C-49261r770150_chk'
  tag severity: 'high'
  tag gid: 'V-245830'
  tag rid: 'SV-245830r822889_rule'
  tag stig_id: 'IS-08.01.02'
  tag gtitle: 'IS-08.01.02'
  tag fix_id: 'F-49216r770151_fix'
  tag satisfies: ['Monitor Screens - Disable Access by CAC or Token Removal', 'or Lock Computer via Ctrl/Alt/Del']
  tag 'documentable'
  tag legacy: ['V-31993', 'SV-42292r3_rule']
end
