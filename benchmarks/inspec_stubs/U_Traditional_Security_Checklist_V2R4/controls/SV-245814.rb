...
Fix #3. Ensure equipment at the IDS/AECS monitor station indicates a failure in power source, a change in power source, and the location of the failure or change."
  ...
  tag check_id: 'C-49245r770102_chk'
  tag severity: 'medium'
  tag gid: 'V-245814'
  tag rid: 'SV-245814r822871_rule'
  tag stig_id: 'IS-02.02.05'
  tag gtitle: 'IS-02.02.05'
  tag fix_id: 'F-49200r770103_fix'
  tag 'documentable'
  tag legacy: ['SV-41561r3_rule', 'V-31290']
end
