...
https://www.niap-ccevs.org/index.cfm'
  desc 'check', 'Validate the correct configuration of CYBEX/Avocent 4 or 8 port KVMs IAW NIAP PCL guidance. This includes physical port separation between SIPRNet and NIPRNet (high and low) connections. Because of the internal physical configuration of the CYBEX boxes, only like classification levels may be connected to adjacent ports. 

TACTICAL ENVIRONMENT: The check is applicable where KVM devices are in use.'
  desc 'fix', '1. Validate the correct configuration of CYBEX/Avocent 4 or 8 port KVMs used for switching devices between the SIPRNet and NIPRNet (or any switching between SIPRNet and any other unclassified network devices) IAW NIAP PCL guidance.

2. Correct configuration must include physical port separation between SIPRNet and NIPRNet (high and low) (or any switching between SIPRNet and any other unclassified network devices) connections.
...
3. Because of the internal physical configuration of the CYBEX/Avocent box backplates, only like classification levels may be connected to adjacent ports.'
  ...
  tag check_id: 'C-49213r917550_chk'
  tag severity: 'medium'
  tag gid: 'V-245782'
  tag rid: 'SV-245782r917551_rule'
  tag stig_id: 'IA-10.02.02'
  tag gtitle: 'IA-10.02.02'
  tag fix_id: 'F-49168r917551_fix'
  tag 'documentable'
