...
DOD 5220.22-M (NISPOM), Incorporating Change 2, 18 May 2016, Chapter 5, Section 8, Construction Requirements, paragraph 5-802. Construction required for Vaults.'
...
The DOD Lock Program Web Portal provides detailed specifications for vaults and ordering instructions for doors. Available through DOD Lock Program at:

https://exwc.navfac.navy.mil/DoD-Lock-Program/
...
Facility Engineer (FE) construction certificates or other documentation must be available to ensure construction standards are met. Often these certificates are posted on the inside of the vault near the door, but can be on file elsewhere at the site.'
  ...
  tag check_id: 'C-49231r917220_chk'
  tag severity: 'high'
  tag gid: 'V-245800'
  tag rid: 'SV-245800r917345_rule'
  tag stig_id: 'IS-02.01.06'
  tag gtitle: 'IS-02.01.06'
  tag fix_id: 'F-49186r917221_fix'
  tag 'documentable'
