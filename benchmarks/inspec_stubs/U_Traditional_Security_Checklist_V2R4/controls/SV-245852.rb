control 'SV-245852' do
  title 'Position of Trust - Knowledge of Responsibility to Self Report Derogatory Information'
  desc 'Failure to inform personnel of the expected standards of conduct while holding a position of trust and their responsibility to self-report derogatory information to the organization security manager can result in conduct by the individual that will require them being removed from that position
...
DOD 5200.2-R, Personnel Security Program, Chapter 9, paragraph C9.1.4 - Individual Responsibility (rescinded but provided for purpose of historical reference).'
...
TACTICAL ENVIRONMENT: The check is applicable for fixed (established) tactical processing environments AND is applicable to a field/mobile environment."
  desc 'fix', "Ensure that Individuals are familiar with pertinent personnel security regulations, such as DOD Manual 5200.02 and are aware of standards of conduct required of persons holding positions of trust, including (and especially) the requirement to report derogatory information to their local security manager.
...
2. Conducting a general survey of multiple employees to ascertain their familiarity with personal responsibilities while holding a security clearance."
  ...
  tag check_id: 'C-49283r917261_chk'
  tag severity: 'low'
  tag gid: 'V-245852'
  tag rid: 'SV-245852r917359_rule'
  tag stig_id: 'PE-01.03.01'
  tag gtitle: 'PE-01.03.01'
  tag fix_id: 'F-49238r917262_fix'
  tag 'documentable'
  tag legacy: ['V-32336', 'SV-42673r3_rule']
end
