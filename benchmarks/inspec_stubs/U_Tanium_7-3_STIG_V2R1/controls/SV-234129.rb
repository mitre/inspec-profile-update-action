...
If the organization cannot provide a server-tuning document from the vendor, this is a finding.'
  desc 'fix', "Obtain the vendor tuning documentation for the deployment.

Include it in the system's documentation as proof of tuning."
  impact 0.5
  ref 'DPMS Target Tanium 7.3'
  tag check_id: 'C-37314r610887_chk'
  tag severity: 'medium'
  tag gid: 'V-234129'
  tag rid: 'SV-234129r612749_rule'
  tag stig_id: 'TANS-SV-000069'
  tag gtitle: 'SRG-APP-000435'
  tag fix_id: 'F-37279r610888_fix'
  tag 'documentable'
  tag legacy: ['SV-102331', 'V-92229']
  tag cci: ['CCI-002385']
  tag nist: ['SC-5 a']
end
