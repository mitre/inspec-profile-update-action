control 'SV-234045' do
  title 'The Tanium application must restrict the ability of individuals to place too much impact upon the network, which might result in a Denial of Service (DoS) event on the network by using RandomSensorDelayInSeconds.'
...
Document the value for later use.'
  ...
  tag check_id: 'C-37230r610635_chk'
  tag severity: 'medium'
  tag gid: 'V-234045'
  tag rid: 'SV-234045r612749_rule'
  tag stig_id: 'TANS-CL-000013'
  tag gtitle: 'SRG-APP-000246'
  tag fix_id: 'F-37195r610636_fix'
  tag 'documentable'
  tag legacy: ['SV-102163', 'V-92061']
  tag cci: ['CCI-001094']
  tag nist: ['SC-5 (1)']
end
