control 'SV-239943' do
  title 'The Cisco ASA must be configured to send log data to at least two central log servers for the purpose of forwarding alerts to organization-defined personnel and/or the firewall administrator.'
  ...
  desc 'check', 'Verify the ASA is configured to send logs to at least two syslog servers. The configuration should look similar to the example below.
...
If the ASA is not configured to send log data to at least two syslog servers, this is a finding.'
  desc 'fix', 'Configure the ASA to send log messages to the syslog servers as shown in the example below.
...
ASA(config)# end'
  ...
  tag check_id: 'C-43176r916031_chk'
  tag severity: 'high'
  tag gid: 'V-239943'
  tag rid: 'SV-239943r916114_rule'
  tag stig_id: 'CASA-ND-001410'
  tag gtitle: 'SRG-APP-000516-NDM-000350'
  tag fix_id: 'F-43135r916032_fix'
  tag 'documentable'
  tag cci: ['CCI-001851']
  tag nist: ['AU-4 (1)']
end
