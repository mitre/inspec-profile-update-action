...
If the deployment requires the use of micro SD cards, KPE can be used to allow its usage in a STIG-approved configuration. In this case, do not configure this policy, and instead replace with KPE policy (innately by the management tool or via KSP) "Enforce external storage encryption" with value "enable".'
  impact 0.7
  ref 'DPMS Target Samsung Android OS 13 with Knox 3.x COBO'
  tag check_id: 'C-58732r867292_chk'
  tag severity: 'high'
  tag gid: 'V-255119'
  tag rid: 'SV-255119r867294_rule'
  tag stig_id: 'KNOX-13-110130'
  tag gtitle: 'PP-MDF-323100'
  tag fix_id: 'F-58676r867293_fix'
  tag 'documentable'
