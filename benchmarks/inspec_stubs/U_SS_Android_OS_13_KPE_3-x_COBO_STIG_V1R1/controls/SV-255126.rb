...
SFR ID: FMT_SMF_EXT.1.1 #8b'
  desc 'check', 'Verify requirement KNOX-13-110190 (managed Google Play) has been implemented.
...
Implement "managed Google Play" (see requirement KNOX-13-110190).'
  impact 0.5
  ref 'DPMS Target Samsung Android OS 13 with Knox 3.x COBO'
  tag check_id: 'C-58739r867313_chk'
  tag severity: 'medium'
  tag gid: 'V-255126'
  tag rid: 'SV-255126r867315_rule'
  tag stig_id: 'KNOX-13-110200'
  tag gtitle: 'PP-MDF-323070'
  tag fix_id: 'F-58683r867314_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
