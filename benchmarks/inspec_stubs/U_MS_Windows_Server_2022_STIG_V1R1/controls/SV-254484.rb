control 'SV-254484' do
  ...
  desc 'UAC is a security mechanism for limiting the elevation of privileges, including administrative accounts, unless authorized. This setting configures the elevation requirements for logged-on administrators to complete a task that requires raised privileges.'
  desc 'check', 'UAC requirements are NA for Server Core installations (this is default installation option for Windows Server 2022 versus Server with Desktop Experience).
...
The more secure option for this setting, "Prompt for credentials on the secure desktop", would also be acceptable.'
  ...
  tag check_id: 'C-57969r849266_chk'
  tag severity: 'medium'
  tag gid: 'V-254484'
  tag rid: 'SV-254484r849268_rule'
  tag stig_id: 'WN22-SO-000400'
  tag gtitle: 'SRG-OS-000134-GPOS-00068'
  tag fix_id: 'F-57920r849267_fix'
  tag 'documentable'
  tag cci: ['CCI-001084']
  tag nist: ['SC-3']
end
