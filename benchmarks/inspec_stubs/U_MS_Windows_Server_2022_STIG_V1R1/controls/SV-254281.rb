control 'SV-254281' do
  title 'The Windows Server 2022 time service must synchronize with an appropriate DoD time source.'
...
The US Naval Observatory operates stratum 1 time servers, identified at https://www.usno.navy.mil/USNO/time/ntp/dod-customers. Time synchronization will occur through a hierarchy of time servers down to the local level. Clients and lower-level servers will synchronize with an authorized time server in the hierarchy.'
  ...
  tag check_id: 'C-57766r848657_chk'
  tag severity: 'low'
  tag gid: 'V-254281'
  tag rid: 'SV-254281r848659_rule'
  tag stig_id: 'WN22-00-000440'
  tag gtitle: 'SRG-OS-000355-GPOS-00143'
  tag fix_id: 'F-57717r848658_fix'
  tag 'documentable'
  tag cci: ['CCI-001891']
  tag nist: ['AU-8 (1) (a)']
end
