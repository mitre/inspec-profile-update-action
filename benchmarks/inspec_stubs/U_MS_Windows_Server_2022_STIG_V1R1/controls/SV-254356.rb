control 'SV-254356' do
  title 'Windows Server 2022 Telemetry must be configured to Security or Basic.'
...
Value: 0x00000000 (0) (Security), 0x00000001 (1) (Basic)'
  desc 'fix', 'Configure the policy value for Computer Configuration >> Administrative Templates >> Windows Components >> Data Collection and Preview Build >> Allow Telemetry to "Enabled" with "0 - Security [Enterprise Only]" or "1 - Basic" selected in "Options".'
  impact 0.5
  ref 'DPMS Target Microsoft Windows Server 2022'
  tag check_id: 'C-57841r848882_chk'
  tag severity: 'medium'
  tag gid: 'V-254356'
  tag rid: 'SV-254356r848884_rule'
  tag stig_id: 'WN22-CC-000250'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-57792r848883_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
