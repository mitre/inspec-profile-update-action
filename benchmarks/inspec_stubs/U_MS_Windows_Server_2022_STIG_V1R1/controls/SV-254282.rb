control 'SV-254282' do
  title 'Windows Server 2022 must have orphaned security identifiers (SIDs) removed from user rights.'
  desc 'Accounts or groups given rights on a system may show up as unresolved SIDs for various reasons including deletion of the accounts or groups. If the account or group objects are reanimated, there is a potential they may still have rights no longer intended. Valid domain accounts or groups may also show up as unresolved SIDs if a connection to the domain cannot be established.'
...
S-1-5-80-3139157870-2983391045-3678747466-658725712-1809340420 - NT Service\\WdiServiceHost'
  ...
  tag check_id: 'C-57767r848660_chk'
  tag severity: 'medium'
  tag gid: 'V-254282'
  tag rid: 'SV-254282r848662_rule'
  tag stig_id: 'WN22-00-000450'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-57718r848661_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
