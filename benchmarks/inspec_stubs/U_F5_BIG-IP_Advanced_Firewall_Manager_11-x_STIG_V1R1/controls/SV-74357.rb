...
This requirement applies to gateways and firewalls that perform content inspection or have higher layer proxy functions.'
  desc 'check', 'Verify the BIG-IP AFM module is configured to handle invalid input in a predictable and documented manner that reflects organizational and system objectives.
...
If the BIG-IP AFM module is not configured to handle invalid inputs in a predictable and documented manner that reflects organizational and system objectives, this is a finding.'
  desc 'fix', 'Configure the BIG-IP AFM module to handle invalid inputs in a predictable and documented manner that reflects organizational and system objectives.'
  impact 0.5
  ref 'DPMS Target F5 BIG-IP AFM 11.x'
  tag check_id: 'C-60617r2_chk'
  tag severity: 'medium'
  tag gid: 'V-59927'
  tag rid: 'SV-74357r1_rule'
  tag stig_id: 'F5BI-AF-000229'
  tag gtitle: 'SRG-NET-000380-ALG-000128'
  tag fix_id: 'F-65337r1_fix'
  tag 'documentable'
  tag cci: ['CCI-002754']
  tag nist: ['SI-10 (3)']
end
