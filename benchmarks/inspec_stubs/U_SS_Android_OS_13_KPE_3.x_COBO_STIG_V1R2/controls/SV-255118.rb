...
The user training requirement is satisfied in requirement KNOX-13-110300.'
  impact 0.3
  ref 'DPMS Target Samsung Android OS 13 with Knox 3.x COBO'
  tag check_id: 'C-58731r867289_chk'
  tag severity: 'low'
  tag gid: 'V-255118'
  tag rid: 'SV-255118r867291_rule'
  tag stig_id: 'KNOX-13-110120'
  tag gtitle: 'PP-MDF-323320'
  tag fix_id: 'F-58675r867290_fix'
  tag 'documentable'
