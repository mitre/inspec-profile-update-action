...
3. Wireless policy must be included in initial briefings for new employees and reinforced periodically such as during annual security refresher training.'
  ...
  tag check_id: 'C-49218r770021_chk'
  tag severity: 'low'
  tag gid: 'V-245787'
  tag rid: 'SV-245787r770023_rule'
  tag stig_id: 'IA-11.03.01'
  tag gtitle: 'IA-11.03.01'
  tag fix_id: 'F-49173r770022_fix'
  tag 'documentable'
  tag legacy: ['V-31129', 'SV-41280r3_rule']
end
