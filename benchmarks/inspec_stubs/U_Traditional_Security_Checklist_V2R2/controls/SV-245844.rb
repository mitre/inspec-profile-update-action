...
Assistant Secretary of Defense for Command, Control, Communications and Intelligence Memorandum: "Disposition of Unclassified DoD Hard Drives, 4 June 2001."

44 USC Chapter 33 - Disposal of Records, dated 01/03/2012

CJCSI 6510.01F, INFORMATION ASSURANCE (IA) AND SUPPORT TO COMPUTER NETWORK DEFENSE (CND), Enclosure C, paragraphs 21.h.(9); 28.a.&c.

NIST Special Publication 800-53 (SP 800-53), Rev 4, Controls: MP-6 and SI-12.

DoDI 8500.01, SUBJECT: Cybersecurity, March 14, 2014, paragraph 3.h.

DoD Manual 5200.01, Volume 3, SUBJECT: DoD Information Security Program: Protection of Classified Information: Enclosure 3 paragraphs 17, 18, & 19; Enclosure 7, paragraph 6.

DoD Manual 5200.01, Volume 4, SUBJECT: DoD Information Security Program: Controlled Unclassified Information (CUI); Enclosure 3, paragraphs 2.e.(5), 4.e.(4), 6.b.(4)(d) and Enclosure 4, paragraph 9.e.(2).

DoD 5200.22-M (NISPOM), Incorporating Change 2, 18 May 2016, 4-103.c., 5-203.b., and Chapter 5, Section 7 Disposition and Retention
...
'
  desc 'check', 'Check to ensure compliance with appropriate methods for disposal of the following:  
...
a. Check recycle bins, regular trash, and the availability of shredders or collection containers for sensitive material.  Ensure the organization knows who gets the recycling (especially if it contains CUI) and that it is disposed of properly (for instance by shredding).  NOTE:  If you find (e.g., in the trash) and can easily reconstruct any document marked FOUO (or other CUI document) and it contains extremely sensitive information such as PII (with SSN, etc.), this should be made a finding.  
...
TACTICAL ENVIRONMENT: The check is applicable for fixed (established) tactical processing environments where training and associated documentation should be in place.  Not applicable to a field/mobile environment.'
  desc 'fix', 'Ensure compliance with appropriate methods for disposal of the following:  
...
b. While not required it is highly recommended using at least a cross cut shredder for destruction of CUI documents.  Further, while a shred-all policy is also not required, this is another strong recommendation.'
  ...
  tag check_id: 'C-49275r822909_chk'
  tag severity: 'medium'
  tag gid: 'V-245844'
  tag rid: 'SV-245844r822911_rule'
  tag stig_id: 'IS-16.02.02'
  tag gtitle: 'IS-16.02.02'
  tag fix_id: 'F-49230r822910_fix'
  tag satisfies: ['Controlled Unclassified Information - Document', 'Hard Drive and Media Disposal']
  tag 'documentable'
  tag legacy: ['SV-42497r3_rule', 'V-32180']
end
