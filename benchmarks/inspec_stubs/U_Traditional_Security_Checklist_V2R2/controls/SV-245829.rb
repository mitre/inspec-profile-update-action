...
DoD 5220.22-M (NISPOM), Incorporating Change 2, 18 May 2016, Chapter 8, Section 3, paragraphs 8-302.b.(1), 8-302.e., 8-302.g.(2), Chapter 10, Section 5 and definition of "Escort" on page C-3.'
...
7.  If a foreign national is permitted to view a US Only screen, U.S. personnel must first ensure:
  ...
  tag check_id: 'C-49260r822886_chk'
  tag severity: 'high'
  tag gid: 'V-245829'
  tag rid: 'SV-245829r822888_rule'
  tag stig_id: 'IS-08.01.01'
  tag gtitle: 'IS-08.01.01'
  tag fix_id: 'F-49215r822887_fix'
  tag 'documentable'
