...
4. Likewise, walls below raised floor (computer room) space may be connected to the true floor with steel mesh or 18-gauge expanded steel screen.'
  ...
  tag check_id: 'C-49228r770051_chk'
  tag severity: 'high'
  tag gid: 'V-245797'
  tag rid: 'SV-245797r822847_rule'
  tag stig_id: 'IS-02.01.03'
  tag gtitle: 'IS-02.01.03'
  tag fix_id: 'F-49183r770052_fix'
  tag 'documentable'
  tag legacy: ['SV-41537r3_rule', 'V-31270']
end
