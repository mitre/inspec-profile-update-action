...
DoD 5220.22-M (NISPOM), Incorporating Change 2, 18 May 2016 Chapter 5, Section 4, paragraphs 5-402.c., 5-403 and Section 9 
...
9. The PDS must not be located within an Uncontrolled Access Area (UAA) and National Manager (NSA) approved encryption solutions must be employed.'
  ...
  tag check_id: 'C-49166r769865_chk'
  tag severity: 'high'
  tag gid: 'V-245735'
  tag rid: 'SV-245735r822802_rule'
  tag stig_id: 'CS-04.01.08'
  tag gtitle: 'CS-04.01.08'
  tag fix_id: 'F-49121r769866_fix'
  tag 'documentable'
  tag legacy: ['V-33456', 'SV-43876r3_rule']
end
