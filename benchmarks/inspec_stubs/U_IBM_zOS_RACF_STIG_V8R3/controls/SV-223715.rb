...
Note: The site should be able to determine the system consoles. However, it is imperative that the site adhere to the "DEFAULT" statement requirement.'
  ...
  tag check_id: 'C-25388r514833_chk'
  tag severity: 'medium'
  tag gid: 'V-223715'
  tag rid: 'SV-223715r604139_rule'
  tag stig_id: 'RACF-ES-000680'
  tag gtitle: 'SRG-OS-000096-GPOS-00050'
  tag fix_id: 'F-25376r514834_fix'
  tag 'documentable'
  tag legacy: ['SV-107241', 'V-98137']
  tag cci: ['CCI-000382']
  tag nist: ['CM-7 b']
end
