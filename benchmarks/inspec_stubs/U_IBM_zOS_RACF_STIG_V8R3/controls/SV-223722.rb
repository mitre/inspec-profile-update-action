control 'SV-223722' do
  title 'IBM RACF user accounts must uniquely identify system users.'
...
If there are shared userids on this domain, this is a finding.'
  ...
  tag check_id: 'C-25395r514854_chk'
  tag severity: 'medium'
  tag gid: 'V-223722'
  tag rid: 'SV-223722r604139_rule'
  tag stig_id: 'RACF-ES-000750'
  tag gtitle: 'SRG-OS-000104-GPOS-00051'
  tag fix_id: 'F-25383r514855_fix'
  tag satisfies: ['SRG-OS-000104-GPOS-00051', 'SRG-OS-000109-GPOS-00056', 'SRG-OS-000125-GPOS-00065', 'SRG-OS-000121-GPOS-00062']
  tag 'documentable'
  tag legacy: ['V-98151', 'SV-107255']
  tag cci: ['CCI-000764', 'CCI-000770', 'CCI-000804', 'CCI-000877']
  tag nist: ['IA-2', 'IA-2 (5)', 'IA-8', 'MA-4 c']
end
