control 'SV-223809' do
  title 'The SSH daemon must be configured with the Standard Mandatory DoD Notice and Consent Banner.'
...
-Notwithstanding the above, using this IS does not constitute consent to PM, LE or CI investigative searching or monitoring of the content of privileged communications, or work product, related to personal representation or services by attorneys, psychotherapists, or clergy, and their assistants. Such communications and work product are private and confidential. See User Agreement for details.'
  ...
  tag check_id: 'C-25482r515115_chk'
  tag severity: 'medium'
  tag gid: 'V-223809'
  tag rid: 'SV-223809r604139_rule'
  tag stig_id: 'RACF-SH-000040'
  tag gtitle: 'SRG-OS-000228-GPOS-00088'
  tag fix_id: 'F-25470r515116_fix'
  tag 'documentable'
  tag legacy: ['SV-107429', 'V-98325']
  tag cci: ['CCI-001387', 'CCI-001388', 'CCI-001385', 'CCI-001386', 'CCI-001384']
  tag nist: ['AC-8 c 2', 'AC-8 c 3', 'AC-8 c 2', 'AC-8 c 2', 'AC-8 c 1']
end
