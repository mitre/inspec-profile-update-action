...
If the ESM data set rules for libraries specify that all (i.e., failures and successes) WRITE or greater access will be logged, this is not a finding.'
  desc 'fix', 'Configure WRITE or greater access to libraries residing in the /etc/steplib to be limited to system programmers only.'
  impact 0.5
  ref 'DPMS Target IBM zOS RACF'
  tag check_id: 'C-25522r515235_chk'
  tag severity: 'medium'
  tag gid: 'V-223849'
  tag rid: 'SV-223849r604139_rule'
  tag stig_id: 'RACF-US-000120'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25510r515236_fix'
  tag satisfies: ['SRG-OS-000080-GPOS-00048', 'SRG-OS-000259-GPOS-00100', 'SRG-OS-000324-GPOS-00125']
  tag 'documentable'
  tag legacy: ['V-98405', 'SV-107509']
