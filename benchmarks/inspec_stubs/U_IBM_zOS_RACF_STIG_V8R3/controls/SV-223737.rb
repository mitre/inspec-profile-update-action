...
If the BANNER statement is coded, this is not a finding.'
  ...
  tag check_id: 'C-25410r514899_chk'
  tag severity: 'medium'
  tag gid: 'V-223737'
  tag rid: 'SV-223737r604139_rule'
  tag stig_id: 'RACF-FT-000050'
  tag gtitle: 'SRG-OS-000228-GPOS-00088'
  tag fix_id: 'F-25398r514900_fix'
  tag 'documentable'
  tag legacy: ['SV-107285', 'V-98181']
  tag cci: ['CCI-001385', 'CCI-001384', 'CCI-001386', 'CCI-001387', 'CCI-001388']
  tag nist: ['AC-8 c 2', 'AC-8 c 1', 'AC-8 c 2', 'AC-8 c 2', 'AC-8 c 3']
end
