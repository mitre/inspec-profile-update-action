...
/var 1775 fff Dynamic data used internally by products and by elements and features of z/OS UNIX.'
  ...
  tag check_id: 'C-25516r515217_chk'
  tag severity: 'medium'
  tag gid: 'V-223843'
  tag rid: 'SV-223843r604139_rule'
  tag stig_id: 'RACF-US-000060'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25504r515218_fix'
  tag 'documentable'
  tag legacy: ['V-98393', 'SV-107497']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
