...
If ESM dataset rules for libraries in the TEXXLIB concatenation restrict GLOBAL read access, this is not a finding.

If ESM data set rules for libraries in the REXLIB concatenating restrict WRITE or Greater access to z/OS system Programmers, this is not a finding.
...
Configure ESM dataset rules to log UPDATE and/or ALTER access (i.e., successes and failures).'
  ...
  tag check_id: 'C-25350r514720_chk'
  tag severity: 'high'
  tag gid: 'V-223677'
  tag rid: 'SV-223677r604139_rule'
  tag stig_id: 'RACF-ES-000290'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25338r514721_fix'
