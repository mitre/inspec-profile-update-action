...
ISRDDN APF'
  desc 'fix', 'Review the entire list of APF authorized libraries and remove those which are no longer valid designations.'
  impact 0.5
  ref 'DPMS Target IBM zOS RACF'
  tag check_id: 'C-25457r515040_chk'
  tag severity: 'medium'
  tag gid: 'V-223784'
  tag rid: 'SV-223784r604139_rule'
  tag stig_id: 'RACF-OS-000280'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-25445r515041_fix'
  tag 'documentable'
  tag legacy: ['V-98275', 'SV-107379']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
