...
If there is no procedure, this is a finding.'
  ...
  tag check_id: 'C-25471r515082_chk'
  tag severity: 'medium'
  tag gid: 'V-223798'
  tag rid: 'SV-223798r604139_rule'
  tag stig_id: 'RACF-OS-000440'
  tag gtitle: 'SRG-OS-000002-GPOS-00002'
  tag fix_id: 'F-25459r515083_fix'
  tag 'documentable'
  tag legacy: ['SV-107407', 'V-98303']
  tag cci: ['CCI-000016']
  tag nist: ['AC-2 (2)']
end
