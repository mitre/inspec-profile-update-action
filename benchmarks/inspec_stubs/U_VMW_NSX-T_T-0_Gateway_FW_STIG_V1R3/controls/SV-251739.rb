...
From the NSX-T Manager web interface, go to Security >> General Settings >> Firewall >> Flood Protection to view Flood Protection profiles.
...
From the NSX-T Manager web interface, go to Security >> General Settings >> Firewall >> Flood Protection >> Add Profile >> Add Edge Gateway Profile.
...
Configure the "Applied To" field to contain Tier-0 Gateways, and then click "Save".'
  ...
  tag check_id: 'C-55176r919226_chk'
  tag severity: 'medium'
  tag gid: 'V-251739'
  tag rid: 'SV-251739r919228_rule'
  tag stig_id: 'T0FW-3X-000019'
  tag gtitle: 'SRG-NET-000192-FW-000029'
  tag fix_id: 'F-55130r919227_fix'
