control 'SV-217208' do
  title 'The SUSE operating system must generate audit records for all account creations, modifications, disabling, and termination events that affect /etc/opasswd.'
...
'
  desc 'check', 'Verify the SUSE operating system generates an audit record when modifications occur to the "/etc/security/opasswd" file.
...
If the command does not return a line, or the line is commented out, this is a finding.'
  desc 'fix', 'Configure the SUSE operating system to generate an audit record when all modifications to the "/etc/security/opasswd" file occur.
...
# sudo systemctl restart auditd.service'
  ...
  tag check_id: 'C-18436r369780_chk'
  tag severity: 'medium'
  tag gid: 'V-217208'
  tag rid: 'SV-217208r603262_rule'
  tag stig_id: 'SLES-12-020230'
  tag gtitle: 'SRG-OS-000004-GPOS-00004'
  tag fix_id: 'F-18434r369781_fix'
  ...
  tag 'documentable'
  tag legacy: ['SV-92017', 'V-77321']
  tag cci: ['CCI-000018', 'CCI-001403', 'CCI-000172', 'CCI-002132', 'CCI-002130']
  tag nist: ['AC-2 (4)', 'AC-2 (4)', 'AU-12 c', 'AC-2 (4)', 'AC-2 (4)']
end
