...
'
  desc 'check', 'Verify the SUSE operating system generates an audit record for all uses of the "newgrp" command.
...
If the command does not return any output or the returned line is commented out, this is a finding.'
  desc 'fix', 'Configure the SUSE operating system to generate an audit record for all uses the "newgrp" command.
...
# sudo systemctl restart auditd.service'
  ...
  tag check_id: 'C-18466r622379_chk'
  tag severity: 'low'
  tag gid: 'V-217238'
  tag rid: 'SV-217238r603917_rule'
  tag stig_id: 'SLES-12-020570'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-18464r622380_fix'
