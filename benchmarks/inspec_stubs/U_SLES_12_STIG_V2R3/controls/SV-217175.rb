...
# chmod 0740 /home/smithj/.<INIT_FILE>'
  ...
  tag check_id: 'C-18403r369681_chk'
  tag severity: 'medium'
  tag gid: 'V-217175'
  tag rid: 'SV-217175r603262_rule'
  tag stig_id: 'SLES-12-010760'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-18401r369682_fix'
  tag 'documentable'
  tag legacy: ['SV-91911', 'V-77215']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
