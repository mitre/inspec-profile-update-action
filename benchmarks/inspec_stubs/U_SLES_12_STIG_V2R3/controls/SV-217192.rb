control 'SV-217192' do
  title 'The SUSE operating system must allocate audit record storage capacity to store at least one weeks worth of audit records when audit records are not immediately sent to a central audit record storage facility.'
...
The task of allocating audit record storage capacity is usually performed during initial installation of the SUSE operating system.'
  desc 'check', "Verify the SUSE operating system allocates audit record storage capacity to store at least one week's worth of audit records when audit records are not immediately sent to a central audit record storage facility.
...
If the audit record partition is not allocated sufficient storage capacity, this is a finding."
  desc 'fix', %q(Allocate enough storage capacity for at least one week's worth of SUSE operating system audit records when audit records are not immediately sent to a central audit record storage facility.
...
If audit records are not stored on a partition made specifically for audit records, a new partition with sufficient amount of space will need be to be created. The new partition can be created using the "YaST2 - Partitioner" program on the system.)
  ...
  tag check_id: 'C-18420r369732_chk'
  tag severity: 'medium'
  tag gid: 'V-217192'
  tag rid: 'SV-217192r603262_rule'
  tag stig_id: 'SLES-12-020020'
  tag gtitle: 'SRG-OS-000341-GPOS-00132'
  tag fix_id: 'F-18418r369733_fix'
  tag 'documentable'
  tag legacy: ['V-77291', 'SV-91987']
  tag cci: ['CCI-001849']
  tag nist: ['AU-4']
end
