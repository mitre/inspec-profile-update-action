...
Uncomment the "Compression" keyword in "/etc/ssh/sshd_config" on the system and set the value to "no":

Compression no'
  impact 0.5
  ref 'DPMS Target SUSE Linux Enterprise Server 12'
  tag check_id: 'C-18507r369993_chk'
  tag severity: 'medium'
  tag gid: 'V-217279'
  tag rid: 'SV-217279r603262_rule'
  tag stig_id: 'SLES-12-030250'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-18505r369994_fix'
  tag 'documentable'
