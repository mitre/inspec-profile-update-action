...
'
  desc 'check', %q(Verify an audit record is generated for all uses of the "chage" command. Perform the verification by running the following command:
...
# sudo systemctl restart auditd.service'
  ...
  tag check_id: 'C-18478r622406_chk'
  tag severity: 'medium'
  tag gid: 'V-217250'
  tag rid: 'SV-217250r603944_rule'
  tag stig_id: 'SLES-12-020690'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-18476r622407_fix'
