control 'SV-217206' do
  title 'The SUSE operating system must generate audit records for all account creations, modifications, disabling, and termination events that affect /etc/group.'
...
'
  desc 'check', 'Verify the SUSE operating system generates an audit record when modifications occur to the "/etc/group" file.
...
If the command does not return a line, or the line is commented out, this is a finding.'
  desc 'fix', 'Configure the SUSE operating system to generate an audit record when all modifications to the "/etc/group" file occur.
...
# sudo systemctl restart auditd.service'
  ...
  tag check_id: 'C-18434r369774_chk'
  tag severity: 'medium'
  tag gid: 'V-217206'
  tag rid: 'SV-217206r603262_rule'
  tag stig_id: 'SLES-12-020210'
  tag gtitle: 'SRG-OS-000004-GPOS-00004'
  tag fix_id: 'F-18432r369775_fix'
