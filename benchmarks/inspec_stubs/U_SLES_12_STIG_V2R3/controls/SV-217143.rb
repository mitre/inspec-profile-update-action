...
http://csrc.nist.gov/groups/STM/cmvp/documents/140-1/140sp/140sp2435.pdf'
  ...
  tag check_id: 'C-18371r369585_chk'
  tag severity: 'medium'
  tag gid: 'V-217143'
  tag rid: 'SV-217143r603262_rule'
  tag stig_id: 'SLES-12-010420'
  tag gtitle: 'SRG-OS-000478-GPOS-00223'
  tag fix_id: 'F-18369r369586_fix'
  tag satisfies: ['SRG-OS-000396-GPOS-00176', 'SRG-OS-000478-GPOS-00223']
  tag 'documentable'
  tag legacy: ['SV-91837', 'V-77141']
  tag cci: ['CCI-002450']
  tag nist: ['SC-13 b']
end
