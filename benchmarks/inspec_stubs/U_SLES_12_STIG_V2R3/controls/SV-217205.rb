...
'
  desc 'check', 'Verify the SUSE operating system generates an audit record when all modifications occur to the "/etc/passwd" file.
...
# sudo systemctl restart auditd.service'
  ...
  tag check_id: 'C-18433r369771_chk'
  tag severity: 'medium'
  tag gid: 'V-217205'
  tag rid: 'SV-217205r603262_rule'
  tag stig_id: 'SLES-12-020200'
  tag gtitle: 'SRG-OS-000004-GPOS-00004'
  tag fix_id: 'F-18431r369772_fix'
  tag satisfies: ['SRG-OS-000004-GPOS-00004', 'SRG-OS-000239-GPOS-00089', 'SRG-OS-000240-GPOS-00090', 'SRG-OS-000241-GPOS-00091', 'SRG-OS-000303-GPOS-00120', 'SRG-OS-000304-GPOS-00121', 'SRG-OS-000470-GPOS-00214', 'SRG-OS-000476-GPOS-00221']
  tag 'documentable'
  tag legacy: ['V-77315', 'SV-92011']
  tag cci: ['CCI-001403', 'CCI-000018', 'CCI-000172', 'CCI-002130', 'CCI-002132']
