control 'SV-257285' do
  title 'The version of VAMI-lighttpd running on the system must be a supported version.'
...
The application will be configured to check for and install security-relevant software updates within an identified time period from the availability of the update. The specific time period will be defined by an authoritative source (e.g., IAVM, CTOs, DTMs, and STIGs).'
  desc 'check', 'VAMI-lighttpd 6.7 is no longer supported by the vendor. If the system is running VAMI-lighttpd 6.7, this is a finding.'
  desc 'fix', 'Upgrade to a supported version.'
  impact 0.7
  ref 'DPMS Target VMware vSphere 6.7 VAMI-lighttpd'
  tag check_id: 'C-60970r918895_chk'
  tag severity: 'high'
  tag gid: 'V-257285'
  tag rid: 'SV-257285r919286_rule'
  tag stig_id: 'VCLD-67-000999'
