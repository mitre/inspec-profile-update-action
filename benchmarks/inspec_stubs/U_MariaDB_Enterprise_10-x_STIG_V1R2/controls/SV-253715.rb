control 'SV-253715' do
  title 'MariaDB and associated applications must reserve the use of dynamic code execution for situations that require it.'
...
If dynamic code execution is employed in circumstances where the objective could practically be satisfied by static execution with strongly typed parameters, this is a finding.'
  ...
  tag check_id: 'C-57167r841668_chk'
  tag severity: 'medium'
  tag gid: 'V-253715'
  tag rid: 'SV-253715r841670_rule'
  tag stig_id: 'MADB-10-005800'
  tag gtitle: 'SRG-APP-000251-DB-000391'
  tag fix_id: 'F-57118r841669_fix'
  tag 'documentable'
  tag cci: ['CCI-001310']
  tag nist: ['SI-10']
end
