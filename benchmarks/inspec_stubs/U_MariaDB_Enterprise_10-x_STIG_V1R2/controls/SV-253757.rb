control 'SV-253757' do
  title 'MariaDB must generate audit records when unsuccessful attempts to modify categories of information (e.g., classification levels/security levels) occur.'
...
MariaDB> INSERT INTO mysql.server_audit_filters (filtername, rule)
  ...
  tag check_id: 'C-57209r841794_chk'
  tag severity: 'medium'
  tag gid: 'V-253757'
  tag rid: 'SV-253757r841796_rule'
  tag stig_id: 'MADB-10-010500'
  tag gtitle: 'SRG-APP-000498-DB-000347'
  tag fix_id: 'F-57160r841795_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
