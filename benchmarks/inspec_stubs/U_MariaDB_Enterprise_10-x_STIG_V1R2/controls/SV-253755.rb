control 'SV-253755' do
  title 'MariaDB must generate audit records when unsuccessful attempts to modify security objects occur.'
...
MariaDB> INSERT INTO mysql.server_audit_filters (filtername, rule)
  ...
  tag check_id: 'C-57207r841788_chk'
  tag severity: 'medium'
  tag gid: 'V-253755'
  tag rid: 'SV-253755r841790_rule'
  tag stig_id: 'MADB-10-010300'
  tag gtitle: 'SRG-APP-000496-DB-000335'
  tag fix_id: 'F-57158r841789_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
