control 'SV-253750' do
  title 'MariaDB must generate audit records when privileges/permissions are added.'
...
MariaDB> INSERT INTO mysql.server_audit_filters (filtername, rule)
  ...
  tag check_id: 'C-57202r841773_chk'
  tag severity: 'medium'
  tag gid: 'V-253750'
  tag rid: 'SV-253750r841775_rule'
  tag stig_id: 'MADB-10-009800'
  tag gtitle: 'SRG-APP-000495-DB-000326'
  tag fix_id: 'F-57153r841774_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
