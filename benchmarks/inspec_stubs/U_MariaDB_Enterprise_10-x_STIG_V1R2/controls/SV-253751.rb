control 'SV-253751' do
  title 'MariaDB must generate audit records when unsuccessful attempts to add privileges/permissions occur.'
...
MariaDB> INSERT INTO mysql.server_audit_filters (filtername, rule)
  ...
  tag check_id: 'C-57203r841776_chk'
  tag severity: 'medium'
  tag gid: 'V-253751'
  tag rid: 'SV-253751r841778_rule'
  tag stig_id: 'MADB-10-009900'
  tag gtitle: 'SRG-APP-000495-DB-000327'
  tag fix_id: 'F-57154r841777_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
