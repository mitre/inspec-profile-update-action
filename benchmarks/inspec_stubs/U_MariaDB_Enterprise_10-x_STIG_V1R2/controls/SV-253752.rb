control 'SV-253752' do
  title 'MariaDB must generate audit records when privileges/permissions are modified.'
...
MariaDB> INSERT INTO mysql.server_audit_filters (filtername, rule)
  ...
  tag check_id: 'C-57204r841779_chk'
  tag severity: 'medium'
  tag gid: 'V-253752'
  tag rid: 'SV-253752r841781_rule'
  tag stig_id: 'MADB-10-010000'
  tag gtitle: 'SRG-APP-000495-DB-000328'
  tag fix_id: 'F-57155r841780_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
