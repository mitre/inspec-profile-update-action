control 'SV-253771' do
  title 'MariaDB must generate audit records when unsuccessful accesses to objects occur.'
...
MariaDB> INSERT INTO mysql.server_audit_filters (filtername, rule)
  ...
  tag check_id: 'C-57223r841836_chk'
  tag severity: 'medium'
  tag gid: 'V-253771'
  tag rid: 'SV-253771r841838_rule'
  tag stig_id: 'MADB-10-011900'
  tag gtitle: 'SRG-APP-000507-DB-000357'
  tag fix_id: 'F-57174r841837_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
