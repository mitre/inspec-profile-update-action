control 'SV-253749' do
  title 'MariaDB must generate audit records when unsuccessful attempts to access categories of information (e.g., classification levels/security levels) occur.'
...
MariaDB> INSERT INTO mysql.server_audit_filters (filtername, rule)
  ...
  tag check_id: 'C-57201r841770_chk'
  tag severity: 'medium'
  tag gid: 'V-253749'
  tag rid: 'SV-253749r841772_rule'
  tag stig_id: 'MADB-10-009700'
  tag gtitle: 'SRG-APP-000494-DB-000345'
  tag fix_id: 'F-57152r841771_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
