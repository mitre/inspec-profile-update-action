control 'SV-253723' do
  title 'MariaDB must prevent nonprivileged users from executing privileged functions, to include disabling, circumventing, or altering implemented security safeguards/countermeasures.'
...
Depending on the capabilities of the DBMS and the design of the database and associated applications, the prevention of unauthorized use of privileged functions may be achieved by means of DBMS security features, database triggers, other mechanisms, or a combination of these.'
  desc 'check', 'Review the system documentation to obtain the definition of the database/MariaDB functionality considered privileged in the context of the system in question.
...
If the configuration does not protect all of the actions defined as privileged, this is a finding.'
  desc 'fix', 'Configure MariaDB security to protect all privileged functionality.'
  impact 0.5
  ref 'DPMS Target MariaDB Enterprise 10.x'
  tag check_id: 'C-57175r841692_chk'
  tag severity: 'medium'
  tag gid: 'V-253723'
  tag rid: 'SV-253723r841694_rule'
  tag stig_id: 'MADB-10-006800'
  tag gtitle: 'SRG-APP-000340-DB-000304'
  tag fix_id: 'F-57126r841693_fix'
  tag 'documentable'
  tag cci: ['CCI-002235']
  tag nist: ['AC-6 (10)']
end
