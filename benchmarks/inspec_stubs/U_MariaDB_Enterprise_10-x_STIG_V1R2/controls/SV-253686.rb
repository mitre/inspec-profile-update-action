control 'SV-253686' do
  title 'The MariaDB software installation account must be restricted to authorized users.'
...
DBA and other privileged administrative or application owner accounts are granted privileges that allow actions that can have a great impact on database security and operation. It is especially important to grant privileged access to only those persons who are qualified and authorized to use them.'
  desc 'check', 'Review procedures for controlling, granting access to, and tracking use of the MariaDB software installation account.
...
If access or use of this account is not restricted to the minimum number of personnel required or if unauthorized access to the account has been granted, this is a finding.'
  desc 'fix', 'Develop, document, and implement procedures to restrict and track use of the MariaDB software installation account.'
  impact 0.7
  ref 'DPMS Target MariaDB Enterprise 10.x'
  tag check_id: 'C-57138r841581_chk'
  tag severity: 'high'
  tag gid: 'V-253686'
  tag rid: 'SV-253686r841583_rule'
  tag stig_id: 'MADB-10-002700'
  tag gtitle: 'SRG-APP-000133-DB-000198'
  tag fix_id: 'F-57089r841582_fix'
  tag 'documentable'
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
end
