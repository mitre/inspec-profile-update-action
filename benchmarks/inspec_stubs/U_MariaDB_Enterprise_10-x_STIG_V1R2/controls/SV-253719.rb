control 'SV-253719' do
  title 'MariaDB must associate organization-defined types of security labels having organization-defined security label values with information in storage.'
...
If security labeling requirements have been specified, but the security labeling is not implemented or does not reliably maintain labels on information in storage, this is a finding.'
  ...
  tag check_id: 'C-57171r841680_chk'
  tag severity: 'medium'
  tag gid: 'V-253719'
  tag rid: 'SV-253719r841682_rule'
  tag stig_id: 'MADB-10-006400'
  tag gtitle: 'SRG-APP-000311-DB-000308'
  tag fix_id: 'F-57122r841681_fix'
  tag 'documentable'
  tag cci: ['CCI-002262']
  tag nist: ['AC-16 a']
end
