control 'SV-253774' do
  title 'MariaDB must implement NIST FIPS 140-2 validated cryptographic modules to generate and validate cryptographic hashes.'
...
Ubuntu: https://security-certs.docs.ubuntu.com/en/fips'
  ...
  tag check_id: 'C-57226r841845_chk'
  tag severity: 'medium'
  tag gid: 'V-253774'
  tag rid: 'SV-253774r841847_rule'
  tag stig_id: 'MADB-10-012200'
  tag gtitle: 'SRG-APP-000514-DB-000382'
  tag fix_id: 'F-57177r841846_fix'
  tag 'documentable'
  tag cci: ['CCI-002450']
  tag nist: ['SC-13 b']
end
