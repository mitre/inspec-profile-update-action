control 'SV-253759' do
  title 'MariaDB must generate audit records when unsuccessful attempts to delete privileges/permissions occur.'
...
MariaDB> INSERT INTO mysql.server_audit_filters (filtername, rule)
  ...
  tag check_id: 'C-57211r841800_chk'
  tag severity: 'medium'
  tag gid: 'V-253759'
  tag rid: 'SV-253759r841802_rule'
  tag stig_id: 'MADB-10-010700'
  tag gtitle: 'SRG-APP-000499-DB-000331'
  tag fix_id: 'F-57162r841801_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
