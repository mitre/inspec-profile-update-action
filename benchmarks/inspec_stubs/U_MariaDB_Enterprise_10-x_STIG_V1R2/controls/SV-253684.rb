control 'SV-253684' do
  title 'MariaDB must protect its audit features from unauthorized removal.'
...
If the MariaDB server is configured to use syslog for logging, consult the organization's syslog setting for permissions and ownership of logs with respect to who can modify them."
  ...
  tag check_id: 'C-57136r841575_chk'
  tag severity: 'medium'
  tag gid: 'V-253684'
  tag rid: 'SV-253684r841577_rule'
  tag stig_id: 'MADB-10-002500'
  tag gtitle: 'SRG-APP-000123-DB-000204'
  tag fix_id: 'F-57087r841576_fix'
  tag 'documentable'
  tag cci: ['CCI-001495']
  tag nist: ['AU-9']
end
