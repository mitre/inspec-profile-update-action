control 'SV-253775' do
  title 'MariaDB must implement NIST FIPS 140-2 validated cryptographic modules to protect unclassified information requiring confidentiality and cryptographic protection, in accordance with the data owners requirements.'
...
Ubuntu: https://security-certs.docs.ubuntu.com/en/fips'
  ...
  tag check_id: 'C-57227r841848_chk'
  tag severity: 'medium'
  tag gid: 'V-253775'
  tag rid: 'SV-253775r841850_rule'
  tag stig_id: 'MADB-10-012300'
  tag gtitle: 'SRG-APP-000514-DB-000383'
  tag fix_id: 'F-57178r841849_fix'
  tag 'documentable'
  tag cci: ['CCI-002450']
  tag nist: ['SC-13 b']
end
