control 'SV-252569' do
  title 'The IBM Aspera Console must be configured to prohibit or restrict the use of functions, ports, protocols, and/or services, as defined in the PPSM CAL and vulnerability assessments.'
...
The network ALG must be configured to prevent or restrict the use of prohibited ports, protocols, and services throughout the network by filtering the network traffic and disallowing or redirecting traffic as necessary. Default and updated policy filters from the vendors will disallow older version of protocols and applications and will address most known non-secure ports, protocols, and/or services. However, sources for further policy filters are the IAVMs and the PPSM requirements.'
  desc 'check', 'The IBM Aspera Console is configured to prohibit or restrict the use of functions, ports, protocols, and/or services, as defined in the PPSM CAL and vulnerability assessments.
...
If there are any ports, protocols, or services that are prohibited by the PPSM CAL, this is a finding.'
  desc 'fix', 'Configure the IBM Aspera Console to disable functions, ports, protocols, and services that are not approved.
...
$ sudo /opt/aspera/common/asctl/asctl mysql:port <number>'
  ...
  tag check_id: 'C-56025r817875_chk'
  tag severity: 'medium'
  tag gid: 'V-252569'
  tag rid: 'SV-252569r817877_rule'
  tag stig_id: 'ASP4-CS-040220'
  tag gtitle: 'SRG-NET-000132-ALG-000087'
  tag fix_id: 'F-55975r817876_fix'
  tag 'documentable'
  tag cci: ['CCI-000382']
  tag nist: ['CM-7 b']
end
