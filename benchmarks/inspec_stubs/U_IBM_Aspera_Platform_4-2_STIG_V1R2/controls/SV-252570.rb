control 'SV-252570' do
  title 'The IBM Aspera Console must be configured to use NIST FIPS-validated cryptography to protect the integrity of file transfers.'
...
'
  desc 'check', 'Ensure that encryption is required for all transfers by the IBM Aspera Console:
...
If the "Transport Encryption" option is set to "none", this is a finding.'
  desc 'fix', 'Configure the system to require encryption for all transfers by the IBM Aspera Console:
...
- Select "Save" at the bottom of the page.'
  ...
  tag check_id: 'C-56026r817878_chk'
  tag severity: 'high'
  tag gid: 'V-252570'
  tag rid: 'SV-252570r831495_rule'
  tag stig_id: 'ASP4-CS-040230'
  tag gtitle: 'SRG-NET-000063-ALG-000012'
  tag fix_id: 'F-55976r817879_fix'
