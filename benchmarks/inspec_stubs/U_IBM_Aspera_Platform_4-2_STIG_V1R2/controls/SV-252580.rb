control 'SV-252580' do
  title 'IBM Aspera Faspex must implement multifactor authentication for remote access to non-privileged accounts such that one of the factors is provided by a device separate from the system gaining access.'
...
If entry of a factor provided by a device separate from the system gaining access is NOT required, this is a finding.'
  desc 'fix', 'For implementations using the IBM Aspera Faspex feature, configure SAML to use an existing IdP that implements multi-factor authentication.'
  impact 0.5
  ref 'DPMS Target IBM Aspera Platform 4.2'
  tag check_id: 'C-56036r817908_chk'
  tag severity: 'medium'
  tag gid: 'V-252580'
  tag rid: 'SV-252580r831502_rule'
  tag stig_id: 'ASP4-FA-050150'
  tag gtitle: 'SRG-NET-000339-ALG-000090'
  tag fix_id: 'F-55986r817909_fix'
