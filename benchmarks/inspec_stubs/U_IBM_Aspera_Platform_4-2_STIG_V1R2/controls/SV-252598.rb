control 'SV-252598' do
  title 'IBM Aspera Shares must be configured to display the Standard Mandatory DoD-approved Notice and Consent Banner before granting access to the system.'
...
If the Standard Mandatory DoD-approved Notice and Consent Banner is not present, this is a finding.'
  desc 'fix', 'Configure the IBM Aspera Shares default webpage to display the Standard Mandatory DoD-approved Notice and Consent Banner.
...
- Select "Save" at the bottom of the page.'
  ...
  tag check_id: 'C-56054r817962_chk'
  tag severity: 'low'
  tag gid: 'V-252598'
  tag rid: 'SV-252598r817964_rule'
  tag stig_id: 'ASP4-SH-060110'
  tag gtitle: 'SRG-NET-000041-ALG-000022'
  tag fix_id: 'F-56004r817963_fix'
