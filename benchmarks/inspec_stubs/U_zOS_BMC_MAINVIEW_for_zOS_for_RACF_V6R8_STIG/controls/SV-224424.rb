...
setr generic(dataset) refresh"
  ...
  tag check_id: 'C-26101r868504_chk'
  tag severity: 'medium'
  tag gid: 'V-224424'
  tag rid: 'SV-224424r868506_rule'
  tag stig_id: 'ZMVZR001'
  tag gtitle: 'SRG-OS-000259'
  tag fix_id: 'F-26089r868505_fix'
  tag 'documentable'
  tag legacy: ['V-17067', 'SV-37723']
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
end
