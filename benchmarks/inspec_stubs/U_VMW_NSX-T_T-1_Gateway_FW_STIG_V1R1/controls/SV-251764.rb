...
Enable SYN Cache and RST Spoofing, then configure the "Applied To" field to contain Tier-1 Gateways and then click "Save".'
  impact 0.5
  ref 'DPMS Target VMware NSX-T Tier 1 Gateway Firewall'
  tag check_id: 'C-55201r810185_chk'
  tag severity: 'medium'
  tag gid: 'V-251764'
  tag rid: 'SV-251764r810187_rule'
  tag stig_id: 'T1FW-3X-000019'
  tag gtitle: 'SRG-NET-000192-FW-000029'
  tag fix_id: 'F-55155r810186_fix'
