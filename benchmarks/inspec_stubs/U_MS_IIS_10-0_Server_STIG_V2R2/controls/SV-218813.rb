control 'SV-218813' do
  title 'The IIS 10.0 web server must provide the capability to immediately disconnect or disable remote access to the hosted applications.'
...
If the web server is not capable or cannot be configured to disconnect or disable remote access to the hosted applications when necessary, this is a finding.'
  desc 'fix', 'Prepare documented procedures for shutting down an IIS 10.0 website in the event of an attack.
