control 'SV-27059' do
  ...
  desc 'check', 'Obtain the list of available package security updates from Red Hat. Check the available package security updates have been installed on the system.
...
One source for the list of Red Hat updates is available at https://access.redhat.com/security/updates/active/'
  ...
  tag check_id: 'C-27973r3_chk'
  tag severity: 'medium'
  tag gid: 'V-783'
  tag rid: 'SV-27059r2_rule'
  tag stig_id: 'GEN000120'
  tag gtitle: 'GEN000120'
  tag fix_id: 'F-31302r1_fix'
  tag 'documentable'
