control 'SV-37312' do
  ...
  desc 'check', 'Verify local initialization files have a library preload list containing only authorized paths.
...
Edit the local initialization file and remove any empty entry that is defined.'
  ...
  tag check_id: 'C-36005r4_chk'
  tag severity: 'medium'
  tag gid: 'V-22364'
  tag rid: 'SV-37312r4_rule'
  tag stig_id: 'GEN001902'
  tag gtitle: 'GEN001902'
  tag fix_id: 'F-31257r2_fix'
  tag 'documentable'
