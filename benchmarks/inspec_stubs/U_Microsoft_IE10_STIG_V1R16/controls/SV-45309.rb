control 'SV-45309' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Restricted Sites Zone -> "Show security warning for potentially unsafe files" must be "Enabled", and "Disable" selected from the drop-down box. 
...
Criteria: If the value 1806 is REG_DWORD = 3, this is not a finding.'
  ...
  tag check_id: 'C-42658r1_chk'
  tag severity: 'medium'
  tag gid: 'V-22159'
  tag rid: 'SV-45309r1_rule'
  tag stig_id: 'DTBI870'
  tag gtitle: 'DTBI870 - Programs and unsafe files - Restricted'
  tag fix_id: 'F-38706r1_fix'
  tag 'documentable'
