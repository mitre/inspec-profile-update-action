control 'SV-45142' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer-> Internet Control Panel-> Security Page-> Internet Zone "Enable dragging of content from different domains across windows" must be "Enabled", and "Disabled" selected. 
...
Criteria: If the value 2709 is REG_DWORD = 3, this is not a finding.'
  desc 'fix', 'Set the policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer-> Internet Control Panel-> Security Page-> Internet Zone "Enable dragging of content from different domains across windows" to "Enabled", and select "Disabled".'
  impact 0.5
  ref 'DPMS Target IE Version 10'
  tag check_id: 'C-42485r1_chk'
  tag severity: 'medium'
  tag gid: 'V-34457'
  tag rid: 'SV-45142r1_rule'
  tag stig_id: 'DTBI990'
  tag gtitle: 'DTBI990 - Content from different domains across windows - Internet zone'
  tag fix_id: 'F-38538r1_fix'
  tag 'documentable'
