control 'SV-45078' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> "Turn off add-on performance notifications" must be "Enabled". 
...
Criteria: If the value DisableAddonLoadTimePerformanceNotifications is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> "Turn off add-on performance notifications" to "Enabled".'
  impact 0.5
  ref 'DPMS Target IE Version 10'
  tag check_id: 'C-42450r2_chk'
  tag severity: 'medium'
  tag gid: 'V-30774'
  tag rid: 'SV-45078r1_rule'
  tag stig_id: 'DTBI745'
  tag gtitle: 'DTBI745 - Add-On Performance Notifications'
  tag fix_id: 'F-38485r2_fix'
  tag 'documentable'
