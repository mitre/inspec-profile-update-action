control 'SV-45439' do
  title 'The URL to be displayed for checking updates to Internet Explorer and Internet Tools must be a blank page.'
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Settings -> Component Updates -> Periodic check for updates to Internet Explorer and Internet Tools -> "Prevent changing the URL for checking updates to Internet Explorer and Internet Tools" must be "Enabled" with a "blank or empty" selection box. 
...
Criteria: The Update_Check_Page value must exist. The value must contain no data value. If the value Update_Check_Page is not present, this is a finding.'
  desc 'fix', 'Set the policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Settings -> Component Updates -> Periodic check for updates to Internet Explorer and Internet Tools -> "Prevent changing the URL for checking updates to Internet Explorer and Internet Tools" to "Enabled" with a "blank or empty" selection box.'
  impact 0.5
  ref 'DPMS Target IE Version 10'
  tag check_id: 'C-42788r1_chk'
  tag severity: 'medium'
  tag gid: 'V-15563'
  tag rid: 'SV-45439r2_rule'
  tag stig_id: 'DTBI675'
  tag gtitle: "DTBI675 - Displaying URL's for update checking"
  tag fix_id: 'F-38836r1_fix'
  tag 'documentable'
