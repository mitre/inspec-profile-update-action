...
Criteria: If the value 2101 is REG_DWORD = 3, this is not a finding.'
  ...
  tag check_id: 'C-42835r1_chk'
  tag severity: 'medium'
  tag gid: 'V-15533'
  tag rid: 'SV-45486r1_rule'
  tag stig_id: 'DTBI515'
  tag gtitle: 'DTBI515 - Less privileged web content - Internet'
  tag fix_id: 'F-38883r1_fix'
  tag 'documentable'
