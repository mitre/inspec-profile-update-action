control 'SV-45493' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Internet Zone -> "Allow loading of XAML files" must be "Enabled", and "Disable" selected from the drop-down box. 
...
Criteria: If the value 2402 is REG_DWORD = 3, this is not a finding.'
  ...
  tag check_id: 'C-42843r1_chk'
  tag severity: 'medium'
  tag gid: 'V-15521'
  tag rid: 'SV-45493r1_rule'
  tag stig_id: 'DTBI455'
  tag gtitle: 'DTBI455 - Loose XAML files - Internet'
  tag fix_id: 'F-38891r1_fix'
  tag 'documentable'
