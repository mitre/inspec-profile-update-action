...
If the attachment circuits have not been bound to VFI configured with the assigned VPN ID for each VLAN, this is a finding.'
  ...
  tag check_id: 'C-7441r382628_chk'
  tag severity: 'high'
  tag gid: 'V-207180'
  tag rid: 'SV-207180r604135_rule'
  tag stig_id: 'SRG-NET-000512-RTR-000009'
  tag gtitle: 'SRG-NET-000512'
  tag fix_id: 'F-7441r382629_fix'
  tag 'documentable'
  tag legacy: ['SV-93009', 'V-78303']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
