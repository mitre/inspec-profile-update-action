control 'SV-220144' do
  title 'The router must be configured to advertise a hop limit of at least 32 in Router Advertisement messages for IPv6 stateless auto-configuration deployments.'
...
If it has been configured and has not been set to at least 32, it is a finding.'
  ...
  tag check_id: 'C-21859r539649_chk'
  tag severity: 'low'
  tag gid: 'V-220144'
  tag rid: 'SV-220144r604135_rule'
  tag stig_id: 'SRG-NET-000512-RTR-000012'
  tag gtitle: 'SRG-NET-000512'
  tag fix_id: 'F-21851r457760_fix'
  tag 'documentable'
  tag legacy: ['V-101083', 'SV-110187']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
