...
If the router is not configured do use its loopback address for LDP peering, this is a finding.'
  ...
  tag check_id: 'C-7434r382607_chk'
  tag severity: 'low'
  tag gid: 'V-207173'
  tag rid: 'SV-207173r604135_rule'
  tag stig_id: 'SRG-NET-000512-RTR-000002'
  tag gtitle: 'SRG-NET-000512'
  tag fix_id: 'F-7434r382608_fix'
  tag 'documentable'
  tag legacy: ['V-78285', 'SV-92991']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
