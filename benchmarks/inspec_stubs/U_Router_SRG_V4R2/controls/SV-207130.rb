...
If the router is not configured to implement a QoS policy in accordance with the QoS GIG Technical Profile, this is a finding.'
  ...
  tag check_id: 'C-7391r539640_chk'
  tag severity: 'low'
  tag gid: 'V-207130'
  tag rid: 'SV-207130r604135_rule'
  tag stig_id: 'SRG-NET-000193-RTR-000113'
  tag gtitle: 'SRG-NET-000193'
  tag fix_id: 'F-7391r539641_fix'
  tag 'documentable'
  tag legacy: ['SV-93025', 'V-78319']
  tag cci: ['CCI-001095']
  tag nist: ['SC-5 (2)']
end
