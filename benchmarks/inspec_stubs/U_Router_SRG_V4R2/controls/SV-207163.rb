...
Configure the router to allow only incoming communications from authorized sources to be routed to authorized destinations.'
  ...
  tag check_id: 'C-7424r382517_chk'
  tag severity: 'medium'
  tag gid: 'V-207163'
  tag rid: 'SV-207163r604135_rule'
  tag stig_id: 'SRG-NET-000364-RTR-000109'
  tag gtitle: 'SRG-NET-000364'
  tag fix_id: 'F-7424r382518_fix'
  tag 'documentable'
  tag legacy: ['V-55785', 'SV-70039']
  tag cci: ['CCI-002403']
  tag nist: ['SC-7 (11)']
end
