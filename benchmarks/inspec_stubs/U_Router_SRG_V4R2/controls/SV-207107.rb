...
If used for out-of-band administrative access, the port must be connected to a secured modem providing encryption and authentication.'
  ...
  tag check_id: 'C-7368r382166_chk'
  tag severity: 'low'
  tag gid: 'V-207107'
  tag rid: 'SV-207107r604135_rule'
  tag stig_id: 'SRG-NET-000019-RTR-000001'
  tag gtitle: 'SRG-NET-000019'
  tag fix_id: 'F-7368r382167_fix'
  tag 'documentable'
  tag legacy: ['V-78235', 'SV-92941']
  tag cci: ['CCI-001414']
  tag nist: ['AC-4']
end
