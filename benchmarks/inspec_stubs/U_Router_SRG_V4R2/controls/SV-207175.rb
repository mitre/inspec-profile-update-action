...
If the router is not configured to disable TTL propagation, this is a finding.'
  ...
  tag check_id: 'C-7436r382613_chk'
  tag severity: 'medium'
  tag gid: 'V-207175'
  tag rid: 'SV-207175r604135_rule'
  tag stig_id: 'SRG-NET-000512-RTR-000004'
  tag gtitle: 'SRG-NET-000512'
  tag fix_id: 'F-7436r382614_fix'
  tag 'documentable'
  tag legacy: ['SV-92997', 'V-78291']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
