control 'SV-38445' do
  ...
  desc 'Disabling accounts after a limited number of unsuccessful logon attempts improves protection against password guessing attacks.'
...
If manually editing the /etc/default/security file, save any change(s) before exiting the editor.'
  ...
  tag check_id: 'C-36249r4_chk'
  tag severity: 'medium'
  tag gid: 'V-766'
  tag rid: 'SV-38445r3_rule'
  tag stig_id: 'GEN000460'
  tag gtitle: 'GEN000460'
  tag fix_id: 'F-31506r3_fix'
  tag 'documentable'
