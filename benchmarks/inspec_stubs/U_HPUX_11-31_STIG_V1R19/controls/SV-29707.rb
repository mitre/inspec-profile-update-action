...
If the listed rules do not block both lsrr and ssrr options, this is a finding.'
  desc 'fix', 'Edit /etc/opt/ipf/ipf.conf and add rules to block outgoing source-routed packets, such as:
...
# ipf -Fa -A -f /etc/opt/ipf/ipf.conf'
  ...
  tag check_id: 'C-36508r2_chk'
  tag severity: 'medium'
  tag gid: 'V-22413'
  tag rid: 'SV-29707r2_rule'
  tag stig_id: 'GEN003606'
  tag gtitle: 'GEN003606'
  tag fix_id: 'F-31866r2_fix'
  tag 'documentable'
