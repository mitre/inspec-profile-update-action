control 'SV-35181' do
  ...
  desc 'Installing extraneous software on a system designated as a dedicated NMS server poses a security threat to the system and the network. Should an attacker gain access to the NMS through unauthorized software, the entire network may be susceptible to malicious activity.'
  ...
  tag check_id: 'C-35026r1_chk'
  tag severity: 'medium'
  tag gid: 'V-4392'
  tag rid: 'SV-35181r1_rule'
  tag stig_id: 'GEN005380'
  tag gtitle: 'GEN005380'
  tag fix_id: 'F-30318r1_fix'
  tag 'documentable'
