...
# chgrp root /var/adm/cron/cron.allow'
  ...
  tag check_id: 'C-36475r1_chk'
  tag severity: 'medium'
  tag gid: 'V-22391'
  tag rid: 'SV-34991r1_rule'
  tag stig_id: 'GEN003250'
  tag gtitle: 'GEN003250'
  tag fix_id: 'F-31818r1_fix'
  tag 'documentable'
