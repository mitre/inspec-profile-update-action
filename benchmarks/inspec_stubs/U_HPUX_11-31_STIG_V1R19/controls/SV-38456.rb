control 'SV-38456' do
  ...
  desc 'check', "Obtain the list of available security patches from HP. Alternatively, obtain, install, and use HP's Patch Tool Bundle to compile a list of superseded patches based on the installed software Product Bundle Patch list(s):
...
Use SMH or # swinstall to apply the patches."
  ...
  tag check_id: 'C-36230r3_chk'
  tag severity: 'medium'
  tag gid: 'V-783'
  tag rid: 'SV-38456r2_rule'
  tag stig_id: 'GEN000120'
  tag gtitle: 'GEN000120'
  tag fix_id: 'F-31489r2_fix'
  tag 'documentable'
