...
Uneven file permissions exist if the file owner has less permissions than the group or other user classes. If any of the files in the above listed directories contain uneven file permissions, this is a finding.'
  desc 'fix', 'Change the mode of files with uneven permissions so owners do not have less permissions than group or world users.'
  impact 0.5
  ref 'DPMS Target HP-UX 11.31'
  tag check_id: 'C-36277r1_chk'
  tag severity: 'medium'
  tag gid: 'V-784'
  tag rid: 'SV-38457r1_rule'
  tag stig_id: 'GEN001140'
  tag gtitle: 'GEN001140'
  tag fix_id: 'F-31534r1_fix'
  tag 'documentable'
