control 'SV-38307' do
  ...
  desc 'check', 'Check that the LD_LIBRARY_PATH and SHLIB_PATH variables are empty or not defined for the root user.
Example:
# echo $LD_LIBRARY_PATH
# echo $SHLIB_PATH
If a path list is returned, this is a finding.'
  desc 'fix', 'Edit the root user initialization files and remove any definition of LD_LIBRARY_PATH and SHLIB_PATH.'
  impact 0.5
  ref 'DPMS Target HP-UX 11.31'
  tag check_id: 'C-36299r1_chk'
  tag severity: 'medium'
  tag gid: 'V-22310'
  tag rid: 'SV-38307r1_rule'
  tag stig_id: 'GEN000945'
  tag gtitle: 'GEN000945'
  tag fix_id: 'F-31554r1_fix'
  tag 'documentable'
