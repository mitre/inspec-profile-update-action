control 'SV-35210' do
  ...
  desc 'check', %q(Check the SSH client configuration for allowed MACs. Note that keywords are case-insensitive and arguments (args) are case-sensitive. 
...
If no lines are returned, or the returned MACs list contains any MAC that is not hmac-sha1 or a better hmac algorithm that is on the FIPS 140-2 approved list, this is a finding.)
  ...
  tag check_id: 'C-36638r3_chk'
  tag severity: 'medium'
  tag gid: 'V-22463'
  tag rid: 'SV-35210r3_rule'
  tag stig_id: 'GEN005512'
  tag gtitle: 'GEN005512'
  tag fix_id: 'F-32009r2_fix'
  tag 'documentable'
