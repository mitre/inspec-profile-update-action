control 'SV-38410' do
  ...
  desc 'check', %q(Ask the SA if the system is a documented mail relay, and if it is, this is not applicable.
...
If the system is using other SMTP software, consult the software's documentation for procedures to restrict mail relaying.)
  ...
  tag check_id: 'C-36578r2_chk'
  tag severity: 'medium'
  tag gid: 'V-23952'
  tag rid: 'SV-38410r1_rule'
  tag stig_id: 'GEN004710'
  tag gtitle: 'GEN004710'
  tag fix_id: 'F-31946r1_fix'
  tag 'documentable'
