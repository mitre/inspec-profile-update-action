control 'SV-40638' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Locked-Down Local Machine Zone -> "Java permissions" must be “Enabled” and "Disable Java" selected from the drop-down box.
...
Criteria: If the value 1C00 is REG_DWORD = 0, this is not a finding.'
  ...
  tag check_id: 'C-39376r1_chk'
  tag severity: 'medium'
  tag gid: 'V-15516'
  tag rid: 'SV-40638r2_rule'
  tag stig_id: 'DTBI430'
  tag gtitle: 'DTBI430 - Java permission - Locked Down Machine'
  tag fix_id: 'F-34492r1_fix'
  tag 'documentable'
