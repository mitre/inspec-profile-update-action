...
Criteria: If the value (Reserved) is REG_SZ = 1, this is not a finding.'
  ...
  tag check_id: 'C-39403r2_chk'
  tag severity: 'medium'
  tag gid: 'V-15556'
  tag rid: 'SV-40672r1_rule'
  tag stig_id: 'DTBI630'
  tag gtitle: 'DTBI630 - File download processes - Reserved'
  tag fix_id: 'F-34525r1_fix'
  tag 'documentable'
