control 'SV-40583' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Trusted Sites Zone -> "Java permissions" must be “Enabled” and "High Safety" selected from the drop-down box.  
...
Criteria: If the value 1C00 is REG_DWORD = 65536, (Decimal), this is not a finding.'
  ...
  tag check_id: 'C-39340r1_chk'
  tag severity: 'medium'
  tag gid: 'V-6281'
  tag rid: 'SV-40583r2_rule'
  tag stig_id: 'DTBI091'
  tag gtitle: 'DTBI091- Java Permission - Trusted'
  tag fix_id: 'F-34448r1_fix'
  tag 'documentable'
