control 'SV-40640' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Locked-Down Trusted Sites Zone -> "Java permissions" must be “Enabled” and "Disable Java" selected from the drop-down box.
...
Criteria: If the value 1C00 is REG_DWORD = 0, this is not a finding.'
  ...
  tag check_id: 'C-39378r1_chk'
  tag severity: 'medium'
  tag gid: 'V-15518'
  tag rid: 'SV-40640r2_rule'
  tag stig_id: 'DTBI440'
  tag gtitle: 'DTBI440 - Java permission - Locked Down Trusted'
  tag fix_id: 'F-34494r1_fix'
  tag 'documentable'
