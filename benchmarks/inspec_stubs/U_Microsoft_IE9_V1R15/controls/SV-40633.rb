control 'SV-40633' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Internet Zone -> "Allow script-initiated windows without size or position constraints" must be “Enabled” and "Disable" selected from the drop-down box. 
...
Criteria: If the value 2102 is REG_DWORD = 3, this is not a finding.'
  ...
  tag check_id: 'C-39371r1_chk'
  tag severity: 'medium'
  tag gid: 'V-15507'
  tag rid: 'SV-40633r1_rule'
  tag stig_id: 'DTBI385'
  tag gtitle: 'DTBI385 - Script initiated windows - Internet'
  tag fix_id: 'F-34485r1_fix'
  tag 'documentable'
