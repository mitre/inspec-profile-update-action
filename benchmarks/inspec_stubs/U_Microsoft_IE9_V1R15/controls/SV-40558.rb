control 'SV-40558' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Internet Zone -> "Download signed ActiveX controls" must be “Enabled” and "Disable" selected from the drop-down box.
...
Criteria: If the value 1001 is REG_DWORD = 3, this is not a finding.'
  ...
  tag check_id: 'C-39324r1_chk'
  tag severity: 'medium'
  tag gid: 'V-6243'
  tag rid: 'SV-40558r1_rule'
  tag stig_id: 'DTBI022'
  tag gtitle: 'DTBI022 - Download signed ActiveX - Internet'
  tag fix_id: 'F-34430r1_fix'
  tag 'documentable'
