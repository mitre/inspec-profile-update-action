control 'SV-40744' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Internet Zone “Run .NET Framework-reliant components signed with Authenticode” must be “Enabled” and “Disable” selected from the drop-down box.
...
Criteria: If the value 2001 is REG_DWORD = 3, this is not a finding.'
  ...
  tag check_id: 'C-39491r1_chk'
  tag severity: 'medium'
  tag gid: 'V-22636'
  tag rid: 'SV-40744r1_rule'
  tag stig_id: 'DTBI930'
  tag gtitle: 'DTBI930 - .NET w/Authenticode signed - Internet'
  tag fix_id: 'F-34608r1_fix'
  tag 'documentable'
