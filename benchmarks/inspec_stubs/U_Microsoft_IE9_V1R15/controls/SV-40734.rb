control 'SV-40734' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Internet Zone -> “Only allow approved domains to use ActiveX controls without prompt” must be “Enabled” and “Enable” selected from the drop-down box.
...
Criteria: If the value 120b is REG_DWORD = 3, this is not a finding.'
  desc 'fix', 'Set the policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Internet Zone -> “Only allow approved domains to use ActiveX controls without prompt” to “Enabled” and select “Enable” from the drop-down box.'
  impact 0.5
  ref 'DPMS Target IE Version 9'
  tag check_id: 'C-39475r1_chk'
  tag severity: 'medium'
  tag gid: 'V-22155'
  tag rid: 'SV-40734r1_rule'
  tag stig_id: 'DTBI830'
  tag gtitle: 'DTBI830 - ActiveX controls no prompt - Internet'
  tag fix_id: 'F-34593r1_fix'
  tag 'documentable'
