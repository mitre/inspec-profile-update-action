control 'SV-40637' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Local Machine Zone -> "Java permissions" must be “Enabled” and "Disable Java" selected from the drop-down box.
...
Criteria: If the value 1C00 is REG_DWORD = 0, this is not a finding.'
  desc 'fix', 'Set the policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Local Machine Zone -> "Java permissions" to “Enabled” and "Disable Java" selected from the drop-down box.'
  impact 0.5
  ref 'DPMS Target IE Version 9'
  tag check_id: 'C-39375r1_chk'
  tag severity: 'medium'
  tag gid: 'V-15515'
  tag rid: 'SV-40637r2_rule'
  tag stig_id: 'DTBI425'
  tag gtitle: 'DTBI425 - Java permission - Local Machine'
  tag fix_id: 'F-34491r1_fix'
  tag 'documentable'
