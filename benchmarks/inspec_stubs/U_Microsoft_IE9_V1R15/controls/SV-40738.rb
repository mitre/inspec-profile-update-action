control 'SV-40738' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Restricted Sites Zone -> “Launching programs and unsafe files” must be “Enabled” and “Disable” selected from the drop-down box. 
...
Criteria: If the value 1806 is REG_DWORD = 3, this is not a finding.'
  desc 'fix', 'Set the policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Restricted Sites Zone -> “Launching programs and unsafe files” to “Enabled” and select “Disable” from the drop-down box.'
  impact 0.5
  ref 'DPMS Target IE Version 9'
  tag check_id: 'C-39485r1_chk'
  tag severity: 'medium'
  tag gid: 'V-22159'
  tag rid: 'SV-40738r1_rule'
  tag stig_id: 'DTBI870'
  tag gtitle: 'DTBI870 - Programs and unsafe files - Restricted'
  tag fix_id: 'F-34597r1_fix'
  tag 'documentable'
