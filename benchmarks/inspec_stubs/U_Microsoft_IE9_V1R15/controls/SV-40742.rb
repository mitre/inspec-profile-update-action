control 'SV-40742' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Internet Zone “Allow status bar updates via script” must be “Enabled” and “Disable” selected from the drop-down box.
...
Criteria: If the value 2103 is REG_DWORD = 3, this is not a finding.'
  desc 'fix', 'Set the policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Internet Zone “Allow status bar updates via script” to “Enabled” and select “Disable” from the drop-down box.'
  impact 0.5
  ref 'DPMS Target IE Version 9'
  tag check_id: 'C-39489r1_chk'
  tag severity: 'medium'
  tag gid: 'V-22634'
  tag rid: 'SV-40742r1_rule'
  tag stig_id: 'DTBI910'
  tag gtitle: 'DTBI910 - Status bar updates via script - Internet'
  tag fix_id: 'F-34606r1_fix'
  tag 'documentable'
