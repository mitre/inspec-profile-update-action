control 'SV-40636' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Internet Zone -> "Automatic prompting for file downloads" must be “Enabled” and "Disable" selected from the drop-down box.
...
Criteria: If the value 2200 is REG_DWORD = 3, this is not a finding.'
  desc 'fix', 'Set the policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Internet Zone -> "Automatic prompting for file downloads" to “Enabled” and select "Disable" from the drop-down box.'
  impact 0.5
  ref 'DPMS Target IE Version 9'
  tag check_id: 'C-39374r1_chk'
  tag severity: 'medium'
  tag gid: 'V-15513'
  tag rid: 'SV-40636r1_rule'
  tag stig_id: 'DTBI415'
  tag gtitle: 'DTBI415 - Prompt for file downloads - Internet'
  tag fix_id: 'F-34490r1_fix'
  tag 'documentable'
