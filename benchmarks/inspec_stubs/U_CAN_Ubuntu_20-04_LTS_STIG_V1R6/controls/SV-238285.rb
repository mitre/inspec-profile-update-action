...
'
  desc 'check', 'Verify the Ubuntu operating system generates an audit record upon successful/unsuccessful modifications to the "tallylog" file. 
...
Note: The "-k" allows for specifying an arbitrary identifier, and the string after it does not need to match the example output above.'
  desc 'fix', 'Configure the audit system to generate an audit event for any successful/unsuccessful modifications to the "tallylog" file.  
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41495r654028_chk'
  tag severity: 'medium'
  tag gid: 'V-238285'
