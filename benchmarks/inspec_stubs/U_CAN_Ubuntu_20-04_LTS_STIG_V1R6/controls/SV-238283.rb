...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', 'Verify the Ubuntu operating system generates an audit record upon successful/unsuccessful attempts to use the "setfacl" command. 
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41493r654022_chk'
  tag severity: 'medium'
  tag gid: 'V-238283'
