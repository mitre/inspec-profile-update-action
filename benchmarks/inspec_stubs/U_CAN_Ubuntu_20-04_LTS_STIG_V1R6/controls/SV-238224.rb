...
If the password length is an odd number then number of changed characters must be rounded up.  For example, a password length of 15 characters must require the change of at least 8 characters.'
  desc 'check', 'Verify the Ubuntu operating system requires the change of at least eight characters when passwords are changed. 
...
If the "difok" parameter is less than "8" or is commented out, this is a finding.'
  desc 'fix', 'Configure the Ubuntu operating system to require the change of at least eight characters when passwords are changed. 
...
difok=8'
  ...
  tag check_id: 'C-41434r653845_chk'
  tag severity: 'low'
  tag gid: 'V-238224'
