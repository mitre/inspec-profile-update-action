control 'SV-241681' do
  title 'tc Server API must set URIEncoding to UTF-8.'
...
Configure each <Connector> node with the value 'URIEncoding="UTF-8"'.)
  ...
  tag check_id: 'C-44957r683903_chk'
  tag severity: 'medium'
  tag gid: 'V-241681'
  tag rid: 'SV-241681r879652_rule'
  tag stig_id: 'VROM-TC-000645'
  tag gtitle: 'SRG-APP-000251-WSR-000157'
  tag fix_id: 'F-44916r683904_fix'
  tag 'documentable'
  tag legacy: ['SV-99647', 'V-88997']
  tag cci: ['CCI-001310']
  tag nist: ['SI-10']
end
