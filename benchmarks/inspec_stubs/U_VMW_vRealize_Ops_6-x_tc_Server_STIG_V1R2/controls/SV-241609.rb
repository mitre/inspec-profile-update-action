control 'SV-241609' do
  title 'tc Server CaSa must produce log records containing sufficient information to establish the source of events.'
...
Note: The “AccessLogValve” should be configured as follows: 
  ...
  tag check_id: 'C-44885r683687_chk'
  tag severity: 'medium'
  tag gid: 'V-241609'
  tag rid: 'SV-241609r879566_rule'
  tag stig_id: 'VROM-TC-000205'
  tag gtitle: 'SRG-APP-000098-WSR-000059'
  tag fix_id: 'F-44844r683688_fix'
  tag 'documentable'
  tag legacy: ['SV-99503', 'V-88853']
  tag cci: ['CCI-000133']
  tag nist: ['AU-3 d']
end
