control 'SV-241617' do
  title 'tc Server UI must produce log records containing sufficient information to establish the identity of any user/subject or process associated with an event.'
...
Note: The “AccessLogValve” should be configured as follows: 
  ...
  tag check_id: 'C-44893r683711_chk'
  tag severity: 'medium'
  tag gid: 'V-241617'
  tag rid: 'SV-241617r879568_rule'
  tag stig_id: 'VROM-TC-000245'
  tag gtitle: 'SRG-APP-000100-WSR-000064'
  tag fix_id: 'F-44852r683712_fix'
  tag 'documentable'
  tag legacy: ['SV-99519', 'V-88869']
  tag cci: ['CCI-001487']
  tag nist: ['AU-3 f']
end
