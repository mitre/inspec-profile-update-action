control 'SV-241708' do
  title 'tc Server CaSa must record time stamps for log records to a minimum granularity of one second.'
...
Note: The <Valve> node should be configured per the below:
  ...
  tag check_id: 'C-44984r854925_chk'
  tag severity: 'medium'
  tag gid: 'V-241708'
  tag rid: 'SV-241708r879748_rule'
  tag stig_id: 'VROM-TC-000820'
  tag gtitle: 'SRG-APP-000375-WSR-000171'
  tag fix_id: 'F-44943r683985_fix'
  tag 'documentable'
  tag legacy: ['SV-99701', 'V-89051']
  tag cci: ['CCI-001889']
  tag nist: ['AU-8 b']
end
