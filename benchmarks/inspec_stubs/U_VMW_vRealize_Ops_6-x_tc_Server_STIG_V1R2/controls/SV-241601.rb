control 'SV-241601' do
  title 'tc Server API must produce log records containing sufficient information to establish what type of events occurred.'
...
Note: The “AccessLogValve” should be configured as follows: 
  ...
  tag check_id: 'C-44877r684119_chk'
  tag severity: 'medium'
  tag gid: 'V-241601'
  tag rid: 'SV-241601r879563_rule'
  tag stig_id: 'VROM-TC-000165'
  tag gtitle: 'SRG-APP-000095-WSR-000056'
  tag fix_id: 'F-44836r683664_fix'
  tag 'documentable'
  tag legacy: ['SV-99487', 'V-88837']
  tag cci: ['CCI-000130']
  tag nist: ['AU-3 a']
end
