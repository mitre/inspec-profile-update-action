control 'SV-241625' do
  title 'tc Server CaSa log files must be protected from unauthorized modification.'
...
Note: Replace <file> with any listed files.'
  ...
  tag check_id: 'C-44901r683735_chk'
  tag severity: 'medium'
  tag gid: 'V-241625'
  tag rid: 'SV-241625r879577_rule'
  tag stig_id: 'VROM-TC-000290'
  tag gtitle: 'SRG-APP-000119-WSR-000069'
  tag fix_id: 'F-44860r683736_fix'
  tag 'documentable'
  tag legacy: ['SV-99535', 'V-88885']
  tag cci: ['CCI-000163']
  tag nist: ['AU-9 a']
end
