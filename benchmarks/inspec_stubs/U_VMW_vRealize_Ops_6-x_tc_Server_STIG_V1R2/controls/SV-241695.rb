control 'SV-241695' do
  title 'tc Server CaSa must set an inactive timeout for sessions.'
...
Add the <session-timeout>30</session-timeout> node setting to the <session-config> node.'
  ...
  tag check_id: 'C-44971r683945_chk'
  tag severity: 'medium'
  tag gid: 'V-241695'
  tag rid: 'SV-241695r879673_rule'
  tag stig_id: 'VROM-TC-000725'
  tag gtitle: 'SRG-APP-000295-WSR-000134'
  tag fix_id: 'F-44930r683946_fix'
  tag 'documentable'
  tag legacy: ['SV-99675', 'V-89025']
  tag cci: ['CCI-002361']
  tag nist: ['AC-12']
end
