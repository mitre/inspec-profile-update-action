control 'SV-241614' do
  title 'tc Server UI must produce log records that contain sufficient information to establish the outcome (success or failure) of events.'
...
Note: The “AccessLogValve” should be configured as follows: 
  ...
  tag check_id: 'C-44890r684133_chk'
  tag severity: 'medium'
  tag gid: 'V-241614'
  tag rid: 'SV-241614r879567_rule'
  tag stig_id: 'VROM-TC-000230'
  tag gtitle: 'SRG-APP-000099-WSR-000061'
  tag fix_id: 'F-44849r683703_fix'
  tag 'documentable'
  tag legacy: ['SV-99513', 'V-88863']
  tag cci: ['CCI-000134']
  tag nist: ['AU-3 e']
end
