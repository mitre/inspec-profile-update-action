control 'SV-241691' do
  title 'tc Server UI must have the debug option turned off.'
...
Note: The debug setting should look like the below:
  ...
  tag check_id: 'C-44967r683933_chk'
  tag severity: 'medium'
  tag gid: 'V-241691'
  tag rid: 'SV-241691r879655_rule'
  tag stig_id: 'VROM-TC-000700'
  tag gtitle: 'SRG-APP-000266-WSR-000160'
  tag fix_id: 'F-44926r683934_fix'
  tag 'documentable'
  tag legacy: ['SV-99667', 'V-89017']
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
end
