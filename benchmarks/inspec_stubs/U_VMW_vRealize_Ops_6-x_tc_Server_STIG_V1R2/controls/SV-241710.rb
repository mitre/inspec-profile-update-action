control 'SV-241710' do
  title 'tc Server UI application, libraries, and configuration files must only be accessible to privileged users.'
...
Repeat the command for each file that was returned'
  ...
  tag check_id: 'C-44986r683990_chk'
  tag severity: 'medium'
  tag gid: 'V-241710'
  tag rid: 'SV-241710r879753_rule'
  tag stig_id: 'VROM-TC-000830'
  tag gtitle: 'SRG-APP-000380-WSR-000072'
  tag fix_id: 'F-44945r683991_fix'
  tag 'documentable'
  tag legacy: ['SV-99705', 'V-89055']
  tag cci: ['CCI-001813']
  tag nist: ['CM-5 (1) (a)']
end
