control 'SV-241607' do
  title 'tc Server API must produce log records containing sufficient information to establish where within the web server the events occurred.'
...
Note: The “AccessLogValve” should be configured as follows: 
  ...
  tag check_id: 'C-44883r683681_chk'
  tag severity: 'medium'
  tag gid: 'V-241607'
  tag rid: 'SV-241607r879565_rule'
  tag stig_id: 'VROM-TC-000195'
  tag gtitle: 'SRG-APP-000097-WSR-000058'
  tag fix_id: 'F-44842r683682_fix'
  tag 'documentable'
  tag legacy: ['SV-99499', 'V-88849']
  tag cci: ['CCI-000132']
  tag nist: ['AU-3 c']
end
