control 'SV-241733' do
  title 'tc Server API must set the secure flag for cookies.'
...
Note: The <cookie-config> --> <secure> node should be configured as shown below:
 ...
 <secure>true</secure>
  ...
  tag check_id: 'C-45009r684059_chk'
  tag severity: 'medium'
  tag gid: 'V-241733'
  tag rid: 'SV-241733r879810_rule'
  tag stig_id: 'VROM-TC-000965'
  tag gtitle: 'SRG-APP-000439-WSR-000155'
  tag fix_id: 'F-44968r684060_fix'
  tag 'documentable'
  tag legacy: ['SV-99751', 'V-89101']
  tag cci: ['CCI-002418']
  tag nist: ['SC-8']
end
