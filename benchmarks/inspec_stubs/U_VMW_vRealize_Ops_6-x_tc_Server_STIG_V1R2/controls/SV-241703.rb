...
If such an alert mechanism is not in use, this is a finding.'
  ...
  tag check_id: 'C-44979r854915_chk'
  tag severity: 'medium'
  tag gid: 'V-241703'
  tag rid: 'SV-241703r879732_rule'
  tag stig_id: 'VROM-TC-000795'
  tag gtitle: 'SRG-APP-000359-WSR-000065'
  tag fix_id: 'F-44938r683970_fix'
  tag 'documentable'
  tag legacy: ['SV-99691', 'V-89041']
  tag cci: ['CCI-001855']
  tag nist: ['AU-5 (1)']
end
