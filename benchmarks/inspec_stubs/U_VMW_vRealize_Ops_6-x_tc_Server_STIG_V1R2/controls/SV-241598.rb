...
'>> "$CATALINA_OUT" 2>&1 "&"')
  ...
  tag check_id: 'C-44874r684115_chk'
  tag severity: 'medium'
  tag gid: 'V-241598'
  tag rid: 'SV-241598r879562_rule'
  tag stig_id: 'VROM-TC-000135'
  tag gtitle: 'SRG-APP-000092-WSR-000055'
  tag fix_id: 'F-44833r683655_fix'
  tag 'documentable'
  tag legacy: ['SV-99475', 'V-88825']
  tag cci: ['CCI-001464']
  tag nist: ['AU-14 (1)']
end
