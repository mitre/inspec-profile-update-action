control 'SV-241656' do
  title 'tc Server API must encrypt passwords during transmission.'
...
Configure each <Connector> with the value 'SSLEnabled="true"')
  ...
  tag check_id: 'C-44932r683828_chk'
  tag severity: 'medium'
  tag gid: 'V-241656'
  tag rid: 'SV-241656r879609_rule'
  tag stig_id: 'VROM-TC-000455'
  tag gtitle: 'SRG-APP-000172-WSR-000104'
  tag fix_id: 'F-44891r683829_fix'
  tag 'documentable'
  tag legacy: ['SV-99597', 'V-88947']
  tag cci: ['CCI-000197']
  tag nist: ['IA-5 (1) (c)']
end
