control 'SV-241619' do
  title 'tc Server API must produce log records containing sufficient information to establish the identity of any user/subject or process associated with an event.'
...
Note: The “AccessLogValve” should be configured as follows: 
  ...
  tag check_id: 'C-44895r683717_chk'
  tag severity: 'medium'
  tag gid: 'V-241619'
  tag rid: 'SV-241619r879568_rule'
  tag stig_id: 'VROM-TC-000255'
  tag gtitle: 'SRG-APP-000100-WSR-000064'
  tag fix_id: 'F-44854r683718_fix'
  tag 'documentable'
  tag legacy: ['SV-99523', 'V-88873']
  tag cci: ['CCI-001487']
  tag nist: ['AU-3 f']
end
