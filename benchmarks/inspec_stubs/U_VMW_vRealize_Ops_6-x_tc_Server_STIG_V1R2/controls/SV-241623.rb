control 'SV-241623' do
  title 'tc Server API log files must only be accessible by privileged users.'
...
find /storage/log/vcops/log/suite-api/ -type f -exec chmod o=--- {} \\;'
  ...
  tag check_id: 'C-44899r683729_chk'
  tag severity: 'medium'
  tag gid: 'V-241623'
  tag rid: 'SV-241623r879576_rule'
  tag stig_id: 'VROM-TC-000280'
  tag gtitle: 'SRG-APP-000118-WSR-000068'
  tag fix_id: 'F-44858r683730_fix'
  tag 'documentable'
  tag legacy: ['SV-99531', 'V-88881']
  tag cci: ['CCI-000162']
  tag nist: ['AU-9 a']
end
