control 'SV-241575' do
  title 'tc Server API must limit the number of maximum concurrent connections permitted.'
...
Note: The <Executor> node should be configured per the below:
  ...
  tag check_id: 'C-44851r683585_chk'
  tag severity: 'medium'
  tag gid: 'V-241575'
  tag rid: 'SV-241575r879511_rule'
  tag stig_id: 'VROM-TC-000015'
  tag gtitle: 'SRG-APP-000001-WSR-000001'
  tag fix_id: 'F-44810r683586_fix'
  tag 'documentable'
  tag legacy: ['SV-99429', 'V-88779']
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
end
