control 'SV-241693' do
  title 'tc Server API must have the debug option turned off.'
...
Note: The debug setting should look like the below:
  ...
  tag check_id: 'C-44969r683939_chk'
  tag severity: 'medium'
  tag gid: 'V-241693'
  tag rid: 'SV-241693r879655_rule'
  tag stig_id: 'VROM-TC-000710'
  tag gtitle: 'SRG-APP-000266-WSR-000160'
  tag fix_id: 'F-44928r683940_fix'
  tag 'documentable'
  tag legacy: ['SV-99671', 'V-89021']
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
end
