control 'SV-241685' do
  title 'tc Server UI must set the welcome-file node to a default web page.'
...
Inspect the file and ensure that it contains the below section:
  ...
  tag check_id: 'C-44961r683915_chk'
  tag severity: 'medium'
  tag gid: 'V-241685'
  tag rid: 'SV-241685r879655_rule'
  tag stig_id: 'VROM-TC-000665'
  tag gtitle: 'SRG-APP-000266-WSR-000142'
  tag fix_id: 'F-44920r683916_fix'
  tag 'documentable'
  tag legacy: ['SV-99655', 'V-89005']
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
end
