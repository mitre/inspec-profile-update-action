control 'SV-241687' do
  title 'tc Server API must set the welcome-file node to a default web page.'
...
Inspect the file and ensure that it contains the below section:
  ...
  tag check_id: 'C-44963r683921_chk'
  tag severity: 'medium'
  tag gid: 'V-241687'
  tag rid: 'SV-241687r879655_rule'
  tag stig_id: 'VROM-TC-000675'
  tag gtitle: 'SRG-APP-000266-WSR-000142'
  tag fix_id: 'F-44922r683922_fix'
  tag 'documentable'
  tag legacy: ['SV-99659', 'V-89009']
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
end
