control 'SV-241579' do
  title 'tc Server UI must limit the number of times that each TCP connection is kept alive.'
...
Configure each <Connector> with the value 'maxKeepAliveRequests="15"'.)
  ...
  tag check_id: 'C-44855r683597_chk'
  tag severity: 'medium'
  tag gid: 'V-241579'
  tag rid: 'SV-241579r879511_rule'
  tag stig_id: 'VROM-TC-000035'
  tag gtitle: 'SRG-APP-000001-WSR-000001'
  tag fix_id: 'F-44814r683598_fix'
  tag 'documentable'
  tag legacy: ['SV-99437', 'V-88787']
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
end
