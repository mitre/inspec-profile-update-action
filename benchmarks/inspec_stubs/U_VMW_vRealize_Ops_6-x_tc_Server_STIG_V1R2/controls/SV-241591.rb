control 'SV-241591' do
  title 'tc Server UI must record user access in a format that enables monitoring of remote access.'
...
Note: The “AccessLogValve” should be configured as follows: 
  ...
  tag check_id: 'C-44867r684101_chk'
  tag severity: 'medium'
  tag gid: 'V-241591'
  tag rid: 'SV-241591r879521_rule'
  tag stig_id: 'VROM-TC-000095'
  tag gtitle: 'SRG-APP-000016-WSR-000005'
  tag fix_id: 'F-44826r683634_fix'
  tag 'documentable'
  tag legacy: ['SV-99461', 'V-88811']
  tag cci: ['CCI-000067']
  tag nist: ['AC-17 (1)']
end
