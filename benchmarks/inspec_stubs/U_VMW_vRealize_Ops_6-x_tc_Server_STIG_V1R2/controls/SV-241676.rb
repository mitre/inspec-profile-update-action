control 'SV-241676' do
  title 'tc Server UI must be configured with a cross-site scripting (XSS) filter.'
...
Configure a <filter> node with the below configuration:
  ...
  tag check_id: 'C-44952r683888_chk'
  tag severity: 'medium'
  tag gid: 'V-241676'
  tag rid: 'SV-241676r879650_rule'
  tag stig_id: 'VROM-TC-000620'
  tag gtitle: 'SRG-APP-000246-WSR-000149'
  tag fix_id: 'F-44911r683889_fix'
  tag 'documentable'
  tag legacy: ['SV-99637', 'V-88987']
  tag cci: ['CCI-001094']
  tag nist: ['SC-5 (1)']
end
