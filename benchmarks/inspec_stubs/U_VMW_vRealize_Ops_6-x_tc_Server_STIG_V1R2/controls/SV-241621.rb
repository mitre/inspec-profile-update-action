control 'SV-241621' do
  title 'tc Server UI log files must only be accessible by privileged users.'
...
find /storage/log/vcops/log/product-ui/ -type f -exec chmod o=--- {} \\;'
  ...
  tag check_id: 'C-44897r683723_chk'
  tag severity: 'medium'
  tag gid: 'V-241621'
  tag rid: 'SV-241621r879576_rule'
  tag stig_id: 'VROM-TC-000270'
  tag gtitle: 'SRG-APP-000118-WSR-000068'
  tag fix_id: 'F-44856r683724_fix'
  tag 'documentable'
  tag legacy: ['SV-99527', 'V-88877']
  tag cci: ['CCI-000162']
  tag nist: ['AU-9 a']
end
