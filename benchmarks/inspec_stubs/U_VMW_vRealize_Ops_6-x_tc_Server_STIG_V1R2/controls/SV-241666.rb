control 'SV-241666' do
  title 'tc Server UI web server application directories must not be accessible to anonymous user.'
...
Repeat the command for each file that was returned.'
  ...
  tag check_id: 'C-44942r683858_chk'
  tag severity: 'high'
  tag gid: 'V-241666'
  tag rid: 'SV-241666r879631_rule'
  tag stig_id: 'VROM-TC-000515'
  tag gtitle: 'SRG-APP-000211-WSR-000031'
  tag fix_id: 'F-44901r683859_fix'
  tag 'documentable'
  tag legacy: ['SV-99617', 'V-88967']
  tag cci: ['CCI-001082']
  tag nist: ['SC-2']
end
