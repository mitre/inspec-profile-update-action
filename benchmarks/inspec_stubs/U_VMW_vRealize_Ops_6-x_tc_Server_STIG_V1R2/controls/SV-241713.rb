control 'SV-241713' do
  title 'tc Server UI must be configured with the appropriate ports.'
...
vmware-bio.https.port=8443'
  ...
  tag check_id: 'C-44989r854932_chk'
  tag severity: 'medium'
  tag gid: 'V-241713'
  tag rid: 'SV-241713r879756_rule'
  tag stig_id: 'VROM-TC-000845'
  tag gtitle: 'SRG-APP-000383-WSR-000175'
  tag fix_id: 'F-44948r684000_fix'
  tag 'documentable'
  tag legacy: ['SV-99711', 'V-89061']
  tag cci: ['CCI-001762']
  tag nist: ['CM-7 (1) (b)']
end
