control 'SV-241732' do
  title 'tc Server CaSa must set the secure flag for cookies.'
...
Note: The <cookie-config> --> <secure> node should be configured as shown below:
 ...
 <secure>true</secure>
  ...
  tag check_id: 'C-45008r684056_chk'
  tag severity: 'medium'
  tag gid: 'V-241732'
  tag rid: 'SV-241732r879810_rule'
  tag stig_id: 'VROM-TC-000960'
  tag gtitle: 'SRG-APP-000439-WSR-000155'
  tag fix_id: 'F-44967r684057_fix'
  tag 'documentable'
  tag legacy: ['SV-99749', 'V-89099']
  tag cci: ['CCI-002418']
  tag nist: ['SC-8']
end
