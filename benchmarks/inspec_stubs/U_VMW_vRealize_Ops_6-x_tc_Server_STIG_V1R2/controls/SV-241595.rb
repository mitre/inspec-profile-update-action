control 'SV-241595' do
  title 'tc Server UI must generate log records for user access and authentication events.'
...
Note: The “AccessLogValve” should be configured as follows: 
  ...
  tag check_id: 'C-44871r684109_chk'
  tag severity: 'medium'
  tag gid: 'V-241595'
  tag rid: 'SV-241595r879559_rule'
  tag stig_id: 'VROM-TC-000120'
  tag gtitle: 'SRG-APP-000089-WSR-000047'
  tag fix_id: 'F-44830r683646_fix'
  tag 'documentable'
  tag legacy: ['SV-99469', 'V-88819']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
