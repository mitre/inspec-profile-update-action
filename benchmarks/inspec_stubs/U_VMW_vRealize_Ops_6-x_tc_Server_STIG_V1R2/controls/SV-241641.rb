control 'SV-241641' do
  title 'tc Server UI must have mappings set for Java Servlet Pages.'
...
Configure the <servlet-mapping> node to look like the code snippet below:
  ...
  tag check_id: 'C-44917r684153_chk'
  tag severity: 'medium'
  tag gid: 'V-241641'
  tag rid: 'SV-241641r879587_rule'
  tag stig_id: 'VROM-TC-000380'
  tag gtitle: 'SRG-APP-000141-WSR-000083'
  tag fix_id: 'F-44876r683784_fix'
  tag 'documentable'
  tag legacy: ['SV-99567', 'V-88917']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
