control 'SV-241606' do
  title 'tc Server CaSa must produce log records containing sufficient information to establish where within the web server the events occurred.'
...
Note: The “AccessLogValve” should be configured as follows: 
  ...
  tag check_id: 'C-44882r683678_chk'
  tag severity: 'medium'
  tag gid: 'V-241606'
  tag rid: 'SV-241606r879565_rule'
  tag stig_id: 'VROM-TC-000190'
  tag gtitle: 'SRG-APP-000097-WSR-000058'
  tag fix_id: 'F-44841r683679_fix'
  tag 'documentable'
  tag legacy: ['SV-99497', 'V-88847']
  tag cci: ['CCI-000132']
  tag nist: ['AU-3 c']
end
