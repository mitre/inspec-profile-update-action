control 'SV-241629' do
  title 'tc Server API log files must be protected from unauthorized deletion.'
...
Note: Replace <file> with any listed files.'
  ...
  tag check_id: 'C-44905r683747_chk'
  tag severity: 'medium'
  tag gid: 'V-241629'
  tag rid: 'SV-241629r879578_rule'
  tag stig_id: 'VROM-TC-000310'
  tag gtitle: 'SRG-APP-000120-WSR-000070'
  tag fix_id: 'F-44864r683748_fix'
  tag 'documentable'
  tag legacy: ['SV-99543', 'V-88893']
  tag cci: ['CCI-000164']
  tag nist: ['AU-9 a']
end
