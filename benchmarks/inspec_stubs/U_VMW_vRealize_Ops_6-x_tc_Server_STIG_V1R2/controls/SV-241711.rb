control 'SV-241711' do
  title 'tc Server CaSa application, libraries, and configuration files must only be accessible to privileged users.'
...
Repeat the command for each file that was returned'
  ...
  tag check_id: 'C-44987r683993_chk'
  tag severity: 'medium'
  tag gid: 'V-241711'
  tag rid: 'SV-241711r879753_rule'
  tag stig_id: 'VROM-TC-000835'
  tag gtitle: 'SRG-APP-000380-WSR-000072'
  tag fix_id: 'F-44946r683994_fix'
  tag 'documentable'
  tag legacy: ['SV-99707', 'V-89057']
  tag cci: ['CCI-001813']
  tag nist: ['CM-5 (1) (a)']
end
