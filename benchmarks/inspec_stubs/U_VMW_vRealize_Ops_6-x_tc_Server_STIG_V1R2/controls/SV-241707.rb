control 'SV-241707' do
  title 'tc Server UI must record time stamps for log records to a minimum granularity of one second.'
...
Note: The <Valve> node should be configured per the below:
  ...
  tag check_id: 'C-44983r854923_chk'
  tag severity: 'medium'
  tag gid: 'V-241707'
  tag rid: 'SV-241707r879748_rule'
  tag stig_id: 'VROM-TC-000815'
  tag gtitle: 'SRG-APP-000375-WSR-000171'
  tag fix_id: 'F-44942r683982_fix'
  tag 'documentable'
  tag legacy: ['SV-99699', 'V-89049']
  tag cci: ['CCI-001889']
  tag nist: ['AU-8 b']
end
