control 'SV-241665' do
  title 'tc Server API accounts accessing the directory tree, the shell, or other operating system functions and utilities must be administrative accounts.'
...
Repeat the command for each file that was returned.'
  ...
  tag check_id: 'C-44941r684175_chk'
  tag severity: 'high'
  tag gid: 'V-241665'
  tag rid: 'SV-241665r879631_rule'
  tag stig_id: 'VROM-TC-000510'
  tag gtitle: 'SRG-APP-000211-WSR-000030'
  tag fix_id: 'F-44900r683856_fix'
  tag 'documentable'
  tag legacy: ['SV-99615', 'V-88965']
  tag cci: ['CCI-001082']
  tag nist: ['SC-2']
end
