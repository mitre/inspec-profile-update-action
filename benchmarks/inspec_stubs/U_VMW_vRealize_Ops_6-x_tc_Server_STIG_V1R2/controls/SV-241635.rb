control 'SV-241635' do
  title 'tc Server API must not use the tomcat-users XML database for user management.'
...
If “tomcat-users.xml” file contains any user information, this is a finding.'
  ...
  tag check_id: 'C-44911r683765_chk'
  tag severity: 'medium'
  tag gid: 'V-241635'
  tag rid: 'SV-241635r879587_rule'
  tag stig_id: 'VROM-TC-000340'
  tag gtitle: 'SRG-APP-000141-WSR-000015'
  tag fix_id: 'F-44870r683766_fix'
  tag 'documentable'
  tag legacy: ['SV-99555', 'V-88905']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
