control 'SV-241610' do
  title 'tc Server API must produce log records containing sufficient information to establish the source of events.'
...
Note: The “AccessLogValve” should be configured as follows: 
  ...
  tag check_id: 'C-44886r684125_chk'
  tag severity: 'medium'
  tag gid: 'V-241610'
  tag rid: 'SV-241610r879566_rule'
  tag stig_id: 'VROM-TC-000210'
  tag gtitle: 'SRG-APP-000098-WSR-000059'
  tag fix_id: 'F-44845r683691_fix'
  tag 'documentable'
  tag legacy: ['SV-99505', 'V-88855']
  tag cci: ['CCI-000133']
  tag nist: ['AU-3 d']
end
