control 'SV-241626' do
  title 'tc Server API log files must be protected from unauthorized modification.'
...
Note: Replace <file> with any listed files.'
  ...
  tag check_id: 'C-44902r683738_chk'
  tag severity: 'medium'
  tag gid: 'V-241626'
  tag rid: 'SV-241626r879577_rule'
  tag stig_id: 'VROM-TC-000295'
  tag gtitle: 'SRG-APP-000119-WSR-000069'
  tag fix_id: 'F-44861r683739_fix'
  tag 'documentable'
  tag legacy: ['SV-99537', 'V-88887']
  tag cci: ['CCI-000163']
  tag nist: ['AU-9 a']
end
