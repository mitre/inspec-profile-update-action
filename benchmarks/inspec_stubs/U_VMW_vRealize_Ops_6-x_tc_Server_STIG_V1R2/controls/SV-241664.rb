control 'SV-241664' do
  title 'tc Server CaSa accounts accessing the directory tree, the shell, or other operating system functions and utilities must be administrative accounts.'
...
Repeat the command for each file that was returned.'
  ...
  tag check_id: 'C-44940r683852_chk'
  tag severity: 'high'
  tag gid: 'V-241664'
  tag rid: 'SV-241664r879631_rule'
  tag stig_id: 'VROM-TC-000505'
  tag gtitle: 'SRG-APP-000211-WSR-000030'
  tag fix_id: 'F-44899r683853_fix'
  tag 'documentable'
  tag legacy: ['SV-99613', 'V-88963']
  tag cci: ['CCI-001082']
  tag nist: ['SC-2']
end
