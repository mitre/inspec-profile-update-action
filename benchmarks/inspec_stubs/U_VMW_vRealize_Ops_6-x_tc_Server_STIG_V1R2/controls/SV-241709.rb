control 'SV-241709' do
  title 'tc Server API must record time stamps for log records to a minimum granularity of one second.'
...
Note: The <Valve> node should be configured per the below:
  ...
  tag check_id: 'C-44985r854927_chk'
  tag severity: 'medium'
  tag gid: 'V-241709'
  tag rid: 'SV-241709r879748_rule'
  tag stig_id: 'VROM-TC-000825'
  tag gtitle: 'SRG-APP-000375-WSR-000171'
  tag fix_id: 'F-44944r683988_fix'
  tag 'documentable'
  tag legacy: ['SV-99703', 'V-89053']
  tag cci: ['CCI-001889']
  tag nist: ['AU-8 b']
end
