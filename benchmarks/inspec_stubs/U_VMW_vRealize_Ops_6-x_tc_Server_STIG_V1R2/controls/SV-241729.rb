control 'SV-241729' do
  title 'tc Server CaSa must set the useHttpOnly parameter.'
...
<Context useHttpOnly="true">)
  ...
  tag check_id: 'C-45005r684047_chk'
  tag severity: 'medium'
  tag gid: 'V-241729'
  tag rid: 'SV-241729r879810_rule'
  tag stig_id: 'VROM-TC-000945'
  tag gtitle: 'SRG-APP-000439-WSR-000154'
  tag fix_id: 'F-44964r684048_fix'
  tag 'documentable'
  tag legacy: ['SV-99743', 'V-89093']
  tag cci: ['CCI-002418']
  tag nist: ['SC-8']
end
