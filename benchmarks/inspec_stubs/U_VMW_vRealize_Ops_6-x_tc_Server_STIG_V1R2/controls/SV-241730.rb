control 'SV-241730' do
  title 'tc Server API must set the useHttpOnly parameter.'
...
<Context useHttpOnly="true">)
  ...
  tag check_id: 'C-45006r854956_chk'
  tag severity: 'medium'
  tag gid: 'V-241730'
  tag rid: 'SV-241730r879810_rule'
  tag stig_id: 'VROM-TC-000950'
  tag gtitle: 'SRG-APP-000439-WSR-000154'
  tag fix_id: 'F-44965r684051_fix'
  tag 'documentable'
  tag legacy: ['SV-99745', 'V-89095']
  tag cci: ['CCI-002418']
  tag nist: ['SC-8']
end
