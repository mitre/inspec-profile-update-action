control 'SV-241604' do
  title 'tc Server API must produce log records containing sufficient information to establish when (date and time) events occurred.'
...
Note: The AccessLogValve should be configured as follows: 
  ...
  tag check_id: 'C-44880r683672_chk'
  tag severity: 'medium'
  tag gid: 'V-241604'
  tag rid: 'SV-241604r879564_rule'
  tag stig_id: 'VROM-TC-000180'
  tag gtitle: 'SRG-APP-000096-WSR-000057'
  tag fix_id: 'F-44839r683673_fix'
  tag 'documentable'
  tag legacy: ['SV-99493', 'V-88843']
  tag cci: ['CCI-000131']
  tag nist: ['AU-3 b']
end
