control 'SV-241679' do
  title 'tc Server UI must set URIEncoding to UTF-8.'
...
Configure each <Connector> node with the value "URIEncoding="UTF-8"'.)
  ...
  tag check_id: 'C-44955r683897_chk'
  tag severity: 'medium'
  tag gid: 'V-241679'
  tag rid: 'SV-241679r879652_rule'
  tag stig_id: 'VROM-TC-000635'
  tag gtitle: 'SRG-APP-000251-WSR-000157'
  tag fix_id: 'F-44914r683898_fix'
  tag 'documentable'
  tag legacy: ['SV-99643', 'V-88993']
  tag cci: ['CCI-001310']
  tag nist: ['SI-10']
end
