control 'SV-241616' do
  title 'tc Server API must produce log records that contain sufficient information to establish the outcome (success or failure) of events.'
...
Note: The “AccessLogValve” should be configured as follows: 
  ...
  tag check_id: 'C-44892r684137_chk'
  tag severity: 'medium'
  tag gid: 'V-241616'
  tag rid: 'SV-241616r879567_rule'
  tag stig_id: 'VROM-TC-000240'
  tag gtitle: 'SRG-APP-000099-WSR-000061'
  tag fix_id: 'F-44851r683709_fix'
  tag 'documentable'
  tag legacy: ['SV-99517', 'V-88867']
  tag cci: ['CCI-000134']
  tag nist: ['AU-3 e']
end
