control 'SV-241578' do
  title 'tc Server API must limit the amount of time that each TCP connection is kept alive.'
...
Configure each <Connector> with the value 'connectionTimeout="20000"'.)
  ...
  tag check_id: 'C-44854r683594_chk'
  tag severity: 'medium'
  tag gid: 'V-241578'
  tag rid: 'SV-241578r879511_rule'
  tag stig_id: 'VROM-TC-000030'
  tag gtitle: 'SRG-APP-000001-WSR-000001'
  tag fix_id: 'F-44813r683595_fix'
  tag 'documentable'
  tag legacy: ['SV-99435', 'V-88785']
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
end
