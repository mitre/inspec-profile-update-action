control 'SV-241643' do
  title 'tc Server API must have mappings set for Java Servlet Pages.'
...
Configure the <servlet-mapping> node to look like the code snippet below:
  ...
  tag check_id: 'C-44919r684157_chk'
  tag severity: 'medium'
  tag gid: 'V-241643'
  tag rid: 'SV-241643r879587_rule'
  tag stig_id: 'VROM-TC-000390'
  tag gtitle: 'SRG-APP-000141-WSR-000083'
  tag fix_id: 'F-44878r683790_fix'
  tag 'documentable'
  tag legacy: ['SV-99571', 'V-88921']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
