control 'SV-258405' do
  title 'Google Android 14 must be configured to disable all data signaling over [assignment: list of externally accessible hardware ports (for example, USB)].'
...
If on EMM console the USB port is not disabled, this is a finding.'
  desc 'fix', 'Configure Google Android 14 device to disable the USB port (except for charging the device).
...
2. Toggle "Enable USB" to "OFF".'
  ...
  tag check_id: 'C-62146r928238_chk'
  tag severity: 'medium'
  tag gid: 'V-258405'
  tag rid: 'SV-258405r928240_rule'
  tag stig_id: 'GOOG-14-012200'
  tag gtitle: 'PP-MDF-993300'
  tag fix_id: 'F-62070r928239_fix'
  tag 'documentable'
  tag cci: ['CCI-002235']
  tag nist: ['AC-6 (10)']
end
