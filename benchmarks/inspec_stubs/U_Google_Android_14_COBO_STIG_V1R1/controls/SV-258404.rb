control 'SV-258404' do
  title 'Android 14 devices must be configured to enable Common Criteria Mode (CC Mode).'
...
SFR ID: FMT_SMF_EXT.1.1 #47'
  desc 'check', 'Review the managed Google Android 14 configuration settings to confirm CC mode is enabled. 
...
If CC mode is not enabled, this is a finding.'
  desc 'fix', 'Configure the Google Android 14 device to implement CC Mode. 
...
2. Toggle "Enable Common Criteria mode" to "ON".'
  ...
  tag check_id: 'C-62145r928235_chk'
  tag severity: 'low'
  tag gid: 'V-258404'
  tag rid: 'SV-258404r928237_rule'
  tag stig_id: 'GOOG-14-011000'
  tag gtitle: 'PP-MDF-993300'
  tag fix_id: 'F-62069r928236_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
