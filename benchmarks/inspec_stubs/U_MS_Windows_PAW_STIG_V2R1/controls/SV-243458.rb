...
Configure the policy value for Computer Configuration >> Windows Settings >> Security Settings >> Local Policies >> Security Options >> "System cryptography: Use FIPS compliant algorithms for encryption, hashing, and signing" to "Enabled".'
  ...
  tag check_id: 'C-46733r722943_chk'
  tag severity: 'high'
  tag gid: 'V-243458'
  tag rid: 'SV-243458r722969_rule'
  tag stig_id: 'WPAW-00-001700'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-46690r722968_fix'
  tag 'documentable'
  tag legacy: ['SV-92883', 'V-78177']
  tag cci: ['CCI-000366', 'CCI-001135', 'CCI-002426']
  tag nist: ['CM-6 b', 'SC-11 a', 'SC-11 (1) (a)']
end
