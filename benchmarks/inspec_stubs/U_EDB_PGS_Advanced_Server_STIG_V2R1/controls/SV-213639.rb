...
Update the system documentation to note the organizationally approved setting and corresponding justification of the setting for this requirement."
  ...
  tag check_id: 'C-14861r290229_chk'
  tag severity: 'medium'
  tag gid: 'V-213639'
  tag rid: 'SV-213639r508024_rule'
  tag stig_id: 'PPS9-00-010200'
  tag gtitle: 'SRG-APP-000494-DB-000344'
  tag fix_id: 'F-14859r290230_fix'
  tag 'documentable'
  tag legacy: ['SV-83635', 'V-69031']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
