...
If other applications are located in the same directory as the DBMS, this is a finding.'
  ...
  tag check_id: 'C-14810r290076_chk'
  tag severity: 'medium'
  tag gid: 'V-213588'
  tag rid: 'SV-213588r508024_rule'
  tag stig_id: 'PPS9-00-003400'
  tag gtitle: 'SRG-APP-000133-DB-000199'
  tag fix_id: 'F-14808r290077_fix'
  tag 'documentable'
  tag legacy: ['SV-83535', 'V-68931']
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
end
