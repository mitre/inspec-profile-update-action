...
Update the system documentation to note the organizationally approved setting and corresponding justification of the setting for this requirement."
  ...
  tag check_id: 'C-14875r290271_chk'
  tag severity: 'medium'
  tag gid: 'V-213653'
  tag rid: 'SV-213653r508024_rule'
  tag stig_id: 'PPS9-00-011600'
  tag gtitle: 'SRG-APP-000502-DB-000348'
  tag fix_id: 'F-14873r290272_fix'
  tag 'documentable'
  tag legacy: ['V-69055', 'SV-83659']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
