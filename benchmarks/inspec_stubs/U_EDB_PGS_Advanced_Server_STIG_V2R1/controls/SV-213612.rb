...
If detailed error messages are displayed to individuals not authorized to view them, this is a finding.'
  ...
  tag check_id: 'C-14834r290148_chk'
  tag severity: 'medium'
  tag gid: 'V-213612'
  tag rid: 'SV-213612r508024_rule'
  tag stig_id: 'PPS9-00-006600'
  tag gtitle: 'SRG-APP-000267-DB-000163'
  tag fix_id: 'F-14832r290149_fix'
  tag 'documentable'
  tag legacy: ['V-68977', 'SV-83581']
  tag cci: ['CCI-001314']
  tag nist: ['SI-11 b']
end
