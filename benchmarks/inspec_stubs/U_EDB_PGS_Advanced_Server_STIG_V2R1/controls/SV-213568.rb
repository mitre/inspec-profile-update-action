control 'SV-213568' do
  title 'The EDB Postgres Advanced Server must generate audit records when unsuccessful attempts to retrieve privileges/permissions occur.'
...
Update the system documentation to note the organizationally approved setting and corresponding justification of the setting for this requirement."
  ...
  tag check_id: 'C-14790r290016_chk'
  tag severity: 'medium'
  tag gid: 'V-213568'
  tag rid: 'SV-213568r508024_rule'
  tag stig_id: 'PPS9-00-001300'
  tag gtitle: 'SRG-APP-000091-DB-000325'
  tag fix_id: 'F-14788r290017_fix'
  tag 'documentable'
  tag legacy: ['SV-83493', 'V-68889']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
