...
Run this command "cat /proc/sys/crypto/fips_enabled". 
...
http://csrc.nist.gov/groups/STM/cmvp/documents/140-1/140sp/140sp1758.pdf'
  ...
  tag check_id: 'C-14886r290304_chk'
  tag severity: 'high'
  tag gid: 'V-213664'
  tag rid: 'SV-213664r508024_rule'
  tag stig_id: 'PPS9-00-012700'
  tag gtitle: 'SRG-APP-000514-DB-000381'
  tag fix_id: 'F-14884r290305_fix'
  tag 'documentable'
  tag legacy: ['V-69077', 'SV-83681']
  tag cci: ['CCI-002450']
  tag nist: ['SC-13 b']
end
