...
If any application-specific packages have been added to these schemas, this is a finding.'
  ...
  tag check_id: 'C-14827r290127_chk'
  tag severity: 'medium'
  tag gid: 'V-213605'
  tag rid: 'SV-213605r508024_rule'
  tag stig_id: 'PPS9-00-005800'
  tag gtitle: 'SRG-APP-000233-DB-000124'
  tag fix_id: 'F-14825r290128_fix'
  tag 'documentable'
  tag legacy: ['V-68963', 'SV-83567']
  tag cci: ['CCI-001084']
  tag nist: ['SC-3']
end
