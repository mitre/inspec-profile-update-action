...
http://www.enterprisedb.com/docs/en/9.5/oracompat/Database_Compatibility_for_Oracle_Developers_Guide.1.201.html#pID0E0D5J0HA'
  ...
  tag check_id: 'C-14838r290160_chk'
  tag severity: 'medium'
  tag gid: 'V-213616'
  tag rid: 'SV-213616r508024_rule'
  tag stig_id: 'PPS9-00-007100'
  tag gtitle: 'SRG-APP-000314-DB-000310'
  tag fix_id: 'F-14836r290161_fix'
  tag 'documentable'
  tag legacy: ['V-68985', 'SV-83589']
  tag cci: ['CCI-002264']
  tag nist: ['AC-16 a']
end
