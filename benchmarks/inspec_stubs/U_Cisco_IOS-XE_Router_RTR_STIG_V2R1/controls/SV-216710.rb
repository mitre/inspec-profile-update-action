...
R1(config-bdomain)#mac limit maximum addresses nnnn'
  impact 0.5
  ref 'DPMS Target Cisco IOS XE Router RTR'
  tag check_id: 'C-17943r288075_chk'
  tag severity: 'medium'
  tag gid: 'V-216710'
  tag rid: 'SV-216710r531086_rule'
  tag stig_id: 'CISC-RT-000720'
  tag gtitle: 'SRG-NET-000192-RTR-000002'
  tag fix_id: 'F-17941r288076_fix'
  tag 'documentable'
  tag legacy: ['SV-106131', 'V-96993']
  tag cci: ['CCI-001094']
  tag nist: ['SC-5 (1)']
end
