...
Note that USNO offers authenticated NTP service to DoD and U.S. Government agencies operating on the NIPR and SIPR networks. Visit https://www.usno.navy.mil/USNO/time/ntp/dod-customers for more information.'
  desc 'check', %q(Verify OL 8 disables the chrony daemon from acting as a server with the following command: 
...
If the "port" option is not set to "0" or is commented out or missing, this is a finding.)
  desc 'fix', 'Configure OL 8 to disable the chrony daemon from acting as a server by adding/modifying the following line in the "/etc/chrony.conf" file. 
 
port 0'
  impact 0.3
  ref 'DPMS Target Oracle Linux 8'
  tag check_id: 'C-52255r780027_chk'
  tag severity: 'low'
  tag gid: 'V-248821'
  tag rid: 'SV-248821r780029_rule'
  tag stig_id: 'OL08-00-030741'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-52209r780028_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
