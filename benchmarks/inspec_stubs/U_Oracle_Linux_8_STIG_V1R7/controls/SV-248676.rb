control 'SV-248676' do
  ...
  desc 'Tmux is a terminal multiplexer that enables a number of terminals to be created, accessed, and controlled from a single screen.
...
This setting will take effect at next logon.'
  ...
  tag check_id: 'C-52110r880536_chk'
  tag severity: 'medium'
  tag gid: 'V-248676'
  tag rid: 'SV-248676r917911_rule'
  tag stig_id: 'OL08-00-020041'
  tag gtitle: 'SRG-OS-000028-GPOS-00009'
  tag fix_id: 'F-52064r880537_fix'
