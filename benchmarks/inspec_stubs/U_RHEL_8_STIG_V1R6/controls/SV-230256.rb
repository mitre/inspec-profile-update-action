...
If the "gnutls.config" does not list "-VERS-DTLS0.9:-VERS-SSL3.0:-VERS-TLS1.0:-VERS-TLS1.1:-VERS-DTLS1.0" to disable unapproved SSL/TLS versions, this is a finding.'
  desc 'fix', 'Configure the RHEL 8 GnuTLS library to use only DoD-approved encryption by adding the following line to "/etc/crypto-policies/back-ends/gnutls.config":
...
A reboot is required for the changes to take effect.'
  ...
  tag check_id: 'C-32925r792858_chk'
  tag severity: 'medium'
  tag gid: 'V-230256'
  tag rid: 'SV-230256r792859_rule'
