...
'
  desc 'check', 'Verify RHEL 8 generates audit records for all account creations, modifications, disabling, and termination events that affect "/etc/gshadow".
...
If the command does not return a line, or the line is commented out, this is a finding.'
  desc 'fix', 'Configure RHEL 8 to generate audit records for all account creations, modifications, disabling, and termination events that affect "/etc/gshadow".
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-33076r567967_chk'
  tag severity: 'medium'
  tag gid: 'V-230407'
