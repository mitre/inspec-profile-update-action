...
'
  desc 'check', 'Verify the operating system initiates a session lock after a 15-minute period of inactivity for graphical user interfaces with the following commands:
...
$ sudo dconf update'
  ...
  tag check_id: 'C-33021r646875_chk'
  tag severity: 'medium'
  tag gid: 'V-230352'
