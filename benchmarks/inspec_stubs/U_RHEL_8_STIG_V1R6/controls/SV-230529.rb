control 'SV-230529' do
  ...
  desc 'check', 'Verify RHEL 8 is not configured to reboot the system when Ctrl-Alt-Delete is pressed with the following command:
...
$ sudo systemctl daemon-reload'
  ...
  tag check_id: 'C-33198r568333_chk'
  tag severity: 'high'
  tag gid: 'V-230529'
