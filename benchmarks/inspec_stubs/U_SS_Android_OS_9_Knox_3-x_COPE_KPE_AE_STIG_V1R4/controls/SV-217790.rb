...
6. Enter the current password.'
  ...
  tag check_id: 'C-19007r362663_chk'
  tag severity: 'medium'
  tag gid: 'V-217790'
  tag rid: 'SV-217790r388482_rule'
  tag stig_id: 'KNOX-09-001480'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-19005r362664_fix'
  tag 'documentable'
  tag legacy: ['SV-103929', 'V-93843']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
