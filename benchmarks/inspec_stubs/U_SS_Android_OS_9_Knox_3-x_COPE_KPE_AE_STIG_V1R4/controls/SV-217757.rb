...
On the MDM console, for the device, in the "Android lock screen restrictions" group, set the "max time to screen lock" to "15" minutes.'
  ...
  tag check_id: 'C-18974r362564_chk'
  tag severity: 'medium'
  tag gid: 'V-217757'
  tag rid: 'SV-217757r378598_rule'
  tag stig_id: 'KNOX-09-000400'
  tag gtitle: 'PP-MDF-301040'
  tag fix_id: 'F-18972r362565_fix'
  tag 'documentable'
  tag legacy: ['SV-103863', 'V-93777']
  tag cci: ['CCI-000057']
  tag nist: ['AC-11 a']
end
