...
7. Enter the current password,'
  ...
  tag check_id: 'C-19005r362657_chk'
  tag severity: 'medium'
  tag gid: 'V-217788'
  tag rid: 'SV-217788r388482_rule'
  tag stig_id: 'KNOX-09-001420'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-19003r362658_fix'
  tag 'documentable'
  tag legacy: ['SV-103925', 'V-93839']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
