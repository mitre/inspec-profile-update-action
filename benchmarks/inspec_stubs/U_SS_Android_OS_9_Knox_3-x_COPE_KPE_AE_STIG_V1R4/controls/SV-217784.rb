...
The DoD mobile service provider should verify that the Exchange server is configured to disable Microsoft EAS Password Recovery.'
  ...
  tag check_id: 'C-19001r362645_chk'
  tag severity: 'medium'
  tag gid: 'V-217784'
  tag rid: 'SV-217784r388482_rule'
  tag stig_id: 'KNOX-09-001360'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-18999r362646_fix'
  tag 'documentable'
  tag legacy: ['SV-103917', 'V-93831']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
