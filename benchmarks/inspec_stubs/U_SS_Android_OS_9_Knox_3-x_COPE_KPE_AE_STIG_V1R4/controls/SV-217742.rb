...
Refer to the MDM documentation to determine how to provision users' work email accounts for the work email app.)
  ...
  tag check_id: 'C-18959r362519_chk'
  tag severity: 'medium'
  tag gid: 'V-217742'
  tag rid: 'SV-217742r388482_rule'
  tag stig_id: 'KNOX-09-000020'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-18957r362520_fix'
  tag 'documentable'
  tag legacy: ['SV-103833', 'V-93747']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
