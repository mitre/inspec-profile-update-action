...
On the MDM console, for the device, in the "Knox restrictions" group, verify that "HID" is selected in the "USB host mode exception list". 
...
On the MDM console, for the device, in the "Knox restrictions" group, select "HID" in the "USB host mode exception list".'
  ...
  tag check_id: 'C-18986r362600_chk'
  tag severity: 'medium'
  tag gid: 'V-217769'
  tag rid: 'SV-217769r388482_rule'
  tag stig_id: 'KNOX-09-000750'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-18984r362601_fix'
  tag 'documentable'
  tag legacy: ['SV-103887', 'V-93801']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
