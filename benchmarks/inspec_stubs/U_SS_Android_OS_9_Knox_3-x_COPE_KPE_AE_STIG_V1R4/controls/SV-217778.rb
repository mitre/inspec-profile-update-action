...
On the MDM console, for the Workspace, in the "Android certificate" group, verify that the DoD root and intermediate PKI certificates are listed. 
...
5. Verify that the DoD root and intermediate certificates are listed under the "Work" list in both the "System" and "User" tabs. 
...
On the MDM console, for the Workspace, in the "Android certificate" group, use "install a CA certificate" to install the DoD root and intermediate certificates. 

The current DoD root and intermediate PKI certificates may be obtained in self-extracting zip files at http://iase.disa.mil/pki-pke (for NIPRNet).'
  impact 0.5
  ref 'DPMS Target Samsung Android OS 9 Knox 3-x COPE KPE AE'
  tag check_id: 'C-18995r362627_chk'
  tag severity: 'medium'
  tag gid: 'V-217778'
  tag rid: 'SV-217778r388482_rule'
  tag stig_id: 'KNOX-09-001070'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-18993r362628_fix'
  tag 'documentable'
  tag legacy: ['SV-103905', 'V-93819']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
