...
On the MDM console, for the Workspace, in the "Android lock screen restrictions" group, verify that "max password failures for local wipe" is "10" or fewer. 
...
On the MDM console, for the Workspace, in the "Android lock screen restrictions" group, set "max password failures for local wipe" to "10".'
  impact 0.3
  ref 'DPMS Target Samsung Android OS 9 Knox 3-x COPE KPE AE'
  tag check_id: 'C-18977r362573_chk'
  tag severity: 'low'
  tag gid: 'V-217760'
  tag rid: 'SV-217760r378517_rule'
  tag stig_id: 'KNOX-09-000440'
  tag gtitle: 'PP-MDF-301050'
  tag fix_id: 'F-18975r362574_fix'
  tag 'documentable'
  tag legacy: ['SV-103869', 'V-93783']
  tag cci: ['CCI-000044']
  tag nist: ['AC-7 a']
end
