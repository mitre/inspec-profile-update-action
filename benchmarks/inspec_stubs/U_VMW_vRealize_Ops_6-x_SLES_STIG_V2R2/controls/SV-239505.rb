control 'SV-239505' do
  title 'Bootloader authentication must be enabled to prevent users without privilege to gain access restricted file system resources.'
...
Click "OK" twice to save the changes.)
  ...
  tag check_id: 'C-42738r661964_chk'
  tag severity: 'medium'
  tag gid: 'V-239505'
  tag rid: 'SV-239505r661966_rule'
  tag stig_id: 'VROM-SL-000420'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-42697r661965_fix'
  tag 'documentable'
  tag legacy: ['SV-99131', 'V-88481']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
