...
-a exit,always -F arch=b32 -S creat -F exit=-EACCES'
  ...
  tag check_id: 'C-42864r662342_chk'
  tag severity: 'medium'
  tag gid: 'V-239631'
  tag rid: 'SV-239631r662344_rule'
  tag stig_id: 'VROM-SL-001410'
  tag gtitle: 'SRG-OS-000474-GPOS-00219'
  tag fix_id: 'F-42823r662343_fix'
  tag 'documentable'
  tag legacy: ['SV-99383', 'V-88733']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
