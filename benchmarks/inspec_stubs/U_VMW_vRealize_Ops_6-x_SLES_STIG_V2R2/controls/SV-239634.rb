...
-a exit,always -F arch=b32 -S truncate -F success=0'
  ...
  tag check_id: 'C-42867r662351_chk'
  tag severity: 'medium'
  tag gid: 'V-239634'
  tag rid: 'SV-239634r662353_rule'
  tag stig_id: 'VROM-SL-001425'
  tag gtitle: 'SRG-OS-000474-GPOS-00219'
  tag fix_id: 'F-42826r662352_fix'
  tag 'documentable'
  tag legacy: ['SV-99389', 'V-88739']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
