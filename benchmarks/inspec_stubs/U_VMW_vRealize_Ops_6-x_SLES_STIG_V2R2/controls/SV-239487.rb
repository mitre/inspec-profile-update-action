control 'SV-239487' do
  title 'The SLES for vRealize must generate audit records when successful/unsuccessful attempts to access privileges occur. The SLES for vRealize must generate audit records for all discretionary access control permission modifications using lsetxattr.'
  desc 'Without generating audit records that are specific to the security and mission needs of the organization, it would be difficult to establish, correlate, and investigate the events relating to an incident or identify those responsible for one.

Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', 'To determine if SLES for vRealize is configured to audit calls to the "lsetxattr" system call, run the following command: 
...
# /etc/dodscript.sh'
  ...
  tag check_id: 'C-42720r661910_chk'
  tag severity: 'medium'
  tag gid: 'V-239487'
  tag rid: 'SV-239487r661912_rule'
  tag stig_id: 'VROM-SL-000305'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-42679r661911_fix'
  tag 'documentable'
  tag legacy: ['SV-99095', 'V-88445']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
