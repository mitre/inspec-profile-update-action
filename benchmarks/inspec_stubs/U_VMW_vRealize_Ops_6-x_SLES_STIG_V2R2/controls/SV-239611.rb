...
# service sshd restart'
  ...
  tag check_id: 'C-42844r662282_chk'
  tag severity: 'high'
  tag gid: 'V-239611'
  tag rid: 'SV-239611r877380_rule'
  tag stig_id: 'VROM-SL-001240'
  tag gtitle: 'SRG-OS-000396-GPOS-00176'
  tag fix_id: 'F-42803r662283_fix'
  tag 'documentable'
  tag legacy: ['SV-99343', 'V-88693']
  tag cci: ['CCI-002450']
  tag nist: ['SC-13 b']
end
