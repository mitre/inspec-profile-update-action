...
If no lines are returned, this is a finding.'
  desc 'fix', 'At a minimum, the audit system should collect file permission changes for all users and "root". Add the following to the "/etc/audit/audit.rules" file: 
...
# /etc/dodscript.sh'
  ...
  tag check_id: 'C-42852r662306_chk'
  tag severity: 'medium'
  tag gid: 'V-239619'
  tag rid: 'SV-239619r662308_rule'
  tag stig_id: 'VROM-SL-001350'
  tag gtitle: 'SRG-OS-000462-GPOS-00206'
  tag fix_id: 'F-42811r662307_fix'
  tag 'documentable'
  tag legacy: ['SV-99359', 'V-88709']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
