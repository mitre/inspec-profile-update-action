...
# sed -i '/pam_cracklib.so/ s/difok=./difok=8/' /etc/pam.d/common-password-vmware.local)
  ...
  tag check_id: 'C-42728r661934_chk'
  tag severity: 'medium'
  tag gid: 'V-239495'
  tag rid: 'SV-239495r661936_rule'
  tag stig_id: 'VROM-SL-000360'
  tag gtitle: 'SRG-OS-000072-GPOS-00040'
  tag fix_id: 'F-42687r661935_fix'
  tag 'documentable'
  tag legacy: ['SV-99111', 'V-88461']
  tag cci: ['CCI-000195']
  tag nist: ['IA-5 (1) (b)']
end
