...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', 'To determine if SLES for vRealize is configured to audit calls to the "fchmod" system call, run the following command: 
...
# /etc/dodscript.sh'
  ...
  tag check_id: 'C-42712r661886_chk'
  tag severity: 'medium'
  tag gid: 'V-239479'
  tag rid: 'SV-239479r661888_rule'
  tag stig_id: 'VROM-SL-000265'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-42671r661887_fix'
  tag 'documentable'
  tag legacy: ['SV-99079', 'V-88429']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
