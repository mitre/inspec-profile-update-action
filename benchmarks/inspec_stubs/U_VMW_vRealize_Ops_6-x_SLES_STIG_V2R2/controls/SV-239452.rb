...
Encryption provides a means to secure the remote connection to prevent unauthorized access to the data traversing the remote access connection (e.g., RDP), thereby providing a degree of confidentiality. The encryption strength of a mechanism is selected based on the security categorization of the information.'
  desc 'check', "Check the SSH daemon configuration for DoD-approved encryption to protect the confidentiality of SSH remote connections by performing the following commands:
...
Save and close the file.'
  ...
  tag check_id: 'C-42685r766910_chk'
  tag severity: 'medium'
  tag gid: 'V-239452'
  tag rid: 'SV-239452r877398_rule'
  tag stig_id: 'VROM-SL-000080'
  tag gtitle: 'SRG-OS-000033-GPOS-00014'
  tag fix_id: 'F-42644r661806_fix'
  tag 'documentable'
  tag legacy: ['SV-99025', 'V-88375']
  tag cci: ['CCI-000068']
  tag nist: ['AC-17 (2)']
end
