...
# chgrp root /etc/ntp.conf'
  ...
  tag check_id: 'C-42835r662255_chk'
  tag severity: 'medium'
  tag gid: 'V-239602'
  tag rid: 'SV-239602r877038_rule'
  tag stig_id: 'VROM-SL-001095'
  tag gtitle: 'SRG-OS-000355-GPOS-00143'
  tag fix_id: 'F-42794r662256_fix'
  tag 'documentable'
  tag legacy: ['SV-99325', 'V-88675']
  tag cci: ['CCI-001891']
  tag nist: ['AU-8 (1) (a)']
end
