control 'SV-239482' do
  title 'The SLES for vRealize must generate audit records when successful/unsuccessful attempts to access privileges occur. The SLES for vRealize must generate audit records for all discretionary access control permission modifications using fchownat.'
  desc 'Without generating audit records that are specific to the security and mission needs of the organization, it would be difficult to establish, correlate, and investigate the events relating to an incident or identify those responsible for one.

Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', 'To determine if SLES for vRealize is configured to audit calls to the "fchownat" system call, run the following command: 
...
# /etc/dodscript.sh'
  ...
  tag check_id: 'C-42715r661895_chk'
  tag severity: 'medium'
  tag gid: 'V-239482'
  tag rid: 'SV-239482r661897_rule'
  tag stig_id: 'VROM-SL-000280'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-42674r661896_fix'
  tag 'documentable'
  tag legacy: ['SV-99085', 'V-88435']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
