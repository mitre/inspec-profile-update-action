...
# chmod 0640 <audit log file>'
  ...
  tag check_id: 'C-42692r661826_chk'
  tag severity: 'medium'
  tag gid: 'V-239459'
  tag rid: 'SV-239459r661828_rule'
  tag stig_id: 'VROM-SL-000165'
  tag gtitle: 'SRG-OS-000059-GPOS-00029'
  tag fix_id: 'F-42651r661827_fix'
  tag 'documentable'
  tag legacy: ['SV-99039', 'V-88389']
  tag cci: ['CCI-000164']
  tag nist: ['AU-9 a']
end
