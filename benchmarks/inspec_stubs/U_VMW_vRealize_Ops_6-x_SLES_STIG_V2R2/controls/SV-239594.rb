...
# service auditd restart'
  ...
  tag check_id: 'C-42827r662231_chk'
  tag severity: 'medium'
  tag gid: 'V-239594'
  tag rid: 'SV-239594r852591_rule'
  tag stig_id: 'VROM-SL-000975'
  tag gtitle: 'SRG-OS-000304-GPOS-00121'
  tag fix_id: 'F-42786r662232_fix'
  tag 'documentable'
  tag legacy: ['SV-99309', 'V-88659']
  tag cci: ['CCI-002132']
  tag nist: ['AC-2 (4)']
end
