...
# /etc/dodscript.sh'
  ...
  tag check_id: 'C-42858r662324_chk'
  tag severity: 'medium'
  tag gid: 'V-239625'
  tag rid: 'SV-239625r662326_rule'
  tag stig_id: 'VROM-SL-001380'
  tag gtitle: 'SRG-OS-000470-GPOS-00214'
  tag fix_id: 'F-42817r662325_fix'
  tag 'documentable'
  tag legacy: ['SV-99371', 'V-88721']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
