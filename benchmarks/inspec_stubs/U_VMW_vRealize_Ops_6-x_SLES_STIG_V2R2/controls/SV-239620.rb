control 'SV-239620' do
  title 'The SLES for vRealize must generate audit records when successful/unsuccessful attempts to modify security objects occur.'
...
# /etc/dodscript.sh'
  ...
  tag check_id: 'C-42853r662309_chk'
  tag severity: 'medium'
  tag gid: 'V-239620'
  tag rid: 'SV-239620r662311_rule'
  tag stig_id: 'VROM-SL-001355'
  tag gtitle: 'SRG-OS-000463-GPOS-00207'
  tag fix_id: 'F-42812r662310_fix'
  tag 'documentable'
  tag legacy: ['SV-99361', 'V-88711']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
