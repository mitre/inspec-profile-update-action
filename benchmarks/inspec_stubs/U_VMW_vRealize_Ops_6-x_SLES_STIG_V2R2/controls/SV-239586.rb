control 'SV-239586' do
  title 'The SLES for vRealize must notify System Administrators and Information Systems Security Officer when accounts are created.'
...
#log { source(src); destination(logserver); };'
  ...
  tag check_id: 'C-42819r662207_chk'
  tag severity: 'low'
  tag gid: 'V-239586'
  tag rid: 'SV-239586r662209_rule'
  tag stig_id: 'VROM-SL-000910'
  tag gtitle: 'SRG-OS-000274-GPOS-00104'
  tag fix_id: 'F-42778r662208_fix'
  tag 'documentable'
  tag legacy: ['SV-99293', 'V-88643']
  tag cci: ['CCI-001683']
  tag nist: ['AC-2 (4)']
end
