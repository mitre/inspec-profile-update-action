control 'SV-239446' do
  ...
  desc %q(Display of a standardized and approved use notification before granting access to the SLES for vRealize ensures privacy and security notification verbiage used is consistent with applicable federal laws, Executive Orders, directives, policies, regulations, standards, and guidance.
...
If the output does not contain "Banner /etc/issue", this is a finding.)
  desc 'fix', 'To configure the SSH daemon with the logon warning banners, modify /etc/ssh/sshd_config execute the following command:
...
# service sshd restart'
  ...
  tag check_id: 'C-42679r661787_chk'
  tag severity: 'medium'
  tag gid: 'V-239446'
  tag rid: 'SV-239446r661789_rule'
  tag stig_id: 'VROM-SL-000030'
  tag gtitle: 'SRG-OS-000023-GPOS-00006'
  tag fix_id: 'F-42638r661788_fix'
  tag 'documentable'
  tag legacy: ['SV-99013', 'V-88363']
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
