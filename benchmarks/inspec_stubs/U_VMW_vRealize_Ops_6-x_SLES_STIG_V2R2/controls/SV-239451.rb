...
# service sshd restart'
  ...
  tag check_id: 'C-42684r661802_chk'
  tag severity: 'medium'
  tag gid: 'V-239451'
  tag rid: 'SV-239451r877398_rule'
  tag stig_id: 'VROM-SL-000075'
  tag gtitle: 'SRG-OS-000033-GPOS-00014'
  tag fix_id: 'F-42643r661803_fix'
  tag 'documentable'
  tag legacy: ['SV-99023', 'V-88373']
  tag cci: ['CCI-000068']
  tag nist: ['AC-17 (2)']
end
