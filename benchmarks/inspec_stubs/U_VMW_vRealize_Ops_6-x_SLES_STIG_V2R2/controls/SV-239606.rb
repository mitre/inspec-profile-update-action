...
# service auditd start'
  ...
  tag check_id: 'C-42839r662267_chk'
  tag severity: 'medium'
  tag gid: 'V-239606'
  tag rid: 'SV-239606r852603_rule'
  tag stig_id: 'VROM-SL-001140'
  tag gtitle: 'SRG-OS-000365-GPOS-00152'
  tag fix_id: 'F-42798r662268_fix'
  tag 'documentable'
  tag legacy: ['SV-99333', 'V-88683']
  tag cci: ['CCI-001814']
  tag nist: ['CM-5 (1)']
end
