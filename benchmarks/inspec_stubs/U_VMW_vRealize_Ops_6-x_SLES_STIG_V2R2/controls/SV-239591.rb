...
mesg n 2>/dev/null'
  ...
  tag check_id: 'C-42824r662222_chk'
  tag severity: 'medium'
  tag gid: 'V-239591'
  tag rid: 'SV-239591r852588_rule'
  tag stig_id: 'VROM-SL-000935'
  tag gtitle: 'SRG-OS-000279-GPOS-00109'
  tag fix_id: 'F-42783r662223_fix'
  tag 'documentable'
  tag legacy: ['SV-99303', 'V-88653']
  tag cci: ['CCI-002361']
  tag nist: ['AC-12']
end
