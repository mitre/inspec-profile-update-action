...
If the switch is not configured to drop IPv6 packets containing a Hop-by-Hop header with invalid option type values, this is a finding.'
  desc 'fix', 'Configure the switch to drop IPv6 packets containing a Hop-by-Hop header with invalid option type values as shown in the example below.
...
SW1(config-if)#end'
  ...
  tag check_id: 'C-40978r856259_chk'
  tag severity: 'medium'
  tag gid: 'V-237766'
  tag rid: 'SV-237766r856667_rule'
  tag stig_id: 'CISC-RT-000394'
  tag gtitle: 'SRG-NET-000364-RTR-000202'
  tag fix_id: 'F-40940r856260_fix'
  tag 'documentable'
  tag cci: ['CCI-002403']
  tag nist: ['SC-7 (11)']
end
