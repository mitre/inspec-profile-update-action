control 'SV-228778' do
  title 'Apple iOS/iPadOS must disable "Allow USB drive access in Files app" if the AO has not approved the use of DoD-approved USB storage drives with iOS/iPadOS devices.'
...
If "Allow USB drive access in Files app" is not disabled in both the management tool and on the Apple device, this is a finding.'
  ...
  tag check_id: 'C-31013r569168_chk'
  tag severity: 'medium'
  tag gid: 'V-228778'
  tag rid: 'SV-228778r561031_rule'
  tag stig_id: 'AIOS-14-011700'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-30990r569169_fix'
  tag 'documentable'
