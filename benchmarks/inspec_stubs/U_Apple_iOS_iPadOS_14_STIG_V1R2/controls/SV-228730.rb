control 'SV-228730' do
  title 'The mobile operating system must be configured to not allow passwords that include more than two repeating or sequential characters.'
...
If "Allow simple value" is checked in the Apple iOS/iPadOS management tool, "<key>allowSimple</key> <true/>" appears in the Configuration Profile, or the password policy on the iPhone and iPad does not have "Simple passcodes allowed" set to "No", this is a finding.'
  ...
  tag check_id: 'C-30965r509818_chk'
  tag severity: 'medium'
  tag gid: 'V-228730'
  tag rid: 'SV-228730r561031_rule'
  tag stig_id: 'AIOS-14-000200'
  tag gtitle: 'PP-MDF-301020'
  tag fix_id: 'F-30942r509819_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
