...
If the variables "Protocol 2,1" or "Protocol 1" are defined on a line without a leading comment, this is a finding.'
  ...
  tag check_id: 'C-25718r516534_chk'
  tag severity: 'high'
  tag gid: 'V-224045'
  tag rid: 'SV-224045r561402_rule'
  tag stig_id: 'TSS0-SH-000030'
  tag gtitle: 'SRG-OS-000096-GPOS-00050'
  tag fix_id: 'F-25706r516535_fix'
  tag 'documentable'
  tag legacy: ['V-98797', 'SV-107901']
  tag cci: ['CCI-000382']
  tag nist: ['CM-7 b']
end
