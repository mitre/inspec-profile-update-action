...
'
  desc 'check', 'Examine the system for active exit modules. You may need the system administrator help for this. There are third-party software products that can determine standard and dynamic exits loaded in the system. 
...
Configure ESM data set rules for all WRITE or greater access to libraries containing z/OS and other system level exits will be logged using the ACP’s facilities. Only systems programming personnel will be authorized to update the libraries containing z/OS and other system level exits.'
  ...
  tag check_id: 'C-25587r516141_chk'
  tag severity: 'high'
  tag gid: 'V-223914'
  tag rid: 'SV-223914r856086_rule'
  tag stig_id: 'TSS0-ES-000410'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25575r516142_fix'
