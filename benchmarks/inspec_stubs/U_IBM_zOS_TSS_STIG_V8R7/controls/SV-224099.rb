...
Alternately, the /etc/banner file may be used in accordance with DISA requirements.'
  ...
  tag check_id: 'C-25772r572007_chk'
  tag severity: 'medium'
  tag gid: 'V-224099'
  tag rid: 'SV-224099r695479_rule'
  tag stig_id: 'TSS0-UT-000010'
  tag gtitle: 'SRG-OS-000024-GPOS-00007'
  tag fix_id: 'F-25760r695478_fix'
  tag satisfies: ['SRG-OS-000024-GPOS-00007', 'SRG-OS-000023-GPOS-00006']
  tag 'documentable'
  tag legacy: ['SV-108009', 'V-98905']
