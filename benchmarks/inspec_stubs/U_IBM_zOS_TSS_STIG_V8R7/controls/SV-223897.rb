control 'SV-223897' do
  title 'CA-TSS must limit WRITE or greater access to all APF-authorized libraries to system programmers only.'
...
Configure WRITE or greater access to all APF-authorized libraries to be limited to system programmers only and all WRITE or greater access is logged.'
  ...
  tag check_id: 'C-25570r516090_chk'
  tag severity: 'high'
  tag gid: 'V-223897'
  tag rid: 'SV-223897r856068_rule'
  tag stig_id: 'TSS0-ES-000240'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25558r516091_fix'
  tag satisfies: ['SRG-OS-000080-GPOS-00048', 'SRG-OS-000259-GPOS-00100', 'SRG-OS-000324-GPOS-00125']
  tag 'documentable'
  tag legacy: ['V-98501', 'SV-107605']
