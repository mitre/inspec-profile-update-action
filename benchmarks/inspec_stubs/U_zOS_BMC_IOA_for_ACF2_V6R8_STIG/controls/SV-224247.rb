control 'SV-224247' do
  title 'BMC IOA resources will be properly defined and protected.'
...
- uid(*) prevent)
  ...
  tag check_id: 'C-25920r868175_chk'
  tag severity: 'medium'
  tag gid: 'V-224247'
  tag rid: 'SV-224247r868177_rule'
  tag stig_id: 'ZIOAA020'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-25908r868176_fix'
  tag 'documentable'
  tag legacy: ['SV-32064', 'V-17947']
