...
# /opt/vmware/sbin/vami-lighttpd -p -f /opt/vmware/etc/lighttpd/lighttpd.conf 2>/dev/null|grep "dir-listing.activate"|sed 's: ::g'
...
# vmon-cli --restart applmgmt'
  ...
  tag check_id: 'C-60339r888512_chk'
  tag severity: 'medium'
  tag gid: 'V-256664'
  tag rid: 'SV-256664r888514_rule'
  tag stig_id: 'VCLD-70-000020'
  tag gtitle: 'SRG-APP-000266-WSR-000142'
  tag fix_id: 'F-60282r888513_fix'
  tag 'documentable'
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
end
