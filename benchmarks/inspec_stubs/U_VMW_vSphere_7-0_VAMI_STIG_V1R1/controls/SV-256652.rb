control 'SV-256652' do
  title 'The rsyslog must be configured to monitor VAMI logs.'
  desc 'For performance reasons, rsyslog file monitoring is preferred over configuring VAMI to send events to a syslog facility. Without ensuring that logs are created, rsyslog configs are created, and those configs are loaded, the log file monitoring and shipping will not be effective.
...
#statsmonitor-alarms
input(type="imfile"
      File="/var/log/vmware/applmgmt/statsmonitor-alarms.log"
      Tag="statsmonitor-alarms"
      Severity="info"
      Facility="local0")
#StatsMonitor
input(type="imfile"
