...
'
  desc 'check', %q(To check if the system is configured to disable access to the Wallet & ApplePay preference pane and prevent it from being displayed, run the following command:
...
If the return is not two arrays (HiddenPreferencePanes and DisabledPreferencePanes) each containing: "com.apple.preferences.wallet", this is a finding.)
  ...
  tag check_id: 'C-55965r816339_chk'
  tag severity: 'medium'
  tag gid: 'V-252509'
  tag rid: 'SV-252509r853295_rule'
  tag stig_id: 'APPL-12-002052'
  tag gtitle: 'SRG-OS-000370-GPOS-00155'
  tag fix_id: 'F-55915r816340_fix'
