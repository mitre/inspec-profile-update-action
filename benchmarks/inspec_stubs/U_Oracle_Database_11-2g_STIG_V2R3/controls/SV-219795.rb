...
Scalability, practicality, and security are simultaneously considered in balancing the need to ensure ease of use for access to federal information and information systems with the need to protect and adequately mitigate risk to organizational operations, organizational assets, individuals, other organizations, and the Nation.'
  desc 'check', 'Review DBMS settings to determine whether non-organizational users are uniquely identified and authenticated when logging onto the system. If non-organizational users are not uniquely identified and authenticated, this is a finding.'
  ...
  tag check_id: 'C-21520r307234_chk'
  tag severity: 'medium'
  tag gid: 'V-219795'
  tag rid: 'SV-219795r397609_rule'
  tag stig_id: 'O112-P2-015800'
  tag gtitle: 'SRG-APP-000180-DB-000115'
  tag fix_id: 'F-21519r307235_fix'
  tag 'documentable'
  tag legacy: ['SV-66671', 'V-52455']
  tag cci: ['CCI-000804']
  tag nist: ['IA-8']
end
