...
<oracle_home>/RDBMS/ADMIN/utlpwdmg.sql.  This can be used as the starting point for a customized function.)'
  ...
  tag check_id: 'C-41674r667561_chk'
  tag severity: 'medium'
  tag gid: 'V-238463'
  tag rid: 'SV-238463r667563_rule'
  tag stig_id: 'O112-C2-014100'
  tag gtitle: 'SRG-APP-000164-DB-000401'
  tag fix_id: 'F-41633r667562_fix'
  tag 'documentable'
  tag legacy: ['V-52275', 'SV-66491']
  tag cci: ['CCI-000192']
  tag nist: ['IA-5 (1) (a)']
end
