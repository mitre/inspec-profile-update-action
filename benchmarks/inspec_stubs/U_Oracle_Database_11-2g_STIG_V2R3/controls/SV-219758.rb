...
http://docs.oracle.com/cd/E11882_01/appdev.112/e40758/d_audit_mgmt.htm)
  ...
  tag check_id: 'C-21483r307123_chk'
  tag severity: 'medium'
  tag gid: 'V-219758'
  tag rid: 'SV-219758r395733_rule'
  tag stig_id: 'O112-C2-007800'
  tag gtitle: 'SRG-APP-000099-DB-000043'
  tag fix_id: 'F-21482r307124_fix'
  tag 'documentable'
  tag legacy: ['SV-66695', 'V-52479']
  tag cci: ['CCI-000134']
  tag nist: ['AU-3 e']
end
