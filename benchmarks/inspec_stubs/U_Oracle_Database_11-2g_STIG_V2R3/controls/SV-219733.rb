...
Authorize and document user access requirements to the directory outside of the Oracle, DBA, and SA account list in the System Security Plan.'
  ...
  tag check_id: 'C-21458r307048_chk'
  tag severity: 'medium'
  tag gid: 'V-219733'
  tag rid: 'SV-219733r401224_rule'
  tag stig_id: 'O112-BP-025101'
  tag gtitle: 'SRG-APP-000516-DB-000363'
  tag fix_id: 'F-21457r307049_fix'
  tag 'documentable'
  tag legacy: ['SV-72025', 'V-57615']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
