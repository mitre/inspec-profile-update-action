...
(Note:  in most cases no fix will be necessary.  This is default functionality for Oracle.)'
  ...
  tag check_id: 'C-41649r667486_chk'
  tag severity: 'medium'
  tag gid: 'V-238438'
  tag rid: 'SV-238438r667488_rule'
  tag stig_id: 'O112-C2-003000'
  tag gtitle: 'SRG-APP-000328-DB-000301'
  tag fix_id: 'F-41608r667487_fix'
  tag 'documentable'
  tag legacy: ['V-52367', 'SV-66583']
  tag cci: ['CCI-002165']
  tag nist: ['AC-3 (4)']
end
