...
http://docs.oracle.com/cd/E11882_01/appdev.112/e40758/d_audit_mgmt.htm)
  ...
  tag check_id: 'C-21484r307126_chk'
  tag severity: 'medium'
  tag gid: 'V-219759'
  tag rid: 'SV-219759r395736_rule'
  tag stig_id: 'O112-C2-007900'
  tag gtitle: 'SRG-APP-000100-DB-000201'
  tag fix_id: 'F-21483r307127_fix'
  tag 'documentable'
  tag legacy: ['SV-66367', 'V-52151']
  tag cci: ['CCI-001487']
  tag nist: ['AU-3 f']
end
