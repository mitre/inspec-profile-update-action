...
When group accounts are utilized without another means of identifying individual users, users may deny having performed a particular action."
  desc 'check', 'Review DBMS settings, OS settings, and/or enterprise-level authentication/access mechanism settings to determine whether group accounts exist. If group accounts do not exist, this is NA. 
...
5)  Make sure the Authentication Scheme is set to x509Scheme.'
  desc 'fix', 'Configure DBMS, OS and/or enterprise-level authentication/access mechanism to require individual authentication prior to authentication for group account access.
...
If appropriate, install Oracle Access Manager to provide multifactor authentication of applications front-ending Oracle Databases and using group accounts.  After installation, use x509 Authentication modules provided out of the box.'
  ...
  tag check_id: 'C-41670r667549_chk'
  tag severity: 'medium'
  tag gid: 'V-238459'
  tag rid: 'SV-238459r667551_rule'
  tag stig_id: 'O112-C2-013300'
  tag gtitle: 'SRG-APP-000148-DB-000103'
  tag fix_id: 'F-41629r667550_fix'
  tag 'documentable'
  tag legacy: ['V-52263', 'SV-66479']
  tag cci: ['CCI-000764']
  tag nist: ['IA-2']
end
