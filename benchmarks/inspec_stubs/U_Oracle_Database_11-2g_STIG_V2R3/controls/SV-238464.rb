...
For each password verification function, examine its source code.  If it does not enforce the organization-defined minimum number of lower-case characters (1 unless otherwise specified), this is a finding."
...
<oracle_home>/RDBMS/ADMIN/utlpwdmg.sql.  This can be used as the starting point for a customized function.)'
  ...
  tag check_id: 'C-41675r667564_chk'
  tag severity: 'medium'
  tag gid: 'V-238464'
  tag rid: 'SV-238464r667566_rule'
  tag stig_id: 'O112-C2-014200'
  tag gtitle: 'SRG-APP-000164-DB-000401'
  tag fix_id: 'F-41634r667565_fix'
  tag 'documentable'
  tag legacy: ['V-52277', 'SV-66493']
  tag cci: ['CCI-000192']
  tag nist: ['IA-5 (1) (a)']
end
