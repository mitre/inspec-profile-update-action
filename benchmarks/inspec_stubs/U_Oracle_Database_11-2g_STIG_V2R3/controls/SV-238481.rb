...
SQL> select * from dba_role_privs where granted_role = 'DBA';"
  ...
  tag check_id: 'C-41692r667615_chk'
  tag severity: 'medium'
  tag gid: 'V-238481'
  tag rid: 'SV-238481r667617_rule'
  tag stig_id: 'O112-OS-011200'
  tag gtitle: 'SRG-APP-000133-DB-000179'
  tag fix_id: 'F-41651r667616_fix'
  tag 'documentable'
  tag legacy: ['V-52429', 'SV-66645']
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
end
