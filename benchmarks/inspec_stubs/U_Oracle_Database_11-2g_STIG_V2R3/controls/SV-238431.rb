...
Document all DBA group accounts and individual DBA account assigned privileges in the System Security Plan.'
  ...
  tag check_id: 'C-41642r667465_chk'
  tag severity: 'high'
  tag gid: 'V-238431'
  tag rid: 'SV-238431r667467_rule'
  tag stig_id: 'O112-C1-004500'
  tag gtitle: 'SRG-APP-000516-DB-000363'
  tag fix_id: 'F-41601r667466_fix'
  tag 'documentable'
  tag legacy: ['V-52125', 'SV-66341']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
