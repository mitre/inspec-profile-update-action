...
(Note: This assumes that a single sqlnet.ora file, in the default location, is in use. Please see the supplemental file "Non-default sqlnet.ora configurations.pdf" for how to find multiple and/or differently located sqlnet.ora files.)'
  ...
  tag check_id: 'C-41680r667579_chk'
  tag severity: 'medium'
  tag gid: 'V-238469'
  tag rid: 'SV-238469r667581_rule'
  tag stig_id: 'O112-C2-015100'
  tag gtitle: 'SRG-APP-000516-DB-000363'
  tag fix_id: 'F-41639r667580_fix'
  tag 'documentable'
  tag legacy: ['V-52289', 'SV-66505']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
