...
The DBA should be able to relate the significance of the presence of a digit in the SID.'
  ...
  tag check_id: 'C-21421r306937_chk'
  tag severity: 'medium'
  tag gid: 'V-219696'
  tag rid: 'SV-219696r401224_rule'
  tag stig_id: 'O112-BP-021300'
  tag gtitle: 'SRG-APP-000516-DB-000363'
  tag fix_id: 'F-21420r306938_fix'
  tag 'documentable'
  tag legacy: ['SV-68203', 'V-53963']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
