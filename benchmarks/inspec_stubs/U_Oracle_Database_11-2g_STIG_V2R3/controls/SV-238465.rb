...
<oracle_home>/RDBMS/ADMIN/utlpwdmg.sql.  This can be used as the starting point for a customized function.)'
  ...
  tag check_id: 'C-41676r667567_chk'
  tag severity: 'medium'
  tag gid: 'V-238465'
  tag rid: 'SV-238465r667569_rule'
  tag stig_id: 'O112-C2-014300'
  tag gtitle: 'SRG-APP-000164-DB-000401'
  tag fix_id: 'F-41635r667568_fix'
  tag 'documentable'
  tag legacy: ['V-52279', 'SV-66495']
  tag cci: ['CCI-000192']
  tag nist: ['IA-5 (1) (a)']
end
