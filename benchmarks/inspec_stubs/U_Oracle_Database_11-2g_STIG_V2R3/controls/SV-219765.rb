...
If an attacker were to gain access to audit tools he could analyze audit logs for system weaknesses or weaknesses in the auditing itself. An attacker could also manipulate logs to hide evidence of malicious activity.'
  desc 'check', 'Review access permissions to tools used to view or modify audit log data. These tools may include the DBMS itself or tools external to the database. If appropriate permissions and access controls are not applied to prevent unauthorized modification of these tools, this is a finding.'
  ...
  tag check_id: 'C-21490r307144_chk'
  tag severity: 'medium'
  tag gid: 'V-219765'
  tag rid: 'SV-219765r395832_rule'
  tag stig_id: 'O112-C2-009700'
  tag gtitle: 'SRG-APP-000122-DB-000203'
  tag fix_id: 'F-21489r307145_fix'
  tag 'documentable'
  tag legacy: ['SV-66413', 'V-52197']
  tag cci: ['CCI-001494']
  tag nist: ['AU-9']
end
