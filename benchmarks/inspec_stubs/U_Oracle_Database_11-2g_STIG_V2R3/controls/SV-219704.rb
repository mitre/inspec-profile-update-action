...
The above SQL*Plus command will set the parameter to take effect at next system startup.'
  ...
  tag check_id: 'C-21429r306961_chk'
  tag severity: 'medium'
  tag gid: 'V-219704'
  tag rid: 'SV-219704r401224_rule'
  tag stig_id: 'O112-BP-022100'
  tag gtitle: 'SRG-APP-000516-DB-000363'
  tag fix_id: 'F-21428r306962_fix'
  tag 'documentable'
  tag legacy: ['SV-68219', 'V-53979']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
