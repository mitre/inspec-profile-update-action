...
Some of the ways databases can limit their exposure to DoS attacks are through limiting the number of connections that can be opened by a single user and database clustering."
  desc 'check', 'Review DBMS settings to verify the DBMS implements measures to limit the effects of the organization-defined types of Denial of Service (DoS) attacks. If measures have not been implemented, this is a finding.
...
Modify the $ORACLE_HOME/network/admin/listener.ora to establish a Rate Limit.'
  ...
  tag check_id: 'C-41688r667603_chk'
  tag severity: 'medium'
  tag gid: 'V-238477'
  tag rid: 'SV-238477r667605_rule'
  tag stig_id: 'O112-C2-019100'
  tag gtitle: 'SRG-APP-000001-DB-000031'
  tag fix_id: 'F-41647r667604_fix'
  tag 'documentable'
  tag legacy: ['V-52161', 'SV-66377']
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
end
