...
Disable access to operating system commands from within the DBMS, or document the need for this capability.'
  ...
  tag check_id: 'C-21496r307162_chk'
  tag severity: 'medium'
  tag gid: 'V-219771'
  tag rid: 'SV-219771r395853_rule'
  tag stig_id: 'O112-C2-011800'
  tag gtitle: 'SRG-APP-000141-DB-000093'
  tag fix_id: 'F-21495r307163_fix'
  tag 'documentable'
  tag legacy: ['SV-66453', 'V-52237']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
