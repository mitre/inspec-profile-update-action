...
If currently running 11.2.x, upgrade to the terminal release (11.2.0.4) for the DB Release you are running and then continue the upgrade process by upgrading to the 19c.'
  impact 0.7
  ref 'DPMS Target Oracle Database 11.2g'
  tag check_id: 'C-55261r810844_chk'
  tag severity: 'high'
  tag gid: 'V-251801'
  tag rid: 'SV-251801r810846_rule'
  tag stig_id: 'O112-BP-024750'
  tag gtitle: 'SRG-APP-000456-DB-000400'
  tag fix_id: 'F-55215r810974_fix'
  tag 'documentable'
  tag cci: ['CCI-002605']
  tag nist: ['SI-2 c']
end
