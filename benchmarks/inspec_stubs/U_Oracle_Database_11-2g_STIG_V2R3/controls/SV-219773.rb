...
Database Management Systems using ports, protocols, and services deemed unsafe are open to attack through those ports, protocols, and services. This can allow unauthorized access to the database and through the database to other components of the information system.'
  desc 'check', 'Review the DBMS settings for functions, ports, protocols, and services that are not approved. If any are found, this is a finding.
...
$ lsnrctl stat'
  ...
  tag check_id: 'C-21498r307168_chk'
  tag severity: 'medium'
  tag gid: 'V-219773'
  tag rid: 'SV-219773r395856_rule'
  tag stig_id: 'O112-C2-011900'
  tag gtitle: 'SRG-APP-000142-DB-000094'
  tag fix_id: 'F-21497r307169_fix'
  tag 'documentable'
  tag legacy: ['SV-66455', 'V-52239']
  tag cci: ['CCI-000382']
  tag nist: ['CM-7 b']
end
