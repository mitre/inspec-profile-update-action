...
If Oracle Database Vault is not in use, configure the correct access privileges for each type of user using Roles and Profiles.'
  ...
  tag check_id: 'C-21475r307099_chk'
  tag severity: 'medium'
  tag gid: 'V-219750'
  tag rid: 'SV-219750r395499_rule'
  tag stig_id: 'O112-C2-002700'
  tag gtitle: 'SRG-APP-000033-DB-000084'
  tag fix_id: 'F-21474r307100_fix'
  tag 'documentable'
  tag legacy: ['SV-66581', 'V-52365']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
