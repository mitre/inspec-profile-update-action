...
Administrative data includes DBMS metadata and other configuration and management data.  Unauthorized access to this data could result in unauthorized changes to database objects, access controls, or DBMS configuration.'
  desc 'check', "Review user privileges to system tables and configuration data stored in the Oracle database. If non-DBA users are assigned privileges to access system tables and tables containing configuration data, this is a finding.
...
and grantee = '<applicable account>';"
  ...
  tag check_id: 'C-41654r667501_chk'
  tag severity: 'medium'
  tag gid: 'V-238443'
  tag rid: 'SV-238443r667503_rule'
  tag stig_id: 'O112-C2-003900'
  tag gtitle: 'SRG-APP-000243-DB-000374'
  tag fix_id: 'F-41613r667502_fix'
  tag 'documentable'
  tag legacy: ['V-52379', 'SV-66595']
  tag cci: ['CCI-001090']
  tag nist: ['SC-4']
end
