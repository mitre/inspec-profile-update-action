...
If the Oracle Data Masking Pack and Enterprise Manager are not available, develop site-specific procedures to manage and obfuscate sensitive data.'
  ...
  tag check_id: 'C-21508r307198_chk'
  tag severity: 'medium'
  tag gid: 'V-219783'
  tag rid: 'SV-219783r397765_rule'
  tag stig_id: 'O112-C2-018900'
  tag gtitle: 'SRG-APP-000243-DB-000128'
  tag fix_id: 'F-21507r307199_fix'
  tag 'documentable'
  tag legacy: ['SV-66373', 'V-52157']
  tag cci: ['CCI-001090']
  tag nist: ['SC-4']
end
