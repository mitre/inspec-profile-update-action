control 'SV-86057' do
  title 'The CA API Gateway providing user authentication intermediary services must implement multifactor authentication for remote access to privileged accounts such that one of the factors is provided by a device separate from the system gaining access.'
...
Configure additional Registered Services in a similar fashion in accordance with organizational requirements.'
  ...
  tag check_id: 'C-71823r1_chk'
  tag severity: 'medium'
  tag gid: 'V-71433'
  tag rid: 'SV-86057r1_rule'
  tag stig_id: 'CAGW-GW-000620'
  tag gtitle: 'SRG-NET-000340-ALG-000091'
  tag fix_id: 'F-77751r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001948']
  tag nist: ['IA-2 (11)']
end
