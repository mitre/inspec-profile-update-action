control 'SV-254034' do
  title 'The Juniper router must be configured to have Internet Control Message Protocol (ICMP) unreachable notifications disabled on all external interfaces.'
...
set interfaces <interface name> unit <number> family inet address <IPv4 address>.<mask>'
  ...
  tag check_id: 'C-57486r844133_chk'
  tag severity: 'medium'
  tag gid: 'V-254034'
  tag rid: 'SV-254034r844135_rule'
  tag stig_id: 'JUEX-RT-000620'
  tag gtitle: 'SRG-NET-000362-RTR-000113'
  tag fix_id: 'F-57437r844134_fix'
  tag 'documentable'
  tag cci: ['CCI-002385']
  tag nist: ['SC-5 a']
end
