control 'SV-254007' do
  title 'The Juniper PE router must be configured to enforce a Quality-of-Service (QoS) policy in accordance with the QoS DODIN Technical Profile.'
...
set class-of-service schedulers Default priority strict-high'
  ...
  tag check_id: 'C-57459r844052_chk'
  tag severity: 'low'
  tag gid: 'V-254007'
  tag rid: 'SV-254007r844054_rule'
  tag stig_id: 'JUEX-RT-000350'
  tag gtitle: 'SRG-NET-000193-RTR-000113'
  tag fix_id: 'F-57410r844053_fix'
  tag 'documentable'
  tag cci: ['CCI-001095']
  tag nist: ['SC-5 (2)']
end
