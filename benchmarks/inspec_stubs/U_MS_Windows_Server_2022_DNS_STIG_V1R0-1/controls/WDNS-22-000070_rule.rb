control 'WDNS-22-000070_rule' do
  title 'The Windows 2022 DNS Server must maintain the integrity of information during preparation for transmission.'
...
From the expanded list, right-click to select the zone (repeat for each hosted zone), point to DNSSEC, and then click "Sign the Zone" using either approved saved parameters or approved custom parameters.'
  impact 0.5
  tag check_id: 'C-WDNS-22-000070_chk'
  tag severity: 'medium'
  tag gid: 'WDNS-22-000070'
  tag rid: 'WDNS-22-000070_rule'
  tag stig_id: 'WDNS-22-000070'
  tag gtitle: 'SRG-APP-000441-DNS-000066'
  tag fix_id: 'F-WDNS-22-000070_fix'
  tag 'documentable'
  tag cci: ['CCI-002420']
  tag nist: ['SC-8 (2)']
end
