control 'WDNS-22-000059_rule' do
...
From the expanded list, right-click to select the zone (repeat for each hosted zone), point to DNSSEC, and then click "Sign the Zone" using either approved saved parameters or approved custom parameters.'
  impact 0.5
  tag check_id: 'C-WDNS-22-000059_chk'
  tag severity: 'medium'
  tag gid: 'WDNS-22-000059'
  tag rid: 'WDNS-22-000059_rule'
  tag stig_id: 'WDNS-22-000059'
  tag gtitle: 'SRG-APP-000425-DNS-000058'
  tag fix_id: 'F-WDNS-22-000059_fix'
  tag 'documentable'
  tag cci: ['CCI-002467']
  tag nist: ['SC-21']
end
