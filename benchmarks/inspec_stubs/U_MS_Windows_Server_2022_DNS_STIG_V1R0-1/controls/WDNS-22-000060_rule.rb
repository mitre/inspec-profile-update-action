control 'WDNS-22-000060_rule' do
  title 'The Windows DNS secondary server must validate data origin verification authentication on the name/address resolution responses received from primary name servers.'
...
From the expanded list, right-click to select the zone (repeat for each hosted zone), point to DNSSEC, and then click "Sign the Zone" using either approved saved parameters or approved custom parameters.'
  impact 0.5
  tag check_id: 'C-WDNS-22-000060_chk'
  tag severity: 'medium'
  tag gid: 'WDNS-22-000060'
  tag rid: 'WDNS-22-000060_rule'
  tag stig_id: 'WDNS-22-000060'
  tag gtitle: 'SRG-APP-000426-DNS-000059'
  tag fix_id: 'F-WDNS-22-000060_fix'
  tag 'documentable'
  tag cci: ['CCI-002468']
  tag nist: ['SC-21']
end
