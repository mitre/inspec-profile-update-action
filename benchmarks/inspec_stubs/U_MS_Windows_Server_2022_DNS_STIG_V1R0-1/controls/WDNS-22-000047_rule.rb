control 'WDNS-22-000047_rule' do
  title 'The Windows 2022 DNS Server must return data information in response to internal name/address resolution queries.'
...
From the expanded list, right-click to select the zone (repeat for each hosted zone), point to DNSSEC, and then click "Sign the Zone" using either approved saved parameters or approved custom parameters.'
  impact 0.5
  tag check_id: 'C-WDNS-22-000047_chk'
  tag severity: 'medium'
  tag gid: 'WDNS-22-000047'
  tag rid: 'WDNS-22-000047_rule'
  tag stig_id: 'WDNS-22-000047'
  tag gtitle: 'SRG-APP-000420-DNS-000053'
  tag fix_id: 'F-WDNS-22-000047_fix'
  tag 'documentable'
