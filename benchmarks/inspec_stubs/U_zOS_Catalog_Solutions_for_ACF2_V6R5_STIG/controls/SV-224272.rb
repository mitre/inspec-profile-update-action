...
d) If any of the above is true, this is a finding.'
  desc 'fix', 'The ISSO will ensure that update and allocate access to program product data sets is limited to system programmers only, unless a letter justifying access is filed with the ISSO, and all update and allocate access is logged.
...
Properly securing the use of various commands and features is crucial. All Catalog Solution functions should be reviewed for potential security exposures and to prevent unauthorized use. Some Catalog Solution functions allow for bypassing of security controls, and as such shall be restricted to system programmers who perform in the specific role of Storage management.'
  ...
  tag check_id: 'C-25945r868113_chk'
  tag severity: 'medium'
  tag gid: 'V-224272'
  tag rid: 'SV-224272r868115_rule'
  tag stig_id: 'ZCSLA000'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-25933r868114_fix'
  tag 'documentable'
  tag legacy: ['V-16932', 'SV-19580']
