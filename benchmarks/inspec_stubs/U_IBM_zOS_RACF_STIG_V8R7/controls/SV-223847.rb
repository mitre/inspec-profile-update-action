...
chaudit rwx=f /bin'
  ...
  tag check_id: 'C-25520r515229_chk'
  tag severity: 'medium'
  tag gid: 'V-223847'
  tag rid: 'SV-223847r604139_rule'
  tag stig_id: 'RACF-US-000100'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25508r515230_fix'
  tag satisfies: ['SRG-OS-000080-GPOS-00048', 'SRG-OS-000259-GPOS-00100']
  tag 'documentable'
  tag legacy: ['V-98401', 'SV-107505']
