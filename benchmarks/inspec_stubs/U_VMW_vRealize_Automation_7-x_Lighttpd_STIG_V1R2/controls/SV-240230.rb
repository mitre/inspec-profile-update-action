...
chmod 640 /opt/vmware/var/log/lighttpd/*.log'
  ...
  tag check_id: 'C-43463r667865_chk'
  tag severity: 'medium'
  tag gid: 'V-240230'
  tag rid: 'SV-240230r879577_rule'
  tag stig_id: 'VRAU-LI-000120'
  tag gtitle: 'SRG-APP-000119-WSR-000069'
  tag fix_id: 'F-43422r667866_fix'
  tag 'documentable'
  tag legacy: ['SV-100977', 'V-90327']
  tag cci: ['CCI-000163']
  tag nist: ['AU-9 a']
end
