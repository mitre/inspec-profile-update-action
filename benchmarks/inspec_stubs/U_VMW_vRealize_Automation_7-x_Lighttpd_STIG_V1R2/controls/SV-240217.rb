...
ssl.engine = "enable"'
  ...
  tag check_id: 'C-43450r667826_chk'
  tag severity: 'medium'
  tag gid: 'V-240217'
  tag rid: 'SV-240217r879520_rule'
  tag stig_id: 'VRAU-LI-000020'
  tag gtitle: 'SRG-APP-000015-WSR-000014'
  tag fix_id: 'F-43409r667827_fix'
  tag 'documentable'
  tag legacy: ['SV-99873', 'V-89223']
  tag cci: ['CCI-001453']
  tag nist: ['AC-17 (2)']
end
