control 'SV-217158' do
  title 'The SUSE operating system Apparmor tool must be configured to control whitelisted applications and user home directory access control.'
...
Note: "pam_apparmor" must have properly configured profiles. All configurations will be based on the actual system setup and organization. See the "pam_apparmor" documentation for more information on configuring profiles.'
  ...
  tag check_id: 'C-18386r646717_chk'
  tag severity: 'medium'
  tag gid: 'V-217158'
  tag rid: 'SV-217158r646719_rule'
  tag stig_id: 'SLES-12-010600'
  tag gtitle: 'SRG-OS-000312-GPOS-00122'
  tag fix_id: 'F-18384r646718_fix'
  tag satisfies: ['SRG-OS-000312-GPOS-00122', 'SRG-OS-000312-GPOS-00123SRG-OS-000312-GPOS-00124', 'SRG-OS-000324-GPOS-00125', 'SRG-OS-000326-GPOS-00126', 'SRG-OS-000370-GPOS-00155', 'SRG-OS-000480-GPOS-00230']
  tag 'documentable'
  tag legacy: ['SV-91865', 'V-77169']
  tag cci: ['CCI-001774', 'CCI-002165', 'CCI-002233', 'CCI-002235']
  tag nist: ['CM-7 (5) (b)', 'AC-3 (4)', 'AC-6 (8)', 'AC-6 (10)']
end
