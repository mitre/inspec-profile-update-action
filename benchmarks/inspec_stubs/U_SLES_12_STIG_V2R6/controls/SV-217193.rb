control 'SV-217193' do
  ...
  desc 'check', 'Determine if the SUSE operating system auditd is configured to notify the System Administrator (SA) and Information System Security Officer (ISSO) when the audit record storage volume reaches 75 percent of the storage capacity.
...
Set the value of the "space_left" keyword in "/etc/audit/auditd.conf" to 25 percent of the partition size.'
  ...
  tag check_id: 'C-18421r369735_chk'
  tag severity: 'medium'
  tag gid: 'V-217193'
  tag rid: 'SV-217193r603262_rule'
  tag stig_id: 'SLES-12-020030'
  tag gtitle: 'SRG-OS-000343-GPOS-00134'
  tag fix_id: 'F-18419r369736_fix'
  tag 'documentable'
  tag legacy: ['SV-91989', 'V-77293']
  tag cci: ['CCI-001855']
  tag nist: ['AU-5 (1)']
end
