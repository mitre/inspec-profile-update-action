...
For every world-writable directory, replace "/tmp" in the command above with the world-writable directory that does not have the sticky bit set.'
  ...
  tag check_id: 'C-18375r369597_chk'
  tag severity: 'medium'
  tag gid: 'V-217147'
  tag rid: 'SV-217147r603262_rule'
  tag stig_id: 'SLES-12-010460'
  tag gtitle: 'SRG-OS-000138-GPOS-00069'
  tag fix_id: 'F-18373r369598_fix'
  tag 'documentable'
  tag legacy: ['SV-91845', 'V-77149']
  tag cci: ['CCI-001090']
  tag nist: ['SC-4']
end
