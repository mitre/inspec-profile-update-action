control 'SV-217280' do
  title 'The SUSE operating system SSH daemon must disable forwarded remote X connections for interactive users, unless to fulfill documented and validated mission requirements.'
...
If the "X11Forwarding" keyword is set to "yes" and is not documented with the Information System Security Officer (ISSO) as an operational requirement, is missing, or is commented out, this is a finding.'
  desc 'fix', 'Configure the SUSE operating system SSH daemon to disable forwarded X connections for interactive users.
...
X11Forwarding no'
  ...
  tag check_id: 'C-18508r622426_chk'
  tag severity: 'medium'
  tag gid: 'V-217280'
  tag rid: 'SV-217280r603964_rule'
  tag stig_id: 'SLES-12-030260'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-18506r622427_fix'
  tag 'documentable'
  tag legacy: ['SV-92169', 'V-77473']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
