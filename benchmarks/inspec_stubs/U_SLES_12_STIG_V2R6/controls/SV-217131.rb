...
The DoD requirement is 60 days.'
  ...
  tag check_id: 'C-18359r646702_chk'
  tag severity: 'medium'
  tag gid: 'V-217131'
  tag rid: 'SV-217131r646704_rule'
  tag stig_id: 'SLES-12-010290'
  tag gtitle: 'SRG-OS-000076-GPOS-00044'
  tag fix_id: 'F-18357r646703_fix'
  tag 'documentable'
  tag legacy: ['SV-91813', 'V-77117']
  tag cci: ['CCI-000199']
  tag nist: ['IA-5 (1) (d)']
end
