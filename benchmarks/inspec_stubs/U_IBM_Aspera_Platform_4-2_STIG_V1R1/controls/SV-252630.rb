control 'SV-252630' do
  title 'The IBM Aspera High-Speed Transfer Server must be configured to use NIST FIPS-validated cryptography to protect the integrity of remote access sessions.'
...
'
  desc 'check', 'Ensure that FIPS compliance is required for all transfers by the IBM Aspera High-Speed Transfer Server with the following command:
...
If results are blank or fips mode is reported as "false", this is a finding.'
  desc 'fix', 'For implementations using IBM Aspera High-Speed Transfer Server, configure FIPS compliance criteria to all transfers by executing the following command:
...
$ sudo systemctl restart asperanoded.service'
  ...
  tag check_id: 'C-56086r818058_chk'
  tag severity: 'high'
  tag gid: 'V-252630'
  tag rid: 'SV-252630r818060_rule'
  tag stig_id: 'ASP4-TS-020140'
  tag gtitle: 'SRG-NET-000062-ALG-000011'
  tag fix_id: 'F-56036r818059_fix'
