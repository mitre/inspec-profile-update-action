control 'SV-252595' do
  title 'The IBM Aspera Faspex Server must restrict users from using transfer services by default.'
...
If the results produce an "allow" value, this is a finding.'
  desc 'fix', 'Configure the IBM Aspera Faspex to restrict users from using transfer services by default with the following commands:
...
$ sudo systemctl restart asperanoded.service'
  ...
  tag check_id: 'C-56051r817953_chk'
  tag severity: 'medium'
  tag gid: 'V-252595'
  tag rid: 'SV-252595r817955_rule'
  tag stig_id: 'ASP4-FA-050310'
  tag gtitle: 'SRG-NET-000015-ALG-000016'
  tag fix_id: 'F-56001r817954_fix'
  tag 'documentable'
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
