control 'SV-252609' do
  title 'IBM Aspera Shares must protect audit information from unauthorized deletion.'
...
If results are returned from the above commands, this is a finding.'
  desc 'fix', 'Remove world access from any IBM Aspera Shares log file that has world permissions granted. 

$ sudo chmod o-rwx <placefilenamehere>'
  impact 0.5
  ref 'DPMS Target IBM Aspera Platform 4.2'
  tag check_id: 'C-56065r817995_chk'
  tag severity: 'medium'
  tag gid: 'V-252609'
  tag rid: 'SV-252609r817997_rule'
  tag stig_id: 'ASP4-SH-060220'
  tag gtitle: 'SRG-NET-000098-ALG-000056'
  tag fix_id: 'F-56015r817996_fix'
