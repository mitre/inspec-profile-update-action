control 'SV-233908' do
  title 'The Infoblox DNS Server must provide additional integrity artifacts along with the authoritative name resolution data the system returns in response to external name/address resolution queries.'
...
1. Verify that DNSSEC validation is enabled by navigating to Data Management >> DNS >> Grid DNS properties.
...
5. Perform a service restart if necessary.'
  ...
  tag check_id: 'C-37093r611244_chk'
  tag severity: 'medium'
  tag gid: 'V-233908'
  tag rid: 'SV-233908r621666_rule'
  tag stig_id: 'IDNS-8X-700003'
  tag gtitle: 'SRG-APP-000422-DNS-000055'
  tag fix_id: 'F-37058r611245_fix'
  tag 'documentable'
  tag cci: ['CCI-002462']
  tag nist: ['SC-20 a']
end
