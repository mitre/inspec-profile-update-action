...
4. Click on the member and select "Stop" to disable the unnecessary service.'
  ...
  tag check_id: 'C-37072r611181_chk'
  tag severity: 'medium'
  tag gid: 'V-233887'
  tag rid: 'SV-233887r621666_rule'
  tag stig_id: 'IDNS-8X-400029'
  tag gtitle: 'SRG-APP-000516-DNS-000500'
  tag fix_id: 'F-37037r611182_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
