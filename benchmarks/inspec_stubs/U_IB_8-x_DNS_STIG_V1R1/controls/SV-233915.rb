control 'SV-233915' do
  title 'The Infoblox DNS server must perform data integrity verification on the name/address resolution responses the system receives from authoritative sources.'
...
5. Perform a service restart if necessary.'
  ...
  tag check_id: 'C-37100r611265_chk'
  tag severity: 'medium'
  tag gid: 'V-233915'
  tag rid: 'SV-233915r621666_rule'
  tag stig_id: 'IDNS-8X-700010'
  tag gtitle: 'SRG-APP-000425-DNS-000058'
  tag fix_id: 'F-37065r611266_fix'
  tag 'documentable'
  tag cci: ['CCI-002467']
  tag nist: ['SC-21']
end
