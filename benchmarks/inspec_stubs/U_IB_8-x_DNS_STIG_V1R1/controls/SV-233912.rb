control 'SV-233912' do
  title 'The Infoblox DNS server must enable verification of a chain of trust among parent and child domains (if the child supports secure resolution services).'
...
5. Perform a service restart if necessary.'
  ...
  tag check_id: 'C-37097r611256_chk'
  tag severity: 'medium'
  tag gid: 'V-233912'
  tag rid: 'SV-233912r621666_rule'
  tag stig_id: 'IDNS-8X-700007'
  tag gtitle: 'SRG-APP-000215-DNS-000026'
  tag fix_id: 'F-37062r611257_fix'
  tag 'documentable'
  tag cci: ['CCI-001663']
  tag nist: ['SC-20 b']
end
