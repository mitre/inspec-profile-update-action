control 'SV-233893' do
  title 'The Infoblox DNS server must provide data origin artifacts for internal name/address resolution queries.'
...
5. Perform a service restart if necessary.'
  ...
  tag check_id: 'C-37078r611199_chk'
  tag severity: 'medium'
  tag gid: 'V-233893'
  tag rid: 'SV-233893r621666_rule'
  tag stig_id: 'IDNS-8X-400035'
  tag gtitle: 'SRG-APP-000420-DNS-000053'
  tag fix_id: 'F-37043r611200_fix'
  tag 'documentable'
