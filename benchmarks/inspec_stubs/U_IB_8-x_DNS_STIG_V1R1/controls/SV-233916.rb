control 'SV-233916' do
  title 'The Infoblox DNS server must perform data origin verification authentication on the name/address resolution responses the system receives from authoritative sources.'
...
5. Perform a service restart if necessary.'
  ...
  tag check_id: 'C-37101r611268_chk'
  tag severity: 'medium'
  tag gid: 'V-233916'
  tag rid: 'SV-233916r621666_rule'
  tag stig_id: 'IDNS-8X-700011'
  tag gtitle: 'SRG-APP-000426-DNS-000059'
  tag fix_id: 'F-37066r611269_fix'
  tag 'documentable'
  tag cci: ['CCI-002468']
  tag nist: ['SC-21']
end
