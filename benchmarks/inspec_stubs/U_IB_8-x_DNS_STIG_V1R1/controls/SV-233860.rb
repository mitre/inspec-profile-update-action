control 'SV-233860' do
  title 'Recursion must be disabled on Infoblox DNS servers that are configured as authoritative name servers.'
...
Since DNS forwarding of queries can be accomplished in some DNS applications without caching locally, DNS forwarding is the method to be used when providing external DNS resolution to internal clients."
  desc 'check', '1. Navigate to Data Management >> DNS >> Members tab. 
...
4. Perform a service restart if necessary.'
  ...
  tag check_id: 'C-37045r611100_chk'
  tag severity: 'medium'
  tag gid: 'V-233860'
  tag rid: 'SV-233860r621666_rule'
  tag stig_id: 'IDNS-8X-400002'
  tag gtitle: 'SRG-APP-000383-DNS-000047'
  tag fix_id: 'F-37010r611101_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
