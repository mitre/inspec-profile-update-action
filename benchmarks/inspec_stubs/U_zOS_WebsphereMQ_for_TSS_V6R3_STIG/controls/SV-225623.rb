...
___ Repeat the above step for each queue manager ssid identified.'
  desc 'fix', 'The system programmer and the IAO will review the WebSphere MQ Screen interface invoked by the REXX CSQOREXX. Reviewing the channel’s SSLCIPH setting.
...
Repeat these steps for each queue manager ssid identified.'
  ...
  tag check_id: 'C-27324r811068_chk'
  tag severity: 'high'
  tag gid: 'V-225623'
  tag rid: 'SV-225623r811070_rule'
  tag stig_id: 'ZWMQ0011'
  tag gtitle: 'SRG-OS-000033'
  tag fix_id: 'F-27312r811069_fix'
