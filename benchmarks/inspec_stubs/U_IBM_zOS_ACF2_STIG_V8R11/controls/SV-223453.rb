control 'SV-223453' do
  title 'CA-ACF2 must limit Write or greater access to SYS1.SVCLIB to system programmers only.'
...
ESM data set rules for SYS1.SVCLIB specify that all (i.e., failures and successes) UPDATE and/or ALTER access will be logged.'
  desc 'fix', 'Configure update and allocate access to SYS1.SVCLIB to be limited to system programmers only and all Update and Allocate access is logged and reviewed. Evaluate the impact of correcting the deficiency. Develop a plan of action and implement the changes for SYS1.SVCLIB. SYS1.SVCLIB contains SVCs and I/O appendages as such: they are very powerful and will be strictly controlled to avoid compromising system integrity.'
  impact 0.7
  ref 'DPMS Target IBM zOS ACF2'
  tag check_id: 'C-25126r504491_chk'
  tag severity: 'high'
  tag gid: 'V-223453'
  tag rid: 'SV-223453r853518_rule'
  tag stig_id: 'ACF2-ES-000320'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25114r504492_fix'
  tag satisfies: ['SRG-OS-000080-GPOS-00048', 'SRG-OS-000259-GPOS-00100', 'SRG-OS-000324-GPOS-00125']
  tag 'documentable'
  tag legacy: ['V-97603', 'SV-106707']
