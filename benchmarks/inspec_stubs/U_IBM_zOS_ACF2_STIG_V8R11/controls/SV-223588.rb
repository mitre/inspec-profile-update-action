...
Examine SSH daemon configuration file. If the variables "Protocol 2,1" or "Protocol 1" are defined on a line without a leading comment, this is a finding.'
  ...
  tag check_id: 'C-25261r500899_chk'
  tag severity: 'high'
  tag gid: 'V-223588'
  tag rid: 'SV-223588r533198_rule'
  tag stig_id: 'ACF2-SH-000040'
  tag gtitle: 'SRG-OS-000096-GPOS-00050'
  tag fix_id: 'F-25249r500900_fix'
  tag 'documentable'
  tag legacy: ['SV-106985', 'V-97881']
  tag cci: ['CCI-000382']
  tag nist: ['CM-7 b']
end
