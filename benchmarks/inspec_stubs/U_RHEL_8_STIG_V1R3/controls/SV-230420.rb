control 'SV-230420' do
  title 'The RHEL 8 audit system must be configured to audit any usage of the setxattr system call.'
...
'
  desc 'check', 'Verify if RHEL 8 is configured to audit the execution of the "setxattr" system call, by running the following command:
...
If the command does not return all lines, or the lines are commented out, this is a finding.'
  desc 'fix', 'Configure RHEL 8 to audit the execution of the "setxattr" system call, by adding or updating the following lines to "/etc/audit/rules.d/audit.rules":
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-33089r619871_chk'
  tag severity: 'medium'
  tag gid: 'V-230420'
