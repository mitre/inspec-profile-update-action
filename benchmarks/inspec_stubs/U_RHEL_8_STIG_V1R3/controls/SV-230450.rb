control 'SV-230450' do
  title 'Successful/unsuccessful uses of the openat system call in RHEL 8 must generate an audit record.'
...
'
  desc 'check', 'Verify RHEL 8 generates an audit record when successful/unsuccessful attempts to use the "openat" command by performing the following command to check the file system rules in "/etc/audit/audit.rules":
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-33119r568096_chk'
  tag severity: 'medium'
  tag gid: 'V-230450'
