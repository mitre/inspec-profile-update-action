...
If fapolicyd is not running in enforcement mode on all system mounts with a deny-all, permit-by-exception policy, this is a finding.'
  desc 'fix', %q(Configure RHEL 8 to employ a deny-all, permit-by-exception application whitelisting policy with "fapolicyd" using the following command:
...
permissive = 0)
  ...
  tag check_id: 'C-47821r743885_chk'
  tag severity: 'medium'
  tag gid: 'V-244546'
