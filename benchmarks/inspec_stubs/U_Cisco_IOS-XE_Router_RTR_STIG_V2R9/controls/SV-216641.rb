...
R5(config-ext-nacl)#permit tcp any x101.23.0 0.0.0.255 eq 515 631 9100
...
R5(config-if)#ip access-group FILTER_SERVER_TRAFFIC in'
  ...
  tag check_id: 'C-17874r287889_chk'
  tag severity: 'medium'
  tag gid: 'V-216641'
  tag rid: 'SV-216641r531086_rule'
  tag stig_id: 'CISC-RT-000010'
  tag gtitle: 'SRG-NET-000018-RTR-000001'
  tag fix_id: 'F-17872r287890_fix'
  tag 'documentable'
  tag legacy: ['SV-105993', 'V-96855']
  tag cci: ['CCI-001368']
  tag nist: ['AC-4']
end
