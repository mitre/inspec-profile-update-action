control 'SV-216999' do
  title 'The Cisco BGP router must be configured to enable the Generalized TTL Security Mechanism (GTSM).'
  desc "As described in RFC 3682, GTSM is designed to protect a router's IP-based control plane from denial of service (DoS) attacks. Many attacks focused on CPU load and line-card overload can be prevented by implementing GTSM on all Exterior Border Gateway Protocol-speaking routers. 
...
R1(config-router)#neighbor x.2.1.7 ttl-security hops 1'
  ...
  tag check_id: 'C-18229r288159_chk'
  tag severity: 'low'
  tag gid: 'V-216999'
  tag rid: 'SV-216999r855842_rule'
  tag stig_id: 'CISC-RT-000470'
  tag gtitle: 'SRG-NET-000362-RTR-000124'
  tag fix_id: 'F-18227r288160_fix'
  tag 'documentable'
  tag legacy: ['SV-106081', 'V-96943']
  tag cci: ['CCI-002385']
  tag nist: ['SC-5 a']
end
