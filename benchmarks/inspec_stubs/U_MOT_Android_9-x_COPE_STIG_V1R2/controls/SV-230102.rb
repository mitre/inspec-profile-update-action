control 'SV-230102' do
  title 'Motorola Android Pie work profile must be configured to enforce the system application disable list.'
...
SFR ID: FMT_SMF_EXT.1.1 #47"
  desc 'check', 'Review the Motorola Android Pie Work Profile configuration settings to confirm the system application disable list is enforced. This setting is enforced by default.
...
If on the MDM console the system app whitelist contains unapproved core apps, this is a finding.'
  desc 'fix', 'Configure the Motorola Android Pie Work Profile to enforce the system application disable list. 
...
On the MDM, configure a list of approved Motorola core and preinstalled apps in the core app whitelist.'
  ...
  tag check_id: 'C-58175r859874_chk'
  tag severity: 'medium'
  tag gid: 'V-230102'
  tag rid: 'SV-230102r859876_rule'
  tag stig_id: 'MOTO-09-009400'
  tag gtitle: 'GOOG-09-009400'
  tag fix_id: 'F-58124r859875_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
