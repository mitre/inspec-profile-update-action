...
If on the Android Pie device the user is able to remove certificates, this is a finding.'
...
2. Set "Disallow config credentials" to "On" for the work profile.'
  ...
  tag check_id: 'C-58173r859868_chk'
  tag severity: 'medium'
  tag gid: 'V-230100'
  tag rid: 'SV-230100r859870_rule'
  tag stig_id: 'MOTO-09-009100'
  tag gtitle: 'GOOG-09-009100'
  tag fix_id: 'F-58122r859869_fix'
  tag 'documentable'
