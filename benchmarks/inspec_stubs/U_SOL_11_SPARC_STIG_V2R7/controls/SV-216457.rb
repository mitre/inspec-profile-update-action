control 'SV-216457' do
  title 'A file integrity baseline must be created, maintained, and reviewed at least weekly to determine if unauthorized changes have been made to important system files located in the root file system.'
  desc "A file integrity baseline is a collection of file metadata used to evaluate the integrity of the system. A minimal baseline must contain metadata for all device files, setuid files, setgid files, system libraries, system binaries, and system configuration files. The minimal metadata must consist of the mode, owner, group owner, and modification times. For regular files, metadata must also include file size and a cryptographic hash of the file's contents."
...
# bart create > /var/adm/log/bartlogs/[baseline manifest filename]'
  ...
  tag check_id: 'C-17693r877416_chk'
  tag severity: 'medium'
  tag gid: 'V-216457'
  tag rid: 'SV-216457r877417_rule'
  tag stig_id: 'SOL-11.1-090010'
  tag gtitle: 'SRG-OS-000480'
  tag fix_id: 'F-17691r371460_fix'
  tag 'documentable'
