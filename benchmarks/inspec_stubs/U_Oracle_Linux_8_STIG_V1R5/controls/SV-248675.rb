...
'
  desc 'check', 'Verify the operating system enables the user to manually initiate a session lock with the following command:
...
Reload tmux configuration to take effect. This can be performed in tmux while it is running:
  ...
  tag check_id: 'C-52109r880562_chk'
  tag severity: 'medium'
  tag gid: 'V-248675'
  tag rid: 'SV-248675r880564_rule'
