control 'SV-248708' do
  title 'OL 8 emergency accounts must be automatically removed or disabled after the crisis is resolved or within 72 hours.'
...
To address access requirements, many OL 8 systems can be integrated with enterprise-level authentication/access mechanisms that meet or exceed access control policy requirements."
...
The automatic expiration or disabling time period may be extended as needed until the crisis is resolved.'
  ...
  tag check_id: 'C-52142r779688_chk'
  tag severity: 'medium'
  tag gid: 'V-248708'
  tag rid: 'SV-248708r779690_rule'
  tag stig_id: 'OL08-00-020270'
  tag gtitle: 'SRG-OS-000123-GPOS-00064'
  tag fix_id: 'F-52096r779689_fix'
  tag 'documentable'
  tag cci: ['CCI-001682']
  tag nist: ['AC-2 (2)']
end
