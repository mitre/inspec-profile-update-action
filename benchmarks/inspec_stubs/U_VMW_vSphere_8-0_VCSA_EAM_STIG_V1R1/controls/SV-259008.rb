control 'SV-259008' do
  title 'The vCenter ESX Agent Manager service must limit privileges for creating or modifying hosted application shared files.'
...
# vmon-cli --restart eam'
  ...
  tag check_id: 'C-62748r934680_chk'
  tag severity: 'medium'
  tag gid: 'V-259008'
  tag rid: 'SV-259008r934682_rule'
  tag stig_id: 'VCEM-80-000034'
  tag gtitle: 'SRG-APP-000133-AS-000092'
  tag fix_id: 'F-62657r934681_fix'
  tag 'documentable'
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
end
