control 'SV-259017' do
  title 'The vCenter ESX Agent Manager service must enable STRICT_SERVLET_COMPLIANCE.'
...
# vmon-cli --restart eam'
  ...
  tag check_id: 'C-62757r934707_chk'
  tag severity: 'medium'
  tag gid: 'V-259017'
  tag rid: 'SV-259017r934709_rule'
  tag stig_id: 'VCEM-80-000124'
  tag gtitle: 'SRG-APP-000516-AS-000237'
  tag fix_id: 'F-62666r934708_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
