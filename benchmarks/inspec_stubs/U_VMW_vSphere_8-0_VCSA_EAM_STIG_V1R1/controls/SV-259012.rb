control 'SV-259012' do
  title 'The vCenter ESX Agent Manager service must be configured to fail to a known safe state if system initialization fails.'
...
# vmon-cli --restart eam'
  ...
  tag check_id: 'C-62752r934692_chk'
  tag severity: 'medium'
  tag gid: 'V-259012'
  tag rid: 'SV-259012r934694_rule'
  tag stig_id: 'VCEM-80-000062'
  tag gtitle: 'SRG-APP-000225-AS-000166'
  tag fix_id: 'F-62661r934693_fix'
  tag 'documentable'
  tag cci: ['CCI-001190']
  tag nist: ['SC-24']
end
