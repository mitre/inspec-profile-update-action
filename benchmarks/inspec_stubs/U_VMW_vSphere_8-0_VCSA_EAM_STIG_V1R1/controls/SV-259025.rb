control 'SV-259025' do
  title 'The vCenter ESX Agent Manager service directory listings parameter must be disabled.'
...
# vmon-cli --restart eam'
  ...
  tag check_id: 'C-62765r934731_chk'
  tag severity: 'medium'
  tag gid: 'V-259025'
  tag rid: 'SV-259025r934733_rule'
  tag stig_id: 'VCEM-80-000137'
  tag gtitle: 'SRG-APP-000141-AS-000095'
  tag fix_id: 'F-62674r934732_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
