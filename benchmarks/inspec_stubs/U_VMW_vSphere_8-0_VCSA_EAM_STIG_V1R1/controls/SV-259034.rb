control 'SV-259034' do
  title 'The vCenter ESX Agent Manager service must enable "ENFORCE_ENCODING_IN_GET_WRITER".'
...
# vmon-cli --restart eam'
  ...
  tag check_id: 'C-62774r934758_chk'
  tag severity: 'medium'
  tag gid: 'V-259034'
  tag rid: 'SV-259034r934760_rule'
  tag stig_id: 'VCEM-80-000152'
  tag gtitle: 'SRG-APP-000516-AS-000237'
  tag fix_id: 'F-62683r934759_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
