control 'SV-259018' do
  title 'The vCenter ESX Agent Manager service must limit the amount of time that each Transmission Control Protocol (TCP) connection is kept alive.'
...
# xmllint --xpath "//Connector[@connectionTimeout = '-1']" /usr/lib/vmware-eam/web/conf/server.xml
...
# vmon-cli --restart eam'
  ...
  tag check_id: 'C-62758r934710_chk'
  tag severity: 'medium'
  tag gid: 'V-259018'
  tag rid: 'SV-259018r934712_rule'
  tag stig_id: 'VCEM-80-000125'
  tag gtitle: 'SRG-APP-000001-AS-000001'
  tag fix_id: 'F-62667r934711_fix'
  tag 'documentable'
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
end
