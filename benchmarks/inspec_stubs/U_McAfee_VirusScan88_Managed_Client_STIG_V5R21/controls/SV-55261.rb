...
Criteria: If [Spyware] uAction_Program=5, this is not a finding.'
  ...
  tag check_id: 'C-48851r4_chk'
  tag severity: 'medium'
  tag gid: 'V-42533'
  tag rid: 'SV-55261r3_rule'
  tag stig_id: 'DTAM155'
  tag gtitle: 'DTAM155-McAfee VirusScan on-demand unwanted programs first action'
  tag fix_id: 'F-48115r3_fix'
  tag 'documentable'
  tag cci: ['CCI-001243']
  tag nist: ['SI-3 c 2']
end
