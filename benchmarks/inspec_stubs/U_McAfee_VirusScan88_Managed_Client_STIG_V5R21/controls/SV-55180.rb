control 'SV-55180' do
  title 'McAfee VirusScan On Delivery Email Scan Policies, When a threat is found, must be configured to clean attachments as the first action and delete attachments if the first action fails.'
...
Criteria:  If the value for uSecAction is not 4, this is a finding.'
  ...
  tag check_id: 'C-48789r5_chk'
  tag severity: 'medium'
  tag gid: 'V-42493'
  tag rid: 'SV-55180r2_rule'
  tag stig_id: 'DTAM162'
  tag gtitle: 'DTAM162-McAfee VirusScan Email on-delivery threat second action'
  tag fix_id: 'F-48034r2_fix'
  tag 'documentable'
  tag cci: ['CCI-001243']
  tag nist: ['SI-3 c 2']
end
