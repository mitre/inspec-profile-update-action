control 'SV-230354' do
  title 'RHEL 8 must prevent a user from overriding graphical user interface settings.'
...
"
  desc 'check', %q(Verify the operating system prevents a user from overriding graphical user interfaces. 
...
/org/gnome/desktop/lockdown/disable-lock-screen'
  ...
  tag check_id: 'C-33023r567808_chk'
  tag severity: 'medium'
  tag gid: 'V-230354'
