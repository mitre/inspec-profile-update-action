control 'SV-230528' do
  title 'RHEL 8 must force a frequent session key renegotiation for SSH connections by the client.'
...
$ sudo systemctl restart sshd.service'
  ...
  tag check_id: 'C-33197r568330_chk'
  tag severity: 'medium'
  tag gid: 'V-230528'
  tag rid: 'SV-230528r627750_rule'
