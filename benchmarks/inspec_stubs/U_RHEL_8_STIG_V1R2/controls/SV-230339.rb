...
'
  desc 'check', %q(Check that the faillock directory contents persist after a reboot with the following commands:
...
dir = /var/log/faillock'
  ...
  tag check_id: 'C-33008r619903_chk'
  tag severity: 'medium'
  tag gid: 'V-230339'
  tag rid: 'SV-230339r627750_rule'
  tag stig_id: 'RHEL-08-020017'
  tag gtitle: 'SRG-OS-000021-GPOS-00005'
  tag fix_id: 'F-32983r567764_fix'
