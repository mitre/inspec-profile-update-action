...
'
  desc 'check', 'Verify the operating system enables the user to initiate a session lock on command. 
...
set -g lock-command vlock'
  ...
  tag check_id: 'C-33017r567790_chk'
  tag severity: 'medium'
  tag gid: 'V-230348'
  tag rid: 'SV-230348r627750_rule'
