control 'SV-230540' do
  ...
  desc 'check', 'Verify RHEL 8 is not performing packet forwarding, unless the system is a router.
...
If IP forwarding value is not "0" and is not documented with the Information System Security Officer (ISSO) as an operational requirement, this is a finding.'
  desc 'fix', %q(Configure RHEL 8 to not allow packet forwarding, unless the system is a router with the following commands:
...
net.ipv6.conf.all.forwarding=0)
  ...
  tag check_id: 'C-33209r568366_chk'
  tag severity: 'medium'
  tag gid: 'V-230540'
