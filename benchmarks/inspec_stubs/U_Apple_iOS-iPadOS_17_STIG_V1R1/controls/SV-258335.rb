control 'SV-258335' do
  title 'Apple iOS/iPadOS 17 must be configured to [selection: wipe protected data, wipe sensitive data] upon unenrollment from MDM.'
...
If one or more managed apps are not set to be removed upon device MDM unenrollment, this is a finding.'
  ...
  tag check_id: 'C-62076r927686_chk'
  tag severity: 'medium'
  tag gid: 'V-258335'
  tag rid: 'SV-258335r927688_rule'
  tag stig_id: 'AIOS-17-009900'
  tag gtitle: 'PP-MDF-333300'
  tag fix_id: 'F-62000r927687_fix'
  tag 'documentable'
