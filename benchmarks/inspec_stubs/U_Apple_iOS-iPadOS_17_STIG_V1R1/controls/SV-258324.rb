control 'SV-258324' do
  title 'Apple iOS/iPadOS 17 must be configured to not allow more than 10 consecutive failed authentication attempts.'
...
If the "Maximum number of failed attempts" is more than 10 in the iOS management tool, "<key>maxFailedAttempts</key> " has an integer value of more than 10, or the password policy on the iPhone and iPad does not list "Max failed attempts" of 10 or fewer, this is a finding.'
  ...
  tag check_id: 'C-62065r927653_chk'
  tag severity: 'medium'
  tag gid: 'V-258324'
  tag rid: 'SV-258324r927655_rule'
  tag stig_id: 'AIOS-17-006900'
  tag gtitle: 'PP-MDF-333040'
  tag fix_id: 'F-61989r927654_fix'
  tag 'documentable'
  tag cci: ['CCI-000044']
  tag nist: ['AC-7 a']
end
