control 'SV-258363' do
  title 'Apple iOS/iPadOS 17 must disable allow setting up new nearby devices.'
...
If "Proximity setup to a new device is not allowed" is disabled in the iOS/iPadOS management tool and on the Apple device, this is a finding.'
  ...
  tag check_id: 'C-62104r927770_chk'
  tag severity: 'medium'
  tag gid: 'V-258363'
  tag rid: 'SV-258363r927772_rule'
  tag stig_id: 'AIOS-17-012800'
  tag gtitle: 'PP-MDF-993300'
  tag fix_id: 'F-62028r927771_fix'
  tag 'documentable'
