...
- Allows unencrypted (or encrypted but not FIPS 140-2/FIPS 140-3 validated) data sharing with other MDs or printers.'
  ...
  tag check_id: 'C-62069r927665_chk'
  tag severity: 'medium'
  tag gid: 'V-258328'
  tag rid: 'SV-258328r935550_rule'
  tag stig_id: 'AIOS-17-007400'
  tag gtitle: 'PP-MDF-333070'
  tag fix_id: 'F-61993r927666_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
