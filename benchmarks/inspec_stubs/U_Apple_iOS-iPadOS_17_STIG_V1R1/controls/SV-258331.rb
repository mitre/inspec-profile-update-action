control 'SV-258331' do
  title 'Apple iOS/iPadOS 17 must be configured to display the DOD advisory warning message at startup or each time the user unlocks the device.'
...
2. By installing a Lock Screen Message payload with the required text (preferred method).'
  ...
  tag check_id: 'C-62072r927674_chk'
  tag severity: 'low'
  tag gid: 'V-258331'
  tag rid: 'SV-258331r935551_rule'
  tag stig_id: 'AIOS-17-008400'
  tag gtitle: 'PP-MDF-333160'
  tag fix_id: 'F-61996r935551_fix'
  tag 'documentable'
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
