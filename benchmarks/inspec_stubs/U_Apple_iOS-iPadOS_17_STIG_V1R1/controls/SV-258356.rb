control 'SV-258356' do
  title 'Apple iOS/iPadOS 17 must implement the management setting: enable USB Restricted Mode.'
...
Note: This control is called "Allow USB accessories while device is locked" in Apple Configurator, and the control logic is opposite to what is listed here. Ensure the MDM policy rule is set correctly (to disable USB accessory connections when the device is locked).'
  ...
  tag check_id: 'C-62097r927749_chk'
  tag severity: 'medium'
  tag gid: 'V-258356'
  tag rid: 'SV-258356r927751_rule'
  tag stig_id: 'AIOS-17-012200'
  tag gtitle: 'PP-MDF-993300'
  tag fix_id: 'F-62021r927750_fix'
  tag 'documentable'
