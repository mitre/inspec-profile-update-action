control 'SV-258310' do
  title 'Apple iOS/iPadOS 17 must allow the Administrator (MDM) to perform the following management function: enable/disable VPN protection across the device and [selection: other methods].'
...
Note: This setting cannot be managed by the MDM administrator and is a User-Based Enforcement (UBE) requirement.'
  desc 'fix', 'If a third-party unmanaged VPN app is installed on the iOS 17 device, do not configure the VPN app with a DOD network VPN profile.'
  impact 0.3
  ref 'DPMS Target Apple iOS-iPadOS 17 STIG'
  tag check_id: 'C-62051r927611_chk'
  tag severity: 'low'
  tag gid: 'V-258310'
  tag rid: 'SV-258310r930574_rule'
  tag stig_id: 'AIOS-17-001000'
  tag gtitle: 'PP-MDF-331090'
  tag fix_id: 'F-61975r927612_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
