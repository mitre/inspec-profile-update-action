control 'SV-259189' do
  title 'Apple iOS/iPadOS 17 must not allow backup to remote systems (Cloud Photo Library).'
...
This requirement will become "Supervised only" in a future iOS/iPadOS release.)
  desc 'fix', 'Install a configuration profile to disable Cloud Photo Library.

This requirement will become "Supervised only" in a future iOS/iPadOS release.'
  impact 0.5
  ref 'DPMS Target Apple iOS-iPadOS 17 STIG'
  tag check_id: 'C-62929r935535_chk'
  tag severity: 'medium'
  tag gid: 'V-259189'
  tag rid: 'SV-259189r935537_rule'
  tag stig_id: 'AIOS-17-003450'
  tag gtitle: 'PP-MDF-333250'
  tag fix_id: 'F-62838r935536_fix'
  tag 'documentable'
