control 'SV-258319' do
  title 'Apple iOS/iPadOS 17 must [selection: remove Enterprise application, remove all noncore applications (any nonfactory-installed application)] upon unenrollment from MDM.'
...
If one or more managed apps are not set to be removed upon device MDM unenrollment, this is a finding.'
  ...
  tag check_id: 'C-62060r927638_chk'
  tag severity: 'medium'
  tag gid: 'V-258319'
  tag rid: 'SV-258319r927640_rule'
  tag stig_id: 'AIOS-17-005000'
  tag gtitle: 'PP-MDF-331410'
  tag fix_id: 'F-61984r927639_fix'
  tag 'documentable'
