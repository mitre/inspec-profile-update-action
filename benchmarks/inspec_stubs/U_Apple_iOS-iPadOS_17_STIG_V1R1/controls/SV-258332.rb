control 'SV-258332' do
  title 'Apple iOS/iPadOS 17 must be configured to not allow backup of [all applications, configuration data] to locally connected systems.'
...
If backing up app data is not disabled in the Apple iOS/iPadOS management tool or "app data will not be backed up" is not listed for each managed app on the iPhone and iPad, this is a finding.'
  ...
  tag check_id: 'C-62073r927677_chk'
  tag severity: 'medium'
  tag gid: 'V-258332'
  tag rid: 'SV-258332r927679_rule'
  tag stig_id: 'AIOS-17-009200'
  tag gtitle: 'PP-MDF-333240'
  tag fix_id: 'F-61997r927678_fix'
  tag 'documentable'
  tag cci: ['CCI-001090']
  tag nist: ['SC-4']
end
