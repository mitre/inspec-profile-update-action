control 'SV-258350' do
  title 'Apple iOS/iPadOS 17 must implement the management setting: Treat AirDrop as an unmanaged destination.'
...
If "Treat AirDrop as unmanaged destination" is disabled in the Apple iOS/iPadOS management tool or the restrictions policy on the iPhone and iPad does not list "Sharing managed documents using AirDrop not allowed", this is a finding.'
  ...
  tag check_id: 'C-62091r927731_chk'
  tag severity: 'medium'
  tag gid: 'V-258350'
  tag rid: 'SV-258350r927733_rule'
  tag stig_id: 'AIOS-17-011500'
  tag gtitle: 'PP-MDF-993300'
  tag fix_id: 'F-62015r927732_fix'
  tag 'documentable'
