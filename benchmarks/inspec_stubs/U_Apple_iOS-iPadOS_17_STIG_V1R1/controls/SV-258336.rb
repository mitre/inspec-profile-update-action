control 'SV-258336' do
  title 'Apple iOS/iPadOS 17 must be configured to [selection: remove Enterprise applications, remove all noncore applications (any nonfactory-installed application)] upon unenrollment from MDM.'
...
If one or more managed apps are not set to be removed upon device MDM unenrollment, this is a finding.'
  ...
  tag check_id: 'C-62077r927689_chk'
  tag severity: 'medium'
  tag gid: 'V-258336'
  tag rid: 'SV-258336r927691_rule'
  tag stig_id: 'AIOS-17-010000'
  tag gtitle: 'PP-MDF-333310'
  tag fix_id: 'F-62001r927690_fix'
  tag 'documentable'
