control 'SV-258340' do
  title 'Apple iOS/iPadOS 17 must implement the management setting: not allow automatic completion of Safari browser passcodes.'
...
If "Enable autofill" is checked in the Apple iOS/iPadOS management tool, "<key>safariAllowAutoFill</key><true>" appears in the configuration profile, or the restrictions policy on the iPhone and iPad does not list "Auto-fill in Safari not allowed", this is a finding.'
  ...
  tag check_id: 'C-62081r927701_chk'
  tag severity: 'low'
  tag gid: 'V-258340'
  tag rid: 'SV-258340r927703_rule'
  tag stig_id: 'AIOS-17-010600'
  tag gtitle: 'PP-MDF-993300'
  tag fix_id: 'F-62005r927702_fix'
  tag 'documentable'
