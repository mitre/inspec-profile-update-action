control 'SV-259186' do
  title 'Apple iOS/iPadOS 17 must not allow backup to remote systems (iCloud).'
...
If "Allow iCloud backup" is checked in the Apple iOS/iPadOS management tool, "<key>allowCloudBackup</key><true/>" appears in the configuration profile, or the restrictions policy on the iPhone and iPad does not list "iCloud backup not allowed", this is a finding.)
  ...
  tag check_id: 'C-62926r935526_chk'
  tag severity: 'medium'
  tag gid: 'V-259186'
  tag rid: 'SV-259186r935528_rule'
  tag stig_id: 'AIOS-17-003000'
  tag gtitle: 'PP-MDF-333250'
  tag fix_id: 'F-62835r935527_fix'
  tag 'documentable'
  tag cci: ['CCI-001090']
  tag nist: ['SC-4']
end
