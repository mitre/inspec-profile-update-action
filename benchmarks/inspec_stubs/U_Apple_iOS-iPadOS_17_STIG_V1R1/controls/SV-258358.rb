control 'SV-258358' do
  title 'Apple iOS/iPadOS 17 must not allow unmanaged apps to read contacts from managed contacts accounts.'
...
If "Allow unmanaged apps to read contacts from managed contacts accounts" is checked in the iOS/iPadOS management tool or the restrictions policy on the iPhone and iPad lists "Allow unmanaged apps to read contacts from managed contacts accounts", this is a finding.'
  ...
  tag check_id: 'C-62099r927755_chk'
  tag severity: 'low'
  tag gid: 'V-258358'
  tag rid: 'SV-258358r927757_rule'
  tag stig_id: 'AIOS-17-012400'
  tag gtitle: 'PP-MDF-993300'
  tag fix_id: 'F-62023r927756_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
