control 'SV-259191' do
  title 'Apple iOS/iPadOS 17 must not allow backup to remote systems (managed applications data stored in iCloud).'
...
If "Allow managed apps to store data in iCloud" is checked in the Apple iOS/iPadOS management tool, "<key>allowManagedAppsCloudSync</key> <true/>" appears in the configuration profile, or the restrictions policy on the iPhone and iPad does not list "Managed apps cloud sync not allowed", this is a finding.'
  ...
  tag check_id: 'C-62931r935541_chk'
  tag severity: 'medium'
  tag gid: 'V-259191'
  tag rid: 'SV-259191r935543_rule'
  tag stig_id: 'AIOS-17-003600'
  tag gtitle: 'PP-MDF-333250'
  tag fix_id: 'F-62840r935542_fix'
  tag 'documentable'
