control 'SV-252965' do
  title 'TOSS must display the date and time of the last successful account logon upon an SSH logon.'
...
The SSH service must be restarted for changes to "sshd_config" to take effect.'
  ...
  tag check_id: 'C-56418r824217_chk'
  tag severity: 'medium'
  tag gid: 'V-252965'
  tag rid: 'SV-252965r824219_rule'
  tag stig_id: 'TOSS-04-020260'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-56368r824218_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
