control 'SV-253129' do
  title 'TOSS must not send Internet Control Message Protocol (ICMP) redirects.'
...
There are notable differences between Internet Protocol version 4 (IPv4) and Internet Protocol version 6 (IPv6). There is only a directive to disable sending of IPv4 redirected packets. Refer to RFC4294 for an explanation of "IPv6 Node Requirements", which resulted in this difference between IPv4 and IPv6.)
  desc 'check', 'Verify TOSS does not IPv4 ICMP redirect messages.
...
If the returned line does not have a value of "0", or a line is not returned, this is a finding.'
  desc 'fix', %q(Configure TOSS to not allow interfaces to perform IPv4 ICMP redirects with the following command:
...
net.ipv4.conf.all.send_redirects=0)
  ...
  tag check_id: 'C-56582r825057_chk'
  tag severity: 'medium'
  tag gid: 'V-253129'
  tag rid: 'SV-253129r825059_rule'
  tag stig_id: 'TOSS-04-040880'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-56532r825058_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
