control 'SV-253079' do
  title 'TOSS must not have the sendmail package installed.'
...
Verify the operating system is configured to disable non-essential capabilities. The most secure way of ensuring a non-essential capability is disabled is to not have the capability installed.'
  desc 'check', 'Check to see if the sendmail package is installed with the following command:
...
$ sudo yum remove sendmail'
  ...
  tag check_id: 'C-56532r824907_chk'
  tag severity: 'medium'
  tag gid: 'V-253079'
  tag rid: 'SV-253079r824909_rule'
  tag stig_id: 'TOSS-04-040250'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-56482r824908_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
