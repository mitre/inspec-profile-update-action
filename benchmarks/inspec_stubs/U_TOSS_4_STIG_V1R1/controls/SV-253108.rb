control 'SV-253108' do
  title 'The TOSS SSH public host key files must have mode 0644 or less permissive.'
...
$ sudo systemctl restart sshd.service'
  ...
  tag check_id: 'C-56561r824994_chk'
  tag severity: 'medium'
  tag gid: 'V-253108'
  tag rid: 'SV-253108r824996_rule'
  tag stig_id: 'TOSS-04-040670'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-56511r824995_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
