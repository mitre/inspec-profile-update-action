control 'SV-253035' do
  title 'The TOSS audit system must be configured to audit any usage of the "lsetxattr" system call.'
...
'
  desc 'check', 'Verify if TOSS is configured to audit the execution of the "lsetxattr" system call, by running the following command:
...
If the command does not return all lines, or the lines are commented out, this is a finding.'
  desc 'fix', 'Configure TOSS to audit the execution of the "lsetxattr" system call, by adding or updating the following lines to "/etc/audit/rules.d/audit.rules":
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-56488r824775_chk'
  tag severity: 'medium'
  tag gid: 'V-253035'
  tag rid: 'SV-253035r824777_rule'
  tag stig_id: 'TOSS-04-031000'
  tag gtitle: 'SRG-OS-000458-GPOS-00203'
  tag fix_id: 'F-56438r824776_fix'
