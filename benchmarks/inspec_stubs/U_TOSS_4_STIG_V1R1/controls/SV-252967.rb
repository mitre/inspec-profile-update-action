control 'SV-252967' do
  title 'TOSS must not have unnecessary accounts.'
...
Document all authorized accounts on the system.'
  ...
  tag check_id: 'C-56420r824223_chk'
  tag severity: 'medium'
  tag gid: 'V-252967'
  tag rid: 'SV-252967r824225_rule'
  tag stig_id: 'TOSS-04-020280'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-56370r824224_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
