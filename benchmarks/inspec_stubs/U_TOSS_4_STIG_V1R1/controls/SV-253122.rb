control 'SV-253122' do
  title 'TOSS must not allow blank or null passwords in the password-auth file.'
...
Note: Manual changes to the listed file may be overwritten by the "authselect" program.'
  ...
  tag check_id: 'C-56575r825036_chk'
  tag severity: 'high'
  tag gid: 'V-253122'
  tag rid: 'SV-253122r825038_rule'
  tag stig_id: 'TOSS-04-040810'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-56525r825037_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
