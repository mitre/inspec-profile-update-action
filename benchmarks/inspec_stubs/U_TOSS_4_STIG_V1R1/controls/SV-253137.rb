control 'SV-253137' do
  title 'TOSS must enable kernel parameters to enforce discretionary access control on hardlinks.'
...
$ sudo sysctl --system'
  ...
  tag check_id: 'C-56590r825081_chk'
  tag severity: 'medium'
  tag gid: 'V-253137'
  tag rid: 'SV-253137r825083_rule'
  tag stig_id: 'TOSS-04-040960'
  tag gtitle: 'SRG-OS-000312-GPOS-00122'
  tag fix_id: 'F-56540r825082_fix'
