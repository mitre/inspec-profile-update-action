control 'SV-253120' do
  title 'TOSS must not accept router advertisements on all IPv6 interfaces by default.'
...
An illicit router advertisement message could result in a man-in-the-middle attack.'
  desc 'check', 'Verify TOSS does not accept router advertisements on all IPv6 interfaces by default, unless the system is a router.
...
If the "accept_ra" value is not "0" and is not documented with the Information System Security Officer (ISSO) as an operational requirement, this is a finding.'
  desc 'fix', %q(Configure TOSS to not accept router advertisements on all IPv6 interfaces by default unless the system is a router with the following commands:
...
net.ipv6.conf.default.accept_ra=0)
  ...
  tag check_id: 'C-56573r825030_chk'
  tag severity: 'medium'
  tag gid: 'V-253120'
  tag rid: 'SV-253120r825032_rule'
  tag stig_id: 'TOSS-04-040790'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-56523r825031_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
