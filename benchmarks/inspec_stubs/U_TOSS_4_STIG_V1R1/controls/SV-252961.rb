control 'SV-252961' do
  title "All TOSS local interactive user home directories must be group-owned by the home directory owner's primary group."
...
$ sudo chgrp users /home/smithj)
  ...
  tag check_id: 'C-56414r824205_chk'
  tag severity: 'medium'
  tag gid: 'V-252961'
  tag rid: 'SV-252961r824207_rule'
  tag stig_id: 'TOSS-04-020210'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-56364r824206_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
