control 'SV-252935' do
  title 'For TOSS systems using Domain Name Servers (DNS) resolution, at least two name servers must be configured.'
...
By default, "NetworkManager" on TOSS dynamically updates the /etc/resolv.conf file with the DNS settings from active "NetworkManager" connection profiles. However, this feature can be disabled to allow manual configurations.
...
$ sudo echo -n > /etc/resolv.conf'
  ...
  tag check_id: 'C-56388r824127_chk'
  tag severity: 'medium'
  tag gid: 'V-252935'
  tag rid: 'SV-252935r824129_rule'
  tag stig_id: 'TOSS-04-010330'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-56338r824128_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
