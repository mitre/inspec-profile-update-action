control 'SV-252921' do
  title 'TOSS must prevent unauthorized and unintended information transfer via shared system resources.'
...
$ sudo chown root [Public Directory]'
  ...
  tag check_id: 'C-56374r824085_chk'
  tag severity: 'medium'
  tag gid: 'V-252921'
  tag rid: 'SV-252921r824087_rule'
  tag stig_id: 'TOSS-04-010100'
  tag gtitle: 'SRG-OS-000138-GPOS-00069'
  tag fix_id: 'F-56324r824086_fix'
  tag 'documentable'
  tag cci: ['CCI-001090']
  tag nist: ['SC-4']
end
