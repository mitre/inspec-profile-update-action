control 'SV-252964' do
  title 'TOSS must disable the user list at logon for graphical user interfaces.'
  ...
  desc 'check', 'Verify the operating system disables the user logon list for graphical user interfaces with the following command:
...
$ sudo dconf update'
  ...
  tag check_id: 'C-56417r824214_chk'
  tag severity: 'medium'
  tag gid: 'V-252964'
  tag rid: 'SV-252964r824216_rule'
  tag stig_id: 'TOSS-04-020250'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-56367r824215_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
