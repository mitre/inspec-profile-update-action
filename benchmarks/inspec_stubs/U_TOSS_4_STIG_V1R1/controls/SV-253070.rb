control 'SV-253070' do
  title 'TOSS must cover or disable the built-in or attached camera when not in use.'
...
Reboot the system for the settings to take effect.'
  ...
  tag check_id: 'C-56523r824880_chk'
  tag severity: 'medium'
  tag gid: 'V-253070'
  tag rid: 'SV-253070r824882_rule'
  tag stig_id: 'TOSS-04-040150'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-56473r824881_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
