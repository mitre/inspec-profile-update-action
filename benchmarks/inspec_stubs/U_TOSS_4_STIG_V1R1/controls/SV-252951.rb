control 'SV-252951' do
  title 'TOSS duplicate User IDs (UIDs) must not exist for interactive users.'
...
'
  desc 'check', %q(Verify that TOSS contains no duplicate User IDs (UIDs) for interactive users.
...
If output is produced, and the accounts listed are interactive user accounts, this is a finding.)
  desc 'fix', 'Edit the file "/etc/passwd" and provide each interactive user account that has a duplicate User ID (UID) with a unique UID.'
  impact 0.5
  ref 'DPMS Target TOSS 4'
  tag check_id: 'C-56404r824175_chk'
  tag severity: 'medium'
  tag gid: 'V-252951'
  tag rid: 'SV-252951r824177_rule'
  tag stig_id: 'TOSS-04-020060'
  tag gtitle: 'SRG-OS-000104-GPOS-00051'
  tag fix_id: 'F-56354r824176_fix'
