control 'SV-252959' do
  title 'TOSS must require users to provide a password for privilege escalation.'
...
If any occurrences of "NOPASSWD" are returned from the command and have not been documented with the ISSO as an organizationally defined administrative group utilizing MFA, this is a finding.'
  ...
  tag check_id: 'C-56412r824199_chk'
  tag severity: 'medium'
  tag gid: 'V-252959'
  tag rid: 'SV-252959r824201_rule'
  tag stig_id: 'TOSS-04-020190'
  tag gtitle: 'SRG-OS-000373-GPOS-00157'
  tag fix_id: 'F-56362r824200_fix'
  tag 'documentable'
  tag cci: ['CCI-002038']
  tag nist: ['IA-11']
end
