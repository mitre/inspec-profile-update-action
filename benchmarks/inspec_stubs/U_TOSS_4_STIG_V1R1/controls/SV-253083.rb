control 'SV-253083' do
  title 'TOSS must be configured so that all network connections associated with SSH traffic are terminated at the end of the session or after 10 minutes of inactivity, except to fulfill documented and validated mission requirements.'
...
If "ClientAliveInterval" and "ClientAliveCountMax" do not exist, does not have a product value of "600" or less in "/etc/ssh/sshd_config", or is commented out, this is a finding.'
  desc 'fix', 'Configure TOSS to automatically terminate all network connections associated with SSH traffic at the end of a session or after 10 minutes of inactivity, or as long as documented with the Information System Security Officer (ISSO) as an operational requirement.
...
$ sudo systemctl restart sshd.service'
  ...
  tag check_id: 'C-56536r824919_chk'
  tag severity: 'medium'
  tag gid: 'V-253083'
  tag rid: 'SV-253083r824921_rule'
  tag stig_id: 'TOSS-04-040290'
  tag gtitle: 'SRG-OS-000126-GPOS-00066'
  tag fix_id: 'F-56486r824920_fix'
