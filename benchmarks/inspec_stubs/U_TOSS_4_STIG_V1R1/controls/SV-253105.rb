control 'SV-253105' do
  title 'The TOSS file integrity tool must be configured to verify extended attributes.'
...
If AIDE is installed, ensure the "xattrs" rule is present on all uncommented file and directory selection lists.'
  ...
  tag check_id: 'C-56558r824985_chk'
  tag severity: 'low'
  tag gid: 'V-253105'
  tag rid: 'SV-253105r824987_rule'
  tag stig_id: 'TOSS-04-040640'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-56508r824986_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
