control 'SV-253034' do
  title 'The TOSS audit system must be configured to audit any usage of the "fsetxattr" system call.'
...
'
  desc 'check', 'Verify if TOSS is configured to audit the execution of the "fsetxattr" system call, by running the following command:
...
If the command does not return all lines, or the lines are commented out, this is a finding.'
  desc 'fix', 'Configure TOSS to audit the execution of the "fsetxattr" system call, by adding or updating the following lines to "/etc/audit/rules.d/audit.rules":
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-56487r824772_chk'
  tag severity: 'medium'
  tag gid: 'V-253034'
  tag rid: 'SV-253034r824774_rule'
  tag stig_id: 'TOSS-04-030990'
  tag gtitle: 'SRG-OS-000458-GPOS-00203'
  tag fix_id: 'F-56437r824773_fix'
