control 'SV-253002' do
  title 'Successful/unsuccessful uses of the "finit_module" command in TOSS must generate an audit record.'
...
'
  desc 'check', 'Verify that an audit event is generated for any successful/unsuccessful use of the "finit_module" syscall by performing the following command to check the file system rules in "/etc/audit/audit.rules":
...
If the command does not return a line, or the line is commented out, this is a finding.'
  desc 'fix', 'Configure the audit system to generate an audit event for any successful/unsuccessful use of the "finit_module" syscall by adding or updating the following rules in the "/etc/audit/rules.d/audit.rules" file:
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-56455r824328_chk'
  tag severity: 'medium'
  tag gid: 'V-253002'
  tag rid: 'SV-253002r824330_rule'
  tag stig_id: 'TOSS-04-030480'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-56405r824329_fix'
