control 'SV-253084' do
  title 'TOSS must have policycoreutils package installed.'
...
policycoreutils.x86_64 2.9-16.el8 @anaconda
...
$ sudo yum install policycoreutils'
  ...
  tag check_id: 'C-56537r824922_chk'
  tag severity: 'low'
  tag gid: 'V-253084'
  tag rid: 'SV-253084r824924_rule'
  tag stig_id: 'TOSS-04-040310'
  tag gtitle: 'SRG-OS-000134-GPOS-00068'
  tag fix_id: 'F-56487r824923_fix'
  tag 'documentable'
  tag cci: ['CCI-001084']
  tag nist: ['SC-3']
end
