control 'SV-252975' do
  title 'TOSS must alert the ISSO and SA (at a minimum) in the event of an audit processing failure.'
...
This requirement applies to each audit data storage repository (i.e., distinct information system component where audit records are stored), the centralized audit storage capacity of organizations (i.e., all audit data storage repositories combined), or both.'
  desc 'check', 'Verify that the SA and ISSO (at a minimum) are notified in the event of an audit processing failure.
...
action_mail_acct = root'
  ...
  tag check_id: 'C-56428r824247_chk'
  tag severity: 'medium'
  tag gid: 'V-252975'
  tag rid: 'SV-252975r824249_rule'
  tag stig_id: 'TOSS-04-030080'
  tag gtitle: 'SRG-OS-000046-GPOS-00022'
  tag fix_id: 'F-56378r824248_fix'
  tag 'documentable'
  tag cci: ['CCI-000139']
  tag nist: ['AU-5 a']
end
