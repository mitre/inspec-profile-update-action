control 'SV-253116' do
  title 'TOSS must ensure the SSH server uses strong entropy.'
...
The SSH service must be restarted for changes to take effect.'
  ...
  tag check_id: 'C-56569r825018_chk'
  tag severity: 'low'
  tag gid: 'V-253116'
  tag rid: 'SV-253116r825020_rule'
  tag stig_id: 'TOSS-04-040750'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-56519r825019_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
