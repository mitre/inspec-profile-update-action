...
This requirement is applicable to access control enforcement applications, a category that includes database management systems. If PostgreSQL does not follow applicable policy when approving access, it may be in conflict with networks or other applications in the information system. This may result in users either gaining or being denied access inappropriately and in conflict with applicable policy.'
  desc 'check', %q(From the system security plan or equivalent documentation, determine the appropriate permissions on database objects for each kind (group role) of user. If this documentation is missing, this is a finding.
...
$ sudo service postgresql-${PGVER?} reload)
  ...
  tag check_id: 'C-15273r360802_chk'
  tag severity: 'medium'
  tag gid: 'V-214057'
  tag rid: 'SV-214057r508027_rule'
  tag stig_id: 'PGS9-00-000900'
  tag gtitle: 'SRG-APP-000033-DB-000084'
  tag fix_id: 'F-15271r360803_fix'
  tag 'documentable'
  tag legacy: ['SV-87511', 'V-72859']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
