control 'SV-33574' do
  ...
  desc 'check', 'The policy value for User Configuration -> Administrative Templates -> Microsoft Outlook 2010 -> Security -> Cryptography -> Signature Status dialog box “Missing root certificates” must be set to “Enabled (Error)”.
...
Criteria: If the value SigStatusNoTrustDecision is REG_DWORD = 2, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft Outlook 2010 -> Security -> Cryptography -> Signature Status dialog box “Missing root certificates” to “Enabled (Error)”.'
  impact 0.5
  ref 'DPMS Target Microsoft Outlook 2010'
  tag check_id: 'C-34036r2_chk'
  tag severity: 'medium'
  tag gid: 'V-17756'
  tag rid: 'SV-33574r2_rule'
  tag stig_id: 'DTOO268 - Outlook'
  tag gtitle: 'DTOO268 - Missing Root Certificates'
  tag fix_id: 'F-29720r2_fix'
  tag 'documentable'
