control 'SV-33412' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2010 (Machine) -> Security Settings -> IE Security “Navigate URL” must be “Enabled” and a check in the ‘outlook.exe’ check box must be present.
...
Criteria: If the value outlook.exe is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2010 (Machine) -> Security Settings -> IE Security “Navigate URL” to “Enabled” and place a check in the ‘outlook.exe’ check box.'
  impact 0.5
  ref 'DPMS Target Microsoft Outlook 2010'
  tag check_id: 'C-33895r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17183'
  tag rid: 'SV-33412r1_rule'
  tag stig_id: 'DTOO123 - Outlook'
  tag gtitle: 'DTOO123-Block Navigation to URL from Office'
  tag fix_id: 'F-29584r1_fix'
  tag 'documentable'
