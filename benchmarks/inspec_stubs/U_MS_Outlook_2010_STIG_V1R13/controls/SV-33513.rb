...
If a calendar is visible to anyone on Office Online or third-party DAV servers, sensitive information might be revealed contained in calendar appointments.'
  desc 'check', 'The policy value for User Configuration -> Administrative Templates -> Microsoft Outlook 2010 -> Outlook Options -> Preferences -> Calendar Options -> Office.com Sharing Service “Access to published calendars” must be set to “Enabled”.
...
Criteria: If the value RestrictedAccessOnly is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft Outlook 2010 -> Outlook Options -> Preferences -> Calendar Options -> Office.com Sharing Service “Access to published calendars” to “Enabled”.'
  impact 0.5
  ref 'DPMS Target Microsoft Outlook 2010'
  tag check_id: 'C-34000r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17546'
  tag rid: 'SV-33513r1_rule'
  tag stig_id: 'DTOO219 - Outlook'
  tag gtitle: 'DTOO219 - Access to Published Calendars'
  tag fix_id: 'F-29688r1_fix'
  tag 'documentable'
