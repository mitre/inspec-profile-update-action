...
By default, Outlook allows scripts included in custom forms or folder home pages for public folders to execute. If users inadvertently run dangerous scripts when using public folders, their computers or data could be at risk.'
  desc 'check', 'The policy value for User Configuration -> Administrative Templates -> Microsoft Outlook 2010 -> Outlook Options -> Other -> Advanced “Do not allow Outlook object model scripts to run for public folders” must be set to “Enabled”.
...
Criteria: If the value PublicFolderScript is REG_DWORD = 0, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft Outlook 2010 -> Outlook Options -> Other -> Advanced “Do not allow Outlook object model scripts to run for public folders” to “Enabled”.'
  impact 0.5
  ref 'DPMS Target Microsoft Outlook 2010'
  tag check_id: 'C-33996r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17675'
  tag rid: 'SV-33510r1_rule'
  tag stig_id: 'DTOO233 - Outlook'
  tag gtitle: 'DTOO233 - OOM scripts for Public Folders'
  tag fix_id: 'F-29685r1_fix'
  tag 'documentable'
