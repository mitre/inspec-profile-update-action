control 'SV-33857' do
  ...
  desc 'check', 'The policy value for User Configuration -> Administrative Templates -> Microsoft Outlook 2010 -> Security -> Trust Center “Turn off Data Execution Prevention” must be set to “Disabled".
...
Criteria: If the value EnableDEP is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft Outlook 2010 -> Security -> Trust Center “Turn off Data Execution Prevention” to “Disabled".'
  impact 0.5
  ref 'DPMS Target Microsoft Outlook 2010'
  tag check_id: 'C-34234r1_chk'
  tag severity: 'medium'
  tag gid: 'V-26590'
  tag rid: 'SV-33857r1_rule'
  tag stig_id: 'DTOO128 - Outlook'
  tag gtitle: 'DTOO128 - Data Execution Prevention'
  tag fix_id: 'F-29924r1_fix'
  tag 'documentable'
