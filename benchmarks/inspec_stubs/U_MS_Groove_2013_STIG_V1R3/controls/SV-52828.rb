...
-Overlay parent windows with their own browser windows to hide important system information, choices or prompts."
  desc 'check', %q(Verify the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Scripted Window Security Restrictions" is set to "Enabled" and 'groove.exe' is checked. 
...
Criteria: If the value groove.exe is REG_DWORD = 1, this is not a finding.)
  desc 'fix', %q(Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Scripted Window Security Restrictions" to "Enabled" and 'groove.exe' is checked.)
  impact 0.5
  ref 'DPMS Target Microsoft Groove 2013'
  tag check_id: 'C-47145r1_chk'
  tag severity: 'medium'
  tag gid: 'V-40770'
  tag rid: 'SV-52828r1_rule'
  tag stig_id: 'DTOO124'
  tag gtitle: 'DTOO124 - Scripted Window Security'
  tag fix_id: 'F-45754r1_fix'
  tag 'documentable'
