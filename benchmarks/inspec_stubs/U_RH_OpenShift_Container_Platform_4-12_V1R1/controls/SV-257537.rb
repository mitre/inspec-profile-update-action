...
The following is an example of how this will look on a system using Red Hat's public registries:
  ...
  desc 'fix', 'Configure the OpenShift Container policy to validate that image signatures are verified and enforced by executing the following:
...
" | oc apply -f -
  ...
  tag check_id: 'C-61272r921552_chk'
  tag severity: 'medium'
  tag gid: 'V-257537'
  tag rid: 'SV-257537r921554_rule'
  tag stig_id: 'CNTR-OS-000360'
  tag gtitle: 'SRG-APP-000131-CTR-000285'
  tag fix_id: 'F-61196r921553_fix'
  tag 'documentable'
  tag cci: ['CCI-001749']
  tag nist: ['CM-5 (3)']
end
