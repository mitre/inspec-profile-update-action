control 'SV-217079' do
  title 'The Juniper PE router must be configured to enforce a Quality-of-Service (QoS) policy in accordance with the QoS GIG Technical Profile.'
...
If the router is not configured to enforce a QoS policy in accordance with the QoS DODIN Technical Profile, this is a finding.'
  desc 'fix', 'Configure all interfaces to use a configured or the default BA classifier as shown in the example below:
...
https://intellipedia.intelink.gov/wiki/Portal:GIG_Technical_Guidance/GTG_GTPs/GTP_Development_List'
  ...
  tag check_id: 'C-18308r297105_chk'
  tag severity: 'low'
  tag gid: 'V-217079'
  tag rid: 'SV-217079r639663_rule'
  tag stig_id: 'JUNI-RT-000740'
  tag gtitle: 'SRG-NET-000193-RTR-000113'
  tag fix_id: 'F-18306r297106_fix'
  tag 'documentable'
  tag legacy: ['SV-101149', 'V-90939']
  tag cci: ['CCI-001095']
  tag nist: ['SC-5 (2)']
end
