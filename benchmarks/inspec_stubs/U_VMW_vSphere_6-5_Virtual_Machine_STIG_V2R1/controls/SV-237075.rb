control 'SV-237075' do
  ...
  desc 'check', 'From the vSphere Web Client right-click the Virtual Machine and go to Edit Settings >> VM Options >> Advanced >> Configuration Parameters >> Edit Configuration. Verify the isolation.tools.memSchedFakeSampleStats.disable value is set to true.
...
If the virtual machine advanced setting isolation.tools.memSchedFakeSampleStats.disable does not exist or is not set to true, this is a finding.'
  desc 'fix', 'From the vSphere Web Client right-click the Virtual Machine and go to Edit Settings >> VM Options >> Advanced >> Configuration Parameters >> Edit Configuration. Find the isolation.tools.memSchedFakeSampleStats.disable value and set it to true. If the setting does not exist, add the Name and Value setting at the bottom of screen.
...
Get-VM "VM Name" | Get-AdvancedSetting -Name isolation.tools.memSchedFakeSampleStats.disable | Set-AdvancedSetting -Value true'
  ...
  tag check_id: 'C-40294r640060_chk'
  tag severity: 'low'
  tag gid: 'V-237075'
  tag rid: 'SV-237075r640062_rule'
  tag stig_id: 'VMCH-65-000013'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-40257r640061_fix'
  tag 'documentable'
  tag legacy: ['SV-104413', 'V-94583']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
