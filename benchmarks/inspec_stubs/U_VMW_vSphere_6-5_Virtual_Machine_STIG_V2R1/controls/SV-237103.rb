control 'SV-237103' do
  ...
  desc 'check', 'Note: If the system does not have vCenter installed and utilizes vMotion, then this is Not Applicable.
...
If the setting does not have a value of "Opportunistic" or "Required", this is a finding.'
  ...
  tag check_id: 'C-40322r802904_chk'
  tag severity: 'medium'
  tag gid: 'V-237103'
  tag rid: 'SV-237103r802905_rule'
  tag stig_id: 'VMCH-65-000049'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-40285r717087_fix'
  tag 'documentable'
  tag legacy: ['SV-104481', 'V-94651']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
