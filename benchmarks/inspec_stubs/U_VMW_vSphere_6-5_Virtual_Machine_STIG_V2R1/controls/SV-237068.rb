...
Get-VM "VM Name" | Get-AdvancedSetting -Name isolation.tools.paste.disable | Set-AdvancedSetting -Value true'
  ...
  tag check_id: 'C-40287r640039_chk'
  tag severity: 'low'
  tag gid: 'V-237068'
  tag rid: 'SV-237068r640041_rule'
  tag stig_id: 'VMCH-65-000004'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-40250r640040_fix'
  tag 'documentable'
  tag legacy: ['SV-104399', 'V-94569']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
