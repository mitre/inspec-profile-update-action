control 'SV-237070' do
  ...
  desc 'check', 'From the vSphere Web Client right-click the Virtual Machine and go to Edit Settings >> VM Options >> Advanced >> Configuration Parameters >> Edit Configuration. Verify the isolation.tools.diskWiper.disable value is set to true.
...
If the virtual machine advanced setting isolation.tools.diskWiper.disable does not exist or is not set to true, this is a finding.'
  desc 'fix', 'From the vSphere Web Client right-click the Virtual Machine and go to Edit Settings >> VM Options >> Advanced >> Configuration Parameters >> Edit Configuration. Find the isolation.tools.diskWiper.disable value and set it to true. If the setting does not exist, add the Name and Value setting at the bottom of screen.
...
Get-VM "VM Name" | Get-AdvancedSetting -Name isolation.tools.diskWiper.disable | Set-AdvancedSetting -Value true'
  ...
  tag check_id: 'C-40289r640045_chk'
  tag severity: 'medium'
  tag gid: 'V-237070'
  tag rid: 'SV-237070r640047_rule'
  tag stig_id: 'VMCH-65-000006'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-40252r640046_fix'
  tag 'documentable'
  tag legacy: ['SV-104403', 'V-94573']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
