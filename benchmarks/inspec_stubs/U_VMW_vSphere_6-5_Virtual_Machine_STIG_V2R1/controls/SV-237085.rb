control 'SV-237085' do
  ...
  desc 'check', 'From the vSphere Web Client right-click the Virtual Machine and go to Edit Settings >> VM Options >> Advanced >> Configuration Parameters >> Edit Configuration. Verify the isolation.tools.vmxDnDVersionGet.disable value is set to true.
...
If the virtual machine advanced setting isolation.tools.vmxDnDVersionGet.disable does not exist or is not set to true, this is a finding.'
  desc 'fix', 'From the vSphere Web Client right-click the Virtual Machine and go to Edit Settings >> VM Options >> Advanced >> Configuration Parameters >> Edit Configuration. Find the isolation.tools.vmxDnDVersionGet.disable value and set it to true. If the setting does not exist, add the Name and Value setting at the bottom of screen.
...
Get-VM "VM Name" | Get-AdvancedSetting -Name isolation.tools.vmxDnDVersionGet.disable | Set-AdvancedSetting -Value true'
  ...
  tag check_id: 'C-40304r640090_chk'
  tag severity: 'low'
  tag gid: 'V-237085'
  tag rid: 'SV-237085r640092_rule'
  tag stig_id: 'VMCH-65-000025'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-40267r640091_fix'
  tag 'documentable'
  tag legacy: ['SV-104439', 'V-94609']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
