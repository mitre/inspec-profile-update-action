control 'SV-243131' do
  title 'The vCenter Server Administrator role must be secured and assigned to specific users other than a Windows Administrator.'
...
If there are any groups or users present in the local administrators group of the vCenter server, this is a finding.'
  ...
  tag check_id: 'C-46406r719634_chk'
  tag severity: 'medium'
  tag gid: 'V-243131'
  tag rid: 'SV-243131r719636_rule'
  tag stig_id: 'VCTR-67-000076'
  tag gtitle: 'SRG-APP-000516'
  tag fix_id: 'F-46363r719635_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
