...
If NetFlow is configured and the collector IP is not known and documented, this is a finding.'
  desc 'fix', 'To remove collector IPs:
...
$pg.ReconfigureDVPortgroup_Task($spec)
  ...
  tag check_id: 'C-46360r719496_chk'
  tag severity: 'medium'
  tag gid: 'V-243085'
  tag rid: 'SV-243085r719498_rule'
  tag stig_id: 'VCTR-67-000016'
  tag gtitle: 'SRG-APP-000516'
  tag fix_id: 'F-46317r719497_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
