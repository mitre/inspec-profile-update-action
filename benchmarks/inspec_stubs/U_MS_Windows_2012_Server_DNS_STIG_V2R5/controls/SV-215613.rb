control 'SV-215613' do
  title 'The Windows 2012 DNS Server must use DNSSEC data within queries to confirm data origin to DNS resolvers.'
...
From the expanded list, right-click to select the zone (repeat for each hosted zone), point to DNSSEC, and then click Sign the Zone, either using approved saved parameters or approved custom parameters.'
  ...
  tag check_id: 'C-16807r314314_chk'
  tag severity: 'medium'
  tag gid: 'V-215613'
  tag rid: 'SV-215613r561297_rule'
  tag stig_id: 'WDNS-SC-000005'
  tag gtitle: 'SRG-APP-000421-DNS-000054'
  tag fix_id: 'F-16805r314315_fix'
  tag 'documentable'
  tag legacy: ['SV-73089', 'V-58659']
