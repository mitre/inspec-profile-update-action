control 'SV-215574' do
  title 'Forwarders on an authoritative Windows 2012 DNS Server, if enabled for external resolution, must only forward to either an internal, non-AD-integrated DNS server or to the DoD Enterprise Recursive Services (ERS).'
...
Deselect the "Use root hints if no forwarders are available".'
  ...
  tag check_id: 'C-16768r572194_chk'
  tag severity: 'medium'
  tag gid: 'V-215574'
  tag rid: 'SV-215574r561297_rule'
  tag stig_id: 'WDNS-CM-000004'
  tag gtitle: 'SRG-APP-000383-DNS-000047'
  tag fix_id: 'F-16766r572195_fix'
  tag 'documentable'
  tag legacy: ['SV-73011', 'V-58581']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
