...
The DNS server should perform self-tests, such as at server start-up, to confirm that its security functions are working properly.'
  desc 'check', 'This functionality should be performed by an Endpoint Security Solution (ESS), mandatory on all DoD systems.

Verify ESS is installed and fully operational on the Windows DNS Server.

If all required ESS products are not installed and/or the installed products are not enabled, this is a finding.'
  desc 'fix', 'Follow the ESS guidance to install all ESS products on the Windows DNS Server.'
  impact 0.5
  ref 'DPMS Target Microsoft Windows 2012 Server Domain Name System'
  tag check_id: 'C-16837r804970_chk'
  tag severity: 'medium'
  tag gid: 'V-215643'
  tag rid: 'SV-215643r804971_rule'
  tag stig_id: 'WDNS-SI-000006'
  tag gtitle: 'SRG-APP-000473-DNS-000072'
  tag fix_id: 'F-16835r804968_fix'
  tag 'documentable'
