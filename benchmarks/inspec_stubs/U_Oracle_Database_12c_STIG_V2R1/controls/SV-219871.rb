control 'SV-219871' do
  ...
  desc 'check', %q(If no data is identified as being sensitive or classified by the Information Owner, in the System Security Plan or in the AIS Functional Architecture documentation, this is not a finding.
...
http://docs.oracle.com/database/121/DBSEG/audit_config.htm#CHDGBAAC'
  ...
  tag check_id: 'C-21582r533126_chk'
  tag severity: 'medium'
  tag gid: 'V-219871'
  tag rid: 'SV-219871r401224_rule'
