...
The SSH service must be restarted for changes to take effect.'
  ...
  tag check_id: 'C-55916r922856_chk'
  tag severity: 'high'
  tag gid: 'V-252460'
  tag rid: 'SV-252460r922858_rule'
  tag stig_id: 'APPL-12-000055'
  tag gtitle: 'SRG-OS-000033-GPOS-00014'
  tag fix_id: 'F-55866r922857_fix'
  ...
  tag 'documentable'
  tag cci: ['CCI-000068', 'CCI-000803', 'CCI-003123', 'CCI-002890']
  tag nist: ['AC-17 (2)', 'IA-7', 'MA-4 (6)', 'MA-4 (6)']
end
