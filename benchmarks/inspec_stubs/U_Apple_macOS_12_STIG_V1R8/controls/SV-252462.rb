...
A text editor may also be used to implement the required updates to the "/etc/security/audit_control" file.)
  ...
  tag check_id: 'C-55918r816198_chk'
  tag severity: 'medium'
  tag gid: 'V-252462'
  tag rid: 'SV-252462r853271_rule'
  tag stig_id: 'APPL-12-001001'
  tag gtitle: 'SRG-OS-000004-GPOS-00004'
  tag fix_id: 'F-55868r853270_fix'
  ...
  tag 'documentable'
  tag cci: ['CCI-000018', 'CCI-000172', 'CCI-001403', 'CCI-001404', 'CCI-001405', 'CCI-002884', 'CCI-002234']
  tag nist: ['AC-2 (4)', 'AU-12 c', 'AC-2 (4)', 'AC-2 (4)', 'AC-2 (4)', 'MA-4 (1) (a)', 'AC-6 (9)']
end
