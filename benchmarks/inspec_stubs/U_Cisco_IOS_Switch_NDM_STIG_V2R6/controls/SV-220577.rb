...
System use notifications are required only for access via logon interfaces with human users.'
  desc 'check', 'Review the Cisco switch configuration to verify that it displays the Standard Mandatory DoD Notice and Consent Banner before granting access to the device as shown in the example below:
...
SW1(config)#end"
  ...
  tag check_id: 'C-22292r507777_chk'
  tag severity: 'medium'
  tag gid: 'V-220577'
  tag rid: 'SV-220577r879547_rule'
  tag stig_id: 'CISC-ND-000160'
  tag gtitle: 'SRG-APP-000068-NDM-000215'
  tag fix_id: 'F-22281r507778_fix'
  tag 'documentable'
  tag legacy: ['SV-110383', 'V-101279']
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
