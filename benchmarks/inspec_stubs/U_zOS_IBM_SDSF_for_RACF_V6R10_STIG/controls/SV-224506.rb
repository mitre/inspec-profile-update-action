...
___       The RACF data set rules for the data sets restricts READ access to the auditors.

___       The RACF data set rules for the data sets restricts UPDATE access to SDSF Started Tasks.
...
PE ' sys1.haspindx.**' ID(audtaudt) ACC(R)"
  ...
  tag check_id: 'C-26189r520367_chk'
  tag severity: 'medium'
  tag gid: 'V-224506'
  tag rid: 'SV-224506r520369_rule'
  tag stig_id: 'ZISFR002'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-26177r520368_fix'
  tag 'documentable'
  tag legacy: ['SV-40731', 'V-21592']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
