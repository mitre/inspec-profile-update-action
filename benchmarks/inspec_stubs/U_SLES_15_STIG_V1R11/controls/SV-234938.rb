control 'SV-234938' do
  title 'The SUSE operating system must generate audit records for all uses of the rmmod command.'
...
The "-k" allows for specifying an arbitrary identifier. The string following "-k" does not need to match the example output above.)
  desc 'fix', 'Configure the SUSE operating system to audit the execution of the module management program "rmmod" by adding the following line to "/etc/audit/rules.d/audit.rules":
