...
/usr/bin/sudo /usr/bin/pwpolicy -u username setaccountpolicies /path/to/file'
  ...
  tag check_id: 'C-26826r467549_chk'
  tag severity: 'medium'
  tag gid: 'V-225127'
  tag rid: 'SV-225127r610901_rule'
  tag stig_id: 'AOSX-15-000012'
  tag gtitle: 'SRG-OS-000002-GPOS-00002'
  tag fix_id: 'F-26814r485756_fix'
  tag satisfies: ['SRG-OS-000002-GPOS-00002', 'SRG-OS-000123-GPOS-00064']
  tag 'documentable'
  tag legacy: ['SV-111631', 'V-102669']
