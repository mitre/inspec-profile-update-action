...
'
  desc 'check', 'Verify that iCloud has been disabled:
...
If the output is null or not "allowCloudPhotoLibrary = 0", this is a finding.'
  ...
  tag check_id: 'C-26891r467744_chk'
  tag severity: 'medium'
  tag gid: 'V-225192'
  tag rid: 'SV-225192r853335_rule'
  tag stig_id: 'AOSX-15-002043'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26879r467745_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['V-102803', 'SV-111765']
