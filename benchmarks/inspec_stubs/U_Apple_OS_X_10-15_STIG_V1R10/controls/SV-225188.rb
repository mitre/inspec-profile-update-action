control 'SV-225188' do
  title 'The macOS system must disable Siri setup pop-ups.'
...
'
  desc 'check', 'To check if the Skip Siri Setup prompt is enabled, run the following command:
...
If the output is null or "SkipSiriSetup" is not set to "1", this is a finding.'
  ...
  tag check_id: 'C-26887r467732_chk'
  tag severity: 'medium'
  tag gid: 'V-225188'
  tag rid: 'SV-225188r853331_rule'
  tag stig_id: 'AOSX-15-002039'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26875r467733_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['V-102795', 'SV-111757']
