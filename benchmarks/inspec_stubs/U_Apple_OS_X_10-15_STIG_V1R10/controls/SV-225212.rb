...
/usr/bin/sudo /usr/bin/sed -i.bak 's/^[\#]*PasswordAuthentication.*/PasswordAuthentication no/' /etc/ssh/sshd_config)
  ...
  tag check_id: 'C-26911r853340_chk'
  tag severity: 'high'
  tag gid: 'V-225212'
  tag rid: 'SV-225212r853342_rule'
  tag stig_id: 'AOSX-15-003020'
  tag gtitle: 'SRG-OS-000105-GPOS-00052'
  tag fix_id: 'F-26899r853341_fix'
  ...
  tag cci: ['CCI-000187', 'CCI-000765', 'CCI-000766', 'CCI-000767', 'CCI-000768', 'CCI-000877', 'CCI-001948']
  tag nist: ['IA-5 (2) (a) (2)', 'IA-2 (1)', 'IA-2 (2)', 'IA-2 (3)', 'IA-2 (4)', 'MA-4 c', 'IA-2 (11)']
end
