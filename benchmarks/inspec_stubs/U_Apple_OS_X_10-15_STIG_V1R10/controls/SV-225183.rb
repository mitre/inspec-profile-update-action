...
If the return is not "SkipSiriSetup = 1", this is a finding.'
  ...
  tag check_id: 'C-26882r467717_chk'
  tag severity: 'medium'
  tag gid: 'V-225183'
  tag rid: 'SV-225183r610901_rule'
  tag stig_id: 'AOSX-15-002034'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26870r467718_fix'
  tag 'documentable'
  tag legacy: ['SV-111747', 'V-102785']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
