...
"
  desc 'check', 'To check if iCloudCalendar is disabled, run the following command:
...
If the return is not “allowCloudCalendar = 0”, this is a finding.'
  ...
  tag check_id: 'C-26869r467678_chk'
  tag severity: 'low'
  tag gid: 'V-225170'
  tag rid: 'SV-225170r853323_rule'
  tag stig_id: 'AOSX-15-002012'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26857r467679_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['V-102757', 'SV-111719']
