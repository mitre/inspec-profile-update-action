...
After "FileVault" is initially set up, additional users can be added.'
  ...
  tag check_id: 'C-26919r467828_chk'
  tag severity: 'medium'
  tag gid: 'V-225220'
  tag rid: 'SV-225220r853345_rule'
  tag stig_id: 'AOSX-15-005020'
  tag gtitle: 'SRG-OS-000185-GPOS-00079'
  tag fix_id: 'F-26907r853344_fix'
  tag satisfies: ['SRG-OS-000185-GPOS-00079', 'SRG-OS-000404-GPOS-00183', 'SRG-OS-000405-GPOS-00184']
  tag 'documentable'
  tag legacy: ['SV-111821', 'V-102859']
