...
If the command does not return a line containing the value "pam_pwquality.so" or the line is commented out, this is a finding.'
  desc 'fix', 'Configure OL 8 to use "pwquality" to enforce password complexity rules.
...
password required pam_pwquality.so'
  ...
  tag check_id: 'C-52120r818656_chk'
  tag severity: 'medium'
  tag gid: 'V-248686'
  tag rid: 'SV-248686r818658_rule'
  tag stig_id: 'OL08-00-020100'
  tag gtitle: 'SRG-OS-000069-GPOS-00037'
  tag fix_id: 'F-52074r818657_fix'
