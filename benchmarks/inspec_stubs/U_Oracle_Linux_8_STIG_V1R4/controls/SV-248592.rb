control 'SV-248592' do
  title 'OL 8 must clear SLUB/SLAB objects to prevent use-after-free attacks.'
...
If "slub_debug" is not set to "P", is missing or commented out, this is a finding.'
  desc 'fix', 'Configure OL 8 to enable poisoning of SLUB/SLAB objects with the following commands:
...
GRUB_CMDLINE_LINUX="slub_debug=P"'
  ...
  tag check_id: 'C-52026r779340_chk'
  tag severity: 'medium'
  tag gid: 'V-248592'
  tag rid: 'SV-248592r779342_rule'
  tag stig_id: 'OL08-00-010423'
  tag gtitle: 'SRG-OS-000134-GPOS-00068'
  tag fix_id: 'F-51980r779341_fix'
  tag 'documentable'
  tag cci: ['CCI-001084']
  tag nist: ['SC-3']
end
