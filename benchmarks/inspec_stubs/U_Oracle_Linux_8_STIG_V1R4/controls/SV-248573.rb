...
Determine if AIDE is installed on the system with the following command:
...
/usr/sbin/aide --check | /bin/mail -s "$HOSTNAME - Daily aide integrity check run" root@sysname.mil'
  ...
  tag check_id: 'C-52007r779283_chk'
  tag severity: 'medium'
  tag gid: 'V-248573'
  tag rid: 'SV-248573r853752_rule'
  tag stig_id: 'OL08-00-010360'
  tag gtitle: 'SRG-OS-000363-GPOS-00150'
  tag fix_id: 'F-51961r779284_fix'
