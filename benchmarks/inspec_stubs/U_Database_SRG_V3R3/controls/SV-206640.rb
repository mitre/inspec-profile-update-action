...
For detailed information, refer to NIST FIPS Publication 140-3, Security Requirements For Cryptographic Modules. Note that the product's cryptographic modules must be validated and certified by NIST as FIPS-compliant."
  desc 'check', 'If the DBMS does not employ NIST FIPS 140-2 or 140-3 validated cryptographic modules to generate and verify cryptographic hashes, this is a finding.'
  desc 'fix', 'Implement a NIST FIPS 140-2 or 140-3 validated cryptographic module in the DBMS for generation and verification of cryptographic hashes.'
  impact 0.5
  ref 'DPMS Target Database Generic'
  tag check_id: 'C-6900r836865_chk'
  tag severity: 'medium'
  tag gid: 'V-206640'
  tag rid: 'SV-206640r836867_rule'
  tag stig_id: 'SRG-APP-000514-DB-000382'
  tag gtitle: 'SRG-APP-000514'
  tag fix_id: 'F-6900r836866_fix'
  tag 'documentable'
