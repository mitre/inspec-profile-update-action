...
If security labeling requirements have been specified, but the security labeling is not implemented or does not reliably maintain labels on information in transmission, this is a finding.'
  desc 'fix', 'Enable DBMS features, deploy third-party software, or add custom data structures, data elements and application code, to provide reliable security labeling of information in transmission.'
  impact 0.5
  ref 'DPMS Target Database Generic'
  tag check_id: 'C-6844r291420_chk'
  tag severity: 'medium'
  tag gid: 'V-206584'
  tag rid: 'SV-206584r617447_rule'
  tag stig_id: 'SRG-APP-000314-DB-000310'
  tag gtitle: 'SRG-APP-000314'
  tag fix_id: 'F-6844r291421_fix'
  tag 'documentable'
  tag legacy: ['SV-72471', 'V-58041']
  tag cci: ['CCI-002264']
  tag nist: ['AC-16 a']
end
