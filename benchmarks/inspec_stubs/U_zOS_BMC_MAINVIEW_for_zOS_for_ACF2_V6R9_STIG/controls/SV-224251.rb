...
___	The ACF2 data set rules for the data sets restricts UPDATE and/or ALTER access to the BMC MAINVIEW for z/OS’s STC(s) and/or batch user(s).'
  desc 'fix', 'The IAO will ensure that update and allocate access to BMC MAINVIEW for z/OS STC data sets is limited to System Programmers and/or BMC MAINVIEW for z/OS’s STC(s) and/or batch user(s) only.  Read access can be given to auditors and authorized users.
...
BMCVIEW.- UID(authorize users) R(A) E(A)'
  ...
  tag check_id: 'C-25924r518962_chk'
  tag severity: 'medium'
  tag gid: 'V-224251'
  tag rid: 'SV-224251r518964_rule'
  tag stig_id: 'ZMVZA001'
  tag gtitle: 'SRG-OS-000259'
  tag fix_id: 'F-25912r518963_fix'
  tag 'documentable'
