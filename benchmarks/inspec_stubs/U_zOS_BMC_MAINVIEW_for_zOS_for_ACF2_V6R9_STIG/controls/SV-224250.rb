...
BMCVIEW.- UID(MAINVIEW STCs) R(A) E(A)'
  ...
  tag check_id: 'C-25923r518959_chk'
  tag severity: 'medium'
  tag gid: 'V-224250'
  tag rid: 'SV-224250r518961_rule'
  tag stig_id: 'ZMVZA000'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-25911r518960_fix'
  tag 'documentable'
  tag legacy: ['V-16932', 'SV-33835']
