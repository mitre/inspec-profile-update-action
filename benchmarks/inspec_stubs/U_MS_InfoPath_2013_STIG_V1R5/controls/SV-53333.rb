control 'SV-53333' do
  ...
  desc 'check', 'The policy value for User Configuration -> Administrative Templates -> Microsoft InfoPath 2013 -> Security -> Trust Center "Disable all trusted locations" must be set to "Enabled".

Procedure: Use the Windows Registry Editor to navigate to the following key: 

HKCU\\Software\\Policies\\Microsoft\\Office\\15.0\\InfoPath\\security\\trusted locations

Criteria: If the value AllLocationsDisabled is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft InfoPath 2013 -> Security -> Trust Center "Disable all trusted locations" to "Enabled".'
  impact 0.5
  ref 'DPMS Target Microsoft InfoPath 2013'
  tag check_id: 'C-47612r2_chk'
  tag severity: 'medium'
  tag gid: 'V-17471'
  tag rid: 'SV-53333r2_rule'
  tag stig_id: 'DTOO133'
  tag gtitle: 'DTOO133-Disable all trusted locations'
  tag fix_id: 'F-46262r1_fix'
  tag 'documentable'
