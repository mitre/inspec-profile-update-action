...
By default, InfoPath can open email forms with full trust. If an attacker designs and sends a dangerous fully trusted email form, it could affect users' computers or give the attacker access to sensitive information."
  desc 'check', 'The policy value for User Configuration -> Administrative Templates -> Microsoft InfoPath 2013 -> InfoPath e-mail forms "Disable e-mail forms from the Full Trust security zone" must be set to "Enabled".
...
Criteria: If the value EnableFullTrustEmailForms is REG_DWORD = 0, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft InfoPath 2013 -> InfoPath e-mail forms "Disable e-mail forms from the Full Trust security zone" to "Enabled".'
  impact 0.5
  ref 'DPMS Target Microsoft InfoPath 2013'
  tag check_id: 'C-47628r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17655'
  tag rid: 'SV-53383r1_rule'
  tag stig_id: 'DTOO173'
  tag gtitle: 'DTOO173 - E-Mail forms from Full Trust Zone'
  tag fix_id: 'F-46307r1_fix'
  tag 'documentable'
