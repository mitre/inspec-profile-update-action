control 'SV-239345' do
  title 'Console access through the VNC protocol must be disabled on the virtual machine.'
  desc 'The VM console enables connection to the console of a virtual machine, in effect seeing what a monitor on a physical server would show. This console is also available via the VNC protocol and should be disabled.'
...
Get-VM "VM Name" | Get-AdvancedSetting -Name RemoteDisplay.vnc.enabled | Set-AdvancedSetting -Value false'
  ...
  tag check_id: 'C-42578r679582_chk'
  tag severity: 'medium'
  tag gid: 'V-239345'
