control 'SV-34946' do
  ...
  desc 'check', 'Check /etc/fstab and verify the nosuid mount option is used on file systems mounted from removable media, network shares, or any other file system not containing approved setuid or setgid files.
...
If the "nosuid" mount option is not used on file systems mounted from removable media, network shares, or any other file system that does not contain approved setuid or setgid files, this is a finding.'
  ...
  tag check_id: 'C-36403r1_chk'
  tag severity: 'medium'
  tag gid: 'V-805'
  tag rid: 'SV-34946r1_rule'
  tag stig_id: 'GEN002420'
  tag gtitle: 'GEN002420'
  tag fix_id: 'F-31742r1_fix'
  tag 'documentable'
