control 'SV-34915' do
  ...
  desc 'check', %q(Verify local initialization files have executable search path containing only absolute paths.
...
This variable is formatted as a colon-separated list of directories. If there is an empty entry, such as a leading or trailing colon, or two consecutive colons, this is a finding. If an entry begins with a character other than a slash (/), this is a relative path, and this is a finding.)
  desc 'fix', 'Edit the local initialization file and remove the relative path entry from the executable search path variable.'
  impact 0.5
  ref 'DPMS Target HP-UX 11.23'
  tag check_id: 'C-37677r1_chk'
  tag severity: 'medium'
  tag gid: 'V-11986'
  tag rid: 'SV-34915r1_rule'
  tag stig_id: 'GEN001900'
  tag gtitle: 'GEN001900'
  tag fix_id: 'F-32917r1_fix'
  tag 'documentable'
