...
"I've read & consent to terms in IS user agreem't.")
  ...
  tag check_id: 'C-36267r1_chk'
  tag severity: 'medium'
  tag gid: 'V-23732'
  tag rid: 'SV-38407r1_rule'
  tag stig_id: 'GEN000410'
  tag gtitle: 'GEN000410'
  tag fix_id: 'F-31524r1_fix'
  tag 'documentable'
