...
Each of the exported file systems should include an entry for the anon= option set to -1 or an equivalent (60001, 65534, or 65535). If an appropriate anon= setting is not present for an exported file system, this is a finding.'
  desc 'fix', 'Edit /etc/exports and set the anon=-1 option for exports without it. Re-export the file systems.'
  impact 0.5
  ref 'DPMS Target HP-UX 11.23'
  tag check_id: 'C-35042r1_chk'
  tag severity: 'medium'
  tag gid: 'V-932'
  tag rid: 'SV-39006r1_rule'
  tag stig_id: 'GEN005820'
  tag gtitle: 'GEN005820'
  tag fix_id: 'F-1086r2_fix'
  tag 'documentable'
  tag responsibility: 'System Administrator'
  tag ia_controls: 'IAIA-2, IAIA-1, ECSC-1'
  tag cci: ['CCI-000062']
  tag nist: ['AC-14 (1)']
end
