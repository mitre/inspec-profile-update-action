...
If the exported file systems do not contain the 'rw' or 'ro' options specifying a list of hosts or networks, this is a finding."
  desc 'fix', 'Edit /etc/exports and add ro and/or rw options (as appropriate) specifying a list of hosts or networks which are permitted access. Re-export the file systems via the following commands:
# exportfs -u <the file system entry that was modified>
# exportfs -v <the file system entry that was modified>'
  impact 0.5
  ref 'DPMS Target HP-UX 11.23'
  tag check_id: 'C-36686r1_chk'
  tag severity: 'medium'
  tag gid: 'V-933'
  tag rid: 'SV-39008r1_rule'
  tag stig_id: 'GEN005840'
  tag gtitle: 'GEN005840'
  tag fix_id: 'F-32060r1_fix'
  tag 'documentable'
