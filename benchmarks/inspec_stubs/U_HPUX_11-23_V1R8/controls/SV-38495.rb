control 'SV-38495' do
  ...
  desc 'check', 'Verify the run control scripts search paths do not contain references to the current working directory or other relative paths in any script where the "PATH" variable occurs.
...
This variable is formatted as a colon-separated list of directories. If there is an empty entry, such as a leading or trailing colon, or two consecutive colons, this is a finding. If an entry begins with a character other than a slash (/), this is a relative path, and this is a finding.'
  ...
  tag check_id: 'C-36339r1_chk'
  tag severity: 'medium'
  tag gid: 'V-907'
  tag rid: 'SV-38495r1_rule'
  tag stig_id: 'GEN001600'
  tag gtitle: 'GEN001600'
  tag fix_id: 'F-31594r1_fix'
  tag 'documentable'
