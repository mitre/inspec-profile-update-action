control 'SV-35080' do
  ...
  desc 'check', 'Check the group ownership of the services file. NOTE: The typical default group ownership for the services file is bin.
# ls -lL /etc/services
