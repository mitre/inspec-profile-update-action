control 'SV-52784' do
  ...
  desc 'check', %q(Verify the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Block popups" is set to "Enabled" and 'onent.exe' is checked. 
...
Criteria: If the value onenote.exe is REG_DWORD = 1, this is not a finding.)
  desc 'fix', %q(Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Block popups" to "Enabled" and select 'onent.exe'.)
  impact 0.5
  ref 'DPMS Target Microsoft OneNote 2013'
  tag check_id: 'C-47113r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17184'
  tag rid: 'SV-52784r1_rule'
  tag stig_id: 'DTOO129'
  tag gtitle: 'DTOO129 - Block Pop-Ups'
  tag fix_id: 'F-45710r1_fix'
  tag 'documentable'
