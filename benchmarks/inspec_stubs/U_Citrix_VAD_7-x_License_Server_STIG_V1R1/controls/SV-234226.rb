control 'SV-234226' do
  title 'Citrix License Server must protect the confidentiality and integrity of transmitted information.'
...
7. Stop and restart the Citrix Licensing service from the services control panel of the machine running the license server.'
  ...
  tag check_id: 'C-37411r611929_chk'
  tag severity: 'medium'
  tag gid: 'V-234226'
  tag rid: 'SV-234226r628795_rule'
  tag stig_id: 'CVAD-LS-001000'
  tag gtitle: 'SRG-APP-000439'
  tag fix_id: 'F-37376r611930_fix'
  tag 'documentable'
  tag cci: ['CCI-002418']
  tag nist: ['SC-8']
end
