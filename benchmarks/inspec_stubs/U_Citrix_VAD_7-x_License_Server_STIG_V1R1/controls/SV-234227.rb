control 'SV-234227' do
  title 'Citrix License Server must implement cryptographic mechanisms to prevent unauthorized disclosure of information and/or detect changes to information during transmission unless otherwise protected by alternative physical safeguards, such as, at a minimum, a Protected Distribution Systems (PDS).'
...
7. Stop and restart the Citrix Licensing service from the services control panel of the machine running the license server.'
  ...
  tag check_id: 'C-37412r611932_chk'
  tag severity: 'high'
  tag gid: 'V-234227'
  tag rid: 'SV-234227r628795_rule'
  tag stig_id: 'CVAD-LS-001005'
  tag gtitle: 'SRG-APP-000440'
  tag fix_id: 'F-37377r611933_fix'
  tag 'documentable'
  tag cci: ['CCI-002421']
  tag nist: ['SC-8 (1)']
end
