...
NOTE:	The default system password for CA 1 provided by CA is CA1(TMS).  The default system passwords provided by SSO are SSOCA1DF and SSOC@1DF."
  desc 'fix', "The systems programmer/IAO will ensure that the CA 1 system password is changed from the vendor default system password.
...
NOTE:	The default system password for CA 1 provided by CA is CA1(TMS).  The default system passwords provided by SSO are SSOCA1DF and SSOC@1DF."
  ...
  tag check_id: 'C-26319r519512_chk'
  tag severity: 'medium'
  tag gid: 'V-224636'
  tag rid: 'SV-224636r519514_rule'
  tag stig_id: 'ZCA10041'
  tag gtitle: 'SRG-OS-000018'
  tag fix_id: 'F-26307r519513_fix'
  tag 'documentable'
  tag legacy: ['V-22689', 'SV-40107']
  tag cci: ['CCI-000035']
  tag nist: ['AC-4 (11)']
end
