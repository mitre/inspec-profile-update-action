...
If the command returns any output, this is a finding.'
  desc 'fix', 'If the VAMI binaries have been modified from the default state when deployed as part of the VCSA, the system must be wiped and redeployed or restored from backup. 
...
VMware does not recommend or support recovering from such a state by reinstalling RPMs or similar efforts.'
  ...
  tag check_id: 'C-42956r679277_chk'
  tag severity: 'medium'
  tag gid: 'V-239723'
