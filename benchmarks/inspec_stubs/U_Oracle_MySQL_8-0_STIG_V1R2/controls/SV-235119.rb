control 'SV-235119' do
  title 'The MySQL Database Server 8.0 must generate audit records when privileges/permissions are deleted.'
...
In an SQL environment, deleting permissions is typically done via the REVOKE or DENY command.'
  desc 'check', %q(Review the system documentation to determine if MySQL Server is required to audit when privileges/permissions are deleted.
...
If the audit event is not present, this is a finding.)
  desc 'fix', 'If currently required, configure the MySQL Database Server to produce audit records when privileges/permissions are deleted.

See the supplemental file "MySQL80Audit.sql".'
  impact 0.5
  ref 'DPMS Target Oracle MySQL 8.0'
  tag check_id: 'C-38338r623477_chk'
  tag severity: 'medium'
  tag gid: 'V-235119'
  tag rid: 'SV-235119r623479_rule'
  tag stig_id: 'MYS8-00-003200'
  tag gtitle: 'SRG-APP-000499-DB-000330'
  tag fix_id: 'F-38301r623478_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
