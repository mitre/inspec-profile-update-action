control 'SV-252871' do
  title 'Zebra Android 11 must be configured to enforce that Wi-Fi Sharing is disabled.'
...
If on the Zebra Android 11 device "Wi-Fi sharing" is enabled, this is a finding.'
  desc 'fix', 'Configure Zebra Android 11 device to disable Wi-Fi Sharing. 
...
2. Toggle "Disallow config tethering" to "On".'
  ...
  tag check_id: 'C-56327r820538_chk'
  tag severity: 'medium'
  tag gid: 'V-252871'
  tag rid: 'SV-252871r820540_rule'
  tag stig_id: 'ZEBR-11-008800'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-56277r820539_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
