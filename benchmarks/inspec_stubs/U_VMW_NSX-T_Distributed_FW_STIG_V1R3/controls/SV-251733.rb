control 'SV-251733' do
  title 'The NSX-T Distributed Firewall must verify time-based firewall rules.'
  desc 'With time windows, security administrators can restrict traffic from a source or to a destination, for a specific time period.
...
After all changes are made click "Publish".'
  ...
  tag check_id: 'C-55170r810051_chk'
  tag severity: 'medium'
  tag gid: 'V-251733'
  tag rid: 'SV-251733r810053_rule'
  tag stig_id: 'TDFW-3X-000042'
  tag gtitle: 'SRG-NET-000019-FW-000003'
  tag fix_id: 'F-55124r810052_fix'
  tag 'documentable'
  tag cci: ['CCI-001414']
  tag nist: ['AC-4']
end
