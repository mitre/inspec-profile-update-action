...
ALTER USER <user> NOBYPASSRLS;'
  ...
  tag check_id: 'C-25867r495600_chk'
  tag severity: 'medium'
  tag gid: 'V-224194'
  tag rid: 'SV-224194r508023_rule'
  tag stig_id: 'EP11-00-007510'
  tag gtitle: 'SRG-APP-000342-DB-000302'
  tag fix_id: 'F-25855r495601_fix'
  tag 'documentable'
  tag legacy: ['SV-109513', 'V-100409']
  tag cci: ['CCI-002233']
  tag nist: ['AC-6 (8)']
end
