...
TSS PERMIT(EXAMMON) DSN(SYS2A.EXAMINE.) ACCESS(R)"
  ...
  tag check_id: 'C-26301r868597_chk'
  tag severity: 'medium'
  tag gid: 'V-224618'
  tag rid: 'SV-224618r868601_rule'
  tag stig_id: 'ZADTT000'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-26289r868598_fix'
  tag 'documentable'
  tag legacy: ['V-16932', 'SV-31920']
