...
If any port with a state of "LISTEN" is not marked with the "LIMIT" action, this is a finding.'
  desc 'fix', 'Configure the application firewall to protect against or limit the effects of DoS attacks by ensuring the Ubuntu operating system is implementing rate-limiting measures on impacted network interfaces. 
...
$ sudo ufw limit in on eth0'
  ...
  tag check_id: 'C-41577r654274_chk'
  tag severity: 'medium'
  tag gid: 'V-238367'
