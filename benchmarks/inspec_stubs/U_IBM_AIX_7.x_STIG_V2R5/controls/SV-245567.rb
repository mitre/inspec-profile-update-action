control 'SV-245567' do
  title 'The AIX /var/spool/cron/atjobs directory must be group-owned by daemon.'
...
If the file is not group-owned by daemon, this is a finding.'
  desc 'fix', 'Change the ownership of the file to root using command: 
# chgrp daemon /var/spool/cron/atjobs'
  impact 0.5
  ref 'DPMS Target IBM AIX 7.x'
  tag check_id: 'C-48846r755140_chk'
  tag severity: 'medium'
  tag gid: 'V-245567'
  tag rid: 'SV-245567r755142_rule'
  tag stig_id: 'AIX7-00-002148'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-48801r755141_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
