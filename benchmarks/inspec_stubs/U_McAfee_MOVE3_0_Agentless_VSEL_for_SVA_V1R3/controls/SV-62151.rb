...
Click Save.'
  ...
  tag check_id: 'C-50141r4_chk'
  tag severity: 'medium'
  tag gid: 'V-49245'
  tag rid: 'SV-62151r1_rule'
  tag stig_id: 'DTAVSEL-112'
  tag gtitle: 'DTAVSEL-112-McAfee MOVE VSEL for SVA ODS decode MIME encoded files'
  tag fix_id: 'F-52397r1_fix'
  tag 'documentable'
