...
Click Save.'
  ...
  tag check_id: 'C-49445r2_chk'
  tag severity: 'medium'
  tag gid: 'V-49063'
  tag rid: 'SV-61965r1_rule'
  tag stig_id: 'DTAVSEL-103'
  tag gtitle: 'DTAVSEL-103-McAfee VSEL for SVA ODS scan for unknown macro viruses'
  tag fix_id: 'F-49556r2_fix'
  tag 'documentable'
