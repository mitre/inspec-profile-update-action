...
On the Honeywell Mobility Edge Android Pie device, to see the installed operating system version: 
1. Open Settings. 
2. Tap "About phone". 
3. Verify "Build number". 
 
If the installed version of the Android operating system on any reviewed Honeywell devices is not the latest released by the wireless carrier, this is a finding. 
...
NOTE: In Honeywell Android devices, operating system updates are released by the wireless carrier (for example, Sprint, T-Mobile, Verizon Wireless, and ATT).'
  ...
  tag check_id: 'C-38311r623291_chk'
  tag severity: 'high'
  tag gid: 'V-235092'
  tag rid: 'SV-235092r626527_rule'
  tag stig_id: 'HONW-09-010900'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-38274r623292_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
