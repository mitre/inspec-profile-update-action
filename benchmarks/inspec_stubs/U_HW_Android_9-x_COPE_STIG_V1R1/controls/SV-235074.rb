control 'SV-235074' do
  title 'The Honeywell Mobility Edge Android Pie device must be configured to display the DoD advisory warning message at start-up or each time the user unlocks the device.'
  desc %q(The Honeywell Mobility Edge Android Pie device is required to display the DoD-approved system use notification message or banner before granting access to the system that provides privacy and security notices consistent with applicable federal laws, Executive Orders, directives, policies, regulations, standards, and guidance. Required banners help ensure that DoD can audit and monitor the activities of mobile device users without legal restriction.
...
Enable "Lock Screen Message" and enter the banner text.'
  ...
  tag check_id: 'C-38293r623237_chk'
  tag severity: 'low'
  tag gid: 'V-235074'
  tag rid: 'SV-235074r626527_rule'
  tag stig_id: 'HONW-09-003400'
  tag gtitle: 'PP-MDF-301200'
  tag fix_id: 'F-38256r623238_fix'
  tag 'documentable'
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
