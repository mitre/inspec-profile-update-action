...
If the RACF data set access authorizations does not restrict READ access to auditors, this is a finding

If the  RACF data set access authorizations does not restrict WRITE and/or greater access to systems programming personnel, this is a finding.

If the RACF data set access authorizations does not  restrict WRITE and/or greater access to the product STC(s) and/or batch job(s), this is a finding.'
...
pe 'sys3.csf.**' id(audtaudt) acc(r)"
  ...
  tag check_id: 'C-56344r864510_chk'
  tag severity: 'medium'
  tag gid: 'V-252888'
  tag rid: 'SV-252888r864511_rule'
  tag stig_id: 'RACF-IC-000030'
  tag gtitle: 'SRG-OS-000259'
  tag fix_id: 'F-56294r822552_fix'
  tag 'documentable'
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
end
