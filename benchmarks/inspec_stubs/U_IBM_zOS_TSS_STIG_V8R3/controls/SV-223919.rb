...
If the SYSCONS resource class does not have the DEPROT attribute, this is a finding.'
  desc 'fix', 'Ensure that all MCS consoles are defined to the SYSCONS resource class and READ access is limited to operators and system programmers.
...
TSS PERMIT(syspsmpl) SYSCONS(MMGMST) ACCESS(READ)'
  ...
  tag check_id: 'C-25592r516156_chk'
  tag severity: 'medium'
  tag gid: 'V-223919'
  tag rid: 'SV-223919r561402_rule'
  tag stig_id: 'TSS0-ES-000460'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25580r516157_fix'
