control 'SV-223983' do
  title 'The IBM z/OS warning banner for the FTP server must be properly specified.'
...
-Communications using, or data stored on, this IS are not private, are subject to routine monitoring, interception, and search, and may be disclosed or used for any USG authorized purpose.'
  ...
  tag check_id: 'C-25656r516348_chk'
  tag severity: 'medium'
  tag gid: 'V-223983'
  tag rid: 'SV-223983r561402_rule'
  tag stig_id: 'TSS0-FT-000110'
  tag gtitle: 'SRG-OS-000228-GPOS-00088'
  tag fix_id: 'F-25644r516349_fix'
  tag 'documentable'
  tag legacy: ['V-98673', 'SV-107777']
