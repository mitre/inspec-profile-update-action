control 'SV-258417' do
  title 'Google Android 14 must be configured to not display the following (work profile) notifications when the device is locked: [selection:
...
SFR ID: FMT_SMF_EXT.1.1 #18'
  desc 'check', 'Review managed Google Android 14 device settings to determine if the Google Android 14 device displays (work profile) notifications on the lock screen. Notifications of incoming phone calls are acceptable even when the device is locked. 
...
If the EMM console device policy allows work notifications on the lock screen, or the managed Google Android 14 device allows work notifications on the lock screen, this is a finding.'
  desc 'fix', 'Configure the Google Android 14 device to not display (work profile) notifications when the device is locked.
...
4. Toggle "Disable unredacted notifications".'
  ...
  tag check_id: 'C-62158r928274_chk'
  tag severity: 'medium'
  tag gid: 'V-258417'
  tag rid: 'SV-258417r928276_rule'
  tag stig_id: 'GOOG-14-006800'
  tag gtitle: 'PP-MDF-333080'
  tag fix_id: 'F-62082r928275_fix'
  tag 'documentable'
  tag cci: ['CCI-000060']
  tag nist: ['AC-11 (1)']
end
