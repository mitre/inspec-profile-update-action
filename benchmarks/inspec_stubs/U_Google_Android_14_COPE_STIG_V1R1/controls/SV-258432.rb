control 'SV-258432' do
  title 'The Google Android 14 work profile must be configured to prevent users from adding personal email accounts to the work email app.'
...
SFR ID: FMT_SMF_EXT.1.1 #47'
  desc 'check', 'Review the managed Google Android 14 work profile configuration settings to confirm that users are prevented from adding personal email accounts to the work email app. 
...
If on the EMM console the restriction to "Disallow modify accounts" is not set, or on the managed Android 14 device the user is able to add an account in the Work section, this is a finding.'
  desc 'fix', %q(Configure the Google Android 14 device to prevent users from adding personal email accounts to the work email app. 
...
Refer to the EMM documentation to determine how to provision users' work email accounts for the work email app.)
  ...
  tag check_id: 'C-62173r928319_chk'
  tag severity: 'medium'
  tag gid: 'V-258432'
  tag rid: 'SV-258432r928321_rule'
  tag stig_id: 'GOOG-14-010100'
  tag gtitle: 'PP-MDF-993300'
  tag fix_id: 'F-62097r928320_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
