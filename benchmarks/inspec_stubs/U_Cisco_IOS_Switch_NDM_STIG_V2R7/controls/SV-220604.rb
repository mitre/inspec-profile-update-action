...
Because of the challenges of applying this requirement on a large scale, organizations are encouraged to only apply the requirement to those limited number (and type) of devices that truly need to support this capability.'
  desc 'check', 'Review the Cisco switch configuration to verify that it authenticates SNMP messages using a FIPS-validated HMAC as shown in the example below:
...
SW4(config)#snmp-server host x.x.x.x version 3 auth V3USER'
  ...
  tag check_id: 'C-22319r507858_chk'
  tag severity: 'medium'
  tag gid: 'V-220604'
  tag rid: 'SV-220604r879768_rule'
  tag stig_id: 'CISC-ND-001130'
  tag gtitle: 'SRG-APP-000395-NDM-000310'
  tag fix_id: 'F-22308r507859_fix'
  tag 'documentable'
  tag legacy: ['SV-110437', 'V-101333']
  tag cci: ['CCI-001967']
  tag nist: ['IA-3 (1)']
end
