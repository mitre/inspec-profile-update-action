...
The security safeguards cannot be defined at the DoD level because they vary according to the capabilities of the individual network devices and the security controls applied on the adjacent networks (e.g., firewalls performing packet filtering to block DoS attacks).'
  desc 'check', 'Review the Cisco switch configuration to verify that it protects against known types of DoS attacks by employing organization-defined security safeguards. 
...
SW1(config-cp)#end'
  ...
  tag check_id: 'C-22324r507873_chk'
  tag severity: 'medium'
  tag gid: 'V-220609'
  tag rid: 'SV-220609r879806_rule'
  tag stig_id: 'CISC-ND-001220'
  tag gtitle: 'SRG-APP-000435-NDM-000315'
  tag fix_id: 'F-22313r507874_fix'
  tag 'documentable'
  tag legacy: ['SV-110447', 'V-101343']
  tag cci: ['CCI-002385']
  tag nist: ['SC-5 a']
end
