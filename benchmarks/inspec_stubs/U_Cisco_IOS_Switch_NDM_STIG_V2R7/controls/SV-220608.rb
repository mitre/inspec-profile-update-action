control 'SV-220608' do
  ...
  desc 'check', 'Review the Cisco switch configuration to verify that it implements cryptographic mechanisms to protect the confidentiality of remote maintenance sessions using a FIPS 140-2 approved algorithm as shown in the example below:
...
SW1(config)#ip ssh server algorithm encryption aes256-ctr aes192-ctr aes128-ctr'
  ...
  tag check_id: 'C-22323r507870_chk'
  tag severity: 'high'
  tag gid: 'V-220608'
  tag rid: 'SV-220608r879785_rule'
  tag stig_id: 'CISC-ND-001210'
  tag gtitle: 'SRG-APP-000412-NDM-000331'
  tag fix_id: 'F-22312r507871_fix'
  tag 'documentable'
  tag legacy: ['SV-110445', 'V-101341']
  tag cci: ['CCI-003123']
  tag nist: ['MA-4 (6)']
end
