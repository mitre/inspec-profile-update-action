...
If any do, determine whether these applications obfuscate authentication data. If they do not, this is a finding.'
  ...
  tag check_id: 'C-14823r290115_chk'
  tag severity: 'high'
  tag gid: 'V-213601'
  tag rid: 'SV-213601r508024_rule'
  tag stig_id: 'PPS9-00-004810'
  tag gtitle: 'SRG-APP-000178-DB-000083'
  tag fix_id: 'F-14821r290116_fix'
  tag 'documentable'
  tag legacy: ['SV-83559', 'V-68955']
  tag cci: ['CCI-000206']
  tag nist: ['IA-6']
end
