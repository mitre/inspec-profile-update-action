control 'SV-213654' do
  title 'Audit records must be generated when unsuccessful attempts to delete categorized information (e.g., classification levels/security levels) occur.'
...
Update the system documentation to note the organizationally approved setting and corresponding justification of the setting for this requirement."
  ...
  tag check_id: 'C-14876r290274_chk'
  tag severity: 'medium'
  tag gid: 'V-213654'
  tag rid: 'SV-213654r508024_rule'
  tag stig_id: 'PPS9-00-011700'
  tag gtitle: 'SRG-APP-000502-DB-000349'
  tag fix_id: 'F-14874r290275_fix'
  tag 'documentable'
  tag legacy: ['SV-83661', 'V-69057']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
