control 'SV-213664' do
  title 'The EDB Postgres Advanced Server must implement NIST FIPS 140-2 or 140-3 validated cryptographic modules to provision digital signatures.'
...
Ubuntu: https://security-certs.docs.ubuntu.com/en/fips'
  ...
  tag check_id: 'C-14886r836845_chk'
  tag severity: 'high'
  tag gid: 'V-213664'
  tag rid: 'SV-213664r836847_rule'
  tag stig_id: 'PPS9-00-012700'
  tag gtitle: 'SRG-APP-000514-DB-000381'
  tag fix_id: 'F-14884r836846_fix'
  tag 'documentable'
  tag legacy: ['SV-83681', 'V-69077']
  tag cci: ['CCI-002450']
  tag nist: ['SC-13 b']
end
