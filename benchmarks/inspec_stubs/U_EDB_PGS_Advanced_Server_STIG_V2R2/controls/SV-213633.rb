...
https://www.postgresql.org/docs/current/ssl-tcp.html'
  ...
  tag check_id: 'C-14855r570385_chk'
  tag severity: 'medium'
  tag gid: 'V-213633'
  tag rid: 'SV-213633r557394_rule'
  tag stig_id: 'PPS9-00-009500'
  tag gtitle: 'SRG-APP-000441-DB-000378'
  tag fix_id: 'F-14853r570386_fix'
  tag 'documentable'
  tag legacy: ['SV-83623', 'V-69019']
  tag cci: ['CCI-002420']
  tag nist: ['SC-8 (2)']
end
