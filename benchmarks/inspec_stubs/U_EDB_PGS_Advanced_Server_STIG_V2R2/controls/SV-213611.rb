...
If custom database errors contain PII data, sensitive business data, or information useful for identifying the host system or database structure, this is a finding.'
  ...
  tag check_id: 'C-14833r290145_chk'
  tag severity: 'medium'
  tag gid: 'V-213611'
  tag rid: 'SV-213611r508024_rule'
  tag stig_id: 'PPS9-00-006500'
  tag gtitle: 'SRG-APP-000266-DB-000162'
  tag fix_id: 'F-14831r290146_fix'
  tag 'documentable'
  tag legacy: ['SV-83579', 'V-68975']
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
end
