...
Ensure that a monitored email address is registered as a user on the EDB support portal and is receiving technical alerts.'
  ...
  tag check_id: 'C-14858r290220_chk'
  tag severity: 'medium'
  tag gid: 'V-213636'
  tag rid: 'SV-213636r508024_rule'
  tag stig_id: 'PPS9-00-009900'
  tag gtitle: 'SRG-APP-000456-DB-000390'
  tag fix_id: 'F-14856r290221_fix'
  tag 'documentable'
  tag legacy: ['SV-83629', 'V-69025']
  tag cci: ['CCI-002605']
  tag nist: ['SI-2 c']
end
