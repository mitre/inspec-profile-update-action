...
For the operating system finding, refer to the appropriate operating system documentation for the procedure to install, configure, and test FIPS mode.'
  ...
  tag severity: 'medium'
  tag gid: 'V-252146'
  tag rid: 'SV-252146r813820_rule'
  tag stig_id: 'MD4X-00-001300'
  tag gtitle: 'SRG-APP-000179-DB-000114'
  tag fix_id: 'F-55552r813819_fix'
  tag satisfies: ['SRG-APP-000179-DB-000114', 'SRG-APP-000416-DB-000380', 'SRG-APP-000514-DB-000381', 'SRG-APP-000514-DB-000382', 'SRG-APP-000514-DB-000383']
  tag 'documentable'
