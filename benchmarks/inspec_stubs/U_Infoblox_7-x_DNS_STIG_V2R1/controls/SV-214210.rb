...
The other set, called internal name servers, is to be located within the firewall and should be configured so they are not reachable from outside and hence provide naming services exclusively to internal clients.'
  desc 'check', 'Validation of this configuration item requires review of the network architecture and security configuration in addition to DNS server configuration to validate internal name servers are not accessible from the external network when a split DNS configuration is implemented.
...
Perform a service restart if necessary.'
  ...
  tag check_id: 'C-15425r295893_chk'
  tag severity: 'medium'
  tag gid: 'V-214210'
  tag rid: 'SV-214210r612370_rule'
  tag stig_id: 'IDNS-7X-000810'
  tag gtitle: 'SRG-APP-000516-DNS-000093'
  tag fix_id: 'F-15423r295894_fix'
  tag 'documentable'
  tag legacy: ['SV-83105', 'V-68615']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
