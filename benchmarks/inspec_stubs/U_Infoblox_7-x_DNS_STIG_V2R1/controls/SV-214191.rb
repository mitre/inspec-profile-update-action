...
Perform a service restart if necessary.'
  ...
  tag check_id: 'C-15406r295836_chk'
  tag severity: 'medium'
  tag gid: 'V-214191'
  tag rid: 'SV-214191r612370_rule'
  tag stig_id: 'IDNS-7X-000520'
  tag gtitle: 'SRG-APP-000423-DNS-000056'
  tag fix_id: 'F-15404r295837_fix'
  tag 'documentable'
  tag legacy: ['SV-83067', 'V-68577']
  tag cci: ['CCI-002465']
  tag nist: ['SC-21']
end
