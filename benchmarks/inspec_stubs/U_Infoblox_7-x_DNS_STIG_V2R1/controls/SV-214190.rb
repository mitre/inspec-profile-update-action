...
Perform a service restart if necessary.'
  ...
  tag check_id: 'C-15405r295833_chk'
  tag severity: 'medium'
  tag gid: 'V-214190'
  tag rid: 'SV-214190r612370_rule'
  tag stig_id: 'IDNS-7X-000510'
  tag gtitle: 'SRG-APP-000422-DNS-000055'
  tag fix_id: 'F-15403r295834_fix'
  tag 'documentable'
  tag legacy: ['V-68575', 'SV-83065']
  tag cci: ['CCI-002462']
  tag nist: ['SC-20 a']
end
