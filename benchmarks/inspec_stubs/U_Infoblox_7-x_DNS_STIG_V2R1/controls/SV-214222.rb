control 'SV-214222' do
  ...
  desc 'check', 'Navigation to the HTTPS interface on the Grid Master using a web browser will display the current DoD banner.
...
Click "Enable Notice and Consent Banner". Use the text box to enter the appropriate banner.
When complete, click "Save & Close" to save the changes and exit the "Properties" screen.

Perform a service restart if necessary.'
  impact 0.3
  ref 'DPMS Target Infoblox 7.x DNS'
  tag check_id: 'C-15437r295929_chk'
  tag severity: 'low'
  tag gid: 'V-214222'
  tag rid: 'SV-214222r612370_rule'
  tag stig_id: 'IDNS-7X-000970'
  tag gtitle: 'SRG-APP-000516-DNS-000500'
  tag fix_id: 'F-15435r295930_fix'
  tag 'documentable'
  tag legacy: ['SV-83117', 'V-68627']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
