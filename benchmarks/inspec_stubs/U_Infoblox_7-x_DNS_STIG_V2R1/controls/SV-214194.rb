...
Perform a service restart if necessary.'
  ...
  tag check_id: 'C-15409r295845_chk'
  tag severity: 'medium'
  tag gid: 'V-214194'
  tag rid: 'SV-214194r612370_rule'
  tag stig_id: 'IDNS-7X-000550'
  tag gtitle: 'SRG-APP-000426-DNS-000059'
  tag fix_id: 'F-15407r295846_fix'
  tag 'documentable'
  tag legacy: ['SV-83073', 'V-68583']
  tag cci: ['CCI-002468']
  tag nist: ['SC-21']
end
