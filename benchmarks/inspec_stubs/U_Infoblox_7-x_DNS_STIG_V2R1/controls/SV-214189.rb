...
Perform a service restart if necessary.'
  ...
  tag check_id: 'C-15404r295830_chk'
  tag severity: 'medium'
  tag gid: 'V-214189'
  tag rid: 'SV-214189r612370_rule'
  tag stig_id: 'IDNS-7X-000500'
  tag gtitle: 'SRG-APP-000421-DNS-000054'
  tag fix_id: 'F-15402r295831_fix'
  tag 'documentable'
  tag legacy: ['SV-83063', 'V-68573']
