...
Incorrect configurations could prevent services from starting and result in a denial of service.'
  desc 'check', 'This applies to member servers. A separate version applies to domain controllers.
...
- Domain Admins Group'
  ...
  tag check_id: 'C-26708r819694_chk'
  tag severity: 'medium'
  tag gid: 'V-225017'
  tag rid: 'SV-225017r819695_rule'
  tag stig_id: 'WN16-MS-000390'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-26696r465954_fix'
  tag 'documentable'
  tag legacy: ['V-73767', 'SV-88431']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
