...
If the Central Log Server is not configured to send an immediate alert to the SA or ISSO if communication with the host and devices within its scope of coverage is lost, this is a finding.'
  ...
  tag check_id: 'C-6754r285723_chk'
  tag severity: 'low'
  tag gid: 'V-206494'
  tag rid: 'SV-206494r855301_rule'
  tag stig_id: 'SRG-APP-000361-AU-000140'
  tag gtitle: 'SRG-APP-000361'
  tag fix_id: 'F-6754r285724_fix'
  tag 'documentable'
  tag legacy: ['SV-95865', 'V-81151']
  tag cci: ['CCI-001861']
  tag nist: ['AU-5 (4)']
end
