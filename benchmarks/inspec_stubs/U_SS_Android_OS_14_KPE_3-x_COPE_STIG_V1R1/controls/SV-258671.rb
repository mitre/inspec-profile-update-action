...
Note: If the management tool has been correctly configured but a Trust Agent is still enabled, configure the "List of approved apps listed in managed Google Play" to disable it; refer to KNOX-14-210190.
...
On the management tool, in the device restrictions, set "Trust Agents" to "Disable".'
  ...
  tag check_id: 'C-62411r931211_chk'
  tag severity: 'medium'
  tag gid: 'V-258671'
  tag rid: 'SV-258671r931213_rule'
  tag stig_id: 'KNOX-14-210090'
  tag gtitle: 'PP-MDF-333030'
  tag fix_id: 'F-62320r931212_fix'
  tag 'documentable'
  tag cci: ['CCI-000767']
  tag nist: ['IA-2 (3)']
end
