...
The user training requirement is satisfied in requirement KNOX-14-210300.'
  impact 0.3
  ref 'DPMS Target Samsung Android OS 14 with Knox 3.x COPE'
  tag check_id: 'C-62413r931217_chk'
  tag severity: 'low'
  tag gid: 'V-258673'
  tag rid: 'SV-258673r931219_rule'
  tag stig_id: 'KNOX-14-210120'
  tag gtitle: 'PP-MDF-333320'
  tag fix_id: 'F-62322r931218_fix'
  tag 'documentable'
