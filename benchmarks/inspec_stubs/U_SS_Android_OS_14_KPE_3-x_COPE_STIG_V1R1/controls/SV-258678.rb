...
2. Verify "Automatic data and time" is on and the user cannot disable it.
...
On the management tool, in the device restrictions, set "Configure Date/Time" to "Disallow".'
  ...
  tag check_id: 'C-62418r931232_chk'
  tag severity: 'medium'
  tag gid: 'V-258678'
  tag rid: 'SV-258678r931234_rule'
  tag stig_id: 'KNOX-14-210170'
  tag gtitle: 'PP-MDF-993300'
  tag fix_id: 'F-62327r931233_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
