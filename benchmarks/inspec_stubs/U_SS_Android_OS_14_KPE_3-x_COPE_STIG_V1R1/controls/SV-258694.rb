...
SFR ID: FMT_SMF_EXT.1.1 #47'
  desc 'check', 'Verify requirement KNOX-14-210160 (disallow config tethering) has been implemented.

If "Disallow config tethering" has not been implemented, this is a finding.'
  desc 'fix', 'Implement "Disallow config tethering" (refer to requirement KNOX-14-210160).'
  impact 0.5
  ref 'DPMS Target Samsung Android OS 14 with Knox 3.x COPE'
  tag check_id: 'C-62434r931280_chk'
  tag severity: 'medium'
  tag gid: 'V-258694'
  tag rid: 'SV-258694r931282_rule'
  tag stig_id: 'KNOX-14-225020'
  tag gtitle: 'PP-MDF-993300'
  tag fix_id: 'F-62343r931281_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
