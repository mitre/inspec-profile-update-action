...
If the setting does not have a value of "Opportunistic" or "Required", this is a finding.'
  desc 'fix', 'From the vSphere Client select the Virtual Machine, right click and go to Edit Settings >> VM Options Tab >> Encryption >> Encrypted vMotion. Set the value to "Opportunistic" or "Required".'
  impact 0.5
  ref 'DPMS Target VMware vSphere 6.7 Virtual Machine'
  tag check_id: 'C-40322r717086_chk'
  tag severity: 'medium'
  tag gid: 'V-242469'
  tag rid: 'SV-242469r717088_rule'
  tag stig_id: 'VMCH-67-000024'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-40285r717087_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
