control 'SV-237237' do
  title 'Apple iOS must be configured to enforce a minimum password length of six characters.'
...
If the "Minimum passcode length" is less than "6" characters in the iOS management tool, "<key>minLength</key> " has an integer value of less than "6", or the password policy on the Apple iOS device from the Apple iOS management tool does not list "Minimum length" of "6" or fewer, this is a finding.'
  ...
  tag check_id: 'C-40456r642261_chk'
  tag severity: 'low'
  tag gid: 'V-237237'
  tag rid: 'SV-237237r642263_rule'
  tag stig_id: 'AIOS-12-000100'
  tag gtitle: 'PP-MDF-301010'
  tag fix_id: 'F-40419r642262_fix'
  tag 'documentable'
  tag legacy: ['SV-96469', 'V-81755']
  tag cci: ['CCI-000205']
  tag nist: ['IA-5 (1) (a)']
end
