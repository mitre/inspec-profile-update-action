...
If "Allow iCloud keychain" is checked in the Apple iOS management tool, "<key>allowCloudKeychainSync</key><true/>" appears in the configuration profile, or "iCloud Keychain not allowed" is not listed on the Apple iOS device, this is a finding.)
  ...
  tag check_id: 'C-40469r642300_chk'
  tag severity: 'medium'
  tag gid: 'V-237250'
  tag rid: 'SV-237250r852621_rule'
  tag stig_id: 'AIOS-12-004300'
  tag gtitle: 'PP-MDF-302220'
  tag fix_id: 'F-40432r642301_fix'
  tag 'documentable'
  tag legacy: ['SV-96497', 'V-81783']
  tag cci: ['CCI-000366', 'CCI-000370', 'CCI-001772']
  tag nist: ['CM-6 b', 'CM-6 (1)', 'CM-7 (5) (a)']
end
