control 'SV-237239' do
  title 'Apple iOS must be configured to lock the display after 15 minutes (or less) of inactivity.'
...
On the management server, if the sum of the "Max grace period" and "Max inactivity" values is not between 1 and 15 minutes in the iOS management tool, if the sum of the values assigned to "<key>maxGracePeriod</key>" and "<key>maxInactivity</key>" is not between 1 and 15 minutes in the configuration profile, or on the iOS device, if the sum of the values assigned to "Max grace period" and "Max inactivity" is not between 1 and 15 minutes, this is a finding.'
  ...
  tag check_id: 'C-40458r642267_chk'
  tag severity: 'medium'
  tag gid: 'V-237239'
  tag rid: 'SV-237239r642269_rule'
  tag stig_id: 'AIOS-12-000300'
  tag gtitle: 'PP-MDF-301030'
  tag fix_id: 'F-40421r642268_fix'
  tag satisfies: ['PP-MDF-301030', 'PP-MDF-301040\n\nSFR ID: FMT_SMF_EXT.1.1 #2a & #2b']
  tag 'documentable'
  tag legacy: ['SV-96473', 'V-81759']
  tag cci: ['CCI-000057']
  tag nist: ['AC-11 a']
end
