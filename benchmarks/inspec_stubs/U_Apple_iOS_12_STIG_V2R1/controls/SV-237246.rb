...
2. By creating a background picture with the relevant information and configuring that picture as the background for the lock screen via the Apple iOS management tool.'
  ...
  tag check_id: 'C-40465r642288_chk'
  tag severity: 'low'
  tag gid: 'V-237246'
  tag rid: 'SV-237246r859301_rule'
  tag stig_id: 'AIOS-12-003600'
  tag gtitle: 'PP-MDF-301200'
  tag fix_id: 'F-40428r859301_fix'
  tag 'documentable'
  tag legacy: ['SV-96489', 'V-81775']
  tag cci: ['CCI-000366', 'CCI-000370', 'CCI-001764']
  tag nist: ['CM-6 b', 'CM-6 (1)', 'CM-7 (2)']
end
