control 'SV-237274' do
  title 'Apple iOS must not allow managed apps to write contacts to unmanaged contacts accounts.'
...
If "Allow managed apps to write contacts to unmanaged contacts accounts" is checked in the iOS management tool or the restrictions policy on the iOS device from the iOS management tool lists "Allow managed apps to write contacts to unmanaged contacts accounts", this is a finding.'
  ...
  tag check_id: 'C-40493r642372_chk'
  tag severity: 'low'
  tag gid: 'V-237274'
  tag rid: 'SV-237274r642374_rule'
  tag stig_id: 'AIOS-12-012600'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-40456r642373_fix'
  tag 'documentable'
  tag legacy: ['SV-96645', 'V-81931']
