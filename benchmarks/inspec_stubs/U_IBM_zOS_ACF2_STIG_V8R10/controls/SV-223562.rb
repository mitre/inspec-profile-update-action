control 'SV-223562' do
  title 'IBM z/OS must not allow non-existent or inaccessible LINKLIST libraries.'
...
-The LNKLSTxx and PROGxx (LNKLST entries) members will contain only required libraries. On a semiannual basis, Software Support should review the volume serial numbers, and should verify them in accordance with the system catalog. Software Support will remove all non-existent libraries. The ISSO should modify and/or delete the rules associated with these libraries.'
  impact 0.5
  ref 'DPMS Target IBM zOS ACF2'
  tag check_id: 'C-25235r504713_chk'
  tag severity: 'medium'
  tag gid: 'V-223562'
  tag rid: 'SV-223562r853549_rule'
  tag stig_id: 'ACF2-OS-000260'
  tag gtitle: 'SRG-OS-000368-GPOS-00154'
  tag fix_id: 'F-25223r504714_fix'
  tag 'documentable'
  tag legacy: ['V-97829', 'SV-106933']
  tag cci: ['CCI-001764']
  tag nist: ['CM-7 (2)']
end
