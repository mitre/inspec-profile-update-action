control 'SV-223641' do
  title 'IBM z/OS UNIX Telnet Server etc/banner file must have the Standard Mandatory DoD Notice and Consent Banner.'
...
-Notwithstanding the above, using this IS does not constitute consent to PM, LE or CI investigative searching or monitoring of the content of privileged communications, or work product, related to personal representation or services by attorneys, psychotherapists, or clergy, and their assistants. Such communications and work product are private and confidential. See User Agreement for details.'
  desc 'fix', 'Preferably configure the /etc/otelnet/banner file and ensure the text specifies a logon banner in accordance with DISA requirements.
Alternately the /etc/banner file may be used in accordance with DISA requirements below.STANDARD MANDATORY DOD NOTICE AND CONSENT BANNER
...
-Notwithstanding the above, using this IS does not constitute consent to PM, LE or CI investigative searching or monitoring of the content of privileged communications, or work product, related to personal representation or services by attorneys, psychotherapists, or clergy, and their assistants. Such communications and work product are private and confidential. See User Agreement for details.'
  ...
  tag check_id: 'C-25314r572048_chk'
  tag severity: 'medium'
  tag gid: 'V-223641'
  tag rid: 'SV-223641r560914_rule'
  tag stig_id: 'ACF2-UT-000030'
  tag gtitle: 'SRG-OS-000024-GPOS-00007'
  tag fix_id: 'F-25302r572049_fix'
  tag satisfies: ['SRG-OS-000024-GPOS-00007', 'SRG-OS-000023-GPOS-00006']
  tag 'documentable'
  tag legacy: ['V-97987', 'SV-107091']
