...
Satisifies: SRG-OS-000505, SRG-OS-000555'
...
___ Repeat the above step for each queue manager ssid identified.'
  desc 'fix', 'Review the WebSphere MQ Screen interface invoked by the REXX CSQOREXX. Reviewing the channel’s SSLCIPH setting.
...
Repeat these steps for each queue manager ssid identified.'
  ...
  tag check_id: 'C-26234r811065_chk'
  tag severity: 'high'
  tag gid: 'V-224551'
  tag rid: 'SV-224551r811067_rule'
  tag stig_id: 'ZWMQ0011'
  tag gtitle: 'SRG-OS-000033'
  tag fix_id: 'F-26222r811066_fix'
  tag 'documentable'
