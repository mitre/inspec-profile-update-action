control 'SV-213749' do
  title 'DB2 must generate audit records when security objects are deleted.'
...
Note: The SECMAINT command grants a role and the OBJMAINT command sets the grant on a user defined function.'
  impact 0.5
  ref 'DPMS Target IBM DB2 V10.5 LUW'
  tag check_id: 'C-14970r295296_chk'
  tag severity: 'medium'
  tag gid: 'V-213749'
  tag rid: 'SV-213749r879872_rule'
  tag stig_id: 'DB2X-00-011000'
  tag gtitle: 'SRG-APP-000501-DB-000336'
  tag fix_id: 'F-14968r295297_fix'
  tag 'documentable'
  tag legacy: ['SV-89315', 'V-74641']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
