control 'SV-213729' do
  title 'DB2 must implement cryptographic mechanisms to prevent unauthorized modification of organization-defined information at rest (to include, at a minimum, PII and classified information) on organization-defined information system components.'
...
If a third-party tool is used for database encryption (IBM highly recommends using IBM Guardium) use the third-party tool's specific check and fix."
  ...
  tag check_id: 'C-14950r295236_chk'
  tag severity: 'medium'
  tag gid: 'V-213729'
  tag rid: 'SV-213729r879799_rule'
  tag stig_id: 'DB2X-00-008800'
  tag gtitle: 'SRG-APP-000428-DB-000386'
  tag fix_id: 'F-14948r295237_fix'
  tag 'documentable'
  tag legacy: ['SV-89275', 'V-74601']
  tag cci: ['CCI-002475']
  tag nist: ['SC-28 (1)']
end
