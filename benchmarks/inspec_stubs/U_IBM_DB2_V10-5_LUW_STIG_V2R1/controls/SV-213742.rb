control 'SV-213742' do
  title 'DB2 must generate audit records when unsuccessful attempts to modify privileges/permissions occur.'
...
To aid in diagnosis, it is necessary to keep track of failed attempts in addition to the successful ones."
  desc 'check', "To verify the database generates audit records when an unsuccessful attempt is made to modify the database privileges/permissions and that the SECMAINT, CONTEXT category auditing must be implemented at the database level. 
...
DB2> AUDIT DATABASE USING POLICY <DB audit policy name>'
  ...
  tag check_id: 'C-14963r295275_chk'
  tag severity: 'medium'
  tag gid: 'V-213742'
  tag rid: 'SV-213742r879866_rule'
  tag stig_id: 'DB2X-00-010300'
  tag gtitle: 'SRG-APP-000495-DB-000329'
  tag fix_id: 'F-14961r295276_fix'
  tag 'documentable'
  tag legacy: ['SV-89301', 'V-74627']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
