control 'SV-213743' do
  title 'DB2 must generate audit records when security objects are modified.'
...
If all the required locally defined security tables' audit policies do not have the values for the SECMAINTSTATUS and OBJMAINTSTATUS columns set to 'S' (Success) or 'B' (Both) or if the value in the ERRORTYPE column is not set to 'A' (Audit), this is a finding."
...
DB2> AUDIT TABLE <table name> USING POLICY EXECDB'
  ...
  tag check_id: 'C-14964r295278_chk'
  tag severity: 'medium'
  tag gid: 'V-213743'
  tag rid: 'SV-213743r879867_rule'
  tag stig_id: 'DB2X-00-010400'
  tag gtitle: 'SRG-APP-000496-DB-000334'
  tag fix_id: 'F-14962r295279_fix'
  tag 'documentable'
  tag legacy: ['SV-89303', 'V-74629']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
