control 'SV-213717' do
  title 'When supporting applications that require security labeling of data, DB2 must associate organization-defined types of security labels having organization-defined security label values with information in process.'
...
http://www.ibm.com/support/knowledgecenter/SSEPGG_10.5.0/com.ibm.db2.luw.sql.ref.doc/doc/r0020026.html?cp=SSEPGG_10.5.0%2F2-12-7-94"
  ...
  tag check_id: 'C-14938r295200_chk'
  tag severity: 'medium'
  tag gid: 'V-213717'
  tag rid: 'SV-213717r879690_rule'
  tag stig_id: 'DB2X-00-006700'
  tag gtitle: 'SRG-APP-000313-DB-000309'
  tag fix_id: 'F-14936r295201_fix'
  tag 'documentable'
  tag legacy: ['SV-89237', 'V-74563']
  tag cci: ['CCI-002263']
  tag nist: ['AC-16 a']
end
