control 'SV-213700' do
  title 'Applications using the database must obscure feedback of authentication information during the authentication process to protect the information from possible exploitation/use by unauthorized individuals.'
...
If any do, determine whether these applications obfuscate authentication data; if they do not, this is a finding.'
  ...
  tag check_id: 'C-14921r295149_chk'
  tag severity: 'high'
  tag gid: 'V-213700'
  tag rid: 'SV-213700r879615_rule'
  tag stig_id: 'DB2X-00-004510'
  tag gtitle: 'SRG-APP-000178-DB-000083'
  tag fix_id: 'F-14919r295150_fix'
  tag 'documentable'
  tag legacy: ['SV-89163', 'V-74489']
  tag cci: ['CCI-000206']
  tag nist: ['IA-6']
end
