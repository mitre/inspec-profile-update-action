control 'SV-213732' do
  title 'DB2 must maintain the confidentiality and integrity of information during reception.'
...
http://www.ibm.com/support/knowledgecenter/SSEPGG_10.5.0/com.ibm.db2.luw.qb.server.doc/doc/t0004714.html?cp=SSEPGG_10.5.0&lang=en'
  ...
  tag check_id: 'C-14953r917669_chk'
  tag severity: 'medium'
  tag gid: 'V-213732'
  tag rid: 'SV-213732r917670_rule'
  tag stig_id: 'DB2X-00-009200'
  tag gtitle: 'SRG-APP-000442-DB-000379'
  tag fix_id: 'F-14951r295246_fix'
  tag 'documentable'
  tag legacy: ['SV-89281', 'V-74607']
  tag cci: ['CCI-002422']
  tag nist: ['SC-8 (2)']
end
