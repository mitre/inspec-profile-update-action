control 'SV-213758' do
  title 'DB2 must generate audit records when concurrent logons/connections by the same user from different workstations occur.'
...
Note: Group by IPADDRESS and validate from audit log.'
  ...
  tag check_id: 'C-14979r295323_chk'
  tag severity: 'medium'
  tag gid: 'V-213758'
  tag rid: 'SV-213758r879877_rule'
  tag stig_id: 'DB2X-00-011900'
  tag gtitle: 'SRG-APP-000506-DB-000353'
  tag fix_id: 'F-14977r295324_fix'
  tag 'documentable'
  tag legacy: ['SV-89257', 'V-74583']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
