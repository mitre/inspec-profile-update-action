control 'SV-213677' do
  title 'DB2 must generate audit records when unsuccessful attempts to retrieve privileges/permissions occur.'
...
Note:  the Database level policy in the Check covered in SRG-APP-DB2X-00-000600, generates audit events of successful/unsuccessful read attempts on views based on these catalog tables.'
  ...
  tag check_id: 'C-14898r295080_chk'
  tag severity: 'medium'
  tag gid: 'V-213677'
  tag rid: 'SV-213677r879561_rule'
  tag stig_id: 'DB2X-00-000900'
  tag gtitle: 'SRG-APP-000091-DB-000325'
  tag fix_id: 'F-14896r295081_fix'
  tag 'documentable'
  tag legacy: ['SV-89117', 'V-74443']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
