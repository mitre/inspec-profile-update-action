control 'SV-213711' do
  title 'DB2 and associated applications must reserve the use of dynamic code execution for situations that require it.'
...
If dynamic code execution is employed in circumstances where the objective could practically be satisfied by static execution with strongly typed parameters, this is a finding.'
  ...
  tag check_id: 'C-14932r295182_chk'
  tag severity: 'medium'
  tag gid: 'V-213711'
  tag rid: 'SV-213711r879652_rule'
  tag stig_id: 'DB2X-00-006000'
  tag gtitle: 'SRG-APP-000251-DB-000391'
  tag fix_id: 'F-14930r295183_fix'
  tag 'documentable'
  tag legacy: ['SV-89185', 'V-74511']
  tag cci: ['CCI-001310']
  tag nist: ['SI-10']
end
