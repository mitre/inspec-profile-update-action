control 'SV-213760' do
  title 'DB2 must generate audit records when unsuccessful accesses to objects occur.'
...
DB2> AUDIT TABLE <table name> USING POLICY EXECDB'
  ...
  tag check_id: 'C-14981r295329_chk'
  tag severity: 'medium'
  tag gid: 'V-213760'
  tag rid: 'SV-213760r879878_rule'
  tag stig_id: 'DB2X-00-012100'
  tag gtitle: 'SRG-APP-000507-DB-000357'
  tag fix_id: 'F-14979r295330_fix'
  tag 'documentable'
  tag legacy: ['SV-89253', 'V-74579']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
