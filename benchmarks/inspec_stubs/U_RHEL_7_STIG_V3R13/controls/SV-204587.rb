control 'SV-204587' do
  title 'The Red Hat Enterprise Linux operating system must be configured so that all network connections associated with SSH traffic are terminated after 10 minutes of becoming unresponsive.'
...
If "ClientAliveInterval" has a value that is greater than "600" and is not documented with the information system security officer (ISSO) as an operational requirement, this is a finding.'
  desc 'fix', 'Note: This setting must be applied in conjunction with RHEL-07-040340 to function correctly.
...
The SSH service must be restarted for changes to take effect.'
  ...
  tag check_id: 'C-4711r917831_chk'
  tag severity: 'medium'
  tag gid: 'V-204587'
  tag rid: 'SV-204587r917833_rule'
  tag stig_id: 'RHEL-07-040320'
  tag gtitle: 'SRG-OS-000163-GPOS-00072'
  tag fix_id: 'F-4711r917832_fix'
