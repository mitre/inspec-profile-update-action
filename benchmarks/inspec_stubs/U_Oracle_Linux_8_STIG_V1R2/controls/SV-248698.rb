...
If the line containing "pam_pwhistory.so" does not have the "remember" module argument set or is commented out, or the value of the "remember" module argument is set to less than "5", this is a finding.'
  desc 'fix', 'Configure OL 8 in the password-auth file to prohibit password reuse for a minimum of five generations. 
...
password required pam_pwhistory.so use_authtok remember=5 retry=3'
  ...
  tag check_id: 'C-52132r818661_chk'
  tag severity: 'low'
  tag gid: 'V-248698'
  tag rid: 'SV-248698r818663_rule'
  tag stig_id: 'OL08-00-020220'
  tag gtitle: 'SRG-OS-000077-GPOS-00045'
  tag fix_id: 'F-52086r818662_fix'
  tag 'documentable'
  tag cci: ['CCI-000200']
  tag nist: ['IA-5 (1) (e)']
end
