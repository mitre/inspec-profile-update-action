...
Check that the "ClientAliveCountMax" is set to "0" by running the following command: 
 
$ sudo grep -i ClientAliveCountMax /etc/ssh/sshd_config

ClientAliveCountMax 0 
 
If "ClientAliveCountMax" does not exist, does not have a product value of "0" in "/etc/ssh/sshd_config", or is commented out, this is a finding.'
...
$ sudo systemctl restart sshd.service'
  ...
  tag check_id: 'C-51986r779220_chk'
  tag severity: 'medium'
  tag gid: 'V-248552'
  tag rid: 'SV-248552r779222_rule'
  tag stig_id: 'OL08-00-010200'
  tag gtitle: 'SRG-OS-000126-GPOS-00066'
  tag fix_id: 'F-51940r779221_fix'
