...
Note: If IPv4 is disabled on the system, this requirement does not apply.
...
net.ipv4.conf.default.send_redirects=0)
  ...
  tag check_id: 'C-52320r818726_chk'
  tag severity: 'medium'
  tag gid: 'V-248886'
  tag rid: 'SV-248886r818727_rule'
  tag stig_id: 'OL08-00-040270'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-52274r780223_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
