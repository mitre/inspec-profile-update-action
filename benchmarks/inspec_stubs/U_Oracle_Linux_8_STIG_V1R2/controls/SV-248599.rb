...
The rngd service feeds random data from hardware device to kernel random device. Quality (non-predictable) random number generation is important for several security functions (i.e., ciphers).'
  desc 'check', 'Verify the rngd service is enabled and active with the following commands: 
...
$ sudo systemctl enable rngd.service'
  ...
  tag check_id: 'C-52033r779361_chk'
  tag severity: 'low'
  tag gid: 'V-248599'
  tag rid: 'SV-248599r779363_rule'
  tag stig_id: 'OL08-00-010471'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-51987r779362_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
