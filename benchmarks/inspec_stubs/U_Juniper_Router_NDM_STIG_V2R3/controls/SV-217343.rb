control 'SV-217343' do
  title 'The Juniper router must be configured to generate log records when administrator privileges are modified.'
...
If the router is not configured to generate log records when administrator privileges are modified, this is a finding.'
  desc 'fix', 'Configure the router to generate log records when account privileges are modified as shown in the example below.
...
set syslog host x.x.x.x any info'
  ...
  tag check_id: 'C-18570r296607_chk'
  tag severity: 'medium'
  tag gid: 'V-217343'
  tag rid: 'SV-217343r879866_rule'
  tag stig_id: 'JUNI-ND-001230'
  tag gtitle: 'SRG-APP-000495-NDM-000318'
  tag fix_id: 'F-18568r296608_fix'
  tag 'documentable'
  tag legacy: ['SV-101275', 'V-91175']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
