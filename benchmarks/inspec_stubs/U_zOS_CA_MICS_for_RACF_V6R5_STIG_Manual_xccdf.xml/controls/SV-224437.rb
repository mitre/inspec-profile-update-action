...
setr generic(dataset) refresh"
  ...
  tag check_id: 'C-26114r868473_chk'
  tag severity: 'medium'
  tag gid: 'V-224437'
  tag rid: 'SV-224437r868476_rule'
  tag stig_id: 'ZMICR002'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-26102r868475_fix'
  tag 'documentable'
  tag legacy: ['SV-50081', 'V-21592']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
