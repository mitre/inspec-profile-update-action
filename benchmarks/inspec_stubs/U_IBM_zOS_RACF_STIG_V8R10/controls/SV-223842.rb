...
If the LOGNAME variable is marked read-only (i.e., "readonly LOGNAME") in /etc/profile, this is not a finding.'
  desc 'fix', 'Configure the etc/profile to specify the UMASK command is executed with a value of 077, the LOGNAME variable is marked read-only for the /etc/profile file, and exceptions are documented with the ISSO.'
  impact 0.5
  ref 'DPMS Target IBM zOS RACF'
  tag check_id: 'C-25515r868888_chk'
  tag severity: 'medium'
  tag gid: 'V-223842'
  tag rid: 'SV-223842r868890_rule'
  tag stig_id: 'RACF-US-000050'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25503r868889_fix'
  tag 'documentable'
