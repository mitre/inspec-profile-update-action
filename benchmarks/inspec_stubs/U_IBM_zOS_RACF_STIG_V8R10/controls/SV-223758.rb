...
BPX.SMF - READ access only when documented and justified in Site Security Plan. Documentation should include a reason why a more specific profile is not acceptable.'
  ...
  tag check_id: 'C-25431r868848_chk'
  tag severity: 'medium'
  tag gid: 'V-223758'
  tag rid: 'SV-223758r868850_rule'
  tag stig_id: 'RACF-OS-000020'
  tag gtitle: 'SRG-OS-000032-GPOS-00013'
  tag fix_id: 'F-25419r868849_fix'
  tag 'documentable'
  tag legacy: ['SV-107327', 'V-98223']
  tag cci: ['CCI-000067']
  tag nist: ['AC-17 (1)']
end
