...
'
  desc 'check', 'Execute a dataset access list for Base TCP/IP component datasets.
...
WRITE and ALLOCATE access to the data set(s) containing the configuration files shared by TCP/IP applications is restricted to systems programming personnel.'
  ...
  tag check_id: 'C-25499r515166_chk'
  tag severity: 'medium'
  tag gid: 'V-223826'
  tag rid: 'SV-223826r604139_rule'
  tag stig_id: 'RACF-TC-000070'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25487r515167_fix'
  tag satisfies: ['SRG-OS-000080-GPOS-00048', 'SRG-OS-000259-GPOS-00100']
  tag 'documentable'
  tag legacy: ['V-98359', 'SV-107463']
