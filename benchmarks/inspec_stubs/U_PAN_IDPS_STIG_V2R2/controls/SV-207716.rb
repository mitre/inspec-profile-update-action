...
Select "OK" when the confirmation dialog appears.'
  ...
  tag check_id: 'C-7970r358481_chk'
  tag severity: 'low'
  tag gid: 'V-207716'
  tag rid: 'SV-207716r557390_rule'
  tag stig_id: 'PANW-IP-000058'
  tag gtitle: 'SRG-NET-000511-IDPS-00012'
  tag fix_id: 'F-7970r358482_fix'
  tag 'documentable'
  tag legacy: ['SV-77193', 'V-62703']
  tag cci: ['CCI-001851']
  tag nist: ['AU-4 (1)']
end
