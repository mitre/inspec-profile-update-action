...
If the return does not contain "/Applications/Calendar.app", this is a finding.'
  ...
  tag check_id: 'C-9838r282243_chk'
  tag severity: 'medium'
  tag gid: 'V-209587'
  tag rid: 'SV-209587r610285_rule'
  tag stig_id: 'AOSX-14-002023'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9838r282244_fix'
  tag 'documentable'
  tag legacy: ['SV-105051', 'V-95913']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
