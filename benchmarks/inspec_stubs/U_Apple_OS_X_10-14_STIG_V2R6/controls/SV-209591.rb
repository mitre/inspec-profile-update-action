...
If the return is not “SkipCloudSetup = 1”, this is a finding.'
  ...
  tag check_id: 'C-9842r282255_chk'
  tag severity: 'medium'
  tag gid: 'V-209591'
  tag rid: 'SV-209591r610285_rule'
  tag stig_id: 'AOSX-14-002035'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9842r282256_fix'
  tag 'documentable'
  tag legacy: ['SV-105059', 'V-95921']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
