...
'
  desc 'check', %q(To check if the system is configured to disable access to the Internet Accounts System preference pane, run the following command:
...
If the return is not two arrays (HiddenPreferencePanes and DisabledPreferencePanes) each containing: "com.apple.preferences.internetaccounts", this is a finding.)
  ...
  tag check_id: 'C-9840r755162_chk'
  tag severity: 'medium'
  tag gid: 'V-209589'
  tag rid: 'SV-209589r755163_rule'
