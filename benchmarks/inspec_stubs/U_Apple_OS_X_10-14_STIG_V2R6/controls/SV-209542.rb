...
/usr/bin/sudo chmod -N [audit log file]'
  ...
  tag check_id: 'C-9793r282108_chk'
  tag severity: 'medium'
  tag gid: 'V-209542'
  tag rid: 'SV-209542r610285_rule'
  tag stig_id: 'AOSX-14-000030'
  tag gtitle: 'SRG-OS-000057-GPOS-00027'
  tag fix_id: 'F-9793r282109_fix'
  tag satisfies: ['SRG-OS-000057-GPOS-00027', 'SRG-OS-000206-GPOS-00084']
  tag 'documentable'
  tag legacy: ['SV-104961', 'V-95823']
