...
/usr/bin/sudo /usr/bin/sed -i.bak 's/logger -p/logger -s -p/' /etc/security/audit_warn; /usr/bin/sudo /usr/sbin/audit -s)
  ...
  tag check_id: 'C-9813r282168_chk'
  tag severity: 'medium'
  tag gid: 'V-209562'
  tag rid: 'SV-209562r610285_rule'
  tag stig_id: 'AOSX-14-001031'
  tag gtitle: 'SRG-OS-000344-GPOS-00135'
  tag fix_id: 'F-9813r282169_fix'
  tag 'documentable'
  tag legacy: ['SV-104995', 'V-95857']
  tag cci: ['CCI-001858']
  tag nist: ['AU-5 (2)']
end
