...
After "FileVault" is initially set up, additional users can be added.'
  ...
  tag check_id: 'C-9887r466288_chk'
  tag severity: 'medium'
  tag gid: 'V-209636'
  tag rid: 'SV-209636r610285_rule'
  tag stig_id: 'AOSX-14-005020'
  tag gtitle: 'SRG-OS-000185-GPOS-00079'
  tag fix_id: 'F-9887r466289_fix'
  tag satisfies: ['SRG-OS-000185-GPOS-00079', 'SRG-OS-000404-GPOS-00183', 'SRG-OS-000405-GPOS-00184']
  tag 'documentable'
  tag legacy: ['SV-105135', 'V-95997']
