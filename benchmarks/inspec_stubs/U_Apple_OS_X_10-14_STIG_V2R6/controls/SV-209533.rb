...
/usr/bin/sudo systemsetup -setnetworktimeserver "server"'
  ...
  tag check_id: 'C-9784r466306_chk'
  tag severity: 'medium'
  tag gid: 'V-209533'
  tag rid: 'SV-209533r610285_rule'
  tag stig_id: 'AOSX-14-000014'
  tag gtitle: 'SRG-OS-000355-GPOS-00143'
  tag fix_id: 'F-9784r466307_fix'
  tag satisfies: ['SRG-OS-000355-GPOS-00143', 'SRG-OS-000356-GPOS-00144']
  tag 'documentable'
  tag legacy: ['SV-104947', 'V-95809']
