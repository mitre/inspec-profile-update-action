...
'
  desc 'check', %q(To check if the system is configured to disable access to the iCloud preference pane, run the following command:
...
If the output is null or not "allowCloudPhotoLibrary = 0", this is a finding.)
  ...
  tag check_id: 'C-9850r755160_chk'
  tag severity: 'medium'
  tag gid: 'V-209599'
  tag rid: 'SV-209599r755161_rule'
  tag stig_id: 'AOSX-14-002043'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9850r569446_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['SV-105075', 'V-95937']
