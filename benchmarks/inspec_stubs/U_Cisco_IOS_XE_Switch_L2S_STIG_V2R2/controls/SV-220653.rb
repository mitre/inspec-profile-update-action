control 'SV-220653' do
  title 'The Cisco switch must be configured to provide the capability for authorized users to remotely view, in real time, all content related to an established user session from a component separate from the Cisco switch.'
  ...
  desc 'check', 'Verify that the switch is capable of capturing ingress and egress packets from any designated switch port for the purpose of remotely monitoring a specific user session. The example configuration below will capture packets from interface GigabitEthernet0/3 and replicate the packets to interface GigabitEthernet0/2.
...
SW1(config)#monitor session 1 destination int g0/2'
  ...
  tag check_id: 'C-22368r507507_chk'
  tag severity: 'medium'
  tag gid: 'V-220653'
  tag rid: 'SV-220653r539671_rule'
  tag stig_id: 'CISC-L2-000070'
  tag gtitle: 'SRG-NET-000332-L2S-000002'
  tag fix_id: 'F-22357r507508_fix'
  tag 'documentable'
  tag legacy: ['SV-110277', 'V-101173']
  tag cci: ['CCI-001920']
  tag nist: ['AU-14 (3)']
end
