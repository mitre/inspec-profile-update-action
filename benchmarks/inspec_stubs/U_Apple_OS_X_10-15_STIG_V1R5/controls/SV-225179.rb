...
The system may need to be restarted for the update to take effect.'
  ...
  tag check_id: 'C-26878r467705_chk'
  tag severity: 'medium'
  tag gid: 'V-225179'
  tag rid: 'SV-225179r610901_rule'
  tag stig_id: 'AOSX-15-002022'
  tag gtitle: 'SRG-OS-000096-GPOS-00050'
  tag fix_id: 'F-26866r467706_fix'
  tag 'documentable'
  tag legacy: ['V-102777', 'SV-111739']
  tag cci: ['CCI-000382']
  tag nist: ['CM-7 b']
end
