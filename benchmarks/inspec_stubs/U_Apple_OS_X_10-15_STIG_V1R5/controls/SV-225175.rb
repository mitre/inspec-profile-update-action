...
If the result is “allowCamera = 1” and the collaborative computing device has not been authorized for use, this is a finding.'
  ...
  tag check_id: 'C-26874r467693_chk'
  tag severity: 'medium'
  tag gid: 'V-225175'
  tag rid: 'SV-225175r610901_rule'
  tag stig_id: 'AOSX-15-002017'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26862r467694_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['V-102767', 'SV-111729']
  tag cci: ['CCI-000381', 'CCI-001150', 'CCI-001153']
  tag nist: ['CM-7 a', 'SC-15 a', 'SC-15 (1)']
end
