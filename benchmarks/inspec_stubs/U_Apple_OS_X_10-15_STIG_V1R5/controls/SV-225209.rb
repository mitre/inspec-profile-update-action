...
If "allowSimple" is not set to "0" or is undefined, this is a finding.'
  ...
  tag check_id: 'C-26908r467795_chk'
  tag severity: 'medium'
  tag gid: 'V-225209'
  tag rid: 'SV-225209r610901_rule'
  tag stig_id: 'AOSX-15-003011'
  tag gtitle: 'SRG-OS-000266-GPOS-00101'
  tag fix_id: 'F-26896r467796_fix'
  tag 'documentable'
  tag legacy: ['V-102837', 'SV-111799']
  tag cci: ['CCI-001619']
  tag nist: ['IA-5 (1) (a)']
end
