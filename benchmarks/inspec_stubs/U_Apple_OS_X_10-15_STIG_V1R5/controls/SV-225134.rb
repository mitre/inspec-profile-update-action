...
Name the file "banner" and place it in "/etc/".'
  ...
  tag check_id: 'C-26833r467570_chk'
  tag severity: 'medium'
  tag gid: 'V-225134'
  tag rid: 'SV-225134r610901_rule'
  tag stig_id: 'AOSX-15-000023'
  tag gtitle: 'SRG-OS-000023-GPOS-00006'
  tag fix_id: 'F-26821r467571_fix'
  tag 'documentable'
  tag legacy: ['V-102683', 'SV-111645']
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
