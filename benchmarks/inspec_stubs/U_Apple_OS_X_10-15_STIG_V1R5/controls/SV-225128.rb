...
'
  desc 'check', 'The TIMED (NTP replacement in Mojave) service must be enabled on all networked systems. To check if the service is running, use the following command:
...
/usr/bin/sudo systemsetup -setnetworktimeserver "server"'
  ...
  tag check_id: 'C-26827r467552_chk'
  tag severity: 'medium'
  tag gid: 'V-225128'
  tag rid: 'SV-225128r610901_rule'
  tag stig_id: 'AOSX-15-000014'
  tag gtitle: 'SRG-OS-000355-GPOS-00143'
  tag fix_id: 'F-26815r467553_fix'
  tag satisfies: ['SRG-OS-000355-GPOS-00143', 'SRG-OS-000356-GPOS-00144']
  tag 'documentable'
  tag legacy: ['V-102671', 'SV-111633']
