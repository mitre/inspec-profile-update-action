...
If the return does not contain "/Applications/Mail.app", this is a finding.'
  ...
  tag check_id: 'C-26875r467696_chk'
  tag severity: 'medium'
  tag gid: 'V-225176'
  tag rid: 'SV-225176r610901_rule'
  tag stig_id: 'AOSX-15-002019'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26863r467697_fix'
  tag 'documentable'
  tag legacy: ['SV-111731', 'V-102769']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
