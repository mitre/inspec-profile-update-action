...
A text editor may also be used to implement the required updates to the "/etc/security/audit_control" file.)
  ...
  tag check_id: 'C-26842r467597_chk'
  tag severity: 'medium'
  tag gid: 'V-225143'
  tag rid: 'SV-225143r610901_rule'
  tag stig_id: 'AOSX-15-001002'
  tag gtitle: 'SRG-OS-000032-GPOS-00013'
  tag fix_id: 'F-26830r485761_fix'
  tag satisfies: ['SRG-OS-000032-GPOS-00013', 'SRG-OS-000462-GPOS-00206']
  tag 'documentable'
  tag legacy: ['SV-111665', 'V-102703']
