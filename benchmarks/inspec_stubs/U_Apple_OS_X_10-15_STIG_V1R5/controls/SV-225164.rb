...
The system may need to be restarted for the update to take effect.'
  ...
  tag check_id: 'C-26863r467660_chk'
  tag severity: 'medium'
  tag gid: 'V-225164'
  tag rid: 'SV-225164r610901_rule'
  tag stig_id: 'AOSX-15-002006'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26851r467661_fix'
  tag 'documentable'
  tag legacy: ['V-102745', 'SV-111707']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
