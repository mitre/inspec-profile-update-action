control 'SV-223915' do
  title 'CA-TSS must limit all system PROCLIB data sets to system programmers only and appropriate authorized users.'
...
If the ESM data set access authorizations restrict WRITE and/or greater access to systems programming personnel, this is not a finding."
  desc 'fix', 'Configure ESM data set rules to restrict all WRITE and/or greater access to all PROCLIBs referenced in the Master JCL and JES2 or JES3 procedure for started tasks (STCs) and TSO logons to systems programming personnel only.
...
d. Ensure that only system programming personnel are authorized WRITE and/or greater access to PROCLIB data sets that contain STC and TSO procedures.'
  ...
  tag check_id: 'C-25588r868942_chk'
  tag severity: 'high'
  tag gid: 'V-223915'
  tag rid: 'SV-223915r877756_rule'
  tag stig_id: 'TSS0-ES-000420'
  tag gtitle: 'SRG-OS-000324-GPOS-00125'
  tag fix_id: 'F-25576r868943_fix'
  tag satisfies: ['SRG-OS-000324-GPOS-00125', 'SRG-OS-000080-GPOS-00048']
  tag 'documentable'
  tag legacy: ['SV-107641', 'V-98537']
