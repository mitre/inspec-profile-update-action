control 'SV-224008' do
  title 'IBM z/OS inapplicable PPT entries must be invalidated.'
...
Examples of non-essential capabilities include, but are not limited to, games, software packages, tools, and demonstration software, not related to requirements or providing a wide array of functionality not required for every mission, but which cannot be disabled.'
  desc 'check', %q(Review program entries in the IBM Program Properties Table (PPT). You may use a third-party product to examine these entries; however, to determine program entries, issue the following command from an ISPF command line:
...
If this is not true, this is a finding.)
  desc 'fix', "Review the PPT and define all entries associated with nonexistent or inapplicable modules as invalidated. Nullify the invalid IEFSDPPT entry by ensuring that there is a corresponding SCHED entry, which confers no special attributes. 
...
-The reason the module's privileges are being revoked"
  ...
  tag check_id: 'C-25681r868987_chk'
  tag severity: 'medium'
  tag gid: 'V-224008'
  tag rid: 'SV-224008r877849_rule'
  tag stig_id: 'TSS0-OS-000120'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-25669r868988_fix'
  tag 'documentable'
  tag legacy: ['SV-107829', 'V-98725']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
