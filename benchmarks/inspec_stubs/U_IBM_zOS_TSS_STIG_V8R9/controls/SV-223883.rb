control 'SV-223883' do
  title 'IBM z/OS for PKI-based authentication must use ICSF or the ESM to store keys.'
...
Remove all .kdb and .jks key files.'
  ...
  tag check_id: 'C-25556r877724_chk'
  tag severity: 'medium'
  tag gid: 'V-223883'
  tag rid: 'SV-223883r877725_rule'
  tag stig_id: 'TSS0-ES-000100'
  tag gtitle: 'SRG-OS-000067-GPOS-00035'
  tag fix_id: 'F-25544r811041_fix'
  tag 'documentable'
