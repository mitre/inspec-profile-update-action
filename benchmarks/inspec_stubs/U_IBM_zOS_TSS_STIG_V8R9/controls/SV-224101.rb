...
chaudit w=sf,rx+f /etc/banner'
  ...
  tag check_id: 'C-25774r516702_chk'
  tag severity: 'medium'
  tag gid: 'V-224101'
  tag rid: 'SV-224101r877941_rule'
  tag stig_id: 'TSS0-UT-000030'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25762r516703_fix'
  tag satisfies: ['SRG-OS-000080-GPOS-00048', 'SRG-OS-000259-GPOS-00100']
  tag 'documentable'
  tag legacy: ['SV-108013', 'V-98909']
