...
If the organization-defined audit requirements are not covered by the default audit options, deploy and configure Fine-Grained Auditing. For details, refer to Oracle documentation, at the locations above.)
  ...
  tag check_id: 'C-21476r307102_chk'
  tag severity: 'medium'
  tag gid: 'V-219751'
  tag rid: 'SV-219751r395706_rule'
  tag stig_id: 'O112-C2-006800'
  tag gtitle: 'SRG-APP-000089-DB-000064'
  tag fix_id: 'F-21475r307103_fix'
  tag 'documentable'
  tag legacy: ['SV-66679', 'V-52463']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
