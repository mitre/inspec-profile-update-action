...
DBA_ROLE_PRIVS'
  ...
  tag check_id: 'C-41658r667513_chk'
  tag severity: 'medium'
  tag gid: 'V-238447'
  tag rid: 'SV-238447r667515_rule'
  tag stig_id: 'O112-C2-004400'
  tag gtitle: 'SRG-APP-000141-DB-000093'
  tag fix_id: 'F-41617r667514_fix'
  tag 'documentable'
  tag legacy: ['V-52399', 'SV-66615']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
