...
For mainframe-based databases, locate database software and configuration files in separate DASD pools from other mainframe applications.'
  ...
  tag check_id: 'C-21518r307228_chk'
  tag severity: 'medium'
  tag gid: 'V-219793'
  tag rid: 'SV-219793r395850_rule'
  tag stig_id: 'O112-P2-010900'
  tag gtitle: 'SRG-APP-000133-DB-000199'
  tag fix_id: 'F-21517r307229_fix'
  tag 'documentable'
  tag legacy: ['SV-66657', 'V-52441']
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
end
