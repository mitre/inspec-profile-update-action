...
(See My Oracle Support Document 948061.1 for more on the chopt command.)'
  ...
  tag check_id: 'C-21495r307159_chk'
  tag severity: 'medium'
  tag gid: 'V-219770'
  tag rid: 'SV-219770r395853_rule'
  tag stig_id: 'O112-C2-011700'
  tag gtitle: 'SRG-APP-000141-DB-000092'
  tag fix_id: 'F-21494r307160_fix'
  tag 'documentable'
  tag legacy: ['SV-66451', 'V-52235']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
