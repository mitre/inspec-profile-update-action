...
File hashes or checksums should be used for comparisons since file dates may be manipulated by malicious users.'
  ...
  tag check_id: 'C-21515r307219_chk'
  tag severity: 'medium'
  tag gid: 'V-219790'
  tag rid: 'SV-219790r395850_rule'
  tag stig_id: 'O112-OS-010700'
  tag gtitle: 'SRG-APP-000133-DB-000179'
  tag fix_id: 'F-21514r307220_fix'
  tag 'documentable'
  tag legacy: ['SV-66643', 'V-52427']
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
end
