...
While password parameters reside in profiles, they are unaffected by RESOURCE_LIMIT or ALTER SYSTEM and password management is always enabled.'
  ...
  tag check_id: 'C-21474r307096_chk'
  tag severity: 'medium'
  tag gid: 'V-219749'
  tag rid: 'SV-219749r395475_rule'
  tag stig_id: 'O112-C2-001800'
  tag gtitle: 'SRG-APP-000023-DB-000001'
  tag fix_id: 'F-21473r307097_fix'
  tag 'documentable'
  tag legacy: ['SV-66565', 'V-52349']
  tag cci: ['CCI-000015']
  tag nist: ['AC-2 (1)']
end
