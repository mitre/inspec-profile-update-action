...
Please see the Oracle Net Services Administrators Guides, External Procedures section for detailed configuration information.'
  ...
  tag check_id: 'C-21497r307165_chk'
  tag severity: 'medium'
  tag gid: 'V-219772'
  tag rid: 'SV-219772r395853_rule'
  tag stig_id: 'O112-C2-011810'
  tag gtitle: 'SRG-APP-000141-DB-000093'
  tag fix_id: 'F-21496r307166_fix'
  tag 'documentable'
  tag legacy: ['SV-74571', 'V-60141']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
