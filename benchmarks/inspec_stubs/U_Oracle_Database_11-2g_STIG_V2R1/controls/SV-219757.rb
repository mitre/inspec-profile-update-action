...
http://docs.oracle.com/cd/E11882_01/appdev.112/e40758/d_audit_mgmt.htm)
  ...
  tag check_id: 'C-21482r307120_chk'
  tag severity: 'medium'
  tag gid: 'V-219757'
  tag rid: 'SV-219757r395730_rule'
  tag stig_id: 'O112-C2-007700'
  tag gtitle: 'SRG-APP-000098-DB-000042'
  tag fix_id: 'F-21481r307121_fix'
  tag 'documentable'
  tag legacy: ['SV-66693', 'V-52477']
  tag cci: ['CCI-000133']
  tag nist: ['AU-3 d']
end
