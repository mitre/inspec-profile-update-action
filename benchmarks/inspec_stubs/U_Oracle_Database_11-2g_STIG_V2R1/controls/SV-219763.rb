...
SQL>REVOKE EXECUTE ON PROCEDURE p FROM george RESTRICT)
  ...
  tag check_id: 'C-21488r307138_chk'
  tag severity: 'medium'
  tag gid: 'V-219763'
  tag rid: 'SV-219763r395826_rule'
  tag stig_id: 'O112-C2-009500'
  tag gtitle: 'SRG-APP-000120-DB-000061'
  tag fix_id: 'F-21487r307139_fix'
  tag 'documentable'
  tag legacy: ['SV-66405', 'V-52189']
  tag cci: ['CCI-000164']
  tag nist: ['AU-9 a']
end
