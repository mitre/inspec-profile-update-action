...
Using protocols deemed non-secure would compromise the ability of the DBMS to operate in a secure fashion. The database must be able to disable network protocols deemed non-secure.'
  desc 'check', %q(Review the PPSM Technical Assurance List to acquire an up-to-date list of network protocols deemed non-secure.
...
Protocol: TCP/IP with SSL  Parameter: PORT      Notes: Specify the listening port number.
  ...
  desc 'fix', 'Disable any network protocol listed as non-secure in the PPSM documentation.
...
(SERVICE_NAME=sales.us.example.com)))'
  ...
  tag check_id: 'C-41646r667477_chk'
  tag severity: 'medium'
  tag gid: 'V-238435'
  tag rid: 'SV-238435r667479_rule'
  tag stig_id: 'O112-C2-001700'
  tag gtitle: 'SRG-APP-000142-DB-000094'
  tag fix_id: 'F-41605r667478_fix'
  tag 'documentable'
  tag legacy: ['V-52347', 'SV-66563']
  tag cci: ['CCI-000382']
  tag nist: ['CM-7 b']
end
