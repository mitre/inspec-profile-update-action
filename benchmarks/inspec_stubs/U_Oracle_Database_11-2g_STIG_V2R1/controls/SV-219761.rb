...
Revoke access to the AUD$ table to anyone who should not have access to it.'
  ...
  tag check_id: 'C-21486r307132_chk'
  tag severity: 'medium'
  tag gid: 'V-219761'
  tag rid: 'SV-219761r395820_rule'
  tag stig_id: 'O112-C2-009300'
  tag gtitle: 'SRG-APP-000118-DB-000059'
  tag fix_id: 'F-21485r307133_fix'
  tag 'documentable'
  tag legacy: ['SV-66395', 'V-52179']
  tag cci: ['CCI-000162']
  tag nist: ['AU-9 a']
end
