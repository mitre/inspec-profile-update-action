...
Where a password lifetime longer than 60 is needed, document the reasons and obtain ISSO approval.'
  ...
  tag check_id: 'C-41681r708142_chk'
  tag severity: 'medium'
  tag gid: 'V-238470'
  tag rid: 'SV-238470r708144_rule'
  tag stig_id: 'O112-C2-015200'
  tag gtitle: 'SRG-APP-000164-DB-000401'
  tag fix_id: 'F-41640r708143_fix'
  tag 'documentable'
  tag legacy: ['V-52291', 'SV-66507']
  tag cci: ['CCI-000192']
  tag nist: ['IA-5 (1) (a)']
end
