...
http://docs.oracle.com/cd/E11882_01/appdev.112/e40758/d_audit_mgmt.htm)
  ...
  tag check_id: 'C-21481r307117_chk'
  tag severity: 'medium'
  tag gid: 'V-219756'
  tag rid: 'SV-219756r395727_rule'
  tag stig_id: 'O112-C2-007600'
  tag gtitle: 'SRG-APP-000097-DB-000041'
  tag fix_id: 'F-21480r307118_fix'
  tag 'documentable'
  tag legacy: ['SV-66691', 'V-52475']
  tag cci: ['CCI-000132']
  tag nist: ['AU-3 c']
end
