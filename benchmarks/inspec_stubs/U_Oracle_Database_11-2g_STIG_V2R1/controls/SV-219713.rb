...
For each remote application or application server, determine whether communications between it and the DBMS are encrypted. If any are not encrypted, this is a finding.'
  ...
  tag check_id: 'C-21438r306988_chk'
  tag severity: 'medium'
  tag gid: 'V-219713'
  tag rid: 'SV-219713r401224_rule'
  tag stig_id: 'O112-BP-023000'
  tag gtitle: 'SRG-APP-000516-DB-000363'
  tag fix_id: 'F-21437r306989_fix'
  tag 'documentable'
  tag legacy: ['SV-68237', 'V-53997']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
