...
If ASO is not an option, use site-specific procedures to secure data at rest.'
  ...
  tag check_id: 'C-21506r307192_chk'
  tag severity: 'medium'
  tag gid: 'V-219781'
  tag rid: 'SV-219781r397744_rule'
  tag stig_id: 'O112-C2-018300'
  tag gtitle: 'SRG-APP-000231-DB-000154'
  tag fix_id: 'F-21505r307193_fix'
  tag 'documentable'
  tag legacy: ['SV-66359', 'V-52143']
  tag cci: ['CCI-001199']
  tag nist: ['SC-28']
end
