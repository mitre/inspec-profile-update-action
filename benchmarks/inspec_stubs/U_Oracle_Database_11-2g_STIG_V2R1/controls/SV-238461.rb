...
<oracle_home>/RDBMS/ADMIN/utlpwdmg.sql.  This can be used as the starting point for a customized function.)'
  ...
  tag check_id: 'C-41672r667555_chk'
  tag severity: 'medium'
  tag gid: 'V-238461'
  tag rid: 'SV-238461r667557_rule'
  tag stig_id: 'O112-C2-013900'
  tag gtitle: 'SRG-APP-000164-DB-000401'
  tag fix_id: 'F-41631r667556_fix'
  tag 'documentable'
  tag legacy: ['V-52271', 'SV-66487']
  tag cci: ['CCI-000192']
  tag nist: ['IA-5 (1) (a)']
end
