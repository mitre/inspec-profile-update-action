...
Failure to properly secure a WebSphere MQ channel may lead to unauthorized access. This exposure could compromise the availability, integrity, and confidentiality of some system services, applications, and customer data.'
  desc 'check', "a) Refer to the following report produced by the MQSeries/WebSphere MQ Data Collection:
...
e) If any of the items in (c) above are untrue, this is a finding."
  desc 'fix', %q(Refer to the following report produced by the z/OS Data Collection:
...
2. For information on obtaining an SSL certificate in the DISA CSD environment, send email inquiry to disaraoperations@disa.mil.)
  impact 0.5
  ref 'DPMS Target zOS WebsphereMQ for RACF'
  tag check_id: 'C-26235r870230_chk'
  tag severity: 'medium'
  tag gid: 'V-224552'
  tag rid: 'SV-224552r870232_rule'
  tag stig_id: 'ZWMQ0012'
  tag gtitle: 'SRG-OS-000403'
  tag fix_id: 'F-26223r870231_fix'
  tag 'documentable'
  tag legacy: ['V-6980', 'SV-111903']
  tag cci: ['CCI-002470']
  tag nist: ['SC-23 (5)']
end
