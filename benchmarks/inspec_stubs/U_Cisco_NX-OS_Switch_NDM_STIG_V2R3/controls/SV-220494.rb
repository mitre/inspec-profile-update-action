...
If account enabling is not automatically audited, this is a finding.'
  desc 'fix', 'Configure the switch to log account enabling using the following steps:
...
SW1(config)# end'
  ...
  tag check_id: 'C-22209r539203_chk'
  tag severity: 'medium'
  tag gid: 'V-220494'
  tag rid: 'SV-220494r604141_rule'
  tag stig_id: 'CISC-ND-000880'
  tag gtitle: 'SRG-APP-000319-NDM-000283'
  tag fix_id: 'F-22198r539204_fix'
  tag 'documentable'
  tag legacy: ['SV-110637', 'V-101533']
  tag cci: ['CCI-002130']
  tag nist: ['AC-2 (4)']
end
