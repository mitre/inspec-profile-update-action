control 'SV-228607' do
  title 'Google Android 11 must be configured to enable a screen-lock policy that will lock the display after a period of inactivity.'
...
If the EMM console device policy is not set to enable a screen-lock policy that will lock the display after a period of inactivity or on the Android 11 device, the device policy is not set to enable a screen-lock policy that will lock the display after a period of inactivity, this is a finding.'
  desc 'fix', 'Configure the Google Android 11 device to enable a screen-lock policy that will lock the display after a period of inactivity.
...
3. Set "Max time to screen lock" to any number desired. The units are in seconds.'
  ...
  tag check_id: 'C-30842r505818_chk'
  tag severity: 'medium'
  tag gid: 'V-228607'
  tag rid: 'SV-228607r505820_rule'
  tag stig_id: 'GOOG-11-000300'
  tag gtitle: 'PP-MDF-301030'
  tag fix_id: 'F-30819r505819_fix'
  tag 'documentable'
  tag cci: ['CCI-000057']
  tag nist: ['AC-11 a']
end
