...
If the scheduled action is not targeted at an "All Computers" Action Group, this is a finding.'
  desc 'fix', %q(Using a web browser on a system that has connectivity to the Tanium Application, access the Tanium Application web user interface (UI).
...
Click on "Show Client Status Details".)
  ...
  tag check_id: 'C-37226r610623_chk'
  tag severity: 'medium'
  tag gid: 'V-234041'
  tag rid: 'SV-234041r612749_rule'
  tag stig_id: 'TANS-CL-000007'
  tag gtitle: 'SRG-APP-000328'
  tag fix_id: 'F-37191r610624_fix'
  tag 'documentable'
  tag legacy: ['SV-102155', 'V-92053']
  tag cci: ['CCI-002165']
  tag nist: ['AC-3 (4)']
end
