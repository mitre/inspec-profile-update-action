...
If the action is not configured to repeat at least once every 24 hours, this is a finding.
...
Configure the schedule to repeat at least every 24 hours for the requested action.
...
Click on "Show Client Status Details".'
  ...
  tag check_id: 'C-37224r811513_chk'
  tag severity: 'medium'
  tag gid: 'V-234039'
  tag rid: 'SV-234039r811515_rule'
  tag stig_id: 'TANS-CL-000005'
  tag gtitle: 'SRG-APP-000328'
  tag fix_id: 'F-37189r811514_fix'
  tag 'documentable'
  tag legacy: ['SV-102151', 'V-92049']
  tag cci: ['CCI-002165']
  tag nist: ['AC-3 (4)']
end
