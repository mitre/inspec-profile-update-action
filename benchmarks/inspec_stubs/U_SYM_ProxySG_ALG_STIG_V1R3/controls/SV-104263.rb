control 'SV-104263' do
  title 'Symantec ProxySG providing reverse proxy encryption intermediary services must use NIST FIPS-validated cryptography to implement encryption services.'
...
See the Blue Coat Reverse Proxy WebGuide for more information.'
  ...
  tag check_id: 'C-93495r1_chk'
  tag severity: 'medium'
  tag gid: 'V-94309'
  tag rid: 'SV-104263r1_rule'
  tag stig_id: 'SYMP-AG-000480'
  tag gtitle: 'SRG-NET-000510-ALG-000111'
  tag fix_id: 'F-100425r1_fix'
  tag 'documentable'
  tag cci: ['CCI-002450']
  tag nist: ['SC-13 b']
end
