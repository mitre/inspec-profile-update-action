control 'SV-104197' do
  title 'Symantec ProxySG providing user access control intermediary services must generate audit records when successful/unsuccessful attempts to access web resources occur.'
...
4. For each Web Access and Web Authentication Layer, right-click the "Track" column for each rule and select "Set". Click "New" and select "Event Log".'
  ...
  tag check_id: 'C-93429r1_chk'
  tag severity: 'medium'
  tag gid: 'V-94243'
  tag rid: 'SV-104197r1_rule'
  tag stig_id: 'SYMP-AG-000140'
  tag gtitle: 'SRG-NET-000513-ALG-000026'
  tag fix_id: 'F-100359r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
