control 'SV-104259' do
  title 'Symantec ProxySG providing reverse proxy encryption intermediary services must implement NIST FIPS-validated cryptography to generate cryptographic hashes.'
...
10. Type "attribute" followed by a list of the desired NIST FIPS-validated cipher suites.'
  ...
  tag check_id: 'C-93491r1_chk'
  tag severity: 'medium'
  tag gid: 'V-94305'
  tag rid: 'SV-104259r1_rule'
  tag stig_id: 'SYMP-AG-000460'
  tag gtitle: 'SRG-NET-000510-ALG-000025'
  tag fix_id: 'F-100421r1_fix'
  tag 'documentable'
  tag cci: ['CCI-002450']
  tag nist: ['SC-13 b']
end
