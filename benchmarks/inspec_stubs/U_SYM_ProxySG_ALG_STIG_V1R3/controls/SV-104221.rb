control 'SV-104221' do
  title 'Symantec ProxySG providing intermediary services for HTTP must inspect inbound HTTP traffic for protocol compliance and protocol anomalies.'
...
3. Once all services have been modified, click "Apply".'
  ...
  tag check_id: 'C-93453r1_chk'
  tag severity: 'medium'
  tag gid: 'V-94267'
  tag rid: 'SV-104221r1_rule'
  tag stig_id: 'SYMP-AG-000260'
  tag gtitle: 'SRG-NET-000512-ALG-000066'
  tag fix_id: 'F-100383r1_fix'
  tag 'documentable'
