control 'SV-233315' do
  title 'Forescout appliance must not be configured to implement a DHCP layer 3 method for separation or device authorization. This is required for compliance with C2C Step 1.'
...
2. Ensure all traffic passing through the NAC is properly labeled and that all authenticated and non-authenticated traffic goes through the NAC.'
  ...
  tag check_id: 'C-36510r811378_chk'
  tag severity: 'high'
  tag gid: 'V-233315'
  tag rid: 'SV-233315r811379_rule'
