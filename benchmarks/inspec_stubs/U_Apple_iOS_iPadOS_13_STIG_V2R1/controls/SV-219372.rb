control 'SV-219372' do
  title 'Apple iOS/iPadOS must implement the management setting: require the user to enter a password when connecting to an AirPlay-enabled device for the first time.'
...
If "Require passcode on first AirPlay pairing" is unchecked in the Apple iOS/iPadOS management tool, "<key>forceAirPlayOutgoingRequestsPairingPassword</key><true/>" appears in the configuration profile, or the restrictions policy on the iPhone and iPad does not list "AirPlay outgoing requests pairing password enforced", this is a finding.'
  ...
  tag check_id: 'C-21097r547631_chk'
  tag severity: 'low'
  tag gid: 'V-219372'
  tag rid: 'SV-219372r604137_rule'
  tag stig_id: 'AIOS-13-011100'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-21096r547632_fix'
  tag 'documentable'
  tag legacy: ['SV-106577', 'V-97473']
  tag cci: ['CCI-000063']
  tag nist: ['AC-17 a']
end
