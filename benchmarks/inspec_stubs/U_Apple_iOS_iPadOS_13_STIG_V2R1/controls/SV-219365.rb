...
<true/>" appears in the configuration profile, or the restrictions policy on the iPhone and iPad does not list "Opening documents from managed to unmanaged apps not allowed", this is a finding.'
  ...
  tag check_id: 'C-21090r547610_chk'
  tag severity: 'medium'
  tag gid: 'V-219365'
  tag rid: 'SV-219365r604137_rule'
  tag stig_id: 'AIOS-13-005600'
  tag gtitle: 'PP-MDF-301260'
  tag fix_id: 'F-21089r547611_fix'
  tag 'documentable'
  tag legacy: ['SV-106561', 'V-97457']
