...
If "Share My Location" is toggled to the right and appears green on the iPhone and iPad when the AO has approved the use of personal iCloud accounts, this is a finding.'
  ...
  tag check_id: 'C-21105r547655_chk'
  tag severity: 'medium'
  tag gid: 'V-219380'
  tag rid: 'SV-219380r604137_rule'
  tag stig_id: 'AIOS-13-011900'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-21104r547656_fix'
  tag 'documentable'
  tag legacy: ['SV-106593', 'V-97489']
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
