control 'SV-219356' do
  title 'Apple iOS/iPadOS must be configured to display the DoD advisory warning message at start-up or each time the user unlocks the device.'
  desc %q(Apple iOS/iPadOS is required to display the DoD-approved system use notification message or banner before granting access to the system that provides privacy and security notices consistent with applicable federal laws, Executive Orders, directives, policies, regulations, standards, and guidance. Required banners help ensure that DoD can audit and monitor the activities of mobile device users without legal restriction.
...
2. By creating a background picture with the relevant information and configuring that picture as the background for the lock screen via the Apple iOS/iPadOS management tool'
  ...
  tag check_id: 'C-21081r547585_chk'
  tag severity: 'low'
  tag gid: 'V-219356'
  tag rid: 'SV-219356r604137_rule'
  tag stig_id: 'AIOS-13-003600'
  tag gtitle: 'PP-MDF-301200'
  tag fix_id: 'F-21080r547697_fix'
  tag 'documentable'
  tag legacy: ['SV-106543', 'V-97439']
  tag cci: ['CCI-000366', 'CCI-001764', 'CCI-000370']
  tag nist: ['CM-6 b', 'CM-7 (2)', 'CM-6 (1)']
end
