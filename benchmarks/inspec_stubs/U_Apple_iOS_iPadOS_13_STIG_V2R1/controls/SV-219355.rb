control 'SV-219355' do
  title 'Apple iOS/iPadOS must not display notifications (calendar information) when the device is locked.'
...
If the "Show Today view in Lock screen" is checked in the Apple iOS/iPadOS management tool, "<key>allowLockScreenTodayView</key><true/>" appears in the configuration profile, or the restrictions policy on the iPhone and iPad does not list "Today view on lock screen not allowed", this is a finding.'
  ...
  tag check_id: 'C-21080r547582_chk'
  tag severity: 'medium'
  tag gid: 'V-219355'
  tag rid: 'SV-219355r604137_rule'
  tag stig_id: 'AIOS-13-001900'
  tag gtitle: 'PP-MDF-301120'
  tag fix_id: 'F-21079r547583_fix'
  tag 'documentable'
  tag legacy: ['SV-106541', 'V-97437']
