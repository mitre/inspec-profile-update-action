...
The organization may use technical means such as whitelisting to prevent the use of browsers and mail applications to enforce this requirement.'
  ...
  tag check_id: 'C-57725r848534_chk'
  tag severity: 'high'
  tag gid: 'V-254240'
  tag rid: 'SV-254240r848536_rule'
  tag stig_id: 'WN22-00-000030'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-57676r848535_fix'
  tag satisfies: ['SRG-OS-000480-GPOS-00227', 'SRG-OS-000205-GPOS-00083']
  tag 'documentable'
