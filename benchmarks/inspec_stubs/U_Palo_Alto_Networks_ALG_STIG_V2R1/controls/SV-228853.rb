control 'SV-228853' do
  title 'The Palo Alto Networks security platform must prevent the download of prohibited mobile code.'
  desc 'MMobile code is defined as software modules obtained from remote systems, transferred across a network, and then downloaded and executed on a local system without explicit installation or execution by the recipient.
...
Select "OK" when the confirmation dialog appears.'
  ...
  tag check_id: 'C-31088r559711_chk'
  tag severity: 'medium'
  tag gid: 'V-228853'
  tag rid: 'SV-228853r559712_rule'
  tag stig_id: 'PANW-AG-000074'
  tag gtitle: 'SRG-NET-000289-ALG-000110'
  tag fix_id: 'F-31065r559710_fix'
  tag 'documentable'
  tag legacy: ['V-62587', 'SV-77077']
  tag cci: ['CCI-001169']
  tag nist: ['SC-18 (3)']
end
