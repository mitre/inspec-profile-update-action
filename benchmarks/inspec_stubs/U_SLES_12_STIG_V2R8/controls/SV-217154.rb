...
solver.upgradeRemoveDroppedPackages = true'
  ...
  tag check_id: 'C-18382r369618_chk'
  tag severity: 'medium'
  tag gid: 'V-217154'
  tag rid: 'SV-217154r854090_rule'
  tag stig_id: 'SLES-12-010570'
  tag gtitle: 'SRG-OS-000437-GPOS-00194'
  tag fix_id: 'F-18380r369619_fix'
  tag 'documentable'
  tag legacy: ['V-77163', 'SV-91859']
  tag cci: ['CCI-002617']
  tag nist: ['SI-2 (6)']
end
