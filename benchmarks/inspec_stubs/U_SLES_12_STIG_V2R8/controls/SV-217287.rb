...
# sysctl --system'
  ...
  tag check_id: 'C-18515r370017_chk'
  tag severity: 'medium'
  tag gid: 'V-217287'
  tag rid: 'SV-217287r603262_rule'
  tag stig_id: 'SLES-12-030360'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-18513r370018_fix'
  tag 'documentable'
  tag legacy: ['V-77487', 'SV-92183']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
