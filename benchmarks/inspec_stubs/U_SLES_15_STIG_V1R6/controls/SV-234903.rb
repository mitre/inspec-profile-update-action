...
'
  desc 'check', %q(Verify the SUSE operating system generates an audit record when all modifications occur to the "/etc/gshadow" file.
...
> sudo augenrules --load'
  ...
  tag check_id: 'C-38091r618978_chk'
  tag severity: 'medium'
  tag gid: 'V-234903'
  tag rid: 'SV-234903r622137_rule'
  tag stig_id: 'SLES-15-030040'
  tag gtitle: 'SRG-OS-000004-GPOS-00004'
  tag fix_id: 'F-38054r618979_fix'
