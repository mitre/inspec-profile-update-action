control 'SV-259052' do
  title 'The vCenter Lookup service must limit the amount of time that each Transmission Control Protocol (TCP) connection is kept alive.'
...
# vmon-cli --restart lookupsvc'
  ...
  tag check_id: 'C-62792r934812_chk'
  tag severity: 'medium'
  tag gid: 'V-259052'
  tag rid: 'SV-259052r934814_rule'
  tag stig_id: 'VCLU-80-000125'
  tag gtitle: 'SRG-APP-000001-AS-000001'
  tag fix_id: 'F-62701r934813_fix'
  tag 'documentable'
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
end
