control 'SV-259068' do
  title 'The vCenter Lookup service must enable "ENFORCE_ENCODING_IN_GET_WRITER".'
...
# vmon-cli --restart lookupsvc'
  ...
  tag check_id: 'C-62808r934860_chk'
  tag severity: 'medium'
  tag gid: 'V-259068'
  tag rid: 'SV-259068r934862_rule'
  tag stig_id: 'VCLU-80-000152'
  tag gtitle: 'SRG-APP-000516-AS-000237'
  tag fix_id: 'F-62717r934861_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
