control 'SV-259058' do
  title 'The vCenter Lookup service debug parameter must be disabled.'
...
# vmon-cli --restart lookupsvc'
  ...
  tag check_id: 'C-62798r934830_chk'
  tag severity: 'medium'
  tag gid: 'V-259058'
  tag rid: 'SV-259058r934832_rule'
  tag stig_id: 'VCLU-80-000136'
  tag gtitle: 'SRG-APP-000141-AS-000095'
  tag fix_id: 'F-62707r934831_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
