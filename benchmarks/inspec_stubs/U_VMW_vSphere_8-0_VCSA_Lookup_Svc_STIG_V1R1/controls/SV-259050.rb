...
Centralized management of log records provides for efficiency in maintenance and management of records, as well as the backup and archiving of those records. Application servers and their related components are required to offload log records onto a different system or media than the system being logged.'
  desc 'check', 'By default, a vmware-services-lookupsvc.conf rsyslog configuration file that includes the service logs when syslog is configured on vCenter, but it must be verified.
...
input(type="imfile"
  ...
  tag check_id: 'C-62790r934806_chk'
  tag severity: 'medium'
  tag gid: 'V-259050'
  tag rid: 'SV-259050r934808_rule'
  tag stig_id: 'VCLU-80-000081'
  tag gtitle: 'SRG-APP-000358-AS-000064'
  tag fix_id: 'F-62699r934807_fix'
  tag 'documentable'
  tag cci: ['CCI-001851']
  tag nist: ['AU-4 (1)']
end
