...
d) If any item in (b) is untrue, this is a finding.'
  desc 'fix', "The systems programmer will have the ISSO  ensure that all update and alter access to MQSeries/WebSphere MQ product and system data sets are restricted to WebSphere MQ administrators, systems programmers, and MQSeries/WebSphere MQ started tasks.
...
(5)	Allocate access to all archive data sets in the queue manager's procedure will be restricted to the queue manager userid, WebSphere MQ administrator, and systems programming personnel. Log all allocate access to these data sets."
  ...
  tag check_id: 'C-27329r868774_chk'
  tag severity: 'medium'
  tag gid: 'V-225628'
  tag rid: 'SV-225628r868776_rule'
  tag stig_id: 'ZWMQ0040'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-27317r868775_fix'
  tag 'documentable'
  tag legacy: ['SV-3905', 'V-3905']
  tag cci: ['CCI-000213', 'CCI-001499', 'CCI-002234']
  tag nist: ['AC-3', 'CM-5 (6)', 'AC-6 (9)']
end
