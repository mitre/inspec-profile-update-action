...
___ Repeat the above step for each queue manager ssid identified.'
  desc 'fix', %q(The system programmer and the ISSO will review the WebSphere MQ Screen interface invoked by the REXX CSQOREXX. Reviewing the channel's SSLCIPH setting.
...
Repeat these steps for each queue manager ssid identified.)
  ...
  tag check_id: 'C-27324r868766_chk'
  tag severity: 'high'
  tag gid: 'V-225623'
  tag rid: 'SV-225623r868768_rule'
  tag stig_id: 'ZWMQ0011'
  tag gtitle: 'SRG-OS-000033'
  tag fix_id: 'F-27312r868767_fix'
  tag satisfies: ['SRG-OS-000505', 'SRG-OS-000555']
  tag 'documentable'
  tag legacy: ['SV-7259', 'V-6958']
