control 'SV-77433' do
  ...
  desc 'check', 'Verify that RiOS is configured to employ automated mechanisms to centrally manage authentication settings.
...
If no servers exist in "TACACS+ Servers" or "RADIUS Servers", this is a finding.'
  desc 'fix', 'Configure RiOS to employ automated mechanisms to centrally manage authentication settings.
...
Navigate to the top of the web page and click "Save" to save these settings permanently'
  ...
  tag check_id: 'C-63695r1_chk'
  tag severity: 'medium'
  tag gid: 'V-62943'
  tag rid: 'SV-77433r1_rule'
  tag stig_id: 'RICX-DM-000092'
  tag gtitle: 'SRG-APP-000516-NDM-000336'
  tag fix_id: 'F-68861r1_fix'
  tag 'documentable'
