control 'SV-77435' do
  ...
  desc 'check', 'Verify that RiOS is configured to employ automated mechanisms to centrally apply authentication settings.
...
If no servers exist in "TACACS+ Servers" or "RADIUS Servers", this is a finding.'
  desc 'fix', 'Configure RiOS to employ automated mechanisms to centrally apply authentication settings.
...
Navigate to the top of the web page and click "Save" to save these settings permanently'
  ...
  tag check_id: 'C-63697r1_chk'
  tag severity: 'medium'
  tag gid: 'V-62945'
  tag rid: 'SV-77435r1_rule'
  tag stig_id: 'RICX-DM-000093'
  tag gtitle: 'SRG-APP-000516-NDM-000337'
  tag fix_id: 'F-68863r1_fix'
  tag 'documentable'
