control 'SV-77471' do
  ...
  desc 'check', 'Verify that RiOS is configured to implement cryptographic mechanisms to protect the integrity of nonlocal maintenance and diagnostic communications.
...
If any one of the above settings is missing from the configuration, this is a finding.'
  desc 'fix', 'Configure RiOS to implement cryptographic mechanisms to protect the integrity of nonlocal maintenance and diagnostic communications.
...
Type: exit'
  ...
  tag check_id: 'C-63733r1_chk'
  tag severity: 'medium'
  tag gid: 'V-62981'
  tag rid: 'SV-77471r1_rule'
  tag stig_id: 'RICX-DM-000134'
  tag gtitle: 'SRG-APP-000411-NDM-000330'
  tag fix_id: 'F-68899r1_fix'
  tag 'documentable'
  tag cci: ['CCI-002890']
  tag nist: ['MA-4 (6)']
end
