...
Network devices providing a user interface to audit data will leverage user permissions and roles identifying the user accessing the data and the corresponding rights the user enjoys in order to make access decisions regarding the deletion of audit data.'
  desc 'check', 'Verify that RiOS is configured to protect audit information from unauthorized deletion.
...
If the control "Basic Diagnostics" is not set according to the authorization level of the user, this is a finding.'
  desc 'fix', 'Configure RiOS to protect audit information from unauthorized deletion.
...
Navigate to the top of the web page and click "Save" to write changes to memory'
  ...
  tag check_id: 'C-63679r1_chk'
  tag severity: 'medium'
  tag gid: 'V-62927'
  tag rid: 'SV-77417r1_rule'
  tag stig_id: 'RICX-DM-000063'
  tag gtitle: 'SRG-APP-000120-NDM-000237'
  tag fix_id: 'F-68845r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000164']
  tag nist: ['AU-9 a']
end
