...
___	The ACF2 data set access authorizations restrict WRITE and/or greater access to the product STC(s) and/or batch job(s).'
  desc 'fix', 'The ISSO will ensure that WRITE and/or greater access to IBM Integrated Crypto Service Facility (ICSF) STC data sets are limited to system programmers and ICSF STC and/or batch jobs only.  READ access can be given to auditors at the ISSOs discretion.
...
CSF.-	UID(audtaudt) R(A) E(A)'
  ...
  tag check_id: 'C-26002r520391_chk'
  tag severity: 'medium'
  tag gid: 'V-224325'
  tag rid: 'SV-224325r520393_rule'
  tag stig_id: 'ZICSA001'
  tag gtitle: 'SRG-OS-000259'
  tag fix_id: 'F-25990r520392_fix'
  tag 'documentable'
