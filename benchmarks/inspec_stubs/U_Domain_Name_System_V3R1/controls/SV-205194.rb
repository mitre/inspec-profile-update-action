...
If the name server is not configured to explicitly refuse queries asking for its version information, this is a finding.'
  ...
  impact 0.5
  ref 'DPMS Target DNS'
  tag check_id: 'C-5461r392495_chk'
  tag severity: 'medium'
  tag gid: 'V-205194'
  tag rid: 'SV-205194r879710_rule'
  tag stig_id: 'SRG-APP-000333-DNS-000104'
  tag gtitle: 'SRG-APP-000333'
  tag fix_id: 'F-5461r392496_fix'
  tag 'documentable'
  tag legacy: ['SV-69093', 'V-54847']
  tag cci: ['CCI-002201']
  tag nist: ['AC-4 (12)']
end
