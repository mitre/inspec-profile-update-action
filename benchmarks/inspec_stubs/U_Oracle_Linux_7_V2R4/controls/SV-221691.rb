...
'
  desc 'check', 'Verify the operating system automatically locks the root account until it is released by an administrator when three unsuccessful logon attempts in 15 minutes are made.
...
If the "even_deny_root" setting is not defined on both lines with the "pam_faillock.so" module, is commented out, or is missing from a line, this is a finding.'
  desc 'fix', 'Configure the operating system to lock automatically the root account until the locked account is released by an administrator when three unsuccessful logon attempts in 15 minutes are made.
...
Note: Manual changes to the listed files may be overwritten by the "authconfig" program. The "authconfig" program should not be used to update the configurations listed in this requirement.'
  ...
  tag check_id: 'C-23406r419145_chk'
  tag severity: 'medium'
  tag gid: 'V-221691'
  tag rid: 'SV-221691r603260_rule'
  tag stig_id: 'OL07-00-010330'
  tag gtitle: 'SRG-OS-000329-GPOS-00128'
  tag fix_id: 'F-23395r419146_fix'
