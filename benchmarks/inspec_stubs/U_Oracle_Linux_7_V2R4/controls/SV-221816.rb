...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-23531r419520_chk'
  tag severity: 'medium'
  tag gid: 'V-221816'
  tag rid: 'SV-221816r603260_rule'
  tag stig_id: 'OL07-00-030770'
  tag gtitle: 'SRG-OS-000042-GPOS-00020'
  tag fix_id: 'F-23520r419521_fix'
  tag satisfies: ['SRG-OS-000042-GPOS-00020', 'SRG-OS-000392-GPOS-00172']
  tag 'documentable'
  tag legacy: ['SV-108475', 'V-99371']
  tag cci: ['CCI-000135']
  tag nist: ['AU-3 (1)']
end
