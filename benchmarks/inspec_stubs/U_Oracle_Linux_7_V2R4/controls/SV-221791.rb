control 'SV-221791' do
  title 'The Oracle Linux operating system must audit all uses of the creat syscall.'
...
'
  desc 'check', 'Verify the operating system generates audit records when successful/unsuccessful attempts to use the "creat" syscall occur.
...
If the output does not produce a rule containing "-F exit=-EACCES", this is a finding.'
  desc 'fix', 'Configure the operating system to generate audit records when successful/unsuccessful attempts to use the "creat" syscall occur.
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-36308r602518_chk'
  tag severity: 'medium'
  tag gid: 'V-221791'
  tag rid: 'SV-221791r603260_rule'
  tag stig_id: 'OL07-00-030500'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-36272r602519_fix'
  tag satisfies: ['SRG-OS-000064-GPOS-00033', 'SRG-OS-000458-GPOS-00203', 'SRG-OS-000461-GPOS-00205', 'SRG-OS-000392-GPOS-00172']
  tag 'documentable'
  tag legacy: ['V-99321', 'SV-108425']
