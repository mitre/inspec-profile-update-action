control 'SV-221789' do
  title 'The Oracle Linux operating system must audit all uses of the fremovexattr syscall.'
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-36306r602512_chk'
  tag severity: 'medium'
  tag gid: 'V-221789'
  tag rid: 'SV-221789r603260_rule'
  tag stig_id: 'OL07-00-030480'
  tag gtitle: 'SRG-OS-000458-GPOS-00203'
  tag fix_id: 'F-36270r602513_fix'
  tag satisfies: ['SRG-OS-000458-GPOS-00203', 'SRG-OS-000392-GPOS-00172', 'SRG-OS-000064-GPOS-00033']
  tag 'documentable'
  tag legacy: ['SV-108421', 'V-99317']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
