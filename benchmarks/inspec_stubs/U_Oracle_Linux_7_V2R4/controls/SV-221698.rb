control 'SV-221698' do
  title 'Oracle Linux operating systems prior to version 7.2 with a Basic Input/Output System (BIOS) must require authentication upon booting into single-user and maintenance modes.'
...
# mv /tmp/grub2.cfg /boot/grub2/grub.cfg'
  ...
  tag check_id: 'C-23413r419166_chk'
  tag severity: 'high'
  tag gid: 'V-221698'
  tag rid: 'SV-221698r603260_rule'
  tag stig_id: 'OL07-00-010480'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-23402r419167_fix'
  tag 'documentable'
  tag legacy: ['SV-108239', 'V-99135']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
