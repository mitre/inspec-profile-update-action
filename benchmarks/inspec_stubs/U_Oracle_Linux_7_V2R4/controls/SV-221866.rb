...
If the option is not set or the line is commented out, this is a finding.'
  desc 'fix', 'Edit the "/etc/ntp.conf" or "/etc/chrony.conf" file and add or update an entry to define "maxpoll" to "10" as follows:
...
# systemctl start chronyd.service'
  ...
  tag check_id: 'C-36327r602575_chk'
  tag severity: 'medium'
  tag gid: 'V-221866'
  tag rid: 'SV-221866r603260_rule'
  tag stig_id: 'OL07-00-040500'
  tag gtitle: 'SRG-OS-000355-GPOS-00143'
  tag fix_id: 'F-36291r602576_fix'
