...
# sudo rpm -Uvh <packagename>'
  ...
  tag check_id: 'C-36265r602389_chk'
  tag severity: 'high'
  tag gid: 'V-221653'
  tag rid: 'SV-221653r603260_rule'
  tag stig_id: 'OL07-00-010020'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-36229r602390_fix'
  tag 'documentable'
  tag legacy: ['V-99047', 'SV-108151']
  tag cci: ['CCI-001749']
  tag nist: ['CM-5 (3)']
end
