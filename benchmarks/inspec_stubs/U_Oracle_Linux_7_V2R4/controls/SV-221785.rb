control 'SV-221785' do
  title 'The Oracle Linux operating system must audit all uses of the setxattr syscall.'
...
'
  desc 'check', 'Verify the operating system generates audit records when successful/unsuccessful attempts to use the "setxattr" syscall occur.
...
If both the "b32" and "b64" audit rules are not defined for the "setxattr" syscall, this is a finding.'
  desc 'fix', 'Configure the operating system to generate audit records when successful/unsuccessful attempts to use the "setxattr" syscall occur.
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-36302r602500_chk'
  tag severity: 'medium'
  tag gid: 'V-221785'
  tag rid: 'SV-221785r603260_rule'
  tag stig_id: 'OL07-00-030440'
  tag gtitle: 'SRG-OS-000458-GPOS-00203'
  tag fix_id: 'F-36266r602501_fix'
