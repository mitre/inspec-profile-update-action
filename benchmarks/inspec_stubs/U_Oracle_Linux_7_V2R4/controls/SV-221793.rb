control 'SV-221793' do
  title 'The Oracle Linux operating system must audit all uses of the openat syscall.'
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-36310r602524_chk'
  tag severity: 'medium'
  tag gid: 'V-221793'
  tag rid: 'SV-221793r603260_rule'
  tag stig_id: 'OL07-00-030520'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-36274r602525_fix'
  tag satisfies: ['SRG-OS-000064-GPOS-00033', 'SRG-OS-000458-GPOS-00203', 'SRG-OS-000461-GPOS-00205', 'SRG-OS-000392-GPOS-00172']
  tag 'documentable'
  tag legacy: ['SV-108429', 'V-99325']
