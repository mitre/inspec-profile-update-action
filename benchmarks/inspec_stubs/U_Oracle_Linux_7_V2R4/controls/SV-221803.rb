...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-23518r419481_chk'
  tag severity: 'medium'
  tag gid: 'V-221803'
  tag rid: 'SV-221803r603260_rule'
  tag stig_id: 'OL07-00-030630'
  tag gtitle: 'SRG-OS-000042-GPOS-00020'
  tag fix_id: 'F-23507r419482_fix'
  tag satisfies: ['SRG-OS-000042-GPOS-00020', 'SRG-OS-000392-GPOS-00172', 'SRG-OS-000471-GPOS-00215']
  tag 'documentable'
  tag legacy: ['SV-108449', 'V-99345']
  tag cci: ['CCI-000135']
  tag nist: ['AU-3 (1)']
end
