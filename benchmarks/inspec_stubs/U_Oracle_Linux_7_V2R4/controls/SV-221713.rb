...
blacklist dccp'
  ...
  tag check_id: 'C-36274r602416_chk'
  tag severity: 'medium'
  tag gid: 'V-221713'
  tag rid: 'SV-221713r603260_rule'
  tag stig_id: 'OL07-00-020101'
  tag gtitle: 'SRG-OS-000378-GPOS-00163'
  tag fix_id: 'F-36238r602417_fix'
  tag 'documentable'
  tag legacy: ['V-99165', 'SV-108269']
  tag cci: ['CCI-001958']
  tag nist: ['IA-3']
end
