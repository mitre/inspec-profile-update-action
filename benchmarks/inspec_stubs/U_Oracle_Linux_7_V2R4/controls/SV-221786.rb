control 'SV-221786' do
  title 'The Oracle Linux operating system must audit all uses of the fsetxattr syscall.'
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-36303r602503_chk'
  tag severity: 'medium'
  tag gid: 'V-221786'
  tag rid: 'SV-221786r603260_rule'
  tag stig_id: 'OL07-00-030450'
  tag gtitle: 'SRG-OS-000458-GPOS-00203'
  tag fix_id: 'F-36267r602504_fix'
  tag satisfies: ['SRG-OS-000458-GPOS-00203', 'SRG-OS-000392-GPOS-00172', 'SRG-OS-000064-GPOS-00033']
  tag 'documentable'
  tag legacy: ['V-99311', 'SV-108415']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
