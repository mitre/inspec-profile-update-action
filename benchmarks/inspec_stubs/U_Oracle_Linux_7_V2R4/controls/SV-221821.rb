control 'SV-221821' do
  title 'The Oracle Linux operating system must audit all uses of the init_module syscall.'
  desc 'Without generating audit records specific to the security and mission needs of the organization, it would be difficult to establish, correlate, and investigate the events relating to an incident or identify those responsible for one. 

Audit records can be generated from various components within the information system (e.g., module or policy filter).

'
  desc 'check', 'Verify the operating system generates audit records when successful/unsuccessful attempts to use the "init_module" syscall occur. 
...
If there are no audit rules defined for "init_module", this is a finding.'
  desc 'fix', 'Configure the operating system to generate audit records when successful/unsuccessful attempts to use the "init_module" syscall occur. 
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-23536r419535_chk'
  tag severity: 'medium'
  tag gid: 'V-221821'
  tag rid: 'SV-221821r603260_rule'
  tag stig_id: 'OL07-00-030820'
  tag gtitle: 'SRG-OS-000471-GPOS-00216'
  tag fix_id: 'F-23525r419536_fix'
