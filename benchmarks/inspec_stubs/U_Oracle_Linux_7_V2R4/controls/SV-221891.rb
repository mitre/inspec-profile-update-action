...
If either of these commands returns any output, this is a finding.'
  ...
  tag check_id: 'C-23606r419745_chk'
  tag severity: 'high'
  tag gid: 'V-221891'
  tag rid: 'SV-221891r603260_rule'
  tag stig_id: 'OL07-00-040800'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-23595r419746_fix'
  tag 'documentable'
  tag legacy: ['V-99521', 'SV-108625']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
