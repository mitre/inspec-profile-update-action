...
# systemctl restart sshd'
  ...
  tag check_id: 'C-23601r622275_chk'
  tag severity: 'medium'
  tag gid: 'V-221886'
  tag rid: 'SV-221886r603812_rule'
  tag stig_id: 'OL07-00-040710'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-23590r622276_fix'
  tag 'documentable'
  tag legacy: ['SV-108615', 'V-99511']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
