...
Select "OK" when the confirmation dialog appears.'
  ...
  tag check_id: 'C-31107r513911_chk'
  tag severity: 'medium'
  tag gid: 'V-228872'
  tag rid: 'SV-228872r831614_rule'
  tag stig_id: 'PANW-AG-000120'
  tag gtitle: 'SRG-NET-000392-ALG-000147'
  tag fix_id: 'F-31084r513912_fix'
  tag 'documentable'
  tag legacy: ['V-62625', 'SV-77115']
  tag cci: ['CCI-002664']
  tag nist: ['SI-4 (5)']
end
