...
Select "OK" when the confirmation dialog appears.'
  ...
  tag check_id: 'C-31091r513863_chk'
  tag severity: 'medium'
  tag gid: 'V-228856'
  tag rid: 'SV-228856r831596_rule'
  tag stig_id: 'PANW-AG-000080'
  tag gtitle: 'SRG-NET-000318-ALG-000014'
  tag fix_id: 'F-31068r513864_fix'
  tag 'documentable'
  tag legacy: ['SV-77083', 'V-62593']
  tag cci: ['CCI-002346']
  tag nist: ['AC-23']
end
