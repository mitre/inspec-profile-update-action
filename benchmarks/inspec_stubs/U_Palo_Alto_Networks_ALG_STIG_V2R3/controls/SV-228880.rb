control 'SV-228880' do
  ...
  desc 'check', 'If the protocol is not used in the implementation, this is not a finding.
...
If the "Profile" column does not display the "Vulnerability Protection Profile" symbol, this is a finding.'
  desc 'fix', %q(If FTP and FTPS is authorized for use in the site's System Security Plan (SSP), configure a security policy to allow it and inspect it.
...
Note: An Antivirus Profile and an Antispyware Profile are required.)
  ...
  tag check_id: 'C-31115r864180_chk'
  tag severity: 'medium'
  tag gid: 'V-228880'
  tag rid: 'SV-228880r864182_rule'
  tag stig_id: 'PANW-AG-000148'
  tag gtitle: 'SRG-NET-000512-ALG-000065'
  tag fix_id: 'F-31092r864181_fix'
  tag 'documentable'
  tag legacy: ['SV-77131', 'V-62641']
