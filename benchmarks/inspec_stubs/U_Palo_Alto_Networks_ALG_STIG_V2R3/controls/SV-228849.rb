control 'SV-228849' do
  ...
  desc 'Taking an appropriate action based on local organizational incident handling procedures minimizes the impact of this code on the network. This requirement is limited to ALGs web content filters and packet inspection firewalls that perform malicious code detection as part of their functionality.
...
Select "OK" when the confirmation dialog appears.'
  ...
  tag check_id: 'C-31084r513842_chk'
  tag severity: 'medium'
  tag gid: 'V-228849'
  tag rid: 'SV-228849r559739_rule'
  tag stig_id: 'PANW-AG-000063'
  tag gtitle: 'SRG-NET-000249-ALG-000145'
  tag fix_id: 'F-31061r573747_fix'
  tag 'documentable'
  tag legacy: ['SV-77071', 'V-62581']
  tag cci: ['CCI-001243']
  tag nist: ['SI-3 c 2']
end
