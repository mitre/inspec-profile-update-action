...
SFR ID: FMT_SMF_EXT.1.1 #47'
  desc 'check', 'Review the Honeywell Mobility Edge Android Pie devices Work Profile configuration settings to confirm that autofill services are disabled. 
 
This procedure is performed on both the MDM Administration console and the Honeywell Mobility Edge Android Pie devices device. 
...
If on the MDM console "Set auto (network) time required" is not set to "On", or on the Honeywell Android Pie device "Automatic date & time" is grayed out, this is a finding.'
  desc 'fix', 'Configure Honeywell Android Pie Work Profile to set auto network time.
...
On the MDM console, in the Android user restrictions section, set "Set auto (network) time required" to "On".'
  ...
  tag check_id: 'C-38247r623087_chk'
  tag severity: 'medium'
  tag gid: 'V-235059'
  tag rid: 'SV-235059r626530_rule'
  tag stig_id: 'HONW-09-010200'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-38210r623088_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
