control 'SV-254633' do
  title 'The Apple iOS/iPadOS 16 must be supervised by the MDM.'
...
- This method is usually only appropriate when MDM management of the DoD Apple device is not appropriate or an older device cannot be registered in ABM."
  ...
  tag check_id: 'C-58244r862153_chk'
  tag severity: 'medium'
  tag gid: 'V-254633'
  tag rid: 'SV-254633r862222_rule'
  tag stig_id: 'AIOS-16-013200'
  tag gtitle: 'PP-MDF-990000'
  tag fix_id: 'F-58190r862221_fix'
  tag 'documentable'
