control 'SV-254613' do
  title 'Apple iOS/iPadOS 16 must implement the management setting: Disable Allow Shared Albums.'
...
If "Allow Shared Albums" is not disabled in the Apple iOS/iPadOS management tool or the restrictions policy on the iPhone and iPad does not list "iCloud Photos not allowed", this is a finding.)
  ...
  tag check_id: 'C-58224r862093_chk'
  tag severity: 'medium'
  tag gid: 'V-254613'
  tag rid: 'SV-254613r862199_rule'
  tag stig_id: 'AIOS-16-011100'
  tag gtitle: 'PP-MDF-990000'
  tag fix_id: 'F-58170r862094_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
