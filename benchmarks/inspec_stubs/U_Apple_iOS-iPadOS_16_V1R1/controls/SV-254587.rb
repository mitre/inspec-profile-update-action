control 'SV-254587' do
  title 'Apple iOS/iPadOS 16 must [selection: remove Enterprise application, remove all noncore applications (any nonfactory-installed application)] upon unenrollment from MDM.'
...
If one or more managed apps are not set to be removed upon device MDM unenrollment, this is a finding.'
  ...
  tag check_id: 'C-58198r862015_chk'
  tag severity: 'medium'
  tag gid: 'V-254587'
  tag rid: 'SV-254587r862017_rule'
  tag stig_id: 'AIOS-16-005000'
  tag gtitle: 'PP-MDF-321410'
  tag fix_id: 'F-58144r862016_fix'
  tag 'documentable'
