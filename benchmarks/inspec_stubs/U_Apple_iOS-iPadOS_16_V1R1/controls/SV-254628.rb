control 'SV-254628' do
  title 'Apple iOS/iPadOS 16 must disable Password AutoFill in browsers and applications.'
...
If "Password AutoFill is not allowed" is not enabled both in the iOS/iPadOS management tool and on the Apple device, this is a finding.'
  ...
  tag check_id: 'C-58239r862138_chk'
  tag severity: 'medium'
  tag gid: 'V-254628'
  tag rid: 'SV-254628r862216_rule'
  tag stig_id: 'AIOS-16-012700'
  tag gtitle: 'PP-MDF-990000'
  tag fix_id: 'F-58185r862139_fix'
  tag 'documentable'
