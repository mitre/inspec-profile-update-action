control 'SV-254578' do
  title 'Apple iOS/iPadOS 16 must allow the Administrator (MDM) to perform the following management function: enable/disable VPN protection across the device and [selection: other methods].'
...
Note: This setting cannot be managed by the MDM administrator and is a User-Based Enforcement (UBE) requirement.'
  ...
  tag check_id: 'C-58189r861988_chk'
  tag severity: 'low'
  tag gid: 'V-254578'
  tag rid: 'SV-254578r862237_rule'
  tag stig_id: 'AIOS-16-001000'
  tag gtitle: 'PP-MDF-321090'
  tag fix_id: 'F-58135r861989_fix'
  tag 'documentable'
  tag cci: ['CCI-000366', 'CCI-000370', 'CCI-000066']
  tag nist: ['CM-6 b', 'CM-6 (1)', 'AC-17 e']
end
