control 'SV-254634' do
  title 'Apple iOS/iPadOS 16 must disable "Allow USB drive access in Files app" if the authorizing official (AO) has not approved the use of DoD-approved USB storage drives with iOS/iPadOS devices.'
...
If "Allow USB drive access in Files app" is not disabled in the management tool and "USB drives not accessible in Files app" is not listed in the Restrictions profile on the Apple device, this is a finding.'
  ...
  tag check_id: 'C-58245r862156_chk'
  tag severity: 'medium'
  tag gid: 'V-254634'
  tag rid: 'SV-254634r862224_rule'
  tag stig_id: 'AIOS-16-013300'
  tag gtitle: 'PP-MDF-990000'
  tag fix_id: 'F-58191r862157_fix'
  tag 'documentable'
