control 'SV-254612' do
  title 'Apple iOS/iPadOS 16 must implement the management setting: Disable Allow MailDrop.'
...
If "Allow MailDrop" is not disabled in the Apple iOS/iPadOS management tool or the restrictions policy on the iPhone and iPad lists "Mail Drop Enabled" as "Yes", this is a finding.'
  ...
  tag check_id: 'C-58223r862090_chk'
  tag severity: 'medium'
  tag gid: 'V-254612'
  tag rid: 'SV-254612r862198_rule'
  tag stig_id: 'AIOS-16-011000'
  tag gtitle: 'PP-MDF-990000'
  tag fix_id: 'F-58169r862091_fix'
  tag 'documentable'
