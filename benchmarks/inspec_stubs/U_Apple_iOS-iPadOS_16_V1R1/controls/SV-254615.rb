control 'SV-254615' do
  title 'Apple iOS/iPadOS 16 must implement the management setting: use SSL for Exchange ActiveSync.'
...
If "Use SSL" is unchecked in the Apple iOS/iPadOS management tool, "<key>SSL</key><false/>" appears in the configuration profile, or the Exchange policy on the iPhone and iPad has "SSL" set to "No", this is a finding.'
  ...
  tag check_id: 'C-58226r862099_chk'
  tag severity: 'medium'
  tag gid: 'V-254615'
  tag rid: 'SV-254615r862201_rule'
  tag stig_id: 'AIOS-16-011300'
  tag gtitle: 'PP-MDF-990000'
  tag fix_id: 'F-58172r862100_fix'
  tag 'documentable'
  tag cci: ['CCI-000764']
  tag nist: ['IA-2']
end
