control 'SV-254625' do
  title 'Apple iOS/iPadOS 16 must not allow unmanaged apps to read contacts from managed contacts accounts.'
...
If "Allow unmanaged apps to read contacts from managed contacts accounts" is checked in the iOS/iPadOS management tool or the restrictions policy on the iPhone and iPad lists "Allow unmanaged apps to read contacts from managed contacts accounts", this is a finding.'
  desc 'fix', 'Install a configuration profile to prevent unmanaged apps from reading contacts from managed contacts accounts.'
  impact 0.3
  ref 'DPMS Target Apple iOS-iPadOS 16'
  tag check_id: 'C-58236r862129_chk'
  tag severity: 'low'
  tag gid: 'V-254625'
  tag rid: 'SV-254625r862213_rule'
  tag stig_id: 'AIOS-16-012400'
  tag gtitle: 'PP-MDF-990000'
  tag fix_id: 'F-58182r862130_fix'
  tag 'documentable'
  tag cci: ['CCI-000366', 'CCI-000051', 'CCI-000370']
  tag nist: ['CM-6 b', 'AC-8 a', 'CM-6 (1)']
end
