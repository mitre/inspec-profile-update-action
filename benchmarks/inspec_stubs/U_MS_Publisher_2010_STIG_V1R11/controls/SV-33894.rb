control 'SV-33894' do
  ...
  desc 'check', "The policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2010 (Machine) -> Security Settings -> IE Security “Block popups” must be “Enabled” and ‘mspub.exe' is checked. 
...
Criteria: If the value mspub.exe  is REG_DWORD = 1, this is not a finding."
  desc 'fix', "Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2010 (Machine) -> Security Settings -> IE Security “Block popups” to “Enabled” and select ‘mspub.exe'."
  impact 0.5
  ref 'DPMS Target Microsoft Publisher 2010'
  tag check_id: 'C-34302r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17184'
  tag rid: 'SV-33894r1_rule'
  tag stig_id: 'DTOO129 - Publisher'
  tag gtitle: 'DTOO129 - Block Pop-Ups'
  tag fix_id: 'F-29965r1_fix'
  tag 'documentable'
