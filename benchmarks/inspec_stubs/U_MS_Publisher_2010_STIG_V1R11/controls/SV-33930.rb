control 'SV-33930' do
  ...
  desc 'check', 'The policy value for User Configuration -> Administrative Templates -> Microsoft Publisher 2010-> Security -> Trust Center “VBA Macro Notification Settings” must be “Enabled (Disabled all with notifications)”. 
...
Criteria: If the value VBAWarnings is REG_DWORD = 2, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft Publisher 2010-> Security -> Trust Center “VBA Macro Notification Settings” to “Enabled (Disabled all with notifications)”.'
  impact 0.5
  ref 'DPMS Target Microsoft Publisher 2010'
  tag check_id: 'C-34372r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17545'
  tag rid: 'SV-33930r1_rule'
  tag stig_id: 'DTOO304 - Publisher'
  tag gtitle: 'DTOO304 - VBA Macro Warning settings'
  tag fix_id: 'F-30008r1_fix'
  tag 'documentable'
