...
sed -i "/^[^#]*UMASK/ c\\UMASK 077" /etc/login.defs'
  ...
  tag check_id: 'C-43287r665329_chk'
  tag severity: 'medium'
  tag gid: 'V-240054'
  tag rid: 'SV-240054r879578_rule'
  tag stig_id: 'VRAU-HA-000105'
  tag gtitle: 'SRG-APP-000120-WSR-000070'
  tag fix_id: 'F-43246r665330_fix'
  tag 'documentable'
  tag legacy: ['SV-99795', 'V-89145']
  tag cci: ['CCI-000164']
  tag nist: ['AU-9 a']
end
