...
bind 0.0.0.0:443 ssl crt /etc/apache2/server.pem ciphers FIPS:+3DES:!aNULL no-sslv3'
  ...
  tag check_id: 'C-43319r665425_chk'
  tag severity: 'medium'
  tag gid: 'V-240086'
  tag rid: 'SV-240086r928837_rule'
  tag stig_id: 'VRAU-HA-000435'
  tag gtitle: 'SRG-APP-000439-WSR-000151'
  tag fix_id: 'F-43278r665426_fix'
  tag 'documentable'
  tag legacy: ['SV-99859', 'V-89209']
  tag cci: ['CCI-002418']
  tag nist: ['SC-8']
end
