...
Standard user accounts must not be members of the built-in Administrators group.'
  desc 'check', 'Review the Administrators group. Only the appropriate administrator groups or accounts responsible for administration of the system may be members of the group.
...
The built-in Administrator account or other required administrative accounts would not be a finding.'
  desc 'fix', 'Configure the system to include only administrator groups or accounts that are responsible for the system in the Administrators group.

Remove any standard user accounts.'
  impact 0.7
  ref 'DPMS Target Microsoft Windows Server 2012-2012 R2 DC'
  tag check_id: 'C-27940r476558_chk'
  tag severity: 'high'
  tag gid: 'V-226238'
  tag rid: 'SV-226238r794556_rule'
  tag stig_id: 'WN12-GE-000004-DC'
  tag gtitle: 'SRG-OS-000324-GPOS-00125'
  tag fix_id: 'F-27928r476559_fix'
  tag 'documentable'
  tag legacy: ['SV-51157', 'V-1127']
  tag cci: ['CCI-002235']
  tag nist: ['AC-6 (10)']
end
