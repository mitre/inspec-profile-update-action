control 'SV-68635' do
  title 'The ALG providing user access control intermediary services must display the Standard Mandatory DoD-approved Notice and Consent Banner before granting access to the network.'
...
If the ALG does not display the Standard Mandatory DoD-approved Notice and Consent Banner before granting access to the network, this is a finding.'
  desc 'fix', 'If user access control intermediary services are provided, configure the ALG to display the Standard Mandatory DoD-approved Notice and Consent Banner before granting access to the network.'
  impact 0.5
  ref 'DPMS Target SRG-NET-ALG'
  tag check_id: 'C-55005r1_chk'
  tag severity: 'medium'
  tag gid: 'V-54389'
  tag rid: 'SV-68635r1_rule'
  tag stig_id: 'SRG-NET-000041-ALG-000022'
  tag gtitle: 'SRG-NET-000041-ALG-000022'
  tag fix_id: 'F-59243r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
