control 'SV-68875' do
  title 'The ALG providing content filtering must protect against known and unknown types of Denial of Service (DoS) attacks by employing rate-based attack prevention behavior analysis.'
...
If the ALG does not protect against or limit the effects of known and unknown types of DoS attacks by employing rate-based attack prevention behavior analysis, this is a finding.'
  desc 'fix', 'If the ALG performs content filtering as part of the traffic management functionality, configure the ALG to protect against or limit the effects of known and unknown types of DoS attacks by employing rate-based attack prevention behavior analysis.'
  impact 0.5
  ref 'DPMS Target SRG-NET-ALG'
  tag check_id: 'C-55249r1_chk'
  tag severity: 'medium'
  tag gid: 'V-54629'
  tag rid: 'SV-68875r1_rule'
  tag stig_id: 'SRG-NET-000362-ALG-000112'
  tag gtitle: 'SRG-NET-000362-ALG-000112'
  tag fix_id: 'F-59485r1_fix'
  tag 'documentable'
  tag cci: ['CCI-002385']
  tag nist: ['SC-5 a']
end
