control 'SV-68661' do
  title 'The ALG providing user access control intermediary services must generate audit records when successful/unsuccessful logon attempts occur.'
...
If the ALG does not generate audit records when successful/unsuccessful logon attempts occur, this is a finding.'
  desc 'fix', 'If user access control intermediary services are provided, configure the ALG to generate audit records when successful/unsuccessful logon attempts occur.'
  impact 0.5
  ref 'DPMS Target SRG-NET-ALG'
  tag check_id: 'C-55381r1_chk'
  tag severity: 'medium'
  tag gid: 'V-54415'
  tag rid: 'SV-68661r1_rule'
  tag stig_id: 'SRG-NET-000503-ALG-000038'
  tag gtitle: 'SRG-NET-000503-ALG-000038'
  tag fix_id: 'F-59617r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
