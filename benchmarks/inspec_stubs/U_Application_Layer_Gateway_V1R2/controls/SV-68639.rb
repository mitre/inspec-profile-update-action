control 'SV-68639' do
  title 'The ALG providing user access control intermediary services for publicly accessible applications must display the Standard Mandatory DoD-approved Notice and Consent Banner before granting access to the system.'
...
If the ALG does not display the Standard Mandatory DoD-approved Notice and Consent Banner before granting access to the system, this is a finding.'
  desc 'fix', 'If user access control intermediary services are provided, configure the ALG to display the Standard Mandatory DoD-approved Notice and Consent Banner before granting access to the system.'
  impact 0.5
  ref 'DPMS Target SRG-NET-ALG'
  tag check_id: 'C-55009r1_chk'
  tag severity: 'medium'
  tag gid: 'V-54393'
  tag rid: 'SV-68639r1_rule'
  tag stig_id: 'SRG-NET-000043-ALG-000024'
  tag gtitle: 'SRG-NET-000043-ALG-000024'
  tag fix_id: 'F-59247r1_fix'
  tag 'documentable'
