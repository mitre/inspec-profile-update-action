control 'SV-68727' do
  title 'The ALG that is part of a CDS must uniquely identify and authenticate destination by organization, system, application, and/or individual for information transfer.'
...
If the ALG is not configured to uniquely identify and authenticate destination by organization, system, application, and/or individual for information transfer, this is a finding.'
  desc 'fix', 'If the ALG is part of a CDS, configure the ALG to uniquely identify and authenticate destination by organization, system, application, and/or individual for information transfer.'
  impact 0.5
  ref 'DPMS Target SRG-NET-ALG'
  tag check_id: 'C-55097r1_chk'
  tag severity: 'medium'
  tag gid: 'V-54481'
  tag rid: 'SV-68727r1_rule'
  tag stig_id: 'SRG-NET-000326-ALG-000076'
  tag gtitle: 'SRG-NET-000326-ALG-000076'
  tag fix_id: 'F-59335r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000366', 'CCI-002207']
