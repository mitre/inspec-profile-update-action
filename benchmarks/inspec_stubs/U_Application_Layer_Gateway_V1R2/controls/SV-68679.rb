control 'SV-68679' do
  title 'The ALG must off-load audit records onto a centralized log server in real time.'
...
This does not apply to audit logs generated on behalf of the device itself (management).'
  desc 'check', 'Verify the ALG off-loads audit records onto a centralized log server in real time.

If the ALG does not off-load onto a centralized log server in real time, this is a finding.'
  desc 'fix', 'Configure the ALG to off-load onto a centralized log server in real time.'
  impact 0.5
  ref 'DPMS Target SRG-NET-ALG'
  tag check_id: 'C-55049r2_chk'
  tag severity: 'medium'
  tag gid: 'V-54433'
  tag rid: 'SV-68679r1_rule'
  tag stig_id: 'SRG-NET-000511-ALG-000051'
  tag gtitle: 'SRG-NET-000511-ALG-000051'
  tag fix_id: 'F-59287r2_fix'
  tag 'documentable'
  tag cci: ['CCI-001851']
  tag nist: ['AU-4 (1)']
end
