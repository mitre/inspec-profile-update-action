control 'SV-213457' do
  ...
  desc 'Office apps, such as Word or Excel, will not be allowed to create child processes. This is a typical malware behavior, especially for macro-based attacks that attempt to use Office apps to launch or download malicious executables.'
...
Click "Show...". Set the Value name to "D4F940AB-401B-4EFC-AADC-AD5F3C50688A" and the Value to "1".'
  ...
  tag check_id: 'C-14682r820218_chk'
  tag severity: 'medium'
  tag gid: 'V-213457'
  tag rid: 'SV-213457r823083_rule'
  tag stig_id: 'WNDF-AV-000033'
  tag gtitle: 'SRG-APP-000210'
  tag fix_id: 'F-14680r823082_fix'
  tag 'documentable'
