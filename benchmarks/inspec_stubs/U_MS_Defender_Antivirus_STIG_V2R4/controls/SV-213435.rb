control 'SV-213435' do
  ...
  desc 'This policy setting configures behavior of samples submission when opt-in for MAPS telemetry is set. Possible options are:  
(0x0) Always prompt
...
Set the policy value for Computer Configuration >> Administrative Templates >> Windows Components >> Microsoft Defender Antivirus >> MAPS >> "Send file samples when further analysis is required" to "Enabled" and select "Send safe samples" from the drop-down box.'
  ...
  tag check_id: 'C-14660r820152_chk'
  tag severity: 'medium'
  tag gid: 'V-213435'
  tag rid: 'SV-213435r823042_rule'
  tag stig_id: 'WNDF-AV-000011'
  tag gtitle: 'SRG-APP-000210'
  tag fix_id: 'F-14658r823041_fix'
  tag 'documentable'
