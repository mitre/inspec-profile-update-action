control 'SV-213433' do
  ...
  desc 'This feature ensures the device checks in real time with the Microsoft Active Protection Service (MAPS) before allowing certain content to be run or accessed. If this feature is disabled, the check will not occur, which will lower the protection state of the device. 
...
Set the policy value for Computer Configuration >> Administrative Templates >> Windows Components >> Microsoft  Defender Antivirus >> MAPS >> "Configure the 'Block at First Sight' feature" to "Enabled".)
  ...
  tag check_id: 'C-14658r820146_chk'
  tag severity: 'medium'
  tag gid: 'V-213433'
  tag rid: 'SV-213433r823038_rule'
  tag stig_id: 'WNDF-AV-000009'
  tag gtitle: 'SRG-APP-000278'
  tag fix_id: 'F-14656r823037_fix'
  tag 'documentable'
