control 'SV-243086' do
  title 'The vCenter Server must configure all port groups to a value other than that of the native VLAN.'
  desc 'ESXi does not use the concept of native VLAN. Frames with VLAN specified in the port group will have a tag, but frames with VLAN not specified in the port group are not tagged and therefore will end up as belonging to native VLAN of the physical switch. 
...
Get-VDPortgroup "portgroup name" | Set-VDVlanConfiguration -VlanId "New VLAN#"'
  ...
  tag check_id: 'C-46361r816848_chk'
  tag severity: 'medium'
  tag gid: 'V-243086'
  tag rid: 'SV-243086r879887_rule'
  tag stig_id: 'VCTR-67-000018'
  tag gtitle: 'SRG-APP-000516'
  tag fix_id: 'F-46318r719500_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
