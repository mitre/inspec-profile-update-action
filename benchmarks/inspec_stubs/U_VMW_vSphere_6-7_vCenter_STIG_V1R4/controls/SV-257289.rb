control 'SV-257289' do
  title 'The version of vCenter running on the system must be a supported version.'
...
The application will be configured to check for and install security-relevant software updates within an identified time period from the availability of the update. The specific time period will be defined by an authoritative source (e.g., IAVM, CTOs, DTMs, and STIGs).'
  desc 'check', 'vCenter 6.7 is no longer supported by the vendor. If the system is running vCenter 6.7, this is a finding.'
  desc 'fix', 'Upgrade to a supported version.'
  impact 0.7
  ref 'DPMS Target VMware vSphere 6.7 vCenter'
  tag check_id: 'C-60973r919013_chk'
  tag severity: 'high'
  tag gid: 'V-257289'
  tag rid: 'SV-257289r919288_rule'
  tag stig_id: 'VCTR-67-000999'
