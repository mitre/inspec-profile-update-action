control 'SV-214012' do
  title 'SQL Server must generate audit records when successful and unsuccessful attempts to delete categorized information (e.g., classification levels/security levels) occur.'
...
'
  desc 'check', %q(Review the system documentation to determine if SQL Server is required to audit when data classifications are successfully andn unsuccessfully deleted.
...
If the "SCHEMA_OBJECT_ACCESS_GROUP" is not returned in an active audit, this is a finding.)
  desc 'fix', 'Deploy an audit to audit when data classifications are unsuccessfully deleted. See the supplemental file "SQL 2016 Audit.sql".'
  impact 0.5
  ref 'DPMS Target MS SQL Server 2016 Instance'
  tag check_id: 'C-15229r902999_chk'
  tag severity: 'medium'
  tag gid: 'V-214012'
  tag rid: 'SV-214012r903000_rule'
  tag stig_id: 'SQL6-D0-014600'
  tag gtitle: 'SRG-APP-000502-DB-000349'
  tag fix_id: 'F-15227r313820_fix'
  tag satisfies: ['SRG-APP-000502-DB-000348']
  tag 'documentable'
  tag legacy: ['SV-93991', 'V-79285']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
