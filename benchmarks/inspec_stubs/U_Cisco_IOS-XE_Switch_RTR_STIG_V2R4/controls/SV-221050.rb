control 'SV-221050' do
  title 'The Cisco PE switch must be configured to enforce a Quality-of-Service (QoS) policy to provide preferred treatment for mission-critical applications.'
...
SW1(config-if)#end'
  ...
  tag check_id: 'C-22765r917443_chk'
  tag severity: 'low'
  tag gid: 'V-221050'
  tag rid: 'SV-221050r917445_rule'
  tag stig_id: 'CISC-RT-000760'
  tag gtitle: 'SRG-NET-000193-RTR-000113'
  tag fix_id: 'F-22754r917444_fix'
  tag 'documentable'
