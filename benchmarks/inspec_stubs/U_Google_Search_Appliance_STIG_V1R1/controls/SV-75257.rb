...
In the "Static Routes" field, ensure the required static routes are entered with one route per line.

If proper destination host or network IP address, netmask, and destination gateway for a particular static route are entered, this is not a finding.'
...
Ensure that the destination host or network IP address, netmask, and destination gateway for a particular static route are entered on one line with a space between each part of the route.

Click Update Setting and Perform Diagnostics.'
  impact 0.5
  ref 'DPMS Target Google Search Appliance v3.1'
  tag check_id: 'C-61729r1_chk'
  tag severity: 'medium'
  tag gid: 'V-60805'
  tag rid: 'SV-75257r1_rule'
  tag stig_id: 'GSAP-00-001045'
  tag gtitle: 'SRG-APP-000516'
  tag fix_id: 'F-66487r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
