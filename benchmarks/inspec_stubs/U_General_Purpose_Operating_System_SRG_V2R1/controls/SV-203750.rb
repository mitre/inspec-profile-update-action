control 'SV-203750' do
  title '[[[MISSING SEVERITY FROM BENCHMARK]]] The operating system must maintain the confidentiality and integrity of information during preparation for transmission.'
