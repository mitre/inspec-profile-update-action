...
-Shell program specified as "/bin/sh"'
  ...
  tag check_id: 'C-25533r868911_chk'
  tag severity: 'medium'
  tag gid: 'V-223860'
  tag rid: 'SV-223860r868913_rule'
  tag stig_id: 'RACF-US-000230'
  tag gtitle: 'SRG-OS-000104-GPOS-00051'
  tag fix_id: 'F-25521r868912_fix'
  tag 'documentable'
  tag legacy: ['SV-107531', 'V-98427']
  tag cci: ['CCI-000764']
  tag nist: ['IA-2']
end
