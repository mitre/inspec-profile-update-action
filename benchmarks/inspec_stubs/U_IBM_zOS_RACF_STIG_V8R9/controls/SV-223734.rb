control 'SV-223734' do
  title 'IBM RACF permission bits and user audit bits for HFS objects that are part of the FTP server component must be properly configured.'
...
chaudit w=sf,rx+f /etc/ftp.banner'
  ...
  tag check_id: 'C-25407r514890_chk'
  tag severity: 'medium'
  tag gid: 'V-223734'
  tag rid: 'SV-223734r604139_rule'
  tag stig_id: 'RACF-FT-000020'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25395r514891_fix'
  tag 'documentable'
  tag legacy: ['V-98175', 'SV-107279']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
