control 'SV-224379' do
  title 'The BlackBerry UEM server must be configured to leverage the MDM platform user accounts and groups for BlackBerry UEM server user identification and CAC authentication.'
...
10. Restart the UEM services on each server that hosts a UEM instance.'
  ...
  tag check_id: 'C-26056r539037_chk'
  tag severity: 'medium'
  tag gid: 'V-224379'
  tag rid: 'SV-224379r604136_rule'
  tag stig_id: 'BUEM-00-000700'
  tag gtitle: 'PP-MDM-414002'
  tag fix_id: 'F-26044r539038_fix'
  tag 'documentable'
  tag legacy: ['SV-111875', 'V-102913']
  tag cci: ['CCI-000015']
  tag nist: ['AC-2 (1)']
end
