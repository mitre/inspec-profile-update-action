control 'SV-224374' do
  title 'The BlackBerry UEM server or platform must be configured to initiate a session lock after a 15-minute period of inactivity.'
...
5. Select "Save".'
  ...
  tag check_id: 'C-26051r539022_chk'
  tag severity: 'medium'
  tag gid: 'V-224374'
  tag rid: 'SV-224374r604136_rule'
  tag stig_id: 'BUEM-00-000460'
  tag gtitle: 'PP-MDM-411047'
  tag fix_id: 'F-26039r539023_fix'
  tag 'documentable'
  tag legacy: ['SV-111865', 'V-102903']
  tag cci: ['CCI-000057']
  tag nist: ['AC-11 a']
end
