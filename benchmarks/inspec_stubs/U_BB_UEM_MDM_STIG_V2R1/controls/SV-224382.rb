...
If there is not a host-based firewall present on the BlackBerry UEM server platform, this is a finding.'
  ...
  tag check_id: 'C-26059r539046_chk'
  tag severity: 'medium'
  tag gid: 'V-224382'
  tag rid: 'SV-224382r604136_rule'
  tag stig_id: 'BUEM-00-200010'
  tag gtitle: 'PP-MDM-431005'
  tag fix_id: 'F-26047r539047_fix'
  tag satisfies: ['SRG-APP-000142']
  tag 'documentable'
  tag legacy: ['SV-111881', 'V-102919']
  tag cci: ['CCI-000382']
  tag nist: ['CM-7 b']
end
