control 'SV-224386' do
  title 'The BlackBerry UEM server must connect to [assignment: [SQL Server]] with an authenticated and secure (encrypted) connection to protect the confidentiality and integrity of transmitted information.'
...
If the SQL server has not been configured to connect to UEM using the TLS connection, this is a finding.'
  ...
  tag check_id: 'C-26063r539058_chk'
  tag severity: 'medium'
  tag gid: 'V-224386'
  tag rid: 'SV-224386r604136_rule'
  tag stig_id: 'BUEM-00-200060'
  tag gtitle: 'PP-MDM-431009'
  tag fix_id: 'F-26051r539059_fix'
  tag satisfies: ['PP-MDM-431009 / SRG-APP-000439', 'SRG-APP-000440\n\nSFR ID: FMT_SMF.1.1(2) b / SC-8', 'SC-8 (1)', 'SC-8 (2)']
  tag 'documentable'
  tag legacy: ['SV-111889', 'V-102927']
