control 'SV-224377' do
  title 'The BlackBerry UEM server must be configured to have at least one user in the following Administrator roles: Server primary administrator, security configuration administrator, device user group administrator, or auditor.'
  desc 'Having several administrative roles for the BlackBerry UEM server supports separation of duties. This allows administrator-level privileges to be granted granularly, such as giving application management privileges to one group and security policy privileges to another group. This helps prevent administrators from intentionally or inadvertently altering other settings and configurations they may not understand or approve of, which can weaken overall security and increase the risk of compromise.
...
Note: The intent of the requirement is that separate people perform each administrator role. The exact name of the role is not important.'
  ...
  tag check_id: 'C-26054r539031_chk'
  tag severity: 'medium'
  tag gid: 'V-224377'
  tag rid: 'SV-224377r604136_rule'
  tag stig_id: 'BUEM-00-000560'
  tag gtitle: 'PP-MDM-411058'
  tag fix_id: 'F-26042r539032_fix'
  tag 'documentable'
  tag legacy: ['SV-111871', 'V-102909']
  tag cci: ['CCI-002226', 'CCI-002227', 'CCI-000366']
  tag nist: ['AC-6 (5)', 'AC-6 (5)', 'CM-6 b']
end
