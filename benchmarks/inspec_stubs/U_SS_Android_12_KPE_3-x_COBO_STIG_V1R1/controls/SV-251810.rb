control 'SV-251810' do
  ...
  desc 'The biometric factor can be used to authenticate the user in order to unlock the mobile device. Unapproved/evaluated biometric mechanisms could allow unauthorized users to have access to DoD sensitive data if compromised. By not permitting the use of unapproved/evaluated biometric authentication mechanisms, this risk is mitigated.
...
On the management tool, in the device restrictions, set "Face" to "Disable".'
  ...
  tag check_id: 'C-55270r814184_chk'
  tag severity: 'medium'
  tag gid: 'V-251810'
  tag rid: 'SV-251810r814186_rule'
  tag stig_id: 'KNOX-12-110080'
  tag gtitle: 'PP-MDF-323110'
  tag fix_id: 'F-55224r814185_fix'
  tag 'documentable'
  tag cci: ['CCI-000767']
  tag nist: ['IA-2 (3)']
end
