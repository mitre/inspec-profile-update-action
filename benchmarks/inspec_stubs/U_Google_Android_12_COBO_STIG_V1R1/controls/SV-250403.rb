...
If the AO has approved the use of Bluetooth, and Bluetooth devices using unauthorized Bluetooth profiles are listed on the device under "Connected devices", this is a finding.'
  desc 'fix', 'Configure the Google Android 12 device to disable Bluetooth or if the AO has approved the use of Bluetooth (for example, for car hands-free use), train the user to connect to Only authorized Bluetooth devices using only HSP, HFP, or SPP Bluetooth capable devices (UBE).
...
The user training requirement is satisfied in requirement GOOG-12-009800.'
  ...
  tag check_id: 'C-53838r802756_chk'
  tag severity: 'low'
  tag gid: 'V-250403'
  tag rid: 'SV-250403r802758_rule'
  tag stig_id: 'GOOG-12-009400'
  tag gtitle: 'PP-MDF-323320'
  tag fix_id: 'F-53792r802757_fix'
  tag 'documentable'
