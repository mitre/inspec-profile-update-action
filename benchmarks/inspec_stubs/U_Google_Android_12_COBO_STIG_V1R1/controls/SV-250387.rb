...
SFR ID: FMT_SMF_EXT.1.1 #1b'
  desc 'check', 'Review managed Google Android 12 device configuration settings to determine if the mobile device is prohibiting passwords with more than two repeating or sequential characters.
...
Note: Alphabetic, Alphanumeric, and Complex are also acceptable selections, but these selections will cause the user to select a complex password, which is not required by the STIG.'
  desc 'fix', 'Configure the Google Android 12 device to prevent passwords from containing more than two repeating or sequential characters.
...
Note: Alphabetic, Alphanumeric, and Complex are also acceptable selections, but these selections will cause the user to select a complex password, which is not required by the STIG.'
  ...
  tag check_id: 'C-53822r802711_chk'
  tag severity: 'medium'
  tag gid: 'V-250387'
  tag rid: 'SV-250387r802713_rule'
  tag stig_id: 'GOOG-12-006100'
  tag gtitle: 'PP-MDF-323025'
  tag fix_id: 'F-53776r802712_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
