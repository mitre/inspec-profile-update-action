...
SFR ID: FMT_SMF_EXT.1.1 #8b'
  desc 'check', 'Review managed Google Android 12 device configuration settings to determine if the mobile device has an application allowlist configured and that the application allowlist does not include applications with the following characteristics:
...
If the EMM console device policy includes applications with unauthorized characteristics, this is a finding.'
  desc 'fix', 'Configure the Google Android 12 device application allowlist to exclude applications with the following characteristics:
...
2. Before selecting an app, review the app details and privacy policy to ensure the app does not include prohibited characteristics.'
  ...
  tag check_id: 'C-53828r796685_chk'
  tag severity: 'medium'
  tag gid: 'V-250393'
  tag rid: 'SV-250393r802792_rule'
  tag stig_id: 'GOOG-12-006700'
  tag gtitle: 'PP-MDF-323070'
  tag fix_id: 'F-53782r802791_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
