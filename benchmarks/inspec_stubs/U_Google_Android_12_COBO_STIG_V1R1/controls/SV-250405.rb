...
SFR ID: NA'
  desc 'check', 'Review a sample of site User Agreements for Google Android 12 device users or similar training records and training course content. 
...
If any Google Android 12 device user has not completed the required training, this is a finding.'
  desc 'fix', 'All Google Android 12 device users must complete training on the following training topics (users must acknowledge that they have reviewed training via a signed User Agreement or similar written record): 
...
- AO guidance on acceptable use and restrictions, if any, on downloading and installing personal apps and data (music, photos, etc.) in the Google device personal space.'
  ...
  tag check_id: 'C-53840r796721_chk'
  tag severity: 'medium'
  tag gid: 'V-250405'
  tag rid: 'SV-250405r802762_rule'
  tag stig_id: 'GOOG-12-009800'
  tag gtitle: 'PP-MDF-990000'
  tag fix_id: 'F-53794r796722_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
