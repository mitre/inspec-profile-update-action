control 'SV-235722' do
  title 'The list of domains for which Microsoft Defender SmartScreen will not trigger warnings must be allowlisted if used.'
...
If this policy is enabled, Microsoft Defender SmartScreen trusts these domains. If the policy is disabled or not set, default Microsoft Defender SmartScreen protection is applied to all resources.'
  desc 'check', %q(If this machine is on SIPRNet, this is Not Applicable.
...
If configured, the list of domains for which Microsoft Defender SmartScreen will not trigger warnings may be allowlisted.)
  desc 'fix', 'The policy value for "Computer Configuration/Administrative Templates/Microsoft Edge/SmartScreen settings/Configure the list of domains for which Microsoft Defender SmartScreen will not trigger warnings" may be set to "allow" for allowlisted domains.'
  impact 0.3
  ref 'DPMS Target Microsoft Edge'
  tag check_id: 'C-38941r863222_chk'
  tag severity: 'low'
  tag gid: 'V-235722'
  tag rid: 'SV-235722r863224_rule'
  tag stig_id: 'EDGE-00-000004'
  tag gtitle: 'SRG-APP-000073'
  tag fix_id: 'F-38904r863223_fix'
  tag 'documentable'
  tag cci: ['CCI-000870']
  tag nist: ['MA-3 (2)']
end
