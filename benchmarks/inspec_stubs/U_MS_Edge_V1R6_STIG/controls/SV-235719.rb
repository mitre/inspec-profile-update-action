...
- pac_script, the ProxyPacUrl and ProxyBypassList fields are used."
  desc 'check', 'The policy value for "Computer Configuration/Administrative Templates/Microsoft Edge/Proxy server/Proxy Settings" must be set to one of the following options: "ProxyMode", "ProxyPacUrl", "ProxyServer", or "ProxyBypassList".
...
If the REG_SZ value for "ProxySettings" is not set to one of the above selections, this is a finding.'
  desc 'fix', 'Set the policy value for "Computer Configuration/Administrative Templates/Microsoft Edge/Proxy server/Proxy Settings" to "ProxyMode", "ProxyPacUrl", "ProxyServer", or "ProxyBypassList".
...
If "ProxyMode" is selected, one of the following must also be set: "direct", "system", "auto_detect", "fixed_servers", or "pac_script".'
  ...
  tag check_id: 'C-38938r862944_chk'
  tag severity: 'low'
  tag gid: 'V-235719'
  tag rid: 'SV-235719r862946_rule'
  tag stig_id: 'EDGE-00-000001'
  tag gtitle: 'SRG-APP-000039'
  tag fix_id: 'F-38901r862945_fix'
  tag 'documentable'
  tag cci: ['CCI-001414']
  tag nist: ['AC-4']
end
