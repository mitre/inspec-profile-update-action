control 'SV-83303' do
  ...
  desc 'check', 'VMware support for ESX versions 3 and 4 ended 21 May 2016.  If ESX version 3 or 4 management software, such as VirtualCenter or vCenter, is installed on a system, this is a finding.'
  desc 'fix', 'Upgrade ESX version 3 and 4 management software to supported versions.'
  impact 0.7
  ref 'DPMS Target VMware VirtualCenter'
  tag check_id: 'C-69217r1_chk'
  tag severity: 'high'
  tag gid: 'V-68725'
  tag rid: 'SV-83303r1_rule'
  tag stig_id: 'ESX0005'
  tag gtitle: 'VMware ESX 3 and 4 Unsupported'
  tag fix_id: 'F-74847r2_fix'
  tag 'documentable'
end
