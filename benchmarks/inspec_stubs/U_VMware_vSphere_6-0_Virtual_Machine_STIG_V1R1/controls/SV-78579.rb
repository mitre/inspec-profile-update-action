control 'SV-78579' do
  ...
  desc 'check', 'From the vSphere Client select the Virtual Machine right click and go to Edit Settings >> VM Options Tab >> Advanced >> Configuration Parameters.  Find the isolation.tools.guestDnDVersionSet.disable value and verify it is set to true.
...
Get-VM "VM Name" | Get-AdvancedSetting -Name isolation.tools.guestDnDVersionSet.disable | Set-AdvancedSetting -Value true'
  ...
  tag check_id: 'C-64839r1_chk'
  tag severity: 'low'
  tag gid: 'V-64089'
  tag rid: 'SV-78579r1_rule'
  tag stig_id: 'VMCH-06-000026'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-70017r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
