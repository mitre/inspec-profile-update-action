control 'SV-78591' do
  ...
  desc 'check', 'From the vSphere Client select the Virtual Machine right click and go to Edit Settings.  Review the VMs hardware and verify no USB devices exist.
...
If a virtual machine has any USB devices or USB controllers present, this is a finding.'
  desc 'fix', 'From the vSphere Client select the Virtual Machine right click and go to Edit Settings.  Select the USB controller and click remove then OK.
...
Note:  This will not remove the USB controller just any connected devices.'
  ...
  tag check_id: 'C-64851r1_chk'
  tag severity: 'medium'
  tag gid: 'V-64101'
  tag rid: 'SV-78591r1_rule'
  tag stig_id: 'VMCH-06-000032'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-70029r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
