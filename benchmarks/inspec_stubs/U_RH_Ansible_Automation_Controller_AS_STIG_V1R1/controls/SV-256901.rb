...
'
  desc 'check', 'Administrator must check, for each Automation Controller host, the rsyslog configuration to verify the log rollover against a organizationally defined log capture size.
...
Check LOG_AGGREGATOR_MAX_DISK_USAGE_PATH field in the Automation Controller configuration for the log file location to "/var/log/awx".

On the host, execute:
awx-manage print_settings LOG_AGGREGATOR_MAX_DISK_USAGE_PATH 

If this field is not set to "/var/log/awx", this is a finding.'
...
Click "PUT".)
  ...
  tag check_id: 'C-60576r902271_chk'
  tag severity: 'medium'
  tag gid: 'V-256901'
  tag rid: 'SV-256901r903513_rule'
  tag stig_id: 'APAS-AT-000031'
  tag gtitle: 'SRG-APP-000109-AS-000068'
  tag fix_id: 'F-60518r903513_fix'
