control 'SV-228618' do
  title 'Google Android 11 must be configured to disable USB mass storage mode.'
...
If the EMM console device policy is not set to disable USB mass storage mode or on the Android 11 device, the device policy is not set to disable USB mass storage mode, this is a finding.'
  desc 'fix', 'Configure the Google Android 11 device to disable USB mass storage mode.
...
2. Toggle "Disallow USB file transfer".'
  ...
  tag check_id: 'C-30853r505851_chk'
  tag severity: 'medium'
  tag gid: 'V-228618'
  tag rid: 'SV-228618r619923_rule'
  tag stig_id: 'GOOG-11-003500'
  tag gtitle: 'PP-MDF-301210'
  tag fix_id: 'F-30830r505852_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
