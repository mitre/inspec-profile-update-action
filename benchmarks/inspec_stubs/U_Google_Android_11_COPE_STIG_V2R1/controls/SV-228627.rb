control 'SV-228627' do
  title 'Google Android 11 must be configured to enforce that Wi-Fi Sharing is disabled.'
...
If on the Google Android 11 device "Wi-Fi sharing" is enabled, this is a finding.'
  desc 'fix', 'Configure Google Android 11 device to disable Wi-Fi Sharing. 
...
2. Toggle "Disallow config tethering" to On.'
  ...
  tag check_id: 'C-30862r505878_chk'
  tag severity: 'medium'
  tag gid: 'V-228627'
  tag rid: 'SV-228627r619923_rule'
  tag stig_id: 'GOOG-11-008800'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-30839r505879_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
