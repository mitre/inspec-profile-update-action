control 'SV-221644' do
  title 'The Workspace ONE UEM server must be configured to leverage the MDM platform user and administrator accounts and groups for Workspace ONE UEM server user identification and authentication.'
...
SFR ID: FIA'
  desc 'check', %q(Review the configuration steps necessary to leverage MDM platform user and administrator accounts and groups for Workspace ONE UEM server user identification and authentication:
...
Exception: One local "Emergency" account may remain.)
  desc 'fix', %q(Configure the Workspace ONE UEM server to leverage the MDM platform user and administrator accounts and groups for Workspace ONE UEM server user identification and authentication.
...
Exception: One local "Emergency" account may remain.)
  ...
  tag check_id: 'C-23359r805063_chk'
  tag severity: 'medium'
  tag gid: 'V-221644'
  tag rid: 'SV-221644r807444_rule'
  tag stig_id: 'VMW1-00-000620'
  tag gtitle: 'PP-MDM-414002'
  tag fix_id: 'F-23348r807443_fix'
  tag 'documentable'
  tag legacy: ['SV-111287', 'V-102331']
  tag cci: ['CCI-000015']
  tag nist: ['AC-2 (1)']
end
