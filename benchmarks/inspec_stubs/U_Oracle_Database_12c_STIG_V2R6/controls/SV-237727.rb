...
PASSWORD_REUSE_MAX is effective if and only if PASSWORD_REUSE_TIME is specified, so if both are UNLIMITED, this is a finding."
...
ALTER PROFILE PPPPPP LIMIT PASSWORD_REUSE_MAX 5 PASSWORD_REUSE_TIME 5;'
  ...
  tag check_id: 'C-40946r667211_chk'
  tag severity: 'medium'
  tag gid: 'V-237727'
  tag rid: 'SV-237727r667213_rule'
  tag stig_id: 'O121-C2-014000'
  tag gtitle: 'SRG-APP-000164-DB-000401'
  tag fix_id: 'F-40909r667212_fix'
  tag 'documentable'
  tag legacy: ['V-61721', 'SV-76211']
  tag cci: ['CCI-000200']
  tag nist: ['IA-5 (1) (e)']
end
