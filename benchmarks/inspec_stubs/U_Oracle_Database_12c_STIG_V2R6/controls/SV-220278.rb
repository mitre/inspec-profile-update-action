...
Modification of database audit data could mask the theft of, or the unauthorized modification of, sensitive data stored in the database.'
  desc 'check', "Review locations of audit logs, both internal to the database and database audit logs located at the operating system-level. Verify there are appropriate controls and permissions to protect the audit information from unauthorized modification.
...
Apply the same process used in standard auditing to the tables with AUDSYS as the owner.)
  ...
  tag check_id: 'C-21993r391965_chk'
  tag severity: 'medium'
  tag gid: 'V-220278'
  tag rid: 'SV-220278r395823_rule'
  tag stig_id: 'O121-C2-009400'
  tag gtitle: 'SRG-APP-000119-DB-000060'
  tag fix_id: 'F-21985r391966_fix'
  tag 'documentable'
  tag legacy: ['SV-76145', 'V-61655']
  tag cci: ['CCI-000163']
  tag nist: ['AU-9 a']
end
