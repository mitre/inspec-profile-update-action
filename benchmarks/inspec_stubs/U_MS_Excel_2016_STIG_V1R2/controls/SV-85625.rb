...
Criteria: If the value NoTBPromptUnsignedAddin is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft Excel 2016 -> Excel Options -> Security -> Trust Center "Disable Trust Bar Notification for unsigned application add-ins and block them" to "Enabled".'
  impact 0.5
  ref 'DPMS Target Microsoft Excel 2016'
  tag check_id: 'C-71429r2_chk'
  tag severity: 'medium'
  tag gid: 'V-71001'
  tag rid: 'SV-85625r1_rule'
  tag stig_id: 'DTOO131'
  tag gtitle: 'SRG-APP-000131'
  tag fix_id: 'F-77333r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001749']
  tag nist: ['CM-5 (3)']
end
