control 'SV-86263' do
  ...
  desc 'check', 'Verify the policy value for User Configuration -> Administrative Templates -> Microsoft Excel 2016 -> Excel Options -> Security -> Trust Center -> Protected View "Open files on local Intranet UNC in Protected View" is set to "Enabled".
...
Criteria: If the value DisableIntranetCheck is REG_DWORD = 0, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft Excel 2016 -> Excel Options -> Security -> Trust Center -> Protected View "Open files on local Intranet UNC in Protected View" to "Enabled".'
  impact 0.5
  ref 'DPMS Target Microsoft Excel 2016'
  tag check_id: 'C-71969r1_chk'
  tag severity: 'medium'
  tag gid: 'V-71639'
  tag rid: 'SV-86263r1_rule'
  tag stig_id: 'DTOO605'
  tag gtitle: 'SRG-APP-000210'
  tag fix_id: 'F-77965r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001170']
  tag nist: ['SC-18 (4)']
end
