...
If the Cisco ISE password policy is not configured to require at least eight for the password delta or is not available in this revision of the ISE, this is a finding.'
  desc 'fix', 'Configure the password policy.

password-policy password-delta 8

Note: this feature may not be available in later revisions of the ISE.'
  impact 0.5
  ref 'DPMS Target Cisco ISE NDM'
  tag check_id: 'C-45925r822760_chk'
  tag severity: 'medium'
  tag gid: 'V-242650'
  tag rid: 'SV-242650r822762_rule'
  tag stig_id: 'CSCO-NM-000450'
  tag gtitle: 'SRG-APP-000170-NDM-000329'
  tag fix_id: 'F-45882r822761_fix'
  tag 'documentable'
  tag cci: ['CCI-000195']
  tag nist: ['IA-5 (1) (b)']
end
