control 'SV-215531' do
  ...
  desc 'check', %q(Verify the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2016 (Machine) -> Security Settings -> IE Security "Saved from URL" is set to "Enabled" and 'groove.exe' is checked.
...
Criteria: If the value groove.exe is REG_DWORD = 1, this is not a finding.)
  desc 'fix', %q(Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2016 (Machine) -> Security Settings -> IE Security "Saved from URL" to "Enabled" and place a check in the 'groove.exe' check box.)
  impact 0.5
  ref 'DPMS Target Microsoft OneDrive'
  tag check_id: 'C-16726r312211_chk'
  tag severity: 'medium'
  tag gid: 'V-215531'
  tag rid: 'SV-215531r879630_rule'
  tag stig_id: 'DTOO117'
  tag gtitle: 'SRG-APP-000210'
  tag fix_id: 'F-16724r312212_fix'
  tag 'documentable'
  tag legacy: ['SV-85927', 'V-71303']
  tag cci: ['CCI-001170']
  tag nist: ['SC-18 (4)']
end
