...
Value: 0x00000001 (1)'
  desc 'fix', 'Configure the policy value for User Configuration >> Administrative Templates >> OneDrive >> "Prevent users from syncing personal OneDrive accounts" to "Enabled". 
...
Copy the OneDrive.admx and .adml files to the \\Windows\\PolicyDefinitions and \\Windows\\PolicyDefinitions\\en-US directories respectively.'
  ...
  tag severity: 'medium'
  tag gid: 'V-230564'
  tag rid: 'SV-230564r918123_rule'
  tag stig_id: 'DTOO607'
  tag gtitle: 'SRG-APP-000141'
  tag fix_id: 'F-33208r918122_fix'
  tag 'documentable'
