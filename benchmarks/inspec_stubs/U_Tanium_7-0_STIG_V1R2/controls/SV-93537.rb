...
Navigate to: HKEY_LOCAL_MACHINE >> SOFTWARE >> Microsoft >> .NETFramework >> v4.0.xxxxx (the sub-version number may vary, but it is a 4.0 version; example: 4.0.30319)
...
Enter "1" in "Value data:" and ensure that under "Base" the "Hexadecimal" radio button is selected. Click "OK".)
  ...
  tag check_id: 'C-78409r1_chk'
  tag severity: 'medium'
  tag gid: 'V-78831'
  tag rid: 'SV-93537r1_rule'
  tag stig_id: 'TANS-SV-000105'
  tag gtitle: 'SRG-APP-000439'
  tag fix_id: 'F-85573r1_fix'
  tag 'documentable'
  tag cci: ['CCI-002418']
  tag nist: ['SC-8']
end
