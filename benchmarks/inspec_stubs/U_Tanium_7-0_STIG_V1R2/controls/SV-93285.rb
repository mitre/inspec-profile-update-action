...
The clients that have their Tanium Client directory "Not Restricted" will be displayed in the bottom window.
...
Click on "Show Client Status Details".'
  ...
  tag check_id: 'C-78149r1_chk'
  tag severity: 'medium'
  tag gid: 'V-78579'
  tag rid: 'SV-93285r1_rule'
  tag stig_id: 'TANS-CL-000002'
  tag gtitle: 'SRG-APP-000119'
  tag fix_id: 'F-85315r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000163']
  tag nist: ['AU-9 a']
end
