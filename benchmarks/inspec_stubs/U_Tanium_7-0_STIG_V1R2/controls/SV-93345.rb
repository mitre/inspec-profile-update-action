control 'SV-93345' do
  title 'Tanium must notify System Administrators and Information System Security Officers for account removal actions.'
  desc 'When application accounts are removed, user accessibility is affected. Accounts are used for identifying individual application users or for identifying the application processes themselves.
...
Work with the SIEM administrator to configure an alert when accounts are deleted.'
  ...
  tag check_id: 'C-78209r1_chk'
  tag severity: 'medium'
  tag gid: 'V-78639'
  tag rid: 'SV-93345r1_rule'
  tag stig_id: 'TANS-CN-000033'
  tag gtitle: 'SRG-APP-000294'
  tag fix_id: 'F-85375r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001686']
  tag nist: ['AC-2 (4)']
end
