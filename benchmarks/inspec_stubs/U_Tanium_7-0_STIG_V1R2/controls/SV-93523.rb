...
Navigate to: HKEY_LOCAL_MACHINE >> SYSTEM >> CurrentControlSet >> Control >> SecurityProviders >> SCHANNEL >> Protocols >> TLS 1.1 >> Server
...
Leave default value of "0" in "Value data:" and ensure that under "Base" the "Hexadecimal" radio button is selected. Click "OK".)
  ...
  tag check_id: 'C-78393r1_chk'
  tag severity: 'medium'
  tag gid: 'V-78817'
  tag rid: 'SV-93523r1_rule'
  tag stig_id: 'TANS-SV-000098'
  tag gtitle: 'SRG-APP-000439'
  tag fix_id: 'F-85559r1_fix'
  tag 'documentable'
  tag cci: ['CCI-002418']
  tag nist: ['SC-8']
end
