...
Vendor documentation can be downloaded from the following URL: https://docs.tanium.com/platform_install/platform_install/reference_smart_card_authentication.html.'
  ...
  tag check_id: 'C-78205r1_chk'
  tag severity: 'medium'
  tag gid: 'V-78635'
  tag rid: 'SV-93341r1_rule'
  tag stig_id: 'TANS-CN-000027'
  tag gtitle: 'SRG-APP-000148'
  tag fix_id: 'F-85371r1_fix'
  ...
  tag 'documentable'
  tag cci: ['CCI-000056', 'CCI-000166', 'CCI-000187', 'CCI-000764', 'CCI-000766', 'CCI-000768', 'CCI-000877', 'CCI-000879', 'CCI-001133', 'CCI-001941', 'CCI-001953', 'CCI-001954', 'CCI-002009', 'CCI-002010', 'CCI-002314', 'CCI-002322']
  tag nist: ['AC-11 b', 'AU-10', 'IA-5 (2) (a) (2)', 'IA-2', 'IA-2 (2)', 'IA-2 (4)', 'MA-4 c', 'MA-4 e', 'SC-10', 'IA-2 (8)', 'IA-2 (12)', 'IA-2 (12)', 'IA-8 (1)', 'IA-8 (1)', 'AC-17 (1)', 'AC-17 (9)']
end
