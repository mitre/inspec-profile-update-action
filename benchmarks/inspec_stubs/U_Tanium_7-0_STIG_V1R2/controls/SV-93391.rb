control 'SV-93391' do
  title 'The Tanium Server must be configured to prohibit or restrict the use of organization-defined functions, ports, protocols, and/or services, as defined in the PPSM CAL and vulnerability assessments.'
...
If any TCP ports are being used on the Tanium Server that have been deemed as restricted by the PPSM CAL, this is a finding.'
  ...
  tag check_id: 'C-78255r1_chk'
  tag severity: 'medium'
  tag gid: 'V-78685'
  tag rid: 'SV-93391r1_rule'
  tag stig_id: 'TANS-SV-000019'
  tag gtitle: 'SRG-APP-000142'
  tag fix_id: 'F-85421r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000382']
  tag nist: ['CM-7 b']
end
