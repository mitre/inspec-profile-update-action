control 'SV-239895' do
  title 'The Cisco ASA must generate an alert to organization-defined personnel and/or the firewall administrator when active propagation of malware or malicious code is detected.'
...
Step 4: Click Save.'
  ...
  tag check_id: 'C-43128r665996_chk'
  tag severity: 'medium'
  tag gid: 'V-239895'
  tag rid: 'SV-239895r665998_rule'
  tag stig_id: 'CASA-IP-000570'
  tag gtitle: 'SRG-NET-000392-IDPS-00219'
  tag fix_id: 'F-43087r665997_fix'
  tag 'documentable'
  tag cci: ['CCI-002664']
  tag nist: ['SI-4 (5)']
end
