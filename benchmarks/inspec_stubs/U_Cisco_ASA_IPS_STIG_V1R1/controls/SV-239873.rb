control 'SV-239873' do
  title 'The Cisco ASA must be configured to produce audit records containing sufficient information to establish what type of event occurred.'
...
Step 5: Click Save.'
  ...
  tag check_id: 'C-43106r665930_chk'
  tag severity: 'medium'
  tag gid: 'V-239873'
  tag rid: 'SV-239873r665932_rule'
  tag stig_id: 'CASA-IP-000040'
  tag gtitle: 'SRG-NET-000074-IDPS-00059'
  tag fix_id: 'F-43065r665931_fix'
  tag 'documentable'
  tag cci: ['CCI-000130']
  tag nist: ['AU-3 a']
end
