control 'SV-239891' do
  title 'The Cisco ASA must be configured to block outbound traffic containing unauthorized activities or conditions.'
...
If the ASA is not configured to block outbound traffic containing unauthorized activities or conditions, this is a finding.'
...
ASA1(config-pmap-c)# sfr fail-open'
  ...
  tag check_id: 'C-43124r665984_chk'
  tag severity: 'medium'
  tag gid: 'V-239891'
  tag rid: 'SV-239891r665986_rule'
  tag stig_id: 'CASA-IP-000510'
  tag gtitle: 'SRG-NET-000391-IDPS-00213'
  tag fix_id: 'F-43083r665985_fix'
  tag 'documentable'
  tag cci: ['CCI-002662']
  tag nist: ['SI-4 (4) (b)']
end
