control 'SV-24908' do
  title 'Execute permission should be revoked from PUBLIC for restricted Oracle packages.'
...
From SQL*Plus:
  ...
  tag check_id: 'C-26553r2_chk'
  tag severity: 'medium'
  tag gid: 'V-2539'
  tag rid: 'SV-24908r2_rule'
  tag stig_id: 'DO3475-ORACLE11'
  tag gtitle: 'Oracle PUBLIC access to restricted packages'
  tag fix_id: 'F-22841r1_fix'
  tag 'documentable'
