control 'SV-24513' do
  title 'The directories assigned to the LOG_ARCHIVE_DEST* parameters should be protected from unauthorized access.'
...
Restrict access to the Oracle process and software owner accounts, DBAs, and backup operator accounts.'
  ...
  tag check_id: 'C-29431r1_chk'
  tag severity: 'medium'
  tag gid: 'V-3854'
  tag rid: 'SV-24513r1_rule'
  tag stig_id: 'DO0238-ORACLE11'
  tag gtitle: 'Oracle LOG_ARCHIVE_DEST parameter'
  tag fix_id: 'F-26460r1_fix'
  tag 'documentable'
