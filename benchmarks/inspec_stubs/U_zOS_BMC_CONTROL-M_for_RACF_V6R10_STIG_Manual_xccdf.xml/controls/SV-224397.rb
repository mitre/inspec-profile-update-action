...
setr generic(dataset)"
  ...
  tag check_id: 'C-26074r868354_chk'
  tag severity: 'medium'
  tag gid: 'V-224397'
  tag rid: 'SV-224397r868356_rule'
  tag stig_id: 'ZCTMR000'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-26062r868355_fix'
  tag 'documentable'
  tag legacy: ['V-16932', 'SV-31898']
