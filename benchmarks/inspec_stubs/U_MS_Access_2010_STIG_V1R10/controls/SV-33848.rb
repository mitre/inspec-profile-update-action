control 'SV-33848' do
  ...
  desc 'check', 'The policy value for User Configuration -> Administrative Templates -> Microsoft Access 2010 -> Application Settings -> Security -> Trust Center “Require that application add-ins are signed by Trusted Publisher” must be set to “Enabled”.
...
Criteria: If the value RequireAddinSig is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft Access 2010 -> Application Settings -> Security -> Trust Center “Require that application add-ins are signed by Trusted Publisher” to “Enabled”.'
  impact 0.5
  ref 'DPMS Target Microsoft Access 2010'
  tag check_id: 'C-34188r1_chk'
  tag severity: 'medium'
  tag gid: 'V-26589'
  tag rid: 'SV-33848r1_rule'
  tag stig_id: 'DTOO127 - Access'
  tag gtitle: 'DTOO127 - Add-ins are signed by Trusted Publisher'
  tag fix_id: 'F-29877r1_fix'
  tag 'documentable'
