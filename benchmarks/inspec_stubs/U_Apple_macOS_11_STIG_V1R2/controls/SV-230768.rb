...
The SSH service must be restarted for changes to take effect.)
  ...
  tag check_id: 'C-33713r648706_chk'
  tag severity: 'medium'
  tag gid: 'V-230768'
  tag rid: 'SV-230768r599842_rule'
  tag stig_id: 'APPL-11-000055'
  tag gtitle: 'SRG-OS-000033-GPOS-00014'
  tag fix_id: 'F-33686r607566_fix'
  ...
  tag 'documentable'
  tag cci: ['CCI-000068', 'CCI-000087', 'CCI-000803', 'CCI-003123', 'CCI-002890']
  tag nist: ['AC-17 (2)', 'AC-19 e', 'IA-7', 'MA-4 (6)', 'MA-4 (6)']
end
