...
If the return is not an array which contains: “com.apple.preferences.AppleIDPrefPane”, this is a finding.'
  desc 'fix', 'This setting is enforced using the "Restrictions Policy" configuration profile.'
  impact 0.7
  ref 'DPMS Target Apple macOS 11'
  tag check_id: 'C-33753r607311_chk'
  tag severity: 'high'
  tag gid: 'V-230808'
  tag rid: 'SV-230808r599842_rule'
