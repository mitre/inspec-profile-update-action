...
'
  desc 'check', 'To check if the system has the correct setting in the configuration profile to disable access to the Internet Accounts preference pane, run the following command:
...
If the return is not an array which contains: "com.apple.preferences.internetaccounts", this is a finding.'
  ...
  tag check_id: 'C-33754r648710_chk'
  tag severity: 'medium'
  tag gid: 'V-230809'
  tag rid: 'SV-230809r599842_rule'
