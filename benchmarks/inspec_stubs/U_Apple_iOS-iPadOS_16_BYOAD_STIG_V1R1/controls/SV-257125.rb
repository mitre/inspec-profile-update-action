control 'SV-257125' do
  title 'Apple iOS/iPadOS 16 must implement the management setting: not allow messages in an ActiveSync Exchange account to be forwarded or moved to other accounts in the Apple iOS/iPadOS 16 Mail app.'
...
If "Allow messages to be moved" is checked in the Apple iOS/iPadOS management tool, "<key>PreventMove</key><false/>" appears in the configuration profile, or the Exchange policy on the iPhone and iPad has "Prevent Move" set to "No", this is a finding.'
  ...
  tag check_id: 'C-60810r904273_chk'
  tag severity: 'medium'
  tag gid: 'V-257125'
  tag rid: 'SV-257125r904275_rule'
  tag stig_id: 'AIOS-16-711400'
  tag gtitle: 'PP-MDF-993300'
  tag fix_id: 'F-60751r904274_fix'
  tag 'documentable'
