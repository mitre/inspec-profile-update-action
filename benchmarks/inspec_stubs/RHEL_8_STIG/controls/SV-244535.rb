...
"
  desc 'check', 'Verify the operating system initiates a session lock a for graphical user interfaces when the screensaver is activated with the following command:
...
$ sudo dconf update'
  ...
  tag check_id: 'C-47810r743852_chk'
  tag severity: 'medium'
  tag gid: 'V-244535'
