...
'
  desc 'check', 'Verify the Ubuntu operating system generates an audit record when successful/unsuccessful modifications to the "lastlog" file occur. 
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41497r654034_chk'
  tag severity: 'medium'
  tag gid: 'V-238287'
