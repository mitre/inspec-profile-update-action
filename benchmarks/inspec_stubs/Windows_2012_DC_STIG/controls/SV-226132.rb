...
Applies to - Descendant Organizational Unit objects'
  ...
  tag check_id: 'C-27834r475719_chk'
  tag severity: 'medium'
  tag gid: 'V-226132'
  tag rid: 'SV-226132r852089_rule'
  tag stig_id: 'WN12-AU-000211-DC'
  tag gtitle: 'SRG-OS-000470-GPOS-00214'
  tag fix_id: 'F-27822r475720_fix'
  tag satisfies: ['SRG-OS-000471-GPOS-00215']
  tag 'documentable'
  tag legacy: ['SV-51173', 'V-39329']
