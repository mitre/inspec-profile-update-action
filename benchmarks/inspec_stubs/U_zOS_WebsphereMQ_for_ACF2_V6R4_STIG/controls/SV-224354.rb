...
___ Repeat the above step for each queue manager ssid identified.'
  desc 'fix', %q(Review the WebSphere MQ Screen interface invoked by the REXX CSQOREXX. Review the channel's SSLCIPH setting.
...
Repeat these steps for each queue manager ssid identified.)
  ...
  tag check_id: 'C-26031r868240_chk'
  tag severity: 'high'
  tag gid: 'V-224354'
  tag rid: 'SV-224354r868242_rule'
  tag stig_id: 'ZWMQ0011'
  tag gtitle: 'SRG-OS-000033'
  tag fix_id: 'F-26019r868241_fix'
