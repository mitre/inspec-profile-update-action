...
d) If (b) is untrue, this is a finding.'
  desc 'fix', 'The ISSO will ensure that all MQSeries/WebSphere MQ namelist resources are restricted to authorized users.
...
SYSTEM.DEFAULT.NAMELIST UID(*) PREVENT'
  ...
  tag check_id: 'C-26043r868263_chk'
  tag severity: 'medium'
  tag gid: 'V-224366'
  tag rid: 'SV-224366r868265_rule'
  tag stig_id: 'ZWMQ0056'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-26031r868264_fix'
  tag 'documentable'
