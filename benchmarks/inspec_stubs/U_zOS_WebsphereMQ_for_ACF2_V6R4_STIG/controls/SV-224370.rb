...
d) If either item in (b) is untrue, this is a finding.'
  desc 'fix', 'The ISSO will ensure that a ssid.RESLEVEL profile is only defined for each queue manager.
...
RESLEVEL UID(*) PREVENT'
  ...
  tag check_id: 'C-26047r868275_chk'
  tag severity: 'medium'
  tag gid: 'V-224370'
  tag rid: 'SV-224370r868277_rule'
  tag stig_id: 'ZWMQ0060'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-26035r868276_fix'
  tag 'documentable'
