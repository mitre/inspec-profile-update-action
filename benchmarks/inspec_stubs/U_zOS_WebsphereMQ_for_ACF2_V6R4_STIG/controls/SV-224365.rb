...
d) If (b) is untrue, this is a finding.'
  desc 'fix', 'The ISSO will ensure that process security is active, and that all profiles defined to the MQPROC class and that process inquiries are restricted to read access.
...
SYSTEM.DEFAULT.PROCESS UID(*)  PREVENT'
  ...
  tag check_id: 'C-26042r868260_chk'
  tag severity: 'medium'
  tag gid: 'V-224365'
  tag rid: 'SV-224365r868262_rule'
  tag stig_id: 'ZWMQ0055'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-26030r868261_fix'
  tag 'documentable'
