control 'SV-225169' do
  title 'The macOS system must be configured to disable the application Messages.'
...
If the return does not contain "/Applications/Messages.app", this is a finding.'
  ...
  tag check_id: 'C-26868r467675_chk'
  tag severity: 'low'
  tag gid: 'V-225169'
  tag rid: 'SV-225169r610901_rule'
  tag stig_id: 'AOSX-15-002011'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26856r467676_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['SV-111717', 'V-102755']
