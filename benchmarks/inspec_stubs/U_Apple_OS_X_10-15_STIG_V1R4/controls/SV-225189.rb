...
If the output is null or not "allowCloudKeychainSync = 0" this is a finding.'
  ...
  tag check_id: 'C-26888r467735_chk'
  tag severity: 'medium'
  tag gid: 'V-225189'
  tag rid: 'SV-225189r610901_rule'
  tag stig_id: 'AOSX-15-002040'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26876r467736_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['V-102797', 'SV-111759']
