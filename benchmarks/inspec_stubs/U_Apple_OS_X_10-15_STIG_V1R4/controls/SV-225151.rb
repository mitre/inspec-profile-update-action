...
/usr/bin/sudo chmod 700 [audit log folder]'
  ...
  tag check_id: 'C-26850r467621_chk'
  tag severity: 'medium'
  tag gid: 'V-225151'
  tag rid: 'SV-225151r610901_rule'
  tag stig_id: 'AOSX-15-001017'
  tag gtitle: 'SRG-OS-000057-GPOS-00027'
  tag fix_id: 'F-26838r467622_fix'
  tag satisfies: ['SRG-OS-000057-GPOS-00027', 'SRG-OS-000058-GPOS-00028', 'SRG-OS-000059-GPOS-00029']
  tag 'documentable'
  tag legacy: ['SV-111681', 'V-102719']
