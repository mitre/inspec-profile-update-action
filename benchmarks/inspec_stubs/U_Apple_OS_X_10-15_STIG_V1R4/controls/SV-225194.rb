...
EnableAssessment = 1;)
  ...
  tag check_id: 'C-26893r648723_chk'
  tag severity: 'medium'
  tag gid: 'V-225194'
  tag rid: 'SV-225194r648724_rule'
  tag stig_id: 'AOSX-15-002060'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-26881r467751_fix'
  tag 'documentable'
  tag legacy: ['SV-111769', 'V-102807']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
