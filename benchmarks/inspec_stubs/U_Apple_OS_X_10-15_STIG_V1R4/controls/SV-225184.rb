...
If the return is not "SkipCloudSetup = 1", this is a finding.'
  ...
  tag check_id: 'C-26883r467720_chk'
  tag severity: 'medium'
  tag gid: 'V-225184'
  tag rid: 'SV-225184r610901_rule'
  tag stig_id: 'AOSX-15-002035'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26871r467721_fix'
  tag 'documentable'
  tag legacy: ['SV-111749', 'V-102787']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
