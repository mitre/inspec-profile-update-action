...
Note: Always check for the minimum allowed in FIPS 140-2.'
  ...
  tag check_id: 'C-25740r516600_chk'
  tag severity: 'medium'
  tag gid: 'V-224067'
  tag rid: 'SV-224067r561402_rule'
  tag stig_id: 'TSS0-TN-000030'
  tag gtitle: 'SRG-OS-000033-GPOS-00014'
  tag fix_id: 'F-25728r516601_fix'
  ...
  tag 'documentable'
  tag legacy: ['V-98841', 'SV-107945']
  tag cci: ['CCI-000068', 'CCI-000803', 'CCI-001453', 'CCI-002890', 'CCI-003123', 'CCI-002450', 'CCI-002421', 'CCI-002422', 'CCI-002418', 'CCI-002420']
  tag nist: ['AC-17 (2)', 'IA-7', 'AC-17 (2)', 'MA-4 (6)', 'MA-4 (6)', 'SC-13 b', 'SC-8 (1)', 'SC-8 (2)', 'SC-8', 'SC-8 (2)']
end
