control 'SV-223909' do
  title 'CA-TSS must limit access to data sets used to back up and/or dump SMF collection files to appropriate users and/or batch jobs that perform SMF dump processing.'
...
If the ESM dataset rules for the SMF dump/backup files do restrict update access as documented in the site security plan this is a finding.
...
If the ESM data set rules for SMF dump/backup files do not specify that all (i.e., failures and successes) WRITE or greater access will be logged this is a finding.'
  desc 'fix', 'Review access authorization to critical system files. Evaluate the impact of correcting the deficiency. Develop a plan of action and implement the changes as required to protect data sets used to backup and/or dump SMF Collection Files.
...
Ensure that all update and alter access authority to SMF history files will be logged using the ESM’s facilities.'
  ...
  tag check_id: 'C-25582r516126_chk'
  tag severity: 'medium'
  tag gid: 'V-223909'
  tag rid: 'SV-223909r561402_rule'
  tag stig_id: 'TSS0-ES-000360'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25570r516127_fix'
  tag satisfies: ['SRG-OS-000080-GPOS-00048', 'SRG-OS-000206-GPOS-00084', 'SRG-OS-000324-GPOS-00125']
  tag 'documentable'
  tag legacy: ['SV-107629', 'V-98525']
