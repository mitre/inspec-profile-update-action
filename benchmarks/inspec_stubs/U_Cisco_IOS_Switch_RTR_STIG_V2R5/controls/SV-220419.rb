...
If the switch is not configured to enforce approved authorizations for controlling the flow of information within the network based on organization-defined information flow control policies, this is a finding.'
  desc 'fix', 'Configure ACLs to allow or deny traffic for specific source and destination addresses as well as ports and protocols between various subnets as required. The commands below were used to create the configuration as shown in the check content: 
...
SW1(config-if)#end'
  ...
  tag check_id: 'C-22134r508351_chk'
  tag severity: 'medium'
  tag gid: 'V-220419'
  tag rid: 'SV-220419r622190_rule'
  tag stig_id: 'CISC-RT-000010'
  tag gtitle: 'SRG-NET-000018-RTR-000001'
  tag fix_id: 'F-22123r508352_fix'
  tag 'documentable'
  tag legacy: ['SV-110685', 'V-101581']
  tag cci: ['CCI-001368']
  tag nist: ['AC-4']
end
