...
If the UEM server does not automatically audit account creation, this is a finding.'
  desc 'fix', 'Configure the UEM server to automatically audit account creation.'
  impact 0.5
  ref 'DPMS Target Unified Endpoint Management Server'
  tag check_id: 'C-37474r613877_chk'
  tag severity: 'medium'
  tag gid: 'V-234289'
  tag rid: 'SV-234289r617355_rule'
  tag stig_id: 'SRG-APP-000026-UEM-000015'
  tag gtitle: 'SRG-APP-000026'
  tag fix_id: 'F-37439r613878_fix'
  tag 'documentable'
  tag cci: ['CCI-000018']
  tag nist: ['AC-2 (4)']
end
