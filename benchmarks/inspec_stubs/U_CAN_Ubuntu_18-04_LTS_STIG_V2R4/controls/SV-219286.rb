...
'
  desc 'check', "Verify the Ubuntu operating system generates audit records when successful/unsuccessful attempts to use lremovexattr system call.
...
The '-k' allows for specifying an arbitrary identifier and the string after it does not need to match the example output above."
  desc 'fix', 'Configure the audit system to generate audit records for successful/unsuccessful attempts to use lremovexattr system call.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-21011r305186_chk'
  tag severity: 'medium'
  tag gid: 'V-219286'
  tag rid: 'SV-219286r610963_rule'
