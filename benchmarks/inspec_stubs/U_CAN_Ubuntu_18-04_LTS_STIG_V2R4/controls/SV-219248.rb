...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', %q(Verify if the Ubuntu operating system is configured to audit the execution of the "lremovexattr" system call.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20973r305072_chk'
  tag severity: 'medium'
  tag gid: 'V-219248'
  tag rid: 'SV-219248r610963_rule'
  tag stig_id: 'UBTU-18-010325'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-20972r305073_fix'
  tag 'documentable'
  tag legacy: ['SV-109825', 'V-100721']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
