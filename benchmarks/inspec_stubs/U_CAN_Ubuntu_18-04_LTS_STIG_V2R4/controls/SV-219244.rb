...
'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when successful/unsuccessful attempts to use the "setxattr" system call.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20969r305060_chk'
  tag severity: 'medium'
  tag gid: 'V-219244'
