...
'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when successful/unsuccessful attempts to use the "lsetxattr" system call.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20970r305063_chk'
  tag severity: 'medium'
  tag gid: 'V-219245'
