...
'
  desc 'check', 'Verify the Ubuntu operating system uses multifactor authentication for local access to accounts.
...
If "pam_pkcs11.so" is not set in "/etc/pam.d/common-auth", this is a finding.'
  desc 'fix', 'Configure the Ubuntu operating system to use multifactor authentication for local access to accounts.
...
auth [success=2 default=ignore] pam_pkcs11.so'
  ...
  tag check_id: 'C-21042r305279_chk'
  tag severity: 'medium'
  tag gid: 'V-219317'
  tag rid: 'SV-219317r610963_rule'
  tag stig_id: 'UBTU-18-010427'
  tag gtitle: 'SRG-OS-000105-GPOS-00052'
  tag fix_id: 'F-21041r305280_fix'
  tag satisfies: ['SRG-OS-000105-GPOS-00052', 'SRG-OS-000106-GPOS-00053', 'SRG-OS-000107-GPOS-00054', 'SRG-OS-000108-GPOS-00055', 'SRG-OS-000377-GPOS-00162']
  tag 'documentable'
  tag legacy: ['V-100857', 'SV-109961']
  tag cci: ['CCI-000765', 'CCI-000766', 'CCI-000767', 'CCI-000768', 'CCI-001954']
  tag nist: ['IA-2 (1)', 'IA-2 (2)', 'IA-2 (3)', 'IA-2 (4)', 'IA-2 (12)']
end
