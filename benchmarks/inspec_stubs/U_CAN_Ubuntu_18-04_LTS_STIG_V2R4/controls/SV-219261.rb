...
'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when unsuccessful attempts to use the "openat" system call.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20986r305111_chk'
  tag severity: 'medium'
  tag gid: 'V-219261'
  tag rid: 'SV-219261r610963_rule'
