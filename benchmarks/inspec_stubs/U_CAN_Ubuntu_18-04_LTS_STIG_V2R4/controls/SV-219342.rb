...
If this returns a result, this is a finding.'
  desc 'fix', 'Set the "kernel.randomize_va_space" entry found in the "/etc/sysctl.conf" file to a value of "2".
...
# sudo sysctl --system'
  ...
  tag check_id: 'C-21067r569469_chk'
  tag severity: 'medium'
  tag gid: 'V-219342'
  tag rid: 'SV-219342r610963_rule'
  tag stig_id: 'UBTU-18-010514'
  tag gtitle: 'SRG-OS-000433-GPOS-00193'
  tag fix_id: 'F-21066r569470_fix'
  tag 'documentable'
  tag legacy: ['SV-110009', 'V-100905']
  tag cci: ['CCI-002824']
  tag nist: ['SI-16']
end
