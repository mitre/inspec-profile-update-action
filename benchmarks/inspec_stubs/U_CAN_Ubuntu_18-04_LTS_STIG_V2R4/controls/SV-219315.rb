...
'
  desc 'check', %q(Verify the Ubuntu operating system, for PKI-based authentication, had valid certificates by constructing a certification path to an accepted trust anchor.
...
If the system is missing an "/etc/pam_pkcs11/" directory and an "/etc/pam_pkcs11/pam_pkcs11.conf", find an example to copy into place and modify accordingly at "/usr/share/doc/libpam-pkcs11/examples/pam_pkcs11.conf.example.gz".'
  ...
  tag check_id: 'C-21040r305273_chk'
  tag severity: 'medium'
  tag gid: 'V-219315'
  tag rid: 'SV-219315r610963_rule'
