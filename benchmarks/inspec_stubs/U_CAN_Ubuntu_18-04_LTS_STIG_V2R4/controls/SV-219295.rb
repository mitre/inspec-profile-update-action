...
'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when unsuccessful attempts to use the "creat" system call.
...
The '-k' allows for specifying an arbitrary identifier and the string after it does not need to match the example output above.)
  desc 'fix', 'Configure the audit system to generate an audit event for any unsuccessful use of the "creat" system call. 
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-21020r569484_chk'
  tag severity: 'medium'
  tag gid: 'V-219295'
  tag rid: 'SV-219295r610963_rule'
  tag stig_id: 'UBTU-18-010384'
  tag gtitle: 'SRG-OS-000474-GPOS-00219'
  tag fix_id: 'F-21019r569485_fix'
  tag satisfies: ['SRG-OS-000064-GPOS-00033']
  tag 'documentable'
  tag legacy: ['V-100813', 'SV-109917']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
