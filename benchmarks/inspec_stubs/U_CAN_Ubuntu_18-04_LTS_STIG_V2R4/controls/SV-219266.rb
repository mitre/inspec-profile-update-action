...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when successful/unsuccessful attempts to use the "newgrp" command occur.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20991r305126_chk'
  tag severity: 'medium'
  tag gid: 'V-219266'
  tag rid: 'SV-219266r610963_rule'
  tag stig_id: 'UBTU-18-010343'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-20990r305127_fix'
  tag 'documentable'
  tag legacy: ['V-100757', 'SV-109861']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
