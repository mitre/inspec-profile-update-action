...
'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when successful/unsuccessful attempts to use the "fremovexattr" system call.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20974r305075_chk'
  tag severity: 'medium'
  tag gid: 'V-219249'
  tag rid: 'SV-219249r610963_rule'
