...
'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when successful/unsuccessful attempts to use the "chown" system call.
...
The '-k' allows for specifying an arbitrary identifier and the string after it does not need to match the example output above.)
  desc 'fix', 'Configure the audit system to generate an audit event for any successful/unsuccessful use of the "chown" system call.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20975r305078_chk'
  tag severity: 'medium'
  tag gid: 'V-219250'
  tag rid: 'SV-219250r610963_rule'
