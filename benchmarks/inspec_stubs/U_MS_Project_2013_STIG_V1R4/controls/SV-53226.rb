control 'SV-53226' do
  ...
  desc 'check', 'Verify the policy value for User Configuration -> Administrative Templates -> Microsoft Project 2013 -> Project Options -> Security ->  Trust Center -> "Require that application add-ins are signed by Trusted Publisher" is set to "Enabled".
...
Criteria: If the value requireaddinsig is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy User Configuration -> Administrative Templates -> Microsoft Project 2013 -> Project Options -> Security ->  Trust Center -> "Require that application add-ins are signed by Trusted Publisher" to "Enabled".'
  impact 0.5
  ref 'DPMS Target Microsoft Project 2013'
  tag check_id: 'C-47533r1_chk'
  tag severity: 'medium'
  tag gid: 'V-40888'
  tag rid: 'SV-53226r1_rule'
  tag stig_id: 'DTOO127'
  tag gtitle: 'DTOO127 - Add-ins are signed by Trusted Publisher'
  tag fix_id: 'F-46153r1_fix'
  tag 'documentable'
