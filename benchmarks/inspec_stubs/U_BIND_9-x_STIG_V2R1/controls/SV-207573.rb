...
If the key file(s) are not owned by root, this is a finding.'
  desc 'fix', 'Change the ownership of the keys to the root account.

# chown root <key_file>.'
  impact 0.5
  ref 'DPMS Target BIND 9.x'
  tag check_id: 'C-7828r283773_chk'
  tag severity: 'medium'
  tag gid: 'V-207573'
  tag rid: 'SV-207573r612253_rule'
  tag stig_id: 'BIND-9X-001140'
  tag gtitle: 'SRG-APP-000516-DNS-000086'
  tag fix_id: 'F-7828r283774_fix'
  tag 'documentable'
  tag legacy: ['SV-87081', 'V-72457']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
