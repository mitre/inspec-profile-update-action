...
If the IDPS data is not backed up on a weekly basis, this is a finding.'
  ...
  tag check_id: 'C-7459r4_chk'
  tag severity: 'medium'
  tag gid: 'V-8078'
  tag rid: 'SV-8564r3_rule'
  tag stig_id: 'NET-IDPS-033'
  tag gtitle: 'NET-IDPS-033 The organization has not established weekly backup procedures for IDS/IPS data'
  tag fix_id: 'F-7653r2_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
