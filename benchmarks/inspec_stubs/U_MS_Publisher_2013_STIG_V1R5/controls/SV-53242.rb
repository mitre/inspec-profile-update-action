control 'SV-53242' do
  ...
  desc 'check', %q(Verify the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Block popups" must be "Enabled" and 'mspub.exe' is checked. 
...
Criteria: If the value mspub.exe  is REG_DWORD = 1, this is not a finding.)
  desc 'fix', %q(Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Block popups" to "Enabled" and select 'mspub.exe'.)
  impact 0.5
  ref 'DPMS Target Microsoft Publisher 2013'
  tag check_id: 'C-47549r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17184'
  tag rid: 'SV-53242r1_rule'
  tag stig_id: 'DTOO129'
  tag gtitle: 'DTOO129 - Block Pop-Ups'
  tag fix_id: 'F-46169r1_fix'
  tag 'documentable'
