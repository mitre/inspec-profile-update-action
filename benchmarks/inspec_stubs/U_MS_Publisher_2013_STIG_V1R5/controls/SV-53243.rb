control 'SV-53243' do
  ...
  desc 'check', 'Verify the policy value for User Configuration -> Administrative Templates -> Microsoft Publisher 2013 -> Security -> Trust Center "Disable Trust Bar Notification for unsigned application add-ins" must be "Enabled". 
...
Criteria: If the value NoTBPromptUnsignedAddin is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft Publisher 2013 -> Security -> Trust Center "Disable Trust Bar Notification for unsigned application add-ins" to "Enabled".'
  impact 0.5
  ref 'DPMS Target Microsoft Publisher 2013'
  tag check_id: 'C-47550r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17187'
  tag rid: 'SV-53243r1_rule'
  tag stig_id: 'DTOO131'
  tag gtitle: 'DTOO131 - Trust Bar Notifications'
  tag fix_id: 'F-46170r1_fix'
  tag 'documentable'
