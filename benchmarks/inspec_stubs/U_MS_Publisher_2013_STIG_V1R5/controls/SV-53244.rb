control 'SV-53244' do
  ...
  desc 'check', %q(Verify the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Restrict File Download" is set to "Enabled" and 'mspub.exe' is checked. 
...
Criteria: If the value mspub.exe is REG_DWORD = 1, this is not a finding.)
  desc 'fix', %q(Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Restrict File Download" to "Enabled" and 'mspub.exe' is checked.)
  impact 0.5
  ref 'DPMS Target Microsoft Publisher 2013'
  tag check_id: 'C-47551r1_chk'
  tag severity: 'medium'
  tag gid: 'V-26587'
  tag rid: 'SV-53244r1_rule'
  tag stig_id: 'DTOO132'
  tag gtitle: 'DTOO132 - Restrict File Download'
  tag fix_id: 'F-46171r1_fix'
  tag 'documentable'
