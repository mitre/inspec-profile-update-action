control 'SV-242580' do
  title 'The Cisco ISE must verify host-based IDS/IPS software is authorized and running on posture required clients defined in the NAC System Security Plan (SSP) prior to granting trusted network access. This is required for compliance with C2C Step 1. This is required for compliance with C2C Step 4.'
...
If there is not a firewall condition tied to a requirement that is applied to an applicable posture policy, this is a finding.'
  desc 'fix', 'If required by the NAC SSP, configure the posture policy to verify that a host-based IPS is running.
...
e. Choose "Save".'
  ...
  tag check_id: 'C-45855r812741_chk'
  tag severity: 'high'
  tag gid: 'V-242580'
  tag rid: 'SV-242580r812742_rule'
  tag stig_id: 'CSCO-NC-000060'
  tag gtitle: 'SRG-NET-000015-NAC-000020'
  tag fix_id: 'F-45812r803526_fix'
  tag 'documentable'
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
