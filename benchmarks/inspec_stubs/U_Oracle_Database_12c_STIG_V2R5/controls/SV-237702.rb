control 'SV-237702' do
  title 'The DBMS must provide a mechanism to automatically remove or disable temporary user accounts after 72 hours.'
...
Create a job to lock accounts under this profile that are more than 72 hours old.'
  ...
  tag check_id: 'C-40921r667136_chk'
  tag severity: 'medium'
  tag gid: 'V-237702'
  tag rid: 'SV-237702r667138_rule'
  tag stig_id: 'O121-C2-002000'
  tag gtitle: 'SRG-APP-000516-DB-000363'
  tag fix_id: 'F-40884r667137_fix'
  tag 'documentable'
  tag legacy: ['V-61561', 'SV-76051']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
