...
If administrative functionality or information regarding DBMS management is presented on an interface available for users, information on DBMS settings may be inadvertently made available to the user.'
  desc 'check', 'Check DBMS settings and vendor documentation to verify administrative functionality is separate from user functionality.
...
If administrator and general user functionality is not separated either physically or logically, this is a finding.'
  ...
  tag check_id: 'C-22027r392067_chk'
  tag severity: 'medium'
  tag gid: 'V-220312'
  tag rid: 'SV-220312r397711_rule'
  tag stig_id: 'O121-P2-017300'
  tag gtitle: 'SRG-APP-000211-DB-000122'
  tag fix_id: 'F-22019r392068_fix'
  tag 'documentable'
  tag legacy: ['SV-76373', 'V-61883']
  tag cci: ['CCI-001082']
  tag nist: ['SC-2']
end
