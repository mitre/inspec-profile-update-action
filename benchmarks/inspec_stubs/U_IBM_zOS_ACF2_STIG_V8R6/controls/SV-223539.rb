...
- The reason the module's privileges are being revoked"
  ...
  tag check_id: 'C-25212r504672_chk'
  tag severity: 'medium'
  tag gid: 'V-223539'
  tag rid: 'SV-223539r533198_rule'
  tag stig_id: 'ACF2-OS-000030'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-25200r504673_fix'
  tag 'documentable'
  tag legacy: ['V-97783', 'SV-106887']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
