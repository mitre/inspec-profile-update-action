control 'SV-59865' do
  ...
  tag check_id: 'C-49983r2_chk'
  tag severity: 'medium'
  tag gid: 'V-46999'
  tag rid: 'SV-59865r1_rule'
  tag stig_id: 'DTBI062-IE11'
  tag gtitle: 'DTBI062-IE11-Anti-Malware programs against ActiveX controls - Intranet'
  tag fix_id: 'F-50719r1_fix'
  tag 'documentable'
