control 'SV-79209' do
  ...
  desc 'check', 'The policy value for Computer Configuration >> Administrative Templates >> Windows Components >> Internet Explorer >> Internet Control Panel >> Security Page >> Internet Zone >> ”Turn on SmartScreen Filter scan” must be ”Enabled” and ”Enable” selected from the drop-down box. 
...
Criteria: If the value "2301" is REG_DWORD = 0, this is not a finding.'
  desc 'fix', 'Set the policy value for Computer Configuration >> Administrative Templates >> Windows Components >> Internet Explorer >> Internet Control Panel >> Security Page >> Internet Zone >> ”Turn on SmartScreen Filter scan” to ”Enabled”, and select ”Enable” from the drop-down box.'
  impact 0.5
  ref 'DPMS Target IE Version 11'
  tag check_id: 'C-65461r2_chk'
  tag severity: 'medium'
  tag gid: 'V-64719'
  tag rid: 'SV-79209r1_rule'
  tag stig_id: 'DTBI1080-IE11'
  tag gtitle: 'DTBI1080-IE11-Managing SmartScreen Filter-Internet Zone'
  tag fix_id: 'F-70649r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001242']
  tag nist: ['SI-3 c 1']
end
