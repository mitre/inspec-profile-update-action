control 'SV-59847' do
  ...
  tag check_id: 'C-49973r2_chk'
  tag severity: 'medium'
  tag gid: 'V-46981'
  tag rid: 'SV-59847r1_rule'
  tag stig_id: 'DTBI990-IE11'
  tag gtitle: 'DTBI990-IE11-Content from different domains across windows - Internet'
  tag fix_id: 'F-50707r1_fix'
  tag 'documentable'
