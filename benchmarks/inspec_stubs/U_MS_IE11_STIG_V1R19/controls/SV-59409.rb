control 'SV-59409' do
  ...
  desc 'fix', "Set the policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer-> Internet Control Panel-> Security Page-> Internet Zone 'Enable dragging of content from different domains within a window' to 'Enabled', and select 'Disabled' from the drop-down box."
  impact 0.5
  ref 'DPMS Target IE Version 11'
  tag check_id: 'C-49717r2_chk'
  tag severity: 'medium'
  tag gid: 'V-46545'
  tag rid: 'SV-59409r1_rule'
  tag stig_id: 'DTBI1000-IE11'
  tag gtitle: 'DTBI1000-IE11-Content from different domains within windows - Internet'
  tag fix_id: 'F-50321r1_fix'
  tag 'documentable'
