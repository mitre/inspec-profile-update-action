control 'SV-59469' do
  ...
  desc 'check', %q(The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Restricted Sites Zone -> 'Allow cut, copy or paste operations from the clipboard via script' must be 'Enabled', and 'Disable' selected from the drop-down box. Procedure: Use the Windows Registry Editor to navigate to the following key: HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4 Criteria: If the value "1407" is REG_DWORD = 3, this is not a finding.)
  ...
  tag check_id: 'C-49771r2_chk'
  tag severity: 'medium'
  tag gid: 'V-46605'
  tag rid: 'SV-59469r1_rule'
  tag stig_id: 'DTBI134-IE11'
  tag gtitle: 'DTBI134-IE11-Paste operations via script - Restricted Sites'
  tag fix_id: 'F-50375r1_fix'
  tag 'documentable'
