control 'SV-59725' do
  ...
  tag check_id: 'C-49933r2_chk'
  tag severity: 'medium'
  tag gid: 'V-46859'
  tag rid: 'SV-59725r1_rule'
  tag stig_id: 'DTBI820-IE11'
  tag gtitle: 'DTBI820-IE11-Security warning for unsafe files - Internet'
  tag fix_id: 'F-50595r1_fix'
  tag 'documentable'
