...
FTPSMFEX'
  ...
  tag check_id: 'C-25414r514911_chk'
  tag severity: 'medium'
  tag gid: 'V-223741'
  tag rid: 'SV-223741r604139_rule'
  tag stig_id: 'RACF-FT-000090'
  tag gtitle: 'SRG-OS-000096-GPOS-00050'
  tag fix_id: 'F-25402r514912_fix'
  tag 'documentable'
  tag legacy: ['V-98189', 'SV-107293']
  tag cci: ['CCI-000382']
  tag nist: ['CM-7 b']
end
