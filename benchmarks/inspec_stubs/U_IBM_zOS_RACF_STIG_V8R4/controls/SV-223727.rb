...
If the PASSWORD(INTERVAL) value is set properly then the message PASSWORD CHANGE INTERVAL IS 060 DAYS, this is not a finding.'
  desc 'fix', 'Configure PASSWORD(INTERVAL) SETROPTS value is set to "060" days. This specifies the maximum number of days that each user’s password is valid.
...
Setting the password interval to 60 days is activated with the command SETR PASSWORD(INTERVAL(60)).'
  ...
  tag check_id: 'C-25400r514869_chk'
  tag severity: 'medium'
  tag gid: 'V-223727'
  tag rid: 'SV-223727r604139_rule'
  tag stig_id: 'RACF-ES-000800'
  tag gtitle: 'SRG-OS-000076-GPOS-00044'
  tag fix_id: 'F-25388r514870_fix'
  tag 'documentable'
