...
'
  desc 'check', 'Refer to the CONSOLxx member of SYS1.PARMLIB.console is defined to RACF with a corresponding profile in the CONSOLE resource class.
...
PE MMD041 CL(CONSOLE) ID(syspsmpl opersmpl)"
  ...
  tag check_id: 'C-25362r514755_chk'
  tag severity: 'medium'
  tag gid: 'V-223689'
  tag rid: 'SV-223689r604139_rule'
  tag stig_id: 'RACF-ES-000410'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25350r514756_fix'
