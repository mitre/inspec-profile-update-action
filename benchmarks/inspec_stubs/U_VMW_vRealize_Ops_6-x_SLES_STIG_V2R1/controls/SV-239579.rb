...
# service sshd restart'
  ...
  tag check_id: 'C-42812r662186_chk'
  tag severity: 'medium'
  tag gid: 'V-239579'
  tag rid: 'SV-239579r662188_rule'
  tag stig_id: 'VROM-SL-000865'
  tag gtitle: 'SRG-OS-000250-GPOS-00093'
  tag fix_id: 'F-42771r662187_fix'
  tag 'documentable'
  tag legacy: ['SV-99279', 'V-88629']
  tag cci: ['CCI-001453']
  tag nist: ['AC-17 (2)']
end
