...
# chgrp root <file referenced from aliases>'
  ...
  tag check_id: 'C-42764r662042_chk'
  tag severity: 'medium'
  tag gid: 'V-239531'
  tag rid: 'SV-239531r662044_rule'
  tag stig_id: 'VROM-SL-000560'
  tag gtitle: 'SRG-OS-000096-GPOS-00050'
  tag fix_id: 'F-42723r662043_fix'
  tag 'documentable'
  tag legacy: ['SV-99183', 'V-88533']
  tag cci: ['CCI-000382']
  tag nist: ['CM-7 b']
end
