control 'SV-239470' do
  title 'The SLES for vRealize must be configured to audit all attempts to alter the system through sched_setscheduler.'
...
# /etc/dodscript.sh"
  ...
  tag check_id: 'C-42703r661859_chk'
  tag severity: 'medium'
  tag gid: 'V-239470'
  tag rid: 'SV-239470r767703_rule'
  tag stig_id: 'VROM-SL-000220'
  tag gtitle: 'VROM-SL-000220'
  tag fix_id: 'F-42662r661860_fix'
  tag 'documentable'
  tag legacy: ['SV-99061', 'V-88411']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
