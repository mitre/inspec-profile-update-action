control 'SV-239469' do
  title 'The SLES for vRealize must be configured to audit all attempts to alter the system through sched_setparam.'
...
# /etc/dodscript.sh"
  ...
  tag check_id: 'C-42702r661856_chk'
  tag severity: 'medium'
  tag gid: 'V-239469'
  tag rid: 'SV-239469r767702_rule'
  tag stig_id: 'VROM-SL-000215'
  tag gtitle: 'VROM-SL-000215'
  tag fix_id: 'F-42661r661857_fix'
  tag 'documentable'
  tag legacy: ['SV-99059', 'V-88409']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
