...
# /etc/dodscript.sh)
  ...
  tag check_id: 'C-42705r661865_chk'
  tag severity: 'medium'
  tag gid: 'V-239472'
  tag rid: 'SV-239472r767705_rule'
  tag stig_id: 'VROM-SL-000230'
  tag gtitle: 'VROM-SL-000230'
  tag fix_id: 'F-42664r661866_fix'
  tag 'documentable'
  tag legacy: ['SV-99065', 'V-88415']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
