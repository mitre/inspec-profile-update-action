...
# service sshd restart'
  ...
  tag check_id: 'C-42793r662129_chk'
  tag severity: 'medium'
  tag gid: 'V-239560'
  tag rid: 'SV-239560r662131_rule'
  tag stig_id: 'VROM-SL-000735'
  tag gtitle: 'SRG-OS-000125-GPOS-00065'
  tag fix_id: 'F-42752r662130_fix'
  tag 'documentable'
  tag legacy: ['SV-99241', 'V-88591']
  tag cci: ['CCI-000877']
  tag nist: ['MA-4 c']
end
