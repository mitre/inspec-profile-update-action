control 'SV-239463' do
  title 'The SLES for vRealize audit system must be configured to audit all attempts to alter system time through settimeofday.'
...
# /etc/dodscript.sh"
  ...
  tag check_id: 'C-42696r661838_chk'
  tag severity: 'medium'
  tag gid: 'V-239463'
  tag rid: 'SV-239463r767696_rule'
  tag stig_id: 'VROM-SL-000185'
  tag gtitle: 'VROM-SL-000185'
  tag fix_id: 'F-42655r661839_fix'
  tag 'documentable'
  tag legacy: ['SV-99047', 'V-88397']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
