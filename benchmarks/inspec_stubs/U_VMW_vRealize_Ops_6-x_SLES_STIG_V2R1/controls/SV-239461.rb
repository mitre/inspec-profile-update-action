...
# /etc/dodscript.sh)
  ...
  tag check_id: 'C-42694r661832_chk'
  tag severity: 'medium'
  tag gid: 'V-239461'
  tag rid: 'SV-239461r767694_rule'
  tag stig_id: 'VROM-SL-000175'
  tag gtitle: 'VROM-SL-000175'
  tag fix_id: 'F-42653r661833_fix'
  tag 'documentable'
  tag legacy: ['SV-99043', 'V-88393']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
