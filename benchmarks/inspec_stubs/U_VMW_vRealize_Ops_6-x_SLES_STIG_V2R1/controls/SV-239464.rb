...
4) All kernel module load, unload, and restart actions.'
  desc 'check', 'Check if SLES for vRealize is configured to audit calls to the "settimeofday" system call, run the following command:

# grep -w "stime" /etc/audit/audit.rules

If SLES for vRealize is configured to audit this activity, it will return at least two lines containing "-S settimeofday" that also contain "arch=b64". If no line is returned, this is a finding.'
...
# /etc/dodscript.sh"
  ...
  tag check_id: 'C-42697r661841_chk'
  tag severity: 'medium'
  tag gid: 'V-239464'
  tag rid: 'SV-239464r767697_rule'
  tag stig_id: 'VROM-SL-000190'
  tag gtitle: 'VROM-SL-000190'
  tag fix_id: 'F-42656r661842_fix'
  tag 'documentable'
  tag legacy: ['SV-99049', 'V-88399']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
