...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', 'To determine if SLES for vRealize is configured to audit calls to the "fremovexattr" system call, run the following command: 
...
# /etc/dodscript.sh'
  ...
  tag check_id: 'C-42716r661898_chk'
  tag severity: 'medium'
  tag gid: 'V-239483'
  tag rid: 'SV-239483r661900_rule'
  tag stig_id: 'VROM-SL-000285'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-42675r661899_fix'
  tag 'documentable'
  tag legacy: ['SV-99087', 'V-88437']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
