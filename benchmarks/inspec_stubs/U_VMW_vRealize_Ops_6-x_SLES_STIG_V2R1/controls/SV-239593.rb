...
# service auditd restart'
  ...
  tag check_id: 'C-42826r662228_chk'
  tag severity: 'medium'
  tag gid: 'V-239593'
  tag rid: 'SV-239593r662230_rule'
  tag stig_id: 'VROM-SL-000970'
  tag gtitle: 'SRG-OS-000303-GPOS-00120'
  tag fix_id: 'F-42785r662229_fix'
  tag 'documentable'
  tag legacy: ['SV-99307', 'V-88657']
  tag cci: ['CCI-002130']
  tag nist: ['AC-2 (4)']
end
