...
# /etc/dodscript.sh"
  ...
  tag check_id: 'C-42700r661850_chk'
  tag severity: 'medium'
  tag gid: 'V-239467'
  tag rid: 'SV-239467r767700_rule'
  tag stig_id: 'VROM-SL-000205'
  tag gtitle: 'VROM-SL-000205'
  tag fix_id: 'F-42659r661851_fix'
  tag 'documentable'
  tag legacy: ['SV-99055', 'V-88405']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
