...
If a line is returned, this is a finding.'
  ...
  tag check_id: 'C-42790r662120_chk'
  tag severity: 'medium'
  tag gid: 'V-239557'
  tag rid: 'SV-239557r662122_rule'
  tag stig_id: 'VROM-SL-000715'
  tag gtitle: 'SRG-OS-000121-GPOS-00062'
  tag fix_id: 'F-42749r662121_fix'
  tag 'documentable'
  tag legacy: ['SV-99235', 'V-88585']
  tag cci: ['CCI-000804']
  tag nist: ['IA-8']
end
