...
#sysctl kernel.randomize_va_space=1'
  ...
  tag check_id: 'C-42848r662294_chk'
  tag severity: 'medium'
  tag gid: 'V-239615'
  tag rid: 'SV-239615r662296_rule'
  tag stig_id: 'VROM-SL-001315'
  tag gtitle: 'SRG-OS-000433-GPOS-00193'
  tag fix_id: 'F-42807r662295_fix'
  tag 'documentable'
  tag legacy: ['SV-99351', 'V-88701']
  tag cci: ['CCI-002824']
  tag nist: ['SI-16']
end
