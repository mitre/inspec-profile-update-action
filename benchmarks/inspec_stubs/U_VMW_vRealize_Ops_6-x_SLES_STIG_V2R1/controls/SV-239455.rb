...
For certain systems, the need for availability outweighs the need to log all actions, and a different setting should be determined.'
  ...
  tag check_id: 'C-42688r661814_chk'
  tag severity: 'medium'
  tag gid: 'V-239455'
  tag rid: 'SV-239455r661816_rule'
  tag stig_id: 'VROM-SL-000130'
  tag gtitle: 'SRG-OS-000047-GPOS-00023'
  tag fix_id: 'F-42647r661815_fix'
  tag 'documentable'
  tag legacy: ['SV-99031', 'V-88381']
  tag cci: ['CCI-000140']
  tag nist: ['AU-5 b']
end
