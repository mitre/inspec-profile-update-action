...
# /etc/dodscript.sh'
  ...
  tag check_id: 'C-42862r662336_chk'
  tag severity: 'medium'
  tag gid: 'V-239629'
  tag rid: 'SV-239629r662338_rule'
  tag stig_id: 'VROM-SL-001400'
  tag gtitle: 'SRG-OS-000473-GPOS-00218'
  tag fix_id: 'F-42821r662337_fix'
  tag 'documentable'
  tag legacy: ['SV-99379', 'V-88729']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
