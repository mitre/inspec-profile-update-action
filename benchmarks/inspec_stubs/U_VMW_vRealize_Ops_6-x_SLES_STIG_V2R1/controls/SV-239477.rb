control 'SV-239477' do
  title 'The SLES for vRealize must generate audit records when successful/unsuccessful attempts to access privileges occur. The operating system must generate audit records for all discretionary access control permission modifications using chmod.'
...
# /etc/dodscript.sh'
  ...
  tag check_id: 'C-42710r661880_chk'
  tag severity: 'medium'
  tag gid: 'V-239477'
  tag rid: 'SV-239477r661882_rule'
  tag stig_id: 'VROM-SL-000255'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-42669r661881_fix'
  tag 'documentable'
  tag legacy: ['SV-99075', 'V-88425']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
