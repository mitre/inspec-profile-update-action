control 'SV-220136' do
  title 'The Cisco router must be configured to send log data to at least two syslog servers for the purpose of forwarding alerts to the administrators and the ISSO.'
...
R4(config)#logging host x.x.x.x'
  ...
  tag check_id: 'C-21850r916040_chk'
  tag severity: 'high'
  tag gid: 'V-220136'
  tag rid: 'SV-220136r916114_rule'
  tag stig_id: 'CISC-ND-001450'
  tag gtitle: 'SRG-APP-000516-NDM-000350'
  tag fix_id: 'F-21844r916041_fix'
  tag 'documentable'
