...
Verify SSHv2 is configured for protocol V2 only, ciphers [ aes256-ctr aes192-ctr aes128-ctr aes256-cbc aes192-cbc aes128-cbc ], key-exchange [ ecdh-sha2-nistp521 ecdh-sha2-nistp384 ecdh-sha2-nistp256 ], and macs [ hmac-sha2-512 hmac-sha2-256].
...
set system services ssh key-exchange ecdh-sha2-nistp256'
  ...
  tag check_id: 'C-57380r919245_chk'
  tag severity: 'high'
  tag gid: 'V-253928'
  tag rid: 'SV-253928r919247_rule'
  tag stig_id: 'JUEX-NM-000510'
  tag gtitle: 'SRG-APP-000411-NDM-000330'
  tag fix_id: 'F-57331r919246_fix'
  tag 'documentable'
  tag cci: ['CCI-002890']
  tag nist: ['MA-4 (6)']
end
