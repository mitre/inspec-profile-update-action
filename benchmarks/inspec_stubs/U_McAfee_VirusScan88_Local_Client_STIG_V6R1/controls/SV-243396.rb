control 'SV-243396' do
  title 'McAfee VirusScan On-Access Scanner All Processes settings must be configured to scan when writing to disk.'
...
Click OK to Save.'
  ...
  tag check_id: 'C-46671r722525_chk'
  tag severity: 'medium'
  tag gid: 'V-243396'
  tag rid: 'SV-243396r722527_rule'
  tag stig_id: 'DTAM101'
  tag gtitle: 'SRG-APP-000278'
  tag fix_id: 'F-46628r722526_fix'
  tag 'documentable'
  tag legacy: ['V-14622', 'SV-56410']
  tag cci: ['CCI-001242']
  tag nist: ['SI-3 c 1']
end
