...
Criteria:  If, under the applicable GUID key, the uAction does not have a value of 5, this is a finding.)
...
Click OK to Save.'
  ...
  tag check_id: 'C-46659r722489_chk'
  tag severity: 'medium'
  tag gid: 'V-243384'
  tag rid: 'SV-243384r722491_rule'
  tag stig_id: 'DTAM056'
  tag gtitle: 'SRG-APP-000279'
  tag fix_id: 'F-46616r722490_fix'
  tag 'documentable'
  tag legacy: ['V-6453', 'SV-56365']
  tag cci: ['CCI-001243']
  tag nist: ['SI-3 c 2']
end
