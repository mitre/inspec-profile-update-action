control 'SV-243362' do
  title 'McAfee VirusScan On-Access Scanner General Settings log file size must be restricted and be configured to at least 10MB.'
...
Click OK to Save.'
  ...
  tag check_id: 'C-46637r722423_chk'
  tag severity: 'medium'
  tag gid: 'V-243362'
  tag rid: 'SV-243362r722425_rule'
  tag stig_id: 'DTAM010'
  tag gtitle: 'SRG-APP-000278'
  tag fix_id: 'F-46594r722424_fix'
  tag 'documentable'
  tag legacy: ['V-42558', 'SV-55286']
  tag cci: ['CCI-001242']
  tag nist: ['SI-3 c 1']
end
