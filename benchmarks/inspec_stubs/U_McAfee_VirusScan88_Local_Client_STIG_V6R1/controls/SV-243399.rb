control 'SV-243399' do
  title 'McAfee VirusScan On-Access Scanner All Processes settings must be configured to find unknown unwanted programs and trojans.'
...
Click OK to Save.'
  ...
  tag check_id: 'C-46674r722534_chk'
  tag severity: 'medium'
  tag gid: 'V-243399'
  tag rid: 'SV-243399r722536_rule'
  tag stig_id: 'DTAM104'
  tag gtitle: 'SRG-APP-000278'
  tag fix_id: 'F-46631r722535_fix'
  tag 'documentable'
  tag legacy: ['V-14625', 'SV-56430']
  tag cci: ['CCI-001242']
  tag nist: ['SI-3 c 1']
end
