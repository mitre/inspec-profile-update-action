control 'SV-215820' do
  title 'The Cisco router must be configured to protect audit information from unauthorized modification.'
...
If the router is configured with a privilege level other than "15" to allow access to the file system, this is a finding.'
  desc 'fix', 'If persistent logging is enabled, configure the router to only allow administrators with privilege level "15" access to the file system as shown in the example below.

R4(config)#file privilege 15'
  impact 0.5
  ref 'DPMS Target Cisco IOS XE Router NDM'
  tag check_id: 'C-17059r287499_chk'
  tag severity: 'medium'
  tag gid: 'V-215820'
  tag rid: 'SV-215820r879577_rule'
  tag stig_id: 'CISC-ND-000380'
  tag gtitle: 'SRG-APP-000119-NDM-000236'
  tag fix_id: 'F-17057r287500_fix'
  tag 'documentable'
  tag legacy: ['SV-105369', 'V-96231']
  tag cci: ['CCI-000163']
  tag nist: ['AU-9 a']
end
