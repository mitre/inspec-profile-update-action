...
If an alarm is not created to alert on permission addition events, this is a finding.'
  ...
  tag check_id: 'C-18098r366315_chk'
  tag severity: 'medium'
  tag gid: 'V-216867'
  tag rid: 'SV-216867r612237_rule'
  tag stig_id: 'VCWN-65-000048'
  tag gtitle: 'SRG-APP-000275'
  tag fix_id: 'F-18096r366316_fix'
  tag 'documentable'
  tag legacy: ['SV-104629', 'V-94799']
  tag cci: ['CCI-001294']
  tag nist: ['SI-6 c']
end
