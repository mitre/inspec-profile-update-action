...
$pg.ReconfigureDVPortgroup_Task($spec)
  ...
  tag check_id: 'C-18069r366228_chk'
  tag severity: 'medium'
  tag gid: 'V-216838'
  tag rid: 'SV-216838r612237_rule'
  tag stig_id: 'VCWN-65-000016'
  tag gtitle: 'SRG-APP-000516'
  tag fix_id: 'F-18067r366229_fix'
  tag 'documentable'
  tag legacy: ['SV-104573', 'V-94743']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
