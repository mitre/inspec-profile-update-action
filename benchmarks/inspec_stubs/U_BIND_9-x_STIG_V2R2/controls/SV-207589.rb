...
If the key file is not owned by root, this is a finding.'
  desc 'fix', 'Change the ownership of the ZSK private key to the root account.

# chown root <key_file>'
  impact 0.5
  ref 'DPMS Target BIND 9.x'
  tag check_id: 'C-7844r283821_chk'
  tag severity: 'medium'
  tag gid: 'V-207589'
  tag rid: 'SV-207589r612253_rule'
  tag stig_id: 'BIND-9X-001410'
  tag gtitle: 'SRG-APP-000516-DNS-000111'
  tag fix_id: 'F-7844r283822_fix'
  tag 'documentable'
  tag legacy: ['SV-87119', 'V-72495']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
