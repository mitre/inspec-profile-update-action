...
If a "NORULE" record exists and is set to "REJECT", this is not a finding.'
  ...
  tag check_id: 'C-41127r858967_chk'
  tag severity: 'medium'
  tag gid: 'V-237917'
  tag rid: 'SV-237917r858969_rule'
  tag stig_id: 'IBMZ-VM-000600'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-41086r858968_fix'
  ...
  tag cci: ['CCI-000213', 'CCI-000366', 'CCI-000764', 'CCI-000804', 'CCI-001804']
  tag nist: ['AC-3', 'CM-6 b', 'IA-2', 'IA-8', 'CM-11 a']
end
