...
Facility ON
LOGON
Lockout after three attempts for 15 minutes, this is not a finding.
...
Lockout after 3 attempts for 15 minutes or 0 if system administrator action is desired.'
  ...
  tag check_id: 'C-41110r858928_chk'
  tag severity: 'medium'
  tag gid: 'V-237900'
  tag rid: 'SV-237900r858930_rule'
  tag stig_id: 'IBMZ-VM-000040'
  tag gtitle: 'SRG-OS-000021-GPOS-00005'
  tag fix_id: 'F-41069r858929_fix'
  tag 'documentable'
