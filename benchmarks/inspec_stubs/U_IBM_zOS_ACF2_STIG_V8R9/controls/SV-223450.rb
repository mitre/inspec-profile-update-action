...
The ACP data set rules for LPA libraries do not restrict UPDATE and/or ALTER access to only z/OS systems programming personnel.

The ACP data set rules for LPA libraries do not specify that all (i.e., failures and successes) UPDATE and/or ALTER access will be logged.'
...
Configure the update and allocate access to all LPA libraries to be limited to system programmers only and all update and allocate access is logged.'
  ...
  tag check_id: 'C-25123r504482_chk'
  tag severity: 'high'
  tag gid: 'V-223450'
  tag rid: 'SV-223450r853515_rule'
