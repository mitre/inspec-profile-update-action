...
If the perimeter router is not configured to block packets with IP options, this is a finding.'
  desc 'fix', 'Configure the perimeter router to block packets with IP options with the following commands:
...
!'
  ...
  tag check_id: 'C-59736r882520_chk'
  tag severity: 'medium'
  tag gid: 'V-256060'
  tag rid: 'SV-256060r882522_rule'
  tag stig_id: 'ARST-RT-000830'
  tag gtitle: 'SRG-NET-000205-RTR-000015'
  tag fix_id: 'F-59679r882521_fix'
  tag 'documentable'
  tag cci: ['CCI-002403']
  tag nist: ['SC-7 (11)']
end
