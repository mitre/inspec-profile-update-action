...
If this policy is not configured, all four schemes are used.'
  desc 'check', 'The policy value for "Computer Configuration/Administrative Templates/Microsoft Edge/HTTP authentication/Supported authentication schemes" must be set to "enabled" with the option value set to "ntlm,negotiate".

Use the Windows Registry Editor to navigate to the following key:
HKLM\\SOFTWARE\\Policies\\Microsoft\\Edge

If the value for "AuthSchemes" is not set to "REG_DWORD = 0", this is a finding.'
  ...
  tag check_id: 'C-38980r626479_chk'
  tag severity: 'medium'
  tag gid: 'V-235761'
  tag rid: 'SV-235761r626523_rule'
