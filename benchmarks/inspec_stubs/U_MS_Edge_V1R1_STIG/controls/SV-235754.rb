...
If the value for "ExtensionInstallBlocklist" is not set to "REG_SZ = *", this is a finding.'
  desc 'fix', 'Set the policy value for "Computer Configuration/Administrative Templates/Microsoft Edge/Extensions/Control which extensions cannot be installed" to "Enabled". A list of blacklisted extensions may then be specified.'
  impact 0.5
  ref 'DPMS Target Microsoft Edge'
  tag check_id: 'C-38973r626458_chk'
  tag severity: 'medium'
  tag gid: 'V-235754'
  tag rid: 'SV-235754r626523_rule'
  tag stig_id: 'EDGE-00-000041'
  tag gtitle: 'SRG-APP-000141'
  tag fix_id: 'F-38936r626459_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
