...
- TrackingPreventionStrict (3) = Strict (blocks harmful trackers and majority of trackers from all sites; content and ads will have minimal personalization; some parts of sites might not work)"
  desc 'check', %q(The policy value for "Computer Configuration/Administrative Templates/Microsoft Edge/Block tracking of users' web-browsing activity" must be set to "enabled" with the option value set to "2" or "3".

Use the Windows Registry Editor to navigate to the following key:
HKLM\SOFTWARE\Policies\Microsoft\Edge

If the value for "TrackingPrevention" is not set to "REG_DWORD = 1", this is a finding.)
  desc 'fix', %q(Set the policy value for "Computer Configuration/Administrative Templates/Microsoft Edge/Block tracking of users' web-browsing activity" to "2" or "3".)
  impact 0.5
  ref 'DPMS Target Microsoft Edge'
  tag check_id: 'C-38985r626494_chk'
  tag severity: 'medium'
  tag gid: 'V-235766'
  tag rid: 'SV-235766r626523_rule'
  tag stig_id: 'EDGE-00-000054'
  tag gtitle: 'SRG-APP-000148'
  tag fix_id: 'F-38948r626495_fix'
  tag 'documentable'
  tag cci: ['CCI-000388']
  tag nist: ['CM-7 (3)']
end
