...
'
  desc 'check', %q(Verify that the Ubuntu operating system utilizes the "pam_faillock" module with the following command:
...
unlock_time = 0'
  ...
  tag check_id: 'C-20891r802353_chk'
  tag severity: 'medium'
  tag gid: 'V-219166'
  tag rid: 'SV-219166r802355_rule'
  tag stig_id: 'UBTU-18-010033'
  tag gtitle: 'SRG-OS-000021-GPOS-00005'
  tag fix_id: 'F-20890r802354_fix'
