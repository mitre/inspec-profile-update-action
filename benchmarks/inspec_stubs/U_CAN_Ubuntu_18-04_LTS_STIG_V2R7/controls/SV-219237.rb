control 'SV-219237' do
  ...
  desc 'In order to ensure Ubuntu operating systems have sufficient storage capacity in which to write the audit logs, Ubuntu operating system needs to be able to allocate audit record storage capacity.
...
The task of allocating audit record storage capacity is usually performed during initial installation of the Ubuntu operating system.'
  desc 'check', "Verify the Ubuntu operating system allocates audit record storage capacity to store at least one week's worth of audit records when audit records are not immediately sent to a central audit record storage facility.
...
where <log mountpoint> is the aforementioned mount point.)
  ...
  tag check_id: 'C-20962r305039_chk'
  tag severity: 'low'
  tag gid: 'V-219237'
  tag rid: 'SV-219237r610963_rule'
  tag stig_id: 'UBTU-18-010314'
  tag gtitle: 'SRG-OS-000341-GPOS-00132'
  tag fix_id: 'F-20961r305040_fix'
  tag 'documentable'
  tag legacy: ['V-100701', 'SV-109805']
  tag cci: ['CCI-001849']
  tag nist: ['AU-4']
end
