...
'
  desc 'check', 'Verify that the Ubuntu operating system enforces SSH protocol 2 for network access.
...
If the returned line allows for use of protocol "1", is commented out, or the line is missing, this is a finding.'
  desc 'fix', 'Configure the Ubuntu operating system to enforce SSHv2 for network access to all accounts.
...
# systemctl restart sshd.service'
  ...
  tag check_id: 'C-21033r305252_chk'
  tag severity: 'high'
  tag gid: 'V-219308'
  tag rid: 'SV-219308r610963_rule'
