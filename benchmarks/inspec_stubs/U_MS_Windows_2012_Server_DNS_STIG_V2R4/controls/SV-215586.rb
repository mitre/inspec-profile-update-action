...
The other set, called internal name servers, is to be located within the firewall and should be configured so they are not reachable from outside and hence provide naming services exclusively to internal clients.'
  desc 'check', "Consult with the System Administrator to review the external Windows DNS Server's Endpoint Security Solution (ESS) firewall policy.
...
If neither the DNS server's ESS firewall policy nor the network firewall is configured to block internal hosts from querying the external DNS server, this is a finding."
  ...
  tag check_id: 'C-16780r804963_chk'
  tag severity: 'medium'
  tag gid: 'V-215586'
  tag rid: 'SV-215586r804964_rule'
