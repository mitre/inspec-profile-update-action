control 'SV-259082' do
  title 'The vCenter Perfcharts service "ErrorReportValve showServerInfo" must be set to "false".'
...
# vmon-cli --restart perfcharts'
  ...
  tag check_id: 'C-62822r934902_chk'
  tag severity: 'medium'
  tag gid: 'V-259082'
  tag rid: 'SV-259082r934904_rule'
  tag stig_id: 'VCPF-80-000067'
  tag gtitle: 'SRG-APP-000266-AS-000169'
  tag fix_id: 'F-62731r934903_fix'
  tag 'documentable'
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
end
