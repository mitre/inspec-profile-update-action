control 'SV-259071' do
  title 'The vCenter Perfcharts service must limit the number of maximum concurrent connections permitted.'
...
# xmllint --xpath '/Server/Service/Executor[@name="tomcatThreadPool"]/@maxThreads' /usr/lib/vmware-perfcharts/tc-instance/conf/server.xml
...
# vmon-cli --restart perfcharts'
  ...
  tag check_id: 'C-62811r934869_chk'
  tag severity: 'medium'
  tag gid: 'V-259071'
  tag rid: 'SV-259071r934871_rule'
  tag stig_id: 'VCPF-80-000001'
  tag gtitle: 'SRG-APP-000001-AS-000001'
  tag fix_id: 'F-62720r934870_fix'
