control 'SV-259085' do
  title 'The vCenter Perfcharts service must enable "STRICT_SERVLET_COMPLIANCE".'
...
# vmon-cli --restart perfcharts'
  ...
  tag check_id: 'C-62825r934911_chk'
  tag severity: 'medium'
  tag gid: 'V-259085'
  tag rid: 'SV-259085r934913_rule'
  tag stig_id: 'VCPF-80-000124'
  tag gtitle: 'SRG-APP-000516-AS-000237'
  tag fix_id: 'F-62734r934912_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
