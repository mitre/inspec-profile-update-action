control 'SV-259087' do
  title 'The vCenter Perfcharts service must limit the number of times that each Transmission Control Protocol (TCP) connection is kept alive.'
...
# vmon-cli --restart perfcharts'
  ...
  tag check_id: 'C-62827r934917_chk'
  tag severity: 'medium'
  tag gid: 'V-259087'
  tag rid: 'SV-259087r934919_rule'
  tag stig_id: 'VCPF-80-000126'
  tag gtitle: 'SRG-APP-000001-AS-000001'
  tag fix_id: 'F-62736r934918_fix'
  tag 'documentable'
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
end
