control 'SV-259100' do
  title 'The vCenter Perfcharts service must disable "ALLOW_BACKSLASH".'
...
# grep ALLOW_BACKSLASH /usr/lib/vmware-perfcharts/tc-instance/conf/catalina.properties
...
# vmon-cli --restart perfcharts'
  ...
  tag check_id: 'C-62840r934956_chk'
  tag severity: 'medium'
  tag gid: 'V-259100'
  tag rid: 'SV-259100r934958_rule'
  tag stig_id: 'VCPF-80-000151'
  tag gtitle: 'SRG-APP-000516-AS-000237'
  tag fix_id: 'F-62749r934957_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
