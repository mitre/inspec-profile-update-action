control 'SV-259077' do
  title 'The vCenter Perfcharts service must disable stack tracing.'
...
# vmon-cli --restart perfcharts)
  ...
  tag check_id: 'C-62817r934887_chk'
  tag severity: 'medium'
  tag gid: 'V-259077'
  tag rid: 'SV-259077r934889_rule'
  tag stig_id: 'VCPF-80-000036'
  tag gtitle: 'SRG-APP-000141-AS-000095'
  tag fix_id: 'F-62726r934888_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
