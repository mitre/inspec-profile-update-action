control 'SV-259076' do
  title 'The vCenter Perfcharts service must limit privileges for creating or modifying hosted application shared files.'
...
# vmon-cli --restart perfcharts'
  ...
  tag check_id: 'C-62816r934884_chk'
  tag severity: 'medium'
  tag gid: 'V-259076'
  tag rid: 'SV-259076r934886_rule'
  tag stig_id: 'VCPF-80-000034'
  tag gtitle: 'SRG-APP-000133-AS-000092'
  tag fix_id: 'F-62725r934885_fix'
  tag 'documentable'
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
end
