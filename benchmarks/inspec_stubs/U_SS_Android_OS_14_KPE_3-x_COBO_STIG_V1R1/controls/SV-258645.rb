control 'SV-258645' do
  title 'Samsung Android must be configured to not allow installation of applications with the following characteristics: 
...
SFR ID: FMT_SMF_EXT.1.1 #8b'
  desc 'check', 'Verify requirement KNOX-14-110190 (managed Google Play) has been implemented.

If managed Google Play has not been implemented, this is a finding.'
  desc 'fix', 'The Authorizing Official (AO) must not approve applications with the following characteristics for installation by users on the device:
...
Implement managed Google Play (refer to requirement KNOX-14-110190).'
  impact 0.5
  ref 'DPMS Target Samsung Android OS 14 with Knox 3.x COBO'
  tag check_id: 'C-62385r931133_chk'
  tag severity: 'medium'
  tag gid: 'V-258645'
  tag rid: 'SV-258645r931135_rule'
  tag stig_id: 'KNOX-14-110200'
  tag gtitle: 'PP-MDF-333070'
  tag fix_id: 'F-62294r931134_fix'
  tag 'documentable'
