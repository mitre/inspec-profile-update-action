...
SFR ID: FMT_MOF_EXT.1.2 #47'
  desc 'check', 'Review the configuration to determine if the Samsung Android devices disallow users from changing the date and time.
...
On the management tool, in the device restrictions, set "Configure Date/Time" to "Disallow".'
  ...
  tag check_id: 'C-62382r931124_chk'
  tag severity: 'medium'
  tag gid: 'V-258642'
  tag rid: 'SV-258642r931126_rule'
  tag stig_id: 'KNOX-14-110170'
  tag gtitle: 'PP-MDF-993300'
  tag fix_id: 'F-62291r931125_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
