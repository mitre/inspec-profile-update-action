...
- Force password information following FOTA update for consistency.
...
On the management tool, in the device restrictions, verify "Common Criteria mode" is set to "Enable".
...
On the management tool, in the device restrictions, set "Common Criteria mode" to "Enable".'
  ...
  tag check_id: 'C-62392r931154_chk'
  tag severity: 'low'
  tag gid: 'V-258652'
  tag rid: 'SV-258652r931156_rule'
  tag stig_id: 'KNOX-14-110280'
  tag gtitle: 'PP-MDF-993300'
  tag fix_id: 'F-62301r931155_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
