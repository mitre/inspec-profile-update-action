control 'SV-258648' do
  title 'Samsung Android must be configured to prevent users from adding personal email accounts to the work email app.'
  desc 'If the user is able to add a personal email account (POP3, IMAP, EAS) to the work email app, it could be used to forward sensitive DOD data to unauthorized recipients. Restricting email account addition to the Administrator or allowlisted accounts mitigates this vulnerability.
...
On the management tool, in the device restrictions, set "Modify accounts" to "Disallow".'
  ...
  tag check_id: 'C-62388r931142_chk'
  tag severity: 'medium'
  tag gid: 'V-258648'
  tag rid: 'SV-258648r931144_rule'
  tag stig_id: 'KNOX-14-110230'
  tag gtitle: 'PP-MDF-993300'
  tag fix_id: 'F-62297r931143_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
