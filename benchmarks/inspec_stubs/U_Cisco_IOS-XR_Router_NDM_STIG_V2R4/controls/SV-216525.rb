control 'SV-216525' do
  title 'The Cisco router must be configured to display the Standard Mandatory DoD Notice and Consent Banner before granting access to the device.'
...
If the Cisco router is not configured to display the Standard Mandatory DoD Notice and Consent Banner before granting access to the device, this is a finding.'
  desc 'fix', "Configure the Cisco router to display the Standard Mandatory DoD Notice and Consent Banner before granting access as shown in the following example:
...
RP/0/0/CPU0:R3(config)#end"
  ...
  tag check_id: 'C-17760r288261_chk'
  tag severity: 'medium'
  tag gid: 'V-216525'
  tag rid: 'SV-216525r879547_rule'
  tag stig_id: 'CISC-ND-000160'
  tag gtitle: 'SRG-APP-000068-NDM-000215'
  tag fix_id: 'F-17757r288262_fix'
  tag 'documentable'
  tag legacy: ['SV-105521', 'V-96383']
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
