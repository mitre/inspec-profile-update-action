...
Configuration settings are the set of parameters that can be changed in hardware, software, or firmware components of the system that affect the security posture and/or functionality of the system. Security-related parameters are those parameters impacting the security state of the system, including the parameters required to satisfy other security control requirements. Security-related parameters include, for example: registry settings; account, file, directory permission settings; and settings for functions, ports, protocols, services, and remote connections.'
  desc 'check', 'Refer to the TN3270 Profile configuration file identified by the PROFILE DD into the TN3270 procedure.
...
Any BEGINVTAM DEFAULTAPPL statement that does not specify a client identifier, or specifies any type of client identifier that would apply to unsecured terminals, specifies a session manager application or an NC PASS application as the application name.'
  ...
  tag check_id: 'C-25286r504800_chk'
  tag severity: 'medium'
  tag gid: 'V-223613'
  tag rid: 'SV-223613r533198_rule'
  tag stig_id: 'ACF2-TN-000060'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-25274r504801_fix'
  tag 'documentable'
  tag legacy: ['V-97931', 'SV-107035']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
