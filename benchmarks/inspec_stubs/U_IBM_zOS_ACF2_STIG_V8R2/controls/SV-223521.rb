control 'SV-223521' do
  title 'IBM z/OS warning banner for the FTP Server must be properly specified.'
...
-Notwithstanding the above, using this IS does not constitute consent to PM, LE or CI investigative searching or monitoring of the content of privileged communications, or work product, related to personal representation or services by attorneys, psychotherapists, or clergy, and their assistants. Such communications and work product are private and confidential. See User Agreement for details.'
  desc 'fix', 'Configure the FTP configuration to include the BANNER statement.'
  impact 0.5
  ref 'DPMS Target IBM zOS ACF2'
  tag check_id: 'C-25194r500697_chk'
  tag severity: 'medium'
  tag gid: 'V-223521'
  tag rid: 'SV-223521r533198_rule'
  tag stig_id: 'ACF2-FT-000050'
  tag gtitle: 'SRG-OS-000228-GPOS-00088'
  tag fix_id: 'F-25182r500698_fix'
  tag 'documentable'
  tag legacy: ['V-97747', 'SV-106851']
  tag cci: ['CCI-001384', 'CCI-001386', 'CCI-001385', 'CCI-001387', 'CCI-001388']
