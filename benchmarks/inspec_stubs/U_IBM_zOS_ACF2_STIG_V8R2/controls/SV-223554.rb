...
Ensure that all (i.e., failures and successes) UPDATE and/or ALTER access are logged.

Ensure read access failures are logged.'
  impact 0.5
  ref 'DPMS Target IBM zOS ACF2'
  tag check_id: 'C-25227r504692_chk'
  tag severity: 'medium'
  tag gid: 'V-223554'
  tag rid: 'SV-223554r533198_rule'
  tag stig_id: 'ACF2-OS-000180'
  tag gtitle: 'SRG-OS-000057-GPOS-00027'
  tag fix_id: 'F-25215r504693_fix'
  ...
  tag cci: ['CCI-001493', 'CCI-001494', 'CCI-001495', 'CCI-001314', 'CCI-000162', 'CCI-000163', 'CCI-000164', 'CCI-000213', 'CCI-002235']
  tag nist: ['AU-9 a', 'AU-9', 'AU-9', 'SI-11 b', 'AU-9 a', 'AU-9 a', 'AU-9 a', 'AC-3', 'AC-6 (10)']
end
