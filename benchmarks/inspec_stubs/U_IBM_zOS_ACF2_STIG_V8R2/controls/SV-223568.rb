control 'SV-223568' do
  title 'IBM z/OS must use SAF Key Rings for key management.'
...
If any files are found, this is a finding.'
  desc 'fix', 'Define all Keys/Certificates to the security database. Remove the all .kdb and .jks files.'
  impact 0.5
  ref 'DPMS Target IBM zOS ACF2'
  tag check_id: 'C-25241r695452_chk'
  tag severity: 'medium'
  tag gid: 'V-223568'
  tag rid: 'SV-223568r695454_rule'
  tag stig_id: 'ACF2-OS-000330'
  tag gtitle: 'SRG-OS-000067-GPOS-00035'
  tag fix_id: 'F-25229r695453_fix'
