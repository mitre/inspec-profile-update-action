...
The structure and content of error messages must be carefully considered by the organization and development team. The extent to which the information system is able to identify and handle error conditions is guided by organizational policy and operational requirements."
  desc 'check', 'Verify that the Ubuntu operating system configures the /var/log directory with a mode of "755" or less permissive.
...
$ sudo chmod 0755 /var/log'
  ...
  tag check_id: 'C-20916r880866_chk'
  tag severity: 'medium'
  tag gid: 'V-219191'
  tag rid: 'SV-219191r880868_rule'
  tag stig_id: 'UBTU-18-010124'
  tag gtitle: 'SRG-OS-000206-GPOS-00084'
  tag fix_id: 'F-20915r880867_fix'
  tag 'documentable'
