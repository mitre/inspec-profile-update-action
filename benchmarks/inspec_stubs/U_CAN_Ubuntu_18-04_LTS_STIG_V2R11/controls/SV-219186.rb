control 'SV-219186' do
  ...
  desc 'check', 'Verify the Ubuntu operating system has the libpam-pwquality package installed, by running the following command:
...
Note: The value of "retry" should be between "1" and "3".'
  ...
  tag check_id: 'C-20911r569487_chk'
  tag severity: 'medium'
  tag gid: 'V-219186'
  tag rid: 'SV-219186r610963_rule'
  tag stig_id: 'UBTU-18-010116'
  tag gtitle: 'SRG-OS-000480-GPOS-00225'
  tag fix_id: 'F-20910r569488_fix'
  tag 'documentable'
  tag legacy: ['V-100599', 'SV-109703']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
