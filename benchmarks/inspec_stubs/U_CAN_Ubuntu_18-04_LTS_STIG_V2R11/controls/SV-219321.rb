...
The DoD will only accept PKI-certificates obtained from a DoD-approved internal or external certificate authority. Reliance on CAs for the establishment of secure sessions includes, for example, the use of SSL/TLS certificates.'
  desc 'check', %q(Verify the directory containing the root certificates for the Ubuntu operating system only contains certificate files for DoD PKI-established certificate authorities by iterating over all files in the '/etc/ssl/certs' directory and checking if, at least one, has the subject matching "DOD ROOT CA".

If none is found, this is a finding.)
  desc 'fix', "Add at least one DOD certificate authority to the '/usr/local/share/ca-certificates' directory, then run the 'update-ca-certificates' command."
  impact 0.5
  ref 'DPMS Target Canonical Ubuntu 18.04 LTS'
  tag check_id: 'C-21046r305291_chk'
  tag severity: 'medium'
  tag gid: 'V-219321'
  tag rid: 'SV-219321r853389_rule'
  tag stig_id: 'UBTU-18-010436'
  tag gtitle: 'SRG-OS-000403-GPOS-00182'
  tag fix_id: 'F-21045r305292_fix'
  tag 'documentable'
  tag legacy: ['V-100865', 'SV-109969']
  tag cci: ['CCI-002470']
  tag nist: ['SC-23 (5)']
end
