...
'
  desc 'check', 'Verify the Ubuntu operating system generates an audit record upon successful/unsuccessful attempts to use the "chown", "fchown", "fchownat", and "lchown" system calls.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20975r809515_chk'
  tag severity: 'medium'
  tag gid: 'V-219250'
  tag rid: 'SV-219250r809517_rule'
  tag stig_id: 'UBTU-18-010327'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-20974r809516_fix'
