...
Notes: The '-k' allows for specifying an arbitrary identifier and the string after it does not need to match the example output above."
  desc 'fix', 'Configure the Ubuntu operating system to audit privileged activities.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20941r304976_chk'
  tag severity: 'medium'
  tag gid: 'V-219216'
  tag rid: 'SV-219216r610963_rule'
  tag stig_id: 'UBTU-18-010237'
  tag gtitle: 'SRG-OS-000471-GPOS-00215'
  tag fix_id: 'F-20940r304977_fix'
  tag 'documentable'
  tag legacy: ['SV-109763', 'V-100659']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
