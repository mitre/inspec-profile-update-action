control 'SV-234937' do
  title 'The SUSE operating system must generate audit records for all uses of the insmod command.'
...
'
  desc 'check', %q(Verify the SUSE operating system is generates an audit record for all uses of the "insmod" command.
...
The "-k" allows for specifying an arbitrary identifier. The string following "-k" does not need to match the example output above.)
  desc 'fix', 'Configure the SUSE operating system to audit the execution of the module management program "insmod" by adding the following line to "/etc/audit/rules.d/audit.rules":
...
> sudo augenrules --load'
  ...
  tag check_id: 'C-38125r619080_chk'
  tag severity: 'medium'
  tag gid: 'V-234937'
  tag rid: 'SV-234937r854244_rule'
  tag stig_id: 'SLES-15-030380'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-38088r619081_fix'
