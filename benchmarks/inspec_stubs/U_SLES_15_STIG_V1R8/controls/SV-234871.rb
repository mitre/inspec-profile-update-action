...
The SUSE operating system needs to track periods of inactivity and disable application identifiers after 35 days of inactivity.'
  desc 'check', %q(Verify the SUSE operating system disables account identifiers after 35 days of inactivity after the password expiration
...
DoD recommendation is "35" days, but a lower value greater than "0" is acceptable.'
  ...
  tag check_id: 'C-38059r618882_chk'
  tag severity: 'medium'
  tag gid: 'V-234871'
  tag rid: 'SV-234871r622137_rule'
  tag stig_id: 'SLES-15-020050'
  tag gtitle: 'SRG-OS-000118-GPOS-00060'
  tag fix_id: 'F-38022r618883_fix'
  tag 'documentable'
  tag cci: ['CCI-000795']
  tag nist: ['IA-4 e']
end
