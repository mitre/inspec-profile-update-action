...
'
  desc 'check', %q(Verify the SUSE operating system generates an audit record for all uses of the "passwd" command.
...
The "-k" allows for specifying an arbitrary identifier. The string following "-k" does not need to match the example output above.)
  desc 'fix', 'Configure the SUSE operating system to generate an audit record for all uses of the "passwd" command.
...
> sudo augenrules --load'
  ...
  tag check_id: 'C-38094r618987_chk'
  tag severity: 'medium'
  tag gid: 'V-234906'
  tag rid: 'SV-234906r854223_rule'
  tag stig_id: 'SLES-15-030070'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-38057r618988_fix'
