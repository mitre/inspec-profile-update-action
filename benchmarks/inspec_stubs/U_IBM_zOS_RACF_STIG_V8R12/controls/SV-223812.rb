control 'SV-223812' do
  title 'IBM z/OS permission bits and user audit bits for HFS objects that are part of the Syslog daemon component must be properly configured.'
...
chaudit rwx=f /log_dir/log_file"
  ...
  tag check_id: 'C-25485r515124_chk'
  tag severity: 'medium'
  tag gid: 'V-223812'
  tag rid: 'SV-223812r604139_rule'
  tag stig_id: 'RACF-SL-000010'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25473r515125_fix'
  tag 'documentable'
  tag legacy: ['V-98331', 'SV-107435']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
