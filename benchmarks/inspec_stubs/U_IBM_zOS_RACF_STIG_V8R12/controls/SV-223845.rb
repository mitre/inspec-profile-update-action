...
Define ESM data set rules for the data set referenced in the ROOT and the MOUNT statements in BPXPRMxx to restrict update and/or allocate access to systems programming personnel.'
  ...
  tag check_id: 'C-25518r515223_chk'
  tag severity: 'medium'
  tag gid: 'V-223845'
  tag rid: 'SV-223845r604139_rule'
  tag stig_id: 'RACF-US-000080'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25506r515224_fix'
  tag satisfies: ['SRG-OS-000080-GPOS-00048', 'SRG-OS-000259-GPOS-00100']
  tag 'documentable'
  tag legacy: ['V-98397', 'SV-107501']
