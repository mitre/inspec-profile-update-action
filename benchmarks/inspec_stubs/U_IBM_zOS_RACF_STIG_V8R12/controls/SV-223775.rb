...
/usr/sbin/sntpd 1740 faf'
  ...
  tag check_id: 'C-25448r515013_chk'
  tag severity: 'medium'
  tag gid: 'V-223775'
  tag rid: 'SV-223775r877038_rule'
  tag stig_id: 'RACF-OS-000190'
  tag gtitle: 'SRG-OS-000355-GPOS-00143'
  tag fix_id: 'F-25436r515014_fix'
  tag 'documentable'
  tag legacy: ['SV-107361', 'V-98257']
  tag cci: ['CCI-001891']
  tag nist: ['AU-8 (1) (a)']
end
