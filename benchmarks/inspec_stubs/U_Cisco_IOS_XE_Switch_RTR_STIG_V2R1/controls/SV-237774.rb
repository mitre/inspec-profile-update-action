...
If the switch is not configured to drop IPv6 packets containing an extension header with the Endpoint Identification option, this is a finding.'
  desc 'fix', 'Configure the switch to drop IPv6 packets containing an option type values of 0x8A (Endpoint Identification) regardless of whether it appears in a Hop-by-Hop or Destination Option header as shown in the example below.
...
SW1(config-if)#end'
  ...
  tag check_id: 'C-40986r648812_chk'
  tag severity: 'medium'
  tag gid: 'V-237774'
  tag rid: 'SV-237774r648815_rule'
  tag stig_id: 'CISC-RT-000396'
  tag gtitle: 'SRG-NET-000364-RTR-000204'
  tag fix_id: 'F-40945r648813_fix'
  tag 'documentable'
  tag cci: ['CCI-002403']
  tag nist: ['SC-7 (11)']
end
