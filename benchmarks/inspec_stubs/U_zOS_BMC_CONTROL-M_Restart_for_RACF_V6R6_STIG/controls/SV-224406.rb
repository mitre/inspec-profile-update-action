...
setr generic(dataset) refresh"
  ...
  tag check_id: 'C-26083r868390_chk'
  tag severity: 'medium'
  tag gid: 'V-224406'
  tag rid: 'SV-224406r868395_rule'
  tag stig_id: 'ZCTRR002'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-26071r868393_fix'
  tag 'documentable'
  tag legacy: ['V-21592', 'SV-32219']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
