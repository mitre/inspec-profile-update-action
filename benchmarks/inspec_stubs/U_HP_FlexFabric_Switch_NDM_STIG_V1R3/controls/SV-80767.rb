control 'SV-80767' do
  title 'The HP FlexFabric Switch must generate audit records when concurrent logons from different workstations occur.'
...
Note:  By default, the information center is enabled.'
  ...
  tag check_id: 'C-66923r1_chk'
  tag severity: 'medium'
  tag gid: 'V-66277'
  tag rid: 'SV-80767r1_rule'
  tag stig_id: 'HFFS-ND-000125'
  tag gtitle: 'SRG-APP-000506-NDM-000323'
  tag fix_id: 'F-72353r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
