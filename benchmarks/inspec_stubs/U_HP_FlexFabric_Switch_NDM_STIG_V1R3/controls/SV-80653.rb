control 'SV-80653' do
  title 'Upon successful logon, the HP FlexFabric Switch must notify the administrator of the number of unsuccessful logon attempts since the last successful logon.'
...
[HP]  password-control enable'
  ...
  tag check_id: 'C-66809r1_chk'
  tag severity: 'medium'
  tag gid: 'V-66163'
  tag rid: 'SV-80653r1_rule'
  tag stig_id: 'HFFS-ND-000019'
  tag gtitle: 'SRG-APP-000076-NDM-000218'
  tag fix_id: 'F-72239r1_fix'
  tag 'documentable'
