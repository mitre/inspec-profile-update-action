control 'SV-80763' do
  title 'The HP FlexFabric Switch must generate audit records for privileged activities or other system-level access.'
...
Note:  By default, the information center is enabled.'
  ...
  tag check_id: 'C-66919r1_chk'
  tag severity: 'medium'
  tag gid: 'V-66273'
  tag rid: 'SV-80763r1_rule'
  tag stig_id: 'HFFS-ND-000123'
  tag gtitle: 'SRG-APP-000504-NDM-000321'
  tag fix_id: 'F-72349r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
