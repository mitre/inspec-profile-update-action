control 'SV-80765' do
  title 'The HP FlexFabric Switch must generate audit records showing starting and ending time for administrator access to the system.'
...
Note:  By default, the information center is enabled.'
  ...
  tag check_id: 'C-66921r1_chk'
  tag severity: 'medium'
  tag gid: 'V-66275'
  tag rid: 'SV-80765r1_rule'
  tag stig_id: 'HFFS-ND-000124'
  tag gtitle: 'SRG-APP-000505-NDM-000322'
  tag fix_id: 'F-72351r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
