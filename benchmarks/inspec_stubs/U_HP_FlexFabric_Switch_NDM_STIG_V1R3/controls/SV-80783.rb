control 'SV-80783' do
  title 'The HP FlexFabric Switch must obtain its public key certificates from an appropriate certificate policy through an approved service provider.'
  desc 'For user certificates, each organization obtains certificates from an approved, shared service provider, as required by OMB policy. For federal agencies operating a legacy public key infrastructure cross-certified with the Federal Bridge Certification Authority at medium assurance or higher, this Certification Authority will suffice.'
  desc 'check', 'Determine if the HP FlexFabric Switch obtains public key certificates from an appropriate certificate policy through an approved service provider.
...
If the HP FlexFabric Switch does not obtain its public key certificates from an appropriate certificate policy through an approved service provider, this is a finding.'
  desc 'fix', 'Configure the HP FlexFabric Switch to obtain its public key certificates in offline mode from an appropriate certificate policy through an approved service provider.
...
Note: Configuration required on the server side is not covered here.'
  ...
  tag check_id: 'C-66939r1_chk'
  tag severity: 'medium'
  tag gid: 'V-66293'
  tag rid: 'SV-80783r1_rule'
  tag stig_id: 'HFFS-ND-000139'
  tag gtitle: 'SRG-APP-000516-NDM-000344'
  tag fix_id: 'F-72369r1_fix'
  tag 'documentable'
