control 'SV-80749' do
  ...
  desc 'check', 'Determine if the HP FlexFabric Switch implements cryptographic mechanisms to protect the integrity of nonlocal maintenance and diagnostic communications.
...
If SSH and SFTP protocols are not configured for nonlocal device maintenance , this is a finding.'
  desc 'fix', 'Configure the HP FlexFabric Switch to implement cryptographic mechanisms to protect the integrity of nonlocal maintenance and diagnostic communications.
...
[HP-luser-admin] service-type ssh'
  ...
  tag check_id: 'C-66905r1_chk'
  tag severity: 'medium'
  tag gid: 'V-66259'
  tag rid: 'SV-80749r1_rule'
  tag stig_id: 'HFFS-ND-000116'
  tag gtitle: 'SRG-APP-000411-NDM-000330'
  tag fix_id: 'F-72335r1_fix'
  tag 'documentable'
  tag cci: ['CCI-002890']
  tag nist: ['MA-4 (6)']
end
