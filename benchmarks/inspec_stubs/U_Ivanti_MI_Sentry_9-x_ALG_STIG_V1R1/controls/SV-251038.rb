control 'SV-251038' do
  title 'The Sentry providing encryption intermediary services must use NIST FIPS-validated cryptography to implement encryption services.'
...
9. Enter "Yes" at proceed do reload.'
  ...
  tag check_id: 'C-54473r802334_chk'
  tag severity: 'medium'
  tag gid: 'V-251038'
  tag rid: 'SV-251038r802336_rule'
  tag stig_id: 'MOIS-AL-001360'
  tag gtitle: 'SRG-NET-000510-ALG-000111'
  tag fix_id: 'F-54427r802335_fix'
  tag 'documentable'
  tag cci: ['CCI-002450']
  tag nist: ['SC-13 b']
end
