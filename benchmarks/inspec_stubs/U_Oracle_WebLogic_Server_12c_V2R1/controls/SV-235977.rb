...
20. Select checkbox for all servers configured in previous steps and click 'Restart SSL'"
  ...
  tag check_id: 'C-39196r628707_chk'
  tag severity: 'medium'
  tag gid: 'V-235977'
  tag rid: 'SV-235977r628709_rule'
  tag stig_id: 'WBLC-06-000190'
  tag gtitle: 'SRG-APP-000440-AS-000167'
  tag fix_id: 'F-39159r628708_fix'
  tag 'documentable'
  tag legacy: ['SV-70557', 'V-56303']
  tag cci: ['CCI-002421']
  tag nist: ['SC-8 (1)']
end
