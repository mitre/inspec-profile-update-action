...
7. Click the 'Start Up' button for the server or cluster to start up again"
  ...
  tag check_id: 'C-39164r628611_chk'
  tag severity: 'low'
  tag gid: 'V-235945'
  tag rid: 'SV-235945r628613_rule'
  tag stig_id: 'WBLC-02-000076'
  tag gtitle: 'SRG-APP-000096-AS-000059'
  tag fix_id: 'F-39127r628612_fix'
  tag 'documentable'
  tag legacy: ['SV-70493', 'V-56239']
  tag cci: ['CCI-000131']
  tag nist: ['AU-3 b']
end
