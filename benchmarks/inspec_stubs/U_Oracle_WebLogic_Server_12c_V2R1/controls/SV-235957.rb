...
9. Repeat steps 5-8 for all users that must not have audit tool configuration access"
  ...
  tag check_id: 'C-39176r628647_chk'
  tag severity: 'medium'
  tag gid: 'V-235957'
  tag rid: 'SV-235957r628649_rule'
  tag stig_id: 'WBLC-02-000098'
  tag gtitle: 'SRG-APP-000121-AS-000081'
  tag fix_id: 'F-39139r628648_fix'
  tag 'documentable'
  tag legacy: ['SV-70517', 'V-56263']
  tag cci: ['CCI-001493']
  tag nist: ['AU-9 a']
end
