...
7. Refer to section 2.2.4 of the Overview document'
  ...
  tag check_id: 'C-39194r628701_chk'
  tag severity: 'medium'
  tag gid: 'V-235975'
  tag rid: 'SV-235975r628703_rule'
  tag stig_id: 'WBLC-05-000176'
  tag gtitle: 'SRG-APP-000179-AS-000129'
  tag fix_id: 'F-39157r628702_fix'
  tag 'documentable'
  tag legacy: ['SV-70553', 'V-56299']
  tag cci: ['CCI-000803']
  tag nist: ['IA-7']
end
