...
8. Set 'Minimum Number of Numeric Characters' field value to '1' or higher. Click 'Save'"
  ...
  tag check_id: 'C-39188r628683_chk'
  tag severity: 'medium'
  tag gid: 'V-235969'
  tag rid: 'SV-235969r628685_rule'
  tag stig_id: 'WBLC-05-000164'
  tag gtitle: 'SRG-APP-000516-AS-000237'
  tag fix_id: 'F-39151r628684_fix'
  tag 'documentable'
  tag legacy: ['SV-70541', 'V-56287']
  tag cci: ['CCI-000194']
  tag nist: ['IA-5 (1) (a)']
end
