control 'SV-253870' do
  title 'Tanium Comply must be configured to receive Open Vulnerability and Assessment Language (OVAL) feeds only from trusted sources.'
...
6. Delete any vulnerability sources configured to nontrusted sources or reconfigure them to point to trusted sources.'
  ...
  tag check_id: 'C-57322r842636_chk'
  tag severity: 'medium'
  tag gid: 'V-253870'
  tag rid: 'SV-253870r842638_rule'
  tag stig_id: 'TANS-SV-000053'
  tag gtitle: 'SRG-APP-000039'
  tag fix_id: 'F-57273r842637_fix'
  tag 'documentable'
  tag cci: ['CCI-001414']
  tag nist: ['AC-4']
end
