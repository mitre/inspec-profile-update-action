...
If the documentation does not reflect a granular, least-privileged-access approach to the LDAP Groups/Tanium Roles assignment, this is a finding."
  desc 'fix', %q(1. Using a web browser on a system that has connectivity to the Tanium application, access the Tanium application web user interface (UI) and log on with multifactor authentication. 
...
8. Ensure LDAP sync repopulates the Tanium users' associated Roles accordingly.)
  ...
  tag check_id: 'C-57248r842414_chk'
  tag severity: 'medium'
  tag gid: 'V-253796'
  tag rid: 'SV-253796r850215_rule'
  tag stig_id: 'TANS-00-001395'
  tag gtitle: 'SRG-APP-000380'
  tag fix_id: 'F-57199r842415_fix'
  tag 'documentable'
  tag cci: ['CCI-001813']
  tag nist: ['CM-5 (1) (a)']
end
