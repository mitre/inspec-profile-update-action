control 'SV-253794' do
  title 'The Tanium application must provide an immediate real-time alert to the system administrator and information system security officer, at a minimum, of all audit failure events requiring real-time alerts.'
...
Work with the SIEM administrator to configure alerts based on audit failures.'
  ...
  tag check_id: 'C-57246r842408_chk'
  tag severity: 'medium'
  tag gid: 'V-253794'
  tag rid: 'SV-253794r850195_rule'
  tag stig_id: 'TANS-00-001320'
  tag gtitle: 'SRG-APP-000360'
  tag fix_id: 'F-57197r842409_fix'
  tag 'documentable'
  tag cci: ['CCI-001858']
  tag nist: ['AU-5 (2)']
end
