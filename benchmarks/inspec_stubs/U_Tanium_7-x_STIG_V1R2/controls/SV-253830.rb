control 'SV-253830' do
  title 'Tanium must notify system administrators and the information system security officer (ISSO) for account removal actions.'
...
6. Work with the SIEM administrator to configure an alert when accounts are deleted.'
  ...
  tag check_id: 'C-57282r842516_chk'
  tag severity: 'medium'
  tag gid: 'V-253830'
  tag rid: 'SV-253830r842518_rule'
  tag stig_id: 'TANS-CN-000033'
  tag gtitle: 'SRG-APP-000294'
  tag fix_id: 'F-57233r842517_fix'
  tag 'documentable'
  tag cci: ['CCI-001686']
  tag nist: ['AC-2 (4)']
end
