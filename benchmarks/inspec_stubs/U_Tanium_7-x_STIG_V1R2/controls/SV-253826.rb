control 'SV-253826' do
  title 'Tanium must notify system administrators and the information system security officer (ISSO) when accounts are modified.'
...
7. Work with the SIEM administrator to configure an alert when accounts are modified.'
  ...
  tag check_id: 'C-57278r842504_chk'
  tag severity: 'medium'
  tag gid: 'V-253826'
  tag rid: 'SV-253826r842506_rule'
  tag stig_id: 'TANS-CN-000020'
  tag gtitle: 'SRG-APP-000292'
  tag fix_id: 'F-57229r842505_fix'
  tag 'documentable'
  tag cci: ['CCI-001684']
  tag nist: ['AC-2 (4)']
end
