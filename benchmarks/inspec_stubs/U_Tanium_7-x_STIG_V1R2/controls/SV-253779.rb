control 'SV-253779' do
  title 'The Tanium application must be configured to send audit records from multiple components within the system to a central location for review and analysis.'
...
9. Click "Create Connection".'
  ...
  tag check_id: 'C-57231r842363_chk'
  tag severity: 'medium'
  tag gid: 'V-253779'
  tag rid: 'SV-253779r842365_rule'
  tag stig_id: 'TANS-00-000155'
  tag gtitle: 'SRG-APP-000111'
  tag fix_id: 'F-57182r842364_fix'
  tag 'documentable'
  tag cci: ['CCI-000154']
  tag nist: ['AU-6 (4)']
end
