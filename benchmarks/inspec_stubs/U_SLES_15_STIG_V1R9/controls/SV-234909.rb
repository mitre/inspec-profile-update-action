...
'
  desc 'check', %q(Verify the SUSE operating system generates an audit record for all uses of the "chsh" command.
...
The "-k" allows for specifying an arbitrary identifier. The string following "-k" does not need to match the example output above.)
  desc 'fix', 'Configure the SUSE operating system to generate an audit record for all uses of the "chsh" command.
...
> sudo augenrules --load'
  ...
  tag check_id: 'C-38097r618996_chk'
  tag severity: 'low'
  tag gid: 'V-234909'
  tag rid: 'SV-234909r854226_rule'
  tag stig_id: 'SLES-15-030100'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-38060r618997_fix'
