...
'
  desc 'check', %q(Verify the SUSE operating system generates an audit record for all uses of the "rm" command.
...
> sudo augenrules --load'
  ...
  tag check_id: 'C-38133r619104_chk'
  tag severity: 'medium'
  tag gid: 'V-234945'
  tag rid: 'SV-234945r854252_rule'
  tag stig_id: 'SLES-15-030460'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-38096r619105_fix'
