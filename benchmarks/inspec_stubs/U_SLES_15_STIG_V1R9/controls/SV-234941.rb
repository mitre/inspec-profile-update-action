...
'
  desc 'check', %q(Verify the SUSE operating system generates an audit record for all uses of the "chmod" command.
...
> sudo augenrules --load'
  ...
  tag check_id: 'C-38129r619092_chk'
  tag severity: 'medium'
  tag gid: 'V-234941'
  tag rid: 'SV-234941r854248_rule'
  tag stig_id: 'SLES-15-030420'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-38092r619093_fix'
