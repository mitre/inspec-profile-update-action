...
MICS.- UID(secaaudt) R(A) E(A)"
  ...
  tag check_id: 'C-25943r868189_chk'
  tag severity: 'medium'
  tag gid: 'V-224270'
  tag rid: 'SV-224270r868191_rule'
  tag stig_id: 'ZMICA000'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-25931r868190_fix'
  tag 'documentable'
  tag legacy: ['V-16932', 'SV-49769']
