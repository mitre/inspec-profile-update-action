control 'SV-207247' do
  title 'For accounts using password authentication, the site-to-site VPN Gatewy must use SHA-2 or later protocol to protect the integrity of the password authentication process.'
