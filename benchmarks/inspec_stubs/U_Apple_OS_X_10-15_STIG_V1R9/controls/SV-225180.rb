...
If the return does not contain "/Applications/Calendar.app", this is a finding.'
  ...
  tag check_id: 'C-26879r467708_chk'
  tag severity: 'medium'
  tag gid: 'V-225180'
  tag rid: 'SV-225180r610901_rule'
  tag stig_id: 'AOSX-15-002023'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26867r467709_fix'
  tag 'documentable'
  tag legacy: ['SV-111741', 'V-102779']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
