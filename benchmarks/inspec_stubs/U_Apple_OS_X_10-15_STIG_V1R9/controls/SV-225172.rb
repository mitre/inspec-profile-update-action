...
If the result is not “allowCloudAddressBook = 0”, this is a finding.'
  ...
  tag check_id: 'C-26871r467684_chk'
  tag severity: 'low'
  tag gid: 'V-225172'
  tag rid: 'SV-225172r610901_rule'
  tag stig_id: 'AOSX-15-002014'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26859r467685_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['V-102761', 'SV-111723']
