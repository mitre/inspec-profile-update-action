...
# /usr/bin/sudo /usr/bin/sed -i.bak 's/^#Banner.*/Banner \\/etc\\/banner/' /etc/ssh/sshd_config"
  ...
  tag check_id: 'C-26834r467573_chk'
  tag severity: 'medium'
  tag gid: 'V-225135'
  tag rid: 'SV-225135r610901_rule'
  tag stig_id: 'AOSX-15-000024'
  tag gtitle: 'SRG-OS-000023-GPOS-00006'
  tag fix_id: 'F-26822r467574_fix'
  tag satisfies: ['SRG-OS-000023-GPOS-00006', 'SRG-OS-000024-GPOS-00007']
  tag 'documentable'
  tag legacy: ['V-102685', 'SV-111647']
