...
'
  desc 'check', %q(To check if the system is configured to disable access to the Internet Accounts preference pane, run the following command:
...
If the return is not an array which contains: "com.apple.preferences.internetaccounts", this is a finding.)
  ...
  tag check_id: 'C-26881r755164_chk'
  tag severity: 'medium'
  tag gid: 'V-225182'
  tag rid: 'SV-225182r755165_rule'
  tag stig_id: 'AOSX-15-002032'
  tag gtitle: 'SRG-OS-000370-GPOS-00155'
  tag fix_id: 'F-26869r467715_fix'
  tag satisfies: ['SRG-OS-000370-GPOS-00155', 'SRG-OS-000095-GPOS-00049']
  tag 'documentable'
  tag legacy: ['SV-111745', 'V-102783']
