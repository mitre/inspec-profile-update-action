...
Uncheck the box labeled "Enable Location Services".'
  ...
  tag check_id: 'C-26861r467654_chk'
  tag severity: 'medium'
  tag gid: 'V-225162'
  tag rid: 'SV-225162r610901_rule'
  tag stig_id: 'AOSX-15-002004'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26849r467655_fix'
  tag 'documentable'
  tag legacy: ['SV-111705', 'V-102743']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
