...
If the return is not “pinHistory = 5” or greater, this is a finding.'
  ...
  tag check_id: 'C-26906r467789_chk'
  tag severity: 'medium'
  tag gid: 'V-225207'
  tag rid: 'SV-225207r610901_rule'
  tag stig_id: 'AOSX-15-003009'
  tag gtitle: 'SRG-OS-000077-GPOS-00045'
  tag fix_id: 'F-26894r467790_fix'
  tag 'documentable'
  tag legacy: ['V-102833', 'SV-111795']
  tag cci: ['CCI-000200']
  tag nist: ['IA-5 (1) (e)']
end
