...
If the return is not, "NoMulticastAdvertisements = 1", this is a finding.'
  ...
  tag check_id: 'C-26862r621620_chk'
  tag severity: 'medium'
  tag gid: 'V-225163'
  tag rid: 'SV-225163r610901_rule'
  tag stig_id: 'AOSX-15-002005'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26850r467658_fix'
  tag 'documentable'
  tag legacy: ['V-102865', 'SV-111827']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
