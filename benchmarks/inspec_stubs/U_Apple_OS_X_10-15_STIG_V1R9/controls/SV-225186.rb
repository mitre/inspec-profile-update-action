...
If the return is not “SkipiCloudStorageSetup = 1”, this is a finding.'
  ...
  tag check_id: 'C-26885r467726_chk'
  tag severity: 'medium'
  tag gid: 'V-225186'
  tag rid: 'SV-225186r610901_rule'
  tag stig_id: 'AOSX-15-002037'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26873r467727_fix'
  tag 'documentable'
  tag legacy: ['V-102791', 'SV-111753']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
