...
If the return is not two arrays (HiddenPreferencePanes and DisabledPreferencePanes) each containing: "com.apple.preferences.Bluetooth", this is a finding.)
  ...
  tag check_id: 'C-56158r819049_chk'
  tag severity: 'low'
  tag gid: 'V-252702'
  tag rid: 'SV-252702r819051_rule'
  tag stig_id: 'AOSX-15-002062'
  tag gtitle: 'SRG-OS-000481-GPOS-00481'
  tag fix_id: 'F-56108r819050_fix'
  tag 'documentable'
  tag legacy: ['V-102811', 'SV-111773']
  tag cci: ['CCI-002418']
  tag nist: ['SC-8']
end
