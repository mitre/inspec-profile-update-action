...
If the file is managed by "aslmanager", find the configuration line in the directory "/etc/asl/" or the file "/etc/asl.conf" and add or edit the mode option to be "mode=0640" or less permissive.'
  ...
  tag check_id: 'C-26916r467819_chk'
  tag severity: 'medium'
  tag gid: 'V-225217'
  tag rid: 'SV-225217r610901_rule'
  tag stig_id: 'AOSX-15-004002'
  tag gtitle: 'SRG-OS-000206-GPOS-00084'
  tag fix_id: 'F-26904r485782_fix'
  tag 'documentable'
  tag legacy: ['V-102853', 'SV-111815']
  tag cci: ['CCI-001314']
  tag nist: ['SI-11 b']
end
