...
If the text is not worded exactly this way, this is a finding.'
  ...
  tag check_id: 'C-26835r467576_chk'
  tag severity: 'medium'
  tag gid: 'V-225136'
  tag rid: 'SV-225136r610901_rule'
  tag stig_id: 'AOSX-15-000025'
  tag gtitle: 'SRG-OS-000023-GPOS-00006'
  tag fix_id: 'F-26823r467577_fix'
  tag satisfies: ['SRG-OS-000023-GPOS-00006', 'SRG-OS-000024-GPOS-00007', 'SRG-OS-000228-GPOS-00088']
  tag 'documentable'
  tag legacy: ['V-102687', 'SV-111649']
