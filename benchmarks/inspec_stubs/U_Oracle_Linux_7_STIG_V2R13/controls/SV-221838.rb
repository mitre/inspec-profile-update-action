...
* hard maxlogins 10'
  ...
  tag check_id: 'C-36322r602560_chk'
  tag severity: 'low'
  tag gid: 'V-221838'
  tag rid: 'SV-221838r877399_rule'
  tag stig_id: 'OL07-00-040000'
  tag gtitle: 'SRG-OS-000027-GPOS-00008'
  tag fix_id: 'F-36286r602561_fix'
  tag 'documentable'
  tag legacy: ['V-99415', 'SV-108519']
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
end
