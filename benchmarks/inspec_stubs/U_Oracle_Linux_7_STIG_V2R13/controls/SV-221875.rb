control 'SV-221875' do
  title 'The Oracle Linux operating system must use a reverse-path filter for IPv4 network traffic when possible by default.'
...
Issue the following command to make the changes take effect:
  ...
  tag check_id: 'C-23590r880640_chk'
  tag severity: 'medium'
  tag gid: 'V-221875'
  tag rid: 'SV-221875r880642_rule'
  tag stig_id: 'OL07-00-040612'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-23579r880641_fix'
  tag 'documentable'
  tag legacy: ['V-99489', 'SV-108593']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
