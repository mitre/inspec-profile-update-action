control 'SV-221874' do
  ...
  desc 'Enabling reverse path filtering drops packets with invalid source addresses received on the interface.  It should not be used on systems that are routers for complicated networks, but is helpful for end hosts and routers serving small networks.'
...
Issue the following command to make the changes take effect:
  ...
  tag check_id: 'C-23589r880637_chk'
  tag severity: 'medium'
  tag gid: 'V-221874'
  tag rid: 'SV-221874r880639_rule'
  tag stig_id: 'OL07-00-040611'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-23578r880638_fix'
  tag 'documentable'
