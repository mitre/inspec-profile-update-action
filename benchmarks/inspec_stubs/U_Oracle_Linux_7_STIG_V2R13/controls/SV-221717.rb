control 'SV-221717' do
  title 'The Oracle Linux operating system must be configured so that the x86 Ctrl-Alt-Delete key sequence is disabled on the command line.'
...
If the ctrl-alt-del.target is active, this is a finding.'
  ...
  tag check_id: 'C-36276r928538_chk'
  tag severity: 'high'
  tag gid: 'V-221717'
  tag rid: 'SV-221717r928540_rule'
  tag stig_id: 'OL07-00-020230'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-36240r928539_fix'
  tag 'documentable'
  tag legacy: ['V-99171', 'SV-108275']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
