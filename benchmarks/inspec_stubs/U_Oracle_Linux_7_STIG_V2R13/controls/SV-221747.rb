control 'SV-221747' do
  title 'The Oracle Linux operating system must mount /dev/shm with secure options.'
...
If /dev/shm is mounted without secure options "nodev", "nosuid", and "noexec", this is a finding.'
  desc 'fix', 'Configure the system so that /dev/shm is mounted with the "nodev", "nosuid", and "noexec" options by adding /modifying the /etc/fstab with the following line:

tmpfs /dev/shm tmpfs defaults,nodev,nosuid,noexec 0 0'
  impact 0.3
  ref 'DPMS Target Oracle Linux 7'
  tag check_id: 'C-36281r602437_chk'
  tag severity: 'low'
  tag gid: 'V-221747'
  tag rid: 'SV-221747r853676_rule'
  tag stig_id: 'OL07-00-021024'
  tag gtitle: 'SRG-OS-000368-GPOS-00154'
  tag fix_id: 'F-36245r602438_fix'
  tag 'documentable'
  tag legacy: ['SV-108337', 'V-99233']
  tag cci: ['CCI-001764']
  tag nist: ['CM-7 (2)']
end
