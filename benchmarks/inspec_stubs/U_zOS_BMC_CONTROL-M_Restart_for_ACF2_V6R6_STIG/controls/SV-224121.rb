...
$KEY(SYS2)
IOA.-.CTRO.-  UID(<syspaudt>) R(A) W(L) A(L) E(A)
IOA.-.CTRO.-  UID(<audtaudt>) R(A)  E(A)
IOA.-.CTRO.-  UID(<bmcuser>) R(A)  E(A)
IOA.-.CTRO.-  UID(CONTROLR) R(A)  E(A)"
  impact 0.5
  ref 'DPMS Target zOS BMC CONTROL-M Restart for ACF2'
  tag check_id: 'C-25794r868154_chk'
  tag severity: 'medium'
  tag gid: 'V-224121'
  tag rid: 'SV-224121r868156_rule'
  tag stig_id: 'ZCTRA000'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-25782r868155_fix'
  tag 'documentable'
  tag legacy: ['V-16932', 'SV-31831']
