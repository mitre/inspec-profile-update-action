control 'SV-252861' do
  title 'Zebra Android 11 must be configured to disable developer modes.'
  desc 'Developer modes expose features of the Zebra Android device that are not available during standard operation. An adversary may leverage a vulnerability inherent in a developer mode to compromise the confidentiality, integrity, and availability of DoD sensitive information. Disabling developer modes mitigates this risk.

SFR ID: FMT_SMF_EXT.1.1 #26'
  desc 'check', 'Review Zebra Android device configuration settings to determine whether a developer mode is enabled.
...
If the EMM console device policy is not set to disable developer mode or on the Android 11 device, the device policy is not set to disable developer mode, this is a finding.'
  desc 'fix', 'Configure the Zebra Android 11 device to disable developer modes.
...
4. Toggle "Disallow debugging features" to "On".'
  ...
  tag check_id: 'C-56317r820508_chk'
  tag severity: 'medium'
  tag gid: 'V-252861'
  tag rid: 'SV-252861r820510_rule'
  tag stig_id: 'ZEBR-11-002800'
  tag gtitle: 'PP-MDF-301170'
  tag fix_id: 'F-56267r820509_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
