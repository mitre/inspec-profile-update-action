control 'SV-252851' do
  title 'Zebra Android 11 must be configured to not allow passwords that include more than four repeating or sequential characters.'
...
SFR ID: FMT_SMF_EXT.1.1 #1b'
  desc 'check', 'Review Zebra Android device configuration settings to determine if the mobile device is prohibiting passwords with more than four repeating or sequential characters.
...
If the EMM console device policy is set to a password with more than four repeating or sequential characters or on the Android 11 device, the device policy is set to a password with more than four repeating or sequential characters, this is a finding.
...
Note: Alphabetic, Alphanumeric, and Complex are also acceptable selections, but these selections will cause the user to select a complex password, which is not required by the STIG.'
  desc 'fix', 'Configure the Zebra Android 11 device to prevent passwords from containing more than four repeating or sequential characters.
...
Note: Alphabetic, Alphanumeric, and Complex are also acceptable selections, but these selections will cause the user to select a complex password, which is not required by the STIG.'
  ...
  tag check_id: 'C-56307r820478_chk'
  tag severity: 'medium'
  tag gid: 'V-252851'
  tag rid: 'SV-252851r820480_rule'
  tag stig_id: 'ZEBR-11-000200'
  tag gtitle: 'PP-MDF-301020'
  tag fix_id: 'F-56257r820479_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
