control 'SV-234567' do
  title 'Citrix Delivery Controller must be configured to disable non-essential capabilities.'
...
Examples of non-essential capabilities include but are not limited to advertising software or browser plug-ins not related to requirements or providing a wide array of functionality not required for every mission but that cannot be disabled.'
  desc 'check', 'Verify Citrix Customer Experience Improvement Program (CEIP) - PHONE HOME is disabled on Delivery Controller.
...
/quiet /verboselog /noreboot'
  ...
  tag check_id: 'C-37752r615788_chk'
  tag severity: 'medium'
  tag gid: 'V-234567'
  tag rid: 'SV-234567r628794_rule'
  tag stig_id: 'CVAD-DC-000270'
  tag gtitle: 'SRG-APP-000141'
  tag fix_id: 'F-37717r615789_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
