...
# chkconfig rexec off'
  ...
  tag check_id: 'C-9169r357728_chk'
  tag severity: 'high'
  tag gid: 'V-208916'
  tag rid: 'SV-208916r793702_rule'
  tag stig_id: 'OL6-00-000216'
  tag gtitle: 'SRG-OS-000033'
  tag fix_id: 'F-9169r357729_fix'
  tag 'documentable'
  tag legacy: ['V-50559', 'SV-64765']
  tag cci: ['CCI-000068']
  tag nist: ['AC-17 (2)']
end
