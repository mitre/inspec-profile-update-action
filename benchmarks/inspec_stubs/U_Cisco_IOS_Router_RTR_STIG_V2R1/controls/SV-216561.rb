control 'SV-216561' do
  ...
  desc 'check', 'Review the external and internal Access Control Lists (ACLs) to verify that the router is configured to only allow specific management and control plane traffic from specific sources destined to itself.
...
R1(config-if)#ip access-group INTERNAL_ACL in'
  ...
  tag check_id: 'C-17796r287067_chk'
  tag severity: 'high'
  tag gid: 'V-216561'
  tag rid: 'SV-216561r531085_rule'
  tag stig_id: 'CISC-RT-000130'
  tag gtitle: 'SRG-NET-000205-RTR-000001'
  tag fix_id: 'F-17792r287068_fix'
  tag 'documentable'
  tag legacy: ['SV-105661', 'V-96523']
  tag cci: ['CCI-001097']
  tag nist: ['SC-7 a']
end
