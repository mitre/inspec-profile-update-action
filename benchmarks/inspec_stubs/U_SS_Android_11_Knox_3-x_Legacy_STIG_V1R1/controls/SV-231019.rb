...
If on the management tool the Work Environment "app installation allowlist" includes apps with unauthorized characteristics, this is a finding.'
...
- If the management tool supports adding apps to the "app installation allowlist" by package name and/or digital signature or supports a combination of the two.'
  ...
  tag check_id: 'C-33949r592671_chk'
  tag severity: 'medium'
  tag gid: 'V-231019'
  tag rid: 'SV-231019r608683_rule'
  tag stig_id: 'KNOX-11-002000'
  tag gtitle: 'PP-MDF-301100'
  tag fix_id: 'F-33922r592672_fix'
  tag 'documentable'
