...
If the setting "etcd-cafile" is not configured in the Kubernetes kube-apiserver manifest file, this is a finding.'
  desc 'fix', 'Edit the Kubernetes kube-apiserver manifest file in the /etc/kubernetes/manifests directory on the Kubernetes Master Node. 

Set the value of "--etcd-cafile" to the Certificate Authority for etcd.'
  impact 0.5
  ref 'DPMS Target Kubernetes'
  tag check_id: 'C-45704r808587_chk'
  tag severity: 'medium'
  tag gid: 'V-242429'
  tag rid: 'SV-242429r808589_rule'
  tag stig_id: 'CNTR-K8-001510'
  tag gtitle: 'SRG-APP-000219-CTR-000550'
  tag fix_id: 'F-45662r808588_fix'
  tag 'documentable'
  tag cci: ['CCI-001184']
  tag nist: ['SC-23']
end
