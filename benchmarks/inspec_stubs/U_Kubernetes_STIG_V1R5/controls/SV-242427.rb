...
To enable encrypted communication for etcd, the parameter key-file must be set. This parameter gives the location of the key file used to secure etcd communication.'
  desc 'check', 'Change to the /etc/kubernetes/manifests directory on the Kubernetes Master Node. 
...
Set the value of "--key-file" to the Approved Organizational Certificate.'
  ...
  tag check_id: 'C-45702r808581_chk'
  tag severity: 'medium'
  tag gid: 'V-242427'
  tag rid: 'SV-242427r808583_rule'
  tag stig_id: 'CNTR-K8-001490'
  tag gtitle: 'SRG-APP-000219-CTR-000550'
  tag fix_id: 'F-45660r808582_fix'
  tag 'documentable'
  tag cci: ['CCI-001184']
  tag nist: ['SC-23']
end
