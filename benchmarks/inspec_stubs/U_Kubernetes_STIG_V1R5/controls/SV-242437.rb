control 'SV-242437' do
  ...
  desc 'check', 'PodSecurityPolicy is planned to be officially deprecated in Kubernetes version 1.21 and removed in version 1.25.
Pod Security Standards (PSS) will be replacing this check. 
...
kubectl create -f restricted.yml"
  ...
  tag check_id: 'C-45712r821608_chk'
  tag severity: 'high'
  tag gid: 'V-242437'
  tag rid: 'SV-242437r821610_rule'
  tag stig_id: 'CNTR-K8-002010'
  tag gtitle: 'SRG-APP-000342-CTR-000775'
  tag fix_id: 'F-45670r821609_fix'
  tag 'documentable'
  tag cci: ['CCI-002233']
  tag nist: ['AC-6 (8)']
end
