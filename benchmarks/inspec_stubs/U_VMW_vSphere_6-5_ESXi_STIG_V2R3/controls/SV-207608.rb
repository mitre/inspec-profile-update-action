control 'SV-207608' do
  ...
  desc 'check', "From the vSphere Web Client select the ESXi Host and go to Configure >> System >> Advanced System Settings. Select the Annotations.WelcomeMessage value and verify it contains the DoD logon banner to follow.
...
<script end>'
  ...
  tag check_id: 'C-7863r364223_chk'
  tag severity: 'medium'
  tag gid: 'V-207608'
  tag rid: 'SV-207608r378520_rule'
  tag stig_id: 'ESXI-65-000007'
  tag gtitle: 'SRG-OS-000023-VMM-000060'
  tag fix_id: 'F-7863r364224_fix'
  tag 'documentable'
  tag legacy: ['V-93961', 'SV-104047']
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
