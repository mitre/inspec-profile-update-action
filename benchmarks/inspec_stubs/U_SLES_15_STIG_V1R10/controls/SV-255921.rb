control 'SV-255921' do
  title 'The SUSE operating system must restrict access to the kernel message buffer.'
...
Reload settings from all system configuration files with the following command:
  ...
  tag check_id: 'C-59598r880962_chk'
  tag severity: 'low'
  tag gid: 'V-255921'
  tag rid: 'SV-255921r880964_rule'
  tag stig_id: 'SLES-15-010375'
  tag gtitle: 'SRG-OS-000138-GPOS-00069'
  tag fix_id: 'F-59541r880963_fix'
  tag 'documentable'
  tag cci: ['CCI-001090']
  tag nist: ['SC-4']
end
