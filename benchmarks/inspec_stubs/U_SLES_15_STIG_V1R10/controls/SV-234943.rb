...
'
  desc 'check', %q(Verify the SUSE operating system generates an audit record for all uses of the "chacl" command.
...
> sudo augenrules --load'
  ...
  tag check_id: 'C-38131r619098_chk'
  tag severity: 'medium'
  tag gid: 'V-234943'
  tag rid: 'SV-234943r854250_rule'
  tag stig_id: 'SLES-15-030440'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-38094r619099_fix'
