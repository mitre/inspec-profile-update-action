...
'
  desc 'check', %q(Verify the SUSE operating system generates an audit record for any use of the "crontab" command.
...
> sudo augenrules --load'
  ...
  tag check_id: 'C-38100r619005_chk'
  tag severity: 'medium'
  tag gid: 'V-234912'
  tag rid: 'SV-234912r854229_rule'
  tag stig_id: 'SLES-15-030130'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-38063r619006_fix'
