...
'
  desc 'check', %q(Verify the SUSE operating system generates an audit record for all uses of the "ssh-keysign" command.
...
The "-k" allows for specifying an arbitrary identifier. The string following "-k" does not need to match the example output above.)
  desc 'fix', 'Configure the SUSE operating system to generate an audit record for all uses of the "ssh-keysign" command.
...
> sudo augenrules --load'
  ...
  tag check_id: 'C-38093r618984_chk'
  tag severity: 'low'
  tag gid: 'V-234905'
  tag rid: 'SV-234905r854222_rule'
  tag stig_id: 'SLES-15-030060'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-38056r618985_fix'
