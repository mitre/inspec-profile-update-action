...
Note: In most cases, OS updates are released by the wireless carrier (for example, Sprint, T-Mobile, Verizon Wireless, and ATT).'
  ...
  tag check_id: 'C-44509r680338_chk'
  tag severity: 'high'
  tag gid: 'V-241233'
  tag rid: 'SV-241233r680340_rule'
  tag stig_id: 'KNOX-10-012500'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-44468r680339_fix'
  tag 'documentable'
  tag legacy: ['SV-109099', 'V-99995']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
