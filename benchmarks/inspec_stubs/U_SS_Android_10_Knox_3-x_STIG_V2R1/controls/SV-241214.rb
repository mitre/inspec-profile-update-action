...
On the management tool, in the Work Environment KPE RCP section, set "Sync calendar to personal" to "Disallow".'
  ...
  tag check_id: 'C-44490r680281_chk'
  tag severity: 'medium'
  tag gid: 'V-241214'
  tag rid: 'SV-241214r852774_rule'
  tag stig_id: 'KNOX-10-004800'
  tag gtitle: 'PP-MDF-301260'
  tag fix_id: 'F-44449r680282_fix'
  tag 'documentable'
  tag legacy: ['SV-109061', 'V-99957']
