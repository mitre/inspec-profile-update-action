...
On the management tool, in the Work Environment restrictions section, set "Autofill services" to "Disallow".'
  ...
  tag check_id: 'C-44499r680308_chk'
  tag severity: 'medium'
  tag gid: 'V-241223'
  tag rid: 'SV-241223r680310_rule'
  tag stig_id: 'KNOX-10-010600'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-44458r680309_fix'
  tag 'documentable'
  tag legacy: ['SV-109079', 'V-99975']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
