...
On the management tool, in the device KPE restrictions section, set "Unsecured hotspot" to "Disallow".'
  ...
  tag check_id: 'C-44487r680272_chk'
  tag severity: 'medium'
  tag gid: 'V-241211'
  tag rid: 'SV-241211r852771_rule'
  tag stig_id: 'KNOX-10-004200'
  tag gtitle: 'PP-MDF-301240'
  tag fix_id: 'F-44446r680273_fix'
  tag 'documentable'
  tag legacy: ['SV-109055', 'V-99951']
  tag cci: ['CCI-002314']
  tag nist: ['AC-17 (1)']
end
