...
On the management tool, in the device password requirements section, verify the "minimum password length" is set to "6".
...
If on the management tool the "minimum password length" is not set to "6", or on the Samsung Android device the text "PIN must contain at least" is followed by a value of less than "6 digits", this is a finding.'
  desc 'fix', 'Configure Samsung Android to enforce a minimum password length of six characters.

On the management tool, in the device password requirements section, set the "minimum password length" to "6".'
  impact 0.5
  ref 'DPMS Target Samsung Android OS 10 with Knox 3-x'
  tag check_id: 'C-44468r680215_chk'
  tag severity: 'medium'
  tag gid: 'V-241192'
  tag rid: 'SV-241192r680217_rule'
  tag stig_id: 'KNOX-10-000100'
  tag gtitle: 'PP-MDF-301010'
  tag fix_id: 'F-44427r680216_fix'
  tag 'documentable'
  tag legacy: ['SV-109017', 'V-99913']
  tag cci: ['CCI-000205']
  tag nist: ['IA-5 (1) (a)']
end
