...
Note: Google Play must not be disabled. Disabling Google Play will cause system instability and critical updates will not be received.'
  ...
  tag check_id: 'C-44473r680230_chk'
  tag severity: 'medium'
  tag gid: 'V-241197'
  tag rid: 'SV-241197r852765_rule'
  tag stig_id: 'KNOX-10-000800'
  tag gtitle: 'PP-MDF-301080'
  tag fix_id: 'F-44432r680231_fix'
  tag 'documentable'
  tag legacy: ['SV-109027', 'V-99923']
