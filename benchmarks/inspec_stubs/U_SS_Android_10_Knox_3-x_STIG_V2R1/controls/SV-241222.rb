...
- AO guidance on acceptable use and restrictions, if any, on downloading and installing personal apps and data (music, photos, etc.) in the Samsung device personal space.'
  ...
  tag check_id: 'C-44498r680305_chk'
  tag severity: 'medium'
  tag gid: 'V-241222'
  tag rid: 'SV-241222r680307_rule'
  tag stig_id: 'KNOX-10-009900'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-44457r680306_fix'
  tag 'documentable'
  tag legacy: ['SV-109077', 'V-99973']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
