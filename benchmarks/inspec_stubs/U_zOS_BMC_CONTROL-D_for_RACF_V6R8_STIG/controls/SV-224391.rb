...
setr generic(dataset) refresh"
  ...
  tag check_id: 'C-26068r868346_chk'
  tag severity: 'medium'
  tag gid: 'V-224391'
  tag rid: 'SV-224391r868348_rule'
  tag stig_id: 'ZCTDR001'
  tag gtitle: 'SRG-OS-000259'
  tag fix_id: 'F-26056r868347_fix'
  tag 'documentable'
  tag legacy: ['V-17067', 'SV-32166']
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
end
