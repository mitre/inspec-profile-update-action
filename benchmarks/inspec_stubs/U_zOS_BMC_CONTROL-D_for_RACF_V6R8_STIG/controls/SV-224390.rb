...
setr generic(dataset) refresh"
  ...
  tag check_id: 'C-26067r868343_chk'
  tag severity: 'medium'
  tag gid: 'V-224390'
  tag rid: 'SV-224390r868345_rule'
  tag stig_id: 'ZCTDR000'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-26055r868344_fix'
  tag 'documentable'
  tag legacy: ['V-16932', 'SV-31828']
