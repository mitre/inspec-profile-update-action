...
If the Central Log Server is not configured so changes made to the level and type of log records stored in the centralized repository must take effect immediately without the need to reboot or restart the application, this is a finding.'
  ...
  tag check_id: 'C-45096r695403_chk'
  tag severity: 'low'
  tag gid: 'V-241820'
  tag rid: 'SV-241820r695405_rule'
  tag stig_id: 'SRG-APP-000516-AU-000060'
  tag gtitle: 'SRG-APP-000516'
  tag fix_id: 'F-45055r695404_fix'
  tag 'documentable'
  tag legacy: ['SV-95853', 'V-81139']
  tag cci: ['CCI-000366', 'CCI-001914']
  tag nist: ['CM-6 b', 'AU-12 (3)']
end
