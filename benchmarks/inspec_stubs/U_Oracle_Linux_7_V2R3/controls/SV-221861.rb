...
If Kerberos authentication is required, it must be documented, to include the location of the configuration file, with the ISSO.'
  ...
  tag check_id: 'C-23576r419655_chk'
  tag severity: 'medium'
  tag gid: 'V-221861'
  tag rid: 'SV-221861r603260_rule'
  tag stig_id: 'OL07-00-040440'
  tag gtitle: 'SRG-OS-000364-GPOS-00151'
  tag fix_id: 'F-23565r419656_fix'
  tag 'documentable'
  tag legacy: ['V-99461', 'SV-108565']
  tag cci: ['CCI-001813']
  tag nist: ['CM-5 (1) (a)']
end
