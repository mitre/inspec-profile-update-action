control 'SV-221782' do
  title 'The Oracle Linux operating system must audit all uses of the chmod syscall.'
...
'
  desc 'check', 'Verify the operating system generates audit records when successful/unsuccessful attempts to use the "chmod" syscall occur.
...
If both the "b32" and "b64" audit rules are not defined for the "chmod" syscall, this is a finding.'
  desc 'fix', 'Configure the operating system to generate audit records when successful/unsuccessful attempts to use the "chmod" syscall occur.
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-36299r602491_chk'
  tag severity: 'medium'
  tag gid: 'V-221782'
  tag rid: 'SV-221782r603260_rule'
  tag stig_id: 'OL07-00-030410'
  tag gtitle: 'SRG-OS-000458-GPOS-00203'
  tag fix_id: 'F-36263r602492_fix'
