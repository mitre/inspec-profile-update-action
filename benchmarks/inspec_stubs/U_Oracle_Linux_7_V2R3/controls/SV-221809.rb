...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-23524r419499_chk'
  tag severity: 'medium'
  tag gid: 'V-221809'
  tag rid: 'SV-221809r603260_rule'
  tag stig_id: 'OL07-00-030690'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-23513r419500_fix'
  ...
  tag 'documentable'
  tag legacy: ['V-99357', 'SV-108461']
  tag cci: ['CCI-000172', 'CCI-000130']
  tag nist: ['AU-12 c', 'AU-3 a']
end
