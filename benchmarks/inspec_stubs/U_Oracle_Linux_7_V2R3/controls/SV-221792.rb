control 'SV-221792' do
  title 'The Oracle Linux operating system must audit all uses of the open syscall.'
...
'
  desc 'check', 'Verify the operating system generates audit records when successful/unsuccessful attempts to use the "open" syscall occur.
...
If the output does not produce a rule containing "-F exit=-EACCES", this is a finding.'
  desc 'fix', 'Configure the operating system to generate audit records when successful/unsuccessful attempts to use the "open" syscall occur.
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-36309r602521_chk'
  tag severity: 'medium'
  tag gid: 'V-221792'
  tag rid: 'SV-221792r603260_rule'
  tag stig_id: 'OL07-00-030510'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-36273r602522_fix'
