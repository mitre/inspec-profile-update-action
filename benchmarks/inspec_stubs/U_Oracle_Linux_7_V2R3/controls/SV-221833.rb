control 'SV-221833' do
  title 'The Oracle Linux operating system must audit all uses of the unlink syscall.'
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-36320r602554_chk'
  tag severity: 'medium'
  tag gid: 'V-221833'
  tag rid: 'SV-221833r603260_rule'
  tag stig_id: 'OL07-00-030910'
  tag gtitle: 'SRG-OS-000466-GPOS-00210'
  tag fix_id: 'F-36284r602555_fix'
