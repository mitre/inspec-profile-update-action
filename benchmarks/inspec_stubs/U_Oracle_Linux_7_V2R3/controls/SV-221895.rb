...
# yum install pam_pkcs11'
  ...
  tag check_id: 'C-36330r602584_chk'
  tag severity: 'medium'
  tag gid: 'V-221895'
  tag rid: 'SV-221895r603260_rule'
  tag stig_id: 'OL07-00-041001'
  tag gtitle: 'SRG-OS-000105-GPOS-00052'
  tag fix_id: 'F-36294r602585_fix'
  tag satisfies: ['SRG-OS-000375-GPOS-00160', 'SRG-OS-000375-GPOS-00161', 'SRG-OS-000377-GPOS-00162']
  tag 'documentable'
  tag legacy: ['V-99529', 'SV-108633']
  tag cci: ['CCI-001954', 'CCI-001953', 'CCI-001948']
