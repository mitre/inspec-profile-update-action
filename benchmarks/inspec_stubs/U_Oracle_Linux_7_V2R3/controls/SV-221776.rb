control 'SV-221776' do
  ...
  desc 'check', 'Verify the operating system immediately notifies the SA and ISSO (at a minimum) via email when the threshold for the repository maximum audit record storage capacity is reached.
...
action_mail_acct = root'
  ...
  tag check_id: 'C-23491r419400_chk'
  tag severity: 'medium'
  tag gid: 'V-221776'
  tag rid: 'SV-221776r603260_rule'
  tag stig_id: 'OL07-00-030350'
  tag gtitle: 'SRG-OS-000343-GPOS-00134'
  tag fix_id: 'F-23480r419401_fix'
  tag 'documentable'
  tag legacy: ['V-99291', 'SV-108395']
  tag cci: ['CCI-001855']
  tag nist: ['AU-5 (1)']
end
