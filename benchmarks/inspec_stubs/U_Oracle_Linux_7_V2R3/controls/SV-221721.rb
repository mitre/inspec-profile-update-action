control 'SV-221721' do
  title 'The Oracle Linux operating system must not have unnecessary accounts.'
...
Document all authorized accounts on the system.'
  ...
  tag check_id: 'C-23436r419235_chk'
  tag severity: 'medium'
  tag gid: 'V-221721'
  tag rid: 'SV-221721r603260_rule'
  tag stig_id: 'OL07-00-020270'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-23425r419236_fix'
  tag 'documentable'
  tag legacy: ['SV-108283', 'V-99179']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
