control 'SV-221690' do
  title 'The Oracle Linux operating system must be configured to lock accounts for a minimum of 15 minutes after three unsuccessful logon attempts within a 15-minute timeframe.'
...
Note: Manual changes to the listed files may be overwritten by the "authconfig" program. The "authconfig" program should not be used to update the configurations listed in this requirement.'
  ...
  tag check_id: 'C-36268r602398_chk'
  tag severity: 'medium'
  tag gid: 'V-221690'
  tag rid: 'SV-221690r603787_rule'
  tag stig_id: 'OL07-00-010320'
  tag gtitle: 'SRG-OS-000021-GPOS-00005'
  tag fix_id: 'F-36232r622251_fix'
  tag satisfies: ['SRG-OS-000329-GPOS-00128', 'SRG-OS-000021-GPOS-00005']
  tag 'documentable'
  tag legacy: ['V-99119', 'SV-108223']
  tag cci: ['CCI-002236', 'CCI-002237', 'CCI-002238', 'CCI-000044']
  tag nist: ['AC-7 b', 'AC-7 b', 'AC-7 b', 'AC-7 a']
end
