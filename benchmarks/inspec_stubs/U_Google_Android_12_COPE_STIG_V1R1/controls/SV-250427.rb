...
SFR ID: FMT_SMF_EXT.1.1 #18'
  desc 'check', 'Review managed Google Android 12 device settings to determine if the Google Android 12 device displays (work profile) notifications on the lock screen. Notifications of incoming phone calls are acceptable even when the device is locked. 
...
If the EMM console device policy allows work notifications on the lock screen, or the managed Google Android 12 device allows work notifications on the lock screen, this is a finding.'
  desc 'fix', 'Configure the Google Android 12 device to not display (work profile) notifications when the device is locked.
...
4. Toggle "Disable unredacted notifications".'
  ...
  tag check_id: 'C-53862r802645_chk'
  tag severity: 'medium'
  tag gid: 'V-250427'
  tag rid: 'SV-250427r802647_rule'
  tag stig_id: 'GOOG-12-006800'
  tag gtitle: 'PP-MDF-323080'
  tag fix_id: 'F-53816r802646_fix'
  tag 'documentable'
  tag cci: ['CCI-000060']
  tag nist: ['AC-11 (1)']
end
