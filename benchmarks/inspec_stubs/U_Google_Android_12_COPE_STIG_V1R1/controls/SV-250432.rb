...
SFR ID: FMT_SMF_EXT.1.1 #39'
  desc 'check', 'Review managed Google Android 12 device configuration settings to determine if the mobile device has a USB mass storage mode and whether it has been disabled. 
...
If the EMM console device policy is not set to disable USB mass storage mode or on the managed Google Android 12 device, the device policy is not set to disable USB mass storage mode, this is a finding.'
  desc 'fix', 'Configure the Google Android 12 device to disable USB mass storage mode.
...
3. Toggle "Disallow USB file transfer" to ON.'
  ...
  tag check_id: 'C-53867r802660_chk'
  tag severity: 'medium'
  tag gid: 'V-250432'
  tag rid: 'SV-250432r802812_rule'
  tag stig_id: 'GOOG-12-008400'
  tag gtitle: 'PP-MDF-323230'
  tag fix_id: 'F-53821r802811_fix'
  tag 'documentable'
  tag cci: ['CCI-002546']
  tag nist: ['SC-41']
end
