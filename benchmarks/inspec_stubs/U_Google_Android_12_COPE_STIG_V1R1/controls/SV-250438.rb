...
SFR ID: FMT_SMF_EXT.1.1/WLAN'
  desc 'check', 'Review the managed Google Android 12 device configuration settings to determine if the mobile device is configured to disable ad hoc wireless client-to-client connection capability.
...
If the EMM console device policy is not set to disable Location sharing and configuration, this is a finding.'
  desc 'fix', 'Configure the Google Android 12 device to disable ad hoc wireless client-to-client connection capability.
...
Note:  Wi-Fi Direct and ad hoc requires Location services to function; therefore, disabling this setting will disable the ad hoc and Wi-Fi Direct feature.'
  ...
  tag check_id: 'C-53873r802676_chk'
  tag severity: 'medium'
  tag gid: 'V-250438'
  tag rid: 'SV-250438r802788_rule'
  tag stig_id: 'GOOG-12-009500'
  tag gtitle: 'PP-MDF-323330'
  tag fix_id: 'F-53827r802787_fix'
  tag 'documentable'
  tag cci: ['CCI-002536']
  tag nist: ['SC-40']
end
