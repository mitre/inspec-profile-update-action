...
If the EMM console device policy is not set to disable data sharing between profiles, this is a finding.'
  desc 'fix', 'Configure the Google Android 12 device to enable the access control policy that prevents [selection: application processes, groups of application processes] from accessing [selection: all, private] data stored by other [selection: application processes, groups of application processes].
...
4. Toggle "Disallow sharing data into the profile" to ON.'
  ...
  tag check_id: 'C-53870r802667_chk'
  tag severity: 'medium'
  tag gid: 'V-250435'
  tag rid: 'SV-250435r802669_rule'
  tag stig_id: 'GOOG-12-008900'
  tag gtitle: 'PP-MDF-323280'
  tag fix_id: 'F-53824r802668_fix'
  tag 'documentable'
