...
SFR ID: FMT_SMF_EXT.1.1 #40'
  desc 'check', 'Review managed Google Android 12 device configuration settings to determine if the capability to back up to a locally connected system has been disabled. 
...
If the EMM console device policy is not set to disable the capability to back up to a locally connected system or on the managed Google Android 12 device, the device policy is not set to disable the capability to back up to a locally connected system, this is a finding.'
  desc 'fix', 'Configure the Google Android 12 device to disable backup to locally connected systems.
...
2. Toggle "Enable backup service" to OFF.'
  ...
  tag check_id: 'C-53868r802663_chk'
  tag severity: 'medium'
  tag gid: 'V-250433'
  tag rid: 'SV-250433r802665_rule'
  tag stig_id: 'GOOG-12-008500'
  tag gtitle: 'PP-MDF-323240'
  tag fix_id: 'F-53822r802664_fix'
  tag 'documentable'
  tag cci: ['CCI-001090']
  tag nist: ['SC-4']
end
