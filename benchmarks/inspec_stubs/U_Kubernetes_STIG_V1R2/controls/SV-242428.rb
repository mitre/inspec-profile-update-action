...
To enable encrypted communication for etcd, the parameter certfile must be set. This parameter gives the location of the SSL certification file used to secure etcd communication.'
  desc 'check', 'Change to the /etc/kubernetes/manifests directory on the Kubernetes Master Node. Run the command:

grep -i certfile * 

If the setting "certfile" is not configured in the Kubernetes etcd manifest file, this is a finding.'
  desc 'fix', 'Edit the Kubernetes etcd manifest file in the /etc/kubernetes/manifests directory on the Kubernetes Master Node. 

Set the value of "--certfile" to the Approved Organizational Certificate.'
  impact 0.5
  ref 'DPMS Target Kubernetes'
  tag check_id: 'C-45703r754814_chk'
  tag severity: 'medium'
  tag gid: 'V-242428'
  tag rid: 'SV-242428r754816_rule'
  tag stig_id: 'CNTR-K8-001500'
  tag gtitle: 'SRG-APP-000219-CTR-000550'
  tag fix_id: 'F-45661r754815_fix'
  tag 'documentable'
  tag cci: ['CCI-001184']
  tag nist: ['SC-23']
end
