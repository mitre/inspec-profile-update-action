control 'SV-254586' do
  title 'Apple iOS/iPadOS 16 must [selection: wipe protected data, wipe sensitive data] upon unenrollment from MDM.'
...
If one or more managed apps are not set to be removed upon device MDM unenrollment, this is a finding.'
  ...
  tag check_id: 'C-58197r862012_chk'
  tag severity: 'medium'
  tag gid: 'V-254586'
  tag rid: 'SV-254586r862014_rule'
  tag stig_id: 'AIOS-16-004900'
  tag gtitle: 'PP-MDF-321400'
  tag fix_id: 'F-58143r862013_fix'
  tag 'documentable'
