control 'SV-254595' do
  title 'Apple iOS/iPadOS 16 allow list must be configured to not include applications with the following characteristics: allow voice dialing when MD is locked.'
...
If "Allow voice dialing when locked not allowed" is checked in the Apple iOS/iPadOS management tool or the restrictions policy on the iPhone and iPad does not list "Voice dialing while locked not allowed", this is a finding.'
  ...
  tag check_id: 'C-58206r862039_chk'
  tag severity: 'medium'
  tag gid: 'V-254595'
  tag rid: 'SV-254595r862041_rule'
  tag stig_id: 'AIOS-16-007300'
  tag gtitle: 'PP-MDF-323070'
  tag fix_id: 'F-58152r862040_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
