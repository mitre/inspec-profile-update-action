control 'SV-254581' do
  title 'Apple iOS/iPadOS 16 must not allow backup to remote systems (iCloud Keychain).'
...
If "Allow iCloud keychain" is checked in the Apple iOS/iPadOS management tool, "<key>allowCloudKeychainSync</key><true/>" appears in the configuration profile, or "iCloud Keychain not allowed" is not listed on the iPhone and iPad, this is a finding.)
  ...
  tag check_id: 'C-58192r861997_chk'
  tag severity: 'medium'
  tag gid: 'V-254581'
  tag rid: 'SV-254581r862185_rule'
  tag stig_id: 'AIOS-16-003300'
  tag gtitle: 'PP-MDF-321290'
  tag fix_id: 'F-58138r861998_fix'
  tag 'documentable'
