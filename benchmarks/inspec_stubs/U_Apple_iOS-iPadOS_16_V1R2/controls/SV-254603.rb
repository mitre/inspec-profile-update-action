control 'SV-254603' do
  title 'Apple iOS/iPadOS 16 must be configured to [selection: wipe protected data, wipe sensitive data] upon unenrollment from MDM.'
...
If one or more managed apps are not set to be removed upon device MDM unenrollment, this is a finding.'
  ...
  tag check_id: 'C-58214r862063_chk'
  tag severity: 'medium'
  tag gid: 'V-254603'
  tag rid: 'SV-254603r862065_rule'
  tag stig_id: 'AIOS-16-009900'
  tag gtitle: 'PP-MDF-323300'
  tag fix_id: 'F-58160r862064_fix'
  tag 'documentable'
