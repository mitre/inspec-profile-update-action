control 'SV-254627' do
  title 'Apple iOS/iPadOS 16 must implement the management setting: Disable paired Apple Watch.'
...
If the AO has not approved pairing an Apple Watch with a DoD-owned iPhone and "Paired Apple Watch not allowed" is not listed both in the management tool and on the Apple device, this is a finding.'
  ...
  tag check_id: 'C-58238r862135_chk'
  tag severity: 'medium'
  tag gid: 'V-254627'
  tag rid: 'SV-254627r862215_rule'
  tag stig_id: 'AIOS-16-012600'
  tag gtitle: 'PP-MDF-990000'
  tag fix_id: 'F-58184r862136_fix'
  tag 'documentable'
