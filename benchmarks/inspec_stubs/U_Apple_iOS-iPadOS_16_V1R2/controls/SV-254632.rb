control 'SV-254632' do
  title 'Apple iOS/iPadOS 16 must disable Find My Friends in the Find My app.'
  desc "This control does not share a DoD user's location but encourages location sharing between DoD mobile device users, which can lead to operational security (OPSEC) risks. Sharing the location of a DoD mobile device is a violation of AIOS-16-011700.
...
If "Find My Friends" and "Allow modifying Find My Friends" are not disabled in the management tool and on the Apple device, this is a finding.'
  ...
  tag check_id: 'C-58243r862150_chk'
  tag severity: 'low'
  tag gid: 'V-254632'
  tag rid: 'SV-254632r862220_rule'
  tag stig_id: 'AIOS-16-013100'
  tag gtitle: 'PP-MDF-990000'
  tag fix_id: 'F-58189r862151_fix'
  tag 'documentable'
