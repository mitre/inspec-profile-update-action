control 'SV-254583' do
  title 'Apple iOS/iPadOS 16 must not allow backup to remote systems (iCloud Photo Sharing, also known as Shared Photo Streams).'
...
If "Allow iCloud Photos" is checked in the Apple iOS/iPadOS management tool, "<key>allowSharedStream</key><true/>" appears in the configuration profile, or the restrictions policy on the iPhone and iPad does not list "Shared streams not allowed", this is a finding.)
  ...
  tag check_id: 'C-58194r862003_chk'
  tag severity: 'medium'
  tag gid: 'V-254583'
  tag rid: 'SV-254583r862187_rule'
  tag stig_id: 'AIOS-16-003500'
  tag gtitle: 'PP-MDF-321290'
  tag fix_id: 'F-58140r862004_fix'
  tag 'documentable'
