control 'SV-254630' do
  title 'Apple iOS/iPadOS 16 must disable password proximity requests.'
...
If "Proximity password requests not allowed" is not disabled in the management tool and on the Apple device, this is a finding.'
  ...
  tag check_id: 'C-58241r862144_chk'
  tag severity: 'medium'
  tag gid: 'V-254630'
  tag rid: 'SV-254630r862218_rule'
  tag stig_id: 'AIOS-16-012900'
  tag gtitle: 'PP-MDF-990000'
  tag fix_id: 'F-58187r862145_fix'
  tag 'documentable'
