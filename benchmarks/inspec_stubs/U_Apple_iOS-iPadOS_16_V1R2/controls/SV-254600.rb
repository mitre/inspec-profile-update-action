control 'SV-254600' do
  title 'Apple iOS/iPadOS 16 must be configured to not allow backup of [all applications, configuration data] to locally connected systems.'
...
Note: iTunes Backup/Finder backup is implemented by the configuration policy rule "Force encrypted backups", which is included in AIOS-16-010700 and therefore not included in the procedure below.
...
If backing up app data is not disabled in the Apple iOS/iPadOS management tool or "app data will not be backed up" is not listed for each managed app on the iPhone and iPad, this is a finding.'
  ...
  tag check_id: 'C-58211r862054_chk'
  tag severity: 'medium'
  tag gid: 'V-254600'
  tag rid: 'SV-254600r862056_rule'
  tag stig_id: 'AIOS-16-009200'
  tag gtitle: 'PP-MDF-323240'
  tag fix_id: 'F-58157r862055_fix'
  tag 'documentable'
  tag cci: ['CCI-001090']
  tag nist: ['SC-4']
end
