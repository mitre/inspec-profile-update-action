...
If "lock-enabled" is not set to "true", this is a finding.'
  desc 'fix', 'Configure the Ubuntu operating system so that it allows a user to lock the current graphical user interface session.
...
# sudo gsettings set org.gnome.desktop.screensaver lock-enabled true'
  ...
  tag check_id: 'C-21027r305234_chk'
  tag severity: 'medium'
  tag gid: 'V-219302'
  tag rid: 'SV-219302r610963_rule'
  tag stig_id: 'UBTU-18-010401'
  tag gtitle: 'SRG-OS-000028-GPOS-00009'
  tag fix_id: 'F-21026r305235_fix'
  tag 'documentable'
  tag legacy: ['V-100827', 'SV-109931']
  tag cci: ['CCI-000056']
  tag nist: ['AC-11 b']
end
