...
Peripherals include, but are not limited to, such devices as flash drives, external storage, and printers.'
  desc 'check', 'Note: The "install" and "blacklist" methods are utilized together to fully disable automatic mounting of the USB mass storage driver.
...
$ sudo su -c "echo blacklist usb-storage >> /etc/modprobe.d/DISASTIG.conf"'
  ...
  tag check_id: 'C-21064r802370_chk'
  tag severity: 'medium'
  tag gid: 'V-219339'
  tag rid: 'SV-219339r853398_rule'
  tag stig_id: 'UBTU-18-010509'
  tag gtitle: 'SRG-OS-000378-GPOS-00163'
  tag fix_id: 'F-21063r802371_fix'
  tag 'documentable'
