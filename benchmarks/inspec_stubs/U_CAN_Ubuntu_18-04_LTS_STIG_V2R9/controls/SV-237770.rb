control 'SV-237770' do
  ...
  desc 'check', %q(Verify the assigned home directory of all local interactive users is group-owned by that user’s primary Group Identifier (GID).
...
$ sudo chgrp users /home/smithj'
  ...
  tag check_id: 'C-40984r648740_chk'
  tag severity: 'medium'
  tag gid: 'V-237770'
