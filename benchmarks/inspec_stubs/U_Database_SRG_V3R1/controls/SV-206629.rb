...
For detailed information on categorizing information, refer to FIPS Publication 199, Standards for Security Categorization of Federal Information and Information Systems, and FIPS Publication 200, Minimum Security Requirements for Federal Information and Information Systems.'
  desc 'check', 'Review DBMS documentation to verify that audit records can be produced when the system denies or fails to complete attempts to delete categories of information.
...
If they are not produced, this is a finding.'
  desc 'fix', 'Deploy a DBMS capable of producing the required audit records when it denies or fails to complete deletion of categories of information.
...
Configure the DBMS to produce audit records when other errors prevent deletion of categories of information.'
  ...
  tag check_id: 'C-6889r291555_chk'
  tag severity: 'medium'
  tag gid: 'V-206629'
  tag rid: 'SV-206629r617447_rule'
  tag stig_id: 'SRG-APP-000502-DB-000349'
  tag gtitle: 'SRG-APP-000502'
  tag fix_id: 'F-6889r291556_fix'
  tag 'documentable'
  tag legacy: ['SV-72535', 'V-58105']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
