...
If the configuration does not protect all of the actions defined as privileged, this is a finding.'
  desc 'fix', 'Configure DBMS security to protect all privileged functionality.'
  impact 0.5
  ref 'DPMS Target Database Generic'
  tag check_id: 'C-6846r291426_chk'
  tag severity: 'medium'
  tag gid: 'V-206586'
  tag rid: 'SV-206586r617447_rule'
  tag stig_id: 'SRG-APP-000340-DB-000304'
  tag gtitle: 'SRG-APP-000340'
  tag fix_id: 'F-6846r291427_fix'
  tag 'documentable'
  tag legacy: ['SV-72453', 'V-58023']
  tag cci: ['CCI-002235']
  tag nist: ['AC-6 (10)']
end
