control 'SV-215821' do
  title 'The Cisco router must be configured to protect audit information from unauthorized deletion.'
...
R4(config)#file privilege 15'
  ...
  tag check_id: 'C-17060r287502_chk'
  tag severity: 'medium'
  tag gid: 'V-215821'
  tag rid: 'SV-215821r531083_rule'
  tag stig_id: 'CISC-ND-000390'
  tag gtitle: 'SRG-APP-000120-NDM-000237'
  tag fix_id: 'F-17058r287503_fix'
  tag 'documentable'
  tag legacy: ['V-96233', 'SV-105371']
  tag cci: ['CCI-000164']
  tag nist: ['AU-9 a']
end
