control 'SV-78525' do
  ...
  desc 'check', 'From the vSphere Client select the vCenter server at the top of the hierarchy and go to >> Alarms >> Definitions.  Verify there is an alarm created to alert on permission changes.
...
If an alarm is not created to alert on permission update events, this is a finding.'
  ...
  tag check_id: 'C-64787r1_chk'
  tag severity: 'medium'
  tag gid: 'V-64035'
  tag rid: 'SV-78525r1_rule'
  tag stig_id: 'VCWN-06-000050'
  tag gtitle: 'SRG-APP-000275'
  tag fix_id: 'F-69965r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001294']
  tag nist: ['SI-6 c']
end
