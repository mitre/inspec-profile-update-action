...
# /opt/vmware/vpostgres/current/bin/psql -U postgres -c "SELECT pg_reload_conf();")
  ...
  tag check_id: 'C-43549r668790_chk'
  tag severity: 'medium'
  tag gid: 'V-240316'
  tag rid: 'SV-240316r879866_rule'
  tag stig_id: 'VRAU-PG-000365'
  tag gtitle: 'SRG-APP-000495-DB-000328'
  tag fix_id: 'F-43508r668791_fix'
  tag 'documentable'
  tag legacy: ['SV-100059', 'V-89409']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
