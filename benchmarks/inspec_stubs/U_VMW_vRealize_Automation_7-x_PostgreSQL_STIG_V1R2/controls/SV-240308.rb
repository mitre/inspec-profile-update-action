...
# /opt/vmware/vpostgres/current/bin/psql -U postgres -c "SELECT pg_reload_conf();")
  ...
  tag check_id: 'C-43541r668766_chk'
  tag severity: 'medium'
  tag gid: 'V-240308'
  tag rid: 'SV-240308r879748_rule'
  tag stig_id: 'VRAU-PG-000305'
  tag gtitle: 'SRG-APP-000375-DB-000323'
  tag fix_id: 'F-43500r668767_fix'
  tag 'documentable'
  tag legacy: ['SV-100043', 'V-89393']
  tag cci: ['CCI-001889']
  tag nist: ['AU-8 b']
end
