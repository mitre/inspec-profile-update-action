...
# /opt/vmware/vpostgres/current/bin/psql -U postgres -c "SELECT pg_reload_conf();")
  ...
  tag check_id: 'C-43516r668691_chk'
  tag severity: 'medium'
  tag gid: 'V-240283'
  tag rid: 'SV-240283r879566_rule'
  tag stig_id: 'VRAU-PG-000065'
  tag gtitle: 'SRG-APP-000098-DB-000042'
  tag fix_id: 'F-43475r668692_fix'
  tag 'documentable'
  tag legacy: ['SV-99993', 'V-89343']
  tag cci: ['CCI-000133']
  tag nist: ['AU-3 d']
end
