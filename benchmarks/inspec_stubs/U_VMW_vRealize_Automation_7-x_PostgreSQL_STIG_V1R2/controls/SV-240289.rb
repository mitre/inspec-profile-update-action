control 'SV-240289' do
  title 'The vRA PostgreSQL database must have the correct ownership on the log files.'
...
Replace <file_name> with files to be modified.'
  ...
  tag check_id: 'C-43522r668709_chk'
  tag severity: 'medium'
  tag gid: 'V-240289'
  tag rid: 'SV-240289r879577_rule'
  tag stig_id: 'VRAU-PG-000100'
  tag gtitle: 'SRG-APP-000119-DB-000060'
  tag fix_id: 'F-43481r668710_fix'
  tag 'documentable'
  tag legacy: ['SV-100005', 'V-89355']
  tag cci: ['CCI-000163']
  tag nist: ['AU-9 a']
end
