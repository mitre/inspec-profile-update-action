control 'SV-240299' do
  title 'The vRA PostgreSQL database must be configured to use ssl.'
...
# grep '^\s*ssl\b' /storage/db/pgdata/postgresql.conf
...
# /opt/vmware/vpostgres/current/bin/psql -U postgres -c "SELECT pg_reload_conf();")
  ...
  tag check_id: 'C-43532r668739_chk'
  tag severity: 'medium'
  tag gid: 'V-240299'
  tag rid: 'SV-240299r879609_rule'
  tag stig_id: 'VRAU-PG-000170'
  tag gtitle: 'SRG-APP-000172-DB-000075'
  tag fix_id: 'F-43491r668740_fix'
  tag 'documentable'
  tag legacy: ['SV-100025', 'V-89375']
  tag cci: ['CCI-000197']
  tag nist: ['IA-5 (1) (c)']
end
