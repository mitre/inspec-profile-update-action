control 'SV-240343' do
  title 'vRA PostgreSQL must limit the number of connections.'
...
# grep '^\s*max_connections\b' /storage/db/pgdata/postgresql.conf
...
# /opt/vmware/vpostgres/current/bin/psql -U postgres -c "SELECT pg_reload_conf();")
  ...
  tag check_id: 'C-43576r668871_chk'
  tag severity: 'medium'
  tag gid: 'V-240343'
  tag rid: 'SV-240343r879511_rule'
  tag stig_id: 'VRAU-PG-000620'
  tag gtitle: 'SRG-APP-000001-DB-000031'
  tag fix_id: 'F-43535r668872_fix'
  tag 'documentable'
  tag legacy: ['SV-100113', 'V-89463']
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
end
