...
# /opt/vmware/vpostgres/current/bin/psql -U postgres -c "SELECT pg_reload_conf();")
  ...
  tag check_id: 'C-43569r668850_chk'
  tag severity: 'high'
  tag gid: 'V-240336'
  tag rid: 'SV-240336r879885_rule'
  tag stig_id: 'VRAU-PG-000480'
  tag gtitle: 'SRG-APP-000514-DB-000383'
  tag fix_id: 'F-43528r668851_fix'
  tag 'documentable'
  tag legacy: ['SV-100099', 'V-89449']
  tag cci: ['CCI-002450']
  tag nist: ['SC-13 b']
end
