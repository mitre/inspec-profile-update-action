...
# /opt/vmware/vpostgres/current/bin/psql -U postgres -c "SELECT pg_reload_conf();")
  ...
  tag check_id: 'C-43567r668844_chk'
  tag severity: 'high'
  tag gid: 'V-240334'
  tag rid: 'SV-240334r879885_rule'
  tag stig_id: 'VRAU-PG-000470'
  tag gtitle: 'SRG-APP-000514-DB-000381'
  tag fix_id: 'F-43526r668845_fix'
  tag 'documentable'
  tag legacy: ['SV-100095', 'V-89445']
  tag cci: ['CCI-002450']
  tag nist: ['SC-13 b']
end
