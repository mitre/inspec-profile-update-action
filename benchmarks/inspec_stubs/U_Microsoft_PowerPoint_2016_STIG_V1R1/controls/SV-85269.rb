control 'SV-85269' do
  ...
  desc 'check', %q(Verify the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2016 (Machine) -> Security Settings -> IE Security "Saved from URL" is set to "Enabled" and 'powerpnt.exe' is checked.
...
Criteria: If the value powerpnt.exe is REG_DWORD = 1, this is not a finding.)
  desc 'fix', %q(Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2016 (Machine) -> Security Settings -> IE Security "Saved from URL" to "Enabled" and place a check in the 'powerpnt.exe' check box.)
  impact 0.5
  ref 'DPMS Target Microsoft PowerPoint 2016'
  tag check_id: 'C-71033r3_chk'
  tag severity: 'medium'
  tag gid: 'V-70647'
  tag rid: 'SV-85269r1_rule'
  tag stig_id: 'DTOO117'
  tag gtitle: 'SRG-APP-000210'
  tag fix_id: 'F-76879r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001170']
  tag nist: ['SC-18 (4)']
end
