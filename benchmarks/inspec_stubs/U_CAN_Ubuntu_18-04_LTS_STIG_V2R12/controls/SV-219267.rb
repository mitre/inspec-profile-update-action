...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when successful/unsuccessful attempts to use the "chcon" command occur.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20992r305129_chk'
  tag severity: 'medium'
  tag gid: 'V-219267'
  tag rid: 'SV-219267r610963_rule'
  tag stig_id: 'UBTU-18-010344'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-20991r305130_fix'
  tag 'documentable'
  tag legacy: ['V-100759', 'SV-109863']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
