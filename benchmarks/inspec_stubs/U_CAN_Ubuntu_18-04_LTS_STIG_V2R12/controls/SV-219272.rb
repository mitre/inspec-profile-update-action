...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', %q(Verify that an audit event is generated for any successful/unsuccessful use of the "unix_update" command.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20997r305144_chk'
  tag severity: 'medium'
  tag gid: 'V-219272'
  tag rid: 'SV-219272r610963_rule'
  tag stig_id: 'UBTU-18-010349'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-20996r305145_fix'
  tag 'documentable'
  tag legacy: ['V-100769', 'SV-109873']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
