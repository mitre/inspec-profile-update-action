...
Password complexity, or strength, is a measure of the effectiveness of a password in resisting attempts at guessing and brute-force attacks. Password length is one factor of several that helps to determine strength and how long it takes to crack a password. Use of more characters in a password helps to exponentially increase the time and/or resources required to compromise the password.'
  desc 'check', 'Verify if the pwquality configuration file enforces a minimum 15-character password length, by running the following command:
...
minlen=15'
  ...
  tag check_id: 'C-20906r304871_chk'
  tag severity: 'medium'
  tag gid: 'V-219181'
  tag rid: 'SV-219181r610963_rule'
  tag stig_id: 'UBTU-18-010109'
  tag gtitle: 'SRG-OS-000078-GPOS-00046'
  tag fix_id: 'F-20905r304872_fix'
  tag 'documentable'
  tag legacy: ['V-100589', 'SV-109693']
  tag cci: ['CCI-000205']
  tag nist: ['IA-5 (1) (a)']
end
