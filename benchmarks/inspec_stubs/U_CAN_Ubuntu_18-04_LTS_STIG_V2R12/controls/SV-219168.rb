...
Requiring individuals to be authenticated with an individual authenticator prior to using a group authenticator allows for traceability of actions, as well as adding an additional level of protection of the actions that can be taken with group account knowledge.)
  desc 'check', 'Verify the Ubuntu operating system prevents direct logins to the root account.
...
If the output does not contain "L" in the second field to indicate the account is locked, this is a finding.'
  desc 'fix', 'Configure the Ubuntu operating system to prevent direct logins to the root account by performing the following operations:

sudo passwd -l root'
  impact 0.5
  ref 'DPMS Target Canonical Ubuntu 18.04 LTS'
  tag check_id: 'C-20893r304832_chk'
  tag severity: 'medium'
  tag gid: 'V-219168'
  tag rid: 'SV-219168r610963_rule'
  tag stig_id: 'UBTU-18-010036'
  tag gtitle: 'SRG-OS-000109-GPOS-00056'
  tag fix_id: 'F-20892r304833_fix'
  tag 'documentable'
  tag legacy: ['SV-109667', 'V-100563']
  tag cci: ['CCI-000770']
  tag nist: ['IA-2 (5)']
end
