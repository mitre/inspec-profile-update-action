...
Off-loading is a common process in information systems with limited audit storage capacity.'
  desc 'check', 'Verify the audit event multiplexor is configured to off-load audit records to a different system or storage media from the system being audited.
...
If there is no evidence that the system is configured to off-load audit logs to a different system or storage media, this is a finding.'
  desc 'fix', "Configure the audit event multiplexor to off-load audit records to a different system or storage media from the system being audited.
...
# sudo systemctl restart auditd.service"
  ...
  tag check_id: 'C-20887r853366_chk'
  tag severity: 'low'
  tag gid: 'V-219162'
  tag rid: 'SV-219162r877390_rule'
  tag stig_id: 'UBTU-18-010025'
  tag gtitle: 'SRG-OS-000342-GPOS-00133'
  tag fix_id: 'F-20886r304815_fix'
  tag 'documentable'
  tag legacy: ['SV-109655', 'V-100551']
  tag cci: ['CCI-001851']
  tag nist: ['AU-4 (1)']
end
