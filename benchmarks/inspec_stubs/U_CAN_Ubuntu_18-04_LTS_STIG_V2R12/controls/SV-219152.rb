control 'SV-219152' do
  ...
  desc 'check', 'Verify the Ubuntu operating system notifies the System Administrator (SA) and Information System Security Officer (ISSO) (at a minimum) when allocated audit record storage volume reaches 75% of the repository maximum audit record storage capacity.
...
Edit /etc/audit/auditd.conf and set the space_left parameter to be, at least, 25% of the repository maximum audit record storage capacity.'
  ...
  tag check_id: 'C-20877r304784_chk'
  tag severity: 'low'
  tag gid: 'V-219152'
  tag rid: 'SV-219152r877389_rule'
  tag stig_id: 'UBTU-18-010006'
  tag gtitle: 'SRG-OS-000343-GPOS-00134'
  tag fix_id: 'F-20876r304785_fix'
  tag 'documentable'
  tag legacy: ['SV-109633', 'V-100529']
  tag cci: ['CCI-001855']
  tag nist: ['AU-5 (1)']
end
