control 'SV-219179' do
  ...
  desc 'check', 'Verify that the Ubuntu operating system enforces a 60-day maximum password lifetime for new user accounts by running the following command:
...
PASS_MAX_DAYS 60'
  ...
  tag check_id: 'C-20904r304865_chk'
  tag severity: 'low'
  tag gid: 'V-219179'
  tag rid: 'SV-219179r610963_rule'
  tag stig_id: 'UBTU-18-010107'
  tag gtitle: 'SRG-OS-000076-GPOS-00044'
  tag fix_id: 'F-20903r304866_fix'
  tag 'documentable'
  tag legacy: ['V-100585', 'SV-109689']
  tag cci: ['CCI-000199']
  tag nist: ['IA-5 (1) (d)']
end
