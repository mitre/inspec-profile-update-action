...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', %q(Verify that an audit event is generated for any successful/unsuccessful use of the "crontab" command.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-21001r305156_chk'
  tag severity: 'medium'
  tag gid: 'V-219276'
  tag rid: 'SV-219276r610963_rule'
  tag stig_id: 'UBTU-18-010353'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-21000r305157_fix'
  tag 'documentable'
  tag legacy: ['V-100917', 'SV-110021']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
