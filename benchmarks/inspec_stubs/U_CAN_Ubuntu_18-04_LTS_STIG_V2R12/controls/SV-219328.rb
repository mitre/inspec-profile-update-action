control 'SV-219328' do
  ...
  desc 'check', 'Verify the Ubuntu operating system defines default permissions for all authenticated users in such a way that the user can only read and modify their own files.
...
If the value of "UMASK" is not set to "077", "UMASK" is commented out or "UMASK" is missing completely, this is a finding.'
  desc 'fix', 'Configure the system to define the default permissions for all authenticated users in such a way that the user can only read and modify their own files.
...
UMASK 077'
  ...
  tag check_id: 'C-21053r305312_chk'
  tag severity: 'medium'
  tag gid: 'V-219328'
  tag rid: 'SV-219328r610963_rule'
  tag stig_id: 'UBTU-18-010448'
  tag gtitle: 'SRG-OS-000480-GPOS-00228'
  tag fix_id: 'F-21052r305313_fix'
  tag 'documentable'
  tag legacy: ['SV-109983', 'V-100879']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
