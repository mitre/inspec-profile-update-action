...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when successful/unsuccessful attempts to use the "chsh" command.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20990r305123_chk'
  tag severity: 'medium'
  tag gid: 'V-219265'
  tag rid: 'SV-219265r610963_rule'
  tag stig_id: 'UBTU-18-010342'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-20989r305124_fix'
  tag 'documentable'
  tag legacy: ['SV-109859', 'V-100755']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
