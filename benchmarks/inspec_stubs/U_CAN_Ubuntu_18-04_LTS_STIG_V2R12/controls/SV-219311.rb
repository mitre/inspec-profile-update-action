control 'SV-219311' do
  title 'The Ubuntu operating system must automatically terminate all network connections associated with SSH traffic at the end of the session or after 10 minutes of inactivity.'
...
If "ClientAliveInterval" does not exist, is not set to a value of "600" or less in "/etc/ssh/sshd_config", or is commented out, this is a finding.'
  desc 'fix', 'Configure the Ubuntu operating system to automatically terminate all network connections associated with SSH traffic at the end of a session or after a 10 minute period of inactivity.
...
# sudo systemctl restart sshd.service'
  ...
  tag check_id: 'C-21036r569462_chk'
  tag severity: 'medium'
  tag gid: 'V-219311'
  tag rid: 'SV-219311r853381_rule'
  tag stig_id: 'UBTU-18-010416'
  tag gtitle: 'SRG-OS-000163-GPOS-00072'
  tag fix_id: 'F-21035r569463_fix'
  tag satisfies: ['SRG-OS-000279-GPOS-00109']
  tag 'documentable'
  tag legacy: ['V-100845', 'SV-109949']
