...
Audit tools include, but are not limited to, vendor-provided and open source audit tools needed to successfully view and manipulate audit information system activity and records. Audit tools include custom queries and report generators.'
  desc 'check', 'Verify the Ubuntu operating system configures the audit tools to be owned by root to prevent any unauthorized access, deletion, or modification.
...
If any of the audit tools are not owned by root, this is a finding.'
  desc 'fix', 'Configure the audit tools on the Ubuntu operating system to be owned by root, by running the following command:
...
Replace "[audit_tool]" with each audit tool not owned by root.'
  ...
  tag check_id: 'C-20921r304916_chk'
  tag severity: 'medium'
  tag gid: 'V-219196'
  tag rid: 'SV-219196r610963_rule'
  tag stig_id: 'UBTU-18-010129'
  tag gtitle: 'SRG-OS-000256-GPOS-00097'
  tag fix_id: 'F-20920r304917_fix'
  tag 'documentable'
  tag legacy: ['V-100619', 'SV-109723']
  tag cci: ['CCI-001493']
  tag nist: ['AU-9 a']
end
