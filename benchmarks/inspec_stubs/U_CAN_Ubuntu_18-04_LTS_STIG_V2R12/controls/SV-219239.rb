...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', %q(Verify if the Ubuntu operating system generates audit records when successful/unsuccessful attempts to use of the "chfn" command occur. 
...
The "root" account must be used to view/edit any files in the /etc/audit/rules.d/ directory.'
  ...
  tag check_id: 'C-20964r305045_chk'
  tag severity: 'medium'
  tag gid: 'V-219239'
  tag rid: 'SV-219239r610963_rule'
  tag stig_id: 'UBTU-18-010316'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-20963r305046_fix'
  tag 'documentable'
  tag legacy: ['V-100705', 'SV-109809']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
