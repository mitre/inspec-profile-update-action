...
The Ubuntu operating system restricts access to security functions through the use of access control mechanisms and by implementing least privilege capabilities.'
  desc 'check', 'Verify that the sudo group has only members who should have access to security functions. 
...
sudo gpasswd -d <username> sudo'
  ...
  tag check_id: 'C-20894r304835_chk'
  tag severity: 'high'
  tag gid: 'V-219169'
  tag rid: 'SV-219169r610963_rule'
  tag stig_id: 'UBTU-18-010037'
  tag gtitle: 'SRG-OS-000134-GPOS-00068'
  tag fix_id: 'F-20893r304836_fix'
  tag 'documentable'
  tag legacy: ['SV-109669', 'V-100565']
  tag cci: ['CCI-001084']
  tag nist: ['SC-3']
end
