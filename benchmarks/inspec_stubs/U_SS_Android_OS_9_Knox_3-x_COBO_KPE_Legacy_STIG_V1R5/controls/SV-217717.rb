...
On the MDM console, in Knox MultiUser, unselect "allow multi-user mode".'
  ...
  tag check_id: 'C-18935r362299_chk'
  tag severity: 'medium'
  tag gid: 'V-217717'
  tag rid: 'SV-217717r388482_rule'
  tag stig_id: 'KNOX-09-000645'
  tag gtitle: 'PP-MDF-301280'
  tag fix_id: 'F-18933r362300_fix'
  tag 'documentable'
  tag legacy: ['SV-103681', 'V-93595']
  tag cci: ['CCI-002110', 'CCI-000366']
  tag nist: ['AC-2 a', 'CM-6 b']
end
