...
# /etc/dodscript.sh"
  ...
  tag check_id: 'C-43602r670846_chk'
  tag severity: 'medium'
  tag gid: 'V-240369'
  tag rid: 'SV-240369r767037_rule'
  tag stig_id: 'VRAU-SL-000205'
  tag gtitle: 'VRAU-SL-000205'
  tag fix_id: 'F-43561r670847_fix'
  tag 'documentable'
  tag legacy: ['SV-100165', 'V-89515']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
