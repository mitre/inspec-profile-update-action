...
LIST_RULES: exit,always watch=/etc/gshadow perm=a key=gshadow)
  desc 'fix', "Configure append auditing of the passwd, shadow, group, and gshadow files. Run the dodscript with the following command as root:
...
# service auditd restart"
  ...
  tag check_id: 'C-43579r670777_chk'
  tag severity: 'medium'
  tag gid: 'V-240346'
  tag rid: 'SV-240346r670779_rule'
  tag stig_id: 'VRAU-SL-000020'
  tag gtitle: 'SRG-OS-000004-GPOS-00004'
  tag fix_id: 'F-43538r670778_fix'
  tag 'documentable'
  tag legacy: ['SV-100119', 'V-89469']
  tag cci: ['CCI-000018']
  tag nist: ['AC-2 (4)']
end
