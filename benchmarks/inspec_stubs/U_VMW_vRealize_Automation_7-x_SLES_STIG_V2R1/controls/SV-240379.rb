control 'SV-240379' do
  title 'The SLES for vRealize must generate audit records when successful/unsuccessful attempts to access privileges occur. The SLES for vRealize must generate audit records for all discretionary access control permission modifications using chmod.'
...
# /etc/dodscript.sh'
  ...
  tag check_id: 'C-43612r670876_chk'
  tag severity: 'medium'
  tag gid: 'V-240379'
  tag rid: 'SV-240379r670878_rule'
  tag stig_id: 'VRAU-SL-000255'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-43571r670877_fix'
  tag 'documentable'
  tag legacy: ['SV-100185', 'V-89535']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
