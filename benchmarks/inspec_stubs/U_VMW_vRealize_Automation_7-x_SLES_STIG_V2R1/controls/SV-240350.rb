...
If the file does not exist, or the TMOUT variable is not set, this is a finding.'
  desc 'fix', 'Ensure the file exists and is owned by "root". If the file does not exist, use the following commands to create the file:
...
mesg n 2>/dev/null'
  ...
  tag check_id: 'C-43583r670789_chk'
  tag severity: 'medium'
  tag gid: 'V-240350'
  tag rid: 'SV-240350r670791_rule'
  tag stig_id: 'VRAU-SL-000050'
  tag gtitle: 'SRG-OS-000029-GPOS-00010'
  tag fix_id: 'F-43542r670790_fix'
  tag 'documentable'
  tag legacy: ['SV-100127', 'V-89477']
  tag cci: ['CCI-000057']
  tag nist: ['AC-11 a']
end
