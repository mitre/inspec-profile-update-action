...
If the group-owner is not set to "root", this is a finding.'
  desc 'fix', 'Change the group-ownership of the /etc/audit/audit.rules.STIG, the /etc/audit/audit.rules.ORIG, and the /etc/audit/audit.rules files (if not a symblic link):
...
# /etc/dodscript.sh'
  ...
  tag check_id: 'C-43611r670873_chk'
  tag severity: 'medium'
  tag gid: 'V-240378'
  tag rid: 'SV-240378r670875_rule'
  tag stig_id: 'VRAU-SL-000250'
  tag gtitle: 'SRG-OS-000063-GPOS-00032'
  tag fix_id: 'F-43570r670874_fix'
  tag 'documentable'
  tag legacy: ['SV-100183', 'V-89533']
  tag cci: ['CCI-000171']
  tag nist: ['AU-12 b']
end
