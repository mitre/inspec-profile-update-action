...
# /etc/dodscript.sh"
  ...
  tag check_id: 'C-43598r670834_chk'
  tag severity: 'medium'
  tag gid: 'V-240365'
  tag rid: 'SV-240365r767033_rule'
  tag stig_id: 'VRAU-SL-000185'
  tag gtitle: 'VRAU-SL-000185'
  tag fix_id: 'F-43557r670835_fix'
  tag 'documentable'
  tag legacy: ['SV-100157', 'V-89507']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
