control 'SV-240402' do
  ...
  desc 'check', 'To check that the SLES for vRealize enforces a 60-days or less maximum password age, run the following command:
...
If "PASS_MAX_DAYS" is not set to the required value, this is a finding.'
  desc 'fix', 'To configure the SLES for vRealize to enforce a 60-day or less maximum password age, edit the file "/etc/login.defs" and add or correct the following line. Replace [DAYS] with the appropriate amount of days.
...
The DoD requirement is "60" days or less (greater than zero, as zero days will lock the account immediately).'
  ...
  tag check_id: 'C-43635r670945_chk'
  tag severity: 'medium'
  tag gid: 'V-240402'
  tag rid: 'SV-240402r670947_rule'
  tag stig_id: 'VRAU-SL-000390'
  tag gtitle: 'SRG-OS-000076-GPOS-00044'
  tag fix_id: 'F-43594r670946_fix'
  tag 'documentable'
  tag legacy: ['SV-100231', 'V-89581']
  tag cci: ['CCI-000199']
  tag nist: ['IA-5 (1) (d)']
end
