...
-w /etc/audit/auditd.conf'
  desc 'fix', "Add the following lines to the audit.rules file to enable auditing of administrative, privileged, and security actions:
...
# /etc/dodscript.sh"
  ...
  tag check_id: 'C-43596r670828_chk'
  tag severity: 'medium'
  tag gid: 'V-240363'
  tag rid: 'SV-240363r767031_rule'
  tag stig_id: 'VRAU-SL-000175'
  tag gtitle: 'VRAU-SL-000175'
  tag fix_id: 'F-43555r670829_fix'
  tag 'documentable'
  tag legacy: ['SV-100153', 'V-89503']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
