control 'SV-240371' do
  title 'The SLES for vRealize audit system must be configured to audit all attempts to alter the system through sched_setparam.'
...
# /etc/dodscript.sh"
  ...
  tag check_id: 'C-43604r670852_chk'
  tag severity: 'medium'
  tag gid: 'V-240371'
  tag rid: 'SV-240371r767039_rule'
  tag stig_id: 'VRAU-SL-000215'
  tag gtitle: 'VRAU-SL-000215'
  tag fix_id: 'F-43563r670853_fix'
  tag 'documentable'
  tag legacy: ['SV-100169', 'V-89519']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
