...
# /etc/dodscript.sh"
  ...
  tag check_id: 'C-43603r670849_chk'
  tag severity: 'medium'
  tag gid: 'V-240370'
  tag rid: 'SV-240370r767038_rule'
  tag stig_id: 'VRAU-SL-000210'
  tag gtitle: 'VRAU-SL-000210'
  tag fix_id: 'F-43562r670850_fix'
  tag 'documentable'
  tag legacy: ['SV-100167', 'V-89517']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
