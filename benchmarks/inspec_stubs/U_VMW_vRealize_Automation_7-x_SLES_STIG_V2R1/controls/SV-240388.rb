...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', 'To determine if the system is configured to audit calls to the "lremovexattr" system call, run the following command: 
...
# /etc/dodscript.sh'
  ...
  tag check_id: 'C-43621r670903_chk'
  tag severity: 'medium'
  tag gid: 'V-240388'
  tag rid: 'SV-240388r670905_rule'
  tag stig_id: 'VRAU-SL-000300'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-43580r670904_fix'
  tag 'documentable'
  tag legacy: ['SV-100203', 'V-89553']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
