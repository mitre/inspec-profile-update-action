...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', 'To determine if the system is configured to audit calls to the "fsetxattr" system call, run the following command: 
...
# /etc/dodscript.sh'
  ...
  tag check_id: 'C-43619r670897_chk'
  tag severity: 'medium'
  tag gid: 'V-240386'
  tag rid: 'SV-240386r670899_rule'
  tag stig_id: 'VRAU-SL-000290'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-43578r670898_fix'
  tag 'documentable'
  tag legacy: ['SV-100199', 'V-89549']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
