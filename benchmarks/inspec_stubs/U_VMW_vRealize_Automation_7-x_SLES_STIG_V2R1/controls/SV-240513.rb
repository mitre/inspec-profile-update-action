...
-a exit,always -F arch=b32 -F euid=0 -S execve'
  desc 'fix', 'Configure the system to log all commands run by "root" with the following command:
...
# service auditd restart'
  ...
  tag check_id: 'C-43746r671278_chk'
  tag severity: 'medium'
  tag gid: 'V-240513'
  tag rid: 'SV-240513r671280_rule'
  tag stig_id: 'VRAU-SL-001245'
  tag gtitle: 'SRG-OS-000392-GPOS-00172'
  tag fix_id: 'F-43705r671279_fix'
  tag 'documentable'
  tag legacy: ['SV-100453', 'V-89803']
  tag cci: ['CCI-002884']
  tag nist: ['MA-4 (1) (a)']
end
