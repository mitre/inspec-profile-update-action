...
LIST_RULES: exit,always watch=/usr/sbin/groupadd perm=x key=groupadd)
  desc 'fix', 'Configure execute auditing of the useradd and groupadd executables. Run the dodscript with the following command as root:
...
# service auditd restart'
  ...
  tag check_id: 'C-43578r670774_chk'
  tag severity: 'medium'
  tag gid: 'V-240345'
  tag rid: 'SV-240345r670776_rule'
  tag stig_id: 'VRAU-SL-000015'
  tag gtitle: 'SRG-OS-000004-GPOS-00004'
  tag fix_id: 'F-43537r670775_fix'
  tag 'documentable'
  tag legacy: ['SV-100117', 'V-89467']
  tag cci: ['CCI-000018']
  tag nist: ['AC-2 (4)']
end
