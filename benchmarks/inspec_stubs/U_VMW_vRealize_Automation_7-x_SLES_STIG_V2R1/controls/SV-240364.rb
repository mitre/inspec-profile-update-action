...
# /etc/dodscript.sh"
  ...
  tag check_id: 'C-43597r670831_chk'
  tag severity: 'medium'
  tag gid: 'V-240364'
  tag rid: 'SV-240364r767032_rule'
  tag stig_id: 'VRAU-SL-000180'
  tag gtitle: 'VRAU-SL-000180'
  tag fix_id: 'F-43556r670832_fix'
  tag 'documentable'
  tag legacy: ['SV-100155', 'V-89505']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
