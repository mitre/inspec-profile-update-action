...
If no line is returned, this is a finding.'
  desc 'fix', "To configure the system to audit attempts to alter time via the /etc/localtime file, run the following command:
...
# /etc/dodscript.sh"
  ...
  tag check_id: 'C-43601r670843_chk'
  tag severity: 'medium'
  tag gid: 'V-240368'
  tag rid: 'SV-240368r767036_rule'
  tag stig_id: 'VRAU-SL-000200'
  tag gtitle: 'VRAU-SL-000200'
  tag fix_id: 'F-43560r670844_fix'
  tag 'documentable'
  tag legacy: ['SV-100163', 'V-89513']
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
