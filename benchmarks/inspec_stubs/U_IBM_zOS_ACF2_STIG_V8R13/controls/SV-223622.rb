...
chaudit rwx=f /dev/console"
  ...
  tag check_id: 'C-25295r504824_chk'
  tag severity: 'medium'
  tag gid: 'V-223622'
  tag rid: 'SV-223622r861188_rule'
  tag stig_id: 'ACF2-US-000070'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25283r858901_fix'
  tag 'documentable'
  tag legacy: ['V-97949', 'SV-107053']
