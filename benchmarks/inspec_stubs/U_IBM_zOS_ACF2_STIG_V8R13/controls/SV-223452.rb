control 'SV-223452' do
  title 'CA-ACF2 must limit Write and allocate access to all system-level product installation libraries to system programmers only.'
...
Configure allocate access to all system-level product execution libraries to be limited to system programmers only.'
  ...
  tag check_id: 'C-25125r918596_chk'
  tag severity: 'medium'
  tag gid: 'V-223452'
  tag rid: 'SV-223452r918597_rule'
