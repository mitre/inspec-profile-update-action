...
'
  desc 'check', 'Determine all associated ACF2 security data sets and/or databases.
...
If all (i.e., failures and successes) data set access authorities (i.e., READ, WRITE, ALLOCATE, and CONTROL) for ACP security data sets and/or databases are logged, this is not a finding.'
  desc 'fix', 'Configure ACF2 READ and/or greater access rules for ACF2 files and/or databases as limited to system programmers and/or security personnel, and/or batch jobs that perform ACP maintenance. 

READ access can be given to auditors and DASD batch. All accesses to ACP files and/or databases are logged.'
  impact 0.7
  ref 'DPMS Target IBM zOS ACF2'
  tag check_id: 'C-25187r918610_chk'
  tag severity: 'high'
  tag gid: 'V-223514'
  tag rid: 'SV-223514r918612_rule'
  tag stig_id: 'ACF2-ES-000970'
  tag gtitle: 'SRG-OS-000134-GPOS-00068'
  tag fix_id: 'F-25175r918611_fix'
