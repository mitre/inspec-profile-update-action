control 'SV-223465' do
  title 'CA-ACF2 must limit Write and allocate access to the JES2 System data sets (e.g., Spool, Checkpoint, and Initialization parameters) to system programmers only.'
...
'
  desc 'check', 'The ACF2 data set rules for the JES2 System data sets (e.g., Spool, Checkpoint, and Initialization parameters) do not restrict WRITE and/or ALLOCATE access to only z/OS systems programming personnel.
...
Access other than this should be documented and approved by the ISSO.'
  ...
  tag check_id: 'C-25138r918605_chk'
  tag severity: 'medium'
  tag gid: 'V-223465'
  tag rid: 'SV-223465r918606_rule'
