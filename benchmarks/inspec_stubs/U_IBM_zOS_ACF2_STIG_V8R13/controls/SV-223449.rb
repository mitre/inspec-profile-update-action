control 'SV-223449' do
  title 'CA-ACF2 must limit Write and Allocate access to all APF-authorized libraries to system programmers only.'
...
Configure Update and Allocate access to all APF-authorized libraries to be limited to system programmers only and all update and alter access is logged.'
  ...
  tag check_id: 'C-25122r918590_chk'
  tag severity: 'high'
  tag gid: 'V-223449'
  tag rid: 'SV-223449r918591_rule'
