...
If any software product requires access to dynamic LPA updates on the system, the ACF2 access to the CSVDYLPA resource and/or generic equivalent will be defined with AUDIT(ALL) and UPDATE only after the product has been validated with the appropriate STIG or SRG for compliance AND receives documented and filed authorization that details the need and any accepted risks from the site ISSM or equivalent security authority, this is not a finding.
...
F ACF2,REBUILD(FAC)"
  ...
  tag check_id: 'C-25112r504449_chk'
  tag severity: 'high'
  tag gid: 'V-223439'
  tag rid: 'SV-223439r533198_rule'
  tag stig_id: 'ACF2-ES-000180'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25100r504450_fix'
