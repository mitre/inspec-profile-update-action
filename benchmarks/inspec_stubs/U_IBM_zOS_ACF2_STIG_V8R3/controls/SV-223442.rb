control 'SV-223442' do
  title 'CA-ACF2 must limit all system PROCLIB data sets to appropriate authorized users.'
...
If the ESM data set access authorizations restrict WRITE and/or greater access to systems programming personnel, this is not a finding.'
  desc 'fix', 'Configure ESM data set rules to ensure that all WRITE and/or greater access to all PROCLIBs referenced in the Master JCL and JES2 or JES3 procedure for started tasks (STCs) and TSO logons are restricted to systems programming personnel only.
...
d. Ensure that only system programming personnel are authorized WRITE and/or greater access to PROCLIB data sets that contain STC and TSO procedures.'
  ...
  tag check_id: 'C-25115r504458_chk'
  tag severity: 'high'
  tag gid: 'V-223442'
  tag rid: 'SV-223442r533198_rule'
  tag stig_id: 'ACF2-ES-000210'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25103r504459_fix'
  tag satisfies: ['SRG-OS-000080-GPOS-00048', 'SRG-OS-000324-GPOS-00125']
  tag 'documentable'
  tag legacy: ['SV-106685', 'V-97581']
