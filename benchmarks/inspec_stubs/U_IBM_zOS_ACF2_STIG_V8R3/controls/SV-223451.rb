control 'SV-223451' do
  title 'CA-ACF2 must limit Update and Allocate access to LINKLIST libraries to system programmers only.'
...
The ACP data set rules for LINKLIST libraries do not restrict UPDATE and/or ALTER access to only z/OS systems programming personnel.

The ACP data set rules for LINKLIST libraries do not specify that all (i.e., failures and successes) UPDATE and/or ALTER access will be logged.'
...
Configure the update and allocate access to LINKLIST libraries to be limited to system programmers only and all update and allocate access is logged.'
  ...
  tag check_id: 'C-25124r504485_chk'
  tag severity: 'medium'
  tag gid: 'V-223451'
  tag rid: 'SV-223451r533198_rule'
