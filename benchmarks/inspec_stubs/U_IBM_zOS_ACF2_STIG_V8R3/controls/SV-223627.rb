...
chaudit rwx=f /dev/console'
  ...
  tag check_id: 'C-25300r504839_chk'
  tag severity: 'medium'
  tag gid: 'V-223627'
  tag rid: 'SV-223627r533198_rule'
  tag stig_id: 'ACF2-US-000120'
  tag gtitle: 'SRG-OS-000259-GPOS-00100'
  tag fix_id: 'F-25288r504840_fix'
  tag 'documentable'
  tag legacy: ['SV-107063', 'V-97959']
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
end
