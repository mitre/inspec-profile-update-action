control 'SV-223526' do
  title 'IBM z/OS startup parameters for the FTP Server must be defined in the SYSTCPD and SYSFTPD DD statements for configuration files.'
...
The systems programmer responsible for supporting ICS will ensure that the FTP daemon’s started task JCL specifies the SYSTCPD and SYSFTPD DD statements for configuration files.'
  ...
  tag check_id: 'C-25199r504636_chk'
  tag severity: 'medium'
  tag gid: 'V-223526'
  tag rid: 'SV-223526r533198_rule'
  tag stig_id: 'ACF2-FT-000100'
  tag gtitle: 'SRG-OS-000163-GPOS-00072'
  tag fix_id: 'F-25187r504637_fix'
  tag 'documentable'
  tag legacy: ['SV-106861', 'V-97757']
  tag cci: ['CCI-001133']
  tag nist: ['SC-10']
end
