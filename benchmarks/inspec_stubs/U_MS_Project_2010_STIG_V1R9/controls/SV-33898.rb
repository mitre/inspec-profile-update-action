control 'SV-33898' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2010 (Machine) -> Security Settings -> IE Security “Navigate URL” must be “Enabled” and a check in the ‘winproj.exe’ check box must be present.
...
Criteria: If the value winproj.exe is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2010 (Machine) -> Security Settings -> IE Security “Navigate URL” to “Enabled” and place a check in the ‘winproj.exe’ check box.'
  impact 0.5
  ref 'DPMS Target Microsoft Project 2010'
  tag check_id: 'C-34315r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17183'
  tag rid: 'SV-33898r1_rule'
  tag stig_id: 'DTOO123 - Project'
  tag gtitle: 'DTOO123-Block Navigation to URL from Office'
  tag fix_id: 'F-29969r1_fix'
  tag 'documentable'
