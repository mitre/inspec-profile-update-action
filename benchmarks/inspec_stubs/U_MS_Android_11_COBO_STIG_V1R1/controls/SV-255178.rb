control 'SV-255178' do
  title "Microsoft Android 11 must be configured to disable trust agents. 
...
5. Toggle "Disable trust agents" to "On".'
  ...
  tag check_id: 'C-58791r869395_chk'
  tag severity: 'medium'
  tag gid: 'V-255178'
  tag rid: 'SV-255178r870672_rule'
  tag stig_id: 'MSFT-11-002300'
  tag gtitle: 'PP-MDF-301150'
  tag fix_id: 'F-58735r869396_fix'
  tag 'documentable'
