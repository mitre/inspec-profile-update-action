control 'SV-255193' do
  title 'The Microsoft Android 11 Work Profile must be configured to prevent users from adding personal email accounts to the work email app.'
...
SFR ID: FMT_SMF_EXT.1.1 #47'
  desc 'check', 'Review the Microsoft Android 11 Work Profile configuration settings to confirm that users are prevented from adding personal email accounts to the work email app. 
...
If on the EMM console the restriction to "Disallow modify accounts" is not set, or on the Microsoft Android 11 device the user is able to add an account in the Work section, this is a finding.'
  desc 'fix', %q(Configure Microsoft Android 11 device to prevent users from adding personal email accounts to the work email app. 
...
Refer to the EMM documentation to determine how to provision users' work email accounts for the work email app.)
  ...
  tag check_id: 'C-58806r870796_chk'
  tag severity: 'medium'
  tag gid: 'V-255193'
  tag rid: 'SV-255193r870797_rule'
  tag stig_id: 'MSFT-11-009200'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-58750r869441_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
