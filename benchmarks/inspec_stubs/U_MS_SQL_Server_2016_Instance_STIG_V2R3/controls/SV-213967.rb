control 'SV-213967' do
  title 'Confidentiality of controlled information during transmission through the use of an approved TLS version.'
...
11.Repeat steps 1 – 10 for "TLS 1.1", "SSL 2.0", and "SSL 3.0"'
  ...
  tag check_id: 'C-15184r313684_chk'
  tag severity: 'medium'
  tag gid: 'V-213967'
  tag rid: 'SV-213967r617437_rule'
  tag stig_id: 'SQL6-D0-008300'
  tag gtitle: 'SRG-APP-000172-DB-000075'
  tag fix_id: 'F-15182r313685_fix'
  tag 'documentable'
