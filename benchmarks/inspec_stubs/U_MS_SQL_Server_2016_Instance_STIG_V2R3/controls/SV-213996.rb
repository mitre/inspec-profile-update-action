...
To aid in diagnosis, it is necessary to keep track of failed attempts in addition to the successful ones.'
  desc 'check', %q(Review the system documentation to determine if SQL Server is required to audit the retrieval of privilege/permission/role membership information. 
...
If the SCHEMA_OBJECT_ACCESS_GROUP is not returned in an active audit, this is a finding.)
  ...
  tag check_id: 'C-15213r313771_chk'
  tag severity: 'medium'
  tag gid: 'V-213996'
  tag rid: 'SV-213996r617437_rule'
  tag stig_id: 'SQL6-D0-013000'
  tag gtitle: 'SRG-APP-000492-DB-000333'
  tag fix_id: 'F-15211r313772_fix'
  tag 'documentable'
  tag legacy: ['SV-93959', 'V-79253']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
