...
For detailed information on categorizing information, refer to FIPS Publication 199, Standards for Security Categorization of Federal Information and Information Systems, and FIPS Publication 200, Minimum Security Requirements for Federal Information and Information Systems.'
  desc 'check', %q(Review the system documentation to determine if SQL Server is required to audit when data classifications are retrieved.
...
If the "SCHEMA_OBJECT_ACCESS_GROUP" is not returned in an active audit, this is a finding.)
  desc 'fix', 'Deploy an audit to audit when data classifications are retrieved. See the supplemental file "SQL 2016 Audit.sql".'
  impact 0.5
  ref 'DPMS Target MS SQL Server 2016 Instance'
  tag check_id: 'C-15214r313774_chk'
  tag severity: 'medium'
  tag gid: 'V-213997'
  tag rid: 'SV-213997r617437_rule'
  tag stig_id: 'SQL6-D0-013100'
  tag gtitle: 'SRG-APP-000494-DB-000344'
  tag fix_id: 'F-15212r313775_fix'
  tag 'documentable'
  tag legacy: ['SV-93961', 'V-79255']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
