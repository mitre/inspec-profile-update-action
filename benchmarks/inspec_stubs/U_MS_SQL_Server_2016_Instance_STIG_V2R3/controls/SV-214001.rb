...
https://msdn.microsoft.com/en-us/library/cc280663.aspx'
  ...
  tag check_id: 'C-15218r313786_chk'
  tag severity: 'medium'
  tag gid: 'V-214001'
  tag rid: 'SV-214001r617437_rule'
  tag stig_id: 'SQL6-D0-013500'
  tag gtitle: 'SRG-APP-000495-DB-000328'
  tag fix_id: 'F-15216r313787_fix'
  tag 'documentable'
  tag legacy: ['SV-93969', 'V-79263']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
