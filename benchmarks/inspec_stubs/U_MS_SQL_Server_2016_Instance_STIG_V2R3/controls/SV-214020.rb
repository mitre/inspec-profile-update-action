...
To aid in diagnosis, it is necessary to keep track of failed attempts in addition to the successful ones.'
  desc 'check', %q(Review the system documentation to determine if SQL Server is required to audit when unsuccessful accesses to objects occur. 
...
If the "SCHEMA_OBJECT_ACCESS_GROUP" is not returned in an active audit, this is a finding.)
  desc 'fix', 'Deploy an audit to audit when unsuccessful accesses to objects occur. See the supplemental file "SQL 2016 Audit.sql".'
  impact 0.5
  ref 'DPMS Target MS SQL Server 2016 Instance'
  tag check_id: 'C-15237r313843_chk'
  tag severity: 'medium'
  tag gid: 'V-214020'
  tag rid: 'SV-214020r617437_rule'
  tag stig_id: 'SQL6-D0-015400'
  tag gtitle: 'SRG-APP-000507-DB-000357'
  tag fix_id: 'F-15235r313844_fix'
  tag 'documentable'
