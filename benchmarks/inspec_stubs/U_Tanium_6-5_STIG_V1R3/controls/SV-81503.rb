...
This not only meets a common requirement in the Federal space but adds a critical layer of security to the user authentication process.'
  desc 'check', 'Access the Tanium server interactively and logon as an Administrator.
...
For example: X509v3 Subject Alternative Name.
...
Vendor documentation can be downloaded from the following URL: https://kb.tanium.com/Smart_Card_Authentication.'
  ...
  tag check_id: 'C-67649r2_chk'
  tag severity: 'high'
  tag gid: 'V-67013'
  tag rid: 'SV-81503r2_rule'
  tag stig_id: 'TANS-CN-000010'
  tag gtitle: 'SRG-APP-000149'
  tag fix_id: 'F-73113r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000056']
  tag nist: ['AC-11 b']
end
