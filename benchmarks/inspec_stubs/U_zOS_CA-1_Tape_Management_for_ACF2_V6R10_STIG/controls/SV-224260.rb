...
CA1.VPD UID(<tstcaudt>) R(A) W(A) A(L) E(A)"
  ...
  tag check_id: 'C-25933r868084_chk'
  tag severity: 'medium'
  tag gid: 'V-224260'
  tag rid: 'SV-224260r868086_rule'
  tag stig_id: 'ZCA1A003'
  tag gtitle: 'SRG-OS-000018'
  tag fix_id: 'F-25921r868085_fix'
  tag 'documentable'
