control 'SV-204589' do
  title 'The Red Hat Enterprise Linux operating system must be configured so that all network connections associated with SSH traffic terminate after becoming unresponsive.'
...
If "ClientAliveCountMax" is not set to "0", this is a finding.'
  desc 'fix', 'Note: This setting must be applied in conjunction with RHEL-07-040320 to function correctly.
...
The SSH service must be restarted for changes to take effect.'
  ...
  tag check_id: 'C-4713r917834_chk'
  tag severity: 'medium'
  tag gid: 'V-204589'
  tag rid: 'SV-204589r917836_rule'
  tag stig_id: 'RHEL-07-040340'
  tag gtitle: 'SRG-OS-000163-GPOS-00072'
  tag fix_id: 'F-4713r917835_fix'
