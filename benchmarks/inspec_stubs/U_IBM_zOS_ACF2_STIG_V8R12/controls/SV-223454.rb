...
If data set rules for SYS1.LINKLIB do not specify that all (i.e., failures and successes) WRITE and/or ALLOCATE access will be logged, this is a finding.'
  desc 'fix', 'Configure the ACF2 rules for SYS1.LINKLIB limit access to system programmers only and all update and allocate access is logged.'
  impact 0.5
  ref 'DPMS Target IBM zOS ACF2'
  tag check_id: 'C-25127r918600_chk'
  tag severity: 'medium'
  tag gid: 'V-223454'
  tag rid: 'SV-223454r918602_rule'
  tag stig_id: 'ACF2-ES-000330'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25115r918601_fix'
