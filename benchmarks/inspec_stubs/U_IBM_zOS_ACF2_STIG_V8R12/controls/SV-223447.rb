...
If the following guidance is true, this is not a finding.
 ...
 The ACP data set rules for SYS1.IMAGELIB do not specify that all (i.e., failures and successes) WRITE and/or ALLOCATE access will be logged.'
  desc 'fix', 'Configure WRITE and/or ALLOCATE access to SYS1.IMAGELIB to be limited to system programmers only and all update and allocate access is logged.
...
SYS1.IMAGELIB is automatically APF-authorized. This data set contains modules, images, tables, and character sets which are essential to system print services.'
  ...
  tag check_id: 'C-25120r918587_chk'
  tag severity: 'high'
  tag gid: 'V-223447'
  tag rid: 'SV-223447r918589_rule'
  tag stig_id: 'ACF2-ES-000260'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25108r918588_fix'
