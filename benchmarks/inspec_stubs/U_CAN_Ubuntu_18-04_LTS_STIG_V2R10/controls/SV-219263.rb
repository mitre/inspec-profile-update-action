...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', %q(Verify that an audit event is generated for any successful/unsuccessful use of the "sudo" command. 
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20988r305117_chk'
  tag severity: 'medium'
  tag gid: 'V-219263'
  tag rid: 'SV-219263r610963_rule'
  tag stig_id: 'UBTU-18-010340'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-20987r305118_fix'
  tag 'documentable'
  tag legacy: ['SV-109855', 'V-100751']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
