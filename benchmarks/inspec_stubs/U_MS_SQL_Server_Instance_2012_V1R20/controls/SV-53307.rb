...
If Trace is in use, SQL Server creates each trace file with a standard set of permissions, overriding the folder permissions.  It grants full control to OWNER RIGHTS, Administrators and <SQL Server Instance name>.  Since this is not configurable, this is not a finding.)
...
9) Permission like a normal user from here)
  ...
  tag check_id: 'C-47608r9_chk'
  tag severity: 'low'
  tag gid: 'V-40953'
  tag rid: 'SV-53307r5_rule'
  tag stig_id: 'SQL2-00-013700'
  tag gtitle: 'SRG-APP-000119-DB-000060'
  tag fix_id: 'F-46235r7_fix'
  tag cci: ['CCI-000163']
  tag nist: ['AU-9 a']
end
