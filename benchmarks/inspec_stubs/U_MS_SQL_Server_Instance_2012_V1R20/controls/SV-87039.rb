control 'SV-87039' do
  ...
  desc 'Windows domain/enterprise authentication and identification must be used (SQL2-00-023600). Native SQL Server authentication may be used only when circumstances make it unavoidable; and must be documented and AO-approved.
...
ALTER LOGIN <login name> CHECK_EXPIRATION = ON;'
  ...
  tag check_id: 'C-72669r2_chk'
  tag severity: 'medium'
  tag gid: 'V-72415'
  tag rid: 'SV-87039r2_rule'
  tag stig_id: 'SQL2-00-038910'
  tag gtitle: 'SRG-APP-000164-DB-000401'
  tag fix_id: 'F-78817r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000198', 'CCI-000199']
  tag nist: ['IA-5 (1) (d)', 'IA-5 (1) (d)']
end
