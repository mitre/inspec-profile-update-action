control 'SV-53417' do
  ...
  desc 'This is intended to limit exposure, by making it possible to trace any unauthorized access to other data or functionality by a privileged user account or role that has permissions on security functions or security-relevant information.'
...
The script provided in the supplemental file, Trace.sql, can be used to do this; edit it as necessary to capture any additional, locally defined events.'
  ...
  tag check_id: 'C-47659r5_chk'
  tag severity: 'medium'
  tag gid: 'V-41042'
  tag rid: 'SV-53417r5_rule'
  tag stig_id: 'SQL2-00-009700'
  tag gtitle: 'SRG-APP-000063-DB-000018'
  tag fix_id: 'F-46341r5_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
