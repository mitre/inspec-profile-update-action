control 'SV-53788' do
  ...
  desc 'Once an attacker establishes initial access to a system, they often attempt to create a persistent method of re-establishing access. One way to accomplish this is for the attacker to simply modify an existing account. 
...
The script provided in the supplemental file, Trace.sql, can be used to do this; edit it as necessary to capture any additional, locally defined events.'
  ...
  tag check_id: 'C-47875r4_chk'
  tag severity: 'medium'
  tag gid: 'V-41306'
  tag rid: 'SV-53788r4_rule'
  tag stig_id: 'SQL2-00-001900'
  tag gtitle: 'SRG-APP-000027-DB-000186'
  tag fix_id: 'F-46697r5_fix'
  tag 'documentable'
  tag cci: ['CCI-001403']
  tag nist: ['AC-2 (4)']
end
