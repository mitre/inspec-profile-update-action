...
Note that this does not apply to logins with names of the form '##MS...##'. These accounts are internal-use system principals provisioned by the DBMS, and required by it for specific purposes."
  desc 'check', "Obtain the list of accounts that have direct access to the server-level permission 'View Any Database' by running the following query:
...
;
GO"
  desc 'fix', "Remove the 'View Any Database' permission access from the account that has direct access by running the following script:
...
GO"
  ...
  tag check_id: 'C-56373r3_chk'
  tag severity: 'medium'
  tag gid: 'V-55805'
  tag rid: 'SV-70059r4_rule'
  tag stig_id: 'SQL2-00-004400'
  tag gtitle: 'SRG-APP-000035-DB-000007'
  tag fix_id: 'F-60677r1_fix'
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
end
