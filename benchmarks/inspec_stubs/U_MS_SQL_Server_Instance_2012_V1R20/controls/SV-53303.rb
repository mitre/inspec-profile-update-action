...
Unmanaged changes that occur to SQL Server software libraries or configuration can lead to unauthorized or compromised installations."
  desc 'check', 'Verify within the system documentation that SQL Server is monitoring for security-relevant configuration settings to discover unauthorized changes.
...
Deploy and implement a third-party tool or some other SQL Server method of monitoring security-relevant configuration settings to discover unauthorized changes.'
  ...
  tag check_id: 'C-47604r2_chk'
  tag severity: 'medium'
  tag gid: 'V-40949'
  tag rid: 'SV-53303r2_rule'
  tag stig_id: 'SQL2-00-015300'
  tag gtitle: 'SRG-APP-000133-DB-000179'
  tag fix_id: 'F-46231r2_fix'
  tag 'documentable'
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
end
