...
Note that this does not apply to logins with names of the form '##MS...##'.  These accounts are internal-use system principals provisioned by the DBMS, and required by it for specific purposes."
  desc 'check', "Obtain the list of accounts that have direct access to the server-level permission 'View server state' by running the following query:
...
;
GO"
  desc 'fix', "Document any necessary exceptions, and obtain the appropriate approval.
...
GO"
  ...
  tag check_id: 'C-47862r7_chk'
  tag severity: 'medium'
  tag gid: 'V-41294'
  tag rid: 'SV-53776r6_rule'
  tag stig_id: 'SQL2-00-003200'
  tag gtitle: 'SRG-APP-000035-DB-000007'
  tag fix_id: 'F-46685r3_fix'
  tag cci: ['CCI-003014']
  tag nist: ['AC-3 (3)']
end
