...
If the ASA is not configured to map the distinguished name or UPN from the client’s certificate to entries in the authentication server to determine authorization, this is a finding.'
  desc 'fix', 'Configure the ASA to map the DN or UPN from the client’s certificate to entries in the authentication server to determine authorization as shown in the example.
...
ASA2(config-tunnel-general)# end'
  ...
  tag check_id: 'C-43202r929012_chk'
  tag severity: 'medium'
  tag gid: 'V-239969'
  tag rid: 'SV-239969r929014_rule'
  tag stig_id: 'CASA-VN-000450'
  tag gtitle: 'SRG-NET-000166-VPN-000590'
  tag fix_id: 'F-43161r929013_fix'
  tag 'documentable'
  tag cci: ['CCI-000187']
  tag nist: ['IA-5 (2) (a) (2)']
end
