control 'SV-239970' do
  title 'The Cisco ASA remote access VPN server must be configured to display the Standard Mandatory DoD Notice and Consent Banner before granting access to the network.'
...
"I've read & consent to terms in IS user agreem't.")
  desc 'check', "Verify that the ASA is configured to display the Standard Mandatory DoD Notice and Consent Banner before granting remote access to the network as shown in the example below.
...
If the ASA is not configured to display the Standard Mandatory DoD Notice and Consent Banner before granting remote access to the network, this is a finding."
  desc 'fix', "Configure the ASA to display the Standard Mandatory DoD Notice and Consent Banner before granting access to the network as shown in the example below.
...
ASA3(config-group-policy)# end"
  ...
  tag check_id: 'C-43203r666314_chk'
  tag severity: 'medium'
  tag gid: 'V-239970'
  tag rid: 'SV-239970r666316_rule'
  tag stig_id: 'CASA-VN-000460'
  tag gtitle: 'SRG-NET-000041-VPN-000110'
  tag fix_id: 'F-43162r666315_fix'
  tag 'documentable'
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
