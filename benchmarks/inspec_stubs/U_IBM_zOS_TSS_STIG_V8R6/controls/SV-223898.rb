...
Configure ESM data set rules to log WRITE or greater access (i.e., successes and failures).'
  ...
  tag check_id: 'C-25571r516093_chk'
  tag severity: 'high'
  tag gid: 'V-223898'
  tag rid: 'SV-223898r561402_rule'
  tag stig_id: 'TSS0-ES-000250'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25559r516094_fix'
  tag satisfies: ['SRG-OS-000080-GPOS-00048', 'SRG-OS-000259-GPOS-00100', 'SRG-OS-000324-GPOS-00125']
  tag 'documentable'
  tag legacy: ['V-98503', 'SV-107607']
