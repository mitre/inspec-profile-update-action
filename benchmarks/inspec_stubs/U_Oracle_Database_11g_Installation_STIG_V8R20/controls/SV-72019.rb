...
Authorize and document user access requirements to the directory outside of the Oracle, DBA, and SA account list in the System Security Plan.'
  ...
  tag check_id: 'C-58441r2_chk'
  tag severity: 'medium'
  tag gid: 'V-57609'
  tag rid: 'SV-72019r1_rule'
  tag stig_id: 'DG7001-ORACLE11'
  tag gtitle: 'Dedicated directory for DBMS audit files'
  tag fix_id: 'F-62809r2_fix'
