...
Audit records can be generated from various components within the network device (e.g., module or policy filter).'
  desc 'check', 'Review the Cisco switch configuration to verify that it generates audit records when successful/unsuccessful logon attempts occur as shown in the examples below:
...
R5(config)#login on-success log'
  ...
  tag check_id: 'C-22327r507882_chk'
  tag severity: 'medium'
  tag gid: 'V-220612'
  tag rid: 'SV-220612r521267_rule'
  tag stig_id: 'CISC-ND-001260'
  tag gtitle: 'SRG-APP-000503-NDM-000320'
  tag fix_id: 'F-22316r507883_fix'
  tag 'documentable'
  tag legacy: ['SV-110453', 'V-101349']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
