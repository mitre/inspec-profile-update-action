control 'SV-228574' do
  title 'Google Android 11 must be configured to enforce a minimum password length of six characters.'
...
If the device password length is not set to six characters or more on EMM console or on the Android 11 device, this is a finding.'
  desc 'fix', 'Configure the Google Android 11 device to enforce a minimum password length of six characters.
...
6. Enter in the number of characters as "6".'
  ...
  tag check_id: 'C-30809r505547_chk'
  tag severity: 'medium'
  tag gid: 'V-228574'
  tag rid: 'SV-228574r510289_rule'
  tag stig_id: 'GOOG-11-000100'
  tag gtitle: 'PP-MDF-301010'
  tag fix_id: 'F-30786r505548_fix'
  tag 'documentable'
  tag cci: ['CCI-000205']
  tag nist: ['IA-5 (1) (a)']
end
