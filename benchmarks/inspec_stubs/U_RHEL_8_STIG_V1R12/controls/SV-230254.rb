...
If the system-wide crypto policy is set to anything other than "FIPS", this is a finding.'
  desc 'fix', 'Configure the RHEL 8 OpenSSL library to use only ciphers employing FIPS 140-2-approved algorithms with the following command:
...
A reboot is required for the changes to take effect.'
  ...
  tag check_id: 'C-32923r567508_chk'
  tag severity: 'medium'
  tag gid: 'V-230254'
