...
If the "AuditBackend" entry does not equal "LinuxAudit", is missing, or the line is commented out, this is a finding.'
  desc 'fix', 'Configure RHEL 8 to enable Linux audit logging of the USBGuard daemon by adding or modifying the following line in "/etc/usbguard/usbguard-daemon.conf":

AuditBackend=LinuxAudit'
  impact 0.3
  ref 'DPMS Target Red Hat Enterprise Linux 8'
  tag check_id: 'C-33139r568156_chk'
  tag severity: 'low'
  tag gid: 'V-230470'
