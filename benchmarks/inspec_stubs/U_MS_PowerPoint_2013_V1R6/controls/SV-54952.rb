control 'SV-54952' do
  ...
  desc 'check', %q(Verify the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Saved from URL" is set to "Enabled" and a check in the 'pptview.exe' check box is selected. 
...
Criteria: If the value pptview.exe is REG_DWORD = 1, this is not a finding.)
  desc 'fix', %q(Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Saved from URL" to "Enabled" and place a check in the 'pptview.exe' check box.)
  impact 0.5
  ref 'DPMS Target Microsoft PowerPoint 2013'
  tag check_id: 'C-48711r2_chk'
  tag severity: 'medium'
  tag gid: 'V-42333'
  tag rid: 'SV-54952r1_rule'
  tag stig_id: 'DTOO503'
  tag gtitle: 'DTOO503 - Saved from URL in PowerPoint Viewer'
  tag fix_id: 'F-47832r2_fix'
  tag 'documentable'
