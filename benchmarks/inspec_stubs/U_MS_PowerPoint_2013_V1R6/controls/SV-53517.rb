control 'SV-53517' do
  ...
  desc 'check', 'Verify the policy value for User Configuration -> Administrative Templates -> Microsoft PowerPoint 2013 -> PowerPoint Options -> Security -> Trust Center -> Protected View "Do not open files in unsafe locations in Protected View" is set to "Disabled". 
...
Criteria: If the value DisableUnsafeLocationsInPV is REG_DWORD = 0, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft PowerPoint 2013 -> PowerPoint Options -> Security -> Trust Center -> Protected View "Do not open files in unsafe locations in Protected View" to "Disabled".'
  impact 0.5
  ref 'DPMS Target Microsoft PowerPoint 2013'
  tag check_id: 'C-47688r1_chk'
  tag severity: 'medium'
  tag gid: 'V-26615'
  tag rid: 'SV-53517r1_rule'
  tag stig_id: 'DTOO288'
  tag gtitle: 'DTOO288 - Files in unsafe locations'
  tag fix_id: 'F-46444r1_fix'
  tag 'documentable'
