control 'SV-53498' do
  ...
  desc 'check', 'Verify the policy value for User Configuration -> Administrative Templates -> Microsoft PowerPoint 2013 -> PowerPoint Options -> Security "Scan encrypted macros in PowerPoint Open XML presentations" must be "Enabled (Scan encrypted macros (default)".
...
Criteria: If the value PowerPointBypassEncryptedMacroScan is REG_DWORD = 0, this not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft PowerPoint 2013 -> PowerPoint Options -> Security "Scan encrypted macros in PowerPoint Open XML presentations" to "Enabled (Scan encrypted macros (default)".'
  impact 0.5
  ref 'DPMS Target Microsoft PowerPoint 2013'
  tag check_id: 'C-47683r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17473'
  tag rid: 'SV-53498r1_rule'
  tag stig_id: 'DTOO142'
  tag gtitle: 'DTOO142 - Force Scan Encr. Macros in open XML'
  tag fix_id: 'F-46427r1_fix'
  tag 'documentable'
