control 'SV-53486' do
  ...
  desc 'check', 'Verify the policy value for User Configuration -> Administrative Templates -> Microsoft PowerPoint 2013 -> PowerPoint Options -> Security -> Trust Center "Disable Trust Bar Notification for unsigned application add-ins and block them" must be "Enabled".
...
Criteria: If the value notbpromptunsignedaddin is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft PowerPoint 2013 -> PowerPoint Options -> Security -> Trust Center "Disable Trust Bar Notification for unsigned application add-ins and block them" to "Enabled".'
  impact 0.5
  ref 'DPMS Target Microsoft PowerPoint 2013'
  tag check_id: 'C-47678r2_chk'
  tag severity: 'medium'
  tag gid: 'V-17187'
  tag rid: 'SV-53486r1_rule'
  tag stig_id: 'DTOO131'
  tag gtitle: 'DTOO131 - Trust Bar Notifications'
  tag fix_id: 'F-46412r1_fix'
  tag 'documentable'
