control 'SV-53515' do
  ...
  desc 'check', %q(Verify the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Restrict ActiveX Install" is set to "Enabled" and 'powerpnt.exe' is checked.
...
Criteria: If the value powerpnt.exe is REG_DWORD = 1, this is not a finding.)
  desc 'fix', %q(Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Restrict ActiveX Install" to "Enabled" and 'powerpnt.exe' is checked.)
  impact 0.5
  ref 'DPMS Target Microsoft PowerPoint 2013'
  tag check_id: 'C-47687r1_chk'
  tag severity: 'medium'
  tag gid: 'V-26586'
  tag rid: 'SV-53515r1_rule'
  tag stig_id: 'DTOO211'
  tag gtitle: 'DTOO211 - Restrict ActiveX Install'
  tag fix_id: 'F-46442r1_fix'
  tag 'documentable'
