control 'SV-53492' do
  ...
  desc 'check', 'Verify the policy value for User Configuration -> Administrative Templates -> Microsoft PowerPoint 2013 -> PowerPoint Options -> Security -> Trust Center -> Trusted Locations "Disable all trusted locations" is set to "Enabled".
...
Criteria: If the value AllLocationsDisabled is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft PowerPoint 2013 -> PowerPoint Options -> Security -> Trust Center -> Trusted Locations "Disable all trusted locations" to "Enabled".'
  impact 0.5
  ref 'DPMS Target Microsoft PowerPoint 2013'
  tag check_id: 'C-47680r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17471'
  tag rid: 'SV-53492r1_rule'
  tag stig_id: 'DTOO133'
  tag gtitle: 'DTOO133-Disable all trusted locations'
  tag fix_id: 'F-46419r1_fix'
  tag 'documentable'
