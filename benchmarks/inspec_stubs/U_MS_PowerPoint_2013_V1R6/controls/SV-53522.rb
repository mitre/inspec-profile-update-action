...
If a file is saved with hidden markup, users might inadvertently distribute sensitive comments or information to others via the presentation file.'
  desc 'check', 'Verify the policy value for User Configuration -> Administrative Templates -> Microsoft PowerPoint 2013 -> PowerPoint Options -> Security "Make hidden markup visible" is set to "Enabled".
...
Criteria: If the value MarkupOpenSave is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft PowerPoint 2013 -> PowerPoint Options -> Security "Make hidden markup visible" to "Enabled".'
  impact 0.5
  ref 'DPMS Target Microsoft PowerPoint 2013'
  tag check_id: 'C-47690r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17752'
  tag rid: 'SV-53522r1_rule'
  tag stig_id: 'DTOO290'
  tag gtitle: 'DTOO290 - Make Hidden marks visible in PowerPoint'
  tag fix_id: 'F-46448r1_fix'
  tag 'documentable'
