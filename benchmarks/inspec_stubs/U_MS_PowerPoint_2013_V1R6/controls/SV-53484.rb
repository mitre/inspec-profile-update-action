control 'SV-53484' do
  ...
  desc 'check', %q(Verify the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Block popups" must be "Enabled" and 'powerpnt.exe' is checked.
...
Criteria: If the value powerpnt.exe is REG_DWORD = 1, this is not a finding.)
  desc 'fix', %q(Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Block popups" to "Enabled" and select 'powerpnt.exe'.)
  impact 0.5
  ref 'DPMS Target Microsoft PowerPoint 2013'
  tag check_id: 'C-47677r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17184'
  tag rid: 'SV-53484r1_rule'
  tag stig_id: 'DTOO129'
  tag gtitle: 'DTOO129 - Block Pop-Ups'
  tag fix_id: 'F-46409r1_fix'
  tag 'documentable'
