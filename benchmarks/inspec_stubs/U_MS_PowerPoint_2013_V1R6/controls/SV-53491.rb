control 'SV-53491' do
  ...
  desc 'check', %q(Verify the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Restrict File Download" is set to "Enabled" and 'powerpnt.exe' is checked.
...
Criteria: If the value powerpnt.exe is REG_DWORD = 1, this is not a finding.)
  desc 'fix', %q(Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Restrict File Download" to "Enabled" and 'powerpnt.exe' is checked.)
  impact 0.5
  ref 'DPMS Target Microsoft PowerPoint 2013'
  tag check_id: 'C-47679r2_chk'
  tag severity: 'medium'
  tag gid: 'V-26587'
  tag rid: 'SV-53491r1_rule'
  tag stig_id: 'DTOO132'
  tag gtitle: 'DTOO132 - Restrict File Download'
  tag fix_id: 'F-46418r2_fix'
  tag 'documentable'
