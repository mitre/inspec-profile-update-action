control 'SV-53509' do
  ...
  desc 'check', %q(Verify the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Protection From Zone Elevation" is set to "Enabled" and 'powerpnt.exe' is checked.
...
Criteria: If the value powerpnt.exe is REG_DWORD = 1, this is not a finding.)
  desc 'fix', %q(Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Protection From Zone Elevation" to "Enabled" and 'powerpnt.exe' is checked.)
  impact 0.5
  ref 'DPMS Target Microsoft PowerPoint 2013'
  tag check_id: 'C-47685r1_chk'
  tag severity: 'medium'
  tag gid: 'V-26585'
  tag rid: 'SV-53509r1_rule'
  tag stig_id: 'DTOO209'
  tag gtitle: 'DTOO209 - Zone Elevation Protection'
  tag fix_id: 'F-46436r1_fix'
  tag 'documentable'
