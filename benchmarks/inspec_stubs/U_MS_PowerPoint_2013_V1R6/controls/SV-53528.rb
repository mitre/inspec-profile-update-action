control 'SV-53528' do
  ...
  desc 'check', 'Verify the policy value for User Configuration -> Administrative Templates -> Microsoft PowerPoint 2013 -> PowerPoint Options -> Security -> Trust Center "VBA Macro Notification Settings" is set to "Enabled (Disable all with notification)".
...
Criteria: If the value VBAWarnings is REG_DWORD = 2, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft PowerPoint 2013 -> PowerPoint Options -> Security -> Trust Center "VBA Macro Notification Settings" to "Enabled (Disable all with notification)".'
  impact 0.5
  ref 'DPMS Target Microsoft PowerPoint 2013'
  tag check_id: 'C-47693r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17545'
  tag rid: 'SV-53528r1_rule'
  tag stig_id: 'DTOO304'
  tag gtitle: 'DTOO304 - VBA Macro Warning settings'
  tag fix_id: 'F-46455r1_fix'
  tag 'documentable'
