...
If this password complexity policy is not configured as stated, this is a finding.'
  desc 'fix', 'From the vSphere Web Client go to Administration >> Single Sign-On >> Configuration >> Policies >> Password Policy. Click "Edit". Set Upper-case Characters to at least "1" and click "OK".'
  impact 0.5
  ref 'DPMS Target VMW vSphere 6.5 vCenter Server for Windows'
  tag check_id: 'C-18091r366294_chk'
  tag severity: 'medium'
  tag gid: 'V-216860'
  tag rid: 'SV-216860r879603_rule'
  tag stig_id: 'VCWN-65-000040'
  tag gtitle: 'SRG-APP-000166'
  tag fix_id: 'F-18089r366295_fix'
  tag 'documentable'
  tag legacy: ['SV-104615', 'V-94785']
  tag cci: ['CCI-000192']
  tag nist: ['IA-5 (1) (a)']
end
