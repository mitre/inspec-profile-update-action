control 'SV-240424' do
  title 'The xinetd service must be disabled if no network services using it are enabled.'
...
# chkconfig xinetd off'
  ...
  tag check_id: 'C-43657r671011_chk'
  tag severity: 'medium'
  tag gid: 'V-240424'
  tag rid: 'SV-240424r671013_rule'
  tag stig_id: 'VRAU-SL-000515'
  tag gtitle: 'SRG-OS-000096-GPOS-00050'
  tag fix_id: 'F-43616r671012_fix'
  tag 'documentable'
  tag legacy: ['SV-100275', 'V-89625']
  tag cci: ['CCI-000382']
  tag nist: ['CM-7 b']
end
