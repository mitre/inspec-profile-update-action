...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', 'To determine if the system is configured to audit calls to the "fchown" system call, run the following command: 
...
# /etc/dodscript.sh'
  ...
  tag check_id: 'C-43616r670888_chk'
  tag severity: 'medium'
  tag gid: 'V-240383'
  tag rid: 'SV-240383r670890_rule'
  tag stig_id: 'VRAU-SL-000275'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-43575r670889_fix'
  tag 'documentable'
  tag legacy: ['SV-100193', 'V-89543']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
