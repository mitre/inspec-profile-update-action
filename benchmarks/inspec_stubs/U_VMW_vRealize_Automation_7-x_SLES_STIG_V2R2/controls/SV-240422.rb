...
If no result is returned, this is a finding.'
  desc 'fix', 'Prevent the use of RDS protocol handler for dynamic loading:

# echo "install rds /bin/true" >> /etc/modprobe.conf.local'
  impact 0.5
  ref 'DPMS Target VMware vRealize Automation 7-x SLES'
  tag check_id: 'C-43655r671005_chk'
  tag severity: 'medium'
  tag gid: 'V-240422'
  tag rid: 'SV-240422r671007_rule'
  tag stig_id: 'VRAU-SL-000505'
  tag gtitle: 'SRG-OS-000096-GPOS-00050'
  tag fix_id: 'F-43614r671006_fix'
  tag 'documentable'
  tag legacy: ['SV-100271', 'V-89621']
  tag cci: ['CCI-000382']
  tag nist: ['CM-7 b']
end
