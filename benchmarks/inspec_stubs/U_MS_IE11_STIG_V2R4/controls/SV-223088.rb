control 'SV-223088' do
  ...
  desc 'check', %q(The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Locked-Down Intranet Zone -> 'Java permissions' must be 'Enabled', and 'Disable Java' selected from the drop-down box. Procedure: Use the Windows Registry Editor to navigate to the following keys: HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Lockdown_Zones\1 Criteria: If the value" 1C00" is REG_DWORD = 0, this is not a finding.)
  ...
  tag check_id: 'C-24761r428814_chk'
  tag severity: 'medium'
  tag gid: 'V-223088'
  tag rid: 'SV-223088r879587_rule'
  tag stig_id: 'DTBI435-IE11'
  tag gtitle: 'SRG-APP-000141'
  tag fix_id: 'F-24749r428815_fix'
  tag 'documentable'
  tag legacy: ['SV-59513', 'V-46649']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
