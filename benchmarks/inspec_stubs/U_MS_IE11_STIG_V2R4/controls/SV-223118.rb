control 'SV-223118' do
  ...
  tag check_id: 'C-24791r428904_chk'
  tag severity: 'medium'
  tag gid: 'V-223118'
  tag rid: 'SV-223118r879587_rule'
  tag stig_id: 'DTBI649-IE11'
  tag gtitle: 'SRG-APP-000141'
  tag fix_id: 'F-24779r428905_fix'
  tag 'documentable'
  tag legacy: ['SV-59657', 'V-46791']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
