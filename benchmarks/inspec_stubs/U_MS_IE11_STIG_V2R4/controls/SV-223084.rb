control 'SV-223084' do
  ...
  tag check_id: 'C-24757r428802_chk'
  tag severity: 'medium'
  tag gid: 'V-223084'
  tag rid: 'SV-223084r879587_rule'
  tag stig_id: 'DTBI415-IE11'
  tag gtitle: 'SRG-APP-000141'
  tag fix_id: 'F-24745r428803_fix'
  tag 'documentable'
  tag legacy: ['SV-59507', 'V-46643']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
