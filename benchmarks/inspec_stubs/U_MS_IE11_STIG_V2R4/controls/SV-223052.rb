control 'SV-223052' do
  ...
  desc 'check', 'In the policy value for Computer Configuration >> Administrative Templates >> Windows Components >> Internet Explorer >> Internet Control Panel >> Security Page >> Restricted Sites Zone, verify "Allow only approved domains to use the TDC ActiveX control" is “Enabled”. 
...
In the Options windows, select "Enable" from the “Only allow approved domains to use the TDC ActiveX control" drop-down box.'
  ...
  tag check_id: 'C-24725r863000_chk'
  tag severity: 'medium'
  tag gid: 'V-223052'
  tag rid: 'SV-223052r879587_rule'
  tag stig_id: 'DTBI1120-IE11'
  tag gtitle: 'SRG-APP-000141'
  tag fix_id: 'F-24713r428707_fix'
  tag 'documentable'
  tag legacy: ['SV-87401', 'V-72763']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
