control 'SV-223105' do
  ...
  tag check_id: 'C-24778r428865_chk'
  tag severity: 'medium'
  tag gid: 'V-223105'
  tag rid: 'SV-223105r879627_rule'
  tag stig_id: 'DTBI596-IE11'
  tag gtitle: 'SRG-APP-000206'
  tag fix_id: 'F-24766r428866_fix'
  tag 'documentable'
  tag legacy: ['SV-59581', 'V-46717']
  tag cci: ['CCI-001166']
  tag nist: ['SC-18 (1)']
end
