control 'SV-223020' do
  ...
  desc 'check', %q(The policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Internet Control Panel -> Security Page -> Internet Zone -> 'Java permissions' must be 'Enabled', and 'Disable Java' selected from the drop-down box. Procedure: Use the Windows Registry Editor to navigate to the following key: HKLM\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3 Criteria: If the value "1C00" is REG_DWORD = 0, this is not a finding.)
  ...
  tag check_id: 'C-24693r428610_chk'
  tag severity: 'medium'
  tag gid: 'V-223020'
  tag rid: 'SV-223020r879587_rule'
  tag stig_id: 'DTBI031-IE11'
  tag gtitle: 'SRG-APP-000141'
  tag fix_id: 'F-24681r428611_fix'
  tag 'documentable'
  tag legacy: ['SV-59371', 'V-46507']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
