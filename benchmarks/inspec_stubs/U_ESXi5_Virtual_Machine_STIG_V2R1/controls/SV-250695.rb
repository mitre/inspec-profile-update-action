...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54130r799545_chk'
  tag severity: 'low'
  tag gid: 'V-250695'
  tag rid: 'SV-250695r799547_rule'
  tag stig_id: 'ESXI5-VM-000021'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54084r799546_fix'
  tag 'documentable'
  tag legacy: ['V-39477', 'SV-51335']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
