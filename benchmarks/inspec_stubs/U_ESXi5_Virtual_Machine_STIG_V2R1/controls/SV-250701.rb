...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54136r799563_chk'
  tag severity: 'low'
  tag gid: 'V-250701'
  tag rid: 'SV-250701r799565_rule'
  tag stig_id: 'ESXI5-VM-000027'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54090r799564_fix'
  tag 'documentable'
  tag legacy: ['V-39483', 'SV-51341']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
