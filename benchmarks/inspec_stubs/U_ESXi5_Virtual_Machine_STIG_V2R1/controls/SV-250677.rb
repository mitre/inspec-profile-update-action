...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54112r799491_chk'
  tag severity: 'low'
  tag gid: 'V-250677'
  tag rid: 'SV-250677r799493_rule'
  tag stig_id: 'ESXI5-VM-000002'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54066r799492_fix'
  tag 'documentable'
  tag legacy: ['SV-51301', 'V-39443']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
