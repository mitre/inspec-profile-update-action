...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54118r799509_chk'
  tag severity: 'high'
  tag gid: 'V-250683'
  tag rid: 'SV-250683r799511_rule'
  tag stig_id: 'ESXI5-VM-000008'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54072r799510_fix'
  tag 'documentable'
  tag legacy: ['SV-51307', 'V-39449']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
