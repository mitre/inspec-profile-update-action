...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54115r799500_chk'
  tag severity: 'low'
  tag gid: 'V-250680'
  tag rid: 'SV-250680r799502_rule'
  tag stig_id: 'ESXI5-VM-000005'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54069r799501_fix'
  tag 'documentable'
  tag legacy: ['V-39446', 'SV-51304']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
