...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54124r799527_chk'
  tag severity: 'low'
  tag gid: 'V-250689'
  tag rid: 'SV-250689r799529_rule'
  tag stig_id: 'ESXI5-VM-000015'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54078r799528_fix'
  tag 'documentable'
  tag legacy: ['V-39457', 'SV-51315']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
