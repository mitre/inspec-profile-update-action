...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54133r799554_chk'
  tag severity: 'low'
  tag gid: 'V-250698'
  tag rid: 'SV-250698r799556_rule'
  tag stig_id: 'ESXI5-VM-000024'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54087r799555_fix'
  tag 'documentable'
  tag legacy: ['SV-51338', 'V-39480']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
