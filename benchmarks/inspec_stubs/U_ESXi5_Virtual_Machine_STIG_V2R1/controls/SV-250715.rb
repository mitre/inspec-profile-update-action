...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54150r799605_chk'
  tag severity: 'low'
  tag gid: 'V-250715'
  tag rid: 'SV-250715r799607_rule'
  tag stig_id: 'ESXI5-VM-000043'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54104r799606_fix'
  tag 'documentable'
  tag legacy: ['V-39497', 'SV-51355']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
