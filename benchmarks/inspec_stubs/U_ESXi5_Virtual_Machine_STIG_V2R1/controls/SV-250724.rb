...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54159r799632_chk'
  tag severity: 'medium'
  tag gid: 'V-250724'
  tag rid: 'SV-250724r799634_rule'
  tag stig_id: 'ESXI5-VM-000053'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54113r799633_fix'
  tag 'documentable'
  tag legacy: ['V-39507', 'SV-51365']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
