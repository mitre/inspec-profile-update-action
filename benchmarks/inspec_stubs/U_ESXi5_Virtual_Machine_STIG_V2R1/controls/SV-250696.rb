...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54131r799548_chk'
  tag severity: 'low'
  tag gid: 'V-250696'
  tag rid: 'SV-250696r799550_rule'
  tag stig_id: 'ESXI5-VM-000022'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54085r799549_fix'
  tag 'documentable'
  tag legacy: ['SV-51336', 'V-39478']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
