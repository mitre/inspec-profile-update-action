...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54128r799539_chk'
  tag severity: 'low'
  tag gid: 'V-250693'
  tag rid: 'SV-250693r799541_rule'
  tag stig_id: 'ESXI5-VM-000019'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54082r799540_fix'
  tag 'documentable'
  tag legacy: ['V-39462', 'SV-51320']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
