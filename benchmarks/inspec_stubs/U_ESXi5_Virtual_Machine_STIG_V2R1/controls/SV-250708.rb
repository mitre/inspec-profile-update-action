...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54143r799584_chk'
  tag severity: 'medium'
  tag gid: 'V-250708'
  tag rid: 'SV-250708r799586_rule'
  tag stig_id: 'ESXI5-VM-000035'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54097r799585_fix'
  tag 'documentable'
  tag legacy: ['SV-51348', 'V-39490']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
