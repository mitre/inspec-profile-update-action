...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54126r799533_chk'
  tag severity: 'low'
  tag gid: 'V-250691'
  tag rid: 'SV-250691r799535_rule'
  tag stig_id: 'ESXI5-VM-000017'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54080r799534_fix'
  tag 'documentable'
  tag legacy: ['V-39459', 'SV-51317']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
