...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54134r799557_chk'
  tag severity: 'low'
  tag gid: 'V-250699'
  tag rid: 'SV-250699r799559_rule'
  tag stig_id: 'ESXI5-VM-000025'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54088r799558_fix'
  tag 'documentable'
  tag legacy: ['V-39481', 'SV-51339']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
