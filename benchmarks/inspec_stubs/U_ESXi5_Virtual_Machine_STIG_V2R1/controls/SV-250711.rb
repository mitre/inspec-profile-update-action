control 'SV-250711' do
  ...
  desc 'check', %q(If USB is required, this check is not applicable.
...
Re-enable Lockdown Mode on the host.)
  desc 'fix', %q(If USB is required, no fix is required.
...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54146r799593_chk'
  tag severity: 'medium'
  tag gid: 'V-250711'
  tag rid: 'SV-250711r799595_rule'
  tag stig_id: 'ESXI5-VM-000038'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54100r799594_fix'
  tag 'documentable'
  tag legacy: ['V-39493', 'SV-51351']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
