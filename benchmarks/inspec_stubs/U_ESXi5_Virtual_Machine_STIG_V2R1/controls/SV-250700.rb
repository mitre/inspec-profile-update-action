...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54135r799560_chk'
  tag severity: 'low'
  tag gid: 'V-250700'
  tag rid: 'SV-250700r799562_rule'
  tag stig_id: 'ESXI5-VM-000026'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54089r799561_fix'
  tag 'documentable'
  tag legacy: ['SV-51340', 'V-39482']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
