...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54137r799566_chk'
  tag severity: 'low'
  tag gid: 'V-250702'
  tag rid: 'SV-250702r799568_rule'
  tag stig_id: 'ESXI5-VM-000028'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54091r799567_fix'
  tag 'documentable'
  tag legacy: ['SV-51342', 'V-39484']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
