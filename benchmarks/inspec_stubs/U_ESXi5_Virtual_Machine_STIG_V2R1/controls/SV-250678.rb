...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54113r799494_chk'
  tag severity: 'low'
  tag gid: 'V-250678'
  tag rid: 'SV-250678r799496_rule'
  tag stig_id: 'ESXI5-VM-000003'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54067r799495_fix'
  tag 'documentable'
  tag legacy: ['V-39444', 'SV-51302']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
