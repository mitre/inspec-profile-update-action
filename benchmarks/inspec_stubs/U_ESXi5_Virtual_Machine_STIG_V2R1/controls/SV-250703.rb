...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54138r799569_chk'
  tag severity: 'low'
  tag gid: 'V-250703'
  tag rid: 'SV-250703r799571_rule'
  tag stig_id: 'ESXI5-VM-000029'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54092r799570_fix'
  tag 'documentable'
  tag legacy: ['V-39485', 'SV-51343']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
