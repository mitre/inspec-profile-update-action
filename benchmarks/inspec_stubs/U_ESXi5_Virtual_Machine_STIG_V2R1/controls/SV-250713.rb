...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54148r799599_chk'
  tag severity: 'medium'
  tag gid: 'V-250713'
  tag rid: 'SV-250713r799601_rule'
  tag stig_id: 'ESXI5-VM-000041'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54102r799600_fix'
  tag 'documentable'
  tag legacy: ['V-39495', 'SV-51353']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
