...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54140r799575_chk'
  tag severity: 'low'
  tag gid: 'V-250705'
  tag rid: 'SV-250705r799577_rule'
  tag stig_id: 'ESXI5-VM-000031'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54094r799576_fix'
  tag 'documentable'
  tag legacy: ['V-39487', 'SV-51345']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
