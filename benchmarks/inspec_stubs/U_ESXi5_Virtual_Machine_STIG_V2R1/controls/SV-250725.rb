...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54160r799635_chk'
  tag severity: 'medium'
  tag gid: 'V-250725'
  tag rid: 'SV-250725r799637_rule'
  tag stig_id: 'ESXI5-VM-000054'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54114r799636_fix'
  tag 'documentable'
  tag legacy: ['SV-51366', 'V-39508']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
