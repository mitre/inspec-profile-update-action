...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54129r799542_chk'
  tag severity: 'low'
  tag gid: 'V-250694'
  tag rid: 'SV-250694r799544_rule'
  tag stig_id: 'ESXI5-VM-000020'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54083r799543_fix'
  tag 'documentable'
  tag legacy: ['SV-51321', 'V-39463']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
