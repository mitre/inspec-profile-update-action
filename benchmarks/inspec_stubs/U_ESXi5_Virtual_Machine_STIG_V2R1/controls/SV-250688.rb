...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54123r799524_chk'
  tag severity: 'low'
  tag gid: 'V-250688'
  tag rid: 'SV-250688r799526_rule'
  tag stig_id: 'ESXI5-VM-000014'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54077r799525_fix'
  tag 'documentable'
  tag legacy: ['SV-51314', 'V-39456']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
