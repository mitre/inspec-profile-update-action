...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54125r799530_chk'
  tag severity: 'low'
  tag gid: 'V-250690'
  tag rid: 'SV-250690r799532_rule'
  tag stig_id: 'ESXI5-VM-000016'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54079r799531_fix'
  tag 'documentable'
  tag legacy: ['SV-51316', 'V-39458']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
