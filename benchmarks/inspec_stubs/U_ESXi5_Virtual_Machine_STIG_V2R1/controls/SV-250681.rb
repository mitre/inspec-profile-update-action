...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54116r799503_chk'
  tag severity: 'low'
  tag gid: 'V-250681'
  tag rid: 'SV-250681r799505_rule'
  tag stig_id: 'ESXI5-VM-000006'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54070r799504_fix'
  tag 'documentable'
  tag legacy: ['SV-51305', 'V-39447']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
