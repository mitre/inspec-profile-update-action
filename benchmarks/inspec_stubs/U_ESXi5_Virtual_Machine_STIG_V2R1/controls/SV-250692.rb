...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54127r799536_chk'
  tag severity: 'low'
  tag gid: 'V-250692'
  tag rid: 'SV-250692r799538_rule'
  tag stig_id: 'ESXI5-VM-000018'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54081r799537_fix'
  tag 'documentable'
  tag legacy: ['SV-51319', 'V-39461']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
