...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54117r799506_chk'
  tag severity: 'high'
  tag gid: 'V-250682'
  tag rid: 'SV-250682r799508_rule'
  tag stig_id: 'ESXI5-VM-000007'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54071r799507_fix'
  tag 'documentable'
  tag legacy: ['V-39448', 'SV-51306']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
