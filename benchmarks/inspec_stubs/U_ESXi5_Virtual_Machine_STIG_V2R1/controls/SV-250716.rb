...
If SSH and/or terminal management services are exclusively used to perform management tasks, this is not a finding.'
  ...
  tag check_id: 'C-54151r799608_chk'
  tag severity: 'medium'
  tag gid: 'V-250716'
  tag rid: 'SV-250716r799610_rule'
  tag stig_id: 'ESXI5-VM-000044'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54105r799609_fix'
  tag 'documentable'
  tag legacy: ['SV-51356', 'V-39498']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
