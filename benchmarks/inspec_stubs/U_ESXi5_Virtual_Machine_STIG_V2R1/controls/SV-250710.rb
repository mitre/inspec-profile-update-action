...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54145r799590_chk'
  tag severity: 'medium'
  tag gid: 'V-250710'
  tag rid: 'SV-250710r799592_rule'
  tag stig_id: 'ESXI5-VM-000037'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54099r799591_fix'
  tag 'documentable'
  tag legacy: ['SV-51350', 'V-39492']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
