...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54153r799614_chk'
  tag severity: 'medium'
  tag gid: 'V-250718'
  tag rid: 'SV-250718r799616_rule'
  tag stig_id: 'ESXI5-VM-000046'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54107r799615_fix'
  tag 'documentable'
  tag legacy: ['SV-51358', 'V-39500']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
