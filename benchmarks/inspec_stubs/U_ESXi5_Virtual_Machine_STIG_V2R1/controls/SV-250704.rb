...
Continue to follow the wizard to add the virtual machine.)
  ...
  tag check_id: 'C-54139r799572_chk'
  tag severity: 'low'
  tag gid: 'V-250704'
  tag rid: 'SV-250704r799574_rule'
  tag stig_id: 'ESXI5-VM-000030'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-54093r799573_fix'
  tag 'documentable'
  tag legacy: ['SV-51344', 'V-39486']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
