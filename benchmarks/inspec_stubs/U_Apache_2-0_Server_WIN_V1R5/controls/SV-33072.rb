...
If accounts other than the SA, the web manager, or the web manager designees have access to the web administration tool or control files, this is a finding.'
  desc 'fix', 'Restrict access to the httpd.conf file to only the web manager and the web manager’s designees.'
  impact 0.5
  ref 'DPMS Target Apache Instance 2.0'
  tag check_id: 'C-33743r2_chk'
  tag severity: 'medium'
  tag gid: 'V-2248'
  tag rid: 'SV-33072r3_rule'
  tag stig_id: 'WG220 W22'
  tag gtitle: 'WG220'
  tag fix_id: 'F-29378r1_fix'
  tag 'documentable'
