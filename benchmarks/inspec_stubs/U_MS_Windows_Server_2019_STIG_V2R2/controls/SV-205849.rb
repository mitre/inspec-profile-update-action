...
Preview versions must not be used in a production environment.'
  desc 'fix', 'Update the system to a Version 1809 (Build 17763.xxx) or greater.'
  impact 0.7
  ref 'DPMS Target MS Windows Server 2019'
  tag check_id: 'C-6114r355909_chk'
  tag severity: 'high'
  tag gid: 'V-205849'
  tag rid: 'SV-205849r569188_rule'
  tag stig_id: 'WN19-00-000100'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-6114r355910_fix'
  tag 'documentable'
  tag legacy: ['SV-103303', 'V-93215']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
