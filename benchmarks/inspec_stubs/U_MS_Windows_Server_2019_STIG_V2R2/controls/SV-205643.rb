...
- Administrators'
  ...
  tag check_id: 'C-5908r354847_chk'
  tag severity: 'medium'
  tag gid: 'V-205643'
  tag rid: 'SV-205643r569188_rule'
  tag stig_id: 'WN19-UR-000170'
  tag gtitle: 'SRG-OS-000057-GPOS-00027'
  tag fix_id: 'F-5908r354848_fix'
  ...
  tag 'documentable'
  tag legacy: ['V-93197', 'SV-103285']
  tag cci: ['CCI-000171', 'CCI-000164', 'CCI-000162', 'CCI-000163', 'CCI-001914']
  tag nist: ['AU-12 b', 'AU-9 a', 'AU-9 a', 'AU-9 a', 'AU-12 (3)']
end
