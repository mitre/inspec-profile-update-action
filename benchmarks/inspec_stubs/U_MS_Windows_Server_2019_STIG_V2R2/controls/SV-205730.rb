...
Logon/Logoff >> Account Lockout - Failure'
  ...
  tag check_id: 'C-5995r355108_chk'
  tag severity: 'medium'
  tag gid: 'V-205730'
  tag rid: 'SV-205730r569188_rule'
  tag stig_id: 'WN19-AU-000160'
  tag gtitle: 'SRG-OS-000240-GPOS-00090'
  tag fix_id: 'F-5995r355109_fix'
  tag satisfies: ['SRG-OS-000240-GPOS-00090', 'SRG-OS-000470-GPOS-00214']
  tag 'documentable'
  tag legacy: ['V-92989', 'SV-103077']
