control 'SV-254520' do
  title 'RHEL 8 must prevent non-privileged users from executing privileged functions, including disabling, circumventing, or altering implemented security safeguards/countermeasures.'
...
If they are not mapped in this way, this is a finding.'
  desc 'fix', 'Configure RHEL 8 to prevent non-privileged users from executing privileged functions, including disabling, circumventing, or altering implemented security safeguards/countermeasures. 
...
$ sudo semanage login -m -s user_u <username>'
  ...
  tag check_id: 'C-58004r858833_chk'
  tag severity: 'medium'
  tag gid: 'V-254520'
  tag rid: 'SV-254520r858835_rule'
  tag stig_id: 'RHEL-08-040400'
  tag gtitle: 'SRG-OS-000324-GPOS-00125'
  tag fix_id: 'F-57953r858834_fix'
  tag 'documentable'
  tag cci: ['CCI-002265']
  tag nist: ['AC-16 b']
end
