...
If there is no process to validate certificates that is approved by the organization, this is a finding.)
  desc 'fix', 'Configure the operating system to verify the signature of packages from a repository prior to install by setting the following option in the "/etc/yum.repos.d/[your_repo_name].repo" file:

gpgcheck=1'
  impact 0.7
  ref 'DPMS Target Red Hat Enterprise Linux 8'
  tag check_id: 'C-32933r567538_chk'
  tag severity: 'high'
  tag gid: 'V-230264'
  tag rid: 'SV-230264r854016_rule'
