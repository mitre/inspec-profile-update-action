control 'SV-244543' do
  ...
  desc 'check', 'Verify RHEL 8 notifies the SA and ISSO (at a minimum) when allocated audit record storage volume reaches 75 percent of the repository maximum audit record storage capacity with the following command:
...
Note: Option names and values in the auditd.conf file are case insensitive.'
  ...
  tag check_id: 'C-47818r743876_chk'
  tag severity: 'medium'
  tag gid: 'V-244543'
  tag rid: 'SV-244543r854072_rule'
