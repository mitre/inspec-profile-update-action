...
If conflicting results are returned, this is a finding.'
  desc 'fix', 'Configure RHEL 8 to allow the SSH daemon to not allow unattended or automatic logon to the system.
...
$ sudo systemctl restart sshd.service'
  ...
  tag check_id: 'C-32999r858712_chk'
  tag severity: 'medium'
  tag gid: 'V-230330'
  tag rid: 'SV-230330r858713_rule'
