control 'SV-230483' do
  ...
  desc 'check', 'Verify RHEL 8 takes action when allocated audit record storage volume reaches 75 percent of the repository maximum audit record storage capacity with the following commands:
...
Note: Option names and values in the auditd.conf file are case insensitive.'
  ...
  tag check_id: 'C-33152r744012_chk'
  tag severity: 'medium'
  tag gid: 'V-230483'
  tag rid: 'SV-230483r854045_rule'
