...
If the site does not have procedures in place, so users can down-load software updates from a DoD source or DoD-approved source, this is a finding.'
  desc 'fix', 'Ensure CMD software updates originate from DoD sources or approved non-DoD sources only. Users do not accept Over-The-Air (OTA) wireless software updates from non-approved sources.'
  impact 0.3
  ref 'DPMS Target Smartphone Handheld Policy'
  tag check_id: 'C-31127r8_chk'
  tag severity: 'low'
  tag gid: 'V-24964'
  tag rid: 'SV-30701r4_rule'
  tag stig_id: 'WIR-SPP-008-02'
  tag gtitle: 'CMD provisioning-02'
  tag fix_id: 'F-27598r3_fix'
  tag 'documentable'
