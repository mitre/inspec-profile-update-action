...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', 'Review the Trend Deep Security server configuration to ensure audit records are generated when successful/unsuccessful logon attempts occur.
...
If the options for “Record” and “Forward” are not enabled, this is a finding.'
  desc 'fix', 'Configure the Trend Deep Security server to generate audit records when successful/unsuccessful logon attempts occur.
...
Configure the alert using the Administration >> System Settings >> System Events for successful/unsuccessful for "User Signed In" (Event ID 600). Select  “Record” and “Forward”.'
  ...
  tag check_id: 'C-66673r1_chk'
  tag severity: 'medium'
  tag gid: 'V-66025'
  tag rid: 'SV-80515r1_rule'
  tag stig_id: 'TMDS-00-000380'
  tag gtitle: 'SRG-APP-000503'
  tag fix_id: 'F-72101r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
