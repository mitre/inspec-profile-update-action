...
To address access requirements, many application developers choose to integrate their applications with enterprise-level authentication/access/audit mechanisms meeting or exceeding access control policy requirements. Such integration allows the application developer to off-load those access control functions and focus on core application features and functionality.'
  desc 'check', 'Review the Trend Deep Security server configuration to ensure account disabling actions are automatically audited.
...
If "User Locked Out" is not enabled this is a finding.'
  desc 'fix', 'Configure the Trend Deep Security server to automatically audit account disabling actions.
...
Select: Forward'
  ...
  tag check_id: 'C-66513r1_chk'
  tag severity: 'medium'
  tag gid: 'V-65865'
  tag rid: 'SV-80355r1_rule'
  tag stig_id: 'TMDS-00-000030'
  tag gtitle: 'SRG-APP-000028'
  tag fix_id: 'F-71941r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001404']
  tag nist: ['AC-2 (4)']
end
