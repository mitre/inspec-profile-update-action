...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', 'Review the Trend Deep Security server to ensure audit records are generated for all direct access to the information system.
...
If the events are not set to “Record” and “Forward”, this is a finding.'
  desc 'fix', 'Configure the Trend Deep Security server to generate audit records for all direct access to the information system.
...
Enable the necessary audit setting to capture direct access to the system by selecting “Record” and “Forward” within the Administration >> System Settings >> System Events, system settings.'
  ...
  tag check_id: 'C-66679r1_chk'
  tag severity: 'medium'
  tag gid: 'V-66031'
  tag rid: 'SV-80521r1_rule'
  tag stig_id: 'TMDS-00-000395'
  tag gtitle: 'SRG-APP-000508'
  tag fix_id: 'F-72107r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
