...
Audit tools include, but are not limited to, vendor-provided and open source audit tools needed to successfully view and manipulate audit information system activity and records. Audit tools include custom queries and report generators.'
  desc 'check', %q(Review the Trend Deep Security server configuration to ensure audit tools are protected from unauthorized deletion.
...
If the information gathered does not match the settings within the application this is a finding.)
  desc 'fix', 'Configure the Trend Deep Security server to protect audit tools from unauthorized deletion.
...
Next select “Other Rights” and modify accordingly.'
  ...
  tag check_id: 'C-66545r1_chk'
  tag severity: 'medium'
  tag gid: 'V-65897'
  tag rid: 'SV-80387r1_rule'
  tag stig_id: 'TMDS-00-000115'
  tag gtitle: 'SRG-APP-000123'
  tag fix_id: 'F-71973r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001495']
  tag nist: ['AU-9']
end
