...
-at least one special character)
  ...
  tag check_id: 'C-26476r461611_chk'
  tag severity: 'medium'
  tag gid: 'V-224785'
  tag rid: 'SV-224785r505933_rule'
  tag stig_id: 'ISEC-06-550700'
  tag gtitle: 'SRG-APP-000164'
  tag fix_id: 'F-26464r461612_fix'
  tag satisfies: ['SRG-APP-000164', 'SRG-APP-000166', 'SRG-APP-000169']
  tag 'documentable'
  tag legacy: ['V-97415', 'SV-106519']
  tag cci: ['CCI-000205', 'CCI-000192', 'CCI-001619']
