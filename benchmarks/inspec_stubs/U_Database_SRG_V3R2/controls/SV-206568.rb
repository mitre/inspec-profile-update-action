...
Abort refers to stopping a program or function before it has finished naturally. The term abort refers to both requested and unexpected terminations.'
  desc 'check', 'Check DBMS settings and vendor documentation to verify the DBMS properly handles transactions in the event of a system failure.
...
The consistent state must include a security configuration that is at least as restrictive as before the system failure. If this is not guaranteed, this is a finding.'
  desc 'fix', 'Configure DBMS settings so that, in the event of a system failure, the DBMS will roll back open transactions to a consistent state, to include a security configuration that is at least as restrictive as before the system failure.'
  impact 0.5
  ref 'DPMS Target Database Generic'
  tag check_id: 'C-6828r291372_chk'
  tag severity: 'medium'
  tag gid: 'V-206568'
  tag rid: 'SV-206568r617447_rule'
  tag stig_id: 'SRG-APP-000225-DB-000153'
  tag gtitle: 'SRG-APP-000225'
  tag fix_id: 'F-6828r291373_fix'
  tag 'documentable'
  tag legacy: ['SV-42865', 'V-32528']
  tag cci: ['CCI-001190']
  tag nist: ['SC-24']
end
