...
You can enable Wireless Setup in the ISE CLI with the command application configure ise, picking the option to enable Wireless Setup.'
  desc 'check', 'Verify Wi-Fi setup has been disabled on a device after initial setup and the device has been placed on the production network.
...
application configure disable Wi-Fi setup'
  ...
  tag check_id: 'C-45916r714231_chk'
  tag severity: 'high'
  tag gid: 'V-242641'
  tag rid: 'SV-242641r714233_rule'
