...
Reference:PP-MDM-412002'
  desc 'check', 'Verify the UEM server uses X.509v3 certificates for code signing for system software updates.

If the UEM server does not use X.509v3 certificates for code signing for system software updates, this is a finding.'
  desc 'fix', 'Configure the UEM server to use X.509v3 certificates for code signing for system software updates.'
  impact 0.5
  ref 'DPMS Target Unified Endpoint Management Server'
  tag check_id: 'C-37759r615356_chk'
  tag severity: 'medium'
  tag gid: 'V-234574'
  tag rid: 'SV-234574r879798_rule'
  tag stig_id: 'SRG-APP-000427-UEM-000299'
  tag gtitle: 'SRG-APP-000427'
  tag fix_id: 'F-37724r615357_fix'
  tag 'documentable'
  tag cci: ['CCI-002470']
  tag nist: ['SC-23 (5)']
end
