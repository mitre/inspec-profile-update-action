...
Reference:PP-MDM-431008)
  desc 'check', 'If the UEM server is using password authentication, verify the server stores only cryptographic representations of passwords.
...
If the UEM server is using password authentication but does not store only cryptographic representations of passwords, this is a finding.'
  desc 'fix', 'For a UEM server using password authentication, configure the server to store only cryptographic representations of passwords.'
  impact 0.5
  ref 'DPMS Target Unified Endpoint Management Server'
  tag check_id: 'C-37559r614132_chk'
  tag severity: 'medium'
  tag gid: 'V-234374'
  tag rid: 'SV-234374r879608_rule'
  tag stig_id: 'SRG-APP-000171-UEM-000101'
  tag gtitle: 'SRG-APP-000171'
  tag fix_id: 'F-37524r614133_fix'
  tag 'documentable'
  tag cci: ['CCI-000196']
  tag nist: ['IA-5 (1) (c)']
end
