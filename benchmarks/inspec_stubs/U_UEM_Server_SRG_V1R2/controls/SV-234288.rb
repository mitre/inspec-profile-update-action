...
If the UEM server does not automatically disable accounts after a 35-day period of account inactivity, this is a finding.'
  desc 'fix', 'Configure the UEM server to automatically disable accounts after a 35-day period of account inactivity.'
  impact 0.5
  ref 'DPMS Target Unified Endpoint Management Server'
  tag check_id: 'C-37473r613874_chk'
  tag severity: 'medium'
  tag gid: 'V-234288'
  tag rid: 'SV-234288r879524_rule'
  tag stig_id: 'SRG-APP-000025-UEM-000014'
  tag gtitle: 'SRG-APP-000025'
  tag fix_id: 'F-37438r613875_fix'
  tag 'documentable'
  tag cci: ['CCI-000017']
  tag nist: ['AC-2 (3) (d)']
end
