...
A reboot is required for the changes to take effect.'
  ...
  tag check_id: 'C-59601r880731_chk'
  tag severity: 'medium'
  tag gid: 'V-255924'
  tag rid: 'SV-255924r880733_rule'
