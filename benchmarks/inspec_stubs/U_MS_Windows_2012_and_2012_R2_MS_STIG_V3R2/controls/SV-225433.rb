...
Severity Override Guidance: This finding can be downgraded to a CAT III if there is an active JIDS or firewall protecting the network.'
  impact 0.5
  ref 'DPMS Target Windows Server 2012-2012 R2 Member Server'
  tag check_id: 'C-27132r471641_chk'
  tag severity: 'medium'
  tag gid: 'V-225433'
  tag rid: 'SV-225433r569185_rule'
  tag stig_id: 'WN12-GE-000022'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-27120r641881_fix'
  tag 'documentable'
