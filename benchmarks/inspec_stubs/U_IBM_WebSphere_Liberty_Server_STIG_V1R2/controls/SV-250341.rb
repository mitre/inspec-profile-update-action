...
<feature>appSecurity-2.0</feature>
  ...
  desc 'fix', 'Configure the ${server.config.dir}/server.xml file and add the appSecurity-2.0 feature. 
...
Validate log entry that indicates "Security service is ready".'
  ...
  tag check_id: 'C-53776r862987_chk'
  tag severity: 'high'
  tag gid: 'V-250341'
  tag rid: 'SV-250341r862989_rule'
  tag stig_id: 'IBMW-LS-000770'
  tag gtitle: 'SRG-APP-000315-AS-000094'
  tag fix_id: 'F-53730r862988_fix'
