control 'SV-230140' do
  title 'Motorola Android Pie must be configured to disallow outgoing beam.'
...
SFR ID: FMT_MOF_EXT.1.2 #47'
  desc 'check', 'Review the Motorola Android Pie device configuration settings to confirm that outgoing beam is disallowed. 
...
If on the MDM console "Disallow outgoing beam" is not set to "On", or on the Motorola Android Pie device "Android Beam" is not off and grayed out, this is a finding.'
  desc 'fix', 'Configure the Motorola Android Pie device to disallow outgoing beam. 
...
On the MDM console, in the Android user restrictions section, set "Disallow outgoing beam" to "On".'
  ...
  tag check_id: 'C-32455r538416_chk'
  tag severity: 'medium'
  tag gid: 'V-230140'
  tag rid: 'SV-230140r569707_rule'
  tag stig_id: 'MOTO-09-010400'
  tag gtitle: 'GOOG-09-010400'
  tag fix_id: 'F-32433r538417_fix'
  tag 'documentable'
