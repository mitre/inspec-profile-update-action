control 'SV-230117' do
  title 'The Motorola Android Pie whitelist must be configured to not include applications with the following characteristics: 
...
SFR ID: FMT_SMF_EXT.1.1 #8b'
  desc 'check', 'Review Motorola Android device configuration settings to determine if the mobile device has an application whitelist configured and that the application whitelist does not include applications with the following characteristics:
...
2. Review the details and privacy policy of each selected app to verify the app does not include prohibited characteristics.

If the MDM console device policy includes applications with unauthorized characteristics, this is a finding.'
  desc 'fix', 'Configure the Motorola Android device application whitelist to exclude applications with the following characteristics:
...
2. Before selecting an app, review the app details and privacy policy to ensure the app does not include prohibited characteristics.'
  ...
  tag check_id: 'C-32432r538347_chk'
  tag severity: 'medium'
  tag gid: 'V-230117'
  tag rid: 'SV-230117r569707_rule'
  tag stig_id: 'MOTO-09-001100'
  tag gtitle: 'GOOG-09-001100'
  tag fix_id: 'F-32410r538348_fix'
  tag 'documentable'
