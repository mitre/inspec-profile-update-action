...
d)	If any item in (b) is untrue for a CICS region’s facility, this is a FINDING.'
  desc 'fix', 'Review the TSS control option values for all CICS facilities.
...
3) CICS transactions defined in the BYPASS list are not sensitive transactions.'
  ...
  tag check_id: 'C-26428r520313_chk'
  tag severity: 'medium'
  tag gid: 'V-224737'
  tag rid: 'SV-224737r520315_rule'
  tag stig_id: 'ZCICT050'
  tag gtitle: 'SRG-OS-000480'
  tag fix_id: 'F-26416r520314_fix'
  tag 'documentable'
