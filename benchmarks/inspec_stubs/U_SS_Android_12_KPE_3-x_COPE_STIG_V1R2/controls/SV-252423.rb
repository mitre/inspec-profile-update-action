...
SFR ID: FMT_SMF_EXT.1.1 #8b'
  desc 'check', "Review the configuration to determine if the Samsung Android devices' Work profile is allowing users to install only applications that have been approved by the Authorizing Official (AO).
...
If on the management tool the app catalog for managed Google Play includes non-AO-approved apps, this is a finding."
  desc 'fix', "Configure the Samsung Android devices' Work profile to allow users to install only applications that have been approved by the Authorizing Official (AO).
...
NOTE: Managed Google Play is an allowed App Store."
  ...
  tag check_id: 'C-55879r815480_chk'
  tag severity: 'medium'
  tag gid: 'V-252423'
  tag rid: 'SV-252423r815482_rule'
  tag stig_id: 'KNOX-12-210180'
  tag gtitle: 'PP-MDF-323060'
  tag fix_id: 'F-55829r815481_fix'
  tag 'documentable'
  tag cci: ['CCI-001764']
  tag nist: ['CM-7 (2)']
end
