...
SFR ID: FMT_SMF_EXT.1.1 #8b'
  desc 'check', 'Verify requirement KNOX-12-210180 (managed Google Play) has been implemented.
...
Implement "managed Google Play" (see requirement KNOX-12-210180).'
  ...
  tag check_id: 'C-55880r816528_chk'
  tag severity: 'medium'
  tag gid: 'V-252424'
  tag rid: 'SV-252424r816527_rule'
  tag stig_id: 'KNOX-12-210190'
  tag gtitle: 'PP-MDF-323070'
  tag fix_id: 'F-55830r816529_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
