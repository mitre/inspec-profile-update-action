control 'SV-216687' do
  ...
  desc 'check', 'This check is Not Applicable for JRSS internal EBGP use.
...
R1(config-router)#end'
  ...
  tag check_id: 'C-17920r877981_chk'
  tag severity: 'medium'
  tag gid: 'V-216687'
  tag rid: 'SV-216687r877982_rule'
  tag stig_id: 'CISC-RT-000490'
  tag gtitle: 'SRG-NET-000018-RTR-000002'
  tag fix_id: 'F-17918r288007_fix'
  tag 'documentable'
  tag legacy: ['SV-106085', 'V-96947']
  tag cci: ['CCI-001368']
  tag nist: ['AC-4']
end
