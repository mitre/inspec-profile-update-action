control 'SV-33131' do
  ...
  desc 'check', 'Query the SA to determine if there is a process for the uploading of files to the web site. This process should include the requirement for the use of a secure encrypted logon and secure encrypted connection.
...
If the remote users are uploading files without utilizing approved encryption methods, this is a finding.'
  ...
  tag check_id: 'C-33783r1_chk'
  tag severity: 'high'
  tag gid: 'V-13686'
  tag rid: 'SV-33131r1_rule'
  tag stig_id: 'WG235 W22'
  tag gtitle: 'WG235'
  tag fix_id: 'F-29426r1_fix'
  tag 'documentable'
