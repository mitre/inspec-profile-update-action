control 'SV-88897' do
  ...
  desc 'check', 'If Reputation-Based Execution settings is not enabled, this check is Not Applicable.
...
Click "Save".'
  ...
  tag check_id: 'C-74259r1_chk'
  tag severity: 'medium'
  tag gid: 'V-74223'
  tag rid: 'SV-88897r1_rule'
  tag stig_id: 'MCAC-TE-000105'
  tag gtitle: 'SRG-APP-000386'
  tag fix_id: 'F-80765r2_fix'
  tag 'documentable'
  tag cci: ['CCI-001774']
  tag nist: ['CM-7 (5) (b)']
end
