...
Incorrect configurations could prevent services from starting and result in a denial of service.'
  desc 'check', 'This applies to member servers only. A separate version applies to domain controllers.
...
- Domain Admins Group'
  ...
  tag check_id: 'C-5939r819708_chk'
  tag severity: 'medium'
  tag gid: 'V-205674'
  tag rid: 'SV-205674r819709_rule'
  tag stig_id: 'WN19-MS-000100'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-5939r354941_fix'
  tag 'documentable'
  tag legacy: ['SV-103101', 'V-93013']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
