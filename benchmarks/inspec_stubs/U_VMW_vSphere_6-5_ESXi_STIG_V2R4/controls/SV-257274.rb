control 'SV-257274' do
  title 'The version of ESXi running on the system must be a supported version.'
...
The application will be configured to check for and install security-relevant software updates within an identified time period from the availability of the update. The specific time period will be defined by an authoritative source (e.g., IAVM, CTOs, DTMs, and STIGs).'
  desc 'check', 'ESXi 6.5 is no longer supported by the vendor. If the system is running ESXi 6.5, this is a finding.'
  desc 'fix', 'Upgrade to a supported version.'
  impact 0.7
  ref 'DPMS Target VMware vSphere 6.5 ESXi'
  tag check_id: 'C-60958r918861_chk'
  tag severity: 'high'
  tag gid: 'V-257274'
  tag rid: 'SV-257274r918863_rule'
  tag stig_id: 'ESXI-65-000999'
