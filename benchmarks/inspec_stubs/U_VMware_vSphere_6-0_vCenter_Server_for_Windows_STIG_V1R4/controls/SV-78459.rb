control 'SV-78459' do
  ...
  desc 'check', 'To view NetFlow Collector IPs configured on distributed switches

From the vSphere Web Client go to Networking >> Select a distributed switch >> Manage >> Settings >> NetFlow.  View the NetFlow pane and verify any collector IP addresses are valid and in use for troubleshooting.
...
$pg.ReconfigureDVPortgroup_Task($spec)
  ...
  tag check_id: 'C-64721r1_chk'
  tag severity: 'medium'
  tag gid: 'V-63969'
  tag rid: 'SV-78459r1_rule'
  tag stig_id: 'VCWN-06-000016'
  tag gtitle: 'SRG-APP-000516'
  tag fix_id: 'F-69899r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
