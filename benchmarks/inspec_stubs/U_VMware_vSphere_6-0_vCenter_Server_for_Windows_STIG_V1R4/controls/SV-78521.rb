control 'SV-78521' do
  ...
  desc 'check', 'From the vSphere Client select the vCenter server at the top of the hierarchy and go to >> Alarms >> Definitions.  Verify there is an alarm created to alert on permission additions.
...
If an alarm is not created to alert on permission addition events, this is a finding.'
  ...
  tag check_id: 'C-64783r1_chk'
  tag severity: 'medium'
  tag gid: 'V-64031'
  tag rid: 'SV-78521r1_rule'
  tag stig_id: 'VCWN-06-000048'
  tag gtitle: 'SRG-APP-000275'
  tag fix_id: 'F-69961r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001294']
  tag nist: ['SI-6 c']
end
