...
If the value of the encryption algorithm for any IKE proposal is not set to use an AES algorithm, this is a finding.'
  desc 'fix', 'The following example commands configure the IKE (phase 1) proposals. The option may also be configured to use the  aes-128-cbc, aes-192-cbc, or aes-256-cbc algorithms.
...
set security ike proposal <IKE-PROPOSAL-NAME> encryption-algorithm aes-256-cbc'
  ...
  tag check_id: 'C-15874r297606_chk'
  tag severity: 'high'
  tag gid: 'V-214673'
  tag rid: 'SV-214673r382783_rule'
  tag stig_id: 'JUSX-VN-000006'
  tag gtitle: 'SRG-NET-000062'
  tag fix_id: 'F-15872r297607_fix'
  tag 'documentable'
