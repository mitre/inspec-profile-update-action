...
___ Repeat the above step for each queue manager ssid identified.'
  desc 'fix', 'Review the WebSphere MQ Screen interface invoked by the REXX CSQOREXX. Review the channel’s SSLCIPH setting.
...
Repeat these steps for each queue manager ssid identified.'
  ...
  tag check_id: 'C-26031r811062_chk'
  tag severity: 'high'
  tag gid: 'V-224354'
  tag rid: 'SV-224354r811064_rule'
  tag stig_id: 'ZWMQ0011'
  tag gtitle: 'SRG-OS-000033'
  tag fix_id: 'F-26019r811063_fix'
