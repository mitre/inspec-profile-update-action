...
d)	If either item in (b) is untrue, this is a FINDING.'
  desc 'fix', "The IAO will ensure that all MQSeries/WebSphere MQ commands are restricted to authorized personnel.
...
F ACF2,REBUILD(MQC)"
  ...
  tag check_id: 'C-26046r521006_chk'
  tag severity: 'medium'
  tag gid: 'V-224369'
  tag rid: 'SV-224369r521008_rule'
  tag stig_id: 'ZWMQ0059'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-26034r521007_fix'
  tag 'documentable'
