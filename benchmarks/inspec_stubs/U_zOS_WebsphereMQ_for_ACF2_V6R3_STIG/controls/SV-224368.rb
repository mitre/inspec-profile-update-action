...
d)	If (b) is untrue, this is a FINDING.'
  desc 'fix', 'The IAO will ensure that use of context resources are restricted to authorized  personnel.
...
CONTEXT.- UID(*) PREVENT'
  ...
  tag check_id: 'C-26045r521003_chk'
  tag severity: 'medium'
  tag gid: 'V-224368'
  tag rid: 'SV-224368r521005_rule'
  tag stig_id: 'ZWMQ0058'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-26033r521004_fix'
  tag 'documentable'
