...
d)	If (b) is untrue, this is a FINDING.'
  desc 'fix', 'The IAO will ensure that use of alternate userids is restricted to authorized  personnel.
...
ALTERNATE.USER.- UID(*) PREVENT'
  ...
  tag check_id: 'C-26044r521000_chk'
  tag severity: 'medium'
  tag gid: 'V-224367'
  tag rid: 'SV-224367r521002_rule'
  tag stig_id: 'ZWMQ0057'
  tag gtitle: 'SRG-OS-000080'
  tag fix_id: 'F-26032r521001_fix'
  tag 'documentable'
