control 'SV-52796' do
  ...
  desc 'check', 'Verify the policy value for User Configuration -> Administrative Templates -> Microsoft Visio 2013 -> Visio Options -> Security -> Trust Center -> "Disable Trust Bar Notification for unsigned application add-ins and block them" is set to "Enabled".
...
Criteria: If the value notbpromptunsignedaddin is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft Visio 2013 -> Visio Options -> Security -> Trust Center -> "Disable Trust Bar Notification for unsigned application add-ins and block them" to "Enabled".'
  impact 0.5
  ref 'DPMS Target Microsoft Visio 2013'
  tag check_id: 'C-47125r1_chk'
  tag severity: 'medium'
  tag gid: 'V-40738'
  tag rid: 'SV-52796r1_rule'
  tag stig_id: 'DTOO131'
  tag gtitle: 'DTOO131 - Trust Bar Notifications'
  tag fix_id: 'F-45722r1_fix'
  tag 'documentable'
