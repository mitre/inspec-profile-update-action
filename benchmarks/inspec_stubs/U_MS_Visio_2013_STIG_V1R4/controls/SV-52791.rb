control 'SV-52791' do
  ...
  desc 'check', %q(Verify the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Navigate URL" is "Enabled" and 'visio.exe' is checked.
...
Criteria: If the value visio.exe is REG_DWORD = 1, this is not a finding.)
  desc 'fix', %q(Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2013 (Machine) -> Security Settings -> IE Security "Navigate URL" to "Enabled" and 'visio.exe'  is checked.)
  impact 0.5
  ref 'DPMS Target Microsoft Visio 2013'
  tag check_id: 'C-47120r1_chk'
  tag severity: 'medium'
  tag gid: 'V-40733'
  tag rid: 'SV-52791r1_rule'
  tag stig_id: 'DTOO123'
  tag gtitle: 'DTOO123 - Block Navigation to URL from Office'
  tag fix_id: 'F-45717r1_fix'
  tag 'documentable'
