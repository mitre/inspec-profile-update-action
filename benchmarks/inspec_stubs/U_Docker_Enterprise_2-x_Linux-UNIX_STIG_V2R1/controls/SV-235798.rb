...
curl -k -H "Authorization: Bearer $AUTHTOKEN" -X POST -d '{"reportAnalytics":false}' -H 'Content-Type: application/json' "https://[dtr_url]/api/v0/meta/settings")
  ...
  tag check_id: 'C-39017r627519_chk'
  tag severity: 'medium'
  tag gid: 'V-235798'
  tag rid: 'SV-235798r627521_rule'
  tag stig_id: 'DKER-EE-001920'
  tag gtitle: 'SRG-APP-000141'
  tag fix_id: 'F-38980r627520_fix'
  tag 'documentable'
  tag legacy: ['SV-104767', 'V-95629']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
