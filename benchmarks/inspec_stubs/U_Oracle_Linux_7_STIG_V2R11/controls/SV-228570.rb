control 'SV-228570' do
  title 'The Oracle Linux operating system must enable the SELinux targeted policy.'
  desc 'Without verification of the security functions, security functions may not operate correctly and the failure may go unnoticed. Security functions are defined as the hardware, software, and/or firmware of the information system responsible for enforcing the system security policy and supporting the isolation of code and data on which the protection is based. Security functionality includes, but is not limited to, establishing system accounts, configuring access authorizations (i.e., permissions, privileges), setting events to be audited, and setting intrusion detection parameters.

This requirement applies to operating systems performing security function verification/testing and/or systems and environments that require this functionality.'
  desc 'check', %q(Per OPORD 16-0080, the endpoint security tool system is Endpoint Security for Linux (ENSL) in conjunction with SELinux.
...
A reboot is required for the changes to take effect.'
  ...
  tag check_id: 'C-36334r754741_chk'
  tag severity: 'medium'
  tag gid: 'V-228570'
  tag rid: 'SV-228570r853732_rule'
  tag stig_id: 'OL07-00-020220'
  tag gtitle: 'SRG-OS-000445-GPOS-00199'
  tag fix_id: 'F-36297r602596_fix'
  tag 'documentable'
