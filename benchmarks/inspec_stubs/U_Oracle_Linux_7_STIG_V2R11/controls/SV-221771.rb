...
enable_krb5 = yes'
  ...
  tag check_id: 'C-23486r419385_chk'
  tag severity: 'medium'
  tag gid: 'V-221771'
  tag rid: 'SV-221771r877390_rule'
  tag stig_id: 'OL07-00-030310'
  tag gtitle: 'SRG-OS-000342-GPOS-00133'
  tag fix_id: 'F-23475r419386_fix'
  tag satisfies: ['SRG-OS-000342-GPOS-00133', 'SRG-OS-000479-GPOS-00224']
  tag 'documentable'
  tag legacy: ['V-99281', 'SV-108385']
  tag cci: ['CCI-001851']
  tag nist: ['AU-4 (1)']
end
