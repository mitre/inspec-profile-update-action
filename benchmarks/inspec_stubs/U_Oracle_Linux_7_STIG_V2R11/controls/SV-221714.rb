...
If "autofs" is required for Network File System (NFS), it must be documented with the ISSO.'
  ...
  tag check_id: 'C-23429r419214_chk'
  tag severity: 'medium'
  tag gid: 'V-221714'
  tag rid: 'SV-221714r603260_rule'
  tag stig_id: 'OL07-00-020110'
  tag gtitle: 'SRG-OS-000114-GPOS-00059'
  tag fix_id: 'F-23418r419215_fix'
  tag satisfies: ['SRG-OS-000114-GPOS-00059', 'SRG-OS-000378-GPOS-00163', 'SRG-OS-000480-GPOS-00227']
  tag 'documentable'
  tag legacy: ['V-99167', 'SV-108271']
  tag cci: ['CCI-000778']
  tag nist: ['IA-3']
end
