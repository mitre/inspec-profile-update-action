control 'SV-233306' do
  title 'The Oracle Linux operating system SSH daemon must prevent remote hosts from connecting to the proxy display.'
...
X11UseLocalhost yes'
  ...
  tag check_id: 'C-36501r622230_chk'
  tag severity: 'medium'
  tag gid: 'V-233306'
  tag rid: 'SV-233306r603298_rule'
  tag stig_id: 'OL07-00-040711'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-36465r622231_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
