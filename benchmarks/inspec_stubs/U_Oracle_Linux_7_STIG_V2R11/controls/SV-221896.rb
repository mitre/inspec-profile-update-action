...
Modify all of the services lines in "/etc/sssd/sssd.conf" or in configuration files found under "/etc/sssd/conf.d" to include pam.'
  ...
  tag check_id: 'C-23611r419760_chk'
  tag severity: 'medium'
  tag gid: 'V-221896'
  tag rid: 'SV-221896r853727_rule'
  tag stig_id: 'OL07-00-041002'
  tag gtitle: 'SRG-OS-000375-GPOS-00160'
  tag fix_id: 'F-23600r419761_fix'
  tag satisfies: ['SRG-OS-000375-GPOS-00160', 'SRG-OS-000375-GPOS-00161', 'SRG-OS-000377-GPOS-00162']
  tag 'documentable'
  tag legacy: ['V-99531', 'SV-108635']
