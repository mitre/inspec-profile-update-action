...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-23529r833077_chk'
  tag severity: 'medium'
  tag gid: 'V-221814'
  tag rid: 'SV-221814r833079_rule'
  tag stig_id: 'OL07-00-030750'
  tag gtitle: 'SRG-OS-000042-GPOS-00020'
  tag fix_id: 'F-23518r833078_fix'
  tag satisfies: ['SRG-OS-000042-GPOS-00020', 'SRG-OS-000392-GPOS-00172']
  tag 'documentable'
  tag legacy: ['SV-108471', 'V-99367']
  tag cci: ['CCI-000135']
  tag nist: ['AU-3 (1)']
end
