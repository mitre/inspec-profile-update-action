control 'SV-255900' do
  title 'The Oracle Linux operating system must have the screen package installed.'
...
Install the tmux program (if it is not on the system) with the following command:
  ...
  tag check_id: 'C-59577r880613_chk'
  tag severity: 'medium'
  tag gid: 'V-255900'
  tag rid: 'SV-255900r880615_rule'
  tag stig_id: 'OL07-00-010090'
  tag gtitle: 'SRG-OS-000029-GPOS-00010'
  tag fix_id: 'F-59520r880614_fix'
  tag 'documentable'
  tag cci: ['CCI-000057']
  tag nist: ['AC-11 a']
end
