...
'
  desc 'check', 'Verify the operating system generates audit records upon successful/unsuccessful attempts to use the "chown", "fchown", "fchownat", and "lchown" syscalls.
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-36295r810480_chk'
  tag severity: 'medium'
  tag gid: 'V-221778'
  tag rid: 'SV-221778r810481_rule'
  tag stig_id: 'OL07-00-030370'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-36259r809146_fix'
