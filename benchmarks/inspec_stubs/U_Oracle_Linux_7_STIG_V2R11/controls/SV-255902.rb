control 'SV-255902' do
  title 'The Oracle Linux operating system must be configured to prevent overwriting of custom authentication configuration settings by the authconfig utility.'
...
Note: With this solution in place, any custom settings to "system-auth" and "password-auth" will be retained and not overwritten by the use of the authconfig utility. The authconfig utility will write its settings to "system-auth-ac" and "password-auth-ac" and continue to function as expected.'
  ...
  tag check_id: 'C-59579r880667_chk'
  tag severity: 'medium'
  tag gid: 'V-255902'
  tag rid: 'SV-255902r902781_rule'
  tag stig_id: 'OL07-00-010199'
  tag gtitle: 'SRG-OS-000073-GPOS-00041'
  tag fix_id: 'F-59522r902780_fix'
  tag 'documentable'
  tag cci: ['CCI-000196']
  tag nist: ['IA-5 (1) (c)']
end
