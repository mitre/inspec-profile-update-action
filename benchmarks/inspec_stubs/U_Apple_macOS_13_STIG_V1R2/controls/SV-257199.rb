...
'
  desc 'check', 'Verify the macOS system is configured to disable Siri and dictation with the following command:
...
If there is no result, or if "Assistant Allowed" and "Ironwood Allowed" are not set to "0", this is a finding.'
  ...
  tag check_id: 'C-60884r905228_chk'
  tag severity: 'medium'
  tag gid: 'V-257199'
  tag rid: 'SV-257199r905230_rule'
