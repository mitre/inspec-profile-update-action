control 'SV-80583' do
  ...
  desc 'check', 'Review the HP FlexFabric Switch configuration and ensure all user-facing or untrusted ports are configured as access port.
...
XGE1/0/4             UP   1G(a)   F(a)   A    100'
  desc 'fix', 'Configure all user-facing or untrusted ports as access ports.

[HP-GigabitEthernet1/0/13]port link-type access'
  impact 0.5
  ref 'DPMS Target HP Flex Fabric Switch 7 L2S'
  tag check_id: 'C-66737r1_chk'
  tag severity: 'medium'
  tag gid: 'V-66093'
  tag rid: 'SV-80583r1_rule'
  tag stig_id: 'HFFS-L2-000028'
  tag gtitle: 'SRG-NET-000512-L2S-000011'
  tag fix_id: 'F-72169r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
