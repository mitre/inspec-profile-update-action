control 'SV-223295' do
  ...
  desc "This policy setting allows you to control how ActiveX controls in UserForms should be initialized based upon whether they are Safe for Initialization (SFI) or Unsafe for Initialization (UFI). 
...
If the value LoadControlsInForms is REG_DWORD=1, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration >> Administrative Templates >> Microsoft Office 2016 >> Security Settings "Load Controls in Forms3" to "Enabled:1".'
  impact 0.5
  ref 'DPMS Target Microsoft Office 365 ProPlus'
  tag check_id: 'C-24968r684245_chk'
  tag severity: 'medium'
  tag gid: 'V-223295'
  tag rid: 'SV-223295r684247_rule'
  tag stig_id: 'O365-CO-000013'
  tag gtitle: 'SRG-APP-000207'
  tag fix_id: 'F-24956r684246_fix'
  tag 'documentable'
