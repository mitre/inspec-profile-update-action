...
If the value for vbawarnings is REG_DWORD = 1, this is not a finding.'
  ...
  tag check_id: 'C-25049r442347_chk'
  tag severity: 'medium'
  tag gid: 'V-223376'
  tag rid: 'SV-223376r508019_rule'
  tag stig_id: 'O365-PR-000003'
  tag gtitle: 'SRG-APP-000141'
  tag fix_id: 'F-25037r442348_fix'
  tag 'documentable'
