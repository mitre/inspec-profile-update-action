...
If the value junkmailprotection is set to "High", this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration >> Administrative Templates >> Microsoft Outlook 2016 >> Outlook Options >> Preferences >> Junk E-mail >> Junk E-mail protection level to "High".'
  impact 0.5
  ref 'DPMS Target Microsoft Office 365 ProPlus'
  tag check_id: 'C-25024r442272_chk'
  tag severity: 'medium'
  tag gid: 'V-223351'
  tag rid: 'SV-223351r508019_rule'
  tag stig_id: 'O365-OU-000006'
  tag gtitle: 'SRG-APP-000516'
  tag fix_id: 'F-25012r442273_fix'
  tag 'documentable'
