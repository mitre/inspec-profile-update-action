...
Note: This policy setting only applies to subscription versions of Office, such as Office 365 ProPlus.'
  desc 'check', 'Verify the policy value for User Configuration >> Administrative Templates >> Microsoft Excel 2016 >> Microsoft Excel 2016 >> Excel Options >> Security >> Trust Center >> External Content >> Always open untrusted database files in Protected View is set to "Enabled".
...
If the value for enabledatabasefileprotectedview is REG_DWORD = 1, this is not a finding.'
  ...
  tag check_id: 'C-25012r684250_chk'
  tag severity: 'medium'
  tag gid: 'V-223339'
  tag rid: 'SV-223339r684251_rule'
