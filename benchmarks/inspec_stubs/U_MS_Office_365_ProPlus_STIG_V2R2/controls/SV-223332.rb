...
If value for extensionhardening is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set policy value for User Configuration >> Administrative Templates >> Microsoft Excel 2016 >> Excel Options >> Security >> Force file extension to match file type to "Always match file type".'
  impact 0.5
  ref 'DPMS Target Microsoft Office 365 ProPlus'
  tag check_id: 'C-25005r442215_chk'
  tag severity: 'medium'
  tag gid: 'V-223332'
  tag rid: 'SV-223332r508019_rule'
  tag stig_id: 'O365-EX-000023'
  tag gtitle: 'SRG-APP-000516'
  tag fix_id: 'F-24993r442216_fix'
  tag 'documentable'
