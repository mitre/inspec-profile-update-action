...
Multifactor authentication (MFA) is required for all administrative and user accounts on network devices, except for an account of last resort and (where applicable) a root account. Passwords should only be used when MFA using PKI is not available and for the account of last resort and root account.'
  desc 'check', 'Review the Cisco switch configuration to verify that it requires the use of at least one upper-case character as shown in the example below:
...
SW1(config-cc-policy)#exit'
  ...
  tag check_id: 'C-22305r507816_chk'
  tag severity: 'medium'
  tag gid: 'V-220590'
  tag rid: 'SV-220590r521267_rule'
  tag stig_id: 'CISC-ND-000570'
  tag gtitle: 'SRG-APP-000166-NDM-000254'
  tag fix_id: 'F-22294r507817_fix'
  tag 'documentable'
  tag legacy: ['SV-110409', 'V-101305']
  tag cci: ['CCI-000192']
  tag nist: ['IA-5 (1) (a)']
end
