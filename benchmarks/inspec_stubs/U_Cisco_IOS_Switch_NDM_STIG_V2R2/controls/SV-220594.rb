...
Multifactor authentication (MFA) is required for all administrative and user accounts on network devices, except for an account of last resort and (where applicable) a root account. Passwords should only be used when MFA using PKI is not available and for the account of last resort and root account.'
  desc 'check', 'Review the Cisco switch configuration to verify that, when a password is changed, it requires the characters to be changed in at least eight of the positions as shown in the example below:
...
SW1(config-cc-policy)#exit'
  ...
  tag check_id: 'C-22309r507828_chk'
  tag severity: 'medium'
  tag gid: 'V-220594'
  tag rid: 'SV-220594r521267_rule'
  tag stig_id: 'CISC-ND-000610'
  tag gtitle: 'SRG-APP-000170-NDM-000329'
  tag fix_id: 'F-22298r507829_fix'
  tag 'documentable'
  tag legacy: ['SV-110417', 'V-101313']
  tag cci: ['CCI-000195']
  tag nist: ['IA-5 (1) (b)']
end
