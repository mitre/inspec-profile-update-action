control 'SV-252850' do
  title 'Zebra Android 11 must be configured to enforce a minimum password length of six characters.'
...
SFR ID: FMT_SMF_EXT.1.1 #1a'
  desc 'check', 'Review Zebra Android device configuration settings to determine if the mobile device is enforcing a minimum password length of six characters.
...
If the device password length is not set to six characters or more on EMM console or on the Android 11 device, this is a finding.'
  desc 'fix', 'Configure the Zebra Android 11 device to enforce a minimum password length of six characters.
...
6. Enter in the number of characters as "6".'
  ...
  tag check_id: 'C-56306r820475_chk'
  tag severity: 'medium'
  tag gid: 'V-252850'
  tag rid: 'SV-252850r820477_rule'
  tag stig_id: 'ZEBR-11-000100'
  tag gtitle: 'PP-MDF-301010'
  tag fix_id: 'F-56256r820476_fix'
  tag 'documentable'
  tag cci: ['CCI-000205']
  tag nist: ['IA-5 (1) (a)']
end
