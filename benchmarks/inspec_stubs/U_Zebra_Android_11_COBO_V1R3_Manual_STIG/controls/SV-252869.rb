control 'SV-252869' do
  title 'Zebra Android 11 must be configured to generate audit records for the following auditable events: Detected integrity violations.'
...
SFR ID: FMT_SMF_EXT.1.1 #37'
  desc 'check', 'Review Zebra Android device configuration settings to determine if the mobile device is configured to generate audit records for the following auditable events: Detected integrity violations.
...
If the EMM console device policy is not set to enable security logging, this is a finding.'
  desc 'fix', 'Configure the Zebra Android 11 device to generate audit records for the following auditable events: Detected integrity violations.
...
2. Toggle "Enable security logging" to "On".'
  ...
  tag check_id: 'C-56325r820532_chk'
  tag severity: 'low'
  tag gid: 'V-252869'
  tag rid: 'SV-252869r820534_rule'
  tag stig_id: 'ZEBR-11-006100'
  tag gtitle: 'PP-MDF-301420'
  tag fix_id: 'F-56275r820533_fix'
  tag 'documentable'
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
end
