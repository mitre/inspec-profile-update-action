control 'SV-252870' do
  title 'Zebra Android 11 users must complete required training.'
...
- AO guidance on acceptable use and restrictions, if any, on downloading and installing personal apps and data (music, photos, etc.) in the Zebra device personal space.'
  ...
  tag check_id: 'C-56326r820535_chk'
  tag severity: 'medium'
  tag gid: 'V-252870'
  tag rid: 'SV-252870r820537_rule'
  tag stig_id: 'ZEBR-11-008700'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-56276r820536_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
