control 'SV-252873' do
  title 'Zebra Android 11 must allow only the administrator (EMM) to install/remove DoD root and intermediate PKI certificates.'
...
If on the Zebra Android 11 device the user is able to remove certificates, this is a finding.'
  desc 'fix', 'Configure Zebra Android 11 device to prevent a user from removing DoD root and intermediate PKI certificates.
...
2. Toggle "Disallow config credentials" to "On".'
  ...
  tag check_id: 'C-56329r820544_chk'
  tag severity: 'medium'
  tag gid: 'V-252873'
  tag rid: 'SV-252873r820546_rule'
  tag stig_id: 'ZEBR-11-009100'
  tag gtitle: 'PP-MDF-992000'
  tag fix_id: 'F-56279r820545_fix'
  tag 'documentable'
