...
If Word is configured to automatically update links when documents are open, document content can change without the user's knowledge, which could put important information at risk."
  desc 'check', 'Verify the policy value for User Configuration -> Administrative Templates -> Microsoft Word 2016 -> Word Options -> Advanced "Update automatic links at Open" is set to "Disabled".
...
Criteria: If the value DontUpdateLinks is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft Word 2016 -> Word Options -> Advanced "Update automatic links at Open" to "Disabled".'
  impact 0.5
  ref 'DPMS Target Microsoft Word 2016'
  tag check_id: 'C-71515r2_chk'
  tag severity: 'medium'
  tag gid: 'V-71087'
  tag rid: 'SV-85711r1_rule'
  tag stig_id: 'DTOO302'
  tag gtitle: 'SRG-APP-000210'
  tag fix_id: 'F-77419r2_fix'
  tag 'documentable'
  tag cci: ['CCI-001170']
  tag nist: ['SC-18 (4)']
end
