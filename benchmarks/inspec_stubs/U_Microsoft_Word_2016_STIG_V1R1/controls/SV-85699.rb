control 'SV-85699' do
  ...
  desc 'check', 'Verify the policy value for User Configuration -> Administrative Templates -> Microsoft Word 2016 -> Word Options -> Security -> Trust Center "Trust access to Visual Basic Project" is set to "Disabled".
...
Criteria: If the value AccessVBOM is REG_DWORD = 0, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft Word 2016 -> Word Options -> Security -> Trust Center "Trust access to Visual Basic Project" to "Disabled".'
  impact 0.5
  ref 'DPMS Target Microsoft Word 2016'
  tag check_id: 'C-71503r2_chk'
  tag severity: 'medium'
  tag gid: 'V-71075'
  tag rid: 'SV-85699r1_rule'
  tag stig_id: 'DTOO146'
  tag gtitle: 'SRG-APP-000141'
  tag fix_id: 'F-77407r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
