...
Criteria: If the value OpenInProtectedView is REG_DWORD = 0, this is not a finding.'
  ...
  tag check_id: 'C-71471r2_chk'
  tag severity: 'medium'
  tag gid: 'V-71043'
  tag rid: 'SV-85667r1_rule'
  tag stig_id: 'DTOO110'
  tag gtitle: 'SRG-APP-000207'
  tag fix_id: 'F-77375r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001662']
  tag nist: ['SC-18 (1)']
end
