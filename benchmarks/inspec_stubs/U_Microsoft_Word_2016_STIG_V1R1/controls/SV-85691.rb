control 'SV-85691' do
  ...
  desc 'check', 'Verify the policy value for User Configuration -> Administrative Templates -> Microsoft Word 2016 -> Word Options -> Security -> Trust Center -> Trusted Locations "Disable all trusted locations" is set to "Enabled".
...
Criteria: If the value AllLocationsDisabled is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft Word 2016 -> Word Options -> Security -> Trust Center -> Trusted Locations "Disable all trusted locations" to "Enabled".'
  impact 0.5
  ref 'DPMS Target Microsoft Word 2016'
  tag check_id: 'C-71495r2_chk'
  tag severity: 'medium'
  tag gid: 'V-71067'
  tag rid: 'SV-85691r1_rule'
  tag stig_id: 'DTOO133'
  tag gtitle: 'SRG-APP-000210'
  tag fix_id: 'F-77399r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001170']
  tag nist: ['SC-18 (4)']
end
