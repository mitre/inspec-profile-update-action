...
Ensure that all IBM SDSF resources are properly protected according to the requirements specified in the Site Security Plan (SSP). The plan should be based on the SDSF SAF Resources table in the z/OS STIG Addendum and validated by the site ISSO. If the following guidance is true, this is not a finding.
...
TSS PERMIT(syspaudt) SDSF(ISFATTR.JOBCL) ACCESS(UPDATE)'
  ...
  tag check_id: 'C-26806r840198_chk'
  tag severity: 'medium'
  tag gid: 'V-225107'
  tag rid: 'SV-225107r840201_rule'
  tag stig_id: 'ZISFT020'
  tag gtitle: 'SRG-OS-000018'
  tag fix_id: 'F-26794r840200_fix'
  tag 'documentable'
