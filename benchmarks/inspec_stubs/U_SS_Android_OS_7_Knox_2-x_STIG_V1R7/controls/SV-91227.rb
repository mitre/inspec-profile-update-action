...
SFR ID: FMT_SMF_EXT.1.1 #8b'
  desc 'check', 'Review Samsung Android 7 with Knox configuration settings to determine if the mobile device has an application disable list configured to include applications with the following characteristics:
...
Note: Refer to the Supplemental document, Table 6-1, for additional information.'
  ...
  tag check_id: 'C-76191r1_chk'
  tag severity: 'medium'
  tag gid: 'V-76531'
  tag rid: 'SV-91227r1_rule'
  tag stig_id: 'KNOX-07-001700'
  tag gtitle: 'PP-MDF-301100'
  tag fix_id: 'F-83213r1_fix'
  tag 'documentable'
