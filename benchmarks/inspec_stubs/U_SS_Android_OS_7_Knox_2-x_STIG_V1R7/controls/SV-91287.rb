...
SFR ID: FMT_SMF_EXT.1.1 #47'
  desc 'check', 'Review Samsung Android 7 with Knox configuration settings to determine if the mobile device is configured to implement to disable manual date and time changes.
...
If the MDM console "Date Time Changes Enabled" is set or on the Samsung Android 7 with Knox device, "Automatic date and time" is not set, or the user is able to turn off this option, this is a finding.'
  desc 'fix', 'Configure the Samsung Android 7 with Knox to disable manual date and time changes.
...
On the MDM console, deselect the "Date Time Changes Enabled" checkbox in the "Android Date Time" rule.'
  ...
  tag check_id: 'C-76259r1_chk'
  tag severity: 'medium'
  tag gid: 'V-76591'
  tag rid: 'SV-91287r1_rule'
  tag stig_id: 'KNOX-07-013100'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-83285r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
