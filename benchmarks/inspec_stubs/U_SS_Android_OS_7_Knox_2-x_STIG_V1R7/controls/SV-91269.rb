...
SFR ID: FMT_SMF_EXT.1.1 #47'
  desc 'check', 'Review Samsung Android 7 with Knox configuration settings to determine if the mobile device has the DoD root and intermediate PKI certificates installed. 
...
If the MDM console "Android Certificate" does not have the DoD root and intermediate PKI certificates present or on the Samsung Android 7 with Knox device, "View security certificates" does not have the DoD root and intermediate PKI certificates present, this is a finding.'
  desc 'fix', 'Configure the Samsung Android 7 with Knox to install DoD root and intermediate certificates.
...
http://iase.rel.disa.smil.mil/pki-pke/function_pages/tools.html (for SIPRNet).'
  ...
  tag check_id: 'C-76239r1_chk'
  tag severity: 'medium'
  tag gid: 'V-76573'
  tag rid: 'SV-91269r1_rule'
  tag stig_id: 'KNOX-07-012300'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-83267r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
