...
SFR ID: FMT_SMF_EXT.1.1 #1a'
  desc 'check', 'Review Samsung Android 7 with Knox configuration settings to determine if the mobile device is enforcing a minimum password length of six characters.
...
If the MDM console "Minimum Length" setting is not set to six characters or more or on the Samsung Android 7 with Knox device, a password of less than six characters is accepted, this is a finding.'
  desc 'fix', 'Configure the Samsung Android 7 with Knox to enforce a minimum password length of six characters.
...
Note: When device encryption is enabled (always enabled by the DoD configuration), Samsung Android 7 with Knox automatically enforces a minimum length of "6".'
  ...
  tag check_id: 'C-76175r1_chk'
  tag severity: 'low'
  tag gid: 'V-76515'
  tag rid: 'SV-91211r1_rule'
  tag stig_id: 'KNOX-07-000100'
  tag gtitle: 'PP-MDF-301010'
  tag fix_id: 'F-83197r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000205']
  tag nist: ['IA-5 (1) (a)']
end
