...
If the specified encryption settings are not set to the appropriate values, this is a finding.)
  desc 'fix', 'Configure the Samsung Android 7 with Knox to enable information at rest protection for removable media.
...
Enable the "External Storage Encryption" setting in the "Android Security" rule.'
  ...
  tag check_id: 'C-76205r1_chk'
  tag severity: 'high'
  tag gid: 'V-76545'
  tag rid: 'SV-91241r1_rule'
  tag stig_id: 'KNOX-07-003000'
  tag gtitle: 'PP-MDF-301140'
  tag fix_id: 'F-83227r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001199']
  tag nist: ['SC-28']
end
