...
SFR ID: FMT_SMF_EXT.1.1 #40'
  desc 'check', 'Review Samsung Android 7 with Knox configuration settings to determine if the capability to back up to a locally connected system has been disabled. 
...
If the MDM console "Disable USB Media Player" is not set to disabled or on the Samsung Android 7 with Knox device, it connects with the Samsung Smart Switch or KIES program, this is a finding.'
  desc 'fix', 'Configure the Samsung Android 7 with Knox to disable backup to locally connected systems.
...
Note: Disabling USB Media Player will also disable USB MTP, USB mass storage, and USB vendor protocol (Smart Switch, KIES).'
  ...
  tag check_id: 'C-76215r1_chk'
  tag severity: 'medium'
  tag gid: 'V-76555'
  tag rid: 'SV-91251r1_rule'
  tag stig_id: 'KNOX-07-004700'
  tag gtitle: 'PP-MDF-301220'
  tag fix_id: 'F-83237r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000097']
  tag nist: ['AC-20 (2)']
end
