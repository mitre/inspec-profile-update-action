control 'SV-91245' do
  ...
  desc 'Developer modes expose features of the Samsung Android 7 with Knox that are not available during standard operation. An adversary may leverage a vulnerability inherent in a developer mode to compromise the confidentiality, integrity, and availability of DoD-sensitive information. Disabling developer modes mitigates this risk.

SFR ID: FMT_SMF_EXT.1.1 #26'
  desc 'check', 'Review Samsung Android 7 with Knox configuration settings to determine whether a developer mode is enabled.
...
4. Rapidly tap on "Build number" multiple times until the device displays the Developer Options menu item.'
  desc 'fix', 'Configure the Samsung Android 7 with Knox to disable developer modes.
...
On the MDM console, deselect the "Allow Developer Mode" checkbox in the "Android Restrictions" rule.'
  ...
  tag check_id: 'C-76209r1_chk'
  tag severity: 'medium'
  tag gid: 'V-76549'
  tag rid: 'SV-91245r1_rule'
  tag stig_id: 'KNOX-07-003700'
  tag gtitle: 'PP-MDF-301170'
  tag fix_id: 'F-83231r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
