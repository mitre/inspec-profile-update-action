...
If the MDM console "Maximum Sequential Character" and "Maximum Sequential Number" are set to more than two repeating or sequential characters or on the Samsung Android 7 with Knox device, a password with more than two repeating or sequential characters is accepted, this is a finding.'
  desc 'fix', 'Configure the Samsung Android 7 with Knox to prevent passwords from containing more than two repeating or sequential characters.
...
2. Set the "Maximum Sequential Numbers" value to "2" in the "Android Password Restrictions" rule.'
  ...
  tag check_id: 'C-76177r1_chk'
  tag severity: 'low'
  tag gid: 'V-76517'
  tag rid: 'SV-91213r1_rule'
  tag stig_id: 'KNOX-07-000200'
  tag gtitle: 'PP-MDF-301020'
  tag fix_id: 'F-83199r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
