...
Note: There are multiple default "classes" defined in the "/etc/security/audit/config" file. The only audit class that is required by this document is the "stig_aud_class". All other defined classes can be removed at the discretion of the organization.'
  ...
  tag check_id: 'C-16444r853462_chk'
  tag severity: 'medium'
  tag gid: 'V-215246'
  tag rid: 'SV-215246r853463_rule'
  ...
  tag cci: ['CCI-000018', 'CCI-000154', 'CCI-000169', 'CCI-000172', 'CCI-001403', 'CCI-001404', 'CCI-001405', 'CCI-001686', 'CCI-001813', 'CCI-002130', 'CCI-002132', 'CCI-002234', 'CCI-002884']
  tag nist: ['AC-2 (4)', 'AU-6 (4)', 'AU-12 a', 'AU-12 c', 'AC-2 (4)', 'AC-2 (4)', 'AC-2 (4)', 'AC-2 (4)', 'CM-5 (1) (a)', 'AC-2 (4)', 'AC-2 (4)', 'AC-6 (9)', 'MA-4 (1) (a)']
end
