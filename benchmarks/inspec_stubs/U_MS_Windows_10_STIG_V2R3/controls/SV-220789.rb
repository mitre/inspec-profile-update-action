...
Object Access  >> Detailed File Share - Failure'
  desc 'fix', 'Configure the policy value for Computer Configuration >> Windows Settings >> Security Settings >> Advanced Audit Policy Configuration >> System Audit Policies >> Object Access >> “Detailed File Share" with "Failure" selected.'
  impact 0.5
  ref 'DPMS Target Windows 10'
  tag check_id: 'C-22504r554852_chk'
  tag severity: 'medium'
  tag gid: 'V-220789'
  tag rid: 'SV-220789r569187_rule'
  tag stig_id: 'WN10-AU-000570'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-22493r554853_fix'
  tag 'documentable'
