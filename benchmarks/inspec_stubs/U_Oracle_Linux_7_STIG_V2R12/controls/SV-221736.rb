control 'SV-221736' do
  title 'The Oracle Linux operating system must be configured so that all local initialization files for local interactive users are be group-owned by the users primary group or root.'
...
Note: The example will be for the user smithj, who has a home directory of "/home/smithj" and has a primary group of users.
  ...
  tag check_id: 'C-36279r917846_chk'
  tag severity: 'medium'
  tag gid: 'V-221736'
  tag rid: 'SV-221736r917848_rule'
  tag stig_id: 'OL07-00-020700'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-36243r917847_fix'
  tag 'documentable'
  tag legacy: ['SV-108315', 'V-99211']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
