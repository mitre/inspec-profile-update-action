...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-23526r833068_chk'
  tag severity: 'medium'
  tag gid: 'V-221811'
  tag rid: 'SV-221811r833070_rule'
  tag stig_id: 'OL07-00-030710'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-23515r833069_fix'
