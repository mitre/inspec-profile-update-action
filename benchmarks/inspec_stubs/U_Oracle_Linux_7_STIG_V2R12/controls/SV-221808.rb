...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-23523r833062_chk'
  tag severity: 'medium'
  tag gid: 'V-221808'
  tag rid: 'SV-221808r833064_rule'
  tag stig_id: 'OL07-00-030680'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-23512r833063_fix'
