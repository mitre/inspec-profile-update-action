control 'SV-221760' do
  title 'The Oracle Linux operating system must be configured so that the file integrity tool is configured to verify extended attributes.'
...
If AIDE is installed, ensure the "xattrs" rule is present on all uncommented file and directory selection lists.'
  ...
  tag check_id: 'C-23475r880696_chk'
  tag severity: 'low'
  tag gid: 'V-221760'
  tag rid: 'SV-221760r880697_rule'
  tag stig_id: 'OL07-00-021610'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-23464r419353_fix'
  tag 'documentable'
  tag legacy: ['V-99259', 'SV-108363']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
