control 'SV-251699' do
  title 'The Oracle Linux operating system must specify the default "include" directory for the /etc/sudoers file.'
...
#includedir /etc/sudoers.d'
  ...
  tag check_id: 'C-55136r833015_chk'
  tag severity: 'medium'
  tag gid: 'V-251699'
  tag rid: 'SV-251699r833016_rule'
  tag stig_id: 'OL07-00-010339'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-55090r809176_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
