control 'SV-256976' do
  title 'The Oracle Linux operating system must disable the login screen user list for graphical user interfaces.'
...
If the login screen user list persists after updating the system databases, you can restart the GNOME Desktop without rebooting the system:
  ...
  tag check_id: 'C-60654r902763_chk'
  tag severity: 'medium'
  tag gid: 'V-256976'
  tag rid: 'SV-256976r902765_rule'
  tag stig_id: 'OL07-00-010063'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-60596r902764_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
