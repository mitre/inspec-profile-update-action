...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-23522r833059_chk'
  tag severity: 'medium'
  tag gid: 'V-221807'
  tag rid: 'SV-221807r833061_rule'
  tag stig_id: 'OL07-00-030670'
  tag gtitle: 'SRG-OS-000042-GPOS-00020'
  tag fix_id: 'F-23511r833060_fix'
  tag satisfies: ['SRG-OS-000042-GPOS-00020', 'SRG-OS-000392-GPOS-00172', 'SRG-OS-000471-GPOS-00215']
  tag 'documentable'
  tag legacy: ['V-99353', 'SV-108457']
  tag cci: ['CCI-000135']
  tag nist: ['AU-3 (1)']
end
