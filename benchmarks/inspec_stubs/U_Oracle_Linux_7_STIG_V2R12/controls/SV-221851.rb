control 'SV-221851' do
  title 'The Oracle Linux operating system must be configured so that all network connections associated with SSH traffic terminate after becoming unresponsive.'
...
If "ClientAliveCountMax" is not set to "0", this is a finding.'
  desc 'fix', 'Note: This setting must be applied in conjunction with OL07-00-040320 to function correctly.
...
The SSH service must be restarted for changes to take effect.'
  ...
  tag check_id: 'C-23566r917858_chk'
  tag severity: 'medium'
  tag gid: 'V-221851'
  tag rid: 'SV-221851r917860_rule'
  tag stig_id: 'OL07-00-040340'
  tag gtitle: 'SRG-OS-000163-GPOS-00072'
  tag fix_id: 'F-23555r917859_fix'
