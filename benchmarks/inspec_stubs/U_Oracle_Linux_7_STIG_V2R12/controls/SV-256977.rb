control 'SV-256977' do
  title 'The Oracle Linux operating system must be configured to allow sending email notifications of unauthorized configuration changes to designated personnel.'
...
If "mailx" package is not installed, this is a finding.'
  ...
  tag check_id: 'C-60655r902769_chk'
  tag severity: 'medium'
  tag gid: 'V-256977'
  tag rid: 'SV-256977r902771_rule'
  tag stig_id: 'OL07-00-020028'
  tag gtitle: 'SRG-OS-000363-GPOS-00150'
  tag fix_id: 'F-60597r902770_fix'
  tag 'documentable'
  tag cci: ['CCI-001744']
  tag nist: ['CM-3 (5)']
end
