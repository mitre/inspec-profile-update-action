control 'SV-255901' do
  title 'The Oracle Linux operating system must restrict access to the kernel message buffer.'
...
Reload settings from all system configuration files with the following command:
  ...
  tag check_id: 'C-59578r880625_chk'
  tag severity: 'low'
  tag gid: 'V-255901'
  tag rid: 'SV-255901r880627_rule'
  tag stig_id: 'OL07-00-010375'
  tag gtitle: 'SRG-OS-000138-GPOS-00069'
  tag fix_id: 'F-59521r880626_fix'
  tag 'documentable'
  tag cci: ['CCI-001090']
  tag nist: ['SC-4']
end
