control 'SV-221892' do
  title 'The Oracle Linux operating system access control program must be configured to grant or deny system access to specific hosts and services.'
...
If "firewalld" is not "active", enable "tcpwrappers" by configuring "/etc/hosts.allow" and "/etc/hosts.deny" to allow or deny access to specific hosts.'
  ...
  tag check_id: 'C-23607r419748_chk'
  tag severity: 'medium'
  tag gid: 'V-221892'
  tag rid: 'SV-221892r603260_rule'
  tag stig_id: 'OL07-00-040810'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-23596r419749_fix'
  tag 'documentable'
  tag legacy: ['SV-108627', 'V-99523']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
