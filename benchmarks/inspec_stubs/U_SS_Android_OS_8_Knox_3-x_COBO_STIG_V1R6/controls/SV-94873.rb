...
SFR ID: FMT_SMF_EXT.1.1 #8b'
  desc 'check', 'Review Samsung Android 8 with Knox configuration settings to determine if the mobile device has been configured to whitelist application installations based on one of the following characteristics:
- Digital signature
- Package name
...
• com.google.android.gsf'
  desc 'fix', 'Configure the Samsung Android 8 with Knox device to whitelist application installations based on one of the following characteristics:
- Digital signature
- Package name
...
• com.google.android.gsf'
  ...
  tag check_id: 'C-79837r1_chk'
  tag severity: 'medium'
  tag gid: 'V-80169'
  tag rid: 'SV-94873r1_rule'
  tag stig_id: 'KNOX-08-001300'
  tag gtitle: 'PP-MDF-301090'
  tag fix_id: 'F-86975r1_fix'
  tag 'documentable'
