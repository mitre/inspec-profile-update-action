...
If the MDM console "Allowed Bluetooth Profiles" is set to profiles other than HSP, HFP, SPP, A2DP, AVRCP, or PBAP the Samsung Android 8 with Knox device is able to pair with a Bluetooth keyboard, this is a finding.

Note: Disabling the Bluetooth radio will satisfy this requirement.'
  desc 'fix', 'Configure the Samsung Android 8 with Knox to disable all Bluetooth profiles except for HSP, HFP, and SPP, A2DP, AVRCP, and PBAP.

On the MDM console, ensure that all options are deselected except HFP, HSP, and SPP, A2DP, AVRCP, and PBAP in the "Allowed Bluetooth Profiles" setting in the "Android Bluetooth" rule.'
  impact 0.3
  ref 'DPMS Target Samsung Android OS 8 with Knox 3.x - COBO use case'
  tag check_id: 'C-79895r2_chk'
  tag severity: 'low'
  tag gid: 'V-80223'
  tag rid: 'SV-94927r2_rule'
  tag stig_id: 'KNOX-08-013900'
  tag gtitle: 'PP-MDF-301110'
  tag fix_id: 'F-87029r2_fix'
  tag 'documentable'
