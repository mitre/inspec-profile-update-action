control 'SV-94933' do
  ...
  desc "On Samsung Android 8 with Knox devices, users may be able to access the device's contact database or calendar to obtain phone numbers and other information using a human voice even when the mobile device is locked. Often this information is personally identifiable information (PII), which is considered sensitive. It could also be used by an adversary to profile the user or engage in social engineering to obtain further information from other unsuspecting users. Disabling access to the contact database and calendar in these situations mitigates the risk of this attack. The Authorizing Official (AO) may waive this requirement with written notice if the operational environment requires this capability.

SFR ID: FMT_SMF_EXT.1.1 #47"
  desc 'check', 'Review Samsung Android 8 with Knox configuration settings to determine if the mobile device is configured to disable S Voice. 
...
If the MDM console "Allow S Voice" check box is selected or on the Samsung Android 8 with Knox device, the S Voice application can be launched, this is a finding.'
  desc 'fix', 'Configure the Samsung Android 8 with Knox to disable S Voice.
...
On the MDM console, deselect the "Allow S Voice" check box in the "Android Restrictions" rule.'
  ...
  tag check_id: 'C-79901r1_chk'
  tag severity: 'medium'
  tag gid: 'V-80229'
  tag rid: 'SV-94933r1_rule'
  tag stig_id: 'KNOX-08-014700'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-87035r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
