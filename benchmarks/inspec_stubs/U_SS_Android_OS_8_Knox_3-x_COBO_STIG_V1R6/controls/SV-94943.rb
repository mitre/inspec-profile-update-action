...
SFR ID: FMT_SMF_EXT.1.1 #47'
  desc 'check', 'Review Samsung Android 8 with Knox configuration settings to determine if the mobile device is enforcing disabling of "Share Via List".
...
Note: Disabling "Share Via List" will also disable functionality such as "Gallery Sharing" and "Direct Sharing".'
  ...
  tag check_id: 'C-79911r1_chk'
  tag severity: 'medium'
  tag gid: 'V-80239'
  tag rid: 'SV-94943r1_rule'
  tag stig_id: 'KNOX-08-015950'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-87045r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
