...
Apply ASM policy to the applicable Virtual Server(s) in BIG-IP LTM module to prevent code injection attacks from being launched against application objects, including, at a minimum, application URLs and application code.'
  ...
  tag check_id: 'C-16966r291135_chk'
  tag severity: 'medium'
  tag gid: 'V-215774'
  tag rid: 'SV-215774r557356_rule'
  tag stig_id: 'F5BI-LT-000159'
  tag gtitle: 'SRG-NET-000318-ALG-000151'
  tag fix_id: 'F-16964r291136_fix'
  tag 'documentable'
  tag legacy: ['V-60329', 'SV-74759']
  tag cci: ['CCI-002346']
  tag nist: ['AC-23']
end
