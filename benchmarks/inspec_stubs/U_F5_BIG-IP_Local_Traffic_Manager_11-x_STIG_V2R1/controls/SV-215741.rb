control 'SV-215741' do
  ...
  desc %q(Display of a standardized and approved use notification before granting access to the virtual servers ensures privacy and security notification verbiage used is consistent with applicable federal laws, Executive Orders, directives, policies, regulations, standards, and guidance.
...
Apply the APM policy to the applicable Virtual Server(s) in the BIG-IP LTM module to display the Standard Mandatory DoD-approved Notice and Consent Banner before granting access to the virtual servers.'
  ...
  tag check_id: 'C-16933r291036_chk'
  tag severity: 'low'
  tag gid: 'V-215741'
  tag rid: 'SV-215741r557356_rule'
  tag stig_id: 'F5BI-LT-000023'
  tag gtitle: 'SRG-NET-000041-ALG-000022'
  tag fix_id: 'F-16931r291037_fix'
  tag 'documentable'
  tag legacy: ['SV-74693', 'V-60263']
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
