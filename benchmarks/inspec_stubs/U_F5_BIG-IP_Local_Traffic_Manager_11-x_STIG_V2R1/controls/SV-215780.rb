...
Apply APM policy to the applicable Virtual Server(s) in the BIG-IP LTM module to require multifactor authentication for remote access to non-privileged accounts in such a way that one of the factors is provided by a device separate from the system gaining access.'
  ...
  tag check_id: 'C-16972r291153_chk'
  tag severity: 'medium'
  tag gid: 'V-215780'
  tag rid: 'SV-215780r557356_rule'
  tag stig_id: 'F5BI-LT-000193'
  tag gtitle: 'SRG-NET-000339-ALG-000090'
  tag fix_id: 'F-16970r291154_fix'
  tag 'documentable'
  tag legacy: ['SV-74771', 'V-60341']
  tag cci: ['CCI-001951']
  tag nist: ['IA-2 (11)']
end
