...
An alternative to remote administration of the web server is to perform web server administration locally at the console.  Local administration at the console implies physical access to the server.'
  desc 'check', 'If web administration is performed remotely the following checks will apply:
...
FIPS 140-2 approved TLS versions include TLS V1.0 or greater.'
  desc 'fix', "Ensure the web server's administration is only performed over a secure path."
  impact 0.7
  ref 'DPMS Target Apache Site 2.0'
  tag check_id: 'C-33705r3_chk'
  tag severity: 'high'
  tag gid: 'V-2249'
