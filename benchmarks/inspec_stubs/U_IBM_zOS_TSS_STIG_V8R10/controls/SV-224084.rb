...
NOTE: In the symbolic permission bit display, the setgid bit is indicated as an "s" or "S" in the execute portion of the group permissions. For example, a display of the permissions of a file with the setgid bit on could be "-rwxrwsrwx".'
  ...
  tag check_id: 'C-25757r516651_chk'
  tag severity: 'medium'
  tag gid: 'V-224084'
  tag rid: 'SV-224084r877922_rule'
  tag stig_id: 'TSS0-US-000110'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25745r516652_fix'
  tag 'documentable'
  tag legacy: ['V-98875', 'SV-107979']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
