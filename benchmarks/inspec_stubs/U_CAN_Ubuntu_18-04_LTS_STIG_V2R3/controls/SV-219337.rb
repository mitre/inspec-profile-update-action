...
'
  desc 'check', %q(Verify the Uncomplicated Firewall is enabled on the system by running the following command:
...
# sudo systemctl start ufw.service'
  ...
  tag check_id: 'C-21062r569466_chk'
  tag severity: 'medium'
  tag gid: 'V-219337'
  tag rid: 'SV-219337r610963_rule'
  tag stig_id: 'UBTU-18-010507'
  tag gtitle: 'SRG-OS-000297-GPOS-00115'
  tag fix_id: 'F-21061r569467_fix'
  tag satisfies: ['SRG-OS-000480-GPOS-00232']
  tag 'documentable'
  tag legacy: ['SV-110001', 'V-100897']
  tag cci: ['CCI-002314', 'CCI-000366']
  tag nist: ['AC-17 (1)', 'CM-6 b']
end
