control 'SV-237768' do
  ...
  desc 'check', %q(Verify the assigned home directory of all local interactive users on the Ubuntu operating system exists.
...
$ sudo chmod 0750 /home/smithj'
  ...
  tag check_id: 'C-40982r648734_chk'
  tag severity: 'medium'
  tag gid: 'V-237768'
