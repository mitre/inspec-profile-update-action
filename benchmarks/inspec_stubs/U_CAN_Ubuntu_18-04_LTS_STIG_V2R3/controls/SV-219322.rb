...
Note: Pam_Apparmor must have properly configured profiles. All configurations will be based on the actual system setup and organization. See the "Pam_Apparmor" documentation for more information on configuring profiles.'
  desc 'fix', 'Configure the Ubuntu operating system to allow system administrators to pass information to any other Ubuntu operating system administrator or user.
...
Note: Pam_Apparmor must have properly configured profiles. All configurations will be based on the actual system setup and organization. See the "Pam_Apparmor" documentation for more information on configuring profiles.'
  ...
  tag check_id: 'C-21047r305294_chk'
  tag severity: 'low'
  tag gid: 'V-219322'
  tag rid: 'SV-219322r610963_rule'
  tag stig_id: 'UBTU-18-010437'
  tag gtitle: 'SRG-OS-000312-GPOS-00122'
  tag fix_id: 'F-21046r305295_fix'
  tag satisfies: ['SRG-OS-000312-GPOS-00122', 'SRG-OS-000312-GPOS-00123', 'SRG-OS-000312-GPOS-00124', 'SRG-OS-000324-GPOS-0012']
  tag 'documentable'
  tag legacy: ['V-100867', 'SV-109971']
