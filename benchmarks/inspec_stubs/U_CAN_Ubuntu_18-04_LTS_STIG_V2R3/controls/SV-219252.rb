...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when successful/unsuccessful attempts to use the "fchownat" system call.
...
The '-k' allows for specifying an arbitrary identifier and the string after it does not need to match the example output above.)
  desc 'fix', 'Configure the audit system to generate an audit event for any successful/unsuccessful use of the "fchownat" system call.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20977r305084_chk'
  tag severity: 'medium'
  tag gid: 'V-219252'
  tag rid: 'SV-219252r610963_rule'
  tag stig_id: 'UBTU-18-010329'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-20976r305085_fix'
  tag 'documentable'
  tag legacy: ['SV-109833', 'V-100729']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
