...
If any temporary account does not expire within 72 hours of that account's creation, this is a finding."
  desc 'fix', 'If a temporary account must be created configure the system to terminate the account after a 72 hour time period with the following command to set an expiration date on it. Substitute "system_account_name" with the account to be created.

# sudo chage -E $(date -d "+3 days" +%F) system_account_name'
  impact 0.5
  ref 'DPMS Target Canonical Ubuntu 18.04 LTS'
  tag check_id: 'C-21054r305315_chk'
  tag severity: 'medium'
  tag gid: 'V-219329'
  tag rid: 'SV-219329r610963_rule'
  tag stig_id: 'UBTU-18-010449'
  tag gtitle: 'SRG-OS-000002-GPOS-00002'
  tag fix_id: 'F-21053r305316_fix'
  tag 'documentable'
  tag legacy: ['V-100881', 'SV-109985']
  tag cci: ['CCI-000016']
  tag nist: ['AC-2 (2)']
end
