...
'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when unsuccessful attempts to use the "ftruncate" system call.
...
The '-k' allows for specifying an arbitrary identifier and the string after it does not need to match the example output above.)
  desc 'fix', 'Configure the audit system to generate an audit event for any unsuccessful use of the "ftruncate" system call. 
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-21019r569481_chk'
  tag severity: 'medium'
  tag gid: 'V-219294'
  tag rid: 'SV-219294r610963_rule'
  tag stig_id: 'UBTU-18-010383'
  tag gtitle: 'SRG-OS-000474-GPOS-00219'
  tag fix_id: 'F-21018r569482_fix'
  tag satisfies: ['SRG-OS-000064-GPOS-00033']
  tag 'documentable'
  tag legacy: ['SV-109915', 'V-100811']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
