...
'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when successful/unsuccessful attempts to use the "fchown" system call.
...
The '-k' allows for specifying an arbitrary identifier and the string after it does not need to match the example output above.)
  desc 'fix', 'Configure the audit system to generate an audit event for any successful/unsuccessful use of the "fchown" system call.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20976r569459_chk'
  tag severity: 'medium'
  tag gid: 'V-219251'
  tag rid: 'SV-219251r610963_rule'
  tag stig_id: 'UBTU-18-010328'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-20975r569460_fix'
  tag satisfies: ['SRG-OS-000064-GPOS-00033', 'SRG-OS-000462-GPOS-00206']
  tag 'documentable'
  tag legacy: ['V-100727', 'SV-109831']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
