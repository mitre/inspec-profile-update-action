...
'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when successful/unsuccessful attempts to use the "lchown" system call.
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20978r305087_chk'
  tag severity: 'medium'
  tag gid: 'V-219253'
  tag rid: 'SV-219253r610963_rule'
  tag stig_id: 'UBTU-18-010330'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-20977r305088_fix'
  tag satisfies: ['SRG-OS-000064-GPOS-00033', 'SRG-OS-000462-GPOS-00206']
  tag 'documentable'
  tag legacy: ['SV-109835', 'V-100731']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
