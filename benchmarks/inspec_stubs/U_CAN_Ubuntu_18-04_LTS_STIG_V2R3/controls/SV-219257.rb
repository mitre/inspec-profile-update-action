...
'
  desc 'check', %q(Verify the Ubuntu operating system generates an audit record when unsuccessful attempts to use the "open" system call occur.
...
The '-k' allows for specifying an arbitrary identifier and the string after it does not need to match the example output above.)
  desc 'fix', 'Configure the audit system to generate an audit event for any unsuccessful use of the "open" system call. 
...
# sudo augenrules --load'
  ...
  tag check_id: 'C-20982r305099_chk'
  tag severity: 'medium'
  tag gid: 'V-219257'
  tag rid: 'SV-219257r610963_rule'
