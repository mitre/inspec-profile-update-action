control 'SV-219170' do
  ...
  desc 'Display of a standardized and approved use notification before granting access to the Ubuntu operating system ensures privacy and security notification verbiage used is consistent with applicable federal laws, Executive Orders, directives, policies, regulations, standards, and guidance.
...
'
  desc 'check', 'Verify the Ubuntu operating system displays the Standard Mandatory DoD Notice and Consent Banner before granting access to the Ubuntu operating system via a ssh logon.
...
If the banner text does not match the Standard Mandatory DoD Notice and Consent Banner exactly, this is a finding.'
  desc 'fix', 'Configure the Ubuntu operating system to display the Standard Mandatory DoD Notice and Consent Banner before granting access to the system via SSH logon.
...
# sudo systemctl restart sshd.service'
  ...
  tag check_id: 'C-20895r304838_chk'
  tag severity: 'medium'
  tag gid: 'V-219170'
  tag rid: 'SV-219170r610963_rule'
  ...
  tag 'documentable'
  tag legacy: ['V-100567', 'SV-109671']
  tag cci: ['CCI-001384', 'CCI-001385', 'CCI-001386', 'CCI-001387', 'CCI-001388', 'CCI-000048']
  tag nist: ['AC-8 c 1', 'AC-8 c 2', 'AC-8 c 2', 'AC-8 c 2', 'AC-8 c 3', 'AC-8 a']
end
