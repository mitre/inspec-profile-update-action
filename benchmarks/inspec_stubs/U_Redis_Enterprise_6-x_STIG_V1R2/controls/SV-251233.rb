control 'SV-251233' do
  title 'Redis Enterprise DBMS must implement NIST FIPS 140-2 or 140-3 validated cryptographic modules to generate and validate cryptographic hashes.'
...
For detailed information, refer to NIST FIPS Publication 140-2 or Publication 140-3, Security Requirements for Cryptographic Modules. Note that the product's cryptographic modules must be validated and certified by NIST as FIPS-compliant."
  desc 'check', %q(The DBMS relies on the underlying operating system's file integrity tools use of cryptographic hashes for verifying file contents and directories have not been altered. These hashes must be FIPS-compliant cryptographic hashes.
...
Reboot the system for the changes to take effect.'
  ...
  tag check_id: 'C-54668r863368_chk'
  tag severity: 'medium'
  tag gid: 'V-251233'
  tag rid: 'SV-251233r863369_rule'
  tag stig_id: 'RD6X-00-009900'
  tag gtitle: 'SRG-APP-000514-DB-000382'
  tag fix_id: 'F-54622r804888_fix'
  tag 'documentable'
  tag cci: ['CCI-002450']
  tag nist: ['SC-13 b']
end
