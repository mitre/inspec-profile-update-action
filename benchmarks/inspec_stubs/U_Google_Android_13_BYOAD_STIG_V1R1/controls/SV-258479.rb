control 'SV-258479' do
  title 'Google Android 13 must be configured to not allow more than 10 consecutive failed authentication attempts.'
  desc 'The more attempts an adversary makes to guess a password, the more likely the adversary will enter the correct password and gain access to resources on the device. Setting a limit on the number of attempts mitigates this risk. Setting the limit at 10 or less gives authorized users the ability to make a few mistakes when entering the password but still provides adequate protection against dictionary or brute force attacks on the password.

SFR ID: FMT_SMF_EXT.1.1 #2c, FIA_AFL_EXT.1.5'
  desc 'check', 'Review managed Google Android 13 device configuration settings to determine if the work profile has the maximum number of consecutive failed authentication attempts set at 10 or fewer.
...
3. Set "Max password failures for local wipe" to a number between 1 and 10.'
  ...
  tag check_id: 'C-62219r929251_chk'
  tag severity: 'medium'
  tag gid: 'V-258479'
  tag rid: 'SV-258479r929253_rule'
  tag stig_id: 'GOOG-13-706400'
  tag gtitle: 'PP-MDF-333040'
  tag fix_id: 'F-62128r929252_fix'
  tag 'documentable'
  tag cci: ['CCI-000044']
  tag nist: ['AC-7 a']
end
