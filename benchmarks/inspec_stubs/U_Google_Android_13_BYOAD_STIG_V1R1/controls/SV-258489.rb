control 'SV-258489' do
  title 'Google Android 13 must have the DOD root and intermediate PKI certificates installed (work profile only).'
...
SFR ID: FMT_SMF_EXT.1.1 #47'
  desc 'check', 'Review device configuration settings to confirm that the DOD root and intermediate PKI certificates are installed (work profile only).
...
If on the EMM console the DOD root and intermediate certificates are not listed in a profile, or the managed Android 13 device does not list the DOD root and intermediate certificates under the user tab, this is a finding.'
  desc 'fix', 'Configure the Google Android 13 device to install DOD root and intermediate certificates (work profile only). 
...
The current DOD root and intermediate PKI certificates may be obtained in self-extracting zip files at http://cyber.mil/pki-pke (for NIPRNet).'
  ...
  tag check_id: 'C-62229r929281_chk'
  tag severity: 'medium'
  tag gid: 'V-258489'
  tag rid: 'SV-258489r929283_rule'
  tag stig_id: 'GOOG-13-710000'
  tag gtitle: 'PP-MDF-993300'
  tag fix_id: 'F-62138r929282_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
