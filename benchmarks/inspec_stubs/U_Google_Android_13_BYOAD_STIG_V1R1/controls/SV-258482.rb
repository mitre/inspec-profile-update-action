control 'SV-258482' do
  title 'Google Android 13 allowlist must be configured to not include applications with the following characteristics (work profile only):
...
2. Before selecting an app, review the app details and privacy policy to ensure the app does not include prohibited characteristics.'
  ...
  tag check_id: 'C-62222r929260_chk'
  tag severity: 'medium'
  tag gid: 'V-258482'
  tag rid: 'SV-258482r929262_rule'
  tag stig_id: 'GOOG-13-706700'
  tag gtitle: 'PP-MDF-333070'
  tag fix_id: 'F-62131r929261_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
