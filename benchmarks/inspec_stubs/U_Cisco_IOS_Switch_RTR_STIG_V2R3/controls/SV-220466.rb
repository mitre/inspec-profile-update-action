control 'SV-220466' do
  ...
  desc 'The current multicast paradigm can let any host join any multicast group at any time by sending an IGMP or MLD membership report to the DR. In a Protocol Independent Multicast (PIM) Sparse Mode network, the DR will send a PIM Join message for the group to the RP. 
...
SW2(config-if)#ip igmp limit 2'
  ...
  tag check_id: 'C-22181r508471_chk'
  tag severity: 'medium'
  tag gid: 'V-220466'
  tag rid: 'SV-220466r856246_rule'
  tag stig_id: 'CISC-RT-000880'
  tag gtitle: 'SRG-NET-000362-RTR-000122'
  tag fix_id: 'F-22170r508472_fix'
  tag 'documentable'
  tag legacy: ['SV-110785', 'V-101681']
  tag cci: ['CCI-002385']
  tag nist: ['SC-5 a']
end
