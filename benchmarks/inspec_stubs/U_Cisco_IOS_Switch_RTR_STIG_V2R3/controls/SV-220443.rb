control 'SV-220443' do
  ...
  desc 'check', 'Review the switch configuration to verify that an ingress access control list (ACL) applied to all external interfaces is blocking packets with Bogon source addresses. 
...
SW1(config-if)#end'
  ...
  tag check_id: 'C-22158r863238_chk'
  tag severity: 'medium'
  tag gid: 'V-220443'
  tag rid: 'SV-220443r863240_rule'
  tag stig_id: 'CISC-RT-000270'
  tag gtitle: 'SRG-NET-000364-RTR-000110'
  tag fix_id: 'F-22147r863239_fix'
  tag 'documentable'
  tag legacy: ['SV-110733', 'V-101629']
  tag cci: ['CCI-002403']
  tag nist: ['SC-7 (11)']
end
