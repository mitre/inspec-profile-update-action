control 'SV-242557' do
  title 'The Zebra Android 10 Work Profile must be configured to prevent users from adding personal email accounts to the work email app.'
...
SFR ID: FMT_SMF_EXT.1.1 #47'
  desc 'check', 'Review the Zebra Android 10 Work Profile configuration settings to confirm that users are prevented from adding personal email accounts to the work email app. 
...
If on the MDM console the restriction to "Disallow modify accounts" is not set or on the Zebra Android 10 device the user is able to add an account in the Work section, this is a finding.'
  desc 'fix', %q(Configure Zebra Android 10 Work Profile to prevent users from adding personal email accounts to the work email app. 
...
Refer to the MDM documentation to determine how to provision users' work email accounts for the work email app.)
  ...
  tag check_id: 'C-45832r714514_chk'
  tag severity: 'medium'
  tag gid: 'V-242557'
  tag rid: 'SV-242557r714516_rule'
  tag stig_id: 'ZEBR-10-009200'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-45789r714515_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
