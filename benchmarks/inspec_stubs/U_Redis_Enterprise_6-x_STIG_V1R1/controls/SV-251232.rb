control 'SV-251232' do
  title 'Redis Enterprise DBMS must implement NIST FIPS 140-2-validated cryptographic modules to provision digital signatures.'
