control 'SV-251229' do
  title 'Redis Enterprise DBMS must use NIST FIPS 140-2-validated cryptographic modules for cryptographic operations.'
...
https://docs.redislabs.com/latest/rs/administering/designing-production/security/'
  desc 'check', 'Review the Redis Enterprise configuration to verify it is using NIST FIPS 140-2-validated cryptographic modules for cryptographic operations. Redis Enterprise uses TLS 1.2 and has a cyber suite of options that is configurable through the rladmin, REST API, and on the Redis Enterprise web UI.
...
Ensure that openssl is on the latest version as required by organizational policies to be FIPS 140-2 compliant.'
  impact 0.7
  ref 'DPMS Target Redis Enterprise 6.x'
  tag check_id: 'C-54664r804875_chk'
  tag severity: 'high'
  tag gid: 'V-251229'
  tag rid: 'SV-251229r804877_rule'
  tag stig_id: 'RD6X-00-009500'
  tag gtitle: 'SRG-APP-000179-DB-000114'
  tag fix_id: 'F-54618r804876_fix'
  tag 'documentable'
  tag cci: ['CCI-000803']
  tag nist: ['IA-7']
end
