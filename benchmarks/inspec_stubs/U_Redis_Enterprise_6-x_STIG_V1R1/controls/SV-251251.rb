control 'SV-251251' do
  title 'Redis Enterprise DBMS and associated applications, when making use of dynamic code execution, must scan input data for invalid values that may indicate a code injection attack.'
...
curl -v -kL -u "<user>:<password>" --location-trusted -H "Content-type: application/json" -d '{ "disabled_commands": "EVAL, EVALSHA" }' -X PUT https://<URL>:PORT/v1/bdbs/<DB_ID>)
  ...
  tag check_id: 'C-54686r804941_chk'
  tag severity: 'medium'
  tag gid: 'V-251251'
  tag rid: 'SV-251251r804943_rule'
  tag stig_id: 'RD6X-00-012000'
  tag gtitle: 'SRG-APP-000251-DB-000392'
  tag fix_id: 'F-54640r804942_fix'
  tag 'documentable'
  tag cci: ['CCI-001310']
  tag nist: ['SI-10']
end
