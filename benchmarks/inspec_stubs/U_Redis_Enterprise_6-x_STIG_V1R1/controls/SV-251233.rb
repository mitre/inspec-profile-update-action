control 'SV-251233' do
  title 'Redis Enterprise DBMS must implement NIST FIPS 140-2-validated cryptographic modules to generate and validate cryptographic hashes.'
...
For detailed information, refer to NIST FIPS Publication 140-2, Security Requirements for Cryptographic Modules. Note that the product's cryptographic modules must be validated and certified by NIST as FIPS-compliant."
  desc 'check', %q(The DBMS relies on the underlying operating system's file integrity tools use of cryptographic hashes for verifying file contents and directories have not been altered. These hashes must be FIPS 140-2 approved cryptographic hashes.
...
Reboot the system for the changes to take effect.'
  ...
  tag check_id: 'C-54668r804887_chk'
  tag severity: 'medium'
  tag gid: 'V-251233'
  tag rid: 'SV-251233r804889_rule'
