control 'SV-251234' do
  title 'Redis Enterprise DBMS must implement NIST FIPS 140-2-validated cryptographic modules to protect unclassified information requiring confidentiality and cryptographic protection, in accordance with the data owners requirements.'
...
The DBMS relies on the underlying Linux operating system to meet this check."
  desc 'check', 'Verify the operating system implements FIPS 140-2 DoD-approved cryptographic modules.
...
If fips_enabled is not 1, this is a finding.'
  ...
  tag check_id: 'C-54669r804890_chk'
  tag severity: 'medium'
  tag gid: 'V-251234'
  tag rid: 'SV-251234r804892_rule'
