...
If the "Specify maximum time for each file scan" is not configured for 45 seconds or more, this is a finding.'
...
Under "On-demand Scan", configure the "Specify maximum time for each file scan" for 45 seconds or more.

Click "Save".'
  impact 0.5
  ref 'DPMS Target McAfee MOVE Agentless 4.5 SVM'
  tag check_id: 'C-78041r1_chk'
  tag severity: 'medium'
  tag gid: 'V-78479'
  tag rid: 'SV-93185r1_rule'
  tag stig_id: 'MV45-ODS-200002'
  tag gtitle: 'MV45-ODS-200002'
  tag fix_id: 'F-85213r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001241']
  tag nist: ['SI-3 c 1']
end
