...
4. Ensure the deployment mode of "Security-Optimized" is selected. The security-optimized deployment mode ensures all strict DoD vulnerabilities are blocked and alerted upon. 
...
4. Navigate to "Profile Overview", and select the action set for each category to "Recommended". The recommended action set is set to ensure all suspicious and vulnerable traffic is blocked and alerted upon.)
  ...
  tag check_id: 'C-45464r710108_chk'
  tag severity: 'medium'
  tag gid: 'V-242189'
  tag rid: 'SV-242189r710110_rule'
  tag stig_id: 'TIPP-IP-000240'
  tag gtitle: 'SRG-NET-000228-IDPS-00196'
  tag fix_id: 'F-45422r710109_fix'
  tag 'documentable'
  tag cci: ['CCI-001166']
  tag nist: ['SC-18 (1)']
end
