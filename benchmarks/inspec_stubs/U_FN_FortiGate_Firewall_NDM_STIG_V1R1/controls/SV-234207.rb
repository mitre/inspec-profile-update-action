...
5. Verify the Special value is set to 1.

If the Special parameter is not set to 1, this is a finding.
...
If the min-non-alphanumeric parameter is not set to 1, this is a finding.'
...
6. Enter the Special value of 1.
...
2. Run the following command:
  ...
  tag check_id: 'C-37392r611808_chk'
  tag severity: 'medium'
  tag gid: 'V-234207'
  tag rid: 'SV-234207r628777_rule'
  tag stig_id: 'FGFW-ND-000240'
  tag gtitle: 'SRG-APP-000169-NDM-000257'
  tag fix_id: 'F-37357r611809_fix'
  tag 'documentable'
  tag cci: ['CCI-001619']
  tag nist: ['IA-5 (1) (a)']
end
