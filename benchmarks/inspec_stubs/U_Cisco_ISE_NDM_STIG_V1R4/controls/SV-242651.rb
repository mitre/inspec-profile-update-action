...
If FIPS mode is not configured, but the Cisco ISE is configured using an alternative manual method to configure the password authentication process to use a FIPS 140-2/3 validated SHA-2 (or greater), this can be lowered to a CAT 2 finding.'
...
NOTE: Configuring FIPS mode is the required DoD configuration. However, this requirement can be lowered to a CAT 2 if the alternative manual configuration is used to configure the password authentication process to use a FIPS 140-2/3 validated SHA-2 (or greater).'
  impact 0.7
  ref 'DPMS Target Cisco ISE NDM'
  tag check_id: 'C-45926r864207_chk'
  tag severity: 'high'
  tag gid: 'V-242651'
  tag rid: 'SV-242651r864209_rule'
  tag stig_id: 'CSCO-NM-000460'
  tag gtitle: 'SRG-APP-000172-NDM-000259'
  tag fix_id: 'F-45883r864208_fix'
  tag 'documentable'
  tag cci: ['CCI-000197']
  tag nist: ['IA-5 (1) (c)']
end
