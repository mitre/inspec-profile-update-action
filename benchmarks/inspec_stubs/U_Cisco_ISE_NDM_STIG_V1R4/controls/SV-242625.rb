control 'SV-242625' do
  title 'The Cisco ISE must generate audit records when concurrent logons from different workstations occur.'
...
6. Click "Save".'
  ...
  tag check_id: 'C-45900r714183_chk'
  tag severity: 'medium'
  tag gid: 'V-242625'
  tag rid: 'SV-242625r714185_rule'
  tag stig_id: 'CSCO-NM-000190'
  tag gtitle: 'SRG-APP-000506-NDM-000323'
  tag fix_id: 'F-45857r714184_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
