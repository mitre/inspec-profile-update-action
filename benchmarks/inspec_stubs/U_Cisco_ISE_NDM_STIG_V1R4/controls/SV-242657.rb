control 'SV-242657' do
  title 'The Cisco ISE must terminate all network connections associated with a device management session at the end of the session, or the session must be terminated after 10 minutes of inactivity except to fulfill documented and validated mission requirements.'
...
3. Click "Save".'
  ...
  tag check_id: 'C-45932r714279_chk'
  tag severity: 'high'
  tag gid: 'V-242657'
  tag rid: 'SV-242657r714281_rule'
  tag stig_id: 'CSCO-NM-000520'
  tag gtitle: 'SRG-APP-000190-NDM-000267'
  tag fix_id: 'F-45889r714280_fix'
  tag 'documentable'
  tag cci: ['CCI-001133']
  tag nist: ['SC-10']
end
