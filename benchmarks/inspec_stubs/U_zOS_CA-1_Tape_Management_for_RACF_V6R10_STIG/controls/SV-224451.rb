control 'SV-224451' do
  ...
  desc 'check', 'Refer to the following report produced by the RACF Data Collection and Data Set and Resource Data Collection:
...
___ The RACF data set access authorizations specify UACC(NONE) and NOWARNING.'
  desc 'fix', "Ensure that WRITE and/or greater access to CA1 Tape management STC data sets is limited to systems programmers and/or CA1 Tape management STC(s) and/or batch user(s) only. READ access can be given to auditors.
...
PE 'CA1.TMS*.**' ID (<audtaudt>)  ACC(R)"
  ...
  tag check_id: 'C-26128r868299_chk'
  tag severity: 'medium'
  tag gid: 'V-224451'
  tag rid: 'SV-224451r870225_rule'
  tag stig_id: 'ZCA1R001'
  tag gtitle: 'SRG-OS-000259'
  tag fix_id: 'F-26116r870224_fix'
  tag 'documentable'
  tag legacy: ['V-17067', 'SV-87411']
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
end
