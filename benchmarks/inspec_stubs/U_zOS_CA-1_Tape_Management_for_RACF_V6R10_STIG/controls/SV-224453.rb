...
PERMIT L0DELETE CLASS(CA@MD) ACCESS(READ) ID(tapeaudt)'
  ...
  tag check_id: 'C-26130r868305_chk'
  tag severity: 'medium'
  tag gid: 'V-224453'
  tag rid: 'SV-224453r868307_rule'
  tag stig_id: 'ZCA1R020'
  tag gtitle: 'SRG-OS-000018'
  tag fix_id: 'F-26118r868306_fix'
  tag 'documentable'
  tag legacy: ['V-17947', 'SV-40074']
