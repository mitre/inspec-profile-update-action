...
Note 4	The UX0AUPD will specify YES only if you alter the fields in the TMC and the TMSUXxA (for r11.5 and below) or TMSXITA (for r12.0 and above) is changed.'
  ...
  tag check_id: 'C-26135r519509_chk'
  tag severity: 'medium'
  tag gid: 'V-224458'
  tag rid: 'SV-224458r519511_rule'
  tag stig_id: 'ZCA1R040'
  tag gtitle: 'SRG-OS-000018'
  tag fix_id: 'F-26123r519510_fix'
  tag 'documentable'
  tag legacy: ['V-18014', 'SV-40101']
  tag cci: ['CCI-000035']
  tag nist: ['AC-4 (11)']
end
