...
View the values of the password format requirements. The following password requirement should be set at a minimum: Numeric Characters: At least "1" 
...
Click "Edit". Set Numeric Characters to at least "1" and click "OK".'
  impact 0.5
  ref 'DPMS Target VMware NSX 6 NDM'
  tag check_id: 'C-69623r1_chk'
  tag severity: 'medium'
  tag gid: 'V-69183'
  tag rid: 'SV-83787r1_rule'
  tag stig_id: 'VNSX-ND-000059'
  tag gtitle: 'SRG-APP-000168-NDM-000256'
  tag fix_id: 'F-75369r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000194']
  tag nist: ['IA-5 (1) (a)']
end
