...
View the values of the password format requirements. The following password requirement should be set at a minimum: Upper-case Characters: At least "1" 
...
Click "Edit". Set Upper-case Characters to at least "1" and click "OK".'
  impact 0.5
  ref 'DPMS Target VMware NSX 6 NDM'
  tag check_id: 'C-69619r1_chk'
  tag severity: 'medium'
  tag gid: 'V-69179'
  tag rid: 'SV-83783r1_rule'
  tag stig_id: 'VNSX-ND-000057'
  tag gtitle: 'SRG-APP-000166-NDM-000254'
  tag fix_id: 'F-75365r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000192']
  tag nist: ['IA-5 (1) (a)']
end
