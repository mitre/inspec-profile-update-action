control 'SV-23456' do
  title 'Video Services Policy guidance being utilized must be supported by DISA.'
...
The current Video Services STIG Guidance will be sunset because technology advancements and best practices have outpaced the existing guidelines. DISA recognizes the current VOIP STIGs require updating and will be placing the VOIP guidance on the STIG sunset list until new VOIP guidance can be developed.  Plans are currently underway to draft new guidance, in the interim period, the sunset VOIP guidance can be utilized to the extent possible, but it will not be updated.'
  desc 'check', 'The Video Services Policy STIG is no longer updated by DISA.
...
If the STIG is being utilized without utilizing current vendor best practices, this is a finding.'
  ...
  tag stig_id: 'RTS-VTC 9000'
  tag gtitle: 'RTS-VTC 9000'
