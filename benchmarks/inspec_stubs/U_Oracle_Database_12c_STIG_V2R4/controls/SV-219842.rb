control 'SV-219842' do
  title 'Database job/batch queues must be reviewed regularly to detect unauthorized database job submissions.'
  desc 'Unauthorized users may bypass security mechanisms by submitting jobs to job queues managed by the database to be run under a more privileged security context of the database or host system. These queues must be monitored regularly to detect any such unauthorized job submissions.'
...
Use auditing to capture use of the DBMS_JOB package in the audit trail. Review the audit trail for unauthorized use of the DBMS_JOB package.'
  ...
  tag check_id: 'C-21553r533065_chk'
  tag severity: 'medium'
  tag gid: 'V-219842'
  tag rid: 'SV-219842r533067_rule'
  tag stig_id: 'O121-BP-023100'
  tag gtitle: 'SRG-APP-000516-DB-000363'
  tag fix_id: 'F-21552r533066_fix'
  tag 'documentable'
  tag legacy: ['SV-75939', 'V-61449']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
