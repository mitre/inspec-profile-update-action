...
The organization must identify authorized software programs and only permit execution of authorized software. The process used to identify software programs that are authorized to execute on organizational information systems is commonly referred to as allowlisting.'
  desc 'check', 'This is applicable to unclassified systems.
...
https://www.iad.gov/iad/library/ia-guidance/tech-briefs/application-allowlisting-using-microsoft-applocker.cfm'
  impact 0.5
  ref 'DPMS Target Microsoft Windows 11'
  tag check_id: 'C-56715r828868_chk'
  tag severity: 'medium'
  tag gid: 'V-253262'
  tag rid: 'SV-253262r828870_rule'
  tag stig_id: 'WN11-00-000035'
  tag gtitle: 'SRG-OS-000370-GPOS-00155'
  tag fix_id: 'F-56665r828869_fix'
  tag 'documentable'
  tag cci: ['CCI-001744']
  tag nist: ['CM-3 (5)']
end
