...
Audit tools include, but are not limited to, vendor-provided and open source audit tools needed to successfully view and manipulate audit information system activity and records. Audit tools include custom queries and report generators.'
  desc 'check', '1. Obtain a list of authorized personnel and IP addresses that should have access to the Web Management Console, SSH, or CLI.
...
Note that DoD requires users to be assigned to groups rather than assigned privileges to individual users whenever possible.'
  ...
  tag check_id: 'C-93867r1_chk'
  tag severity: 'medium'
  tag gid: 'V-94677'
  tag rid: 'SV-104507r1_rule'
  tag stig_id: 'SYMP-NM-000130'
  tag gtitle: 'SRG-APP-000121-NDM-000238'
  tag fix_id: 'F-100795r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001493']
  tag nist: ['AU-9 a']
end
