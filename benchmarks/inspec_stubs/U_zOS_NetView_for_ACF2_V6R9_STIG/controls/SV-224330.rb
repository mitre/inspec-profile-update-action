...
- UID(*) PREVENT"
  ...
  tag check_id: 'C-26007r868219_chk'
  tag severity: 'medium'
  tag gid: 'V-224330'
  tag rid: 'SV-224330r868221_rule'
  tag stig_id: 'ZNETA020'
  tag gtitle: 'SRG-OS-000018'
  tag fix_id: 'F-25995r868220_fix'
  tag 'documentable'
  tag legacy: ['V-17947', 'SV-50924']
