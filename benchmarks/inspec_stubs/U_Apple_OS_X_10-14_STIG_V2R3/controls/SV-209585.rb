...
/usr/bin/sudo /usr/bin/chgrp admin /Library/Application\\ Support/CrashReporter/DiagnosticMessagesHistory.plist'
  ...
  tag check_id: 'C-9836r466273_chk'
  tag severity: 'medium'
  tag gid: 'V-209585'
  tag rid: 'SV-209585r610285_rule'
  tag stig_id: 'AOSX-14-002021'
  tag gtitle: 'SRG-OS-000096-GPOS-00050'
  tag fix_id: 'F-9836r466274_fix'
  tag 'documentable'
  tag legacy: ['SV-105047', 'V-95909']
  tag cci: ['CCI-000382']
  tag nist: ['CM-7 b']
end
