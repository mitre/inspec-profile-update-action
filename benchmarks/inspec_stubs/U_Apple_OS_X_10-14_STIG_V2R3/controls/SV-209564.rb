...
Note: Before applying the "Smart Card Policy", the supplemental guidance provided with the STIG should be consulted to ensure continued access to the operating system.'
  ...
  tag check_id: 'C-9815r466309_chk'
  tag severity: 'medium'
  tag gid: 'V-209564'
  tag rid: 'SV-209564r610285_rule'
  tag stig_id: 'AOSX-14-001060'
  tag gtitle: 'SRG-OS-000376-GPOS-00161'
  tag fix_id: 'F-9815r466310_fix'
  tag satisfies: ['SRG-OS-000376-GPOS-00161', 'SRG-OS-000377-GPOS-00162', 'SRG-OS-000384-GPOS-00167', 'SRG-OS-000403-GPOS-00182']
  tag 'documentable'
  tag legacy: ['V-95861', 'SV-104999']
  tag cci: ['CCI-001953', 'CCI-001954', 'CCI-001991', 'CCI-002470']
  tag nist: ['IA-2 (12)', 'IA-2 (12)', 'IA-5 (2) (d)', 'SC-23 (5)']
end
