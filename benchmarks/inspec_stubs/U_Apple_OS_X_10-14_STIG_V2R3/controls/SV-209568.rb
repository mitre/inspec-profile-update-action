...
The system may need to be restarted for the update to take effect.'
  ...
  tag check_id: 'C-9819r282186_chk'
  tag severity: 'medium'
  tag gid: 'V-209568'
  tag rid: 'SV-209568r610285_rule'
  tag stig_id: 'AOSX-14-002003'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9819r282187_fix'
  tag 'documentable'
  tag legacy: ['V-95869', 'SV-105007']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
