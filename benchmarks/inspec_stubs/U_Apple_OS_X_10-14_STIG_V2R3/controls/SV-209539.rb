...
Name the file "banner" and place it in "/etc/".'
  ...
  tag check_id: 'C-9790r282099_chk'
  tag severity: 'medium'
  tag gid: 'V-209539'
  tag rid: 'SV-209539r610285_rule'
  tag stig_id: 'AOSX-14-000023'
  tag gtitle: 'SRG-OS-000023-GPOS-00006'
  tag fix_id: 'F-9790r282100_fix'
  tag 'documentable'
  tag legacy: ['SV-104955', 'V-95817']
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
