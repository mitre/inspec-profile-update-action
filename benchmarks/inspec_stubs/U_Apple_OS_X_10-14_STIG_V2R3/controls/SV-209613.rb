...
If this list does not contain approved certificates, this is a finding.)
  ...
  tag check_id: 'C-9864r282321_chk'
  tag severity: 'high'
  tag gid: 'V-209613'
  tag rid: 'SV-209613r610285_rule'
  tag stig_id: 'AOSX-14-003001'
  tag gtitle: 'SRG-OS-000066-GPOS-00034'
  tag fix_id: 'F-9864r282322_fix'
  tag satisfies: ['SRG-OS-000066-GPOS-00034', 'SRG-OS-000478-GPOS-00223']
  tag 'documentable'
  tag legacy: ['V-95957', 'SV-105095']
