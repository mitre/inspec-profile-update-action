...
AirDrop must be disabled.'
  desc 'check', 'AirDrop relies on Bluetooth LE for discovery. To check if AirDrop has been disabled, run the following command:
...
If the return is not, "DisableBluetooth = 1", this is a finding.'
  ...
  tag check_id: 'C-9825r282204_chk'
  tag severity: 'low'
  tag gid: 'V-209574'
  tag rid: 'SV-209574r610285_rule'
  tag stig_id: 'AOSX-14-002009'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9825r282205_fix'
  tag 'documentable'
  tag legacy: ['SV-105023', 'V-95885']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
