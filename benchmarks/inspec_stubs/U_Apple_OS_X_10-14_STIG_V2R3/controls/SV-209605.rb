...
If the result is null or not "DisableGuestAccount = 1", this is a finding.'
  desc 'fix', 'This is managed with Login Window Policy.'
  impact 0.7
  ref 'DPMS Target Apple OS X 10.14'
  tag check_id: 'C-9856r282297_chk'
  tag severity: 'high'
  tag gid: 'V-209605'
  tag rid: 'SV-209605r610285_rule'
  tag stig_id: 'AOSX-14-002063'
  tag gtitle: 'SRG-OS-000364-GPOS-00151'
  tag fix_id: 'F-9856r282298_fix'
  tag 'documentable'
  tag legacy: ['V-95949', 'SV-105087']
  tag cci: ['CCI-001813']
  tag nist: ['CM-5 (1) (a)']
end
