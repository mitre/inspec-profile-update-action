...
/usr/bin/sudo /usr/bin/security authorizationdb write system.preferences < ~/Desktop/authdb.txt'
  ...
  tag check_id: 'C-37884r621681_chk'
  tag severity: 'medium'
  tag gid: 'V-234699'
  tag rid: 'SV-234699r615888_rule'
  tag stig_id: 'AOSX-14-002069'
  tag gtitle: 'SRG-OS-000378-GPOS-00163'
  tag fix_id: 'F-26889r485788_fix'
  tag 'documentable'
  tag legacy: ['SV-104725', 'V-95541']
  tag cci: ['CCI-001958']
  tag nist: ['IA-3']
end
