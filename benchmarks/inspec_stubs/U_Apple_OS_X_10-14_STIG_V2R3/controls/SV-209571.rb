...
The system may need to be restarted for the update to take effect.'
  ...
  tag check_id: 'C-9822r282195_chk'
  tag severity: 'medium'
  tag gid: 'V-209571'
  tag rid: 'SV-209571r610285_rule'
  tag stig_id: 'AOSX-14-002006'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9822r282196_fix'
  tag 'documentable'
  tag legacy: ['SV-105013', 'V-95875']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
