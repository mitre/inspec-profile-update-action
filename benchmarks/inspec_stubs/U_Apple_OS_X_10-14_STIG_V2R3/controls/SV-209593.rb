...
If the return is not “SkipiCloudStorageSetup = 1”, this is a finding.'
  ...
  tag check_id: 'C-9844r282261_chk'
  tag severity: 'medium'
  tag gid: 'V-209593'
  tag rid: 'SV-209593r610285_rule'
  tag stig_id: 'AOSX-14-002037'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9844r282262_fix'
  tag 'documentable'
  tag legacy: ['V-95925', 'SV-105063']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
