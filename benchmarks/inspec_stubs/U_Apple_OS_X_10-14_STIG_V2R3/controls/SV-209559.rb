...
A text editor may also be used to implement the required updates to the "/etc/security/audit_control" file.)
  ...
  tag check_id: 'C-9810r466267_chk'
  tag severity: 'medium'
  tag gid: 'V-209559'
  tag rid: 'SV-209559r610285_rule'
  tag stig_id: 'AOSX-14-001020'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-9810r466268_fix'
