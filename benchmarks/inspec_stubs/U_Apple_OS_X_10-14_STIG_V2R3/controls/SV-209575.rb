...
If the return does not contain "/Applications/FaceTime.app", this is a finding.'
  ...
  tag check_id: 'C-9826r282207_chk'
  tag severity: 'low'
  tag gid: 'V-209575'
  tag rid: 'SV-209575r610285_rule'
  tag stig_id: 'AOSX-14-002010'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9826r282208_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['SV-105025', 'V-95887']
