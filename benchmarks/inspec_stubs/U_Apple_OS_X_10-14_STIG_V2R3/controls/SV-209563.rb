...
A text editor may also be used to implement the required updates to the "/etc/security/audit_control" file.)
  ...
  tag check_id: 'C-9814r466315_chk'
  tag severity: 'medium'
  tag gid: 'V-209563'
  tag rid: 'SV-209563r610285_rule'
  tag stig_id: 'AOSX-14-001044'
  tag gtitle: 'SRG-OS-000470-GPOS-00214'
  tag fix_id: 'F-9814r466316_fix'
  tag satisfies: ['SRG-OS-000470-GPOS-00214', 'SRG-OS-000472-GPOS-00217', 'SRG-OS-000473-GPOS-00218', 'SRG-OS-000475-GPOS-00220']
  tag 'documentable'
  tag legacy: ['SV-104997', 'V-95859']
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
