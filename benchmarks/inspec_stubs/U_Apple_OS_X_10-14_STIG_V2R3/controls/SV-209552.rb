...
sudo /usr/bin/sed -i.bak '/^policy/ s/$/,ahlt/' /etc/security/audit_control; sudo /usr/sbin/audit -s)
  ...
  tag check_id: 'C-9803r466264_chk'
  tag severity: 'medium'
  tag gid: 'V-209552'
  tag rid: 'SV-209552r610285_rule'
  tag stig_id: 'AOSX-14-001010'
  tag gtitle: 'SRG-OS-000047-GPOS-00023'
  tag fix_id: 'F-9803r466265_fix'
  tag 'documentable'
  tag legacy: ['V-95839', 'SV-104977']
  tag cci: ['CCI-000140']
  tag nist: ['AU-5 b']
end
