...
If the return is not “allowCloudReminders = 0”, this is a finding.'
  ...
  tag check_id: 'C-9829r282216_chk'
  tag severity: 'low'
  tag gid: 'V-209578'
  tag rid: 'SV-209578r610285_rule'
  tag stig_id: 'AOSX-14-002013'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9829r282217_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['SV-105031', 'V-95893']
