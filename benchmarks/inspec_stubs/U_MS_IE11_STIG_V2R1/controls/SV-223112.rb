control 'SV-223112' do
  ...
  tag check_id: 'C-24785r428886_chk'
  tag severity: 'medium'
  tag gid: 'V-223112'
  tag rid: 'SV-223112r428888_rule'
  tag stig_id: 'DTBI614-IE11'
  tag gtitle: 'SRG-APP-000233'
  tag fix_id: 'F-24773r428887_fix'
  tag 'documentable'
  tag legacy: ['SV-59595', 'V-46731']
  tag cci: ['CCI-001084']
  tag nist: ['SC-3']
end
