...
From the expanded list, right-click to select the zone (repeat for each hosted zone), point to DNSSEC, and then click Sign the Zone, either using approved saved parameters or approved custom parameters.'
  ...
  tag check_id: 'C-16816r314341_chk'
  tag severity: 'medium'
  tag gid: 'V-215622'
  tag rid: 'SV-215622r561297_rule'
  tag stig_id: 'WDNS-SC-000014'
  tag gtitle: 'SRG-APP-000423-DNS-000056'
  tag fix_id: 'F-16814r572380_fix'
  tag 'documentable'
  tag legacy: ['SV-73107', 'V-58677']
  tag cci: ['CCI-002465']
  tag nist: ['SC-21']
end
