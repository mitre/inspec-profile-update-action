control 'SV-215630' do
  title 'The Windows 2012 DNS Server must protect secret/private cryptographic keys while at rest.'
...
If a backup policy does not exist or the backup policy does not specify the protection required for backup medium to be at or above the same level as the server, this is a finding.'
  ...
  tag check_id: 'C-16824r572270_chk'
  tag severity: 'medium'
  tag gid: 'V-215630'
  tag rid: 'SV-215630r561297_rule'
  tag stig_id: 'WDNS-SC-000024'
  tag gtitle: 'SRG-APP-000231-DNS-000033'
  tag fix_id: 'F-16822r572271_fix'
  tag 'documentable'
  tag legacy: ['SV-73123', 'V-58693']
  tag cci: ['CCI-001199']
  tag nist: ['SC-28']
end
