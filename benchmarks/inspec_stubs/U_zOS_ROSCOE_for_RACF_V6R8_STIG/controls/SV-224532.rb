...
setr racl(started) ref"
  ...
  tag check_id: 'C-26215r520844_chk'
  tag severity: 'medium'
  tag gid: 'V-224532'
  tag rid: 'SV-224532r520846_rule'
  tag stig_id: 'ZROSR032'
  tag gtitle: 'SRG-OS-000104'
  tag fix_id: 'F-26203r520845_fix'
  tag 'documentable'
  tag legacy: ['V-17454', 'SV-24812']
  tag cci: ['CCI-000764']
  tag nist: ['IA-2']
end
