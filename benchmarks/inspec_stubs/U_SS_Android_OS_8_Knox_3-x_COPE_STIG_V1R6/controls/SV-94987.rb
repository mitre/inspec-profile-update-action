control 'SV-94987' do
  title 'The Samsung Android 8 with Knox CONTAINER whitelist must be configured to not include applications with the following characteristics: Transmit mobile device (MD) diagnostic data to non-DoD servers.'
...
On the MDM CONTAINER console, add all applications that transmit MD diagnostic data to non-DoD servers to the "Application disable list" setting in the "Android Applications" rule.
...
Note: Refer to the Supplemental document for additional information.'
  ...
  tag check_id: 'C-79955r1_chk'
  tag severity: 'medium'
  tag gid: 'V-80283'
  tag rid: 'SV-94987r1_rule'
  tag stig_id: 'KNOX-08-002300'
  tag gtitle: 'PP-MDF-301100'
  tag fix_id: 'F-87089r1_fix'
  tag 'documentable'
