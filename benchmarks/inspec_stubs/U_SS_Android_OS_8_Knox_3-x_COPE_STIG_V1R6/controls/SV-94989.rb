control 'SV-94989' do
  title 'The Samsung Android 8 with Knox CONTAINER whitelist must be configured to not include applications with the following characteristics: Voice assistant application if available when mobile device (MD) is locked.'
...
On the MDM CONTAINER console, add all applications that provide voice assistant when MD is locked to the "Application disable list" setting in the "Android Applications" rule.
...
Note: Refer to the Supplemental document for additional information.'
  ...
  tag check_id: 'C-79957r1_chk'
  tag severity: 'medium'
  tag gid: 'V-80285'
  tag rid: 'SV-94989r1_rule'
  tag stig_id: 'KNOX-08-002400'
  tag gtitle: 'PP-MDF-301100'
  tag fix_id: 'F-87091r1_fix'
  tag 'documentable'
