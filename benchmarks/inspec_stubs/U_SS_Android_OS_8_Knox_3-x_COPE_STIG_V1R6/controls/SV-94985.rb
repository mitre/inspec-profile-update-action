control 'SV-94985' do
  title 'The Samsung Android 8 with Knox CONTAINER whitelist must be configured to not include applications with the following characteristics: Back up mobile device (MD) data to non-DoD cloud servers (including user and application access to cloud backup services).'
...
Note: Include Samsung Accounts on the list.'
  ...
  tag check_id: 'C-79953r1_chk'
  tag severity: 'medium'
  tag gid: 'V-80281'
  tag rid: 'SV-94985r1_rule'
  tag stig_id: 'KNOX-08-002200'
  tag gtitle: 'PP-MDF-301100'
  tag fix_id: 'F-87087r1_fix'
  tag 'documentable'
