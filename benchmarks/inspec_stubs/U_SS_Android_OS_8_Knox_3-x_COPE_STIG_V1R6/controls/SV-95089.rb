...
If the MDM console "Allow Google Backup" check box is selected or on the Samsung Android 8 with Knox device, the user can enable "Back up my data", this is a finding.'
  desc 'fix', 'Configure Samsung Android 8 with Knox to disable backup to remote systems (including commercial clouds).
...
On the MDM console, deselect the "Allow Google Backup" check box in the "Android Restrictions" rule.'
  ...
  tag check_id: 'C-80057r1_chk'
  tag severity: 'medium'
  tag gid: 'V-80385'
  tag rid: 'SV-95089r1_rule'
  tag stig_id: 'KNOX-08-017400'
  tag gtitle: 'PP-MDF-301230'
  tag fix_id: 'F-87191r1_fix'
  tag 'documentable'
  tag cci: ['CCI-002338']
  tag nist: ['AC-20 (3)']
end
