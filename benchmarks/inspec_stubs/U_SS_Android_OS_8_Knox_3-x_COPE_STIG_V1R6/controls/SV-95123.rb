...
Review Samsung Android 8 with Knox configuration settings to determine if the mobile device has VPN protection for per app use for the personal side.
...
2. Verify the value of the setting is the list of all the Authorizing Official (AO)-approved packages.
...
If the MDM console "Get All Packages In VPN Profile" contains packages not AO-approved or "VPN profiles" does not list the organization VPN profile, this is a finding.'
...
2. Add each AO-approved package to "Add Packages To VPN in the "Generic VPN" rule.'
  ...
  tag check_id: 'C-80091r1_chk'
  tag severity: 'medium'
  tag gid: 'V-80419'
  tag rid: 'SV-95123r1_rule'
  tag stig_id: 'KNOX-08-023200'
  tag gtitle: 'PP-MDF-301060'
  tag fix_id: 'F-87225r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000068']
  tag nist: ['AC-17 (2)']
end
