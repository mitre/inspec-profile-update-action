control 'SV-94993' do
  title 'The Samsung Android 8 with Knox CONTAINER whitelist must be configured to not include applications with the following characteristics: Allows synchronization of data or applications between devices associated with user.'
...
On the MDM CONTAINER console, add all applications that allow synchronization of data or applications between devices associated with user to the "Application disable list" setting in the "Android Applications" rule.

Note: Refer to the Supplemental document for additional information.'
  impact 0.5
  ref 'DPMS Target Samsung Android OS 8 with Knox 3.x - COPE use case'
  tag check_id: 'C-79961r1_chk'
  tag severity: 'medium'
  tag gid: 'V-80289'
  tag rid: 'SV-94993r1_rule'
  tag stig_id: 'KNOX-08-002600'
  tag gtitle: 'PP-MDF-301100'
  tag fix_id: 'F-87095r1_fix'
  tag 'documentable'
