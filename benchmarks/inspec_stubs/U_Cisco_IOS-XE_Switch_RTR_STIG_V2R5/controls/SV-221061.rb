...
If the DR is not filtering IGMP or MLD report messages, this is a finding.'
  desc 'fix', 'Configure the DR to filter the IGMP and MLD report messages to allow hosts to join only those multicast groups from sources that have been approved as shown in the example below:
...
SW2(config-if)#ip igmp access-group IGMP_JOIN_FILTER'
  ...
  tag check_id: 'C-22776r507606_chk'
  tag severity: 'medium'
  tag gid: 'V-221061'
  tag rid: 'SV-221061r863381_rule'
  tag stig_id: 'CISC-RT-000870'
  tag gtitle: 'SRG-NET-000364-RTR-000115'
  tag fix_id: 'F-22765r507607_fix'
  tag 'documentable'
  tag legacy: ['SV-110943', 'V-101839']
  tag cci: ['CCI-002403']
  tag nist: ['SC-7 (11)']
end
