...
# sudo chkstat --set /etc/permissions.local'
  ...
  tag check_id: 'C-18430r369762_chk'
  tag severity: 'medium'
  tag gid: 'V-217202'
  tag rid: 'SV-217202r603262_rule'
  tag stig_id: 'SLES-12-020120'
  tag gtitle: 'SRG-OS-000057-GPOS-00027'
  tag fix_id: 'F-18428r369763_fix'
  tag satisfies: ['SRG-OS-000057-GPOS-00027', 'SRG-OS-000058-GPOS-00028', 'SRG-OS-000059-GPOS-00029']
  tag 'documentable'
  tag legacy: ['V-77311', 'SV-92007']
