...
The DoD standard requires a minimum 15-character password length.'
  ...
  tag check_id: 'C-18355r369537_chk'
  tag severity: 'medium'
  tag gid: 'V-217127'
  tag rid: 'SV-217127r603262_rule'
  tag stig_id: 'SLES-12-010250'
  tag gtitle: 'SRG-OS-000078-GPOS-00046'
  tag fix_id: 'F-18353r369538_fix'
  tag 'documentable'
  tag legacy: ['SV-91805', 'V-77109']
  tag cci: ['CCI-000205']
  tag nist: ['IA-5 (1) (a)']
end
