...
-Notwithstanding the above, using this IS does not constitute consent to PM, LE or CI investigative searching or monitoring of the content of privileged communications, or work product, related to personal representation or services by attorneys, psychotherapists, or clergy, and their assistants. Such communications and work product are private and confidential. See User Agreement for details."'
  desc 'check', 'Verify the SUSE operating system displays the approved Standard Mandatory DoD Notice before granting local or remote access to the system via a graphical user logon.
...
> sudo dconf update'
  ...
  tag check_id: 'C-18334r646679_chk'
  tag severity: 'medium'
  tag gid: 'V-217106'
  tag rid: 'SV-217106r646681_rule'
  tag stig_id: 'SLES-12-010050'
  tag gtitle: 'SRG-OS-000228-GPOS-00088'
  tag fix_id: 'F-18332r646680_fix'
  tag 'documentable'
  tag legacy: ['SV-91751', 'V-77055']
  tag cci: ['CCI-001386', 'CCI-001384', 'CCI-001388', 'CCI-001385', 'CCI-001387']
  tag nist: ['AC-8 c 2', 'AC-8 c 1', 'AC-8 c 3', 'AC-8 c 2', 'AC-8 c 2']
end
