control 'SV-251633' do
  title 'CA IDMS CV must supply logout functionality to allow the user to implicitly terminate a session by disconnecting or ending before an explicit logout.'
...
Note: The UCFCICZ interface may also be used to clean up the CA IDMS session if access is through CICS and the CICS session has ended.'
  ...
  tag check_id: 'C-55068r807764_chk'
  tag severity: 'medium'
  tag gid: 'V-251633'
  tag rid: 'SV-251633r855271_rule'
  tag stig_id: 'IDMS-DB-000620'
  tag gtitle: 'SRG-APP-000296-DB-000306'
  tag fix_id: 'F-55022r807765_fix'
  tag 'documentable'
  tag cci: ['CCI-002363']
  tag nist: ['AC-12 (1)']
end
