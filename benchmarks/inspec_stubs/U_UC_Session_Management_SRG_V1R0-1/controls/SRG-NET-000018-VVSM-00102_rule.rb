control 'SRG-NET-000018-VVSM-00102_rule' do
  title 'The Unified Communications Session Manager must be configured to globally disable the extension mobility feature for endpoints.'
...
Extension mobility is similar to but not the same as forwarding calls. Forwarding is typically activated from the user's normal phone or their user preferences configuration settings. Forwarding is therefore preset to a known location. Extension mobility is typically activated from the remote location and is activated upon arrival at that location. Extension mobility should be available only to those individuals that need to use the feature."
  desc 'check', 'Verify the configuration for the extension mobility feature is globally disabled.
...
If the extension mobility feature is not globally disabled, this is a finding.'
  ...
  impact 0.5
  tag check_id: 'C-SRG-NET-000018-VVSM-00102_chk'
  tag severity: 'medium'
  tag gid: 'SRG-NET-000018-VVSM-00102'
  tag rid: 'SRG-NET-000018-VVSM-00102_rule'
  tag stig_id: 'SRG-NET-000018-VVSM-00102'
  tag gtitle: 'SRG-NET-000018-VVSM-00102'
  tag fix_id: 'F-SRG-NET-000018-VVSM-00102_fix'
  tag 'documentable'
  tag cci: ['CCI-001368']
  tag nist: ['AC-4']
end
