control 'SRG-NET-000334-VVSM-00101_rule' do
...
If the Unified Communications Session Manager does not offload session records to a central log server, this is a finding.'
  ...
  impact 0.7
  tag check_id: 'C-SRG-NET-000334-VVSM-00101_chk'
  tag severity: 'high'
  tag gid: 'SRG-NET-000334-VVSM-00101'
  tag rid: 'SRG-NET-000334-VVSM-00101_rule'
  tag stig_id: 'SRG-NET-000334-VVSM-00101'
  tag gtitle: 'SRG-NET-000334-VVSM-00101'
  tag fix_id: 'F-SRG-NET-000334-VVSM-00101_fix'
  tag 'documentable'
  tag cci: ['CCI-001851']
  tag nist: ['AU-4 (1)']
end
