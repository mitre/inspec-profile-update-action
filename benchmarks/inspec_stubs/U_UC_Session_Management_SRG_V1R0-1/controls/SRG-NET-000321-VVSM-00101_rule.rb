control 'SRG-NET-000321-VVSM-00101_rule' do
  title 'The Unified Communications Session Manager must be configured to enforce changes to privileges of Voice Video Endpoint user access.'
...
This may be mitigated by implementing SRG-NET-000321-VVSM-00008.'
  desc 'check', 'Verify the Unified Communications Session Manager enforces change to privileges of Voice Video Endpoint user access. Privileges include access to outside connections, precedence, and preemption capabilities.

If the Unified Communications Session Manager does not enforce changes to privileges of Voice Video Endpoint user access, this is a finding.'
  desc 'fix', 'Configure the Unified Communications Session Manager to enforce changes to privileges of Voice Video Endpoint user access.'
  impact 0.5
  tag check_id: 'C-SRG-NET-000321-VVSM-00101_chk'
  tag severity: 'medium'
  tag gid: 'SRG-NET-000321-VVSM-00101'
  tag rid: 'SRG-NET-000321-VVSM-00101_rule'
  tag stig_id: 'SRG-NET-000321-VVSM-00101'
  tag gtitle: 'SRG-NET-000321-VVSM-00101'
  tag fix_id: 'F-SRG-NET-000321-VVSM-00101_fix'
  tag 'documentable'
  tag cci: ['CCI-002178']
  tag nist: ['AC-3 (8)']
end
