control 'SV-224193' do
  ...
  desc 'In certain situations, to provide required functionality, a DBMS must execute internal logic (stored procedures, functions, triggers, etc.) and/or external code modules with elevated privileges. However, if the privileges required for execution are at a higher level than the privileges assigned to organizational users invoking the functionality applications/programs, those users are indirectly provided with greater privileges than assigned by organizations.
...
ALTER FUNCTION <function()> SECURITY INVOKER;'
  ...
  tag check_id: 'C-25866r495597_chk'
  tag severity: 'medium'
  tag gid: 'V-224193'
  tag rid: 'SV-224193r508023_rule'
  tag stig_id: 'EP11-00-007500'
  tag gtitle: 'SRG-APP-000342-DB-000302'
  tag fix_id: 'F-25854r495598_fix'
  tag 'documentable'
  tag legacy: ['SV-109511', 'V-100407']
  tag cci: ['CCI-002233']
  tag nist: ['AC-6 (8)']
end
