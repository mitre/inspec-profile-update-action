control 'SV-251243' do
  title 'Redis Enterprise DBMS must implement cryptographic mechanisms to prevent unauthorized modification of organization-defined information at rest (to include, at a minimum, PII and classified information) on organization-defined information system components.'
...
Detailed information on encrypting partitions using LUKS can be found on the Red Hat Documentation website: https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html/security_guide/sec-encryption'
  ...
  tag check_id: 'C-54678r804917_chk'
  tag severity: 'medium'
  tag gid: 'V-251243'
  tag rid: 'SV-251243r864489_rule'
  tag stig_id: 'RD6X-00-010900'
  tag gtitle: 'SRG-APP-000428-DB-000386'
  tag fix_id: 'F-54632r804918_fix'
  tag 'documentable'
  tag cci: ['CCI-002475']
  tag nist: ['SC-28 (1)']
end
