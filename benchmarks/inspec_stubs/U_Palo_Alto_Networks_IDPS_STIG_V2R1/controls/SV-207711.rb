...
Select "OK" when the confirmation dialog appears.'
  ...
  tag check_id: 'C-7965r358466_chk'
  tag severity: 'medium'
  tag gid: 'V-207711'
  tag rid: 'SV-207711r557390_rule'
  tag stig_id: 'PANW-IP-000051'
  tag gtitle: 'SRG-NET-000392-IDPS-00214'
  tag fix_id: 'F-7965r358467_fix'
  tag 'documentable'
  tag legacy: ['V-62693', 'SV-77183']
  tag cci: ['CCI-002664']
  tag nist: ['SI-4 (5)']
end
