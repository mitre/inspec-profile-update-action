...
SW1(config-switch)#neighbor x.1.4.12 prefix-list FILTER _CORE_PREFIXES out'
  impact 0.5
  ref 'DPMS Target Cisco IOS-XE Switch RTR'
  tag check_id: 'C-22742r408875_chk'
  tag severity: 'medium'
  tag gid: 'V-221027'
  tag rid: 'SV-221027r622190_rule'
  tag stig_id: 'CISC-RT-000530'
  tag gtitle: 'SRG-NET-000205-RTR-000006'
  tag fix_id: 'F-22731r408876_fix'
  tag 'documentable'
  tag legacy: ['SV-110875', 'V-101771']
  tag cci: ['CCI-001097']
  tag nist: ['SC-7 a']
end
