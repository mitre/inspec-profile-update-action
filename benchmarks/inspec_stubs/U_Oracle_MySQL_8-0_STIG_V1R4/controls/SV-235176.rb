control 'SV-235176' do
  title 'The MySQL Database Server 8.0 must provide an immediate real-time alert to appropriate support staff of all audit log failures.'
...
Alerts provide organizations with urgent messages. Real-time alerts provide these messages immediately (i.e., the time from event detection to alert occurs in seconds or less).'
  desc 'check', 'Review MySQL Server settings, OS, or third-party logging software settings to determine whether a real-time alert will be sent to the appropriate personnel when auditing fails for any reason.
...
If real-time alerts are not sent upon auditing failure, this is a finding.'
  ...
  tag check_id: 'C-38395r623648_chk'
  tag severity: 'medium'
  tag gid: 'V-235176'
  tag rid: 'SV-235176r879733_rule'
