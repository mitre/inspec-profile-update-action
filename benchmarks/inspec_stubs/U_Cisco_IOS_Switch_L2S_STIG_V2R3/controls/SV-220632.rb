...
If any access switch ports do not have UUFB enabled, this is a finding.'
  desc 'fix', 'Configure the switch to have UUFB enabled as shown in the configuration example below:

SW1(config)#int range g0/0 - 9
SW1(config-if-range)#switchport block unicast'
  impact 0.5
  ref 'DPMS Target Cisco IOS Switch L2S'
  tag check_id: 'C-22347r507942_chk'
  tag severity: 'medium'
  tag gid: 'V-220632'
  tag rid: 'SV-220632r856226_rule'
  tag stig_id: 'CISC-L2-000120'
  tag gtitle: 'SRG-NET-000362-L2S-000024'
  tag fix_id: 'F-22336r507943_fix'
  tag 'documentable'
  tag legacy: ['SV-110235', 'V-101131']
  tag cci: ['CCI-002385']
  tag nist: ['SC-5 a']
end
