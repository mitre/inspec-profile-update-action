control 'SV-223654' do
  title 'IBM RACF must protect memory and privileged program dumps in accordance with proper security requirements.'
  ...
  desc 'check', 'Execute a resource access list for the IEAABD. resources.
...
If the IEAABD.DMPAKEY resource and/or generic equivalent is defined and all access is restricted to systems personnel and that all access is logged, this is not a finding.'
  desc 'fix', %q(Memory and privileged program dump resources are provided via resources in the FACILITY resource class. Configure these resources to the ESM as specified in the following. 
...
PERMIT IEAABD.DMPAKEY.** CLASS(FACILITY) ID(syspsmpl) ACCESS(READ))
  ...
  tag check_id: 'C-25327r514651_chk'
  tag severity: 'medium'
  tag gid: 'V-223654'
  tag rid: 'SV-223654r868794_rule'
  tag stig_id: 'RACF-ES-000060'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25315r868793_fix'
  tag 'documentable'
  tag legacy: ['SV-107117', 'V-98013']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
