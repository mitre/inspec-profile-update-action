...
The TESTAUTH authorization is restricted to only z/OS systems programming personnel."
  ...
  tag check_id: 'C-25509r515196_chk'
  tag severity: 'medium'
  tag gid: 'V-223836'
  tag rid: 'SV-223836r868884_rule'
  tag stig_id: 'RACF-TS-000010'
  tag gtitle: 'SRG-OS-000080-GPOS-00048'
  tag fix_id: 'F-25497r868883_fix'
  tag 'documentable'
  tag legacy: ['V-98379', 'SV-107483']
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
