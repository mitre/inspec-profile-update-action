...
//SYSABEND DD SYSOUT=*"
  ...
  tag check_id: 'C-25447r868854_chk'
  tag severity: 'medium'
  tag gid: 'V-223774'
  tag rid: 'SV-223774r877038_rule'
  tag stig_id: 'RACF-OS-000180'
  tag gtitle: 'SRG-OS-000355-GPOS-00143'
  tag fix_id: 'F-25435r868855_fix'
  tag 'documentable'
  tag legacy: ['V-98255', 'SV-107359']
  tag cci: ['CCI-001891']
  tag nist: ['AU-8 (1) (a)']
end
