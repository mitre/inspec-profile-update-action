...
If "Attached policy set" column displays none, but the System Security Plan specifies security extensions as required, this is a finding.'
  desc 'fix', 'To attach policy sets for your service clients: 
...
Restart DMGR and resync the JVMs.'
  ...
  tag check_id: 'C-81033r2_chk'
  tag severity: 'medium'
  tag gid: 'V-81329'
  tag rid: 'SV-96043r1_rule'
  tag stig_id: 'WBSP-AS-001090'
  tag gtitle: 'SRG-APP-000156-AS-000106'
  tag fix_id: 'F-88113r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001941']
  tag nist: ['IA-2 (8)']
end
