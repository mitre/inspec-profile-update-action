...
In the Object Explorer in SQL Server Management Studio (SSMS), right-click on the server instance, select "Properties", and then select the "Security" page. If Windows Authentication Mode is selected, this is not a finding. 
...
DROP USER <user_name>;)
  ...
  tag check_id: 'C-15118r822442_chk'
  tag severity: 'high'
  tag gid: 'V-213900'
  tag rid: 'SV-213900r822444_rule'
  tag stig_id: 'SQL6-D0-000100'
  tag gtitle: 'SRG-APP-000023-DB-000001'
  tag fix_id: 'F-15116r822443_fix'
  tag 'documentable'
