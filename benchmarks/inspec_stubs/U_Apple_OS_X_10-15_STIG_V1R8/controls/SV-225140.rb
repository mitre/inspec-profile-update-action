...
/usr/bin/sudo /usr/bin/sed -i.bak 's/.*ClientAliveCountMax.*/ClientAliveCountMax 0/' /etc/ssh/sshd_config)
  ...
  tag check_id: 'C-26839r467588_chk'
  tag severity: 'medium'
  tag gid: 'V-225140'
  tag rid: 'SV-225140r610901_rule'
  tag stig_id: 'AOSX-15-000052'
  tag gtitle: 'SRG-OS-000163-GPOS-00072'
  tag fix_id: 'F-26827r467589_fix'
  tag 'documentable'
  tag legacy: ['SV-111659', 'V-102697']
  tag cci: ['CCI-001133']
  tag nist: ['SC-10']
end
