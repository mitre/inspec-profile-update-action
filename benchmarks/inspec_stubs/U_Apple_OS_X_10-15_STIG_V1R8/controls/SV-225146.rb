...
[audit log file] is the full path to the log file in question.'
  ...
  tag check_id: 'C-26845r467606_chk'
  tag severity: 'medium'
  tag gid: 'V-225146'
  tag rid: 'SV-225146r610901_rule'
  tag stig_id: 'AOSX-15-001012'
  tag gtitle: 'SRG-OS-000057-GPOS-00027'
  tag fix_id: 'F-26833r467607_fix'
  tag 'documentable'
  tag legacy: ['V-102709', 'SV-111671']
  tag cci: ['CCI-000162']
  tag nist: ['AU-9 a']
end
