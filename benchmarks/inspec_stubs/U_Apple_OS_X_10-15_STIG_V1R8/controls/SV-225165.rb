...
If the return is not, "forceInternetSharingOff = 1", this is a finding.'
  ...
  tag check_id: 'C-26864r467663_chk'
  tag severity: 'medium'
  tag gid: 'V-225165'
  tag rid: 'SV-225165r610901_rule'
  tag stig_id: 'AOSX-15-002007'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-26852r467664_fix'
  tag 'documentable'
  tag legacy: ['SV-111709', 'V-102747']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
