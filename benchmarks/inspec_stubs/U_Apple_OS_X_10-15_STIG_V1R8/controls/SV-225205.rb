...
If the return is not “requireAlphanumeric = 1”, this is a finding.'
  ...
  tag check_id: 'C-26904r467783_chk'
  tag severity: 'medium'
  tag gid: 'V-225205'
  tag rid: 'SV-225205r610901_rule'
  tag stig_id: 'AOSX-15-003007'
  tag gtitle: 'SRG-OS-000071-GPOS-00039'
  tag fix_id: 'F-26892r467784_fix'
  tag 'documentable'
  tag legacy: ['V-102829', 'SV-111791']
  tag cci: ['CCI-000194']
  tag nist: ['IA-5 (1) (a)']
end
