...
If there is no result, or if "askForPassword" is not set to "1", this is a finding.'
  ...
  tag check_id: 'C-26818r467525_chk'
  tag severity: 'medium'
  tag gid: 'V-225119'
  tag rid: 'SV-225119r610901_rule'
  tag stig_id: 'AOSX-15-000002'
  tag gtitle: 'SRG-OS-000028-GPOS-00009'
  tag fix_id: 'F-26806r467526_fix'
  tag 'documentable'
  tag legacy: ['SV-111615', 'V-102653']
  tag cci: ['CCI-000056']
  tag nist: ['AC-11 b']
end
