control 'SV-251421' do
  title 'The Ivanti MobileIron Core server must, at a minimum, off-load audit logs of interconnected systems in real time and off-load standalone systems weekly.'
...
If "Audit Log" is not included in the "Data To Index", this is a finding.'
  desc 'fix', 'Complete the following activities to configure the transfer of MobileIron Core 11 server logs:
...
6. Click Apply >> OK to save the changes.'
  ...
  tag check_id: 'C-54856r806393_chk'
  tag severity: 'medium'
  tag gid: 'V-251421'
  tag rid: 'SV-251421r806395_rule'
  tag stig_id: 'IMIC-11-012500'
  tag gtitle: 'SRG-APP-000515-UEM-000390'
  tag fix_id: 'F-54809r806394_fix'
