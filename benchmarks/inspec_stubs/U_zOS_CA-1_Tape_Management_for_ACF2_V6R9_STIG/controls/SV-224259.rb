...
___	The ACF2 data set access authorizations restrict WRITE and/or greater access to CA1 Tape Management STCs and/or batch users.'
  desc 'fix', 'Ensure that WRITE and/or greater access to CA1 Tape management STC data sets is limited to System Programmers and/or CA1 Tape management STC(s) and/or batch user(s) only.  
...
CA1.TMS*.**- UID(<audtaudt>) R(A) E(A)'
  ...
  tag check_id: 'C-25932r519461_chk'
  tag severity: 'medium'
  tag gid: 'V-224259'
  tag rid: 'SV-224259r519463_rule'
  tag stig_id: 'ZCA1A001'
  tag gtitle: 'SRG-OS-000259'
  tag fix_id: 'F-25920r519462_fix'
  tag 'documentable'
