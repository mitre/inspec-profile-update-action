control 'SV-242620' do
  title 'The Cisco ISE must generate audit records when successful attempts to access privileges occur.'
...
5. Click "Save".'
  ...
  tag check_id: 'C-45895r864186_chk'
  tag severity: 'medium'
  tag gid: 'V-242620'
  tag rid: 'SV-242620r879561_rule'
  tag stig_id: 'CSCO-NM-000140'
  tag gtitle: 'SRG-APP-000091-NDM-000223'
  tag fix_id: 'F-45852r864187_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
end
