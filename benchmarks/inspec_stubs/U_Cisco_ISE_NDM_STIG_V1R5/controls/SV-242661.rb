control 'SV-242661' do
  title 'The Cisco ISE must be configured to send log data to at least two central log servers for the purpose of forwarding alerts to the administrators and the information system security officer (ISSO).'
...
If at least two remote logging targets are not configured, this is a finding.'
  desc 'fix', 'Create at least two Remote Logging Targets and direct logging to those targets. To create an external logging target, complete the following steps:
...
The updating of the selected Log Collector is completed.'
  ...
  tag check_id: 'C-45936r916085_chk'
  tag severity: 'medium'
  tag gid: 'V-242661'
  tag rid: 'SV-242661r916114_rule'
  tag stig_id: 'CSCO-NM-000560'
  tag gtitle: 'SRG-APP-000516-NDM-000350'
  tag fix_id: 'F-45893r916086_fix'
  tag 'documentable'
  tag cci: ['CCI-001851']
  tag nist: ['AU-4 (1)']
end
