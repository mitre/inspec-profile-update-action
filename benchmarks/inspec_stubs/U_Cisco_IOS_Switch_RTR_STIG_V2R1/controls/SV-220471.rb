...
This can generate significant amounts of traffic. Therefore, protection measures to counteract IP source address spoofing must be taken. When uRPF is enabled in strict mode, the packet must be received on the interface that the device would use to forward the return packet, thereby mitigating IP source address spoofing.'
  desc 'check', 'Review the switch configuration to verify that uRPF or an egress ACL has been configured on all internal interfaces to restrict the switch from accepting outbound IP packets that contain an illegitimate address in the source address field. 
...
SW1(config-if)#ip verify unicast source reachable-via rx'
  ...
  tag check_id: 'C-22186r508486_chk'
  tag severity: 'high'
  tag gid: 'V-220471'
  tag rid: 'SV-220471r622190_rule'
  tag stig_id: 'CISC-RT-000310'
  tag gtitle: 'SRG-NET-000205-RTR-000014'
  tag fix_id: 'F-22175r508487_fix'
  tag 'documentable'
  tag legacy: ['SV-110735', 'V-101631']
  tag cci: ['CCI-001094']
  tag nist: ['SC-5 (1)']
end
