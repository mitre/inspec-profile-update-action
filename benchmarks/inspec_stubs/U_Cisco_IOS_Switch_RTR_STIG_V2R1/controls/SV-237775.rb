...
If the switch is not configured to drop IPv6 packets containing the NSAP address option within Destination Option header, this is a finding.'
  desc 'fix', 'Configure the switch to to drop IPv6 packets containing the NSAP address option within Destination Option header as shown in the example below.
...
SW1(config-if)#end'
  ...
  tag check_id: 'C-40987r648816_chk'
  tag severity: 'medium'
  tag gid: 'V-237775'
  tag rid: 'SV-237775r648818_rule'
  tag stig_id: 'CISC-RT-000397'
  tag gtitle: 'SRG-NET-000364-RTR-000205'
  tag fix_id: 'F-40946r648817_fix'
  tag 'documentable'
  tag cci: ['CCI-002403']
  tag nist: ['SC-7 (11)']
end
