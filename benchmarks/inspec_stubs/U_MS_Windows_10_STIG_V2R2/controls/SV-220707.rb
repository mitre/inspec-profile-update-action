control 'SV-220707' do
  ...
  desc 'check', 'Verify an anti-virus solution is installed on the system and in use. The anti-virus solution may be bundled with an approved host-based security solution.
...
If there is no anti-virus solution installed on the system, this is a finding.'
  desc 'fix', 'If no anti-virus software is in use, install Windows Defender or a third-party anti-virus solution.'
  impact 0.7
  ref 'DPMS Target Windows 10'
  tag check_id: 'C-22422r641867_chk'
  tag severity: 'high'
  tag gid: 'V-220707'
  tag rid: 'SV-220707r569187_rule'
  tag stig_id: 'WN10-00-000045'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-22411r641868_fix'
  tag 'documentable'
