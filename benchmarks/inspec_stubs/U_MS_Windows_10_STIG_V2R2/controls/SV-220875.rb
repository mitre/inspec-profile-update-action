control 'SV-220875' do
  title 'Windows 10 Exploit Protection system-level mitigation, Control flow guard (CFG), must be on.'
  desc 'Exploit protection in Windows 10 enables mitigations against potential threats at the system and application level.  Several mitigations, including "Control flow guard (CFG)", are enabled by default at the system level. CFG ensures flow integrity for indirect calls. If this is turned off, Windows 10 may be subject to various exploits.'
...
The XML file is applied with the group policy setting Computer Configuration >> Administrative Settings >> Windows Components >> Windows Defender Exploit Guard >> Exploit Protection >> "Use a common set of exploit protection settings" configured to "Enabled" with file name and location defined under "Options:". It is recommended the file be in a read-only network location.'
  ...
  tag check_id: 'C-22590r555110_chk'
  tag severity: 'medium'
  tag gid: 'V-220875'
  tag rid: 'SV-220875r569187_rule'
  tag stig_id: 'WN10-EP-000040'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-22579r555111_fix'
  tag 'documentable'
  tag legacy: ['SV-91793', 'V-77097']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
