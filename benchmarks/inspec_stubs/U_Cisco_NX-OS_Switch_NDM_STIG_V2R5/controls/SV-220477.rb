control 'SV-220477' do
  ...
  desc 'check', 'Review the switch configuration to determine if it automatically audits account disabling. 
...
If account disabling is not automatically audited, this is a finding.'
  desc 'fix', 'Configure the switch to log account disabling using the following steps:
...
SW1(config)# end'
  ...
  tag check_id: 'C-22192r539152_chk'
  tag severity: 'medium'
  tag gid: 'V-220477'
  tag rid: 'SV-220477r879527_rule'
  tag stig_id: 'CISC-ND-000110'
  tag gtitle: 'SRG-APP-000028-NDM-000210'
  tag fix_id: 'F-22181r539153_fix'
  tag 'documentable'
  tag legacy: ['SV-110601', 'V-101497']
  tag cci: ['CCI-001404']
  tag nist: ['AC-2 (4)']
end
