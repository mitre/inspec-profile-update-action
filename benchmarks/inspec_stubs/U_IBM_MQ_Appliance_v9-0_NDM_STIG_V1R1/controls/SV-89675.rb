control 'SV-89675' do
  title 'WebGUI access to the MQ Appliance network device must accept Personal Identity Verification (PIV) credentials.'
...
y'
  ...
  tag check_id: 'C-74853r1_chk'
  tag severity: 'medium'
  tag gid: 'V-75001'
  tag rid: 'SV-89675r1_rule'
  tag stig_id: 'MQMH-ND-001160'
  tag gtitle: 'SRG-APP-000391-NDM-000308'
  tag fix_id: 'F-81617r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001953']
  tag nist: ['IA-2 (12)']
end
