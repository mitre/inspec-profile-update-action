control 'SV-89677' do
  title 'WebGUI access to the MQ Appliance network device must electronically verify Personal Identity Verification (PIV) credentials.'
...
DoD has mandated the use of the CAC to support identity management and personal authentication for systems covered under HSPD 12, as well as a primary component of layered protection for national security systems.'
  desc 'check', 'Log on to the MQ Appliance CLI as a privileged user. Verify MQ Appliance PKI-based user authentication is configured. 
...
If unauthorized access succeeds, this is a finding.'
  desc 'fix', 'Log on to the MQ Appliance CLI as a privileged user. Configure MQ Appliance PKI-based user authentication. 
...
y'
  ...
  tag check_id: 'C-74855r1_chk'
  tag severity: 'medium'
  tag gid: 'V-75003'
  tag rid: 'SV-89677r1_rule'
  tag stig_id: 'MQMH-ND-001180'
  tag gtitle: 'SRG-APP-000392-NDM-000309'
  tag fix_id: 'F-81619r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001954']
  tag nist: ['IA-2 (12)']
end
