control 'SV-89671' do
  title 'The MQ Appliance network device must synchronize internal information system clocks to the authoritative time source when the time difference is greater than the organization-defined time period.'
...
Click "Save configuration".'
  ...
  tag check_id: 'C-74849r1_chk'
  tag severity: 'medium'
  tag gid: 'V-74997'
  tag rid: 'SV-89671r1_rule'
  tag stig_id: 'MQMH-ND-001070'
  tag gtitle: 'SRG-APP-000372-NDM-000297'
  tag fix_id: 'F-81613r1_fix'
  tag 'documentable'
  tag cci: ['CCI-002046']
  tag nist: ['AU-8 (1) (b)']
end
