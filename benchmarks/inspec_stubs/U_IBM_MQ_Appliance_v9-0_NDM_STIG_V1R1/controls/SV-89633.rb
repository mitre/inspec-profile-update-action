control 'SV-89633' do
  title 'The MQ Appliance network device must enforce password complexity by requiring that at least one special character be used.'
...
Check the Require Non-alphanumeric check box.'
  ...
  tag check_id: 'C-74817r1_chk'
  tag severity: 'medium'
  tag gid: 'V-74959'
  tag rid: 'SV-89633r1_rule'
  tag stig_id: 'MQMH-ND-000610'
  tag gtitle: 'SRG-APP-000169-NDM-000257'
  tag fix_id: 'F-81575r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001619']
  tag nist: ['IA-5 (1) (a)']
end
