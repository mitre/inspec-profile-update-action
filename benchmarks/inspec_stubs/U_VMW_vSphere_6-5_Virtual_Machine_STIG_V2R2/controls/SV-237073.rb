control 'SV-237073' do
  ...
  desc 'check', 'From the vSphere Web Client right-click the Virtual Machine and go to Edit Settings >> VM Options >> Advanced >> Configuration Parameters >> Edit Configuration. Verify the isolation.tools.ghi.autologon.disable value is set to true.
...
If the virtual machine advanced setting isolation.tools.ghi.autologon.disable does not exist or is not set to true, this is a finding.'
  desc 'fix', 'From the vSphere Web Client right-click the Virtual Machine and go to Edit Settings >> VM Options >> Advanced >> Configuration Parameters >> Edit Configuration. Find the isolation.tools.ghi.autologon.disable value and set it to true. If the setting does not exist, add the Name and Value setting at the bottom of screen.
...
Get-VM "VM Name" | Get-AdvancedSetting -Name isolation.tools.ghi.autologon.disable | Set-AdvancedSetting -Value true'
  ...
  tag check_id: 'C-40292r640054_chk'
  tag severity: 'low'
  tag gid: 'V-237073'
  tag rid: 'SV-237073r640056_rule'
  tag stig_id: 'VMCH-65-000009'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-40255r640055_fix'
  tag 'documentable'
  tag legacy: ['SV-104409', 'V-94579']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
