control 'SV-237082' do
  ...
  desc 'check', 'From the vSphere Web Client right-click the Virtual Machine and go to Edit Settings >> VM Options >> Advanced >> Configuration Parameters >> Edit Configuration. Verify the isolation.tools.unity.taskbar.disable value is set to true.
...
If the virtual machine advanced setting isolation.tools.unity.taskbar.disable does not exist or is not set to true, this is a finding.'
  desc 'fix', 'From the vSphere Web Client right-click the Virtual Machine and go to Edit Settings >> VM Options >> Advanced >> Configuration Parameters >> Edit Configuration. Find the isolation.tools.unity.taskbar.disable value and set it to true. If the setting does not exist, add the Name and Value setting at the bottom of screen.
...
Get-VM "VM Name" | Get-AdvancedSetting -Name isolation.tools.unity.taskbar.disable | Set-AdvancedSetting -Value true'
  ...
  tag check_id: 'C-40301r640081_chk'
  tag severity: 'low'
  tag gid: 'V-237082'
  tag rid: 'SV-237082r640083_rule'
  tag stig_id: 'VMCH-65-000022'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-40264r640082_fix'
  tag 'documentable'
  tag legacy: ['SV-104433', 'V-94603']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
