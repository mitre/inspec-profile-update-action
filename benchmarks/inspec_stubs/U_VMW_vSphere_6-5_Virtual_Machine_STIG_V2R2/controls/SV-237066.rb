control 'SV-237066' do
  ...
  desc 'check', 'From the vSphere Web Client right-click the Virtual Machine and go to Edit Settings >> VM Options >> Advanced >> Configuration Parameters >> Edit Configuration. Verify the isolation.tools.dnd.disable value is set to true.
...
If the virtual machine advanced setting isolation.tools.dnd.disable does not exist or is not set to true, this is a finding.'
  desc 'fix', 'From the vSphere Web Client right-click the Virtual Machine and go to Edit Settings >> VM Options >> Advanced >> Configuration Parameters >> Edit Configuration. Verify the isolation.tools.dnd.disable value is set to true. If the setting does not exist, add the Name and Value setting at the bottom of screen.
...
Get-VM "VM Name" | Get-AdvancedSetting -Name isolation.tools.dnd.disable | Set-AdvancedSetting -Value true'
  ...
  tag check_id: 'C-40285r640033_chk'
  tag severity: 'low'
  tag gid: 'V-237066'
  tag rid: 'SV-237066r640035_rule'
  tag stig_id: 'VMCH-65-000002'
  tag gtitle: 'SRG-OS-000480-VMM-002000'
  tag fix_id: 'F-40248r640034_fix'
  tag 'documentable'
  tag legacy: ['SV-104395', 'V-94565']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
