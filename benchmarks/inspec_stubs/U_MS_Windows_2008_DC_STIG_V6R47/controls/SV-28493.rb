control 'SV-28493' do
  ...
  desc 'check', '1. Analyze the system using the Security Configuration and Analysis tool.  
...
Value:  0'
  ...
  tag check_id: 'C-96r1_chk'
  tag severity: 'medium'
  tag gid: 'V-2373'
  tag rid: 'SV-28493r1_rule'
  tag stig_id: 'AD.3058_2008'
