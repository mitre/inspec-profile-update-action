...
If it does not enforce the organization-defined minimum number of special characters (1 unless otherwise specified), this is a finding."
...
$ORACLE_HOME/rdbms/admin/catpvf.sql'
  ...
  tag check_id: 'C-40950r667223_chk'
  tag severity: 'medium'
  tag gid: 'V-237731'
  tag rid: 'SV-237731r879601_rule'
  tag stig_id: 'O121-C2-014400'
  tag gtitle: 'SRG-APP-000164-DB-000401'
  tag fix_id: 'F-40913r667224_fix'
  tag 'documentable'
  tag legacy: ['V-61729', 'SV-76219']
  tag cci: ['CCI-001619']
  tag nist: ['IA-5 (1) (a)']
end
