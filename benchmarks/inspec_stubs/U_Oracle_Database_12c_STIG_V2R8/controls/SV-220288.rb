...
For each process, determine the directory specified in the ORACLE_HOME or TNS_ADMIN environment variable defined for the process account to locate the listener.ora file.'
  desc 'fix', 'If use of the external procedure agent is required, then authorize and document the requirement in the System Security Plan.
...
See the Oracle Net Services Administrators Guides, External Procedures section for detailed configuration information.'
  ...
  tag check_id: 'C-22003r391995_chk'
  tag severity: 'medium'
  tag gid: 'V-220288'
  tag rid: 'SV-220288r879587_rule'
  tag stig_id: 'O121-C2-011810'
  tag gtitle: 'SRG-APP-000141-DB-000093'
  tag fix_id: 'F-21995r391996_fix'
  tag 'documentable'
  tag legacy: ['SV-76175', 'V-61685']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
