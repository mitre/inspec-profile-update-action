control 'SV-87933' do
  ...
  desc 'check', 'Verify DoD approved HBSS software is installed, configured, and properly operating. Ask the operator to document the HBSS software installation and configuration.
...
If the operator is not able to provide a documented configuration for an installed HBSS or if the HBSS software is not properly configured, maintained, or used, this is a finding.'
  ...
  tag check_id: 'C-94159r1_chk'
  tag severity: 'medium'
  tag gid: 'V-73281'
  tag rid: 'SV-87933r2_rule'
  tag stig_id: 'WN16-00-000320'
  tag gtitle: 'SRG-OS-000191-GPOS-00080'
  tag fix_id: 'F-101005r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001233']
  tag nist: ['SI-2 (2)']
end
