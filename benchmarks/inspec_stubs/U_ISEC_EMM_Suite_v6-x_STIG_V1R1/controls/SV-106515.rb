...
Verify that sslProtocol is set to TLS1.2.'
  ...
  tag check_id: 'C-96247r1_chk'
  tag severity: 'medium'
  tag gid: 'V-97411'
  tag rid: 'SV-106515r1_rule'
  tag stig_id: 'ISEC-06-002620'
  tag gtitle: 'SRG-APP-000585'
  tag fix_id: 'F-103089r1_fix'
  tag satisfies: ['SRG-APP-000585', 'SRG-APP-000590', 'SRG-APP-000560', 'SRG-APP-000645']
  tag 'documentable'
  tag cci: ['CCI-000382', 'CCI-001453', 'CCI-001967']
  tag nist: ['CM-7 b', 'AC-17 (2)', 'IA-3 (1)']
end
