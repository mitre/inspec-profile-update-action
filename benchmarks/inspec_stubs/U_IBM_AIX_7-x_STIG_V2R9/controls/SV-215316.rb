control 'SV-215316' do
  title 'The AIX audit configuration files must be group-owned by audit.'
  ...
  desc 'check', %q(Check that all the audit configuration files under /etc/security/audit/* have group ownership. 
...
If any file's group ownership is not "audit",  this is a finding.)
  desc 'fix', 'Set the group of the audit configuration files to "audit".
# chgrp audit /etc/security/audit/*'
  impact 0.5
  ref 'DPMS Target IBM AIX 7.x'
  tag check_id: 'C-16514r294399_chk'
  tag severity: 'medium'
  tag gid: 'V-215316'
  tag rid: 'SV-215316r508663_rule'
  tag stig_id: 'AIX7-00-002201'
  tag gtitle: 'SRG-OS-000063-GPOS-00032'
  tag fix_id: 'F-16512r294400_fix'
  tag 'documentable'
  tag legacy: ['SV-101371', 'V-91273']
  tag cci: ['CCI-000171']
  tag nist: ['AU-12 b']
end
