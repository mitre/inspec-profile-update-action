...
'
  desc 'check', %q(Verify the SUSE operating system generates an audit record for all uses of the "passmass" command.
...
> sudo augenrules --load'
  ...
  tag check_id: 'C-38136r619113_chk'
  tag severity: 'medium'
  tag gid: 'V-234948'
  tag rid: 'SV-234948r622137_rule'
  tag stig_id: 'SLES-15-030490'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-38099r619114_fix'
