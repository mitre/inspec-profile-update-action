...
> sudo systemctl restart sshd.service'
  ...
  tag check_id: 'C-38018r618759_chk'
  tag severity: 'medium'
  tag gid: 'V-234830'
  tag rid: 'SV-234830r622137_rule'
  tag stig_id: 'SLES-15-010320'
  tag gtitle: 'SRG-OS-000163-GPOS-00072'
  tag fix_id: 'F-37981r618760_fix'
  tag 'documentable'
  tag cci: ['CCI-001133', 'CCI-000879', 'CCI-002361']
  tag nist: ['SC-10', 'MA-4 e', 'AC-12']
end
