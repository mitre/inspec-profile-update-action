control 'SV-234902' do
  title 'The SUSE operating system must generate audit records for all account creations, modifications, disabling, and termination events that affect /etc/security/opasswd.'
...
'
  desc 'check', %q(Verify the SUSE operating system generates an audit record when modifications occur to the "/etc/security/opasswd" file.
...
> sudo augenrules --load'
  ...
  tag check_id: 'C-38090r618975_chk'
  tag severity: 'medium'
  tag gid: 'V-234902'
  tag rid: 'SV-234902r622137_rule'
  tag stig_id: 'SLES-15-030030'
  tag gtitle: 'SRG-OS-000004-GPOS-00004'
  tag fix_id: 'F-38053r618976_fix'
  ...
  tag 'documentable'
  tag cci: ['CCI-000018', 'CCI-000172', 'CCI-002132', 'CCI-002130', 'CCI-001403']
