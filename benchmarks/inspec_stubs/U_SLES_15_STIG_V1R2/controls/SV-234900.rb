...
'
  desc 'check', %q(Verify the SUSE operating system generates an audit record when modifications occur to the "/etc/group" file.
...
> sudo augenrules --load'
  ...
  tag check_id: 'C-38088r618969_chk'
  tag severity: 'medium'
  tag gid: 'V-234900'
  tag rid: 'SV-234900r622137_rule'
  tag stig_id: 'SLES-15-030010'
  tag gtitle: 'SRG-OS-000004-GPOS-00004'
  tag fix_id: 'F-38051r618970_fix'
  ...
  tag 'documentable'
  tag cci: ['CCI-000018', 'CCI-002132', 'CCI-002130', 'CCI-001403', 'CCI-000172']
