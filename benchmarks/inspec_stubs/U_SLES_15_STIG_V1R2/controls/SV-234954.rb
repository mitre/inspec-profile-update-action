...
'
  desc 'check', %q(Verify the SUSE operating system generates an audit record for any use of the "su" command.
...
> sudo augenrules --load'
  ...
  tag check_id: 'C-38142r619131_chk'
  tag severity: 'medium'
  tag gid: 'V-234954'
  tag rid: 'SV-234954r622137_rule'
  tag stig_id: 'SLES-15-030550'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-38105r619132_fix'
