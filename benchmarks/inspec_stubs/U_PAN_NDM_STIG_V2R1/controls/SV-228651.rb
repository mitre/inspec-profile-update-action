...
Select "OK" when the confirmation dialog appears.'
  ...
  tag check_id: 'C-30886r513556_chk'
  tag severity: 'medium'
  tag gid: 'V-228651'
  tag rid: 'SV-228651r513558_rule'
  tag stig_id: 'PANW-NM-000056'
  tag gtitle: 'SRG-APP-000167-NDM-000255'
  tag fix_id: 'F-30863r513557_fix'
  tag 'documentable'
  tag legacy: ['SV-77219', 'V-62729']
  tag cci: ['CCI-000193']
  tag nist: ['IA-5 (1) (a)']
end
