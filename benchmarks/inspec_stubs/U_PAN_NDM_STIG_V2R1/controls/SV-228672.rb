...
Select "OK" when the confirmation dialog appears.'
  ...
  tag check_id: 'C-30907r513619_chk'
  tag severity: 'medium'
  tag gid: 'V-228672'
  tag rid: 'SV-228672r513621_rule'
  tag stig_id: 'PANW-NM-000131'
  tag gtitle: 'SRG-APP-000516-NDM-000317'
  tag fix_id: 'F-30884r513620_fix'
  tag 'documentable'
  tag legacy: ['SV-77261', 'V-62771']
  tag cci: ['CCI-000366', 'CCI-000366', 'CCI-001274']
  tag nist: ['CM-6 b', 'CM-6 b', 'SI-4 (12)']
end
