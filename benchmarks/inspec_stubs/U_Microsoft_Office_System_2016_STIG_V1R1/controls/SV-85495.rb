control 'SV-85495' do
  ...
  desc 'check', 'Verify the policy value for User Configuration -> Administrative Templates -> Microsoft Office 2016 -> Security Settings "Load Controls in Forms3" is set to "Disabled".
...
Criteria: If the value LoadControlsInForms exists, this is a finding.'
  desc 'fix', 'Set the policy value for User Configuration -> Administrative Templates -> Microsoft Office 2016 -> Security Settings "Load Controls in Forms3" to "Disabled".'
  impact 0.5
  ref 'DPMS Target Microsoft Office System 2016'
  tag check_id: 'C-71315r2_chk'
  tag severity: 'medium'
  tag gid: 'V-70871'
  tag rid: 'SV-85495r1_rule'
  tag stig_id: 'DTOO192'
  tag gtitle: 'SRG-APP-000207'
  tag fix_id: 'F-77203r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001662']
  tag nist: ['SC-18 (1)']
end
