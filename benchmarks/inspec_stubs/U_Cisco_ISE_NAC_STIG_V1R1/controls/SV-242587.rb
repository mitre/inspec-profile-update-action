control 'SV-242587' do
  title 'The Cisco ISE must be configured so client machines do not communicate with other network devices in the DMZ or subnet except as needed to perform an access client assessment or to identify themselves.'
...
The failure must also be used to update the HBSS agent.'
  desc 'check', 'Verify the authorization policy will prevent intra-remediation VLAN communication.
...
If the authorization policy does not prevent intra-remediation VLAN communication, this is a finding.'
  desc 'fix', 'Configure the remediation authorization policy to prevent intra-remediation VLAN communication.
...
6. Choose "Save".'
  ...
  tag check_id: 'C-45862r714069_chk'
  tag severity: 'medium'
  tag gid: 'V-242587'
  tag rid: 'SV-242587r714071_rule'
  tag stig_id: 'CSCO-NC-000130'
  tag gtitle: 'SRG-NET-000015-NAC-000130'
  tag fix_id: 'F-45819r714070_fix'
  tag 'documentable'
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
