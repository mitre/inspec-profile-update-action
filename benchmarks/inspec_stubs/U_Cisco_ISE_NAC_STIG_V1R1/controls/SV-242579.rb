control 'SV-242579' do
  title 'The Cisco ISE must verify anti-malware software is installed and up to date on posture required clients defined in the NAC System Security Plan (SSP) prior to granting trusted network access.'
  ...
  desc 'check', 'Verify that the posture policy will verify that anti-malware software is installed and up to date.
...
If there is not a firewall condition tied to a requirement that is applied to an applicable posture policy, this is a finding.'
  desc 'fix', %q(Configure the posture policy to verify that an anti-malware software is up to date.
...
e. Choose "Save".)
  ...
  tag check_id: 'C-45854r714045_chk'
  tag severity: 'high'
  tag gid: 'V-242579'
  tag rid: 'SV-242579r714047_rule'
  tag stig_id: 'CSCO-NC-000050'
  tag gtitle: 'SRG-NET-000015-NAC-000020'
  tag fix_id: 'F-45811r714046_fix'
  tag 'documentable'
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
