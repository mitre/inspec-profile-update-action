control 'SV-242577' do
  title 'The Cisco ISE must be configured to profile endpoints connecting to the network.'
  ...
  desc 'check', 'Verify the profiling service is configured and enabled.
...
6. Click "Save" to save the node configuration.'
  ...
  tag check_id: 'C-45852r714039_chk'
  tag severity: 'high'
  tag gid: 'V-242577'
  tag rid: 'SV-242577r714041_rule'
