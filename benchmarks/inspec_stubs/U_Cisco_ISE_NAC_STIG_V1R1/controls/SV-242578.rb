control 'SV-242578' do
  title 'The Cisco ISE must verify host-based firewall software is running on posture required clients defined in the NAC System Security Plan (SSP) prior to granting trusted network access.'
  ...
  desc 'check', 'Verify that the posture policy will verify that a host-based firewall is running.
...
If there is not a firewall condition tied to a requirement that is applied to an applicable posture policy, this is a finding.'
  desc 'fix', %q(Configure the posture policy to verify that a host-based firewall is running.
...
e. Choose "Save".)
  ...
  tag check_id: 'C-45853r714042_chk'
  tag severity: 'high'
  tag gid: 'V-242578'
  tag rid: 'SV-242578r714044_rule'
  tag stig_id: 'CSCO-NC-000040'
  tag gtitle: 'SRG-NET-000015-NAC-000020'
  tag fix_id: 'F-45810r714043_fix'
  tag 'documentable'
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
