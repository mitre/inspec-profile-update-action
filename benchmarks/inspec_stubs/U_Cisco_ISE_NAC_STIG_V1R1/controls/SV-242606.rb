control 'SV-242606' do
  title 'The Cisco ISE must have a posture policy for posture required clients defined in the NAC System Security Plan (SSP).'
  ...
  desc 'check', 'Verify the posture policy for posture required clients.
...
If there is not an enabled policy that will be applied to posture required endpoints, this is a finding.'
  desc 'fix', 'Configure the posture policy for posture required clients.
...
Note: You can apply multiple requirements to a single policy, or have multiple policies with a single policy with a single requirement as the posture policy operates in a "match-all" fashion.'
  ...
  tag check_id: 'C-45881r714126_chk'
  tag severity: 'high'
  tag gid: 'V-242606'
  tag rid: 'SV-242606r714128_rule'
  tag stig_id: 'CSCO-NC-000320'
  tag gtitle: 'SRG-NET-000512-NAC-002310'
  tag fix_id: 'F-45838r714127_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
