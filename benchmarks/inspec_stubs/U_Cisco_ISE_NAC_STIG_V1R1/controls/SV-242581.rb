control 'SV-242581' do
  title 'For endpoints that require automated remediation, the Cisco ISE must be configured to redirect endpoints to a logically separate VLAN for remediation services.'
...
Unauthenticated devices must not be allowed to connect to remediation services.'
  desc 'check', 'Verify that the authorization policies for "Posture NonCompliant" have a result that will assign the remediation VLAN. 
...
If posture is not mandated by the Information System Security Manager (ISSM), this is not a finding.'
  desc 'fix', 'Configure the "Posture NonCompliant" authorization policy so that the result that will assign the remediation VLAN. 
...
5. Assign the remediation VLAN result.'
  ...
  tag check_id: 'C-45856r714051_chk'
  tag severity: 'medium'
  tag gid: 'V-242581'
  tag rid: 'SV-242581r714053_rule'
  tag stig_id: 'CSCO-NC-000070'
  tag gtitle: 'SRG-NET-000015-NAC-000040'
  tag fix_id: 'F-45813r714052_fix'
  tag 'documentable'
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
end
