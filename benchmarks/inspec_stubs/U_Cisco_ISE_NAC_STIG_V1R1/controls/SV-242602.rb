control 'SV-242602' do
  title 'The Cisco ISE must be configured to dynamically apply restricted access of endpoints that are granted access using MAC Authentication Bypass (MAB).'
...
NPE devices that can support PKI or an allowed authentication type must use PKI. MAB may be used for NPE that cannot support an approved device authentication. Non-entity endpoints include IoT devices, VOIP phone, and printer.'
  desc 'check', 'Verify that the authorization policies for devices granted access via MAB will have restricted access. 
...
6. Choose "Save".'
  ...
  tag check_id: 'C-45877r714114_chk'
  tag severity: 'medium'
  tag gid: 'V-242602'
  tag rid: 'SV-242602r714116_rule'
