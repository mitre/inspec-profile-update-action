...
For detailed information on categorizing information, refer to FIPS Publication 199, Standards for Security Categorization of Federal Information and Information Systems, and FIPS Publication 200, Minimum Security Requirements for Federal Information and Information Systems.'
  desc 'check', %q(Review the system documentation to determine if SQL Server is required to audit when data classifications are unsuccessfully retrieved. 
...
If the "SCHEMA_OBJECT_ACCESS_GROUP" is not returned in an active audit, this is a finding.)
  desc 'fix', 'Deploy an audit to audit when data classifications are unsuccessfully retrieved. See the supplemental file "SQL 2016 Audit.sql".'
  impact 0.5
  ref 'DPMS Target MS SQL Server 2016 Instance'
  tag check_id: 'C-15215r313777_chk'
  tag severity: 'medium'
  tag gid: 'V-213998'
  tag rid: 'SV-213998r754643_rule'
  tag stig_id: 'SQL6-D0-013200'
  tag gtitle: 'SRG-APP-000494-DB-000345'
  tag fix_id: 'F-15213r313778_fix'
  tag 'documentable'
