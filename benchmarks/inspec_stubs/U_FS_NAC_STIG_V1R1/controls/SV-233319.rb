control 'SV-233319' do
  title 'Forescout must be configured so client machines do not communicate with other network devices in the DMZ or subnet except as needed to perform a client assessment or to identify itself.'
...
Verify that Forescout  is not allowed to communicate with other hosts in the DMZ that do not perform security policy assessment or remediation services.'
  desc 'check', '1. Select Tools >> Options >> Appliance >> IP Assignment.
...
3. Select Segment >> IP Addresses. Find the IP address for the DMZ subnet and delete it.'
  ...
  tag check_id: 'C-36514r605660_chk'
  tag severity: 'medium'
  tag gid: 'V-233319'
  tag rid: 'SV-233319r611394_rule'
