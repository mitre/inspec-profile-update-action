control 'SV-233331' do
  title 'For TLS connections, Forescout must automatically terminate the session when a client certificate is requested and the client does not have a suitable certificate.'
...
5. In the Client-Server Connection, ensure the Minimum Supported TLS Version is set to TLS version 1.2.)
  ...
  tag check_id: 'C-36526r605696_chk'
  tag severity: 'medium'
  tag gid: 'V-233331'
  tag rid: 'SV-233331r611394_rule'
  tag stig_id: 'FORE-NC-000260'
  tag gtitle: 'SRG-NET-000517-NAC-002370'
  tag fix_id: 'F-36491r605697_fix'
  tag 'documentable'
  tag cci: ['CCI-002361']
  tag nist: ['AC-12']
end
