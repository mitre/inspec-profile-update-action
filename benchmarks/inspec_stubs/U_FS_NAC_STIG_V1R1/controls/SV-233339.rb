control 'SV-233339' do
  title 'Forescout must use a bidirectional authentication mechanism configured with a FIPS-validated Advanced Encryption Standard (AES) cipher block algorithm to authenticate with the endpoint device.'
...
Note: Use of FIPS mode is not mandatory in DoD. However, it is the primary method for mitigation of this requirement and ensuring FIPS compliance.'
  ...
  tag check_id: 'C-36534r605720_chk'
  tag severity: 'medium'
  tag gid: 'V-233339'
  tag rid: 'SV-233339r611394_rule'
  tag stig_id: 'FORE-NC-000460'
  tag gtitle: 'SRG-NET-000151-NAC-000630'
  tag fix_id: 'F-36499r605721_fix'
  tag 'documentable'
  tag cci: ['CCI-001967']
  tag nist: ['IA-3 (1)']
end
