control 'SV-233329' do
  title 'Forescout must configure TCP for the syslog protocol to allow for detection by the central event server if communications is lost.'
...
5. Click "Apply".'
  ...
  tag check_id: 'C-36524r615866_chk'
  tag severity: 'medium'
  tag gid: 'V-233329'
  tag rid: 'SV-233329r615867_rule'
