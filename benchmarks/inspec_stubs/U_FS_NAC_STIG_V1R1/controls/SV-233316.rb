control 'SV-233316' do
  title 'Forescout must send an alert to the Information System Security Manager (ISSM) and System Administrator (SA), at a minimum, when critical security issues are found that put the network at risk.'
  ...
  desc 'check', 'Verify Forescout performs device authentication before policy assessment is performed.
...
2. Ensure the Authentication & Authorization policy happens prior to any NAC check.'
  ...
  tag check_id: 'C-36511r605651_chk'
  tag severity: 'medium'
  tag gid: 'V-233316'
  tag rid: 'SV-233316r611394_rule'
