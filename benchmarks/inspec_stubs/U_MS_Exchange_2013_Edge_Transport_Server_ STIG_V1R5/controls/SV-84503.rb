control 'SV-84503' do
  title 'Exchange messages with malformed From address must be rejected.'
...
Set-SenderIdConfig -SpoofedDomainAction Reject'
  ...
  tag check_id: 'C-70349r2_chk'
  tag severity: 'medium'
  tag gid: 'V-69881'
  tag rid: 'SV-84503r1_rule'
  tag stig_id: 'EX13-EG-000215'
  tag gtitle: 'SRG-APP-000261'
  tag fix_id: 'F-76111r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001308']
  tag nist: ['SI-8 (2)']
end
