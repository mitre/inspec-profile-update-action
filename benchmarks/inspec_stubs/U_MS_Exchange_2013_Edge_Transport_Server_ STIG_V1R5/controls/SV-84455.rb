...
Note: Both the <NewName> and <IdentityName>values must be in quotes.

Repeat the procedure for each Send connector."
  impact 0.3
  ref 'DPMS Target Microsoft Exchange 2013 Edge Transport Server'
  tag check_id: 'C-70303r1_chk'
  tag severity: 'low'
  tag gid: 'V-69833'
  tag rid: 'SV-84455r1_rule'
  tag stig_id: 'EX13-EG-000130'
  tag gtitle: 'SRG-APP-000247'
  tag fix_id: 'F-76063r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001095']
  tag nist: ['SC-5 (2)']
end
