...
Note: The units are in seconds.'
  ...
  tag check_id: 'C-58347r862405_chk'
  tag severity: 'medium'
  tag gid: 'V-254736'
  tag rid: 'SV-254736r862407_rule'
  tag stig_id: 'GOOG-13-006200'
  tag gtitle: 'PP-MDF-323026'
  tag fix_id: 'F-58293r862406_fix'
  tag 'documentable'
  tag cci: ['CCI-000057']
  tag nist: ['AC-11 a']
end
