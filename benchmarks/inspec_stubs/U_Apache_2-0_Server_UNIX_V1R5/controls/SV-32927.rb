...
If the site does not have a process in place to monitor changes to CGI program files, this is a finding.'
  ...
  tag ia_controls: 'ECAT-1, ECAT-2, ECCD-1'
end
