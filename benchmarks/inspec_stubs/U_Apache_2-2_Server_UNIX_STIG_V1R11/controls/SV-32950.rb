...
Confirm that the additional service or application is not installed on the same partition as the operating systems root directory or the web document root. If it is, this is a finding.'
  desc 'fix', 'Move or install additional services and applications to partitions that are not the operating system root or the web document root.'
  impact 0.5
  ref 'DPMS Target Apache Instance 2.x'
  tag check_id: 'C-33633r1_chk'
  tag severity: 'medium'
  tag gid: 'V-6577'
