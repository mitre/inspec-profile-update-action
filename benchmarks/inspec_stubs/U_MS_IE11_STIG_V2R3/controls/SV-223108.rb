control 'SV-223108' do
  ...
  tag check_id: 'C-24781r428874_chk'
  tag severity: 'medium'
  tag gid: 'V-223108'
  tag rid: 'SV-223108r428876_rule'
  tag stig_id: 'DTBI600-IE11'
  tag gtitle: 'SRG-APP-000141'
  tag fix_id: 'F-24769r428875_fix'
  tag 'documentable'
  tag legacy: ['SV-59587', 'V-46723']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
