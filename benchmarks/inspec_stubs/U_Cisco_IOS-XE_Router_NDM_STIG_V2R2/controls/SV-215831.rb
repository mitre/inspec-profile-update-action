control 'SV-215831' do
  title 'The Cisco router must be configured to require that when a password is changed, the characters are changed in at least eight of the positions within the password.'
...
If the Cisco router is not configured to require that when a password is changed, the characters are changed in at least eight of the positions within the password, this is a finding.'
  desc 'fix', 'Configure the Cisco router to enforce password complexity by requiring that when a password is changed, the characters are changed in at least eight of the positions within the password as shown in the example below.
...
R1(config-cc-policy)#exit'
  ...
  tag check_id: 'C-17070r287532_chk'
  tag severity: 'medium'
  tag gid: 'V-215831'
  tag rid: 'SV-215831r531083_rule'
  tag stig_id: 'CISC-ND-000610'
  tag gtitle: 'SRG-APP-000170-NDM-000329'
  tag fix_id: 'F-17068r287533_fix'
  tag 'documentable'
  tag legacy: ['SV-105401', 'V-96263']
  tag cci: ['CCI-000195']
  tag nist: ['IA-5 (1) (b)']
end
