control 'SV-33418' do
  ...
  desc 'check', 'The policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2010 (Machine) -> Security Settings -> IE Security “Saved from URL” must be “Enabled” and a check in the ‘winword.exe’ check box must be present.
...
Criteria: If the value winword.exe is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy value for Computer Configuration -> Administrative Templates -> Microsoft Office 2010 (Machine) -> Security Settings -> IE Security “Saved from URL” to “Enabled” and place a check in the ‘winword.exe’ check box.'
  impact 0.5
  ref 'DPMS Target Microsoft Word 2010'
  tag check_id: 'C-33901r1_chk'
  tag severity: 'medium'
  tag gid: 'V-17175'
  tag rid: 'SV-33418r1_rule'
  tag stig_id: 'DTOO117 - Word'
  tag gtitle: 'DTOO117 - Saved from URL'
  tag fix_id: 'F-29590r1_fix'
  tag 'documentable'
