...
3. Enter in the number of characters as "6".'
  ...
  tag check_id: 'C-30511r494901_chk'
  tag severity: 'medium'
  tag gid: 'V-228278'
  tag rid: 'SV-228278r494903_rule'
  tag stig_id: 'GOOG-09-000100'
  tag gtitle: 'PP-MDF-301010'
  tag fix_id: 'F-30496r494902_fix'
  tag 'documentable'
  tag legacy: ['SV-106409', 'V-97305']
  tag cci: ['CCI-000205']
  tag nist: ['IA-5 (1) (a)']
end
