...
4. Set Disallow "Install unknown sources".'
  ...
  tag check_id: 'C-30516r494916_chk'
  tag severity: 'medium'
  tag gid: 'V-228283'
  tag rid: 'SV-228283r852692_rule'
  tag stig_id: 'GOOG-09-000800'
  tag gtitle: 'PP-MDF-301080'
  tag fix_id: 'F-30501r494917_fix'
  tag 'documentable'
  tag legacy: ['SV-106419', 'V-97315']
