...
Enable "Lock Screen Message" and enter the banner text.'
  ...
  tag check_id: 'C-30523r494937_chk'
  tag severity: 'low'
  tag gid: 'V-228290'
  tag rid: 'SV-228290r494939_rule'
  tag stig_id: 'GOOG-09-003400'
  tag gtitle: 'PP-MDF-301200'
  tag fix_id: 'F-30508r494938_fix'
  tag 'documentable'
  tag legacy: ['SV-106433', 'V-97329']
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
