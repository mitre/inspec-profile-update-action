...
3. Set "Maximum Number of Failed Attempts" to a number between 1 and 10.'
  ...
  tag check_id: 'C-30515r494913_chk'
  tag severity: 'low'
  tag gid: 'V-228282'
  tag rid: 'SV-228282r494915_rule'
  tag stig_id: 'GOOG-09-000500'
  tag gtitle: 'PP-MDF-301050'
  tag fix_id: 'F-30500r494914_fix'
  tag 'documentable'
  tag legacy: ['SV-106417', 'V-97313']
  tag cci: ['CCI-000044']
  tag nist: ['AC-7 a']
end
