...
If there are no entries for the DoD Root CA 2, DoD Root CA 3, DoD Root CA 4, and DoD Root CA 5, this is a finding.
...
On Windows, import certificates from the operating system by using Certificates >> Import Enterprise Roots (Certificates) via policy or Group Policy Object (GPO).'
  ...
  tag check_id: 'C-54995r820753_chk'
  tag severity: 'medium'
  tag gid: 'V-251560'
  tag rid: 'SV-251560r820754_rule'
  tag stig_id: 'FFOX-00-000016'
  tag gtitle: 'SRG-APP-000175'
  tag fix_id: 'F-54949r807151_fix'
  tag 'documentable'
  tag cci: ['CCI-000185']
  tag nist: ['IA-5 (2) (b) (1)']
end
