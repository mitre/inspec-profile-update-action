...
The session lock is implemented at the point where session activity can be determined and/or controlled."
  desc 'check', 'Verify the operating system initiates a screensaver after a 15-minute period of inactivity for graphical user interfaces. The screen program must be installed to lock sessions on the console.
...
Users must log out and then log in again before the system-wide settings take effect.'
  ...
  tag check_id: 'C-23375r419052_chk'
  tag severity: 'medium'
  tag gid: 'V-221660'
  tag rid: 'SV-221660r603260_rule'
  tag stig_id: 'OL07-00-010070'
  tag gtitle: 'SRG-OS-000029-GPOS-00010'
  tag fix_id: 'F-23364r419053_fix'
  tag 'documentable'
