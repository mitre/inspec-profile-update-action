...
minlen = 15'
  ...
  tag check_id: 'C-23401r419130_chk'
  tag severity: 'medium'
  tag gid: 'V-221686'
  tag rid: 'SV-221686r603260_rule'
  tag stig_id: 'OL07-00-010280'
  tag gtitle: 'SRG-OS-000078-GPOS-00046'
  tag fix_id: 'F-23390r419131_fix'
  tag 'documentable'
  tag legacy: ['SV-108215', 'V-99111']
  tag cci: ['CCI-000205']
  tag nist: ['IA-5 (1) (a)']
end
