control 'SV-254522' do
  title 'Oracle Linux operating system emergency accounts must be automatically removed or disabled after the crisis is resolved or within 72 hours.'
...
The automatic expiration or disabling time period may be extended as needed until the crisis is resolved.'
  ...
  tag check_id: 'C-58006r858473_chk'
  tag severity: 'medium'
  tag gid: 'V-254522'
  tag rid: 'SV-254522r858475_rule'
  tag stig_id: 'OL07-00-010271'
  tag gtitle: 'SRG-OS-000123-GPOS-00064'
  tag fix_id: 'F-57955r858474_fix'
  tag 'documentable'
  tag cci: ['CCI-001682']
  tag nist: ['AC-2 (2)']
end
