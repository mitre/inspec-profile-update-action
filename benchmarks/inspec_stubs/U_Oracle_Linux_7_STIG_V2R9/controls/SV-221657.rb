...
'
  desc 'check', %q(Verify the operating system enables a user's session lock until that user re-establishes access using established identification and authentication procedures. The screen program must be installed to lock sessions on the console.
...
Users must log out and then log in again before the system-wide settings take effect.)
  ...
  tag check_id: 'C-23372r419043_chk'
  tag severity: 'medium'
  tag gid: 'V-221657'
  tag rid: 'SV-221657r603260_rule'
  tag stig_id: 'OL07-00-010060'
  tag gtitle: 'SRG-OS-000028-GPOS-00009'
  tag fix_id: 'F-23361r419044_fix'
