...
If the returned line does not have a value of "0", this is a finding.)
  desc 'fix', 'Configure the system not to allow interfaces to perform IPv4 ICMP redirects. 
...
# sysctl --system'
  ...
  tag check_id: 'C-23596r419715_chk'
  tag severity: 'medium'
  tag gid: 'V-221881'
  tag rid: 'SV-221881r603260_rule'
  tag stig_id: 'OL07-00-040660'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-23585r419716_fix'
  tag 'documentable'
  tag legacy: ['V-99501', 'SV-108605']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
