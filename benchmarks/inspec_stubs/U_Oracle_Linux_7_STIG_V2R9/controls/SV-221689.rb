...
If "INACTIVE" is set to "-1", a value greater than "35", is commented out, or is not defined, this is a finding.'
  desc 'fix', 'Configure the operating system to disable account identifiers (individuals, groups, roles, and devices) 35 days after the password expires.
...
DoD recommendation is 35 days, but a lower value is acceptable. The value "-1" will disable this feature, and "0" will disable the account immediately after the password expires.'
  ...
  tag check_id: 'C-23404r809142_chk'
  tag severity: 'medium'
  tag gid: 'V-221689'
  tag rid: 'SV-221689r809144_rule'
  tag stig_id: 'OL07-00-010310'
  tag gtitle: 'SRG-OS-000118-GPOS-00060'
  tag fix_id: 'F-23393r809143_fix'
  tag 'documentable'
