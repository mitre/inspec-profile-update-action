control 'SV-221842' do
  title 'The Oracle Linux operating system must display the Standard Mandatory DoD Notice and Consent Banner immediately prior to, or as part of, remote access logon prompts.'
...
The SSH service must be restarted for changes to take effect.'
  ...
  tag check_id: 'C-36323r602563_chk'
  tag severity: 'medium'
  tag gid: 'V-221842'
  tag rid: 'SV-221842r603260_rule'
  tag stig_id: 'OL07-00-040170'
  tag gtitle: 'SRG-OS-000023-GPOS-00006'
  tag fix_id: 'F-36287r602564_fix'
  tag satisfies: ['SRG-OS-000023-GPOS-00006', 'SRG-OS-000024-GPOS-00007', 'SRG-OS-000228-GPOS-00088']
  tag 'documentable'
  tag legacy: ['V-99423', 'SV-108527']
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
