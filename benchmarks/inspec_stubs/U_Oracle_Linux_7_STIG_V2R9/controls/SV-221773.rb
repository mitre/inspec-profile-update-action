...
network_failure_action = syslog'
  ...
  tag check_id: 'C-36292r602470_chk'
  tag severity: 'medium'
  tag gid: 'V-221773'
  tag rid: 'SV-221773r853687_rule'
  tag stig_id: 'OL07-00-030321'
  tag gtitle: 'SRG-OS-000342-GPOS-00133'
  tag fix_id: 'F-36256r602471_fix'
  tag 'documentable'
  tag legacy: ['SV-108389', 'V-99285']
  tag cci: ['CCI-001851']
  tag nist: ['AU-4 (1)']
end
