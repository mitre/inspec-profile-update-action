control 'SV-221898' do
  title 'The Oracle Linux operating system must be configured so that all wireless network adapters are disabled.'
...
#nmcli radio wifi off'
  ...
  tag check_id: 'C-23613r419766_chk'
  tag severity: 'medium'
  tag gid: 'V-221898'
  tag rid: 'SV-221898r853729_rule'
  tag stig_id: 'OL07-00-041010'
  tag gtitle: 'SRG-OS-000424-GPOS-00188'
  tag fix_id: 'F-23602r419767_fix'
  tag 'documentable'
  tag legacy: ['SV-108639', 'V-99535']
  tag cci: ['CCI-002421']
  tag nist: ['SC-8 (1)']
end
