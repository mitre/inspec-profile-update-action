...
'
  desc 'check', %q(Verify the operating system generates audit records upon successful/unsuccessful attempts to use the "creat", "open", "openat", "open_by_handle_at", "truncate", and "ftruncate" syscalls.
...
If the output does not produce rules containing "-F exit=-EACCES", this is a finding.)
  desc 'fix', 'Configure the operating system to generate audit records upon successful/unsuccessful attempts to use the "creat", "open", "openat", "open_by_handle_at", "truncate", and "ftruncate" syscalls.
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-36309r853692_chk'
  tag severity: 'medium'
  tag gid: 'V-221792'
  tag rid: 'SV-221792r853694_rule'
  tag stig_id: 'OL07-00-030510'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-36273r853693_fix'
  tag satisfies: ['SRG-OS-000064-GPOS-00033', 'SRG-OS-000458-GPOS-00203', 'SRG-OS-000461-GPOS-00205', 'SRG-OS-000392-GPOS-00172']
  tag 'documentable'
  tag legacy: ['V-99323', 'SV-108427']
