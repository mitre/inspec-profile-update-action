control 'SV-221758' do
  ...
  desc 'Use of weak or untested encryption algorithms undermines the purposes of using encryption to protect data. The operating system must implement cryptographic modules that adhere to the higher standards approved by the federal government to ensure they have been tested and validated.
...
Reboot the system for the changes to take effect.'
  ...
  tag check_id: 'C-36284r602446_chk'
  tag severity: 'high'
  tag gid: 'V-221758'
  tag rid: 'SV-221758r860863_rule'
  tag stig_id: 'OL07-00-021350'
  tag gtitle: 'SRG-OS-000033-GPOS-00014'
  tag fix_id: 'F-36248r602447_fix'
