...
# service auditd restart'
  ...
  tag check_id: 'C-36289r602461_chk'
  tag severity: 'medium'
  tag gid: 'V-221768'
  tag rid: 'SV-221768r853682_rule'
  tag stig_id: 'OL07-00-030210'
  tag gtitle: 'SRG-OS-000342-GPOS-00133'
  tag fix_id: 'F-36253r602462_fix'
  tag satisfies: ['SRG-OS-000342-GPOS-00133', 'SRG-OS-000479-GPOS-00224']
  tag 'documentable'
  tag legacy: ['SV-108379', 'V-99275']
  tag cci: ['CCI-001851']
  tag nist: ['AU-4 (1)']
end
