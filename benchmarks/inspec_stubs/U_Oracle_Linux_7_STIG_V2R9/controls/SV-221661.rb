...
/org/gnome/desktop/screensaver/lock-delay'
  ...
  tag check_id: 'C-23376r419055_chk'
  tag severity: 'medium'
  tag gid: 'V-221661'
  tag rid: 'SV-221661r603260_rule'
  tag stig_id: 'OL07-00-010081'
  tag gtitle: 'SRG-OS-000029-GPOS-00010'
  tag fix_id: 'F-23365r419056_fix'
  tag 'documentable'
  tag legacy: ['V-99063', 'SV-108167']
  tag cci: ['CCI-000057']
  tag nist: ['AC-11 a']
end
