...
- level: RequestResponse'
  ...
  tag check_id: 'C-45678r863807_chk'
  tag severity: 'medium'
  tag gid: 'V-242403'
  tag rid: 'SV-242403r879525_rule'
  ...
  tag nist: ['AC-2 (4)', 'AU-3 a', 'AU-3 b', 'AU-3 c', 'AU-3 d', 'AU-3 e', 'AU-3 (1)', 'AU-12 c', 'AC-2 (4)', 'AC-2 (4)', 'AU-3 f', 'AU-3 (2)', 'AC-16 a']
end
