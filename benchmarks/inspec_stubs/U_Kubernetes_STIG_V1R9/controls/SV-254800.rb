...
If least privilege is not represented, this is a finding.'
  desc 'fix', %q(Modify the file /etc/kubernetes/manifests/kube-apiserver.yaml and add the flag --admission-control-config-file (with a valid path for the file) to the apiserver configuration.
...
Best Practice: https://kubernetes.io/docs/concepts/security/pod-security-policy/#recommended-practice)
  ...
  tag check_id: 'C-58411r863727_chk'
  tag severity: 'high'
  tag gid: 'V-254800'
  tag rid: 'SV-254800r879719_rule'
