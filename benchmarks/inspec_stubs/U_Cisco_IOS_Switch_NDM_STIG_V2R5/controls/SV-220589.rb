...
The shorter the password, the lower the number of possible combinations that need to be tested before the password is compromised. Use of more characters in a password helps to exponentially increase the time and/or resources required to compromise the password.'
  desc 'check', 'Review the Cisco switch configuration to verify that it enforces a minimum 15-character password length as shown in the example below:
...
SW1(config-cc-policy)#exit'
  ...
  tag check_id: 'C-22304r507813_chk'
  tag severity: 'medium'
  tag gid: 'V-220589'
  tag rid: 'SV-220589r879601_rule'
  tag stig_id: 'CISC-ND-000550'
  tag gtitle: 'SRG-APP-000164-NDM-000252'
  tag fix_id: 'F-22293r507814_fix'
  tag 'documentable'
  tag legacy: ['SV-110407', 'V-101303']
  tag cci: ['CCI-000205']
  tag nist: ['IA-5 (1) (a)']
end
