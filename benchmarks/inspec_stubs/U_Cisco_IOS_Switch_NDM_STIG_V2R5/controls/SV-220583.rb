...
Network devices providing a user interface to audit data will leverage user permissions and roles identifying the user accessing the data and the corresponding user rights to make access decisions regarding the modification of audit data.'
  desc 'check', 'Review the Cisco switch configuration to verify that it is configured to protect audit information.
...
SW4(config)#file privilege 15'
  ...
  tag check_id: 'C-22298r507795_chk'
  tag severity: 'medium'
  tag gid: 'V-220583'
  tag rid: 'SV-220583r879577_rule'
  tag stig_id: 'CISC-ND-000380'
  tag gtitle: 'SRG-APP-000119-NDM-000236'
  tag fix_id: 'F-22287r507796_fix'
  tag 'documentable'
  tag legacy: ['SV-110395', 'V-101291']
  tag cci: ['CCI-000163']
  tag nist: ['AU-9 a']
end
