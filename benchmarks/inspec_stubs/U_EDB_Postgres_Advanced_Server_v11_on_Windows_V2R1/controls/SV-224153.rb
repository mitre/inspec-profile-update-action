...
If other permissions have been granted to other users or groups, ensure that the system documentation is updated to note the organizationally approved permission setting and corresponding justification of the permission settings for this requirement.)
  ...
  tag check_id: 'C-25826r495479_chk'
  tag severity: 'medium'
  tag gid: 'V-224153'
  tag rid: 'SV-224153r508023_rule'
  tag stig_id: 'EP11-00-003100'
  tag gtitle: 'SRG-APP-000123-DB-000204'
  tag fix_id: 'F-25814r495480_fix'
  tag 'documentable'
  tag legacy: ['SV-109437', 'V-100333']
  tag cci: ['CCI-001495']
  tag nist: ['AU-9']
end
