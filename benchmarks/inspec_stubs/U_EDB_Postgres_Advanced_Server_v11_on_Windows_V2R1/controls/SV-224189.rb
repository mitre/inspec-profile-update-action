...
If security labeling requirements have been specified, but neither a third-party solution nor an EDB Postgres Advanced Server Row-Level security solution is implemented that reliably maintains labels on information in process, this is a finding."
  desc 'fix', 'Deploy EDB Postgres Advanced Server Row-Level Security (see link below) or a third-party software, or add custom data structures, data elements and application code, to provide reliable security labeling of information in process.
...
https://www.enterprisedb.com/docs/en/11.0/EPAS_BIP_Guide_v11/Database_Compatibility_for_Oracle_Developers_Built-in_Package_Guide.1.31.html#pID0E0UUD0HA'
  ...
  tag check_id: 'C-25862r495585_chk'
  tag severity: 'medium'
  tag gid: 'V-224189'
  tag rid: 'SV-224189r508023_rule'
  tag stig_id: 'EP11-00-007000'
  tag gtitle: 'SRG-APP-000313-DB-000309'
  tag fix_id: 'F-25850r495586_fix'
  tag 'documentable'
  tag legacy: ['SV-109505', 'V-100401']
  tag cci: ['CCI-002263']
  tag nist: ['AC-16 a']
end
