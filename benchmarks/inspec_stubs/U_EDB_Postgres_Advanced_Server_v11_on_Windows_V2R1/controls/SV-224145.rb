...
EXECUTE PROCEDURE add_audit_info();"
  ...
  tag check_id: 'C-25818r495455_chk'
  tag severity: 'medium'
  tag gid: 'V-224145'
  tag rid: 'SV-224145r508023_rule'
  tag stig_id: 'EP11-00-002200'
  tag gtitle: 'SRG-APP-000101-DB-000044'
  tag fix_id: 'F-25806r495456_fix'
  tag 'documentable'
  tag legacy: ['V-100317', 'SV-109421']
  tag cci: ['CCI-000135']
  tag nist: ['AU-3 (1)']
end
