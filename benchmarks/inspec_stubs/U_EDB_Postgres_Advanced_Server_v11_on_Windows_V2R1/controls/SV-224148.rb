...
If any permissions are listed for any account other than the database service account not identified in the system documentation as being approved for the permission, this is a finding.'
...
If other permissions have been granted to other users or groups, ensure that the system documentation is updated to note the organizationally approved permission setting and corresponding justification of the permission settings for this requirement.)
  ...
  tag check_id: 'C-25821r495464_chk'
  tag severity: 'medium'
  tag gid: 'V-224148'
  tag rid: 'SV-224148r508023_rule'
  tag stig_id: 'EP11-00-002600'
  tag gtitle: 'SRG-APP-000118-DB-000059'
  tag fix_id: 'F-25809r495465_fix'
  tag 'documentable'
  tag legacy: ['SV-109427', 'V-100323']
  tag cci: ['CCI-000162']
  tag nist: ['AU-9 a']
end
