...
https://www.postgresql.org/docs/current/auth-pg-hba-conf.html'
  ...
  tag check_id: 'C-25882r557406_chk'
  tag severity: 'medium'
  tag gid: 'V-224209'
  tag rid: 'SV-224209r557408_rule'
  tag stig_id: 'EP11-00-009600'
  tag gtitle: 'SRG-APP-000442-DB-000379'
  tag fix_id: 'F-25870r557407_fix'
  tag 'documentable'
  tag legacy: ['V-100439', 'SV-109543']
  tag cci: ['CCI-002422']
  tag nist: ['SC-8 (2)']
end
