control 'SV-224190' do
  title 'The EDB Postgres Advanced Server must associate organization-defined types of security labels having organization-defined security label values with information in transmission.'
...
If security labeling requirements have been specified, but neither a third-party solution nor an EDB Postgres Advanced Server Row-Level security solution is implemented that reliably maintains labels on information in transmission, this is a finding."
  desc 'fix', 'Deploy EDB Postgres Advanced Server Row-Level Security (see link below) or a third-party software, or add custom data structures, data elements and application code, to provide reliable security labeling of information in transmission.
...
https://www.enterprisedb.com/docs/en/11.0/EPAS_BIP_Guide_v11/Database_Compatibility_for_Oracle_Developers_Built-in_Package_Guide.1.31.html#pID0E0UUD0HA'
  ...
  tag check_id: 'C-25863r495588_chk'
  tag severity: 'medium'
  tag gid: 'V-224190'
  tag rid: 'SV-224190r508023_rule'
  tag stig_id: 'EP11-00-007100'
  tag gtitle: 'SRG-APP-000314-DB-000310'
  tag fix_id: 'F-25851r495589_fix'
  tag 'documentable'
  tag legacy: ['SV-109507', 'V-100403']
  tag cci: ['CCI-002264']
  tag nist: ['AC-16 a']
end
