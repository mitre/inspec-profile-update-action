...
If other permissions have been granted to other users or groups, ensure the system documentation is updated to note the organizationally approved permission setting and corresponding justification of the permission settings for this requirement.)
  ...
  tag check_id: 'C-25822r495467_chk'
  tag severity: 'medium'
  tag gid: 'V-224149'
  tag rid: 'SV-224149r508023_rule'
  tag stig_id: 'EP11-00-002700'
  tag gtitle: 'SRG-APP-000119-DB-000060'
  tag fix_id: 'F-25810r495468_fix'
  tag 'documentable'
  tag legacy: ['SV-109429', 'V-100325']
  tag cci: ['CCI-000163']
  tag nist: ['AU-9 a']
end
