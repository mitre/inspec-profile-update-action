...
If the organization's Combatant Command, Service or Agency (CC/S/A) has issued guidelines for control of sensitive items, then compliance with this rule will be considered validated if following the issued guidelines."
  ...
  tag check_id: 'C-49300r770352_chk'
  tag severity: 'medium'
  tag gid: 'V-245869'
  tag rid: 'SV-245869r770353_rule'
  tag stig_id: 'PH-07.02.01'
  tag gtitle: 'PH-07.02.01'
  tag fix_id: 'F-49255r770268_fix'
  tag satisfies: ['Sensitive Item Control - Keys', 'Locks and Access Cards']
  tag 'documentable'
  tag legacy: ['V-32603', 'SV-42940r3_rule']
end
