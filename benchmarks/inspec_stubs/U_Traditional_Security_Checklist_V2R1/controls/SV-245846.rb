...
See ASD(NII) Memorandum, Encryption of Sensitive Unclassified Data at Rest on Mobile Computing Devices and Removable Storage Media, 3 Jul 07 for detailed guidance.'
  ...
  tag check_id: 'C-49277r770198_chk'
  tag severity: 'medium'
  tag gid: 'V-245846'
  tag rid: 'SV-245846r770200_rule'
  tag stig_id: 'IS-16.02.04'
  tag gtitle: 'IS-16.02.04'
  tag fix_id: 'F-49232r770199_fix'
  tag 'documentable'
  tag legacy: ['V-32263', 'SV-42580r3_rule']
end
