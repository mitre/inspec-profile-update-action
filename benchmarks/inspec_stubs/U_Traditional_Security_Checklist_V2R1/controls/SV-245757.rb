...
TACTICAL ENVIRONMENT: This check is applicable where LN/FN are employed in a tactical environment with access to US or Coalition Forces Systems.'
  ...
  tag check_id: 'C-49188r769931_chk'
  tag severity: 'medium'
  tag gid: 'V-245757'
  tag rid: 'SV-245757r769933_rule'
  tag stig_id: 'FN-01.02.01'
  tag gtitle: 'FN-01.02.01'
  tag fix_id: 'F-49143r769932_fix'
  tag 'documentable'
  tag legacy: ['V-31210', 'SV-41407r3_rule']
end
