...
TACTICAL ENVIRONMENT APPLICABILITY: Apply to fixed tactical environments where IDS is installed to protect SIPRNet and other DoDIN (AKA: DISN) connected assets.'
  ...
  tag check_id: 'C-49293r770246_chk'
  tag severity: 'medium'
  tag gid: 'V-245862'
  tag rid: 'SV-245862r770248_rule'
  tag stig_id: 'PE-08.02.02'
  tag gtitle: 'PE-08.02.02'
  tag fix_id: 'F-49248r770247_fix'
  tag 'documentable'
  tag legacy: ['V-32477', 'SV-42814r3_rule']
end
