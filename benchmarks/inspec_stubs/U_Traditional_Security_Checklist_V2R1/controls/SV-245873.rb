control 'SV-245873' do
  title 'Counter-Intelligence Program - Training, Procedures and  Incident Reporting'
  desc 'Failure to establish a good working relationship with the supporting/local CI agency and lack of proper CI training for site/organization employees could result in not being informed of local threats and warnings leaving the organization vulnerable to the threat and/or a delay in reporting a possible incident involving  reportable FIE-Associated Cyberspace Contacts, Activities, Indicators, and Behaviors, which could adversely impact the Confidentiality, Integrity, or Availability (CIA) of the DISN.

REFERENCES:

DoDD 5240.06, Counterintelligence Awareness and Reporting (CIAR), 17 May 11, Incorporating Change 2, July 21, 2017 
Enclosure 3 and Enclosure 4. para 4.a.
...
Ensure all assigned site/organization personnel have received both initial and annual CIAR training in accordance with DoDD 5240.06.  Further, ensure there are procedures for reporting possible threat information and that local threat assessments and warnings received are properly shared with the work force.'
  ...
  tag check_id: 'C-49304r770279_chk'
  tag severity: 'low'
  tag gid: 'V-245873'
  tag rid: 'SV-245873r770281_rule'
  tag stig_id: 'SM-03.03.01'
  tag gtitle: 'SM-03.03.01'
  tag fix_id: 'F-49259r770280_fix'
  tag satisfies: ['Counter-Intelligence Program - Training', 'Procedures and  Incident Reporting']
  tag 'documentable'
  tag legacy: ['V-32607', 'SV-42944r3_rule']
end
