...
j. In-processing and vetting of employees for systems access (proper investigation and security clearance)'
  ...
  tag check_id: 'C-49202r769973_chk'
  tag severity: 'low'
  tag gid: 'V-245771'
  tag rid: 'SV-245771r769975_rule'
  tag stig_id: 'IA-01.03.01'
  tag gtitle: 'IA-01.03.01'
  tag fix_id: 'F-49157r769974_fix'
  tag 'documentable'
  tag legacy: ['V-30996', 'SV-41042r3_rule']
end
