...
CJCSI 6510.01F, INFORMATION ASSURANCE (IA) AND SUPPORT TO COMPUTER NETWORK DEFENSE (CND), Encl C, paragraphs 5, 6.f.(1), 9.b., 10., 27.a, 27.b., 27.c., 27.e. (8) and  27.f.

NIST Special Publication 800-53 (SP 800-53), Rev 4, Controls: 
AC-1, PL-1, PL-4, AT-1, AT-2, AT-3, PE-2(1), PE-2(3) and PE-3
...
DoD Manual 5200.01, Volume 1, SUBJECT: DoD Information Security Program: Overview, Classification, and Declassification, Encl 3,  para 5.b.

DoD Manual 5200.01, Volume 3, SUBJECT: DoD Information Security Program: Protection of Classified Information, Encl 3, para 5; Encl 4, para 2.c.; Appendix to Encl 4, para 1.f.; Encl 7
...
TACTICAL ENVIRONMENT: This check is applicable where REL partners/LN/FN are employed in a tactical environment with access to US Systems'
  desc 'fix', 'BACKGROUND: US employees must clearly understand the differences and limitations between REL Officers, other NATO partners, Non-NATO partners and Coalition Partners. 
...
3. Clear evidence employees are not familiar with the rules for information sharing.'
  ...
  tag check_id: 'C-49199r769964_chk'
  tag severity: 'medium'
  tag gid: 'V-245768'
  tag rid: 'SV-245768r769966_rule'
  tag stig_id: 'FN-05.02.01'
  tag gtitle: 'FN-05.02.01'
  tag fix_id: 'F-49154r769965_fix'
  tag 'documentable'
  tag legacy: ['V-31263', 'SV-41502r3_rule']
end
