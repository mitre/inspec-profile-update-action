...
NOTE 4: If keyed locks are used, ensure that proper key control procedures are in place.'
  ...
  tag check_id: 'C-49296r770255_chk'
  tag severity: 'medium'
  tag gid: 'V-245865'
  tag rid: 'SV-245865r770257_rule'
  tag stig_id: 'PH-03.02.01'
  tag gtitle: 'PH-03.02.01'
  tag fix_id: 'F-49251r770256_fix'
  tag 'documentable'
  tag legacy: ['V-32580', 'SV-42917r3_rule']
end
