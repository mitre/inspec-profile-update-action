...
2.  Electronic transmission of FOUO information, e.g., email, shall be by approved secure communications systems or systems utilizing other protective measures such as Public Key Infrastructure (PKI) or transport layer security (e.g., https). 
...
4.  Transmission of FOUO by facsimile machine (fax) is permitted; the sender is responsible for determining that appropriate protection will be available at the receiving location prior to transmission (e.g., machine attended by a person authorized to receive FOUO; fax located in a controlled government environment).'
  ...
  tag check_id: 'C-49278r770344_chk'
  tag severity: 'medium'
  tag gid: 'V-245847'
  tag rid: 'SV-245847r770346_rule'
  tag stig_id: 'IS-16.02.05'
  tag gtitle: 'IS-16.02.05'
  tag fix_id: 'F-49233r770345_fix'
  tag 'documentable'
  tag legacy: ['SV-42581r3_rule', 'V-32264']
end
