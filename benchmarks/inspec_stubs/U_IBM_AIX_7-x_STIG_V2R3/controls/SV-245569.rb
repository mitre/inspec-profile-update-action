control 'SV-245569' do
  title 'AIX cron and crontab directories must be group owned by cron.'
...
# chgrp cron /var/spool/cron/crontabs'
  ...
  tag check_id: 'C-48848r755146_chk'
  tag severity: 'medium'
  tag gid: 'V-245569'
  tag rid: 'SV-245569r755148_rule'
  tag stig_id: 'AIX7-00-002150'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-48803r755147_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
