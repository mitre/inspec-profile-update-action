control 'SV-245562' do
  title 'The AIX /etc/syslog.conf file must be group-owned by root.'
...
# chgrp root /etc/syslog.conf'
  ...
  tag check_id: 'C-48841r755125_chk'
  tag severity: 'medium'
  tag gid: 'V-245562'
  tag rid: 'SV-245562r755127_rule'
  tag stig_id: 'AIX7-00-002145'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-48796r755126_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
