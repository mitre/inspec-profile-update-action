...
'
  desc 'check', %q(Verify the SUSE operating system generates an audit record for all uses of the "creat", "open", "openat", "open_by_handle_at", "truncate", and "ftruncate" syscalls.
...
If the output does not produce rules containing "-F exit=-EACCES", this is a finding.)
  desc 'fix', 'Configure the SUSE operating system to generate an audit record for all uses of the "creat", "open", "openat", "open_by_handle_at", "truncate", and "ftruncate" syscalls. 
...
> sudo systemctl restart auditd.service'
  ...
  tag check_id: 'C-18458r861097_chk'
  tag severity: 'medium'
  tag gid: 'V-217230'
  tag rid: 'SV-217230r861099_rule'
  tag stig_id: 'SLES-12-020490'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-18456r861098_fix'
