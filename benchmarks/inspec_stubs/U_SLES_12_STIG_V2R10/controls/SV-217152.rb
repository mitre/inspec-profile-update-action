...
/usr/sbin/augenrules p+i+n+u+g+s+b+acl+selinux+xattrs+sha512'
  ...
  tag check_id: 'C-18380r369612_chk'
  tag severity: 'medium'
  tag gid: 'V-217152'
  tag rid: 'SV-217152r877393_rule'
  tag stig_id: 'SLES-12-010540'
  tag gtitle: 'SRG-OS-000278-GPOS-00108'
  tag fix_id: 'F-18378r369613_fix'
  tag 'documentable'
  tag legacy: ['V-77159', 'SV-91855']
  tag cci: ['CCI-001496']
  tag nist: ['AU-9 (3)']
end
