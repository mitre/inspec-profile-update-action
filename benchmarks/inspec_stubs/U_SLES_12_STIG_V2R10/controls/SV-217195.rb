...
> sudo newaliases)
  ...
  tag check_id: 'C-18423r646738_chk'
  tag severity: 'medium'
  tag gid: 'V-217195'
  tag rid: 'SV-217195r646740_rule'
  tag stig_id: 'SLES-12-020050'
  tag gtitle: 'SRG-OS-000046-GPOS-00022'
  tag fix_id: 'F-18421r646739_fix'
  tag 'documentable'
  tag legacy: ['SV-91993', 'V-77297']
  tag cci: ['CCI-000139']
  tag nist: ['AU-5 a']
end
