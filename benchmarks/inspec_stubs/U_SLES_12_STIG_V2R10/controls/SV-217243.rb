...
'
  desc 'check', 'Verify the SUSE operating system generates an audit record for all uses of the "chacl" command.
...
If the command does not return any output or the returned line is commented out, this is a finding.'
  desc 'fix', 'Configure the SUSE operating system to generate an audit record for all uses of the "chacl" command. 
...
# sudo systemctl restart auditd.service'
  ...
  tag check_id: 'C-18471r622391_chk'
  tag severity: 'medium'
  tag gid: 'V-217243'
  tag rid: 'SV-217243r854137_rule'
  tag stig_id: 'SLES-12-020620'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-18469r622392_fix'
