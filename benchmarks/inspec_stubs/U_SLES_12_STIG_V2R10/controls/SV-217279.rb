control 'SV-217279' do
  ...
  desc 'check', 'Note:  If the installed version of OpenSSH is 7.4 or above, this requirement is not applicable. 
...
Uncomment the "Compression" keyword in "/etc/ssh/sshd_config" on the system and set the value to "delayed" or "no":
  ...
  tag check_id: 'C-18507r880923_chk'
  tag severity: 'medium'
  tag gid: 'V-217279'
  tag rid: 'SV-217279r880925_rule'
  tag stig_id: 'SLES-12-030250'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-18505r880924_fix'
  tag 'documentable'
  tag legacy: ['SV-92167', 'V-77471']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
