...
'
  desc 'check', %q(Verify an audit record is generated for all uses of the "pam_timestamp_check" command.
...
# sudo systemctl restart auditd.service'
  ...
  tag check_id: 'C-18481r622415_chk'
  tag severity: 'medium'
  tag gid: 'V-217253'
  tag rid: 'SV-217253r854147_rule'
  tag stig_id: 'SLES-12-020720'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-18479r622416_fix'
