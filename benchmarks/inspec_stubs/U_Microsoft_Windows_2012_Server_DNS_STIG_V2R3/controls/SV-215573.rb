control 'SV-215573' do
  title 'The Windows 2012 DNS Server must prohibit recursion on authoritative name servers for which forwarders have not been configured for external queries.'
...
Select the "Disable recursion (also disables forwarders)" check box.'
  ...
  tag check_id: 'C-16767r572191_chk'
  tag severity: 'medium'
  tag gid: 'V-215573'
  tag rid: 'SV-215573r561297_rule'
  tag stig_id: 'WDNS-CM-000003'
  tag gtitle: 'SRG-APP-000383-DNS-000047'
  tag fix_id: 'F-16765r572192_fix'
  tag 'documentable'
  tag legacy: ['SV-73009', 'V-58579']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
