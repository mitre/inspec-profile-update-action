...
From the expanded list, right-click to select the zone (repeat for each hosted zone), point to DNSSEC, and then click Sign the Zone, either using approved saved parameters or approved custom parameters.'
  ...
  tag check_id: 'C-16819r314350_chk'
  tag severity: 'medium'
  tag gid: 'V-215625'
  tag rid: 'SV-215625r561297_rule'
  tag stig_id: 'WDNS-SC-000018'
  tag gtitle: 'SRG-APP-000426-DNS-000059'
  tag fix_id: 'F-16817r314351_fix'
  tag 'documentable'
  tag legacy: ['SV-73113', 'V-58683']
  tag cci: ['CCI-002468']
  tag nist: ['SC-21']
end
