...
DEFAULT DSNAME(SYS3.OMEGAMON.qualifier.RLSNAM) –
  ...
  tag check_id: 'C-26340r767051_chk'
  tag severity: 'medium'
  tag gid: 'V-224657'
  tag rid: 'SV-224657r767052_rule'
  tag stig_id: 'ZCLST042'
  tag gtitle: 'SRG-OS-000018'
  tag fix_id: 'F-26328r519789_fix'
  tag 'documentable'
  tag legacy: ['V-22690', 'SV-27258']
  tag cci: ['CCI-000035']
  tag nist: ['AC-4 (11)']
end
