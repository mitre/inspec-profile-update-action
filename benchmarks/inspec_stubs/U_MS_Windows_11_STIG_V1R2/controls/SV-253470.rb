control 'SV-253470' do
  title 'Windows 11 must use multifactor authentication for local and network access to privileged and non-privileged accounts.'
...
\\HKLM\\SOFTWARE\\Microsoft\\Cryptography\\Calais\\SmartCards'
  desc 'fix', 'For non-domain joined systems, configuring Windows Hello for sign on options would be suggested based on the organizations needs and capabilities.'
  impact 0.5
  ref 'DPMS Target Microsoft Windows 11'
  tag check_id: 'C-56923r829492_chk'
  tag severity: 'medium'
  tag gid: 'V-253470'
  tag rid: 'SV-253470r829494_rule'
  tag stig_id: 'WN11-SO-000251'
  tag gtitle: 'SRG-OS-000105-GPOS-00052'
  tag fix_id: 'F-56873r829493_fix'
