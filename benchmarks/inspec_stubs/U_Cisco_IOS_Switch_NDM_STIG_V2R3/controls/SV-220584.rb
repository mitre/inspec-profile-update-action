...
Network devices providing a user interface to audit data will leverage user permissions and roles identifying the user accessing the data and the corresponding user rights to make access decisions regarding the deletion of audit data.'
  desc 'check', 'Review the Cisco switch configuration to verify that it protects audit information from unauthorized deletion.
...
SW4(config)#file privilege 15'
  ...
  tag check_id: 'C-22299r507798_chk'
  tag severity: 'medium'
  tag gid: 'V-220584'
  tag rid: 'SV-220584r521267_rule'
  tag stig_id: 'CISC-ND-000390'
  tag gtitle: 'SRG-APP-000120-NDM-000237'
  tag fix_id: 'F-22288r507799_fix'
  tag 'documentable'
  tag legacy: ['SV-110397', 'V-101293']
  tag cci: ['CCI-000164']
  tag nist: ['AU-9 a']
end
