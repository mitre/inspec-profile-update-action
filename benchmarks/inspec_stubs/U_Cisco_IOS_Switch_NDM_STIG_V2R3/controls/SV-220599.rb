control 'SV-220599' do
  ...
  desc 'To ensure that network devices have a sufficient storage capacity in which to write the audit logs, they need to be able to allocate audit record storage capacity. The task of allocating audit record storage capacity is usually performed during initial device setup if it is modifiable. 
...
SW2(config)#logging buffered xxxxxxxx informational'
  ...
  tag check_id: 'C-22314r507843_chk'
  tag severity: 'medium'
  tag gid: 'V-220599'
  tag rid: 'SV-220599r521267_rule'
  tag stig_id: 'CISC-ND-000980'
  tag gtitle: 'SRG-APP-000357-NDM-000293'
  tag fix_id: 'F-22303r507844_fix'
  tag 'documentable'
  tag legacy: ['SV-110427', 'V-101323']
  tag cci: ['CCI-001849']
  tag nist: ['AU-4']
end
