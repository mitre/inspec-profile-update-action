...
Alerts provide organizations with urgent messages. Real-time alerts provide these messages immediately (i.e., the time from event detection to alert occurs in seconds or less).'
  desc 'check', 'Review the Cisco switch configuration to verify that it generates an alert for all audit failure events as shown in the example below:
...
Note: The parameter "critical" can replaced with a lesser severity level (i.e., error, warning, notice, informational).'
  ...
  tag check_id: 'C-22315r507846_chk'
  tag severity: 'medium'
  tag gid: 'V-220600'
  tag rid: 'SV-220600r521267_rule'
  tag stig_id: 'CISC-ND-001000'
  tag gtitle: 'SRG-APP-000360-NDM-000295'
  tag fix_id: 'F-22304r507847_fix'
  tag 'documentable'
  tag legacy: ['SV-110429', 'V-101325']
  tag cci: ['CCI-001858']
  tag nist: ['AU-5 (2)']
end
