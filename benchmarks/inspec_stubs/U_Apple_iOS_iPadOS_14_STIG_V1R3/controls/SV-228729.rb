control 'SV-228729' do
  title 'The mobile operating system must be configured to enforce a minimum password length of six characters.'
...
If the "Minimum passcode length" is less than six characters in the iOS management tool, "<key>minLength</key> " has an integer value of less than six, or the password policy on the iPhone and iPad from the Apple iOS/iPadOS management tool does not list "Minimum length" of six or fewer, this is a finding.'
  ...
  tag check_id: 'C-30964r509815_chk'
  tag severity: 'medium'
  tag gid: 'V-228729'
  tag rid: 'SV-228729r561031_rule'
  tag stig_id: 'AIOS-14-000100'
  tag gtitle: 'PP-MDF-301010'
  tag fix_id: 'F-30941r509816_fix'
  tag 'documentable'
  tag cci: ['CCI-000205']
  tag nist: ['IA-5 (1) (a)']
end
