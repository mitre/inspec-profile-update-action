control 'SV-228739' do
  title 'The mobile operating system must be configured to display the DoD advisory warning message at start-up or each time the user unlocks the device.'
...
2. By creating a background picture with the relevant information and configuring that picture as the background for the lock screen via the Apple iOS/iPadOS management tool.'
  ...
  tag check_id: 'C-30974r509845_chk'
  tag severity: 'low'
  tag gid: 'V-228739'
  tag rid: 'SV-228739r561044_rule'
  tag stig_id: 'AIOS-14-003300'
  tag gtitle: 'PP-MDF-301200'
  tag fix_id: 'F-30951r569177_fix'
  tag 'documentable'
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
