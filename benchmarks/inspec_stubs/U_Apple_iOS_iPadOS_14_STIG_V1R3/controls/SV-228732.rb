control 'SV-228732' do
  title 'The mobile operating system must be configured to not allow more than ten consecutive failed authentication attempts.'
...
If the "Maximum number of failed attempts" is more than 10 in the iOS management tool, "<key>maxFailedAttempts</key> " has an integer value of more than 10, or the password policy on the iPhone and iPad does not list "Max failed attempts" of ten or fewer, this is a finding.'
  desc 'fix', 'Install a configuration profile to allow only ten or fewer consecutive failed authentication attempts.'
  impact 0.5
  ref 'DPMS Target Apple iOS iPadOS 14'
  tag check_id: 'C-30967r509824_chk'
  tag severity: 'medium'
  tag gid: 'V-228732'
  tag rid: 'SV-228732r561031_rule'
  tag stig_id: 'AIOS-14-000400'
  tag gtitle: 'PP-MDF-301050'
  tag fix_id: 'F-30944r509825_fix'
  tag 'documentable'
  tag cci: ['CCI-000044']
  tag nist: ['AC-7 a']
end
