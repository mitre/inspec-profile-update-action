control 'SV-228779' do
  title 'Apple iOS must be configured to disable automatic transfer of diagnostic data to an external device other than an MDM service with which the device has enrolled.'
...
If "Allow sending diagnostic and usage data to Apple" is checked in the iOS management tool, "<key>allowDiagnosticSubmission</key><true/>" appears in the configuration profile, or the restrictions policy on the Apple iOS device from the Apple iOS management tool does not list "Diagnostic submission not allowed", this is a finding.'
  ...
  tag check_id: 'C-31014r509965_chk'
  tag severity: 'low'
  tag gid: 'V-228779'
  tag rid: 'SV-228779r561031_rule'
  tag stig_id: 'AIOS-14-011800'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-30991r509966_fix'
  tag 'documentable'
  tag cci: ['CCI-001199']
  tag nist: ['SC-28']
end
