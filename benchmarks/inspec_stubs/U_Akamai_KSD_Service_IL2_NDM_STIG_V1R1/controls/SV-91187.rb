...
Password complexity is one factor of several that determine how long it takes to crack a password. The more complex the password, the greater the number of possible combinations that need to be tested before the password is compromised.'
  desc 'check', 'Verify the password must contain at least one numeric character.

Contact the Akamai Professional Services team to verify the changes at 1-877-4-AKATEC (1-877-425-2832).

If the password does not require at least one numeric character, this is a finding.'
...
Complete the contact information fields if they haven't been prepopulated, and then click "Create Case")
  ...
  tag check_id: 'C-76151r1_chk'
  tag severity: 'medium'
  tag gid: 'V-76491'
  tag rid: 'SV-91187r1_rule'
  tag stig_id: 'AKSD-DM-000031'
  tag gtitle: 'SRG-APP-000168-NDM-000256'
  tag fix_id: 'F-83169r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000194']
  tag nist: ['IA-5 (1) (a)']
end
