...
The shorter the password, the lower the number of possible combinations that need to be tested before the password is compromised. Use of more characters in a password helps to exponentially increase the time and/or resources required to compromise the password.'
  desc 'check', 'Verify the minimum 15-character length for passwords.

Contact the Akamai Professional Services team to verify the changes at 1-877-4-AKATEC (1-877-425-2832).

If the minimum password length is not 15-character, this is a finding.'
...
Complete the contact information fields if they haven't been prepopulated, and then click "Create Case")
  ...
  tag check_id: 'C-76145r1_chk'
  tag severity: 'medium'
  tag gid: 'V-76485'
  tag rid: 'SV-91181r1_rule'
  tag stig_id: 'AKSD-DM-000028'
  tag gtitle: 'SRG-APP-000164-NDM-000252'
  tag fix_id: 'F-83163r1_fix'
  tag 'documentable'
  tag cci: ['CCI-000205']
  tag nist: ['IA-5 (1) (a)']
end
