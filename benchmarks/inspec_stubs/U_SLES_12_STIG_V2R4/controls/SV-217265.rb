...
# systemctl restart sshd'
  ...
  tag check_id: 'C-18493r369951_chk'
  tag severity: 'medium'
  tag gid: 'V-217265'
  tag rid: 'SV-217265r603262_rule'
  tag stig_id: 'SLES-12-030110'
  tag gtitle: 'SRG-OS-000032-GPOS-00013'
  tag fix_id: 'F-18491r369952_fix'
  tag 'documentable'
  tag legacy: ['V-77443', 'SV-92139']
  tag cci: ['CCI-000067']
  tag nist: ['AC-17 (1)']
end
