...
disk_full_action = syslog'
  ...
  tag check_id: 'C-18429r369759_chk'
  tag severity: 'medium'
  tag gid: 'V-217201'
  tag rid: 'SV-217201r603262_rule'
  tag stig_id: 'SLES-12-020110'
  tag gtitle: 'SRG-OS-000479-GPOS-00224'
  tag fix_id: 'F-18427r369760_fix'
  tag 'documentable'
  tag legacy: ['SV-92005', 'V-77309']
  tag cci: ['CCI-001851']
  tag nist: ['AU-4 (1)']
end
