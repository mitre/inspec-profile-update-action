control 'SV-217150' do
  ...
  desc 'check', 'Verify that the SUSE operating system file integrity tool is configured to verify ACLs.
...
If AIDE is installed, ensure the "acl" rule is present on all file and directory selection lists.'
  ...
  tag check_id: 'C-18378r646710_chk'
  tag severity: 'low'
  tag gid: 'V-217150'
  tag rid: 'SV-217150r646711_rule'
  tag stig_id: 'SLES-12-010520'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-18376r369607_fix'
  tag 'documentable'
  tag legacy: ['V-77155', 'SV-91851']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
