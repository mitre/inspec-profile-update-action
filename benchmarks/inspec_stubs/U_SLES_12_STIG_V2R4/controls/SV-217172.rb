...
# chmod 0750 /home/smithj'
  ...
  tag check_id: 'C-18400r622348_chk'
  tag severity: 'medium'
  tag gid: 'V-217172'
  tag rid: 'SV-217172r603885_rule'
  tag stig_id: 'SLES-12-010730'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-18398r369673_fix'
  tag 'documentable'
  tag legacy: ['SV-91899', 'V-77203']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
