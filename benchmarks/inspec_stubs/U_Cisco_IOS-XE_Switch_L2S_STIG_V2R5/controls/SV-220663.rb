control 'SV-220663' do
  ...
  desc 'check', 'Review the switch configuration to verify that IGMP or MLD snooping has been configured for IPv4 and IPv6 multicast traffic respectively. Below is an example of the steps to verify that IGMP snooping is enabled for each VLAN.
...
SW1(config)#ip igmp snooping'
  ...
  tag check_id: 'C-22378r929004_chk'
  tag severity: 'low'
  tag gid: 'V-220663'
  tag rid: 'SV-220663r929005_rule'
