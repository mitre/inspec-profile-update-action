...
Uncheck the box labeled "Enable Location Services".'
  ...
  tag check_id: 'C-9820r282189_chk'
  tag severity: 'medium'
  tag gid: 'V-209569'
  tag rid: 'SV-209569r610285_rule'
  tag stig_id: 'AOSX-14-002004'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9820r282190_fix'
  tag 'documentable'
  tag legacy: ['SV-105009', 'V-95871']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
