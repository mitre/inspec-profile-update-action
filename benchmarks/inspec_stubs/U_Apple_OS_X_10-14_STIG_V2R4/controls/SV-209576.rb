...
If the return does not contain "/Applications/Messages.app", this is a finding.'
  ...
  tag check_id: 'C-9827r282210_chk'
  tag severity: 'low'
  tag gid: 'V-209576'
  tag rid: 'SV-209576r610285_rule'
  tag stig_id: 'AOSX-14-002011'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9827r282211_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['SV-105027', 'V-95889']
