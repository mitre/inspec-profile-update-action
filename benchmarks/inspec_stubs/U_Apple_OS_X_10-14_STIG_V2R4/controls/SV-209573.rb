...
The system may need to be restarted for the update to take effect.'
  ...
  tag check_id: 'C-9824r282201_chk'
  tag severity: 'medium'
  tag gid: 'V-209573'
  tag rid: 'SV-209573r610285_rule'
  tag stig_id: 'AOSX-14-002008'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9824r282202_fix'
  tag 'documentable'
  tag legacy: ['SV-105021', 'V-95883']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
