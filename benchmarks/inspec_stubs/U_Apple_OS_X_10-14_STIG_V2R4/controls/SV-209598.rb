...
If the output is null or not "allowCloudBookmarks = 0" this is a finding.'
  ...
  tag check_id: 'C-9849r282276_chk'
  tag severity: 'medium'
  tag gid: 'V-209598'
  tag rid: 'SV-209598r610285_rule'
  tag stig_id: 'AOSX-14-002042'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9849r282277_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['SV-105073', 'V-95935']
