...
A text editor may also be used to implement the required updates to the "/etc/security/audit_control" file.)
  ...
  tag check_id: 'C-9800r466255_chk'
  tag severity: 'medium'
  tag gid: 'V-209549'
  tag rid: 'SV-209549r610285_rule'
  tag stig_id: 'AOSX-14-001001'
  tag gtitle: 'SRG-OS-000004-GPOS-00004'
  tag fix_id: 'F-9800r466256_fix'
  ...
  tag 'documentable'
  tag legacy: ['SV-104971', 'V-95833']
  tag cci: ['CCI-001403', 'CCI-001404', 'CCI-001405', 'CCI-000018', 'CCI-000172', 'CCI-002884', 'CCI-002234']
  tag nist: ['AC-2 (4)', 'AC-2 (4)', 'AC-2 (4)', 'AC-2 (4)', 'AU-12 c', 'MA-4 (1) (a)', 'AC-6 (9)']
end
