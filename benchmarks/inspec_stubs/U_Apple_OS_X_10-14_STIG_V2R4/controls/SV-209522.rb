...
If there is no result, or if "askForPassword" is not set to "1", this is a finding.'
  ...
  tag check_id: 'C-9773r282048_chk'
  tag severity: 'medium'
  tag gid: 'V-209522'
  tag rid: 'SV-209522r610285_rule'
  tag stig_id: 'AOSX-14-000002'
  tag gtitle: 'SRG-OS-000028-GPOS-00009'
  tag fix_id: 'F-9773r282049_fix'
  tag 'documentable'
  tag legacy: ['SV-104927', 'V-95789']
  tag cci: ['CCI-000056']
  tag nist: ['AC-11 b']
end
