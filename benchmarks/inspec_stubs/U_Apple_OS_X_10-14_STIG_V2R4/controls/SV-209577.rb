...
If the return is not “allowCloudCalendar = 0”, this is a finding.'
  ...
  tag check_id: 'C-9828r282213_chk'
  tag severity: 'low'
  tag gid: 'V-209577'
  tag rid: 'SV-209577r610285_rule'
  tag stig_id: 'AOSX-14-002012'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9828r282214_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['SV-105029', 'V-95891']
