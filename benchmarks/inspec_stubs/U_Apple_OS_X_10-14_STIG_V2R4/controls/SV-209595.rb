...
If the output is null or "SkipSiriSetup" is not set to "1", this is a finding.'
  ...
  tag check_id: 'C-9846r282267_chk'
  tag severity: 'medium'
  tag gid: 'V-209595'
  tag rid: 'SV-209595r610285_rule'
  tag stig_id: 'AOSX-14-002039'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9846r282268_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['SV-105067', 'V-95929']
