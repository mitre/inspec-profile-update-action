...
If the return is not “allowCloudNotes = 0”, this is a finding.'
  ...
  tag check_id: 'C-9832r282225_chk'
  tag severity: 'low'
  tag gid: 'V-209581'
  tag rid: 'SV-209581r610285_rule'
  tag stig_id: 'AOSX-14-002016'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9832r282226_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['SV-105037', 'V-95899']
