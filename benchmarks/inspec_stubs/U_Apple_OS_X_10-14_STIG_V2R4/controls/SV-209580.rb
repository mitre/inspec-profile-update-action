...
If the result is not “allowCloudMail = 0”, this is a finding.'
  ...
  tag check_id: 'C-9831r282222_chk'
  tag severity: 'low'
  tag gid: 'V-209580'
  tag rid: 'SV-209580r610285_rule'
  tag stig_id: 'AOSX-14-002015'
  tag gtitle: 'SRG-OS-000095-GPOS-00049'
  tag fix_id: 'F-9831r282223_fix'
  tag satisfies: ['SRG-OS-000095-GPOS-00049', 'SRG-OS-000370-GPOS-00155']
  tag 'documentable'
  tag legacy: ['SV-105035', 'V-95897']
