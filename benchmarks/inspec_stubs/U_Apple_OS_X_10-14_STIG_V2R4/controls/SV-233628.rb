...
The SSH service must be restarted for changes to take effect.)
  ...
  tag check_id: 'C-33607r591063_chk'
  tag severity: 'medium'
  tag gid: 'V-233628'
  tag rid: 'SV-233628r610285_rule'
  tag stig_id: 'AOSX-14-000054'
  tag gtitle: 'SRG-OS-000033-GPOS-00014'
  tag fix_id: 'F-36783r621603_fix'
  ...
  tag 'documentable'
  tag cci: ['CCI-000068', 'CCI-000877', 'CCI-000803', 'CCI-003123', 'CCI-002890']
  tag nist: ['AC-17 (2)', 'MA-4 c', 'IA-7', 'MA-4 (6)', 'MA-4 (6)']
end
