...
At the top level of the directories identified after the enabled DocumentRoot & Alias directives, verify that a “robots.txt” file does not exist.  If the file does exist, this is a finding.'
  desc 'fix', 'Remove the robots.txt file from the web site.  If there is information on the web site that needs protection from search engines and public view, then other methods must be used to safeguard the data.'
  impact 0.5
  ref 'DPMS Target Apache Site 2.0'
  tag check_id: 'C-35765r2_chk'
  tag severity: 'medium'
  tag gid: 'V-2260'
  tag rid: 'SV-28798r2_rule'
  tag stig_id: 'WG310 W22'
  tag gtitle: 'WG310'
  tag fix_id: 'F-29434r2_fix'
  tag 'documentable'
