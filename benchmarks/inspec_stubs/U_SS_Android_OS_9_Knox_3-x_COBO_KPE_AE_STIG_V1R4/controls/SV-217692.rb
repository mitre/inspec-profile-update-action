...
Use either Method #1 (preferred) or Method #2. 
...
Note: On some MDM consoles, the Knox banner is automatically enabled while the Samsung Android device is enrolled. In this case, the above guidance is not applicable.'
  ...
  tag check_id: 'C-18911r362105_chk'
  tag severity: 'low'
  tag gid: 'V-217692'
  tag rid: 'SV-217692r378520_rule'
  tag stig_id: 'KNOX-09-001160'
  tag gtitle: 'PP-MDF-301200'
  tag fix_id: 'F-18909r362106_fix'
  tag 'documentable'
  tag legacy: ['SV-103009', 'V-92921']
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
