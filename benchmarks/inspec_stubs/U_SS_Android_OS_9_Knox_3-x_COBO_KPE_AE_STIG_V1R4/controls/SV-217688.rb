...
On the MDM console, in the Knox Wifi restrictions, unselect "allow unsecured hotspot".'
  ...
  tag check_id: 'C-18907r362093_chk'
  tag severity: 'medium'
  tag gid: 'V-217688'
  tag rid: 'SV-217688r617464_rule'
  tag stig_id: 'KNOX-09-000940'
  tag gtitle: 'PP-MDF-301240'
  tag fix_id: 'F-18905r362094_fix'
  tag 'documentable'
  tag legacy: ['SV-103001', 'V-92913']
  tag cci: ['CCI-002314']
  tag nist: ['AC-17 (1)']
end
