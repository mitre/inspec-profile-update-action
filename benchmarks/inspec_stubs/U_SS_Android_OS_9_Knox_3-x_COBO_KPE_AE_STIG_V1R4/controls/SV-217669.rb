...
On the MDM console, in the Android password constraints, set the "minimum password length" to "6" or greater.'
  ...
  tag check_id: 'C-18888r362036_chk'
  tag severity: 'low'
  tag gid: 'V-217669'
  tag rid: 'SV-217669r378766_rule'
  tag stig_id: 'KNOX-09-000370'
  tag gtitle: 'PP-MDF-301010'
  tag fix_id: 'F-18886r362037_fix'
  tag 'documentable'
  tag legacy: ['SV-102963', 'V-92875']
  tag cci: ['CCI-000205']
  tag nist: ['IA-5 (1) (a)']
end
