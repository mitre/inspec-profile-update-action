...
Refer to the MDM documentation to determine how to configure OCSP checking to "enable for all apps". Some may, for example, allow a wildcard string: "*" (asterisk).'
  ...
  tag check_id: 'C-18913r362111_chk'
  tag severity: 'medium'
  tag gid: 'V-217694'
  tag rid: 'SV-217694r388482_rule'
  tag stig_id: 'KNOX-09-001340'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-18911r362112_fix'
  tag 'documentable'
  tag legacy: ['SV-103013', 'V-92925']
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
