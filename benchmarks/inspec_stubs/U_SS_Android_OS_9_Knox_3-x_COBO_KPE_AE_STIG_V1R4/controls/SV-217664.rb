...
On the MDM console, for the device, in the "Android user restrictions" group, select "disallow install unknown sources".'
  ...
  tag check_id: 'C-18883r362021_chk'
  tag severity: 'medium'
  tag gid: 'V-217664'
  tag rid: 'SV-217664r617471_rule'
  tag stig_id: 'KNOX-09-000130'
  tag gtitle: 'PP-MDF-301080'
  tag fix_id: 'F-18881r362022_fix'
  tag 'documentable'
  tag legacy: ['SV-102953', 'V-92865']
