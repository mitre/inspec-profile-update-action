...
Note: The guidance for disablement of system apps that have the characteristic "back up MD data to non-DoD cloud servers (including user and application access to cloud backup services)" is covered by KNOX-09-000100.'
  ...
  tag check_id: 'C-18905r362087_chk'
  tag severity: 'medium'
  tag gid: 'V-217686'
  tag rid: 'SV-217686r617478_rule'
  tag stig_id: 'KNOX-09-000860'
  tag gtitle: 'PP-MDF-301230'
  tag fix_id: 'F-18903r362088_fix'
  tag 'documentable'
  tag legacy: ['SV-102997', 'V-92909']
  tag cci: ['CCI-002338']
  tag nist: ['AC-20 (3)']
end
