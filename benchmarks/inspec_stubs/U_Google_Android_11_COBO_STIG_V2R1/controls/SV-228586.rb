control 'SV-228586' do
  title 'Google Android 11 must be configured to display the DoD advisory warning message at start-up or each time the user unlocks the device.'
  desc %q(The Google Android 11 is required to display the DoD-approved system use notification message or banner before granting access to the system that provides privacy and security notices consistent with applicable federal laws, Executive Orders, directives, policies, regulations, standards, and guidance. Required banners help ensure that DoD can audit and monitor the activities of mobile device users without legal restriction.
...
4. Enter in message.'
  ...
  tag check_id: 'C-30821r505583_chk'
  tag severity: 'low'
  tag gid: 'V-228586'
  tag rid: 'SV-228586r619923_rule'
  tag stig_id: 'GOOG-11-003400'
  tag gtitle: 'PP-MDF-301200'
  tag fix_id: 'F-30798r505584_fix'
  tag 'documentable'
  tag cci: ['CCI-000048']
  tag nist: ['AC-8 a']
end
