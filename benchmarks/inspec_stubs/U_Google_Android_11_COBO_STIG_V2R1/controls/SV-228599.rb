control 'SV-228599' do
  title 'Google Android 11 work profile must be configured to disable automatic completion of workspace internet browser text input.'
...
SFR ID: FMT_SMF_EXT.1.1 #47"
  desc 'check', 'Review Chrome Browser in Google Android 11 Work Profile autofill setting.
...
If on the EMM console autofill is set to On in the Chrome Browser Settings, this is a finding.'
  desc 'fix', 'Configure Chrome Browser in Google Android 11 device Work Profile to disable autofill.
...
Refer to the EMM documentation to determine how to configure Chrome Browser Settings.'
  ...
  tag check_id: 'C-30834r505622_chk'
  tag severity: 'medium'
  tag gid: 'V-228599'
  tag rid: 'SV-228599r874143_rule'
  tag stig_id: 'GOOG-11-009800'
  tag gtitle: 'PP-MDF-991000'
  tag fix_id: 'F-30811r505623_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
