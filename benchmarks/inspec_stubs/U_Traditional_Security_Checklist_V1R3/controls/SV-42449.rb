...
Also ensure that these instructions are readily available to the employee population.  Such plans should be posted on or near safes, exits to vaults and secure rooms or at any location where classified materials are stored.'
  ...
  tag check_id: 'C-40662r7_chk'
  tag severity: 'medium'
  tag gid: 'V-32132'
  tag rid: 'SV-42449r3_rule'
  tag stig_id: 'IS-13.02.01'
  tag gtitle: 'Classified Emergency Destruction Plans'
  tag fix_id: 'F-36073r4_fix'
  tag 'documentable'
  tag severity_override_guidance: 'CAT II if there are not any plans developed for emergency destruction, removal, etc.

CAT III if plans have been developed but are not readily available for reference by employees.'
end
