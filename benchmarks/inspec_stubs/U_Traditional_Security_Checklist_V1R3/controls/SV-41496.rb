...
2. A formal Appointment Letter for these duties that outlines responsibilities, etc. must be on-hand.'
  ...
  tag check_id: 'C-39977r5_chk'
  tag severity: 'low'
  tag gid: 'V-31262'
  tag rid: 'SV-41496r3_rule'
  tag stig_id: 'FN-05.03.01'
  tag gtitle: 'Foreign National (FN) Administrative  Controls - Contact Officer Appointment'
  tag fix_id: 'F-35149r5_fix'
  tag 'documentable'
end
