...
*Note that the SAO for the Defense Security Service (DSS)/industry is the Cognizant Security Agency (CSA)/Cognizant Security Office (CSO).'
  ...
  tag check_id: 'C-41040r14_chk'
  tag severity: 'medium'
  tag gid: 'V-32601'
  tag rid: 'SV-42938r3_rule'
  tag stig_id: 'PH-05.02.01'
  tag gtitle: 'Security-in-Depth - Minimum Physical Barriers and Access Control Measures for DoDIN Connected Assets'
  tag fix_id: 'F-36516r9_fix'
  tag 'documentable'
end
