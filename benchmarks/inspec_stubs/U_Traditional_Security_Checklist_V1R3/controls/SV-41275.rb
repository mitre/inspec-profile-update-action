...
Joint USD(I) and DoD CIO Memorandum, dated 25, Sep 2015, SUBJECT: Security and Operational Guidance for Classified Portable Electronic Devices'
  desc 'check', '1. Check to ensure that unauthorized wireless devices (PEDs such as cell phones, Black Berrys, laptops, etc.) are not being used in areas where classified systems or machines (SIPRNet) are in use.
...
TACTICAL ENVIRONMENT: The check is applicable for ALL classified processing environments.'
  desc 'fix', '1. Unauthorized wireless devices (PEDs such as cell phones, Black Berrys, laptops, etc.) must not be permitted for use in areas where classified systems or machines (SIPRNet) are in use.
...
2. If PED usage in classified processing areas is permitted, there must be specific written AO (formerly DAA) approval and a CTTA assessment of the environment and any resulting recommended TEMPEST countermeasures must be implemented.'
  ...
  tag check_id: 'C-39822r8_chk'
  tag severity: 'medium'
  tag gid: 'V-31128'
  tag rid: 'SV-41275r3_rule'
  tag stig_id: 'IA-11.02.01'
  tag gtitle: 'Information Assurance - Unauthorized Wireless Devices - Classified Areas'
  tag fix_id: 'F-35021r11_fix'
  tag 'documentable'
  tag mitigations: 'Information Assurance'
  tag mitigation_control: 'Official PDA/Blackberries must be allowed to sync. Recommend they only be powered up for 
