...
The Information Security Oversight Office (ISOO): http://www.archives.gov/isoo/   Implementing Directive for Protection of Classified (for Executive Order 13526), 32 CFR Parts 2001 and 2003 Classified National Security Information: Subpart B - § 2001.15 Classification guides.
...
DoD 5200.22-M (NISPOM), Incorporating Change 2, 18 May 2016, paragraphs  4-101, 4-102, 4-103 and 7-102.'
  ...
  tag check_id: 'C-40669r8_chk'
  tag severity: 'medium'
  tag gid: 'V-32150'
  tag rid: 'SV-42467r3_rule'
  tag stig_id: 'IS-15.02.01'
  tag gtitle: 'Classification Guides'
  tag fix_id: 'F-36079r5_fix'
  tag 'documentable'
end
