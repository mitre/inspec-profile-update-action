...
DoD 5200.22-M (NISPOM), Incorporating Change 2, 18 May 2016, Chapter 5, Section 9. Intrusion Detection Systems, paragraphs 5-900 and 5-902.'
  ...
  tag check_id: 'C-40055r5_chk'
  tag severity: 'medium'
  tag gid: 'V-31293'
  tag rid: 'SV-41564r3_rule'
  tag stig_id: 'IS-02.02.07'
  tag gtitle: 'Vault/Secure Room Standards - IDS Monitor Location'
  tag fix_id: 'F-35212r1_fix'
  tag 'documentable'
end
