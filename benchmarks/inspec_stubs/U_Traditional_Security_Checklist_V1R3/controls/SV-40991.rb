...
NOTE:  If a pre-fabricated (Modular types such as Holocom or Wiremold) PDS is used it is also required to have all joints sealed as specified above.'
  ...
  tag check_id: 'C-39611r7_chk'
  tag severity: 'medium'
  tag gid: 'V-30949'
  tag rid: 'SV-40991r4_rule'
  tag stig_id: 'CS-04.02.02'
  tag gtitle: 'PDS Construction - Sealed Joints'
  tag fix_id: 'F-34761r6_fix'
  tag 'documentable'
  tag severity_override_guidance: 'None - the default CAT II severity level applies to all checks.'
end
