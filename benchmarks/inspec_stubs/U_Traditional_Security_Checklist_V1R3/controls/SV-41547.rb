...
DoD 5200.22-M (NISPOM), Incorporating Change 2, 18 May 2016, paragraphs 5-901., 5-904. and 5-905.
...
Fix #4. Ensure that results of testing are maintained on file for at least 1-year.'
  ...
  tag check_id: 'C-40042r4_chk'
  tag severity: 'medium'
  tag gid: 'V-31279'
  tag rid: 'SV-41547r3_rule'
  tag stig_id: 'IS-02.02.02'
  tag gtitle: 'Vault/Secure Room Standards - IDS Verification'
  tag fix_id: 'F-35191r4_fix'
  tag 'documentable'
  tag severity_override_guidance: 'Default CAT II:  If IDS functionality checks are not conducted at least semi-annually using industry best practices or other DoD standards this is a CAT II finding.

Downgrade to CAT III:  If IDS functionality testing is conducted at least semi-annually but there is a lack of adequate written procedures for the process or results of testing are not maintained for audit purposes this finding may be downgraded to CAT III.

Downgrade to CAT III:  If IDS functionality testing is conducted at a frequency less than semi-annually but at least annually this finding may be downgraded to CAT III. 

NOTE:  There is NO reduction of severity level from the default level of CAT II if testing is not conducted at least annually.

Not Applicable (NA) if 4-hour random checks of secure room spaces are conducted in lieu of IDS.'
end
