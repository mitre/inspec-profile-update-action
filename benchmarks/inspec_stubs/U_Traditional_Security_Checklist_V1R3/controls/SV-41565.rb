...
Based on the access control method(s) used for each individual Continuous Operations Facility at a site, comply with all of the requirements detailed in all of the individual checks applicable to the selected method(s) of access control. Compliance with at least one complete set of checks applicable to a particular method of access control is required for each Continuous Operations Facility.'
  ...
  tag check_id: 'C-40057r39_chk'
  tag severity: 'high'
  tag gid: 'V-31294'
  tag rid: 'SV-41565r3_rule'
  tag stig_id: 'IS-02.01.13'
  tag gtitle: 'Information Security (IS) - Continuous Operations Facility'
  tag fix_id: 'F-35254r13_fix'
  tag 'documentable'
  tag severity_override_guidance: 'Default severity level for this requirement is a Category I (CAT I).

If one or more of the following six checks are the *ONLY* findings (no CAT I checks are found to be deficient), the finding under this requirement may be downgraded to a CAT II severity level.:
