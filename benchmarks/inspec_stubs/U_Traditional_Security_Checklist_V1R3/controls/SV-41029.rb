...
4. Emergency lighting must be tested on a periodic basis.'
  ...
  tag check_id: 'C-39650r6_chk'
  tag severity: 'low'
  tag gid: 'V-30985'
  tag rid: 'SV-41029r3_rule'
  tag stig_id: 'EC-02.03.01'
  tag gtitle: 'Environmental IA Controls - Emergency Lighting and Exits - Documentation and Testing'
  tag fix_id: 'F-34796r5_fix'
  tag 'documentable'
end
