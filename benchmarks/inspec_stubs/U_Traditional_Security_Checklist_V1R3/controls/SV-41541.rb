...
DoD 5200.22-M (NISPOM), Incorporating Change 2, 18 May 2016, Chapter 5, Section 3; paragraphs 5-306.b., 5-307.a., 5-307.b. & Section 9; paragraphs 5-900 and 5-904.'
...
In summary: An IDS must be used as a supplemental protective measure AND it must be supported both by a valid risk assessment AND security-in-depth as approved in writing by the senior agency official.'
  ...
  tag check_id: 'C-40016r10_chk'
  tag severity: 'high'
  tag gid: 'V-31274'
  tag rid: 'SV-41541r3_rule'
  tag stig_id: 'IS-02.01.07'
  tag gtitle: 'Information Security (INFOSEC) - Secure Room Standards - IDS'
  tag fix_id: 'F-35185r9_fix'
  tag 'documentable'
  tag severity_override_guidance: '1. The default when no IDS is used in secure rooms or classified open storage areas housing SIPRNet equipment is a CAT I finding. 

2. Where IDS is being used properly BUT there is NO RISK ASSESSMENT and/or a SECURITY-IN-DEPTH DETERMINATION * IN WRITING by the C/S/A senior agency (security) official that specifically addresses the secure room or open storage space - then the severity level is a CAT II. 

3. This requirement/check is NA if random checks not exceeding 4-hours are used in lieu of IDS, but only if the use of random checks is supported by a valid risk assessment and a security-in-depth determination.  

4. This requirement/check for IDS (IS-02.01.07) cannot be used together with the requirement/check for 4-hour random checks (IS-02.01.10).  Only one or the other is applicable to any individual secure room or collateral classified open storage area.'
end
