...
7. The PDS must not be located within an Uncontrolled Access Area (UAA).'
  ...
  tag check_id: 'C-39630r10_chk'
  tag severity: 'high'
  tag gid: 'V-30970'
  tag rid: 'SV-41012r3_rule'
  tag stig_id: 'CS-04.01.05'
  tag gtitle: 'PDS Construction - External Suspended PDS'
  tag fix_id: 'F-34780r11_fix'
  tag 'documentable'
...
This Rule covering (External) Suspended Carriers (STIG ID: CS-04.01.05) may be used in conjunction with the other Category 2 carriers.  Different requirements apply to each type of Category 2 carrier and must be assessed under their respective STIG Rules.'
end
