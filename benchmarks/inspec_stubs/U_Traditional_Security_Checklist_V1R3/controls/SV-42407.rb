...
TACTICAL ENVIRONMENT: The check is applicable for fixed (established) tactical processing environments where procedural documents (SOPs) should be in place.  Not applicable to a field/mobile environment.'
  ...
  tag check_id: 'C-40659r6_chk'
  tag severity: 'low'
  tag gid: 'V-32090'
  tag rid: 'SV-42407r3_rule'
  tag stig_id: 'IS-11.03.01'
  tag gtitle: 'Destruction of  Classified and Unclassified Documents, Equipment and Media - Policy/Procedure'
  tag fix_id: 'F-36047r4_fix'
  tag 'documentable'
end
