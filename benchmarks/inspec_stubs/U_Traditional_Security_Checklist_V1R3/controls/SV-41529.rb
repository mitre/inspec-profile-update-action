...
DoD 5200.22-M (NISPOM), Incorporating Change 2, 18 May 2016, Chapter 5, paragraphs 5-303., 5-306., 5-307.c., 5-310., 5-312., 5-313., 5-314. & Section 8, Construction Requirements.'
...
The primary ingress/egress door must be equipped with a proper combination lock that is installed properly and is being used. Door must be equipped with a built-in GSA-approved combination lock meeting Federal Specification FF-L-2740, such as the X07, X09 locks. 

NOTE: The use of automated entry control systems (AECS) is encouraged to control access to secure room space during working hours; however, electrically actuated locks (e.g., cypher and magnetic access card locks) do not afford by themselves the required degree of protection for classified information and must not be used as a substitute for the combination locks meeting Federal Specification FF-L-2740.'
  impact 0.7
  ref 'DPMS Target Traditional Security'
  tag check_id: 'C-39996r8_chk'
  tag severity: 'high'
  tag gid: 'V-31267'
  tag rid: 'SV-41529r3_rule'
  tag stig_id: 'IS-02.01.01'
  tag gtitle: 'Information Security (INFOSEC) - Vault/Secure Room Standards - Combination Lock'
  tag fix_id: 'F-35164r6_fix'
  tag 'documentable'
  tag severity_override_guidance: 'The default severity level is CAT I but may be reduced to a CAT II finding at DoD Industry sites ONLY if compliance with NISPOM standards are met.  This allows for the use of either an approved built-in combination lock or an approved combination or key-operated padlock.  Particular attention must be given to control of key operated padlocks and keys IAW the NISPOM paragraph 5-310.  If proper key control is not maintained the downgrade to CAT II should not be allowed.'
end
