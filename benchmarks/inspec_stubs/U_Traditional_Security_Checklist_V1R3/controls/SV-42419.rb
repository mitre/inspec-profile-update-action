...
6.  Are there appropriate transportation and/or shipping arrangements to ensure the classified material is properly protected while in transit to the destruction facility?'
  ...
  tag check_id: 'C-40660r8_chk'
  tag severity: 'medium'
  tag gid: 'V-32102'
  tag rid: 'SV-42419r3_rule'
  tag stig_id: 'IS-11.02.01'
  tag gtitle: 'Classified Destruction -  Media Sanitization Devices and Plans not Available for AIS On-Hand'
  tag fix_id: 'F-36053r7_fix'
  tag 'documentable'
end
