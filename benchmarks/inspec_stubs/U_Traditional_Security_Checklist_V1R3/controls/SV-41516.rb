...
TACTICAL ENVIRONMENT: This check is applicable where REL partners/LN/FN are employed in a tactical environment with access to classified or unclassified US Systems or Coalition Systems.'
  ...
  tag check_id: 'C-39994r3_chk'
  tag severity: 'medium'
  tag gid: 'V-31265'
  tag rid: 'SV-41516r3_rule'
  tag stig_id: 'FN-05.02.02'
  tag gtitle: 'Foreign National (FN) Administrative Controls - System Access Request Procedure'
  tag fix_id: 'F-35162r5_fix'
  tag 'documentable'
  tag severity_override_guidance: 'Finding is a CAT II by default.  Reduce to CAT III if no local policy and procedures exist for adding foreign nationals to systems - but no inappropriate system access was found to be granted IAW DoD 8570.01-M as follows:
C3.2.4.8.2. ...LNs and Foreign Nationals (FNs) must comply with background investigation requirements and cannot be assigned to IAT Level III positions.'
end
