...
DoD 5200.22-M (NISPOM), Incorporating Change 2, 18 May 2016, Chapter 8, paragraphs 8-101.c., 8-103.a., & 8-302.j.'
...
3. All training accomplished must be documented for each individual user.'
  ...
  tag check_id: 'C-39681r7_chk'
  tag severity: 'medium'
  tag gid: 'V-31082'
  tag rid: 'SV-41133r3_rule'
  tag stig_id: 'IA-06.02.02'
  tag gtitle: 'Information Assurance/Cybersecurity Training for System Users'
  tag fix_id: 'F-34887r6_fix'
  tag 'documentable'
end
