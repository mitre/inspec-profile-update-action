...
2. Conducting a general survey of multiple employees to ascertain their familiarity with personal responsibilities while holding a security clearance.'
  ...
  tag check_id: 'C-40788r8_chk'
  tag severity: 'low'
  tag gid: 'V-32336'
  tag rid: 'SV-42673r3_rule'
  tag stig_id: 'PE-01.03.01'
  tag gtitle: 'Position of Trust - Knowledge of Responsibility to Report Derogatory Information'
  tag fix_id: 'F-36252r5_fix'
  tag 'documentable'
end
