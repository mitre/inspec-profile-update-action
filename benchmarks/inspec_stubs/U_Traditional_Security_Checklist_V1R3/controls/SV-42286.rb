...
DoD 5200.22-M (NISPOM), Incorporating Change 2, 18 May 2016, Chapter 3, Section 1, paragraph 3-106.
...
For individuals without an SF 312 or other approved NDA form on file (either hard copy or in JPAS), immediately remove access to classified information systems (ie, SIPRNet) pending proper execution of an NDA (SF 312) and annotation in JPAS.'
  ...
  tag check_id: 'C-40625r8_chk'
  tag severity: 'low'
  tag gid: 'V-31987'
  tag rid: 'SV-42286r3_rule'
  tag stig_id: 'IS-06.03.01'
  tag gtitle: 'Non-Disclosure Agreement - Standard Form 312'
  tag fix_id: 'F-35916r6_fix'
  tag 'documentable'
end
