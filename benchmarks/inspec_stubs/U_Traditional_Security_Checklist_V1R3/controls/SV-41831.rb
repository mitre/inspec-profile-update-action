...
DoD 5200.22-M (NISPOM), Incorporating Change 2, 18 May 2016, Chapter 5, paragraph 5-313.i.'
...
3. Ensure that records concerning personnel removed from the system are retained for a minimum of 90 days.'
  ...
  tag check_id: 'C-40276r6_chk'
  tag severity: 'medium'
  tag gid: 'V-31548'
  tag rid: 'SV-41831r3_rule'
  tag stig_id: 'IS-02.02.08'
  tag gtitle: 'Vault/Secure Room Storage Standards - Automated Entry Control System (AECS) Records Maintenance'
  tag fix_id: 'F-35460r5_fix'
  tag 'documentable'
  tag severity_override_guidance: 'Default is a CAT II for a finding that records reflecting active assignment of ID badge/card, PIN, level of access, and similar system-related records are not accurately maintained. 

May be reduced to a CAT III severity level if one or both of the following checks are the only findings:

Check to ensure there is a documented procedure for granting access and removal of persons from the Automated Entry Control System.(CAT III - for lack of written procedures)

Check to ensure that records concerning personnel removed from the system are retained for a minimum of 90 days.  (CAT III - if records are maintained for less than 90 days)'
end
