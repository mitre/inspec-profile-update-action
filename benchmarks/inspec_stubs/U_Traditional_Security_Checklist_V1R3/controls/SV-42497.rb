...
b. While not required it is highly recommended using at least a cross cut shredder for destruction of CUI documents.  Further, while a shred-all policy is also not required, this is another strong recommendation.'
  ...
  tag check_id: 'C-40687r13_chk'
  tag severity: 'medium'
  tag gid: 'V-32180'
  tag rid: 'SV-42497r3_rule'
  tag stig_id: 'IS-16.02.02'
  tag gtitle: 'Controlled Unclassified Information - Document, Hard Drive and Media Disposal'
  tag fix_id: 'F-36106r5_fix'
  tag 'documentable'
end
