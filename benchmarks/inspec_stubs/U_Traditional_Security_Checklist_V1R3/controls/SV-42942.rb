...
4. Ensure that security staff have been properly trained and certified for the positions to which they are appointed (e.g. IAM I, II or III for ISSM/ISSO) and that they meet all applicable requirements for the positions.  For instance the AO and ISSM must be US citizens.'
  ...
  tag check_id: 'C-41044r6_chk'
  tag severity: 'medium'
  tag gid: 'V-32605'
  tag rid: 'SV-42942r3_rule'
  tag stig_id: 'SM-01.03.01'
  tag gtitle: 'Security and Cybersecurity Staff Appointment, Training/Certification and Suitability'
  tag fix_id: 'F-36520r4_fix'
  tag 'documentable'
  tag severity_override_guidance: 'Default is CAT II based on Check #4 below.  If check #4 is compliant then reduce to CAT III for checks #1 through #3 as follows:
...
Check # 4. Check supporting documentation to ensure that security staff have been properly trained and certified for the positions to which they are appointed and that they meet all applicable requirements for the positions.  For instance the AO and ISSM must be US Citizens.   (CAT II)'
end
