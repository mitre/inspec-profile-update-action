...
Additionally, the need for additional short term or long term alternative power sources such as use of a secondary commercial power supply or use of one or more generators with sufficient capacity to meet the needs of the organization must be considered in the organizations Holistic Risk Assessment; when such alternative sources of power are actually not available.'
  ...
  tag check_id: 'C-62507r6_chk'
  tag severity: 'medium'
  tag gid: 'V-61629'
  tag rid: 'SV-76119r1_rule'
  tag stig_id: 'EC-03.03.02'
  tag gtitle: 'Environmental IA Controls - Emergency Power'
  tag fix_id: 'F-67557r2_fix'
  tag 'documentable'
  tag severity_override_guidance: 'The default finding is CAT II where a short-term uninterruptible power supply (UPS) is not available.  

If a UPS is available but there are no other longer term power sources such as secondary commercial power or generators and the organizations Holistic Risk Assessment has not specifically considered the impact of not having a long term alternate power source the finding severity level can be lowered to a CAT III.  

NOTE: It is not necessary for the risk assessment to specifically address the need for long term alternative power if it is actually available at the site.'
