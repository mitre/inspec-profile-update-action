...
DoD Manual 5200.01, Volume 4, SUBJECT: DoD Information Security Program: Controlled Unclassified Information (CUI); Enclosure 2, paragraph 4.b. and Enclosure 4, paragraphs 6 and 8.

DoD 5200.22-M (NISPOM), Incorporating Change 2, 18 May 2016, Chapter 7, Section 1, paragraph 7-101.a.(2).'
...
Ensure there are local written procedures for handling, marking, storing, destroying and transmitting Controlled Unclassified Information.'
  ...
  tag check_id: 'C-40670r5_chk'
  tag severity: 'low'
  tag gid: 'V-32156'
  tag rid: 'SV-42473r3_rule'
  tag stig_id: 'IS-16.03.01'
  tag gtitle: 'Controlled Unclassified Information (CUI) - Local Policy and Procedure'
  tag fix_id: 'F-36080r3_fix'
  tag 'documentable'
end
