...
CNSSI No.7003, September 2015, Protected Distribution Systems (PDS), Section X, paragraph 30.e.'
  desc 'check', 'PDS in a tactical environment.  Check to ensure:
...
4. ALL PDS in a tactical environment must be included in a well-documented Risk Assessment, for which residual risk has been acknowledged and accepted by the PDS Approval Authority.'
  desc 'fix', 'PDS in a tactical environment:
...
4. ALL PDS in a tactical environment must be included in a well-documented Risk Assessment, for which residual risk has been acknowledged and accepted by the PDS Approval Authority.'
  ...
  tag check_id: 'C-39633r10_chk'
  tag severity: 'high'
  tag gid: 'V-30973'
  tag rid: 'SV-41015r3_rule'
  tag stig_id: 'CS-04.01.07'
  tag gtitle: 'PDS Construction - Tactical Environment'
  tag fix_id: 'F-34783r8_fix'
  tag 'documentable'
  tag potential_impacts: 'This requirements ONLY FOR USE IN TACTICAL ENVIRONMENTS.  It is NOT APPLICABLE (NA) for all other locations.'
end
