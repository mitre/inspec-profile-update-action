...
4. Windows will be covered with curtains, screens or otherwise limit visibility into the secure room space when classified equipment, documents or media can be viewed from outside the area.'
  ...
  tag check_id: 'C-40006r4_chk'
  tag severity: 'high'
  tag gid: 'V-31272'
  tag rid: 'SV-41539r3_rule'
  tag stig_id: 'IS-02.01.05'
  tag gtitle: 'Information Security (INFOSEC) - Secure Room Storage Standards  Windows'
  tag fix_id: 'F-35169r5_fix'
  tag 'documentable'
  tag potential_impacts: 'Associated Traditional Security STIG Rules are:
