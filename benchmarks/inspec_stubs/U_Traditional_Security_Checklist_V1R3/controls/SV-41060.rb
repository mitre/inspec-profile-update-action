...
3. Training/certification requirements must be documented for each IA staff member to include their current certification level: IAM (I-III) or IAT (I-III).'
  ...
  tag check_id: 'C-39674r5_chk'
  tag severity: 'medium'
  tag gid: 'V-31013'
  tag rid: 'SV-41060r3_rule'
  tag stig_id: 'IA-06.02.01'
  tag gtitle: 'Information Assurance - System Training and Certification/ IA Personnel'
  tag fix_id: 'F-34826r4_fix'
  tag 'documentable'
end
