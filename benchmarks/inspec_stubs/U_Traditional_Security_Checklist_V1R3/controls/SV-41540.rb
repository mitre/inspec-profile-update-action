...
Facility Engineer (FE) construction certificates or other documentation must be available to ensure construction standards are met.  Often these certificates are posted on the inside of the vault near the door, but can be on file elsewhere at the site.'
  ...
  tag check_id: 'C-40007r8_chk'
  tag severity: 'high'
  tag gid: 'V-31273'
  tag rid: 'SV-41540r3_rule'
  tag stig_id: 'IS-02.01.06'
  tag gtitle: 'Information Security (INFOSEC) - Vault Storage/Construction Standards'
  tag fix_id: 'F-35174r5_fix'
  tag 'documentable'
  tag mitigations: 'INFOSEC-Vault Storage/Construction Standards'
  tag mitigation_control: 'For Industry sites ONLY that are not located within the bounds of a DoD installation the standards for vault construction found in the NISPOM under Section 8, paragraph 5-802. Construction Required for Vaults - may be used.'
end
