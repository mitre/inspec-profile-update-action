...
c. FBI-HQ/ID (Where information exists regarding residence by the foreign national in the U.S. or Territory for one year or more since age 18).'
  ...
  tag check_id: 'C-39936r9_chk'
  tag severity: 'medium'
  tag gid: 'V-31211'
  tag rid: 'SV-41411r3_rule'
  tag stig_id: 'FN-02.02.01'
  tag gtitle: 'Foreign National (FN) Systems Access - Local Nationals Overseas System Access -  NIPRNet'
  tag fix_id: 'F-39500r6_fix'
  tag 'documentable'
end
