...
5.  Ensure there is an organizational procedure developed to outline methodology for validation and maintenance of required security clearances.'
  ...
  tag check_id: 'C-40792r12_chk'
  tag severity: 'medium'
  tag gid: 'V-32343'
  tag rid: 'SV-42680r3_rule'
  tag stig_id: 'PE-03.02.01'
  tag gtitle: 'Validation Procedures for Clearance Issuance and Access Granted'
  tag fix_id: 'F-36256r7_fix'
  tag 'documentable'
  tag responsibility: ['Information Assurance Manager', 'Security Manager']
end
