...
Minimally monitor station personnel must be subjects of a successfully adjudicated Tier 3 investigation or an older NACLAC and ANACI that is still within scope.'
  ...
  tag check_id: 'C-40902r6_chk'
  tag severity: 'medium'
  tag gid: 'V-32457'
  tag rid: 'SV-42794r3_rule'
  tag stig_id: 'PE-08.02.01'
  tag gtitle: 'Intrusion Detection System (IDS) Monitoring Station Personnel -  Suitability Checks'
  tag fix_id: 'F-36380r5_fix'
  tag 'documentable'
end
