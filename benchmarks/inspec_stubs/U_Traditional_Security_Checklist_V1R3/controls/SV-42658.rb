...
DoD 5200.22-M (NISPOM), Incorporating Change 2, 18 May 2016, Chapter 5, Section 7, paragraph 5-700.b.'
...
2. Ensure there is a memorandum or some form of documentation covering results of the last clean out day.'
  impact 0.3
  ref 'DPMS Target Traditional Security'
  tag check_id: 'C-40787r5_chk'
  tag severity: 'low'
  tag gid: 'V-32321'
  tag rid: 'SV-42658r3_rule'
  tag stig_id: 'IS-17.03.01'
  tag gtitle: 'Classified Annual Review'
  tag fix_id: 'F-36248r3_fix'
  tag 'documentable'
end
