...
'
  desc 'check', 'Verify the Ubuntu operating system generates an audit record upon unsuccessful attempts to use the "open_by_handle_at" system call. 
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41486r654001_chk'
  tag severity: 'medium'
  tag gid: 'V-238276'
