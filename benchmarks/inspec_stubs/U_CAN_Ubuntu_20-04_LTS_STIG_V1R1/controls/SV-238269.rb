...
'
  desc 'check', 'Verify the Ubuntu operating system generates an audit record upon successful/unsuccessful attempts to use the "fchmod" system call. 
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41479r653980_chk'
  tag severity: 'medium'
  tag gid: 'V-238269'
