...
'
  desc 'check', 'Verify the Ubuntu operating system generates an audit record upon unsuccessful attempts to use the "creat" system call. 
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41484r653995_chk'
  tag severity: 'medium'
  tag gid: 'V-238274'
