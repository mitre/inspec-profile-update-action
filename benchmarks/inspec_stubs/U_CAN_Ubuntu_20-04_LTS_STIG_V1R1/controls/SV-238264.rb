...
'
  desc 'check', 'Verify the Ubuntu operating system generates an audit record upon successful/unsuccessful attempts to use the "chown" system call. 
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41474r653965_chk'
  tag severity: 'medium'
  tag gid: 'V-238264'
