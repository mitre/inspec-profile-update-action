...
'
  desc 'check', 'Verify the Ubuntu operating system generates an audit record upon successful/unsuccessful attempts to use the "chmod" system call. 
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41478r653977_chk'
  tag severity: 'medium'
  tag gid: 'V-238268'
