...
'
  desc 'check', 'Verify the Ubuntu operating system generates an audit record upon unsuccessful attempts to use the "ftruncate" system call. 
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41483r653992_chk'
  tag severity: 'medium'
  tag gid: 'V-238273'
