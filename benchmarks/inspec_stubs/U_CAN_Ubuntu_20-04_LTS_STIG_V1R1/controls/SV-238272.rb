...
'
  desc 'check', 'Verify the Ubuntu operating system generates an audit record upon unsuccessful attempts to use the "truncate" system call. 
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41482r653989_chk'
  tag severity: 'medium'
  tag gid: 'V-238272'
