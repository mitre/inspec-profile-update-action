...
'
  desc 'check', 'Verify the Ubuntu operating system generates an audit record upon successful/unsuccessful attempts to use the "fchown" system call. 
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41475r653968_chk'
  tag severity: 'medium'
  tag gid: 'V-238265'
