...
'
  desc 'check', 'Verify the Ubuntu operating system generates an audit record upon successful/unsuccessful attempts to use the "fchownat" system call. 
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41476r653971_chk'
  tag severity: 'medium'
  tag gid: 'V-238266'
