...
'
  desc 'check', 'Verify the Ubuntu operating system generates an audit record upon unsuccessful attempts to use the "open" system call. 
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41481r653986_chk'
  tag severity: 'medium'
  tag gid: 'V-238271'
