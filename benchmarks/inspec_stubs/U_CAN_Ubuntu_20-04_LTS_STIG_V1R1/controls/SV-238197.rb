...
"I've read & consent to terms in IS user agreem't.")
  desc 'check', 'Verify the Ubuntu operating system is configured to display the Standard Mandatory DoD Notice and Consent Banner before granting access to the operating system via a graphical user logon. 
...
$ sudo systemctl restart gdm3'
  ...
  tag check_id: 'C-41407r653764_chk'
  tag severity: 'medium'
  tag gid: 'V-238197'
