...
'
  desc 'check', 'Verify the Ubuntu operating system generates an audit record upon successful/unsuccessful attempts to use the "fchmodat" system call. 
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41480r653983_chk'
  tag severity: 'medium'
  tag gid: 'V-238270'
