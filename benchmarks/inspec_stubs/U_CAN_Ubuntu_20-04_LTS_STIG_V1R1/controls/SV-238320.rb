...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', 'Verify the Ubuntu operating system is configured to audit the execution of the partition management program "fdisk". 
...
$ sudo augenrules --load'
  ...
  tag check_id: 'C-41530r654133_chk'
  tag severity: 'medium'
  tag gid: 'V-238320'
