...
If the value vbawarnings is REG_DWORD = 3, this is not a finding.'
  desc 'fix', 'Set the policy value for User Configuration >> Administrative Templates >> Microsoft Publisher 2016\\Security >> Trust Center >> VBA Macro Notification Settings >> VBA Macro Notification Settings must to Disable all except digitally signed macros.'
  impact 0.5
  ref 'DPMS Target Microsoft Office 365 ProPlus'
  tag check_id: 'C-25065r744268_chk'
  tag severity: 'medium'
  tag gid: 'V-223392'
  tag rid: 'SV-223392r744269_rule'
  tag stig_id: 'O365-PU-000003'
  tag gtitle: 'SRG-APP-000131'
  tag fix_id: 'F-25053r442396_fix'
  tag 'documentable'
