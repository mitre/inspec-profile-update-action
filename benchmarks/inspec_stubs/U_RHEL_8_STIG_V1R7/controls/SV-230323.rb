control 'SV-230323' do
  ...
  desc 'check', %q(Verify the assigned home directory of all local interactive users on RHEL 8 exists with the following command:
...
$ sudo chmod 0750 /home/smithj'
  ...
  tag check_id: 'C-32992r567715_chk'
  tag severity: 'medium'
  tag gid: 'V-230323'
