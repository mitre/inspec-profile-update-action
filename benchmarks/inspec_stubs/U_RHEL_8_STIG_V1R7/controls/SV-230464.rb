...
'
  desc 'check', 'Verify RHEL 8 generates an audit record when successful/unsuccessful attempts to use the "chacl" command by performing the following command to check the file system rules in "/etc/audit/audit.rules":
...
The audit daemon must be restarted for the changes to take effect.'
  ...
  tag check_id: 'C-33133r568138_chk'
  tag severity: 'medium'
  tag gid: 'V-230464'
