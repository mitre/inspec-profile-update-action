control 'SV-230307' do
  ...
  desc 'check', 'Verify file systems that are being NFS-imported are mounted with the "nodev" option with the following command:
...
If a file system found in "/etc/fstab" refers to NFS and it does not have the "nodev" option set, this is a finding.'
  ...
  tag check_id: 'C-32976r567667_chk'
  tag severity: 'medium'
  tag gid: 'V-230307'
