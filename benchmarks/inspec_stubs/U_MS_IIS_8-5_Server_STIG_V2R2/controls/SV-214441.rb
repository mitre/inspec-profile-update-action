...
If the server is hosting WSUS, this is Not Applicable.'
  desc 'fix', 'If the server is hosting SharePoint, this is Not Applicable
...
Remove all groups other than “Administrators”.'
  ...
  tag check_id: 'C-15651r695285_chk'
  tag severity: 'medium'
  tag gid: 'V-214441'
  tag rid: 'SV-214441r695287_rule'
  tag stig_id: 'IISW-SV-000159'
  tag gtitle: 'SRG-APP-000516-WSR-000174'
  tag fix_id: 'F-15649r695286_fix'
  tag 'documentable'
