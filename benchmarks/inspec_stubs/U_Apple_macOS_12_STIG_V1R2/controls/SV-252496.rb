...
The Apple ID System Preference Pane must be disabled.'
  desc 'check', %q(To check if the system is configured to disable access to the Apple ID preference pane and prevent it from being displayed, run the following command:
...
If the return is not an array, DisabledPreferencePanes, containing: "com.apple.preferences.AppleIDPrefPane", this is a finding.)
  ...
  tag check_id: 'C-55952r816300_chk'
  tag severity: 'high'
  tag gid: 'V-252496'
  tag rid: 'SV-252496r816302_rule'
  tag stig_id: 'APPL-12-002031'
  tag gtitle: 'SRG-OS-000370-GPOS-00155'
  tag fix_id: 'F-55902r816301_fix'
  tag 'documentable'
  tag cci: ['CCI-001774']
  tag nist: ['CM-7 (5) (b)']
end
