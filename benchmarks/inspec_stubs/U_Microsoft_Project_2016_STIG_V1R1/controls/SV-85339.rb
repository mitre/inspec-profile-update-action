control 'SV-85339' do
  ...
  desc 'check', 'Verify the policy value for User Configuration -> Administrative Templates -> Microsoft Project 2016 -> Project Options -> Security ->  Trust Center -> "Require that application add-ins are signed by Trusted Publisher" is set to "Enabled".
...
Criteria: If the value requireaddinsig is REG_DWORD = 1, this is not a finding.'
  desc 'fix', 'Set the policy User Configuration -> Administrative Templates -> Microsoft Project 2016 -> Project Options -> Security ->  Trust Center -> "Require that application add-ins are signed by Trusted Publisher" to "Enabled".'
  impact 0.5
  ref 'DPMS Target Microsoft Project 2016'
  tag check_id: 'C-71197r2_chk'
  tag severity: 'medium'
  tag gid: 'V-70715'
  tag rid: 'SV-85339r1_rule'
  tag stig_id: 'DTOO127'
  tag gtitle: 'SRG-APP-000131'
  tag fix_id: 'F-77039r1_fix'
  tag 'documentable'
  tag cci: ['CCI-001749']
  tag nist: ['CM-5 (3)']
end
