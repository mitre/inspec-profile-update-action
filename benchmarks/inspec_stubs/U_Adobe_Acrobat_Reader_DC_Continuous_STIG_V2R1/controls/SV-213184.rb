...
Value: 1'
  ...
  tag check_id: 'C-14419r276770_chk'
  tag severity: 'medium'
  tag gid: 'V-213184'
  tag rid: 'SV-213184r395853_rule'
  tag stig_id: 'ARDC-CN-000090'
  tag gtitle: 'SRG-APP-000141'
  tag fix_id: 'F-14417r276771_fix'
  tag 'documentable'
  tag legacy: ['SV-79439', 'V-64949']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
