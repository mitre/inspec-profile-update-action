...
Value: 1'
  ...
  tag check_id: 'C-14413r276752_chk'
  tag severity: 'medium'
  tag gid: 'V-213178'
  tag rid: 'SV-213178r395853_rule'
  tag stig_id: 'ARDC-CN-000060'
  tag gtitle: 'SRG-APP-000141'
  tag fix_id: 'F-14411r276753_fix'
  tag 'documentable'
  tag legacy: ['SV-79429', 'V-64939']
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
