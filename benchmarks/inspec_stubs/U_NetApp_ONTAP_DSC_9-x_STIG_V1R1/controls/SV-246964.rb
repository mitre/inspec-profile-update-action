control 'SV-246964' do
  title 'ONTAP must be configured to send log data to a central log server.'
  ...
  desc 'check', 'Use "cluster log-forwarding show" to see if remote syslogging of ONTAP is configured.

If ONTAP cannot be configured to send log data to a central log server, this is a finding.'
  ...
  tag check_id: 'C-50396r769222_chk'
  tag severity: 'high'
  tag gid: 'V-246964'
  tag rid: 'SV-246964r769224_rule'
