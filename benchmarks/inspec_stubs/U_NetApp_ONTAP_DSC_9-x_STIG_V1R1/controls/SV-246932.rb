...
If ONTAP cannot be configured to display the Standard Mandatory DoD Notice and Consent Banner before granting access to the device, this is a finding.'
  ...
  tag check_id: 'C-50364r769126_chk'
  tag severity: 'medium'
  tag gid: 'V-246932'
  tag rid: 'SV-246932r769128_rule'
