...
If ONTAP cannot be configured to synchronize internal information system clocks using redundant authoritative time sources, this is a finding.'
  desc 'fix', 'Configure network time protocol for ONTAP with "cluster time-service ntp server create -server <IP address>" to add new ntp servers. Up to ten servers can be defined.'
  impact 0.5
  ref 'DPMS Target NetApp ONTAP DSC 9.x'
  tag check_id: 'C-50368r769138_chk'
  tag severity: 'medium'
  tag gid: 'V-246936'
  tag rid: 'SV-246936r769140_rule'
  tag stig_id: 'NAOT-AU-000004'
  tag gtitle: 'SRG-APP-000373-NDM-000298'
  tag fix_id: 'F-50322r769139_fix'
  tag 'documentable'
