...
Because of the challenges of applying this requirement on a large scale, organizations are encouraged to only apply the requirement to those limited number (and type) of devices that truly need to support this capability.'
  desc 'check', 'Use "security snmpusers -authmethod usm" to see snmpV3 users using FIPS-validated Keyed-HMAC.

If ONTAP cannot be configured to authenticate SNMP messages using FIPS-validated Keyed-HMAC, this is a finding.'
...
Which privacy protocol do you want to choose (none, des, aes128) [none]: aes128.)
  ...
  tag check_id: 'C-50381r769177_chk'
  tag severity: 'medium'
  tag gid: 'V-246949'
  tag rid: 'SV-246949r769179_rule'
