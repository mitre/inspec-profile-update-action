...
If ONTAP cannot be configured to enforce password complexity by requiring that at least one numeric character be used, this is a finding.'
  ...
  tag check_id: 'C-50386r769192_chk'
  tag severity: 'medium'
  tag gid: 'V-246954'
  tag rid: 'SV-246954r769194_rule'
