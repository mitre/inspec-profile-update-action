...
If ONTAP cannot be configured to record time stamps for audit records that can be mapped to Coordinated Universal Time (UTC) or Greenwich Mean Time (GMT), this is a finding.'
  desc 'fix', 'Configure the time zone to UTC with "cluster date modify -timezone UCT".'
  impact 0.5
  ref 'DPMS Target NetApp ONTAP DSC 9.x'
  tag check_id: 'C-50370r769144_chk'
  tag severity: 'medium'
  tag gid: 'V-246938'
  tag rid: 'SV-246938r769146_rule'
  tag stig_id: 'NAOT-AU-000006'
  tag gtitle: 'SRG-APP-000374-NDM-000299'
  tag fix_id: 'F-50324r769145_fix'
  tag 'documentable'
  tag cci: ['CCI-001890']
  tag nist: ['AU-8 b']
end
