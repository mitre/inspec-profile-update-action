...
If ONTAP cannot be configured to enforce a minimum 15-character password length, this is a finding.'
  ...
  tag check_id: 'C-50383r769183_chk'
  tag severity: 'medium'
  tag gid: 'V-246951'
  tag rid: 'SV-246951r769185_rule'
