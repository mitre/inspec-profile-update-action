...
If ONTAP cannot be configured to use replay-resistant authentication mechanisms for network access to privileges, this is a finding.'
  ...
  tag check_id: 'C-50380r769174_chk'
  tag severity: 'medium'
  tag gid: 'V-246948'
  tag rid: 'SV-246948r769176_rule'
