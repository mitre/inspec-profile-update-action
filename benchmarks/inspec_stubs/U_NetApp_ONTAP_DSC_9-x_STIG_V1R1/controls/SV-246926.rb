...
If ONTAP cannot be configured with only one local account to be used as the account of last resort in the event the authentication server is unavailable, this is a finding.'
  ...
  tag check_id: 'C-50358r769108_chk'
  tag severity: 'medium'
  tag gid: 'V-246926'
  tag rid: 'SV-246926r769110_rule'
