...
If ONTAP cannot be configured to authenticate NTP sources using authentication that is cryptographically based, this is a finding.'
  ...
  tag check_id: 'C-50382r769180_chk'
  tag severity: 'medium'
  tag gid: 'V-246950'
  tag rid: 'SV-246950r769182_rule'
